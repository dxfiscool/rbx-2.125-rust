//! audio generated_163 — next 150 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Audio|Sound (2541 distinct) exhausted — filler EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 150 stubs | skeleton batch | range 0x2b6d04..0x2bddc0 EA-sorted asc filler gap, rbx_core::SharedPtr not boost
...
pub fn stub_2b71e0() -> ! {
    todo!("0x2b71e0 boost::shared_ptr<RBX::TaskScheduler::Job>::shared_ptr<RBX::GcJob>(RBX::GcJob *)")
}
...
pub fn stub_2b72c8() -> ! {
    todo!("0x2b72c8 void boost::enable_shared_from_this<RBX::TaskScheduler::Job>::_internal_accept_owner<RBX::TaskScheduler::Job,RBX::GcJob>(boost::shared_ptr<RBX::TaskScheduler::Job> const*,RBX::GcJob *)const")
}
...
pub fn stub_2b73ac() -> ! {
    todo!("0x2b73ac boost::detail::shared_count::shared_count<RBX::GcJob>(RBX::GcJob *)")
}
...
pub fn stub_2b74ac() -> ! {
    todo!("0x2b74ac boost::detail::sp_counted_impl_p<RBX::GcJob>::dispose(void)")
}
...
pub fn stub_2b74bc() -> ! {
    todo!("0x2b74bc boost::detail::sp_counted_impl_p<RBX::GcJob>::get_deleter(std::type_info const&)")
}
...
pub fn stub_2b74c0() -> ! {
    todo!("0x2b74c0 boost::detail::sp_counted_impl_p<RBX::GcJob>::get_untyped_deleter(void)")
}
...
// was: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, boost::detail::sp_counted_base *, char, int, int, int, int, int, int, int) -> rbx_core::SharedPtr
...
// was: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int) -> rbx_core::SharedPtr
...
// was: int __fastcall(char, boost::mutex *, int, int, int, int) -> rbx_core::SharedPtr
...
// was: int __fastcall(int, int, int, int, boost::mutex *, char, int, int, int, int) -> rbx_core::SharedPtr
...
pub fn stub_2baca8() -> ! {
    todo!("0x2baca8 std::list<RBX::Reflection::SignatureDescriptor::Item,std::allocator<RBX::Reflection::SignatureDescriptor::Item>>::_M_create_node(RBX::Reflection::SignatureDescriptor::Item const&)")
}
...
pub fn stub_2bb218() -> ! {
    todo!("0x2bb218 RBX::Reflection::BoundProp<int,(RBX::Reflection::Mutability)1>::~BoundProp()")
}
...
pub fn stub_2bb658() -> ! {
    todo!("0x2bb658 rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> const&)")
}
...
pub fn stub_2bb6c0() -> ! {
    todo!("0x2bb6c0 boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>::operator=(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> const&)")
}
...
#[doc(alias = "rbx::implementation::typed_holder<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>::construct_func(char const*,char *)")]
pub fn stub_2bb6f8() -> ! {
    todo!("0x2bb6f8 rbx::implementation::typed_holder<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>::construct_func(char const*,char *)")
}
...
pub fn stub_2bbf50() -> ! {
    todo!("0x2bbf50 RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::~BoundProp()")
}
...
pub fn stub_2bbf80() -> ! {
    todo!("0x2bbf80 RBX::Reflection::TypedPropertyDescriptor<bool>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_2bbfa8() -> ! {
    todo!("0x2bbfa8 RBX::Reflection::TypedPropertyDescriptor<bool>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_2bc0f8() -> ! {
    todo!("0x2bc0f8 RBX::Reflection::TypedPropertyDescriptor<bool>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_2bccc0() -> ! {
    todo!("0x2bccc0 boost::scoped_ptr<std::string>::~scoped_ptr()")
}
...
pub fn stub_2bd4f0() -> ! {
    todo!("0x2bd4f0 std::string RBX::Reflection::ArgHelper::getArg<std::string,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<std::string> const&,boost::disable_if<boost::is_same<std::string,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")
}
