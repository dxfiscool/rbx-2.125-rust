...
pub fn stub_2b6d04() {
    // IDA 0x2b6d04: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b6da4() {
    // IDA 0x2b6da4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b6dac() {
    // IDA 0x2b6dac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b6e50() {
    // IDA 0x2b6e50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b6e58() {
    // IDA 0x2b6e58: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b6fe4() {
    // IDA 0x2b6fe4: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
pub fn stub_2b70c8() {
    // IDA 0x2b70c8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b71c0() {
    // IDA 0x2b71c0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x2b71c4 — __ZN5boost6detail17sp_counted_impl_pIN3RBX17WaitingScriptsJobEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_p<RBX::WaitingScriptsJob>::~sp_counted_impl_p()")]
pub fn stub_2b71c4() {
    // IDA 0x2b71c4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b71c8() {
    // IDA 0x2b71c8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b71d8() {
    // IDA 0x2b71d8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b71dc() {
    // IDA 0x2b71dc: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b71e0() -> ! {
    todo!("0x2b71e0 __ZN5boost10shared_ptrIN3RBX13TaskScheduler3JobEEC2INS1_5GcJobEEEPT_")
}
...
pub fn stub_2b72c8() {
    // IDA 0x2b72c8: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
pub fn stub_2b73ac() {
    // IDA 0x2b73ac: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b74ac() {
    // IDA 0x2b74ac: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b74bc() {
    // IDA 0x2b74bc: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b74c0() {
    // IDA 0x2b74c0: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b8008() {
    // IDA 0x2b8008: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b83cc() {
    // IDA 0x2b83cc: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
pub fn stub_2b84b8() {
    // IDA 0x2b84b8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b85c0() {
    // IDA 0x2b85c0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b85c8() {
    // IDA 0x2b85c8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b85e8() {
    // IDA 0x2b85e8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b8600() {
    // IDA 0x2b8600: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2b8a94() {
    // IDA 0x2b8a94: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2b8f38() -> ! {
    todo!("0x2b8f38 __ZNK3RBX10Reflection13EventDescBaseINS_13ScriptContextEFvSsSsN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_E13disconnectAllEPNS0_11EventSourceE")
}
...
pub fn stub_2b8f4c() -> ! {
    todo!("0x2b8f4c __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE13disconnectAllEv")
}
...
pub fn stub_2b91b8() -> ! {
    todo!("0x2b91b8 __ZN5boost4bindIvN3RBX10Reflection18GenericSlotWrapperERKSsS5_RKNS_10shared_ptrINS1_8InstanceEEENS6_IS3_EENS_3argILi1EEENSC_ILi2EEENSC_ILi3EEEEENS_3_bi6bind_tIT_NS_4_mfi3mf3ISI_T0_T1_T2_T3_EENSG_9list_av_4IT4_T5_T6_T7_E4typeEEEMSL_FSI_SM_SN_SO_ESR_SS_ST_SU_")
}
...
pub fn stub_2b92d4() -> ! {
    todo!("0x2b92d4 __ZN3RBX10Reflection18GenericSlotWrapper8execute3ISsSsN5boost10shared_ptrINS_8InstanceEEEEEvRKT_RKT0_RKT1_")
}
...
pub fn stub_2b9460() {
    // IDA 0x2b9460: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_2b9658() -> ! {
    todo!("0x2b9658 __ZN5boost9function3IvSsSsNS_10shared_ptrIN3RBX8InstanceEEEE9assign_toINS_3_bi6bind_tIvNS_4_mfi3mf3IvNS2_10Reflection18GenericSlotWrapperERKSsSE_RKS4_EENS7_5list4INS7_5valueINS1_ISC_EEEENS_3argILi1EEENSM_ILi2EEENSM_ILi3EEEEEEEEEvT_")
}
...
pub fn stub_2b9750() {
    // IDA 0x2b9750: functor_manager::manage dispatched clone/destroy on the erased buffer (IDA 0x2d644: op==4 clones via manager). Clone/Drop glue — no-op carrier.
}
...
pub fn stub_2b976c() {
    // IDA 0x2b976c: invoker::invoke unpacked the buffer and called the bound functor. Closure call at the live site — carrier no-op.
}
...
pub fn stub_2b978c() -> ! {
    todo!("0x2b978c __ZNK5boost6detail8function13basic_vtable3IvSsSsNS_10shared_ptrIN3RBX8InstanceEEEE9assign_toINS_3_bi6bind_tIvNS_4_mfi3mf3IvNS4_10Reflection18GenericSlotWrapperERKSsSG_RKS6_EENS9_5list4INS9_5valueINS3_ISE_EEEENS_3argILi1EEENSO_ILi2EEENSO_ILi3EEEEEEEEEbT_RNS1_15function_bufferE")
}
...
pub fn stub_2b9874() -> ! {
    todo!("0x2b9874 __ZNK5boost6detail8function13basic_vtable3IvSsSsNS_10shared_ptrIN3RBX8InstanceEEEE9assign_toINS_3_bi6bind_tIvNS_4_mfi3mf3IvNS4_10Reflection18GenericSlotWrapperERKSsSG_RKS6_EENS9_5list4INS9_5valueINS3_ISE_EEEENS_3argILi1EEENSO_ILi2EEENSO_ILi3EEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE")
}
...
pub fn stub_2b9958() -> ! {
    todo!("0x2b9958 __ZNK5boost6detail8function13basic_vtable3IvSsSsNS_10shared_ptrIN3RBX8InstanceEEEE14assign_functorINS_3_bi6bind_tIvNS_4_mfi3mf3IvNS4_10Reflection18GenericSlotWrapperERKSsSG_RKS6_EENS9_5list4INS9_5valueINS3_ISE_EEEENS_3argILi1EEENSO_ILi2EEENSO_ILi3EEEEEEEEEvT_RNS1_15function_bufferEN4mpl_5bool_ILb0EEE")
}
...
pub fn stub_2b9a2c() -> ! {
    todo!("0x2b9a2c __ZN5boost3_bi5list4INS0_5valueINS_10shared_ptrIN3RBX10Reflection18GenericSlotWrapperEEEEENS_3argILi1EEENS9_ILi2EEENS9_ILi3EEEEclINS_4_mfi3mf3IvS6_RKSsSI_RKNS3_INS4_8InstanceEEEEENS0_5list3IRSsSP_RSK_EEEEvNS0_4typeIvEERT_RT0_i")
}
...
pub fn stub_2b9a54() {
    // IDA 0x2b9a54: functor_manager::manage dispatched clone/destroy on the erased buffer (IDA 0x2d644: op==4 clones via manager). Clone/Drop glue — no-op carrier.
}
...
pub fn stub_2b9bac() -> ! {
    todo!("0x2b9bac __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE7connectINS2_8functionIS7_EEEENS0_10connectionERKT_")
}
...
pub fn stub_2b9ca0() -> ! {
    todo!("0x2b9ca0 __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE6insertEPNS8_4slotE")
}
...
pub fn stub_2b9eac() -> ! {
    todo!("0x2b9eac __ZN5boost13intrusive_ptrIN3rbx7signals6signalIFvSsSsNS_10shared_ptrIN3RBX8InstanceEEEEE4slotEEaSEPSA_")
}
...
pub fn stub_2b9ed0() -> ! {
    todo!("0x2b9ed0 __ZN3rbx8callableINS_7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slotENS3_8functionIS8_EELi3ES8_EC2IPS9_EERKSC_T_")
}
...
pub fn stub_2b9fcc() {
    // IDA 0x2b9fcc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x2ba0dc — __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE13callable_slotINS2_8functionIS7_EEED0Ev
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,rbx_core::SharedPtr<RBX::Instance>)>::callable_slot<boost::function<void ()(std::string,std::string,rbx_core::SharedPtr<RBX::Instance>)>>::~callable_slot()")]
pub fn stub_2ba0dc() {
    // IDA 0x2ba0dc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2ba20c() -> ! {
    todo!("0x2ba20c __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slot10disconnectEv")
}
...
pub fn stub_2ba31c() -> ! {
    todo!("0x2ba31c __ZNK3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slot9connectedEv")
}
...
pub fn stub_2ba328() -> ! {
    todo!("0x2ba328 __ZN3rbx8callableINS_7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slotENS3_8functionIS8_EELi3ES8_E4callESsSsS7_")
}
...
pub fn stub_2ba518() {
    // IDA 0x2ba518: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2ba520() -> ! {
    todo!("0x2ba520 __ZNK5boost9function3IvSsSsNS_10shared_ptrIN3RBX8InstanceEEEEclESsSsS4_")
}
...
pub fn stub_2ba750() -> ! {
    todo!("0x2ba750 __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE6removeEPNS8_4slotE")
}
...
pub fn stub_2ba840() -> ! {
    todo!("0x2ba840 __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slot22safe_static_init_mutexEv")
}
...
pub fn stub_2ba844() -> ! {
    todo!("0x2ba844 __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slot24safe_static_do_get_mutexEv")
}
...
pub fn stub_2ba934() {
    // IDA 0x2ba934: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "rbx::callable<rbx::signals::signal<void ()(std::string,std::string,rbx_core::SharedPtr<RBX::Instance>)>::slot,boost::function<void ()(std::string,std::string,rbx_core::SharedPtr<RBX::Instance>)>,3,void ()(std::string,std::string,rbx_core::SharedPtr<RBX::Instance>)>::~callable()")]
pub fn stub_2baa44() {
    // IDA 0x2baa44: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bab74() {
    // IDA 0x2bab74: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x2baba0 — __ZN3rbx7signals6signalIFvSsSsN5boost10shared_ptrIN3RBX8InstanceEEEEE4slotD0Ev
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,rbx_core::SharedPtr<RBX::Instance>)>::slot::~slot()")]
pub fn stub_2baba0() {
    // IDA 0x2baba0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bac74() {
    // IDA 0x2bac74: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_2baca8() {
    // IDA 0x2baca8: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_2baf7c() {
    // IDA 0x2baf7c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bb218() {
    // IDA 0x2bb218: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bb394() -> ! {
    todo!("0x2bb394 __ZN3RBX10Reflection13BoundFuncDescINS_13ScriptContextEFN5boost10shared_ptrIKSt6vectorINS0_7VariantESaIS6_EEEEvELi0EEC2EMS2_FSA_vEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE")
}
...
pub fn stub_2bb498() {
    // IDA 0x2bb498: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bb54c() -> ! {
    todo!("0x2bb54c __ZNK3RBX10Reflection13BoundFuncDescINS_13ScriptContextEFN5boost10shared_ptrIKSt6vectorINS0_7VariantESaIS6_EEEEvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")
}
...
pub fn stub_2bb8fc() {
    // IDA 0x2bb8fc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bbca4() {
    // IDA 0x2bbca4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bbf50() {
    // IDA 0x2bbf50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bc530() {
    // IDA 0x2bc530: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bcde0() {
    // IDA 0x2bcde0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bd0cc() {
    // IDA 0x2bd0cc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2bd958() {
    // IDA 0x2bd958: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
