//! audio generated_45 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Sound|Audio exhausted (2541 distinct) — filler workspace EA-sorted asc after 0x445af0, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0x445c38..0x44a198 EA-sorted asc after 0x445af0, skip existing, rbx_core::SharedPtr not boost
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Lighting,RBX::Lighting>(boost::shared_ptr<RBX::Lighting> const*,RBX::Lighting *)const
...
// demangled: void boost::function0<void>::assign_to<boost::_bi::bind_t<std::string,std::string (*)(std::string const&,std::string const&),boost::_bi::list2<boost::_bi::value<std::string>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<std::string,std::string (*)(std::string const&,std::string const&),boost::_bi::list2<boost::_bi::value<std::string>,boost::_bi::value<std::string>>>)
...
// demangled: boost::detail::thread_data_base::thread_data_base(void)
// type: boost::detail::thread_data_base *__fastcall(boost::detail::thread_data_base *this)
// was type: boost::detail::thread_data_base *__fastcall(boost::detail::thread_data_base *this)
...
// demangled: std::vector<std::pair<boost::condition_variable *,boost::mutex *>,std::allocator<std::pair<boost::condition_variable *,boost::mutex *>>>::push_back(std::pair<boost::condition_variable *,boost::mutex *> const&)
...
// demangled: std::_Vector_base<std::pair<boost::condition_variable *,boost::mutex *>,std::allocator<std::pair<boost::condition_variable *,boost::mutex *>>>::_M_allocate(unsigned long)
...
// demangled: std::pair<boost::condition_variable *,boost::mutex *> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<std::pair<boost::condition_variable *,boost::mutex *> *,std::pair<boost::condition_variable *,boost::mutex *> *>(std::pair<boost::condition_variable *,boost::mutex *> *,std::pair<boost::condition_variable *,boost::mutex *> *,std::pair<boost::condition_variable *,boost::mutex *> *)
// type: int __fastcall(int, int, int)
...
// demangled: boost::shared_ptr<boost::detail::thread_data_base>::shared_ptr<boost::detail::thread_data<boost::function0<void>>>(boost::detail::thread_data<boost::function0<void>> *)
// type: _DWORD *__fastcall(_DWORD *, void *, int, int, int, int)
// was: boost::shared_ptr<boost::detail::thread_data_base>::shared_ptr<boost::detail::thread_data<boost::function0<void>>>(boost::detail::thread_data<boost::function0<void>> *) -> rbx_core::SharedPtr
...
// demangled: void boost::function0<void>::assign_to<boost::_bi::bind_t<std::string,std::string (*)(std::string const&),boost::_bi::list1<boost::_bi::value<std::string>>>>(boost::_bi::bind_t<std::string,std::string (*)(std::string const&),boost::_bi::list1<boost::_bi::value<std::string>>>)
// type: void __fastcall(_DWORD *, int)
...
// demangled: void boost::function2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(std::string)>>,boost::_bi::value<boost::function<void ()(std::string)>>>>>(boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(std::string)>>,boost::_bi::value<boost::function<void ()(std::string)>>>>)
...
// demangled: void boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(std::string)>>,boost::_bi::value<boost::function<void ()(std::string)>>>::operator()<void (*)(std::string *,std::exception *,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>),boost::_bi::list2<std::string *&,std::exception *&>>(boost::_bi::type<void>,void (*)(std::string *,std::exception *,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>) &,boost::_bi::list2<std::string *&,std::exception *&> &,int)
...
// demangled: boost::thread_specific_ptr<RBX::DataModel::GenericJob *>::reset(RBX::DataModel::GenericJob **)
// type: void __fastcall(shared_count *, const void *)
#[doc(alias = "__ZN5boost19thread_specific_ptrIPN3RBX9DataModel10GenericJobEE5resetEPS4_")]
pub fn stub_4486b8() -> ! {
...
// demangled: RBX::AssetService * RBX::ServiceProvider::find<RBX::AssetService>(void)const
...
#[doc(alias = "__ZNK3RBX15ServiceProvider4findINS_12AssetServiceEEEPT_v")]
pub fn stub_4487a0() -> ! {
...
// demangled: boost::shared_ptr<RBX::AssetService> RBX::Creatable<RBX::Instance>::create<RBX::AssetService>(void)
// type: void __fastcall(int)
// was: boost::shared_ptr<RBX::AssetService> RBX::Creatable<RBX::Instance>::create<RBX::AssetService>(void) -> rbx_core::SharedPtr
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_12AssetServiceEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_448914() -> ! {
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::AssetService>(boost::shared_ptr<RBX::AssetService> const&)
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::AssetService>(void)
#[doc(alias = "__ZN3RBX15ServiceProvider19callDoGetClassIndexINS_12AssetServiceEEEvv")]
pub fn stub_448b24() -> ! {
...
// demangled: unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::AssetService>(void)
// type: int()
#[doc(alias = "__ZN3RBX15ServiceProvider15doGetClassIndexINS_12AssetServiceEEEmv")]
pub fn stub_448b28() -> ! {
...
// demangled: boost::shared_ptr<RBX::AssetService>::shared_ptr<RBX::AssetService,RBX::Creatable<RBX::Instance>::Deleter>(RBX::AssetService *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int *__fastcall(int *, int, int, int)
// was: boost::shared_ptr<RBX::AssetService>::shared_ptr<RBX::AssetService,RBX::Creatable<RBX::Instance>::Deleter>(RBX::AssetService *,RBX::Creatable<RBX::Instance>::Deleter) -> rbx_core::SharedPtr
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX12AssetServiceEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_")]
pub fn stub_448c00() -> ! {
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::AssetService,RBX::AssetService>(boost::shared_ptr<RBX::AssetService> const*,RBX::AssetService *)const
// type: void __fastcall(_DWORD *, const shared_count *, int)
...
pub fn stub_448f00() -> ! {
    todo!("0x448f00 __ZN3RBX17NonFactoryProductINS_8InstanceELZNS_13sAssetServiceEEE15isNullClassNameEv")
}

// 0x448fa4 — __ZN3RBX9CreatableINS_8InstanceEE6createINS_13ScriptServiceEEEN5boost10shared_ptrIT_EEv
// demangled: boost::shared_ptr<RBX::ScriptService> RBX::Creatable<RBX::Instance>::create<RBX::ScriptService>(void)
// type: void __fastcall(__guard *)
// was: boost::shared_ptr<RBX::ScriptService> RBX::Creatable<RBX::Instance>::create<RBX::ScriptService>(void) -> rbx_core::SharedPtr
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_13ScriptServiceEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_448fa4() -> ! {
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::ScriptService>(boost::shared_ptr<RBX::ScriptService> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::ScriptService>(void)
#[doc(alias = "__ZN3RBX15ServiceProvider19callDoGetClassIndexINS_13ScriptServiceEEEvv")]
pub fn stub_449188() -> ! {
...
// demangled: std::vector<boost::shared_ptr<RBX::ScriptService::Info>,std::allocator<boost::shared_ptr<RBX::ScriptService::Info>>>::~vector()
// type: int __fastcall(int)
...
// demangled: boost::shared_ptr<RBX::ScriptService>::shared_ptr<RBX::ScriptService,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ScriptService *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int *__fastcall(int *, int, int, int)
// was: boost::shared_ptr<RBX::ScriptService>::shared_ptr<RBX::ScriptService,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ScriptService *,RBX::Creatable<RBX::Instance>::Deleter) -> rbx_core::SharedPtr
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX13ScriptServiceEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_")]
pub fn stub_449b10() -> ! {
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::ScriptService,RBX::ScriptService>(boost::shared_ptr<RBX::ScriptService> const*,RBX::ScriptService *)const
// type: void __fastcall(_DWORD *, const shared_count *, int)
...
// demangled: RBX::ContextActionService * RBX::ServiceProvider::find<RBX::ContextActionService>(void)const
// type: RBX::Name *__fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
// was type: RBX::Name *__fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "__ZNK3RBX15ServiceProvider4findINS_20ContextActionServiceEEEPT_v")]
pub fn stub_449e10() -> ! {
...
// demangled: boost::shared_ptr<RBX::ContextActionService> RBX::Creatable<RBX::Instance>::create<RBX::ContextActionService>(void)
// type: void __fastcall(int)
// was: boost::shared_ptr<RBX::ContextActionService> RBX::Creatable<RBX::Instance>::create<RBX::ContextActionService>(void) -> rbx_core::SharedPtr
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_20ContextActionServiceEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_449f84() -> ! {
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::ContextActionService>(boost::shared_ptr<RBX::ContextActionService> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::ContextActionService>(void)
#[doc(alias = "__ZN3RBX15ServiceProvider19callDoGetClassIndexINS_20ContextActionServiceEEEvv")]
pub fn stub_44a194() -> ! {
...
// demangled: unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::ContextActionService>(void)
// type: int()
#[doc(alias = "__ZN3RBX15ServiceProvider15doGetClassIndexINS_20ContextActionServiceEEEmv")]
pub fn stub_44a198() -> ! {
