//! audio batch — remaining strict-audio (FMOD|Audio|Sound|Soundscape) EAs not in global set (52) + EA-sorted filler (48) = 100
//! Filter exhausted: only 52 strict-audio EAs left globally; filler lowest EA-sorted asc not in global set. rbx_core::SharedPtr not boost.
