...
pub fn stub_f2d1b4() {
    // IDA 0xf2d1b4: Thumb import jump veneer for `j___ZN3RBX9CreatableINS_12MouseCommandEE6createINS_12PartDragToolEPNS_12PartInstanceEN3G3D7Vector3EPNS_9WorkspaceEN5boost10shared_ptrINS_8InstanceEEEEENSC_IT_EET0_T1_T2_T3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::PartDragTool> RBX::Creatable<RBX::MouseCommand>::create<RBX::PartDragTool,RBX::PartInstance *,G3D::Vector3,RBX::Workspace *,boost::shared_ptr<RBX::Instance>>(RBX::PartInstance *,G3D::Vector3,RBX::Workspace *,boost::shared_ptr<RBX::Instance>).
}
...
pub fn stub_f2d1c4() {
    // IDA 0xf2d1c4: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX12PartDragToolEEC2IS2_NS1_9CreatableINS1_12MouseCommandEE7DeleterEEEPT_T0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::PartDragTool>::shared_ptr<RBX::PartDragTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::PartDragTool *,RBX::Creatable<RBX::MouseCommand>::Deleter).
}
...
pub fn stub_f2d1f4() {
    // IDA 0xf2d1f4: Thumb import jump veneer for `j___ZN3G3D5ArrayIPN3RBX9PrimitiveELi10ELm32EE4initEiRKNS_23ReferenceCountedPointerINS_13MemoryManagerEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<RBX::Primitive *,10,32ul>::init(int,G3D::ReferenceCountedPointer<G3D::MemoryManager> const&).
}
...
pub fn stub_f2d204() {
    // IDA 0xf2d204: Thumb import jump veneer for `j___ZN3G3D5ArrayIPN3RBX9PrimitiveELi10ELm32EE6appendERKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<RBX::Primitive *,10,32ul>::append(RBX::Primitive * const&).
}
...
pub fn stub_f2d214() {
    // IDA 0xf2d214: Thumb import jump veneer for `j___ZN3RBX7Extents18negativeMaxExtentsEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Extents::negativeMaxExtents(void).
}
...
pub fn stub_f2d224() {
    // IDA 0xf2d224: Thumb import jump veneer for `j___ZN5boost9unordered6detail5tableINS1_3setISaIPKN3RBX9PrimitiveEES7_NS_4hashIS7_EESt8equal_toIS7_EEEEC2EmRKSA_RKSC_RKSaINS1_8ptr_nodeIS7_EEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::Primitive const*>,RBX::Primitive const*,boost::hash<RBX::Primitive const*>,std::equal_to<RBX::Primitive const*>>>::table(unsigned long,boost::hash<RBX::Primitive const*> const&,std::equal_to<RBX::Primitive const*> const&,std::allocator<boost::unordered::detail::ptr_node<RBX::Primitive const*>> const&).
}
...
pub fn stub_f2d234() {
    // IDA 0xf2d234: Thumb import jump veneer for `j___ZNK3RBX4POLY4Edge9getVertexEPKNS0_4FaceEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::POLY::Edge::getVertex(RBX::POLY::Face const*,unsigned long)const.
}
...
pub fn stub_f2d244() {
    // IDA 0xf2d244: Thumb import jump veneer for `j___ZNSt12_Vector_baseIN3RBX7ExtentsESaIS1_EE11_M_allocateEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Vector_base<RBX::Extents,std::allocator<RBX::Extents>>::_M_allocate(unsigned long).
}
...
pub fn stub_f2d254() {
    // IDA 0xf2d254: Thumb import jump veneer for `j___ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX7ExtentsES5_EET0_T_S7_S6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Extents * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::Extents *,RBX::Extents *>(RBX::Extents *,RBX::Extents *,RBX::Extents *).
}
...
pub fn stub_f2d264() {
    // IDA 0xf2d264: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX7ExtentsESaIS1_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS1_S3_EERKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::Extents,std::allocator<RBX::Extents>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::Extents*,std::vector<RBX::Extents,std::allocator<RBX::Extents>>>,RBX::Extents const&).
}
...
pub fn stub_f2d274() {
    // IDA 0xf2d274: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX7ExtentsESaIS1_EE7reserveEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::Extents,std::allocator<RBX::Extents>>::reserve(unsigned long).
}
...
pub fn stub_f2d284() {
    // IDA 0xf2d284: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX7ExtentsESaIS1_EE9push_backERKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::Extents,std::allocator<RBX::Extents>>::push_back(RBX::Extents const&).
}
...
pub fn stub_f2d2a4() {
    // IDA 0xf2d2a4: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX11LuaDragToolEEC2IS2_NS1_9CreatableINS1_12MouseCommandEE7DeleterEEEPT_T0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::LuaDragTool>::shared_ptr<RBX::LuaDragTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::LuaDragTool *,RBX::Creatable<RBX::MouseCommand>::Deleter).
}
...
pub fn stub_f2d2d4() {
    // IDA 0xf2d2d4: Thumb import jump veneer for `j___ZN3RBX9CreatableINS_8InstanceEE6createINS_9ExplosionEEEN5boost10shared_ptrIT_EEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::Explosion> RBX::Creatable<RBX::Instance>::create<RBX::Explosion>(void).
}
...
pub fn stub_f2d2e4() {
    // IDA 0xf2d2e4: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX9ExplosionEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::Explosion>::shared_ptr<RBX::Explosion,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Explosion *,RBX::Creatable<RBX::Instance>::Deleter).
}
...
pub fn stub_f2d324() {
    // IDA 0xf2d324: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvN3G3D7Vector34AxisEELi1EE16declareSignatureEPKcNS0_7VariantE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(G3D::Vector3::Axis),1>::declareSignature(char const*,RBX::Reflection::Variant).
}
...
pub fn stub_f2d334() {
    // IDA 0xf2d334: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvN3G3D7Vector34AxisEELi1EEC2EMS2_FvS5_EPKcSB_S5_NS_8Security11PermissionsENS0_10Descriptor10AttributesE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(G3D::Vector3::Axis),1>::BoundFuncDesc(void (RBX::LuaDragger::*)(G3D::Vector3::Axis),char const*,char const*,G3D::Vector3::Axis,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes).
}
...
pub fn stub_f2d344() {
    // IDA 0xf2d344: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvN5boost10shared_ptrINS_8InstanceEEEN3G3D7Vector3ENS4_IKSt6vectorIS6_SaIS6_EEEEELi3EE16declareSignatureEPKcNS0_7VariantESH_SI_SH_SI_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(boost::shared_ptr<RBX::Instance>,G3D::Vector3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),3>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant).
}
...
pub fn stub_f2d354() {
    // IDA 0xf2d354: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvN5boost10shared_ptrINS_8InstanceEEEN3G3D7Vector3ENS4_IKSt6vectorIS6_SaIS6_EEEEELi3EEC2EMS2_FvS6_S8_SD_EPKcSJ_SJ_SJ_NS_8Security11PermissionsENS0_10Descriptor10AttributesE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(boost::shared_ptr<RBX::Instance>,G3D::Vector3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),3>::BoundFuncDesc(void (RBX::LuaDragger::*)(boost::shared_ptr<RBX::Instance>,G3D::Vector3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),char const*,char const*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes).
}
...
pub fn stub_f2d374() {
    // IDA 0xf2d374: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvNS_6RbxRayEELi1EE16declareSignatureEPKcNS0_7VariantE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(RBX::RbxRay),1>::declareSignature(char const*,RBX::Reflection::Variant).
}
...
pub fn stub_f2d384() {
    // IDA 0xf2d384: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvNS_6RbxRayEELi1EEC2EMS2_FvS3_EPKcS9_NS_8Security11PermissionsENS0_10Descriptor10AttributesE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(RBX::RbxRay),1>::BoundFuncDesc(void (RBX::LuaDragger::*)(RBX::RbxRay),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes).
}
...
pub fn stub_f2d394() {
    // IDA 0xf2d394: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_10LuaDraggerEFvvELi0EEC2EMS2_FvvEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::LuaDragger,void ()(void),0>::BoundFuncDesc(void (RBX::LuaDragger::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes).
}
...
pub fn stub_f2d3a4() {
    // IDA 0xf2d3a4: Thumb import jump veneer for `j___ZN3RBX10Reflection9ArgHelper6getArgIN3G3D7Vector34AxisELi1EEET_RNS0_18FunctionDescriptor9ArgumentsERKN5boost10scoped_ptrIS6_EEPNSA_10disable_ifINSA_7is_sameIS6_NSA_10shared_ptrIKNS0_5TupleEEEEEvE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Vector3::Axis RBX::Reflection::ArgHelper::getArg<G3D::Vector3::Axis,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<G3D::Vector3::Axis> const&,boost::disable_if<boost::is_same<G3D::Vector3::Axis,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *).
}
...
pub fn stub_f2d3b4() {
    // IDA 0xf2d3b4: Thumb import jump veneer for `j___ZN3RBX10Reflection9ArgHelper6getArgIN3G3D7Vector3ELi2EEET_RNS0_18FunctionDescriptor9ArgumentsERKN5boost10scoped_ptrIS5_EEPNS9_10disable_ifINS9_7is_sameIS5_NS9_10shared_ptrIKNS0_5TupleEEEEEvE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Vector3 RBX::Reflection::ArgHelper::getArg<G3D::Vector3,2>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<G3D::Vector3> const&,boost::disable_if<boost::is_same<G3D::Vector3,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *).
}
...
pub fn stub_f2d3c4() {
    // IDA 0xf2d3c4: Thumb import jump veneer for `j___ZN3RBX10Reflection9ArgHelper6getArgIN5boost10shared_ptrIKSt6vectorINS4_INS_8InstanceEEESaIS7_EEEELi3EEET_RNS0_18FunctionDescriptor9ArgumentsERKNS3_10scoped_ptrISC_EEPNS3_10disable_ifINS3_7is_sameISC_NS4_IKNS0_5TupleEEEEEvE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> RBX::Reflection::ArgHelper::getArg<boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>,3>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>> const&,boost::disable_if<boost::is_same<boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *).
}
...
pub fn stub_f2d3d4() {
    // IDA 0xf2d3d4: Thumb import jump veneer for `j___ZN3RBX10Reflection9ArgHelper8try_enumILi1EN3G3D7Vector34AxisEEEbRNS0_18FunctionDescriptor9ArgumentsERT0_PN5boost9enable_ifINSB_7is_enumIS9_EEvE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::Reflection::ArgHelper::try_enum<1,G3D::Vector3::Axis>(RBX::Reflection::FunctionDescriptor::Arguments &,G3D::Vector3::Axis &,boost::enable_if<boost::is_enum<G3D::Vector3::Axis>,void>::type *).
}
...
pub fn stub_f2d3e4() {
    // IDA 0xf2d3e4: Thumb import jump veneer for `j___ZN3RBX14FactoryProductINS_10LuaDraggerENS_8InstanceELZNS_11sLuaDraggerEES2_E17static_getCreatorEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX14FactoryProductINS_10LuaDraggerENS_8InstanceELZNS_11sLuaDraggerEES2_E17static_getCreatorEv.
}
...
pub fn stub_f2d3f4() {
    // IDA 0xf2d3f4: Thumb import jump veneer for `j___ZN3RBX14FactoryProductINS_10LuaDraggerENS_8InstanceELZNS_11sLuaDraggerEES2_E7CreatorC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX14FactoryProductINS_10LuaDraggerENS_8InstanceELZNS_11sLuaDraggerEES2_E7CreatorC2Ev.
}
...
pub fn stub_f2d414() {
    // IDA 0xf2d414: Thumb import jump veneer for `j___ZN3RBX4Name9doDeclareILZNS_11sLuaDraggerEEEERKS0_v` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX4Name9doDeclareILZNS_11sLuaDraggerEEEERKS0_v.
}
...
pub fn stub_f2d424() {
    // IDA 0xf2d424: Thumb import jump veneer for `j___ZN3RBX9CreatableINS_8InstanceEE6createINS_10LuaDraggerEEEN5boost10shared_ptrIT_EEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::LuaDragger> RBX::Creatable<RBX::Instance>::create<RBX::LuaDragger>(void).
}
...
pub fn stub_f2d434() {
    // IDA 0xf2d434: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX10LuaDraggerEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::LuaDragger>::shared_ptr<RBX::LuaDragger,RBX::Creatable<RBX::Instance>::Deleter>(RBX::LuaDragger *,RBX::Creatable<RBX::Instance>::Deleter).
}
...
pub fn stub_f2d444() {
    // IDA 0xf2d444: Thumb import jump veneer for `j___ZN5boost20dynamic_pointer_castIN3RBX12PartInstanceENS1_8InstanceEEENS_10shared_ptrIT_EERKNS4_IT0_EE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::PartInstance> boost::dynamic_pointer_cast<RBX::PartInstance,RBX::Instance>(boost::shared_ptr<RBX::Instance> const&).
}
...
pub fn stub_f2d454() {
    // IDA 0xf2d454: Thumb import jump veneer for `j___ZN5boost3_bi5list2INS_3argILi1EEENS0_5valueIPSt6vectorINS_8weak_ptrIN3RBX12PartInstanceEEESaIS9_EEEEEclIPFvNS_10shared_ptrINS7_8InstanceEEESC_ENS0_5list1IRKSI_EEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list2<boost::arg<1>,boost::_bi::value<std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>> *>>::operator()<void (*)(boost::shared_ptr<RBX::Instance>,std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>> *),boost::_bi::list1<boost::shared_ptr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(boost::shared_ptr<RBX::Instance>,std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>> *) &,boost::_bi::list1<boost::shared_ptr<RBX::Instance> const&> &,int).
}
...
pub fn stub_f2d474() {
    // IDA 0xf2d474: Thumb import jump veneer for `j___ZNK3RBX14FactoryProductINS_10LuaDraggerENS_8InstanceELZNS_11sLuaDraggerEES2_E7Creator12getClassNameEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZNK3RBX14FactoryProductINS_10LuaDraggerENS_8InstanceELZNS_11sLuaDraggerEES2_E7Creator12getClassNameEv.
}
...
pub fn stub_f2d494() {
    // IDA 0xf2d494: Thumb import jump veneer for `j___ZNSt6__copyILb0ESt26random_access_iterator_tagE4copyIPKN5boost8weak_ptrIN3RBX12PartInstanceEEEPS7_EET0_T_SC_SB_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::weak_ptr<RBX::PartInstance>* std::__copy<false,std::random_access_iterator_tag>::copy<boost::weak_ptr<RBX::PartInstance> const*,boost::weak_ptr<RBX::PartInstance>*>(boost::weak_ptr<RBX::PartInstance> const*,boost::weak_ptr<RBX::PartInstance> const*,boost::weak_ptr<RBX::PartInstance>*).
}
...
pub fn stub_f2d4a4() {
    // IDA 0xf2d4a4: Thumb import jump veneer for `j___ZNSt6__copyILb0ESt26random_access_iterator_tagE4copyIPN5boost8weak_ptrIN3RBX12PartInstanceEEES8_EET0_T_SA_S9_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::weak_ptr<RBX::PartInstance> * std::__copy<false,std::random_access_iterator_tag>::copy<boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *>(boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *).
}
...
pub fn stub_f2d4d4() {
    // IDA 0xf2d4d4: Thumb import jump veneer for `j___ZNSt6vectorIN5boost8weak_ptrIN3RBX12PartInstanceEEESaIS4_EEaSERKS6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::operator=(std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>> const&).
}

// 0xf2d4e4 — j___ZNSt8auto_ptrIN3RBX10RunDraggerEE5resetEPS1_
#[doc(alias = "std::auto_ptr<RBX::RunDragger>::reset(RBX::RunDragger*)")]
pub fn stub_f2d4e4() {
    // IDA 0xf2d4e4: Thumb import jump veneer for `j___ZNSt8auto_ptrIN3RBX10RunDraggerEE5resetEPS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::auto_ptr<RBX::RunDragger>::reset(RBX::RunDragger*).
}
...
pub fn stub_f2d524() {
    // IDA 0xf2d524: Thumb import jump veneer for `j___ZN3RBX11shared_fromINS_11LuaDragToolEEEN5boost10shared_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::LuaDragTool> RBX::shared_from<RBX::LuaDragTool>(RBX::LuaDragTool*).
}
...
pub fn stub_f2d534() {
    // IDA 0xf2d534: Thumb import jump veneer for `j___ZN3RBX4Name9doDeclareILZNS_12sLuaDragToolEEEERKS0_v` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX4Name9doDeclareILZNS_12sLuaDragToolEEEERKS0_v.
}
...
pub fn stub_f2d544() {
    // IDA 0xf2d544: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX10LuaDraggerEEaSERKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::LuaDragger>::operator=(boost::shared_ptr<RBX::LuaDragger> const&).
}
...
pub fn stub_f2d554() {
    // IDA 0xf2d554: Thumb import jump veneer for `j___ZN3RBX11shared_fromINS_18MoveResizeJoinToolEEEN5boost10shared_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::MoveResizeJoinTool> RBX::shared_from<RBX::MoveResizeJoinTool>(RBX::MoveResizeJoinTool*).
}
...
pub fn stub_f2d564() {
    // IDA 0xf2d564: Thumb import jump veneer for `j___ZN3RBX11shared_fromINS_11NewNullToolEEEN5boost10shared_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::NewNullTool> RBX::shared_from<RBX::NewNullTool>(RBX::NewNullTool*).
}
...
pub fn stub_f2d574() {
    // IDA 0xf2d574: Thumb import jump veneer for `j___ZN3RBX11shared_fromINS_8NullToolEEEN5boost10shared_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::NullTool> RBX::shared_from<RBX::NullTool>(RBX::NullTool*).
}
...
pub fn stub_f2d584() {
    // IDA 0xf2d584: Thumb import jump veneer for `j___ZN3RBX4Name9doDeclareILZNS_12sNewNullToolEEEERKS0_v` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX4Name9doDeclareILZNS_12sNewNullToolEEEERKS0_v.
}
...
pub fn stub_f2d594() {
    // IDA 0xf2d594: Thumb import jump veneer for `j___ZN3RBX11MegaDragger12getMousePartEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::MegaDragger::getMousePart(void).
}
...
pub fn stub_f2d5a4() {
    // IDA 0xf2d5a4: Thumb import jump veneer for `j___ZN3RBX11shared_fromINS_12PartDragToolEEEN5boost10shared_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::PartDragTool> RBX::shared_from<RBX::PartDragTool>(RBX::PartDragTool*).
}
...
pub fn stub_f2d5b4() {
    // IDA 0xf2d5b4: Thumb import jump veneer for `j___ZN3RBX4Name9doDeclareILZNS_13sPartDragToolEEEERKS0_v` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX4Name9doDeclareILZNS_13sPartDragToolEEEERKS0_v.
}

// 0xf2d5c4 — j___ZN3G3D5ArrayImLi10ELm32EE6appendERKm
#[doc(alias = "G3D::Array<unsigned long,10,32ul>::append(unsigned long const&)")]
pub fn stub_f2d5c4() {
    // IDA 0xf2d5c4: Thumb import jump veneer for `j___ZN3G3D5ArrayImLi10ELm32EE6appendERKm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<unsigned long,10,32ul>::append(unsigned long const&).
}

// 0xf2d5d4 — j___ZN3G3D5ArrayImLi10ELm32EE6resizeEib
#[doc(alias = "G3D::Array<unsigned long,10,32ul>::resize(int,bool)")]
pub fn stub_f2d5d4() {
    // IDA 0xf2d5d4: Thumb import jump veneer for `j___ZN3G3D5ArrayImLi10ELm32EE6resizeEib` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<unsigned long,10,32ul>::resize(int,bool).
}

// 0xf2d5e4 — j___ZN3G3D5ArrayImLi10ELm32EE7reallocEi
#[doc(alias = "G3D::Array<unsigned long,10,32ul>::realloc(int)")]
pub fn stub_f2d5e4() {
    // IDA 0xf2d5e4: Thumb import jump veneer for `j___ZN3G3D5ArrayImLi10ELm32EE7reallocEi` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<unsigned long,10,32ul>::realloc(int).
}

// 0xf2d5f4 — j___ZN3G3D5ArrayImLi10ELm32EEC2Ev
#[doc(alias = "G3D::Array<unsigned long,10,32ul>::Array(void)")]
pub fn stub_f2d5f4() {
    // IDA 0xf2d5f4: Thumb import jump veneer for `j___ZN3G3D5ArrayImLi10ELm32EEC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<unsigned long,10,32ul>::Array(void).
}
...
pub fn stub_f2d614() {
    // IDA 0xf2d614: Thumb import jump veneer for `j___ZN3RBX11shared_fromINS_17FilteredSelectionINS_8InstanceEEEEEN5boost10shared_ptrIT_EEPS6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>> RBX::shared_from<RBX::FilteredSelection<RBX::Instance>>(RBX::FilteredSelection<RBX::Instance>*).
}
...
pub fn stub_f2d624() {
    // IDA 0xf2d624: Thumb import jump veneer for `j___ZN3RBX15ServiceProvider6createINS_17FilteredSelectionINS_8InstanceEEEEEPT_PKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::FilteredSelection<RBX::Instance> * RBX::ServiceProvider::create<RBX::FilteredSelection<RBX::Instance>>(RBX::Instance const*).
}
...
pub fn stub_f2d634() {
    // IDA 0xf2d634: Thumb import jump veneer for `j___ZN3RBX4Name9doDeclareILZNS_17sBoxSelectCommandEEEERKS0_v` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN3RBX4Name9doDeclareILZNS_17sBoxSelectCommandEEEERKS0_v.
}
...
pub fn stub_f2d644() {
    // IDA 0xf2d644: Thumb import jump veneer for `j___ZN3RBX8Instance15queryTypedChildINS_10SelectableEEEPT_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selectable * RBX::Instance::queryTypedChild<RBX::Selectable>(int).
}
...
pub fn stub_f2d654() {
    // IDA 0xf2d654: Thumb import jump veneer for `j___ZN3RBX9CreatableINS_12MouseCommandEE6createINS_16BoxSelectCommandEPNS_9WorkspaceEEEN5boost10shared_ptrIT_EET0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::BoxSelectCommand> RBX::Creatable<RBX::MouseCommand>::create<RBX::BoxSelectCommand,RBX::Workspace *>(RBX::Workspace *).
}
...
pub fn stub_f2d664() {
    // IDA 0xf2d664: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX16BoxSelectCommandEEC2IS2_NS1_9CreatableINS1_12MouseCommandEE7DeleterEEEPT_T0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::BoxSelectCommand>::shared_ptr<RBX::BoxSelectCommand,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::BoxSelectCommand *,RBX::Creatable<RBX::MouseCommand>::Deleter).
}
...
pub fn stub_f2d674() {
    // IDA 0xf2d674: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX17FilteredSelectionINS1_8InstanceEEEEaSERKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>>::operator=(boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>> const&).
}
...
pub fn stub_f2d694() {
    // IDA 0xf2d694: Thumb import jump veneer for `j___ZNK3RBX13ServiceClientINS_17FilteredSelectionINS_8InstanceEEEE13createServiceEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::ServiceClient<RBX::FilteredSelection<RBX::Instance>>::createService(void)const.
}
...
pub fn stub_f2d6a4() {
    // IDA 0xf2d6a4: Thumb import jump veneer for `j___ZNK3RBX9Selection10isSelectedEPKNS_8InstanceE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::isSelected(RBX::Instance const*)const.
}
...
pub fn stub_f2d6c4() {
    // IDA 0xf2d6c4: Thumb import jump veneer for `j___ZNSt6__copyILb0ESt26bidirectional_iterator_tagE4copyISt23_Rb_tree_const_iteratorIN5boost10shared_ptrIN3RBX8InstanceEEEENS6_9Selection11AddIteratorEEET0_T_SD_SC_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::AddIterator std::__copy<false,std::bidirectional_iterator_tag>::copy<std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::AddIterator>(std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::AddIterator).
}
...
pub fn stub_f2d6d4() {
    // IDA 0xf2d6d4: Thumb import jump veneer for `j___ZNSt6__copyILb0ESt26bidirectional_iterator_tagE4copyISt23_Rb_tree_const_iteratorIN5boost10shared_ptrIN3RBX8InstanceEEEENS6_9Selection14RemoveIteratorEEET0_T_SD_SC_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::RemoveIterator std::__copy<false,std::bidirectional_iterator_tag>::copy<std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::RemoveIterator>(std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::RemoveIterator).
}
...
pub fn stub_f2d6e4() {
    // IDA 0xf2d6e4: Thumb import jump veneer for `j___ZNSt6__copyILb0ESt26bidirectional_iterator_tagE4copyISt23_Rb_tree_const_iteratorIN5boost10shared_ptrIN3RBX8InstanceEEEENS6_9Selection14ToggleIteratorEEET0_T_SD_SC_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::ToggleIterator std::__copy<false,std::bidirectional_iterator_tag>::copy<std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::ToggleIterator>(std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::ToggleIterator).
}
...
pub fn stub_f2d714() {
    // IDA 0xf2d714: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN5boost10shared_ptrIN3RBX8InstanceEEES4_St9_IdentityIS4_ESt4lessIS4_ESaIS4_EE16_M_insert_uniqueERKS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>,std::_Identity<boost::shared_ptr<RBX::Instance>>,std::less<boost::shared_ptr<RBX::Instance>>,std::allocator<boost::shared_ptr<RBX::Instance>>>::_M_insert_unique(boost::shared_ptr<RBX::Instance> const&).
}
...
pub fn stub_f2d724() {
    // IDA 0xf2d724: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN5boost10shared_ptrIN3RBX8InstanceEEES4_St9_IdentityIS4_ESt4lessIS4_ESaIS4_EE7_M_copyEPKSt13_Rb_tree_nodeIS4_EPSC_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>,std::_Identity<boost::shared_ptr<RBX::Instance>>,std::less<boost::shared_ptr<RBX::Instance>>,std::allocator<boost::shared_ptr<RBX::Instance>>>::_M_copy(std::_Rb_tree_node<boost::shared_ptr<RBX::Instance>> const*,std::_Rb_tree_node<boost::shared_ptr<RBX::Instance>>*).
}
...
pub fn stub_f2d744() {
    // IDA 0xf2d744: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN5boost10shared_ptrIN3RBX8InstanceEEES4_St9_IdentityIS4_ESt4lessIS4_ESaIS4_EE9_M_insertEPSt18_Rb_tree_node_baseSC_RKS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>,std::_Identity<boost::shared_ptr<RBX::Instance>>,std::less<boost::shared_ptr<RBX::Instance>>,std::allocator<boost::shared_ptr<RBX::Instance>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,boost::shared_ptr<RBX::Instance> const&).
}
...
pub fn stub_f2d754() {
    // IDA 0xf2d754: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN5boost10shared_ptrIN3RBX8InstanceEEES4_St9_IdentityIS4_ESt4lessIS4_ESaIS4_EEaSERKSA_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>,std::_Identity<boost::shared_ptr<RBX::Instance>>,std::less<boost::shared_ptr<RBX::Instance>>,std::allocator<boost::shared_ptr<RBX::Instance>>>::operator=(std::_Rb_tree<boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>,std::_Identity<boost::shared_ptr<RBX::Instance>>,std::less<boost::shared_ptr<RBX::Instance>>,std::allocator<boost::shared_ptr<RBX::Instance>>> const&).
}
...
pub fn stub_f2d764() {
    // IDA 0xf2d764: Thumb import jump veneer for `j___ZSt14set_differenceISt23_Rb_tree_const_iteratorIN5boost10shared_ptrIN3RBX8InstanceEEEES6_NS3_9Selection11AddIteratorEET1_T_SA_T0_SB_S9_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::AddIterator std::set_difference<std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::AddIterator>(std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::AddIterator).
}
...
pub fn stub_f2d774() {
    // IDA 0xf2d774: Thumb import jump veneer for `j___ZSt14set_differenceISt23_Rb_tree_const_iteratorIN5boost10shared_ptrIN3RBX8InstanceEEEES6_NS3_9Selection14RemoveIteratorEET1_T_SA_T0_SB_S9_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::RemoveIterator std::set_difference<std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::RemoveIterator>(std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::RemoveIterator).
}
...
pub fn stub_f2d784() {
    // IDA 0xf2d784: Thumb import jump veneer for `j___ZSt14set_differenceISt23_Rb_tree_const_iteratorIN5boost10shared_ptrIN3RBX8InstanceEEEES6_NS3_9Selection14ToggleIteratorEET1_T_SA_T0_SB_S9_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Selection::ToggleIterator std::set_difference<std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::ToggleIterator>(std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,std::_Rb_tree_const_iterator<boost::shared_ptr<RBX::Instance>>,RBX::Selection::ToggleIterator).
}
...
pub fn stub_f2d794() {
    // IDA 0xf2d794: Thumb import jump veneer for `j___ZSt6__findIN9__gnu_cxx17__normal_iteratorIPKN5boost10shared_ptrIN3RBX8InstanceEEESt6vectorIS6_SaIS6_EEEENS3_IKS5_EEET_SF_SF_RKT0_St26random_access_iterator_tag` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: __gnu_cxx::__normal_iterator<boost::shared_ptr<RBX::Instance> const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>> std::__find<__gnu_cxx::__normal_iterator<boost::shared_ptr<RBX::Instance> const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>,boost::shared_ptr<RBX::Instance const>>(__gnu_cxx::__normal_iterator<boost::shared_ptr<RBX::Instance> const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>,__gnu_cxx::__normal_iterator<boost::shared_ptr<RBX::Instance> const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>,boost::shared_ptr<RBX::Instance const> const&,std::random_access_iterator_tag).
}
...
pub fn stub_f2d7a4() {
    // IDA 0xf2d7a4: Thumb import jump veneer for `j___ZN3RBX10Reflection8EnumDescINS_6Action10ActionTypeEE7addPairES3_PKc` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::EnumDesc<RBX::Action::ActionType>::addPair(RBX::Action::ActionType,char const*).
}
...
pub fn stub_f2d7b4() {
    // IDA 0xf2d7b4: Thumb import jump veneer for `j___ZNSt12_Vector_baseIN3RBX6Action10ActionTypeESaIS2_EE11_M_allocateEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Vector_base<RBX::Action::ActionType,std::allocator<RBX::Action::ActionType>>::_M_allocate(unsigned long).
}
...
pub fn stub_f2d7c4() {
    // IDA 0xf2d7c4: Thumb import jump veneer for `j___ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX6Action10ActionTypeES6_EET0_T_S8_S7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Action::ActionType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::Action::ActionType *,RBX::Action::ActionType *>(RBX::Action::ActionType *,RBX::Action::ActionType *,RBX::Action::ActionType *).
}
...
pub fn stub_f2d7d4() {
    // IDA 0xf2d7d4: Thumb import jump veneer for `j___ZNSt3mapIPKN3RBX4NameENS0_6Action10ActionTypeESt4lessIS3_ESaISt4pairIKS3_S5_EEEixERS9_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::map<RBX::Name const*,RBX::Action::ActionType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Action::ActionType>>>::operator[](RBX::Name const* const&).
}
...
pub fn stub_f2d7e4() {
    // IDA 0xf2d7e4: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX6Action10ActionTypeESaIS2_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS2_S4_EERKS2_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::Action::ActionType,std::allocator<RBX::Action::ActionType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::Action::ActionType*,std::vector<RBX::Action::ActionType,std::allocator<RBX::Action::ActionType>>>,RBX::Action::ActionType const&).
}
