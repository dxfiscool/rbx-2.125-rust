//! audio generated_audio_watchdog_k — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio exhausted, global gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x544a54..0x549954 | existing 30813 -> 30913 distinct
...
// demangled: RBX::GuiService::getUseLuaChat(void)const
...
pub fn stub_544a54() -> ! {
    todo!("0x544a54 __ZNK3RBX10GuiService13getUseLuaChatEv")
}
...
pub fn stub_544a5c() {
    // IDA 0x544a5c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544a80() {
    // IDA 0x544a80: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544aa4() {
    // IDA 0x544aa4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544ae4() {
    // IDA 0x544ae4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544b24() {
    // IDA 0x544b24: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544b48() {
    // IDA 0x544b48: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544b4c() {
    // IDA 0x544b4c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544b50() {
    // IDA 0x544b50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_544c44() {
    // IDA 0x544c44: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x544ca0 — __ZNK3RBX10GuiService23getShowLegacyPlayerListEv
// demangled: RBX::GuiService::getShowLegacyPlayerList(void)const
// type: _DWORD __fastcall(RBX::GuiService *__hidden this)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::addPair(RBX::GuiService::SpecialKey,char const*)
...
// demangled: RBX::GuiService::SpecialKey & RBX::Reflection::Variant::genericConvert<RBX::GuiService::SpecialKey>(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::addPair(RBX::GuiService::CenterDialogType,char const*)
...
// demangled: RBX::GuiService::CenterDialogType & RBX::Reflection::Variant::genericConvert<RBX::GuiService::CenterDialogType>(void)
...
// demangled: RBX::CoreGuiService * RBX::ServiceProvider::create<RBX::CoreGuiService>(RBX::Instance const*)
...
// demangled: std::map<RBX::GuiService::CenterDialogType,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::operator[](RBX::GuiService::CenterDialogType const&)
...
// demangled: boost::weak_ptr<RBX::GuiObject> RBX::weak_from<RBX::GuiObject>(RBX::GuiObject*)
...
// demangled: boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list_av_3<boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool>::type> boost::bind<void,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool>(void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool)
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list_av_3<rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool>::type> boost::bind<void,rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool,rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool>(void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool)")]
...
pub fn stub_545c48() {
    // IDA 0x545c48: weak_ptr ctor/assign. Weak::from(&Arc) at construction — carrier no-op.
}
...
// demangled: std::map<boost::weak_ptr<RBX::GuiObject>,RBX::GuiService::DialogWrapper *,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::operator[](boost::weak_ptr<RBX::GuiObject> const&)
...
// demangled: boost::_bi::bind_t<boost::_bi::unspecified,boost::function<void ()(void)>,boost::_bi::list0> boost::bind<boost::function<void ()(void)>>(boost::function<void ()(void)>)
...
// demangled: std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>::remove(RBX::GuiService::DialogWrapper * const&)
...
// demangled: rbx::signals::signal_with_args<2,void ()(RBX::GuiService::SpecialKey,std::string)>::operator()(RBX::GuiService::SpecialKey,std::string)
...
// demangled: rbx::signals::signal_with_args<2,void ()(std::string,std::string)>::operator()(std::string,std::string)
...
// demangled: boost::shared_ptr<RBX::NotificationObject> RBX::Creatable<RBX::Instance>::create<RBX::NotificationObject>(void)
...
// demangled: boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list_av_2<boost::weak_ptr<RBX::NotificationObject>,RBX::Lua::WeakFunctionRef>::type> boost::bind<void,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::weak_ptr<RBX::NotificationObject>,RBX::Lua::WeakFunctionRef>(void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::weak_ptr<RBX::NotificationObject>,RBX::Lua::WeakFunctionRef)
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list_av_2<rbx_core::Weak<RBX::NotificationObject>,RBX::Lua::WeakFunctionRef>::type> boost::bind<void,rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,rbx_core::Weak<RBX::NotificationObject>,RBX::Lua::WeakFunctionRef>(void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),rbx_core::Weak<RBX::NotificationObject>,RBX::Lua::WeakFunctionRef)")]
...
pub fn stub_5465b8() {
    // IDA 0x5465b8: weak_ptr ctor/assign. Weak::from(&Arc) at construction — carrier no-op.
}

// 0x54678c — __ZN3RBX9weak_fromINS_18NotificationObjectEEEN5boost8weak_ptrIT_EEPS4_
// demangled: boost::weak_ptr<RBX::NotificationObject> RBX::weak_from<RBX::NotificationObject>(RBX::NotificationObject*)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::~EnumDesc()
...
pub fn stub_546994() {
    // IDA 0x546994: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_546998() {
    // IDA 0x546998: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x546a38 — __ZNK3RBX10Reflection8EnumDescINS_10GuiService10SpecialKeyEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::~EnumDesc()
...
pub fn stub_546c00() {
    // IDA 0x546c00: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_546c04() {
    // IDA 0x546c04: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x546ca4 — __ZNK3RBX10Reflection8EnumDescINS_10GuiService16CenterDialogTypeEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::GuiService::~GuiService()
...
// demangled: std::_Rb_tree<RBX::GuiService::SpecialKey,RBX::GuiService::SpecialKey,std::_Identity<RBX::GuiService::SpecialKey>,std::less<RBX::GuiService::SpecialKey>,std::allocator<RBX::GuiService::SpecialKey>>::_M_erase(std::_Rb_tree_node<RBX::GuiService::SpecialKey> *)
...
pub fn stub_547484() {
    // IDA 0x547484: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x5474ac — __ZNK3RBX10Reflection8EnumDescINS_10GuiService16CenterDialogTypeEE15convertToStringERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::convertToString(RBX::GuiService::CenterDialogType const&)const
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::GuiService::CenterDialogType>(RBX::GuiService::CenterDialogType const&)
...
// demangled: rbx::implementation::typed_holder<RBX::GuiService::CenterDialogType>::singleton(void)
...
// demangled: rbx::implementation::typed_holder<RBX::GuiService::CenterDialogType>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::convertToItem(RBX::GuiService::CenterDialogType const&)const
...
// demangled: RBX::GuiService::CenterDialogType const& rbx::any_cast<RBX::GuiService::CenterDialogType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::convertToValue(RBX::Name const&,RBX::GuiService::CenterDialogType&)const
...
pub fn stub_547950() {
    // IDA 0x547950: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x547b24 — __ZNK3RBX10Reflection8EnumDescINS_10GuiService10SpecialKeyEE15convertToStringERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToString(RBX::GuiService::SpecialKey const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::GuiService::SpecialKey>(RBX::GuiService::SpecialKey const&)
...
// demangled: rbx::implementation::typed_holder<RBX::GuiService::SpecialKey>::singleton(void)
...
// demangled: rbx::implementation::typed_holder<RBX::GuiService::SpecialKey>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToItem(RBX::GuiService::SpecialKey const&)const
...
// demangled: RBX::GuiService::SpecialKey const& rbx::any_cast<RBX::GuiService::SpecialKey const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToValue(RBX::Name const&,RBX::GuiService::SpecialKey&)const
...
pub fn stub_547fc8() {
    // IDA 0x547fc8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::detail::weak_count::weak_count(boost::detail::weak_count const&)
...
// demangled: void boost::function0<void>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>)
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, RBX::Lua::WeakFunctionRef *, int, int, int, int)
#[doc(alias = "void boost::function0<void>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>)")]
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
...
pub fn stub_548608() {
    // IDA 0x548608: functor_manager::manage dispatched clone/destroy on the erased buffer (IDA 0x2d644: op==4 clones via manager). Clone/Drop glue — no-op carrier.
}
...
// demangled: boost::detail::function::void_function_obj_invoker0<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>,void>::invoke(boost::detail::function::function_buffer &)
#[doc(alias = "boost::detail::function::void_function_obj_invoker0<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>,void>::invoke(boost::detail::function::function_buffer &)")]
...
pub fn stub_548624() {
    // IDA 0x548624: invoker::invoke unpacked the buffer and called the bound functor. Closure call at the live site — carrier no-op.
}
...
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, RBX::Lua::WeakFunctionRef *, int, int, int, int)
#[doc(alias = "bool boost::detail::function::basic_vtable0<void>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>,boost::detail::function::function_buffer &)const")]
...
#[doc(alias = "void boost::detail::function::basic_vtable0<void>::assign_functor<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
// demangled: void boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::operator()<void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list0>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef) &,boost::_bi::list0 &,int)
// type: int __fastcall(int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "void boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::operator()<void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list0>(boost::_bi::type<void>,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef) &,boost::_bi::list0 &,int)")]
...
// demangled: boost::weak_ptr<RBX::GuiObject>::weak_ptr<RBX::NotificationObject>(boost::weak_ptr<RBX::NotificationObject> const&,boost::detail::sp_enable_if_convertible<RBX::NotificationObject,RBX::GuiObject>::type)
...
pub fn stub_548ae8() {
    // IDA 0x548ae8: weak_ptr ctor/assign. Weak::from(&Arc) at construction — carrier no-op.
}

// 0x548b18 — __ZN5boost10shared_ptrIN3RBX18NotificationObjectEEC2IS2_EERKNS_8weak_ptrIT_EENS_6detail14sp_nothrow_tagE
// demangled: boost::shared_ptr<RBX::NotificationObject>::shared_ptr<RBX::NotificationObject>(boost::weak_ptr<RBX::NotificationObject> const&,boost::detail::sp_nothrow_tag)
...
pub fn stub_548b18() {
    // IDA 0x548b18: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>>>::manager(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type,mpl_::bool_<false>)")]
...
pub fn stub_548b94() {
    // IDA 0x548b94: functor_manager::manage dispatched clone/destroy on the erased buffer (IDA 0x2d644: op==4 clones via manager). Clone/Drop glue — no-op carrier.
}
...
// demangled: boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::list2(boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>)
// type: int __fastcall(int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::list2(boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>)")]
...
pub fn stub_548d44() {
    // IDA 0x548d44: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
// demangled: boost::_bi::storage2<boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::storage2(boost::_bi::value<boost::weak_ptr<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>)
// type: int __fastcall(int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int)
#[doc(alias = "boost::_bi::storage2<boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::storage2(boost::_bi::value<rbx_core::Weak<RBX::NotificationObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>)")]
...
// demangled: boost::shared_ptr<RBX::NotificationObject>::shared_ptr<RBX::NotificationObject,RBX::Creatable<RBX::Instance>::Deleter>(RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter)
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::NotificationObject,RBX::NotificationObject>(boost::shared_ptr<RBX::NotificationObject> const*,RBX::NotificationObject *)const
...
pub fn stub_549014() {
    // IDA 0x549014: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}

// 0x5490fc — __ZN5boost6detail12shared_countC2IPN3RBX18NotificationObjectENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
// demangled: boost::detail::shared_count::shared_count<RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_5490fc() {
    // IDA 0x5490fc: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x549204 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX18NotificationObjectENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// demangled: boost::detail::sp_counted_impl_pd<RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
...
pub fn stub_549204() {
    // IDA 0x549204: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_549208() {
    // IDA 0x549208: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
pub fn stub_54920c() {
    // IDA 0x54920c: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
...
pub fn stub_54922c() {
    // IDA 0x54922c: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
...
pub fn stub_549244() {
    // IDA 0x549244: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x549368 — __ZNSt8_Rb_treeIN3RBX10GuiService10SpecialKeyES2_St9_IdentityIS2_ESt4lessIS2_ESaIS2_EE16_M_insert_uniqueERKS2_
// demangled: std::_Rb_tree<RBX::GuiService::SpecialKey,RBX::GuiService::SpecialKey,std::_Identity<RBX::GuiService::SpecialKey>,std::less<RBX::GuiService::SpecialKey>,std::allocator<RBX::GuiService::SpecialKey>>::_M_insert_unique(RBX::GuiService::SpecialKey const&)
...
// demangled: std::_Rb_tree<RBX::GuiService::SpecialKey,RBX::GuiService::SpecialKey,std::_Identity<RBX::GuiService::SpecialKey>,std::less<RBX::GuiService::SpecialKey>,std::allocator<RBX::GuiService::SpecialKey>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,RBX::GuiService::SpecialKey const&)
...
// demangled: std::_Rb_tree<char,char,std::_Identity<char>,std::less<char>,std::allocator<char>>::_M_insert_unique(char const&)
...
// demangled: std::_Rb_tree<char,char,std::_Identity<char>,std::less<char>,std::allocator<char>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,char const&)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::next(boost::intrusive_ptr<rbx::signals::signal<void ()(std::string,std::string)>::slot> &)
...
// demangled: rbx::signals::signal_with_args<2,void ()(std::string,std::string)>::fireItem(rbx::signals::signal<void ()(std::string,std::string)>::slot *,std::string,std::string)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::on_error(std::exception &)
...
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(std::string,std::string)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(std::string,std::string)>::slot> const&)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::safe_static_init_mutex(void)
// type: int()
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::safe_static_do_get_mutex(void)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::next(boost::intrusive_ptr<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot> &)
// type: int __fastcall(int, int, int, int, char, int, int, int, int, int)
