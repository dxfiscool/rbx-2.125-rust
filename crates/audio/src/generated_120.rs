//! audio generated_120 — next 100 stubs EA-sorted, from ida/export.json
...
//! Batch: 100 stubs | skeleton batch | range 0xf2de34..0xf2e464 EA-sorted asc filler after 0xf2de24, skip existing, rbx_core::SharedPtr not boost
...
pub fn stub_f2de34() {
    // IDA 0xf2de34: Thumb import jump veneer for `j___ZN3RBX10BrickColor8BrickMap18generatePaletteMapERSt3mapINS0_6NumberEiSt4lessIS3_ESaISt4pairIKS3_iEEESt6vectorIS0_SaIS0_EES3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::generatePaletteMap(std::map<RBX::BrickColor::Number,int,std::less<RBX::BrickColor::Number>,std::allocator<std::pair<RBX::BrickColor::Number const,int>>> &,std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>,RBX::BrickColor::Number).
}
...
pub fn stub_f2de44() {
    // IDA 0xf2de44: Thumb import jump veneer for `j___ZN3RBX10BrickColor8BrickMap18generatePaletteMapEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::generatePaletteMap(void).
}
...
pub fn stub_f2de54() {
    // IDA 0xf2de54: Thumb import jump veneer for `j___ZN3RBX10BrickColor8BrickMap32setRenderingSupportedPaletteSizeEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::setRenderingSupportedPaletteSize(unsigned long).
}
...
pub fn stub_f2de64() {
    // IDA 0xf2de64: Thumb import jump veneer for `j___ZN3RBX10BrickColor8BrickMap6insertENS0_6NumberEhhhSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::insert(RBX::BrickColor::Number,unsigned char,unsigned char,unsigned char,std::string).
}
...
pub fn stub_f2de74() {
    // IDA 0xf2de74: Thumb import jump veneer for `j___ZN3RBX10BrickColor8BrickMap9ColorInfoaSERKS2_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::ColorInfo::operator=(RBX::BrickColor::BrickMap::ColorInfo const&).
}
...
pub fn stub_f2de84() {
    // IDA 0xf2de84: Thumb import jump veneer for `j___ZN3RBX10BrickColor8BrickMapC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::BrickMap(void).
}
...
pub fn stub_f2dea4() {
    // IDA 0xf2dea4: Thumb import jump veneer for `j___ZNSt12_Vector_baseIN3RBX10BrickColor8BrickMap9ColorInfoESaIS3_EE11_M_allocateEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Vector_base<RBX::BrickColor::BrickMap::ColorInfo,std::allocator<RBX::BrickColor::BrickMap::ColorInfo>>::_M_allocate(unsigned long).
}
...
pub fn stub_f2deb4() {
    // IDA 0xf2deb4: Thumb import jump veneer for `j___ZNSt12_Vector_baseIN3RBX10BrickColorESaIS1_EE11_M_allocateEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Vector_base<RBX::BrickColor,std::allocator<RBX::BrickColor>>::_M_allocate(unsigned long).
}
...
pub fn stub_f2dec4() {
    // IDA 0xf2dec4: Thumb import jump veneer for `j___ZNSt12_Vector_baseIN3RBX10BrickColorESaIS1_EEC2EmRKS2_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Vector_base<RBX::BrickColor,std::allocator<RBX::BrickColor>>::_Vector_base(unsigned long,std::allocator<RBX::BrickColor> const&).
}
...
pub fn stub_f2ded4() {
    // IDA 0xf2ded4: Thumb import jump veneer for `j___ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX10BrickColor8BrickMap9ColorInfoES7_EET0_T_S9_S8_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor::BrickMap::ColorInfo * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::BrickColor::BrickMap::ColorInfo *,RBX::BrickColor::BrickMap::ColorInfo *>(RBX::BrickColor::BrickMap::ColorInfo *,RBX::BrickColor::BrickMap::ColorInfo *,RBX::BrickColor::BrickMap::ColorInfo *).
}
...
pub fn stub_f2dee4() {
    // IDA 0xf2dee4: Thumb import jump veneer for `j___ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX10BrickColorES5_EET0_T_S7_S6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::BrickColor * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::BrickColor *,RBX::BrickColor *>(RBX::BrickColor *,RBX::BrickColor *,RBX::BrickColor *).
}
...
pub fn stub_f2def4() {
    // IDA 0xf2def4: Thumb import jump veneer for `j___ZNSt3mapIN3RBX10BrickColor6NumberEiSt4lessIS2_ESaISt4pairIKS2_iEEEixERS6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::map<RBX::BrickColor::Number,int,std::less<RBX::BrickColor::Number>,std::allocator<std::pair<RBX::BrickColor::Number const,int>>>::operator[](RBX::BrickColor::Number const&).
}
...
pub fn stub_f2df04() {
    // IDA 0xf2df04: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColor8BrickMap9ColorInfoESaIS3_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS3_S5_EEmRKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor::BrickMap::ColorInfo,std::allocator<RBX::BrickColor::BrickMap::ColorInfo>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::BrickColor::BrickMap::ColorInfo*,std::vector<RBX::BrickColor::BrickMap::ColorInfo,std::allocator<RBX::BrickColor::BrickMap::ColorInfo>>>,unsigned long,RBX::BrickColor::BrickMap::ColorInfo const&).
}
...
pub fn stub_f2df14() {
    // IDA 0xf2df14: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColor8BrickMap9ColorInfoESaIS3_EE6resizeEmS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor::BrickMap::ColorInfo,std::allocator<RBX::BrickColor::BrickMap::ColorInfo>>::resize(unsigned long,RBX::BrickColor::BrickMap::ColorInfo).
}
...
pub fn stub_f2df34() {
    // IDA 0xf2df34: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColorESaIS1_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS1_S3_EERKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::BrickColor*,std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>>,RBX::BrickColor const&).
}
...
pub fn stub_f2df44() {
    // IDA 0xf2df44: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColorESaIS1_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS1_S3_EEmRKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::BrickColor*,std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>>,unsigned long,RBX::BrickColor const&).
}
...
pub fn stub_f2df54() {
    // IDA 0xf2df54: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColorESaIS1_EE6resizeEmS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>::resize(unsigned long,RBX::BrickColor).
}
...
pub fn stub_f2df64() {
    // IDA 0xf2df64: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColorESaIS1_EE9push_backERKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>::push_back(RBX::BrickColor const&).
}
...
pub fn stub_f2df74() {
    // IDA 0xf2df74: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX10BrickColorESaIS1_EEC2ERKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>>::vector(std::vector<RBX::BrickColor,std::allocator<RBX::BrickColor>> const&).
}
...
pub fn stub_f2df84() {
    // IDA 0xf2df84: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN3RBX10BrickColor6NumberESt4pairIKS2_iESt10_Select1stIS5_ESt4lessIS2_ESaIS5_EE16_M_insert_uniqueERKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<RBX::BrickColor::Number,std::pair<RBX::BrickColor::Number const,int>,std::_Select1st<std::pair<RBX::BrickColor::Number const,int>>,std::less<RBX::BrickColor::Number>,std::allocator<std::pair<RBX::BrickColor::Number const,int>>>::_M_insert_unique(std::pair<RBX::BrickColor::Number const,int> const&).
}
...
pub fn stub_f2df94() {
    // IDA 0xf2df94: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN3RBX10BrickColor6NumberESt4pairIKS2_iESt10_Select1stIS5_ESt4lessIS2_ESaIS5_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS5_ERKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<RBX::BrickColor::Number,std::pair<RBX::BrickColor::Number const,int>,std::_Select1st<std::pair<RBX::BrickColor::Number const,int>>,std::less<RBX::BrickColor::Number>,std::allocator<std::pair<RBX::BrickColor::Number const,int>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::BrickColor::Number const,int>>,std::pair<RBX::BrickColor::Number const,int> const&).
}
...
pub fn stub_f2dfa4() {
    // IDA 0xf2dfa4: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_f2dfb4() {
    // IDA 0xf2dfb4: Thumb import jump veneer for `j___ZNSt8_Rb_treeIN3RBX10BrickColor6NumberESt4pairIKS2_iESt10_Select1stIS5_ESt4lessIS2_ESaIS5_EE9_M_insertEPSt18_Rb_tree_node_baseSD_RKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<RBX::BrickColor::Number,std::pair<RBX::BrickColor::Number const,int>,std::_Select1st<std::pair<RBX::BrickColor::Number const,int>>,std::less<RBX::BrickColor::Number>,std::allocator<std::pair<RBX::BrickColor::Number const,int>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::BrickColor::Number const,int> const&).
}
...
pub fn stub_f2dfc4() {
    // IDA 0xf2dfc4: Thumb import jump veneer for `j___ZSt26__uninitialized_fill_n_auxIPN3RBX10BrickColor8BrickMap9ColorInfoEmS3_EvT_T0_RKT1_St12__false_type` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void std::__uninitialized_fill_n_aux<RBX::BrickColor::BrickMap::ColorInfo *,unsigned long,RBX::BrickColor::BrickMap::ColorInfo>(RBX::BrickColor::BrickMap::ColorInfo *,unsigned long,RBX::BrickColor::BrickMap::ColorInfo const&,std::__false_type).
}
...
pub fn stub_f2dfd4() {
    // IDA 0xf2dfd4: Thumb import jump veneer for `j___ZSt4fillIPN3RBX10BrickColor8BrickMap9ColorInfoES3_EvT_S5_RKT0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void std::fill<RBX::BrickColor::BrickMap::ColorInfo *,RBX::BrickColor::BrickMap::ColorInfo>(RBX::BrickColor::BrickMap::ColorInfo *,RBX::BrickColor::BrickMap::ColorInfo *,RBX::BrickColor::BrickMap::ColorInfo const&).
}

// 0xf2dfe4 — j___ZN3RBX13CameraSubject23cameraPointFromDistanceERKN3G3D7Vector3ES4_f
// type: _DWORD *__fastcall(_DWORD *this, const Vector3 *, const Vector3 *, float32_t)
#[doc(alias = "RBX::CameraSubject::cameraPointFromDistance(G3D::Vector3 const&,G3D::Vector3 const&,float)")]
pub fn stub_f2dfe4() {
    // IDA 0xf2dfe4: Thumb import jump veneer for `j___ZN3RBX13CameraSubject23cameraPointFromDistanceERKN3G3D7Vector3ES4_f` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::CameraSubject::cameraPointFromDistance(G3D::Vector3 const&,G3D::Vector3 const&,float).
}
...
pub fn stub_f2dff4() {
    // IDA 0xf2dff4: Thumb import jump veneer for `j___ZN3RBX10Reflection11Call1HelperINS_13ContentFilterEMS2_FvSsESsvE4callEPS2_S4_RNS0_7VariantERKSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::Call1Helper<RBX::ContentFilter,void (RBX::ContentFilter::*)(std::string),std::string,void>::call(RBX::ContentFilter*,void (RBX::ContentFilter::*)(std::string),RBX::Reflection::Variant &,std::string const&).
}
...
pub fn stub_f2e004() {
    // IDA 0xf2e004: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_13ContentFilterEFvSsELi1EE16declareSignatureEPKcNS0_7VariantE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::ContentFilter,void ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant).
}
...
pub fn stub_f2e014() {
    // IDA 0xf2e014: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_13ContentFilterEFvSsELi1EEC2EMS2_FvSsEPKcS8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::ContentFilter,void ()(std::string),1>::BoundFuncDesc(void (RBX::ContentFilter::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes).
}
...
pub fn stub_f2e024() {
    // IDA 0xf2e024: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_13ContentFilterEFviiELi2EE16declareSignatureEPKcNS0_7VariantES6_S7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::ContentFilter,void ()(int,int),2>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant).
}
...
pub fn stub_f2e034() {
    // IDA 0xf2e034: Thumb import jump veneer for `j___ZN3RBX10Reflection13BoundFuncDescINS_13ContentFilterEFviiELi2EEC2EMS2_FviiEPKcS8_S8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::BoundFuncDesc<RBX::ContentFilter,void ()(int,int),2>::BoundFuncDesc(void (RBX::ContentFilter::*)(int,int),char const*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes).
}
...
pub fn stub_f2e044() {
    // IDA 0xf2e044: Thumb import jump veneer for `j___ZN3RBX9weak_fromINS_13ContentFilterEEEN5boost8weak_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::weak_ptr<RBX::ContentFilter> RBX::weak_from<RBX::ContentFilter>(RBX::ContentFilter*).
}
...
pub fn stub_f2e054() {
    // IDA 0xf2e054: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX13ContentFilterEEC2IS2_EERKNS_8weak_ptrIT_EENS_6detail14sp_nothrow_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::ContentFilter>::shared_ptr<RBX::ContentFilter>(boost::weak_ptr<RBX::ContentFilter> const&,boost::detail::sp_nothrow_tag).
}

// 0xf2e064 — j___ZN5boost3_bi5list2INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEEEC2ES7_S8_
// type: int __fastcall(rbx_core::detail::sp_counted_base *)
...
// 0xf2e074 — j___ZN5boost3_bi5list2INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEEEclIPFvS6_SsENS0_5list1IRPNS4_9DataModelEEEEEvNS0_4typeIvEERT_RT0_i
// type: int()
...
pub fn stub_f2e074() {
    // IDA 0xf2e074: Thumb import jump veneer for `j___ZN5boost3_bi5list2INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEEEclIPFvS6_SsENS0_5list1IRPNS4_9DataModelEEEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>::operator()<void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list1<RBX::DataModel *&>>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string) &,boost::_bi::list1<RBX::DataModel *&> &,int).
}
...
// 0xf2e094 — j___ZN5boost3_bi5list3INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEENS2_IbEEEclIPFvS6_SsbENS0_5list1IRPNS4_9DataModelEEEEEvNS0_4typeIvEERT_RT0_i
// type: int()
...
pub fn stub_f2e094() {
    // IDA 0xf2e094: Thumb import jump veneer for `j___ZN5boost3_bi5list3INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEENS2_IbEEEclIPFvS6_SsbENS0_5list1IRPNS4_9DataModelEEEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>::operator()<void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list1<RBX::DataModel *&>>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool) &,boost::_bi::list1<RBX::DataModel *&> &,int).
}
...
pub fn stub_f2e0b4() {
    // IDA 0xf2e0b4: Thumb import jump veneer for `j___ZN5boost3_bi5list4INS_3argILi1EEENS2_ILi2EEENS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS5_ISsEEEclIPFvPSsPSt9exceptionS9_SsENS0_5list2IRSE_RSG_EEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>::operator()<void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<std::string *&,std::exception *&>>(boost::_bi::type<void>,void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string) &,boost::_bi::list2<std::string *&,std::exception *&> &,int).
}

// 0xf2e0c4 — j___ZN5boost3_bi8storage2INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEEEC2ES7_S8_
// type: int *__fastcall(int *, int *, const std::string *, int, int, rbx_core::detail::sp_counted_base *, int, int, int, int)
...
pub fn stub_f2e0c4() {
    // IDA 0xf2e0c4: Thumb import jump veneer for `j___ZN5boost3_bi8storage2INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEEEC2ES7_S8_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>::storage2(boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>).
}

// 0xf2e0d4 — j___ZN5boost3_bi8storage3INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEENS2_IbEEEC2ES7_S8_S9_
// type: int __fastcall(rbx_core::detail::sp_counted_base *, int, int, int)
...
pub fn stub_f2e0d4() {
    // IDA 0xf2e0d4: Thumb import jump veneer for `j___ZN5boost3_bi8storage3INS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS2_ISsEENS2_IbEEEC2ES7_S8_S9_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>::storage3(boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>).
}
...
// type: int __fastcall(int, int, int, int, int, rbx_core::detail::sp_counted_base *, int, int, int, int)
...
pub fn stub_f2e0e4() {
    // IDA 0xf2e0e4: Thumb import jump veneer for `j___ZN5boost3_bi8storage4INS_3argILi1EEENS2_ILi2EEENS0_5valueINS_8weak_ptrIN3RBX13ContentFilterEEEEENS5_ISsEEEC2ES3_S4_SA_SB_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>::storage4(boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>).
}
...
pub fn stub_f2e0f4() {
    // IDA 0xf2e0f4: Thumb import jump veneer for `j___ZN5boost4bindIvNS_8weak_ptrIN3RBX13ContentFilterEEESsS4_SsEENS_3_bi6bind_tIT_PFS7_T0_T1_ENS5_9list_av_2IT2_T3_E4typeEEESB_SD_SE_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list_av_2<boost::weak_ptr<RBX::ContentFilter>,std::string>::type> boost::bind<void,boost::weak_ptr<RBX::ContentFilter>,std::string,boost::weak_ptr<RBX::ContentFilter>,std::string>(void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::weak_ptr<RBX::ContentFilter>,std::string).
}
...
pub fn stub_f2e104() {
    // IDA 0xf2e104: Thumb import jump veneer for `j___ZN5boost4bindIvNS_8weak_ptrIN3RBX13ContentFilterEEESsbS4_SsbEENS_3_bi6bind_tIT_PFS7_T0_T1_T2_ENS5_9list_av_3IT3_T4_T5_E4typeEEESC_SE_SF_SG_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list_av_3<boost::weak_ptr<RBX::ContentFilter>,std::string,bool>::type> boost::bind<void,boost::weak_ptr<RBX::ContentFilter>,std::string,bool,boost::weak_ptr<RBX::ContentFilter>,std::string,bool>(void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::weak_ptr<RBX::ContentFilter>,std::string,bool).
}
...
pub fn stub_f2e114() {
    // IDA 0xf2e114: Thumb import jump veneer for `j___ZN5boost4bindIvPSsPSt9exceptionNS_8weak_ptrIN3RBX13ContentFilterEEESsNS_3argILi1EEENS8_ILi2EEES7_SsEENS_3_bi6bind_tIT_PFSD_T0_T1_T2_T3_ENSB_9list_av_4IT4_T5_T6_T7_E4typeEEESJ_SL_SM_SN_SO_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list_av_4<boost::arg<1>,boost::arg<2>,boost::weak_ptr<RBX::ContentFilter>,std::string>::type> boost::bind<void,std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string,boost::arg<1>,boost::arg<2>,boost::weak_ptr<RBX::ContentFilter>,std::string>(void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::arg<1>,boost::arg<2>,boost::weak_ptr<RBX::ContentFilter>,std::string).
}
...
pub fn stub_f2e154() {
    // IDA 0xf2e154: Thumb import jump veneer for `j___ZN5boost8functionIFvPN3RBX9DataModelEEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsENS7_5list2INS7_5valueISB_EENSF_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISK_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost8functionIFvPN3RBX9DataModelEEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsENS7_5list2INS7_5valueISB_EENSF_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISK_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e164() {
    // IDA 0xf2e164: Thumb import jump veneer for `j___ZN5boost8functionIFvPN3RBX9DataModelEEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsbENS7_5list3INS7_5valueISB_EENSF_ISsEENSF_IbEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISL_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost8functionIFvPN3RBX9DataModelEEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsbENS7_5list3INS7_5valueISB_EENSF_ISsEENSF_IbEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISL_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e174() {
    // IDA 0xf2e174: Thumb import jump veneer for `j___ZN5boost8functionIFvPSsPSt9exceptionEEC2INS_3_bi6bind_tIvPFvS1_S3_NS_8weak_ptrIN3RBX13ContentFilterEEESsENS7_5list4INS_3argILi1EEENSG_ILi2EEENS7_5valueISC_EENSJ_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost8functionIFvPSsPSt9exceptionEEC2INS_3_bi6bind_tIvPFvS1_S3_NS_8weak_ptrIN3RBX13ContentFilterEEESsENS7_5list4INS_3argILi1EEENSG_ILi2EEENS7_5valueISC_EENSJ_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e184() {
    // IDA 0xf2e184: Thumb import jump veneer for `j___ZN5boost8weak_ptrIN3RBX13ContentFilterEEC2IS2_EERKNS_10shared_ptrIT_EENS_6detail24sp_enable_if_convertibleIS6_S2_E4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::weak_ptr<RBX::ContentFilter>::weak_ptr<RBX::ContentFilter>(boost::shared_ptr<RBX::ContentFilter> const&,boost::detail::sp_enable_if_convertible<RBX::ContentFilter,RBX::ContentFilter>::type).
}

// 0xf2e194 — j___ZN5boost9function1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsENS6_5list2INS6_5valueISA_EENSE_ISsEEEEEEEEvT_
// type: int()
...
pub fn stub_f2e194() {
    // IDA 0xf2e194: Thumb import jump veneer for `j___ZN5boost9function1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsENS6_5list2INS6_5valueISA_EENSE_ISsEEEEEEEEvT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::function1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>).
}

// 0xf2e1a4 — j___ZN5boost9function1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsbENS6_5list3INS6_5valueISA_EENSE_ISsEENSE_IbEEEEEEEEvT_
// type: int()
...
pub fn stub_f2e1a4() {
    // IDA 0xf2e1a4: Thumb import jump veneer for `j___ZN5boost9function1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsbENS6_5list3INS6_5valueISA_EENSE_ISsEENSE_IbEEEEEEEEvT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::function1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>).
}
...
pub fn stub_f2e1b4() {
    // IDA 0xf2e1b4: Thumb import jump veneer for `j___ZN5boost9function1IvPN3RBX9DataModelEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsENS6_5list2INS6_5valueISA_EENSE_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISJ_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost9function1IvPN3RBX9DataModelEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsENS6_5list2INS6_5valueISA_EENSE_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISJ_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e1c4() {
    // IDA 0xf2e1c4: Thumb import jump veneer for `j___ZN5boost9function1IvPN3RBX9DataModelEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsbENS6_5list3INS6_5valueISA_EENSE_ISsEENSE_IbEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISK_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost9function1IvPN3RBX9DataModelEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrINS1_13ContentFilterEEESsbENS6_5list3INS6_5valueISA_EENSE_ISsEENSE_IbEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISK_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e1d4() {
    // IDA 0xf2e1d4: Thumb import jump veneer for `j___ZN5boost9function2IvPSsPSt9exceptionE9assign_toINS_3_bi6bind_tIvPFvS1_S3_NS_8weak_ptrIN3RBX13ContentFilterEEESsENS6_5list4INS_3argILi1EEENSF_ILi2EEENS6_5valueISB_EENSI_ISsEEEEEEEEvT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::function2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>).
}
...
pub fn stub_f2e1e4() {
    // IDA 0xf2e1e4: Thumb import jump veneer for `j___ZN5boost9function2IvPSsPSt9exceptionEC2INS_3_bi6bind_tIvPFvS1_S3_NS_8weak_ptrIN3RBX13ContentFilterEEESsENS6_5list4INS_3argILi1EEENSF_ILi2EEENS6_5valueISB_EENSI_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISN_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost9function2IvPSsPSt9exceptionEC2INS_3_bi6bind_tIvPFvS1_S3_NS_8weak_ptrIN3RBX13ContentFilterEEESsENS6_5list4INS_3argILi1EEENSF_ILi2EEENS6_5valueISB_EENSI_ISsEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISN_EE5valueEEE5valueEiE4typeE.
}

// 0xf2e1f4 — j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE14assign_functorINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsENS8_5list2INS8_5valueISC_EENSG_ISsEEEEEEEEvT_RNS1_15function_bufferEN4mpl_5bool_ILb0EEE
...
pub fn stub_f2e1f4() {
    // IDA 0xf2e1f4: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE14assign_functorINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsENS8_5list2INS8_5valueISC_EENSG_ISsEEEEEEEEvT_RNS1_15function_bufferEN4mpl_5bool_ILb0EEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_functor<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const.
}

// 0xf2e204 — j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE14assign_functorINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsbENS8_5list3INS8_5valueISC_EENSG_ISsEENSG_IbEEEEEEEEvT_RNS1_15function_bufferEN4mpl_5bool_ILb0EEE
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, void *, int, int, int, int)
...
pub fn stub_f2e204() {
    // IDA 0xf2e204: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE14assign_functorINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsbENS8_5list3INS8_5valueISC_EENSG_ISsEENSG_IbEEEEEEEEvT_RNS1_15function_bufferEN4mpl_5bool_ILb0EEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_functor<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const.
}

// 0xf2e214 — j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsENS8_5list2INS8_5valueISC_EENSG_ISsEEEEEEEEbT_RNS1_15function_bufferE
// type: int()
...
pub fn stub_f2e214() {
    // IDA 0xf2e214: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsENS8_5list2INS8_5valueISC_EENSG_ISsEEEEEEEEbT_RNS1_15function_bufferE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &)const.
}

// 0xf2e224 — j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsENS8_5list2INS8_5valueISC_EENSG_ISsEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE
// type: int __fastcall(int, int, void *)
#[doc(alias = "bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<rbx_core::WeakPtr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<rbx_core::WeakPtr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f2e224() {
    // IDA 0xf2e224: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsENS8_5list2INS8_5valueISC_EENSG_ISsEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list2<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const.
}

// 0xf2e234 — j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsbENS8_5list3INS8_5valueISC_EENSG_ISsEENSG_IbEEEEEEEEbT_RNS1_15function_bufferE
// type: int()
...
pub fn stub_f2e234() {
    // IDA 0xf2e234: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsbENS8_5list3INS8_5valueISC_EENSG_ISsEENSG_IbEEEEEEEEbT_RNS1_15function_bufferE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>,boost::detail::function::function_buffer &)const.
}

// 0xf2e244 — j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsbENS8_5list3INS8_5valueISC_EENSG_ISsEENSG_IbEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE
// type: int __fastcall(int, int, int)
#[doc(alias = "bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<rbx_core::WeakPtr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<rbx_core::WeakPtr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f2e244() {
    // IDA 0xf2e244: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tIvPFvNS_8weak_ptrINS3_13ContentFilterEEESsbENS8_5list3INS8_5valueISC_EENSG_ISsEENSG_IbEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ContentFilter>,std::string,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const.
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,rbx_core::WeakPtr<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<rbx_core::WeakPtr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,rbx_core::WeakPtr<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<rbx_core::WeakPtr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f2e274() {
    // IDA 0xf2e274: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable2IvPSsPSt9exceptionE9assign_toINS_3_bi6bind_tIvPFvS3_S5_NS_8weak_ptrIN3RBX13ContentFilterEEESsENS8_5list4INS_3argILi1EEENSH_ILi2EEENS8_5valueISD_EENSK_ISsEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::ContentFilter>>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const.
}
...
pub fn stub_f2e284() {
    // IDA 0xf2e284: Thumb import jump veneer for `j___ZNSt3mapISsN3RBX13ContentFilter11ResultEntryESt4lessISsESaISt4pairIKSsS2_EEEixERS6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::map<std::string,RBX::ContentFilter::ResultEntry,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::operator[](std::string const&).
}
...
pub fn stub_f2e294() {
    // IDA 0xf2e294: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE11lower_boundERKSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::lower_bound(std::string const&).
}
...
pub fn stub_f2e2a4() {
    // IDA 0xf2e2a4: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE11upper_boundERKSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::upper_bound(std::string const&).
}
...
pub fn stub_f2e2b4() {
    // IDA 0xf2e2b4: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE4findERKSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::find(std::string const&).
}
...
pub fn stub_f2e2c4() {
    // IDA 0xf2e2c4: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE5eraseERKSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::erase(std::string const&).
}
...
pub fn stub_f2e2d4() {
    // IDA 0xf2e2d4: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE5eraseESt17_Rb_tree_iteratorISsE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::erase(std::_Rb_tree_iterator<std::string>).
}
...
pub fn stub_f2e2e4() {
    // IDA 0xf2e2e4: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE5eraseESt17_Rb_tree_iteratorISsES7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::erase(std::_Rb_tree_iterator<std::string>,std::_Rb_tree_iterator<std::string>).
}
...
pub fn stub_f2e2f4() {
    // IDA 0xf2e2f4: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ContentFilter11ResultEntryEESt10_Select1stIS5_ESt4lessISsESaIS5_EE11lower_boundERS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::pair<std::string const,RBX::ContentFilter::ResultEntry>,std::_Select1st<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::lower_bound(std::string const&).
}
...
pub fn stub_f2e304() {
    // IDA 0xf2e304: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_f2e314() {
    // IDA 0xf2e314: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ContentFilter11ResultEntryEESt10_Select1stIS5_ESt4lessISsESaIS5_EE16_M_insert_uniqueERKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::pair<std::string const,RBX::ContentFilter::ResultEntry>,std::_Select1st<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::_M_insert_unique(std::pair<std::string const,RBX::ContentFilter::ResultEntry> const&).
}
...
pub fn stub_f2e324() {
    // IDA 0xf2e324: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ContentFilter11ResultEntryEESt10_Select1stIS5_ESt4lessISsESaIS5_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS5_ERKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::pair<std::string const,RBX::ContentFilter::ResultEntry>,std::_Select1st<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::pair<std::string const,RBX::ContentFilter::ResultEntry> const&).
}
...
pub fn stub_f2e334() {
    // IDA 0xf2e334: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ContentFilter11ResultEntryEESt10_Select1stIS5_ESt4lessISsESaIS5_EE4findERS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::pair<std::string const,RBX::ContentFilter::ResultEntry>,std::_Select1st<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::find(std::string const&).
}
...
pub fn stub_f2e344() {
    // IDA 0xf2e344: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ContentFilter11ResultEntryEESt10_Select1stIS5_ESt4lessISsESaIS5_EE5eraseESt17_Rb_tree_iteratorIS5_E` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::pair<std::string const,RBX::ContentFilter::ResultEntry>,std::_Select1st<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::erase(std::_Rb_tree_iterator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>).
}
...
pub fn stub_f2e354() {
    // IDA 0xf2e354: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_f2e364() {
    // IDA 0xf2e364: Thumb import jump veneer for `j___ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ContentFilter11ResultEntryEESt10_Select1stIS5_ESt4lessISsESaIS5_EE9_M_insertEPSt18_Rb_tree_node_baseSD_RKS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<std::string,std::pair<std::string const,RBX::ContentFilter::ResultEntry>,std::_Select1st<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::ContentFilter::ResultEntry>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<std::string const,RBX::ContentFilter::ResultEntry> const&).
}
...
pub fn stub_f2e374() {
    // IDA 0xf2e374: Thumb import jump veneer for `j___ZN5boost9unordered6detail5tableINS1_3mapISaISt4pairIKSsSsEESsSsNS_4hashISsEESt8equal_toISsEEEE11delete_nodeEPNS1_10ptr_bucketE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,std::string>>,std::string,std::string,boost::hash<std::string>,std::equal_to<std::string>>>::delete_node(boost::unordered::detail::ptr_bucket *).
}
...
// type: int __fastcall(rbx_core::filesystem::directory_iterator *this, const rbx_core::filesystem::path *)
#[doc(alias = "boost::filesystem::directory_iterator::directory_iterator(boost::filesystem::path const&)")]
pub fn stub_f2e394() {
    // IDA 0xf2e394: Thumb import jump veneer for `j___ZN5boost10filesystem18directory_iteratorC2ERKNS0_4pathE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::filesystem::directory_iterator::directory_iterator(boost::filesystem::path const&).
}
...
pub fn stub_f2e3a4() {
    // IDA 0xf2e3a4: Thumb import jump veneer for `j___ZN5boost10filesystem4pathaSIPcEENS_9enable_ifINS0_11path_traits11is_pathableINS_5decayIT_E4typeEEERS1_E4typeERKS8_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::enable_if<boost::filesystem::path_traits::is_pathable<boost::decay<char *>::type>,boost::filesystem::path&>::type boost::filesystem::path::operator=<char *>(char * const&).
}
...
pub fn stub_f2e3b4() {
    // IDA 0xf2e3b4: Thumb import jump veneer for `j___ZN5boost10filesystem4pathaSISsEENS_9enable_ifINS0_11path_traits11is_pathableINS_5decayIT_E4typeEEERS1_E4typeERKS7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::enable_if<boost::filesystem::path_traits::is_pathable<boost::decay<std::string>::type>,boost::filesystem::path&>::type boost::filesystem::path::operator=<std::string>(std::string const&).
}

// 0xf2e3c4 — j___ZN5boost10filesystem6detail11dir_itr_impD2Ev
// type: void __fastcall(rbx_core::filesystem::detail::dir_itr_imp *__hidden this)
...
pub fn stub_f2e3d4() {
    // IDA 0xf2e3d4: Thumb import jump veneer for `j___ZN5boost10shared_ptrINS_10filesystem6detail11dir_itr_impEEC2IS3_EEPT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<boost::filesystem::detail::dir_itr_imp>::shared_ptr<boost::filesystem::detail::dir_itr_imp>(boost::filesystem::detail::dir_itr_imp *).
}
...
pub fn stub_f2e3f4() {
    // IDA 0xf2e3f4: Thumb import jump veneer for `j___ZN3RBX4Http10MutexGuardC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Http::MutexGuard::MutexGuard(void).
}
...
pub fn stub_f2e414() {
    // IDA 0xf2e414: Thumb import jump veneer for `j___ZN5boost10shared_ptrISiEC2ISt19basic_istringstreamIcSt11char_traitsIcESaIcEEEEPT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<std::istream>::shared_ptr<std::basic_istringstream<char,std::char_traits<char>,std::allocator<char>>>(std::basic_istringstream<char,std::char_traits<char>,std::allocator<char>> *).
}
...
pub fn stub_f2e424() {
    // IDA 0xf2e424: Thumb import jump veneer for `j___ZN5boost15circular_bufferIdSaIdEE7destroyEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer<double,std::allocator<double>>::destroy(void).
}
...
pub fn stub_f2e444() {
    // IDA 0xf2e444: Thumb import jump veneer for `j___ZN5boost3_bi5list3INS0_5valueISsEENS2_IbEENS2_INS_8functionIFvPSsPSt9exceptionEEEEEEclIPFvSsbSA_ENS0_5list1IRNS_10shared_ptrIN3RBX5mutexEEEEEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list3<boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>::operator()<void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list1<boost::shared_ptr<RBX::mutex> &>>(boost::_bi::type<void>,void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>) &,boost::_bi::list1<boost::shared_ptr<RBX::mutex> &> &,int).
}
...
pub fn stub_f2e464() {
    // IDA 0xf2e464: Thumb import jump veneer for `j___ZN5boost3_bi5list5INS0_5valueISsEENS2_INS_10shared_ptrISiEEEENS2_IbEES7_NS2_INS_8functionIFvPSsPSt9exceptionEEEEEEclIPFvSsS5_bbSD_ENS0_5list1IRNS4_IN3RBX5mutexEEEEEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>::operator()<void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list1<boost::shared_ptr<RBX::mutex> &>>(boost::_bi::type<void>,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>) &,boost::_bi::list1<boost::shared_ptr<RBX::mutex> &> &,int).
}
