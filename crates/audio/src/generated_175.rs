...
// Batch: +150 stubs | range 0x369504..0x371070 | audio 22315 -> 22465 distinct
...
#[doc(alias = "__ZN3RBX13HeartbeatTask16stepDataModelJobERKNS_13TaskScheduler3Job5StatsE")]
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX10RunServiceEEC2IS2_EERKNS_8weak_ptrIT_EENS_6detail14sp_nothrow_tagE")]
pub fn stub_0x369698() -> ! {
    todo!("0x369698 rbx_core::SharedPtr<RBX::RunService>::shared_ptr<RBX::RunService>(rbx_core::Weak<RBX::RunService> const&,boost::detail::sp_nothrow_tag)")
}
...
#[doc(alias = "__ZN5boost6detail10weak_countC1ERKNS0_12shared_countE")]
pub fn stub_0x369718() {
    // IDA 0x369718: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX10PhysicsJobC2EN5boost10shared_ptrINS_9DataModelEEE")]
...
pub fn stub_0x3698b8() {
    // IDA 0x3698b8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x369988() {
    // IDA 0x369988: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX10PhysicsJob9sleepTimeERKNS_13TaskScheduler3Job5StatsE")]
pub fn stub_0x369a70() -> ! {
    todo!("0x369a70 RBX::PhysicsJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)")
}
...
#[doc(alias = "__ZN3RBX10PhysicsJob5errorERKNS_13TaskScheduler3Job5StatsE")]
pub fn stub_0x369ab0() -> ! {
    todo!("0x369ab0 RBX::PhysicsJob::error(RBX::TaskScheduler::Job::Stats const&)")
}
...
#[doc(alias = "__ZNK3RBX10PhysicsJob26getDesiredConcurrencyCountEv")]
pub fn stub_0x369ac8() -> ! {
    todo!("0x369ac8 RBX::PhysicsJob::getDesiredConcurrencyCount(void)const")
}
...
#[doc(alias = "__ZN3RBX10PhysicsJob16stepDataModelJobERKNS_13TaskScheduler3Job5StatsE")]
...
#[doc(alias = "__ZN3rbx7signals6signalIFvRKN3RBX7SteppedEEE13disconnectAllEv")]
pub fn stub_0x369c54() -> ! {
    todo!("0x369c54 rbx::signals::signal<void ()(RBX::Stepped const&)>::disconnectAll(void)")
}
...
#[doc(alias = "__ZN3rbx7signals6signalIFvRKN3RBX9HeartbeatEEE13disconnectAllEv")]
pub fn stub_0x369dcc() -> ! {
    todo!("0x369dcc rbx::signals::signal<void ()(RBX::Heartbeat const&)>::disconnectAll(void)")
}
...
#[doc(alias = "__ZN3rbx7signals6signalIFvN3RBX13RunTransitionEEE13disconnectAllEv")]
...
#[doc(alias = "__ZN3RBX25ScriptInformationProviderC1Ev")]
pub fn stub_0x36a44c() -> ! {
    todo!("0x36a44c RBX::ScriptInformationProvider::ScriptInformationProvider(void)")
}

// 0x36a450 — __ZN3RBX25ScriptInformationProviderC2Ev
// type: RBX::Instance *__fastcall(RBX::ScriptInformationProvider *this)
#[doc(alias = "RBX::ScriptInformationProvider::ScriptInformationProvider(void)")]
#[doc(alias = "__ZN3RBX25ScriptInformationProviderC2Ev")]
pub fn stub_0x36a450() -> ! {
    todo!("0x36a450 RBX::ScriptInformationProvider::ScriptInformationProvider(void)")
}
...
#[doc(alias = "__ZN3RBX25ScriptInformationProvider11onHeartbeatERKNS_9HeartbeatE")]
pub fn stub_0x36a714() -> ! {
    todo!("0x36a714 RBX::ScriptInformationProvider::onHeartbeat(RBX::Heartbeat const&)")
}
...
pub fn stub_0x36a71c() {
    // IDA 0x36a71c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "RBX::ScriptInformationProvider::HandleHttpResponse(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>)")]
...
pub fn stub_0x36a724() -> ! {
    todo!("0x36a724 RBX::ScriptInformationProvider::HandleHttpResponse(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>)")
}
...
pub fn stub_0x36a87c() -> ! {
    todo!("0x36a87c RBX::ScriptInformationProvider::getScriptInfo(std::string const&,bool,float,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>,RBX::AsyncHttpQueue::ResultJob)")
}
...
pub fn stub_0x36b030() -> ! {
    todo!("0x36b030 RBX::ScriptInformationProvider::CachedScriptInfo::CachedScriptInfo(rbx_core::SharedPtr<std::string const>,rbx_core::SharedPtr<std::string const>)")
}
...
#[doc(alias = "__ZN3RBX25ScriptInformationProvider11setAssetUrlESs")]
pub fn stub_0x36b240() -> ! {
    todo!("0x36b240 RBX::ScriptInformationProvider::setAssetUrl(std::string)")
}
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_25ScriptInformationProviderEFvSsELi1EED1Ev")]
pub fn stub_0x36b248() {
    // IDA 0x36b248: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX25ScriptInformationProvider12setAccessKeyESs")]
pub fn stub_0x36b33c() -> ! {
    todo!("0x36b33c RBX::ScriptInformationProvider::setAccessKey(std::string)")
}
...
pub fn stub_0x36b344() -> ! {
    todo!("0x36b344 void rbx_core::SharedPtr<RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false>>::reset<RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false>>(RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false> *)")
}
...
pub fn stub_0x36b370() {
    // IDA 0x36b370: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14AsyncHttpCacheINS_25ScriptInformationProvider16CachedScriptInfoELb0EE13findCacheItemERKSsPS2_")]
pub fn stub_0x36b454() -> ! {
    todo!("0x36b454 RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false>::findCacheItem(std::string const&,RBX::ScriptInformationProvider::CachedScriptInfo*)")
}
...
pub fn stub_0x36b568() -> ! {
    todo!("0x36b568 boost::function5<void,RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool>::operator()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)const")
}
...
#[doc(alias = "__ZN3RBX20SizeEnforcedLRUCacheISsSsE6insertERKSsS3_m")]
...
pub fn stub_0x36b678() -> ! {
    todo!("0x36b678 boost::_bi::bind_t<boost::_bi::unspecified,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>,boost::_bi::list_av_5<RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool>::type> boost::bind<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>,RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool>(boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>,RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)")
}
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list_av_4<rbx_core::Weak<RBX::ScriptInformationProvider>,boost::arg<1>,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>::type> boost::bind<void,rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>,rbx_core::Weak<RBX::ScriptInformationProvider>,boost::arg<1>,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>(void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),rbx_core::Weak<RBX::ScriptInformationProvider>,boost::arg<1>,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>)")]
...
pub fn stub_0x36b76c() -> ! {
    todo!("0x36b76c boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list_av_4<rbx_core::Weak<RBX::ScriptInformationProvider>,boost::arg<1>,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>::type> boost::bind<void,rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>,rbx_core::Weak<RBX::ScriptInformationProvider>,boost::arg<1>,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>(void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),rbx_core::Weak<RBX::ScriptInformationProvider>,boost::arg<1>,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>)")
}

// 0x36bac4 — __ZN3RBX9weak_fromINS_25ScriptInformationProviderEEEN5boost8weak_ptrIT_EEPS4_
// type: void __fastcall(int, int)
#[doc(alias = "rbx_core::Weak<RBX::ScriptInformationProvider> RBX::weak_from<RBX::ScriptInformationProvider>(RBX::ScriptInformationProvider*)")]
#[doc(alias = "__ZN3RBX9weak_fromINS_25ScriptInformationProviderEEEN5boost8weak_ptrIT_EEPS4_")]
pub fn stub_0x36bac4() -> ! {
    todo!("0x36bac4 rbx_core::Weak<RBX::ScriptInformationProvider> RBX::weak_from<RBX::ScriptInformationProvider>(RBX::ScriptInformationProvider*)")
}
...
pub fn stub_0x36bcbc() {
    // IDA 0x36bcbc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36bcc0() {
    // IDA 0x36bcc0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX25ScriptInformationProvider17onServiceProviderEPNS_15ServiceProviderES2_")]
pub fn stub_0x36bd64() -> ! {
    todo!("0x36bd64 RBX::ScriptInformationProvider::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x36bd70() -> ! {
    todo!("0x36bd70 __ZNK3RBX17NonFactoryProductINS_8InstanceELZNS_26sScriptInformationProviderEEE12getClassNameEv")
}
...
pub fn stub_0x36bd9c() {
    // IDA 0x36bd9c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36bda4() {
    // IDA 0x36bda4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36be48() {
    // IDA 0x36be48: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36be70() {
    // IDA 0x36be70: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36be78() {
    // IDA 0x36be78: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36bf20() {
    // IDA 0x36bf20: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36bf28() {
    // IDA 0x36bf28: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36bfd0() -> ! {
    todo!("0x36bfd0 __ZN3RBX4Name13callDoDeclareILZNS_26sScriptInformationProviderEEEEvv")
}
...
#[doc(alias = "boost::_bi::storage4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>::storage4(boost::_bi::storage4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>> const&)")]
...
pub fn stub_0x36c42c() {
    // IDA 0x36c42c: function ctor/assign from a bind_t functor. Box<dyn Fn> from closure captures — carrier no-op.
}
...
#[doc(alias = "void boost::function3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>)")]
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
...
pub fn stub_0x36c7fc() {
    // IDA 0x36c7fc: invoker::invoke unpacked the buffer and called the bound functor. Closure call at the live site — carrier no-op.
}
...
pub fn stub_0x36c820() -> ! {
    todo!("0x36c820 bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>,boost::detail::function::function_buffer &)const")
}
...
pub fn stub_0x36ca44() -> ! {
    todo!("0x36ca44 bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")
}
...
#[doc(alias = "void boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_functor<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
pub fn stub_0x36cc64() -> ! {
    todo!("0x36cc64 void boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_functor<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")
}
...
#[doc(alias = "void boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>::operator()<void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list3<RBX::AsyncHttpQueue::RequestResult&,std::istream *&,rbx_core::SharedPtr<std::string const> &>>(boost::_bi::type<void>,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>) &,boost::_bi::list3<RBX::AsyncHttpQueue::RequestResult&,std::istream *&,rbx_core::SharedPtr<std::string const> &> &,int)")]
...
pub fn stub_0x36cd24() -> ! {
    todo!("0x36cd24 void boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>::operator()<void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>),boost::_bi::list3<RBX::AsyncHttpQueue::RequestResult&,std::istream *&,rbx_core::SharedPtr<std::string const> &>>(boost::_bi::type<void>,void (*)(rbx_core::Weak<RBX::ScriptInformationProvider>,RBX::AsyncHttpQueue::RequestResult,std::string,boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>) &,boost::_bi::list3<RBX::AsyncHttpQueue::RequestResult&,std::istream *&,rbx_core::SharedPtr<std::string const> &> &,int)")
}
...
#[doc(alias = "boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>::list4(boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>)")]
...
pub fn stub_0x36d0dc() {
    // IDA 0x36d0dc: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
#[doc(alias = "boost::_bi::storage4<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>>::storage4(boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>,boost::_bi::value<boost::function<void ()(RBX::ScriptInformationProvider::RequestResult,bool,bool,float,bool)>>)")]
...
pub fn stub_0x36d2b8() {
    // IDA 0x36d2b8: function ctor/assign from a bind_t functor. Box<dyn Fn> from closure captures — carrier no-op.
}
...
#[doc(alias = "boost::_bi::storage3<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>>::storage3(boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>)")]
...
pub fn stub_0x36d4c0() -> ! {
    todo!("0x36d4c0 boost::_bi::storage3<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>>::storage3(boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>,boost::_bi::value<std::string>)")
}
...
#[doc(alias = "boost::_bi::storage2<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>>::storage2(boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>)")]
...
pub fn stub_0x36d600() -> ! {
    todo!("0x36d600 boost::_bi::storage2<boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>>::storage2(boost::_bi::value<rbx_core::Weak<RBX::ScriptInformationProvider>>,boost::arg<1>)")
}
...
// type: _DWORD *__fastcall(_DWORD *, _DWORD *)
#[doc(alias = "rbx_core::Weak<RBX::ScriptInformationProvider>::weak_ptr<RBX::ScriptInformationProvider>(rbx_core::SharedPtr<RBX::ScriptInformationProvider> const&,boost::detail::sp_enable_if_convertible<RBX::ScriptInformationProvider,RBX::ScriptInformationProvider>::type)")]
...
pub fn stub_0x36d748() -> ! {
    todo!("0x36d748 rbx_core::Weak<RBX::ScriptInformationProvider>::weak_ptr<RBX::ScriptInformationProvider>(rbx_core::SharedPtr<RBX::ScriptInformationProvider> const&,boost::detail::sp_enable_if_convertible<RBX::ScriptInformationProvider,RBX::ScriptInformationProvider>::type)")
}
...
#[doc(alias = "__ZN5boost9function1IvPN3RBX9DataModelEE9assign_toINS_3_bi6bind_tINS6_11unspecifiedENS_8functionIFvNS1_25ScriptInformationProvider13RequestResultEbbfbEEENS6_5list5INS6_5valueISB_EENSF_IbEESH_NSF_IfEESH_EEEEEEvT_")]
...
pub fn stub_0x36da4c() {
    // IDA 0x36da4c: invoker::invoke unpacked the buffer and called the bound functor. Closure call at the live site — carrier no-op.
}
...
pub fn stub_0x36de2c() {
    // IDA 0x36de2c: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_0x36e874() {
    // IDA 0x36e874: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36e898() {
    // IDA 0x36e898: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36e908() {
    // IDA 0x36e908: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36ea30() {
    // IDA 0x36ea30: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36ec4c() {
    // IDA 0x36ec4c: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36ed5c() -> ! {
    todo!("0x36ed5c boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,std::_List_iterator<std::pair<std::string,std::pair<unsigned long,RBX::ScriptInformationProvider::CachedScriptInfo>>>>>,std::string,std::_List_iterator<std::pair<std::string,std::pair<unsigned long,RBX::ScriptInformationProvider::CachedScriptInfo>>>,boost::hash<std::string>,std::equal_to<std::string>>>::find_node(std::string const&)const")
}
...
pub fn stub_0x36ed98() -> ! {
    todo!("0x36ed98 boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<std::string const,std::_List_iterator<std::pair<std::string,std::pair<unsigned long,RBX::ScriptInformationProvider::CachedScriptInfo>>>>>> boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<std::string const,std::_List_iterator<std::pair<std::string,std::pair<unsigned long,RBX::ScriptInformationProvider::CachedScriptInfo>>>>>,std::string,std::_List_iterator<std::pair<std::string,std::pair<unsigned long,RBX::ScriptInformationProvider::CachedScriptInfo>>>,boost::hash<std::string>,std::equal_to<std::string>>>::find_node_impl<std::string,std::equal_to<std::string>>(unsigned long,std::string const&,std::equal_to<std::string> const&)const")
}
...
pub fn stub_0x36ee08() -> ! {
    todo!("0x36ee08 rbx_core::SharedPtr<RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false>>::shared_ptr<RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false>>(RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false> *)")
}
...
pub fn stub_0x36f018() {
    // IDA 0x36f018: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_0x36f118() {
    // IDA 0x36f118: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_0x36f12c() {
    // IDA 0x36f12c: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_0x36f130() {
    // IDA 0x36f130: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_0x36f284() {
    // IDA 0x36f284: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36f38c() {
    // IDA 0x36f38c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x36f4a4() -> ! {
    todo!("0x36f4a4 RBX::AsyncHttpCache<RBX::ScriptInformationProvider::CachedScriptInfo,false>::registerContent(std::string const&,rbx_core::SharedPtr<std::string const>,rbx_core::SharedPtr<std::string const>)")
}
...
pub fn stub_0x36fe00() {
    // IDA 0x36fe00: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36fe24() {
    // IDA 0x36fe24: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36fe90() {
    // IDA 0x36fe90: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x36ffb8() {
    // IDA 0x36ffb8: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x370108() {
    // IDA 0x370108: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x3701ec() {
    // IDA 0x3701ec: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x3705a0() {
    // IDA 0x3705a0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x370950() {
    // IDA 0x370950: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x370954() {
    // IDA 0x370954: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x3709f4() {
    // IDA 0x3709f4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x3709fc() {
    // IDA 0x3709fc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x370aa0() {
    // IDA 0x370aa0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x370aa8() {
    // IDA 0x370aa8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x370cf8() {
    // IDA 0x370cf8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x371070() {
    // IDA 0x371070: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
