//! audio generated_audio_14 — next 100 stubs EA-sorted, from ida/export.json
...
//! Batch: 100 stubs | skeleton batch | range 0x3ff478..0x40287c EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
...
// demangled: __ZN3RBX10Reflection9DescribedINS_7Network7PlayersELZNS2_8sPlayersEENS_17NonFactoryProductINS_8InstanceELZNS2_8sPlayersEEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EE15classDescriptorEv
...
// demangled: RBX::FilteredSelection<RBX::Instance>::getSelection(void)
...
pub fn stub_3ff5f0() -> ! {
    todo!("0x3ff5f0 void RBX::Selection::setSelection<__gnu_cxx::__normal_iterator<RBX::Instance **,std::vector<RBX::Instance *,std::allocator<RBX::Instance *>>>>(__gnu_cxx::__normal_iterator<RBX::Instance **,std::vector<RBX::Instance *,std::allocator<RBX::Instance *>>>,__gnu_cxx::__normal_iterator<RBX::Instance **,std::vector<RBX::Instance *,std::allocator<RBX::Instance *>>>)")
}

// 0x3ff614 — __ZNK3RBX15ServiceProvider4findINS_17FilteredSelectionINS_8InstanceEEEEEPT_v
// demangled: RBX::FilteredSelection<RBX::Instance> * RBX::ServiceProvider::find<RBX::FilteredSelection<RBX::Instance>>(void)const
...
// demangled: __ZN3RBX17NonFactoryProductINS_8InstanceELZNS_18sFilteredSelectionEEE15isNullClassNameEv
// type: int()
...
// 0x3ff828 — __ZN3RBX4Name7declareILZNS_18sFilteredSelectionEEEERKS0_v
// demangled: __ZN3RBX4Name7declareILZNS_18sFilteredSelectionEEEERKS0_v
// type: 
#[doc(alias = "__ZN3RBX4Name7declareILZNS_18sFilteredSelectionEEEERKS0_v")]
pub fn stub_3ff828() -> ! {
    todo!("0x3ff828 __ZN3RBX4Name7declareILZNS_18sFilteredSelectionEEEERKS0_v")
}

// 0x3ff86c — __ZN3RBX4Name13callDoDeclareILZNS_18sFilteredSelectionEEEEvv
// demangled: __ZN3RBX4Name13callDoDeclareILZNS_18sFilteredSelectionEEEEvv
// type: 
#[doc(alias = "__ZN3RBX4Name13callDoDeclareILZNS_18sFilteredSelectionEEEEvv")]
pub fn stub_3ff86c() -> ! {
    todo!("0x3ff86c __ZN3RBX4Name13callDoDeclareILZNS_18sFilteredSelectionEEEEvv")
}

// 0x3ff870 — __ZN3RBX4Name9doDeclareILZNS_18sFilteredSelectionEEEERKS0_v
// demangled: __ZN3RBX4Name9doDeclareILZNS_18sFilteredSelectionEEEERKS0_v
// type: int()
#[doc(alias = "__ZN3RBX4Name9doDeclareILZNS_18sFilteredSelectionEEEERKS0_v")]
pub fn stub_3ff870() -> ! {
    todo!("0x3ff870 __ZN3RBX4Name9doDeclareILZNS_18sFilteredSelectionEEEERKS0_v")
}

// 0x3ff954 — __ZN3RBX15ServiceProvider19callDoGetClassIndexINS_17FilteredSelectionINS_8InstanceEEEEEvv
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::FilteredSelection<RBX::Instance>>(void)
// type: 
...
// demangled: unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::FilteredSelection<RBX::Instance>>(void)
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::Instance> * RBX::ServiceProvider::create<RBX::FilteredSelection<RBX::Instance>>(void)const
...
// demangled: boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>> RBX::Creatable<RBX::Instance>::create<RBX::FilteredSelection<RBX::Instance>>(void)
...
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_17FilteredSelectionIS1_EEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_3ffbf8() -> ! {
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::FilteredSelection<RBX::Instance>>(boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>> const&)
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX8InstanceEEaSINS1_17FilteredSelectionIS2_EEEERS3_RKNS0_IT_EE")]
pub fn stub_3ffca8() -> ! {
...
// demangled: RBX::FilteredSelection<RBX::Instance>::FilteredSelection(void)
...
// demangled: RBX::FilteredSelection<RBX::Instance>::~FilteredSelection()
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::Instance>::onAncestorChanged(RBX::AncestorChanged const&)
...
// demangled: __ZNK3RBX17NonFactoryProductINS_8InstanceELZNS_18sFilteredSelectionEEE12getClassNameEv
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::Instance>::onSelectionChanged(RBX::SelectionChanged const&)
...
// demangled: non-virtual thunk to RBX::FilteredSelection<RBX::Instance>::~FilteredSelection()
// type: int __fastcall(int)
...
// demangled: __ZThn32_NK3RBX17NonFactoryProductINS_8InstanceELZNS_18sFilteredSelectionEEE12getClassNameEv
// type: int()
...
// demangled: non-virtual thunk to RBX::FilteredSelection<RBX::Instance>::onSelectionChanged(RBX::SelectionChanged const&)
// type: int()
...
// demangled: boost::shared_ptr<RBX::Selection>::operator=(boost::shared_ptr<RBX::Selection> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
#[doc(alias = "rbx_core::SharedPtr<RBX::Selection>::operator=(rbx_core::SharedPtr<RBX::Selection> const&)")]
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX9SelectionEEaSERKS3_")]
pub fn stub_4002d4() -> ! {
...
// demangled: boost::shared_ptr<RBX::Selection> RBX::shared_from<RBX::Selection>(RBX::Selection*)
// type: void __fastcall(_DWORD *, int)
#[doc(alias = "rbx_core::SharedPtr<RBX::Selection> RBX::shared_from<RBX::Selection>(RBX::Selection*)")]
#[doc(alias = "__ZN3RBX11shared_fromINS_9SelectionEEEN5boost10shared_ptrIT_EEPS4_")]
pub fn stub_40030c() -> ! {
...
// demangled: boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>>::shared_ptr<RBX::FilteredSelection<RBX::Instance>,RBX::Creatable<RBX::Instance>::Deleter>(RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter)
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX17FilteredSelectionINS1_8InstanceEEEEC2IS4_NS1_9CreatableIS3_E7DeleterEEEPT_T0_")]
pub fn stub_4003f4() -> ! {
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::FilteredSelection<RBX::Instance>,RBX::FilteredSelection<RBX::Instance>>(boost::shared_ptr<RBX::FilteredSelection<RBX::Instance>> const*,RBX::FilteredSelection<RBX::Instance> *)const
...
pub fn stub_4004bc() {
    // IDA 0x4004bc: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}

// 0x4005a4 — __ZN5boost6detail12shared_countC2IPN3RBX17FilteredSelectionINS3_8InstanceEEENS3_9CreatableIS5_E7DeleterEEET_T0_
// demangled: boost::detail::shared_count::shared_count<RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter)
...
#[doc(alias = "__ZN5boost6detail12shared_countC2IPN3RBX17FilteredSelectionINS3_8InstanceEEENS3_9CreatableIS5_E7DeleterEEET_T0_")]
pub fn stub_4005a4() {
    // IDA 0x4005a4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
// type: void()
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_8InstanceEEENS2_9CreatableIS4_E7DeleterEED1Ev")]
pub fn stub_4006ac() {
    // IDA 0x4006ac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_8InstanceEEENS2_9CreatableIS4_E7DeleterEED0Ev")]
pub fn stub_4006b0() {
    // IDA 0x4006b0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_8InstanceEEENS2_9CreatableIS4_E7DeleterEE7disposeEv")]
pub fn stub_4006b4() {
    // IDA 0x4006b4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
// type: int __fastcall(int, int)
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_8InstanceEEENS2_9CreatableIS4_E7DeleterEE11get_deleterERKSt9type_info")]
pub fn stub_4006d4() {
    // IDA 0x4006d4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::Instance> *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
// type: int __fastcall(int)
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_8InstanceEEENS2_9CreatableIS4_E7DeleterEE19get_untyped_deleterEv")]
pub fn stub_4006ec() {
    // IDA 0x4006ec: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x4006f0 — __ZN3RBX17FilteredSelectionINS_13ModelInstanceEE12getSelectionEv
// demangled: RBX::FilteredSelection<RBX::ModelInstance>::getSelection(void)
// type: int __fastcall(int)
...
// demangled: RBX::Ungroup::operator()(boost::shared_ptr<RBX::Instance> const&)
// type: _BYTE *__fastcall(int *, RBX::Instance **)
#[doc(alias = "RBX::Ungroup::operator()(rbx_core::SharedPtr<RBX::Instance> const&)")]
#[doc(alias = "__ZN3RBX7UngroupclERKN5boost10shared_ptrINS_8InstanceEEE")]
pub fn stub_400748() -> ! {
...
// demangled: RBX::FilteredSelection<RBX::ModelInstance> * RBX::ServiceProvider::find<RBX::FilteredSelection<RBX::ModelInstance>>(void)const
// type: RBX::Name *__fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::FilteredSelection<RBX::ModelInstance>>(void)
// type: 
...
// demangled: unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::FilteredSelection<RBX::ModelInstance>>(void)
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::ModelInstance> * RBX::ServiceProvider::create<RBX::FilteredSelection<RBX::ModelInstance>>(void)const
// type: int __fastcall(RBX::Instance *, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: boost::shared_ptr<RBX::FilteredSelection<RBX::ModelInstance>> RBX::Creatable<RBX::Instance>::create<RBX::FilteredSelection<RBX::ModelInstance>>(void)
// type: void __fastcall(int)
...
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_17FilteredSelectionINS_13ModelInstanceEEEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_400bcc() -> ! {
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::FilteredSelection<RBX::ModelInstance>>(boost::shared_ptr<RBX::FilteredSelection<RBX::ModelInstance>> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX8InstanceEEaSINS1_17FilteredSelectionINS1_13ModelInstanceEEEEERS3_RKNS0_IT_EE")]
pub fn stub_400c7c() -> ! {
...
// demangled: RBX::FilteredSelection<RBX::ModelInstance>::FilteredSelection(void)
// type: RBX::Instance *__fastcall(RBX::Instance *)
...
// demangled: RBX::FilteredSelection<RBX::ModelInstance>::~FilteredSelection()
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::ModelInstance>::onAncestorChanged(RBX::AncestorChanged const&)
// type: void __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: RBX::FilteredSelection<RBX::ModelInstance>::onSelectionChanged(RBX::SelectionChanged const&)
// type: int __fastcall(int, int)
...
// demangled: non-virtual thunk to RBX::FilteredSelection<RBX::ModelInstance>::~FilteredSelection()
// type: int __fastcall(int)
...
// demangled: non-virtual thunk to RBX::FilteredSelection<RBX::ModelInstance>::onSelectionChanged(RBX::SelectionChanged const&)
// type: int __fastcall(int)
...
// demangled: std::vector<RBX::ModelInstance *,std::allocator<RBX::ModelInstance *>>::push_back(RBX::ModelInstance * const&)
...
// demangled: std::vector<RBX::ModelInstance *,std::allocator<RBX::ModelInstance *>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::ModelInstance **,std::vector<RBX::ModelInstance *,std::allocator<RBX::ModelInstance *>>>,RBX::ModelInstance * const&)
...
// demangled: std::_Vector_base<RBX::ModelInstance *,std::allocator<RBX::ModelInstance *>>::_M_allocate(unsigned long)
...
// demangled: boost::shared_ptr<RBX::FilteredSelection<RBX::ModelInstance>>::shared_ptr<RBX::FilteredSelection<RBX::ModelInstance>,RBX::Creatable<RBX::Instance>::Deleter>(RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int *__fastcall(int *, int, int, int)
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX17FilteredSelectionINS1_13ModelInstanceEEEEC2IS4_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_")]
pub fn stub_401414() -> ! {
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::FilteredSelection<RBX::ModelInstance>,RBX::FilteredSelection<RBX::ModelInstance>>(boost::shared_ptr<RBX::FilteredSelection<RBX::ModelInstance>> const*,RBX::FilteredSelection<RBX::ModelInstance> *)const
// type: void __fastcall(_DWORD *, const shared_count *, int)
...
pub fn stub_4014dc() {
    // IDA 0x4014dc: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
// demangled: boost::detail::shared_count::shared_count<RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter)
// type: _DWORD *__fastcall(_DWORD *, int, int, int, void *, int)
...
#[doc(alias = "__ZN5boost6detail12shared_countC2IPN3RBX17FilteredSelectionINS3_13ModelInstanceEEENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_")]
pub fn stub_4015c4() {
    // IDA 0x4015c4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
// type: void()
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_13ModelInstanceEEENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev")]
pub fn stub_4016cc() {
    // IDA 0x4016cc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_13ModelInstanceEEENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev")]
pub fn stub_4016d0() {
    // IDA 0x4016d0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
// type: int __fastcall(int, RBX::Instance *)
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_13ModelInstanceEEENS2_9CreatableINS2_8InstanceEE7DeleterEE7disposeEv")]
pub fn stub_4016d4() {
    // IDA 0x4016d4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
// type: int __fastcall(int, int)
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_13ModelInstanceEEENS2_9CreatableINS2_8InstanceEE7DeleterEE11get_deleterERKSt9type_info")]
pub fn stub_4016f4() {
    // IDA 0x4016f4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::FilteredSelection<RBX::ModelInstance> *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
// type: int __fastcall(int)
...
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX17FilteredSelectionINS2_13ModelInstanceEEENS2_9CreatableINS2_8InstanceEE7DeleterEE19get_untyped_deleterEv")]
pub fn stub_40170c() {
    // IDA 0x40170c: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: void boost::_bi::list1<boost::arg<1>>::operator()<void (*)(boost::shared_ptr<RBX::Instance>),boost::_bi::list1<boost::shared_ptr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(boost::shared_ptr<RBX::Instance>) &,boost::_bi::list1<boost::shared_ptr<RBX::Instance> const&> &,int)
...
#[doc(alias = "__ZN5boost3_bi5list1INS_3argILi1EEEEclIPFvNS_10shared_ptrIN3RBX8InstanceEEEENS1_IRKS9_EEEEvNS0_4typeIvEERT_RT0_i")]
pub fn stub_401710() -> ! {
...
// demangled: RBX::Instance::findCommonNode(RBX::Instance*,RBX::Instance*)
...
// demangled: RBX::Instance::canAddChild(RBX::Instance const*)const
...
// demangled: boost::shared_ptr<RBX::ModelInstance> RBX::Creatable<RBX::Instance>::create<RBX::ModelInstance>(void)
// type: void __fastcall(int)
#[doc(alias = "rbx_core::SharedPtr<RBX::ModelInstance> RBX::Creatable<RBX::Instance>::create<RBX::ModelInstance>(void)")]
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_13ModelInstanceEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_40187c() -> ! {
...
// demangled: boost::shared_ptr<RBX::ModelInstance>::shared_ptr<RBX::ModelInstance,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int *__fastcall(int *, int, int, int)
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX13ModelInstanceEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_")]
pub fn stub_401930() -> ! {
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::ModelInstance,RBX::ModelInstance>(boost::shared_ptr<RBX::ModelInstance> const*,RBX::ModelInstance *)const
// type: void __fastcall(_DWORD *, const shared_count *, int)
...
pub fn stub_4019f8() {
    // IDA 0x4019f8: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}

// 0x401ae0 — __ZN5boost6detail12shared_countC2IPN3RBX13ModelInstanceENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
// demangled: boost::detail::shared_count::shared_count<RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter)
// type: _DWORD *__fastcall(_DWORD *, int, int, int, void *, int)
...
#[doc(alias = "__ZN5boost6detail12shared_countC2IPN3RBX13ModelInstanceENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_")]
pub fn stub_401ae0() {
    // IDA 0x401ae0: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x401be8 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX13ModelInstanceENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// demangled: boost::detail::sp_counted_impl_pd<RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
// type: void()
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX13ModelInstanceENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev")]
pub fn stub_401be8() {
    // IDA 0x401be8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x401bec — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX13ModelInstanceENS2_9CreatableINS2_8InstanceEE7DeleterEE7disposeEv
// demangled: boost::detail::sp_counted_impl_pd<RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
// type: int __fastcall(int, RBX::Instance *)
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::ModelInstance *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")]
#[doc(alias = "__ZN5boost6detail18sp_counted_impl_pdIPN3RBX13ModelInstanceENS2_9CreatableINS2_8InstanceEE7DeleterEE7disposeEv")]
pub fn stub_401bec() {
    // IDA 0x401bec: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x401c0c — __ZNK3RBX13ServiceClientINS_10RunServiceEE13createServiceEv
// demangled: RBX::ServiceClient<RBX::RunService>::createService(void)const
// type: int __fastcall(_DWORD *)
#[doc(alias = "RBX::ServiceClient<RBX::RunService>::createService(void)const")]
#[doc(alias = "__ZNK3RBX13ServiceClientINS_10RunServiceEE13createServiceEv")]
pub fn stub_401c0c() -> ! {
...
// demangled: __ZNK3RBX14FactoryProductINS_15NetworkSettingsENS_22GlobalAdvancedSettings4ItemELZNS_16sNetworkSettingsEENS_8InstanceEE7Creator12getClassNameEv
// type: int()
...
// demangled: __ZN3RBX4Name7declareILZNS_16sNetworkSettingsEEEERKS0_v
// type: 
...
// demangled: __ZN3RBX4Name9doDeclareILZNS_16sNetworkSettingsEEEERKS0_v
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::PVInstance>::getSelection(void)
// type: int __fastcall(int)
...
// demangled: RBX::FilteredSelection<RBX::PVInstance> * RBX::ServiceProvider::create<RBX::FilteredSelection<RBX::PVInstance>>(void)const
// type: int __fastcall(RBX::Instance *, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: RBX::FilteredSelection<RBX::PVInstance> * RBX::ServiceProvider::find<RBX::FilteredSelection<RBX::PVInstance>>(void)const
// type: RBX::Name *__fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: boost::shared_ptr<RBX::FilteredSelection<RBX::PVInstance>> RBX::Creatable<RBX::Instance>::create<RBX::FilteredSelection<RBX::PVInstance>>(void)
// type: void __fastcall(int)
...
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_17FilteredSelectionINS_10PVInstanceEEEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_402214() -> ! {
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::FilteredSelection<RBX::PVInstance>>(boost::shared_ptr<RBX::FilteredSelection<RBX::PVInstance>> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
...
#[doc(alias = "__ZN5boost10shared_ptrIN3RBX8InstanceEEaSINS1_17FilteredSelectionINS1_10PVInstanceEEEEERS3_RKNS0_IT_EE")]
pub fn stub_4022c4() -> ! {
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::FilteredSelection<RBX::PVInstance>>(void)
// type: 
...
// demangled: unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::FilteredSelection<RBX::PVInstance>>(void)
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::PVInstance>::FilteredSelection(void)
// type: RBX::Instance *__fastcall(RBX::Instance *)
...
// demangled: RBX::FilteredSelection<RBX::PVInstance>::~FilteredSelection()
// type: int()
...
// demangled: RBX::FilteredSelection<RBX::PVInstance>::onAncestorChanged(RBX::AncestorChanged const&)
// type: void __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: RBX::FilteredSelection<RBX::PVInstance>::onSelectionChanged(RBX::SelectionChanged const&)
// type: int __fastcall(int, int)
...
// demangled: non-virtual thunk to RBX::FilteredSelection<RBX::PVInstance>::~FilteredSelection()
// type: int __fastcall(int)
...
// demangled: non-virtual thunk to RBX::FilteredSelection<RBX::PVInstance>::onSelectionChanged(RBX::SelectionChanged const&)
// type: int __fastcall(int)
...
// demangled: std::vector<RBX::PVInstance *,std::allocator<RBX::PVInstance *>>::push_back(RBX::PVInstance * const&)
// type: int __fastcall(int result, _DWORD *)
