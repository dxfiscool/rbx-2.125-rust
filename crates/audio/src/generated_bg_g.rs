//! audio generated_bg_g — global gap filler batch G — next 100 EA not yet in crates/audio/src, EA-sorted asc
//! Filter: global gap filler skeleton batch G — EA-sorted asc skip audio existing, rbx_core::SharedPtr not boost::shared_ptr
//! Batch: 100 stubs | skeleton batch | range 0x26a064..0x26e100 EA-sorted asc batch G (audio gap filler, global next 100 after 0x26a060)
...
// demangled: RBX::CoreScript::~CoreScript()
// type: void __fastcall(RBX::CoreScript *__hidden this)
#[doc(alias = "RBX::CoreScript::~CoreScript()")]
#[doc(alias = "__ZN3RBX10CoreScriptD0Ev")]
pub fn stub_26a064() {
    // IDA 0x26a064: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: non-virtual thunk to RBX::CoreScript::~CoreScript()
// type: void __fastcall(RBX::CoreScript *__hidden this)
#[doc(alias = "non-virtual thunk to RBX::CoreScript::~CoreScript()")]
#[doc(alias = "__ZThn32_N3RBX10CoreScriptD1Ev")]
pub fn stub_26a12c() {
    // IDA 0x26a12c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a134() {
    // IDA 0x26a134: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a1d8() {
    // IDA 0x26a1d8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a200() {
    // IDA 0x26a200: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a208() {
    // IDA 0x26a208: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x26a2ac — __ZN3RBX13StarterScriptD1Ev
// demangled: RBX::StarterScript::~StarterScript()
...
pub fn stub_26a2ac() {
    // IDA 0x26a2ac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a2b0() {
    // IDA 0x26a2b0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: non-virtual thunk to RBX::StarterScript::~StarterScript()
// type: void __fastcall(RBX::StarterScript *__hidden this)
#[doc(alias = "non-virtual thunk to RBX::StarterScript::~StarterScript()")]
#[doc(alias = "__ZThn32_N3RBX13StarterScriptD1Ev")]
pub fn stub_26a378() {
    // IDA 0x26a378: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a380() {
    // IDA 0x26a380: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a424() {
    // IDA 0x26a424: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a44c() {
    // IDA 0x26a44c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a454() {
    // IDA 0x26a454: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a88c() {
    // IDA 0x26a88c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a890() {
    // IDA 0x26a890: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a930() {
    // IDA 0x26a930: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a938() {
    // IDA 0x26a938: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a9dc() {
    // IDA 0x26a9dc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26a9e4() {
    // IDA 0x26a9e4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26aba4() {
    // IDA 0x26aba4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26aba8() {
    // IDA 0x26aba8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26ac48() {
    // IDA 0x26ac48: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26ac50() {
    // IDA 0x26ac50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26acf4() {
    // IDA 0x26acf4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26acfc() {
    // IDA 0x26acfc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26ada0() {
    // IDA 0x26ada0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26ada4() {
    // IDA 0x26ada4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26ae44() {
    // IDA 0x26ae44: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26ae4c() {
    // IDA 0x26ae4c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26aef0() {
    // IDA 0x26aef0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26aef8() {
    // IDA 0x26aef8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::multi_index::detail::auto_space<unsigned long,std::allocator<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>>>::auto_space(std::allocator<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>> const&,unsigned long)
...
// demangled: RBX::BaseScript::extraErrorReporting(lua_State *)
// type: void()
...
pub fn stub_26aff8() {
    // IDA 0x26aff8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26affc() {
    // IDA 0x26affc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26b09c() {
    // IDA 0x26b09c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26b0a4() {
    // IDA 0x26b0a4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26b148() {
    // IDA 0x26b148: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_26b150() {
    // IDA 0x26b150: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x26b1f4 — __GLOBAL__I_a_62
// demangled: global constructor keyed to_a_62
...
// demangled: RBX::Lua::LuaArguments::getString(int,std::string &)const
...
#[doc(alias = "__ZNK3RBX3Lua12LuaArguments9getStringEiRSs")]
pub fn stub_26b464() -> ! {
...
// demangled: RBX::Lua::LuaArguments::getVector3int16(int,G3D::Vector3int16 &)const
...
// demangled: RBX::Lua::LuaArguments::getRegion3int16(int,RBX::Region3int16 &)const
...
#[doc(alias = "__ZNK3RBX3Lua12LuaArguments15getRegion3int16EiRNS_12Region3int16E")]
pub fn stub_26b4d8() -> ! {
...
// demangled: RBX::Lua::LuaArguments::getVector3(int,G3D::Vector3 &)const
...
// demangled: RBX::Lua::LuaArguments::getRegion3(int,RBX::Region3 &)const
...
#[doc(alias = "__ZNK3RBX3Lua12LuaArguments10getRegion3EiRNS_7Region3E")]
pub fn stub_26b530() -> ! {
...
// demangled: RBX::Lua::LuaArguments::getObject(int,boost::shared_ptr<RBX::Reflection::DescribedBase> &)const
// type: int __fastcall(int, int, int)
// was: RBX::Lua::LuaArguments::getObject(int,boost::shared_ptr<RBX::Reflection::DescribedBase> &)const -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::LuaArguments::getEnum(int,RBX::Reflection::EnumDescriptor const&,int &)const
...
#[doc(alias = "__ZNK3RBX3Lua12LuaArguments7getEnumEiRKNS_10Reflection14EnumDescriptorERi")]
pub fn stub_26b6e4() -> ! {
...
// demangled: RBX::Lua::LuaArguments::get(lua_State *,int,RBX::Reflection::Variant &,bool)
...
#[doc(alias = "__ZN3RBX3Lua12LuaArguments3getEP9lua_StateiRNS_10Reflection7VariantEb")]
pub fn stub_26b788() -> ! {
...
// demangled: RBX::Lua::LuaArguments::push(RBX::Reflection::Variant const&,lua_State *)
// type: int()
#[doc(alias = "RBX::Lua::LuaArguments::push(RBX::Reflection::Variant const&,lua_State *)")]
#[doc(alias = "__ZN3RBX3Lua12LuaArguments4pushERKNS_10Reflection7VariantEP9lua_State")]
pub fn stub_26c138() -> ! {
...
// demangled: bool RBX::Lua::Bridge<G3D::Vector3int16,true>::getValue<G3D::Vector3int16>(lua_State *,unsigned int,G3D::Vector3int16 &)
// type: int __fastcall(int, int, int)
...
// demangled: bool RBX::Lua::Bridge<RBX::Region3int16,true>::getValue<RBX::Region3int16>(lua_State *,unsigned int,RBX::Region3int16 &)
// type: int __fastcall(int, int, int)
#[doc(alias = "bool RBX::Lua::Bridge<RBX::Region3int16,true>::getValue<RBX::Region3int16>(lua_State *,unsigned int,RBX::Region3int16 &)")]
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_12Region3int16ELb1EE8getValueIS2_EEbP9lua_StatejRT_")]
pub fn stub_26c1b8() -> ! {
...
// demangled: bool RBX::Lua::Bridge<G3D::Vector3,true>::getValue<G3D::Vector3>(lua_State *,unsigned int,G3D::Vector3 &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<RBX::Region3,true>::getValue<RBX::Region3>(lua_State *,unsigned int,RBX::Region3 &)
// type: int __fastcall(int, int, int)
#[doc(alias = "bool RBX::Lua::Bridge<RBX::Region3,true>::getValue<RBX::Region3>(lua_State *,unsigned int,RBX::Region3 &)")]
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_7Region3ELb1EE8getValueIS2_EEbP9lua_StatejRT_")]
pub fn stub_26c2ac() -> ! {
...
// demangled: boost::shared_ptr<RBX::Reflection::DescribedBase>& boost::shared_ptr<RBX::Reflection::DescribedBase>::operator=<RBX::Instance>(boost::shared_ptr<RBX::Instance> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
// was: boost::shared_ptr<RBX::Reflection::DescribedBase>& boost::shared_ptr<RBX::Reflection::DescribedBase>::operator=<RBX::Instance>(boost::shared_ptr<RBX::Instance> const&) -> rbx_core::SharedPtr
...
// demangled: bool RBX::Lua::SharedPtrBridge<RBX::Instance>::getPtr<boost::shared_ptr<RBX::Reflection::DescribedBase>>(lua_State *,unsigned int,boost::shared_ptr<RBX::Reflection::DescribedBase> &)
// type: int __fastcall(int, int, int)
// was: bool RBX::Lua::SharedPtrBridge<RBX::Instance>::getPtr<boost::shared_ptr<RBX::Reflection::DescribedBase>>(lua_State *,unsigned int,boost::shared_ptr<RBX::Reflection::DescribedBase> &) -> rbx_core::SharedPtr
...
#[doc(alias = "__ZNK3RBX10Reflection4TypeneERKS1_")]
pub fn stub_26c474() -> ! {
...
// was: boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>> rbx::make_shared<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>,int>(int const&) -> rbx_core::SharedPtr
...
#[doc(alias = "__ZN3rbx11make_sharedISt6vectorIN3RBX10Reflection7VariantESaIS4_EEiEEN5boost10shared_ptrIT_EERKT0_")]
pub fn stub_26c500() -> ! {
...
#[doc(alias = "__ZN5boost10shared_ptrINS_9unordered13unordered_mapISsN3RBX10Reflection7VariantENS_4hashISsEESt8equal_toISsESaISt4pairIKSsS5_EEEEEaSERKSF_")]
pub fn stub_26c6a4() -> ! {
...
// was: boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> rbx::make_shared<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>(void) -> rbx_core::SharedPtr
...
#[doc(alias = "__ZN3rbx11make_sharedIKSt6vectorIN3RBX10Reflection7VariantESaIS4_EEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_26c6dc() -> ! {
...
// demangled: bool RBX::Lua::SharedPtrBridge<RBX::Instance>::getPtr<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<G3D::CoordinateFrame,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<RBX::Region3,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_7Region3ELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26c9a8() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::Region3int16,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_12Region3int16ELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26ca24() -> ! {
...
// demangled: bool RBX::Lua::Bridge<G3D::Vector3int16,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<G3D::Vector2int16,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<G3D::Vector3,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<G3D::Vector2,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<RBX::RbxRay,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_6RbxRayELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26cc90() -> ! {
...
// demangled: bool RBX::Lua::Bridge<G3D::Color3,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
// demangled: bool RBX::Lua::Bridge<RBX::BrickColor,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_10BrickColorELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26cd88() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::UDim,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_4UDimELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26ce04() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::UDim2,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_5UDim2ELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26ce80() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::Faces,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, int)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_5FacesELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26cefc() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::Axes,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_4AxesELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26cf78() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::CellID,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_6CellIDELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26cff4() -> ! {
...
// demangled: bool RBX::Lua::Bridge<RBX::InputObject,true>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &)
// type: int __fastcall(int, int, _DWORD *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeINS_11InputObjectELb1EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_")]
pub fn stub_26d070() -> ! {
...
// demangled: int RBX::withVariantValue<int,RBX::Lua::ArgumentPusher>(RBX::Reflection::Variant const&,RBX::Lua::ArgumentPusher)
...
#[doc(alias = "__ZN3RBX16withVariantValueIiNS_3Lua14ArgumentPusherEEET_RKNS_10Reflection7VariantET0_")]
pub fn stub_26d0ec() -> ! {
...
// demangled: RBX::Lua::LuaArguments::getVariant(int,RBX::Reflection::Variant &)const
// type: int __fastcall(int, int, int)
#[doc(alias = "RBX::Lua::LuaArguments::getVariant(int,RBX::Reflection::Variant &)const")]
#[doc(alias = "__ZNK3RBX3Lua12LuaArguments10getVariantEiRNS_10Reflection7VariantE")]
pub fn stub_26dc38() -> ! {
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<RBX::Instance> const&)
// type: int __fastcall(int *, int)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<RBX::Instance> const&) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)
// type: int __fastcall(_DWORD *, _DWORD *)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)
// type: int __fastcall(int *, int *)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)
// type: int __fastcall(int *, _DWORD *)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>)
// type: int __fastcall(_DWORD *, _DWORD *)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<RBX::Reflection::Tuple const>)
// type: int __fastcall(int *, char ******)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<RBX::Reflection::Tuple const>) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<boost::function<boost::shared_ptr<RBX::Reflection::Tuple const> ()(boost::shared_ptr<RBX::Reflection::Tuple const>)>>)
// type: int __fastcall(int *, const shared_count *)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<boost::function<boost::shared_ptr<RBX::Reflection::Tuple const> ()(boost::shared_ptr<RBX::Reflection::Tuple const>)>>) -> rbx_core::SharedPtr
...
// demangled: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<boost::function<void ()(boost::shared_ptr<RBX::Reflection::Tuple const>,boost::function<void ()(RBX::Lua::IAsyncResult *)>)>>)
// type: int __fastcall(int *, const shared_count *)
// was: RBX::Lua::ArgumentPusher::operator()(boost::shared_ptr<boost::function<void ()(boost::shared_ptr<RBX::Reflection::Tuple const>,boost::function<void ()(RBX::Lua::IAsyncResult *)>)>>) -> rbx_core::SharedPtr
...
// demangled: int RBX::Lua::ArgumentPusher::operator()<RBX::CellID>(RBX::CellID const&,boost::disable_if<boost::is_arithmetic<RBX::CellID>,void>::type *)
// type: int __fastcall(int *, int)
...
#[doc(alias = "__ZN3RBX3Lua14ArgumentPusherclINS_6CellIDEEEiRKT_PN5boost10disable_ifINS7_13is_arithmeticIS4_EEvE4typeE")]
pub fn stub_26e100() -> ! {
