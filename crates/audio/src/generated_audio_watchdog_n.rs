//! audio generated_audio_watchdog_n — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio exhausted, global gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x5541e0..0x5595e0 | existing 31122 -> 31222 distinct
...
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::PropDescriptor<bool (RBX::GuiService::*)(void)const,int>(char const*,char const*,bool (RBX::GuiService::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
pub fn stub_554210() -> ! {
    todo!("0x554210 __ZN3RBX10Reflection14PropDescriptorINS_10GuiServiceEbEC2IMS2_KFbvEiEEPKcS8_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")
}

// 0x55431c — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE10isReadOnlyEv
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::GetImpl<bool (RBX::GuiService::*)(void)const>::isReadOnly(void)const
...
pub fn stub_55431c() -> ! {
    todo!("0x55431c __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE10isReadOnlyEv")
}

// 0x554320 — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE11isWriteOnlyEv
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::GetImpl<bool (RBX::GuiService::*)(void)const>::isWriteOnly(void)const
...
pub fn stub_554320() -> ! {
    todo!("0x554320 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE11isWriteOnlyEv")
}

// 0x554324 — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE8getValueEPKNS0_13DescribedBaseE
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::GetImpl<bool (RBX::GuiService::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_554324() -> ! {
    todo!("0x554324 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE8getValueEPKNS0_13DescribedBaseE")
}

// 0x554348 — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE8setValueEPNS0_13DescribedBaseERKb
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::GetImpl<bool (RBX::GuiService::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,bool const&)const
...
pub fn stub_554348() -> ! {
    todo!("0x554348 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE7GetImplIMS2_KFbvEE8setValueEPNS0_13DescribedBaseERKb")
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,double>::PropDescriptor<double (RBX::GuiService::*)(void)const,int>(char const*,char const*,double (RBX::GuiService::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
// type: int __fastcall(int, int, int, int, int, void *, int, int, int, int)
...
pub fn stub_554468() -> ! {
    todo!("0x554468 __ZN3RBX10Reflection14PropDescriptorINS_10GuiServiceEdEC2IMS2_KFdvEiEEPKcS8_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,double>::GetImpl<double (RBX::GuiService::*)(void)const>::isReadOnly(void)const
...
pub fn stub_5545a0() -> ! {
    todo!("0x5545a0 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE10isReadOnlyEv")
}

// 0x5545a4 — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE11isWriteOnlyEv
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,double>::GetImpl<double (RBX::GuiService::*)(void)const>::isWriteOnly(void)const
...
pub fn stub_5545a4() -> ! {
    todo!("0x5545a4 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE11isWriteOnlyEv")
}

// 0x5545a8 — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE8getValueEPKNS0_13DescribedBaseE
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,double>::GetImpl<double (RBX::GuiService::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_5545a8() -> ! {
    todo!("0x5545a8 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE8getValueEPKNS0_13DescribedBaseE")
}

// 0x5545c8 — __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE8setValueEPNS0_13DescribedBaseERKd
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,double>::GetImpl<double (RBX::GuiService::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,double const&)const
...
pub fn stub_5545c8() -> ! {
    todo!("0x5545c8 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEdE7GetImplIMS2_KFdvEE8setValueEPNS0_13DescribedBaseERKd")
}

// 0x5546e8 — __ZN3rbx11make_sharedIN3RBX10Reflection5TupleEEEN5boost10shared_ptrIT_EEv
// demangled: boost::shared_ptr<RBX::Reflection::Tuple> rbx::make_shared<RBX::Reflection::Tuple>(void)
...
// demangled: RBX::ScriptContext * RBX::ServiceProvider::create<RBX::ScriptContext>(RBX::Instance const*)
...
// demangled: RBX::Lua::ThreadRef::ThreadRef(RBX::Lua::detail::LiveThreadRef *)
...
// demangled: RBX::registerBodyMovers(void)
...
// demangled: RBX::BodyMover::BodyMover(char const*)
...
// demangled: RBX::BodyMover::~BodyMover()
...
// demangled: RBX::BodyMover::computeForce(bool)
...
// demangled: RBX::BodyMover::computeForce(bool,RBX::Body *&,G3D::Vector3 &,G3D::Vector3 &)
...
pub fn stub_555e18() -> ! {
    todo!("0x555e18 __ZN3RBX9BodyMover12computeForceEbRPNS_4BodyERN3G3D7Vector3ES6_")
}
...
// demangled: different5percent(G3D::Vector3 const&,G3D::Vector3 const&)
...
// demangled: RBX::BodyMover::stepWorld(void)
...
// demangled: RBX::BodyMover::getEngineBody(void)
// type: _DWORD __fastcall(RBX::BodyMover *__hidden this)
...
// demangled: RBX::BodyMover::duplicateBodyMoverExists(RBX::Primitive *,RBX::Primitive *)
...
// demangled: RBX::BodyMover::onAncestorChanged(RBX::AncestorChanged const&)
...
// demangled: RBX::BodyMover::askSetParent(RBX::Instance const*)const
...
// demangled: RBX::Rocket::setTarget(RBX::PartInstance *)
...
// demangled: RBX::Rocket::fire(void)
...
// demangled: RBX::Rocket::abort(void)
// type: _DWORD __fastcall(RBX::Rocket *__hidden this)
...
// demangled: RBX::Rocket::Rocket(void)
// type: _DWORD __fastcall(RBX::Rocket *__hidden this)
...
// demangled: RBX::Rocket::onStepped(RBX::Stepped const&)
...
// demangled: RBX::Rocket::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
pub fn stub_557064() -> ! {
    todo!("0x557064 __ZN3RBX6Rocket16computeForceImplEbPNS_4BodyES2_RN3G3D7Vector3ES5_")
}

// 0x5575a4 — __ZN3RBX6Rocket13computeTorqueEPNS_4BodyES2_RKN3G3D7Vector3E
// demangled: RBX::Rocket::computeTorque(RBX::Body *,RBX::Body *,G3D::Vector3 const&)
...
pub fn stub_5575a4() -> ! {
    todo!("0x5575a4 __ZN3RBX6Rocket13computeTorqueEPNS_4BodyES2_RKN3G3D7Vector3E")
}

// 0x5578a0 — __ZN3RBX8BodyGyroC2Ev
// demangled: RBX::BodyGyro::BodyGyro(void)
...
// demangled: RBX::BodyGyro::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
pub fn stub_557a64() -> ! {
    todo!("0x557a64 __ZN3RBX8BodyGyro16computeForceImplEbPNS_4BodyES2_RN3G3D7Vector3ES5_")
}

// 0x557c50 — __ZN3RBX8BodyGyro20computeBalanceTorqueEPNS_4BodyES2_
// demangled: RBX::BodyGyro::computeBalanceTorque(RBX::Body *,RBX::Body *)
...
// demangled: RBX::BodyGyro::computeOrientationTorque(RBX::Body *,RBX::Body *)
// type: _DWORD __fastcall(RBX::BodyGyro *__hidden this, RBX::Body *, RBX::Body *)
...
// demangled: RBX::BodyPosition::BodyPosition(void)
...
// demangled: RBX::BodyPosition::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
// demangled: RBX::BodyPosition::onStepped(RBX::Stepped const&)
...
// demangled: RBX::BodyVelocity::BodyVelocity(void)
...
// demangled: RBX::BodyVelocity::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
// demangled: RBX::BodyAngularVelocity::BodyAngularVelocity(void)
...
// demangled: RBX::BodyAngularVelocity::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
// demangled: RBX::BodyForce::BodyForce(void)
...
// demangled: RBX::BodyForce::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
// demangled: RBX::BodyThrust::BodyThrust(void)
...
// demangled: RBX::BodyThrust::computeForceImpl(bool,RBX::Body *,RBX::Body *,G3D::Vector3 &,G3D::Vector3 &)
...
// demangled: RBX::Rocket::getTargetDangerous(void)const
// type: _DWORD __fastcall(RBX::Rocket *__hidden this)
...
// demangled: RBX::Rocket::onGoalChanged(RBX::Reflection::PropertyDescriptor const&)
...
pub fn stub_559474() -> ! {
    todo!("0x559474 __ZN3RBX6Rocket13onGoalChangedERKNS_10Reflection18PropertyDescriptorE")
}
...
// demangled: RBX::Body::getBranchForce(void)const
...
// demangled: RBX::Body::getBranchTorque(void)const
// type: _DWORD __fastcall(RBX::Body *__hidden this)
...
// demangled: RBX::BodyPosition::onGoalChanged(RBX::Reflection::PropertyDescriptor const&)
...
pub fn stub_5595a4() -> ! {
    todo!("0x5595a4 __ZN3RBX12BodyPosition13onGoalChangedERKNS_10Reflection18PropertyDescriptorE")
}

// 0x5595ac — __ZN3RBX12BodyPosition12getLastForceEv
// demangled: RBX::BodyPosition::getLastForce(void)
// type: _DWORD __fastcall(RBX::BodyPosition *__hidden this)
