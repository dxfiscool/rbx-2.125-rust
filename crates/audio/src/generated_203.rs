//! audio generated_203 — 150 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 150 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4b1834..0x4b6c78 | existing 27413 -> 27563 distinct
...
pub fn stub_4b1834() {
    // IDA 0x4b1834: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b18d8() {
    // IDA 0x4b18d8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b18e0() {
    // IDA 0x4b18e0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b1984 — __ZN5boost10shared_ptrIN3RBX11CustomEventEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_
// demangled: boost::shared_ptr<RBX::CustomEvent>::shared_ptr<RBX::CustomEvent,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4b1a4c() {
    // IDA 0x4b1a4c: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}

// 0x4b1b34 — __ZN5boost6detail12shared_countC2IPN3RBX11CustomEventENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
// demangled: boost::detail::shared_count::shared_count<RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4b1b34() {
    // IDA 0x4b1b34: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x4b1c3c — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX11CustomEventENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
...
pub fn stub_4b1c3c() {
    // IDA 0x4b1c3c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b1c40() {
    // IDA 0x4b1c40: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b1c44 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX11CustomEventENS2_9CreatableINS2_8InstanceEE7DeleterEE7disposeEv
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
pub fn stub_4b1c44() {
    // IDA 0x4b1c44: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
...
pub fn stub_4b1c64() {
    // IDA 0x4b1c64: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEvent *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
...
pub fn stub_4b1c7c() {
    // IDA 0x4b1c7c: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_4b1fd4() {
    // IDA 0x4b1fd4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::shared_ptr<RBX::CustomEventReceiver> RBX::Creatable<RBX::Instance>::create<RBX::CustomEventReceiver>(void)
...
// 0x4b22d0 — __ZN3RBX19CustomEventReceiverC2Ev
// demangled: RBX::CustomEventReceiver::CustomEventReceiver(void)
...
// demangled: rbx::signals::connection rbx::signals::signal<void ()(float)>::connect<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>>>(boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>> const&)
...
// 0x4b26f4 — __ZN3RBX19CustomEventReceiver15setCurrentValueEf
// demangled: RBX::CustomEventReceiver::setCurrentValue(float)
...
// demangled: RBX::CustomEventReceiver::askForbidChild(RBX::Instance const*)const
...
// demangled: RBX::CustomEventReceiver::askSetParent(RBX::Instance const*)const
// type: _DWORD __fastcall(RBX::CustomEventReceiver *__hidden this, const RBX::Instance *)
...
pub fn stub_4b276c() -> ! {
    todo!("0x4b276c __ZNK3RBX19CustomEventReceiver12askSetParentEPKNS_8InstanceE")
}
...
pub fn stub_4b27b8() {
    // IDA 0x4b27b8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x4b283c — __ZN3rbx7signals6signalIFvfEE13disconnectAllEv
// demangled: rbx::signals::signal<void ()(float)>::disconnectAll(void)
...
pub fn stub_4b283c() -> ! {
    todo!("0x4b283c __ZN3rbx7signals6signalIFvfEE13disconnectAllEv")
}

// 0x4b29b4 — __ZN5boost13intrusive_ptrIN3rbx7signals6signalIFvfEE4slotEEaSERKS7_
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(float)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(float)>::slot> const&)
...
// 0x4b29d8 — __ZN3rbx7signals6signalIFvfEE22safe_static_init_mutexEv
// demangled: rbx::signals::signal<void ()(float)>::safe_static_init_mutex(void)
...
pub fn stub_4b29d8() -> ! {
    todo!("0x4b29d8 __ZN3rbx7signals6signalIFvfEE22safe_static_init_mutexEv")
}

// 0x4b29dc — __ZN3rbx7signals6signalIFvfEE24safe_static_do_get_mutexEv
// demangled: rbx::signals::signal<void ()(float)>::safe_static_do_get_mutex(void)
...
pub fn stub_4b29dc() -> ! {
    todo!("0x4b29dc __ZN3rbx7signals6signalIFvfEE24safe_static_do_get_mutexEv")
}

// 0x4b2ad4 — __ZN3rbx7signals6signalIFvfEE6insertEPNS3_4slotE
// demangled: rbx::signals::signal<void ()(float)>::insert(rbx::signals::signal<void ()(float)>::slot *)
...
pub fn stub_4b2ad4() -> ! {
    todo!("0x4b2ad4 __ZN3rbx7signals6signalIFvfEE6insertEPNS3_4slotE")
}

// 0x4b2ce0 — __ZN5boost13intrusive_ptrIN3rbx7signals6signalIFvfEE4slotEEaSEPS6_
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(float)>::slot>::operator=(rbx::signals::signal<void ()(float)>::slot*)
...
// demangled: rbx::signals::signal<void ()(float)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>>>::~callable_slot()
...
pub fn stub_4b2d04() {
    // IDA 0x4b2d04: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b2d30() {
    // IDA 0x4b2d30: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b2e04 — __ZN3rbx7signals6signalIFvfEE4slot10disconnectEv
// demangled: rbx::signals::signal<void ()(float)>::slot::disconnect(void)
#[doc(alias = "rbx::signals::signal<void ()(float)>::slot::disconnect(void)")]
#[doc(alias = "__ZN3rbx7signals6signalIFvfEE4slot10disconnectEv")]
pub fn stub_4b2e04() -> ! {
    todo!("0x4b2e04 __ZN3rbx7signals6signalIFvfEE4slot10disconnectEv")
}

// 0x4b2f14 — __ZNK3rbx7signals6signalIFvfEE4slot9connectedEv
// demangled: rbx::signals::signal<void ()(float)>::slot::connected(void)const
...
pub fn stub_4b2f14() -> ! {
    todo!("0x4b2f14 __ZNK3rbx7signals6signalIFvfEE4slot9connectedEv")
}
...
// demangled: rbx::callable<rbx::signals::signal<void ()(float)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>>,1,void ()(float)>::call(float)
...
// demangled: non-virtual thunk to rbx::callable<rbx::signals::signal<void ()(float)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>>,1,void ()(float)>::call(float)
...
pub fn stub_4b2f34() {
    // IDA 0x4b2f34: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: void boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>>::operator()<float>(float &)
...
// 0x4b2f68 — __ZN3rbx7signals6signalIFvfEE6removeEPNS3_4slotE
// demangled: rbx::signals::signal<void ()(float)>::remove(rbx::signals::signal<void ()(float)>::slot *)
...
pub fn stub_4b2f68() -> ! {
    todo!("0x4b2f68 __ZN3rbx7signals6signalIFvfEE6removeEPNS3_4slotE")
}

// 0x4b3058 — __ZN3rbx7signals6signalIFvfEE4slot22safe_static_init_mutexEv
// demangled: rbx::signals::signal<void ()(float)>::slot::safe_static_init_mutex(void)
...
pub fn stub_4b3058() -> ! {
    todo!("0x4b3058 __ZN3rbx7signals6signalIFvfEE4slot22safe_static_init_mutexEv")
}

// 0x4b305c — __ZN3rbx7signals6signalIFvfEE4slot24safe_static_do_get_mutexEv
// demangled: rbx::signals::signal<void ()(float)>::slot::safe_static_do_get_mutex(void)
...
pub fn stub_4b305c() -> ! {
    todo!("0x4b305c __ZN3rbx7signals6signalIFvfEE4slot24safe_static_do_get_mutexEv")
}

// 0x4b314c — __ZN3rbx7signals6signalIFvfEE4slotD1Ev
// demangled: rbx::signals::signal<void ()(float)>::slot::~slot()
// type: int __fastcall(int)
#[doc(alias = "rbx::signals::signal<void ()(float)>::slot::~slot()")]
#[doc(alias = "__ZN3rbx7signals6signalIFvfEE4slotD1Ev")]
pub fn stub_4b314c() {
    // IDA 0x4b314c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b3178 — __ZN3rbx7signals6signalIFvfEE4slotD0Ev
// demangled: rbx::signals::signal<void ()(float)>::slot::~slot()
#[doc(alias = "rbx::signals::signal<void ()(float)>::slot::~slot()")]
#[doc(alias = "__ZN3rbx7signals6signalIFvfEE4slotD0Ev")]
pub fn stub_4b3178() {
    // IDA 0x4b3178: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: rbx::callable<rbx::signals::signal<void ()(float)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::CustomEventReceiver,float>,boost::_bi::list2<boost::_bi::value<RBX::CustomEventReceiver*>,boost::arg<1>>>,1,void ()(float)>::~callable()
...
pub fn stub_4b324c() {
    // IDA 0x4b324c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b3278() {
    // IDA 0x4b3278: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b346c() {
    // IDA 0x4b346c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b3470() {
    // IDA 0x4b3470: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b3510() {
    // IDA 0x4b3510: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b3518() {
    // IDA 0x4b3518: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b35bc() {
    // IDA 0x4b35bc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b35c4() {
    // IDA 0x4b35c4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b3668 — __ZN5boost10shared_ptrIN3RBX19CustomEventReceiverEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_
// demangled: boost::shared_ptr<RBX::CustomEventReceiver>::shared_ptr<RBX::CustomEventReceiver,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4b3730() {
    // IDA 0x4b3730: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}

// 0x4b3818 — __ZN5boost6detail12shared_countC2IPN3RBX19CustomEventReceiverENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
// demangled: boost::detail::shared_count::shared_count<RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int __fastcall(int, int, int, int, void *, int)
...
pub fn stub_4b3818() {
    // IDA 0x4b3818: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x4b3920 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX19CustomEventReceiverENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
...
pub fn stub_4b3920() {
    // IDA 0x4b3920: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b3924() {
    // IDA 0x4b3924: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
pub fn stub_4b3928() {
    // IDA 0x4b3928: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
...
pub fn stub_4b3948() {
    // IDA 0x4b3948: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::CustomEventReceiver *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
...
pub fn stub_4b3960() {
    // IDA 0x4b3960: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::StarterGuiService::CoreGuiType> const>::doGetSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::StarterGuiService::CoreGuiType>::~EnumDesc()
...
pub fn stub_4b3da8() {
    // IDA 0x4b3da8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b3dac() {
    // IDA 0x4b3dac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b3f80 — __ZNK3RBX10Reflection8EnumDescINS_17StarterGuiService11CoreGuiTypeEE15convertToStringEmRSs
// demangled: RBX::Reflection::EnumDesc<RBX::StarterGuiService::CoreGuiType>::convertToString(unsigned long,std::string &)const
...
// 0x4b40c4 — __ZN3rbx14implementation12typed_holderIN3RBX17StarterGuiService11CoreGuiTypeEE14construct_funcEPKcPc
// demangled: rbx::implementation::typed_holder<RBX::StarterGuiService::CoreGuiType>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::StarterGuiService::CoreGuiType>::convertToItem(RBX::StarterGuiService::CoreGuiType const&)const
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType> const>::doGetSingleton(void)
// type: void *()
...
pub fn stub_4b4290() {
    // IDA 0x4b4290: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b4294() {
    // IDA 0x4b4294: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b4468() {
    // IDA 0x4b4468: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b4508 — __ZNK3RBX10Reflection8EnumDescINS_11HttpService15HttpContentTypeEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::convertToString(RBX::HttpService::HttpContentType const&)const
...
// 0x4b4898 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_11HttpService15HttpContentTypeEEERS3_RKT_
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::HttpService::HttpContentType>(RBX::HttpService::HttpContentType const&)
...
// 0x4b48e8 — __ZN3rbx14implementation12typed_holderIN3RBX11HttpService15HttpContentTypeEE9singletonEv
// demangled: rbx::implementation::typed_holder<RBX::HttpService::HttpContentType>::singleton(void)
...
// 0x4b4954 — __ZN3rbx14implementation12typed_holderIN3RBX11HttpService15HttpContentTypeEE14construct_funcEPKcPc
// demangled: rbx::implementation::typed_holder<RBX::HttpService::HttpContentType>::construct_func(char const*,char *)
...
// 0x4b4960 — __ZN3rbx14implementation12typed_holderIN3RBX11HttpService15HttpContentTypeEE13destruct_funcEPc
...
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::convertToItem(RBX::HttpService::HttpContentType const&)const
...
// 0x4b4a30 — __ZN3rbx8any_castIRKN3RBX11HttpService15HttpContentTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE
// demangled: RBX::HttpService::HttpContentType const& rbx::any_cast<RBX::HttpService::HttpContentType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::convertToValue(RBX::Name const&,RBX::HttpService::HttpContentType&)const
...
pub fn stub_4b4b9c() {
    // IDA 0x4b4b9c: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4b4bc4 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_12AssetService10AccessTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::AssetService::AccessType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::AssetService::AccessType> const>::doGetSingleton(void)
...
pub fn stub_4b4cb8() {
    // IDA 0x4b4cb8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b4cbc() {
    // IDA 0x4b4cbc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b4e90() {
    // IDA 0x4b4e90: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b4f30 — __ZNK3RBX10Reflection8EnumDescINS_12AssetService10AccessTypeEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::convertToString(RBX::AssetService::AccessType const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::AssetService::AccessType>(RBX::AssetService::AccessType const&)
...
// demangled: rbx::implementation::typed_holder<RBX::AssetService::AccessType>::singleton(void)
...
// demangled: rbx::implementation::typed_holder<RBX::AssetService::AccessType>::construct_func(char const*,char *)
...
// demangled: rbx::implementation::typed_holder<RBX::AssetService::AccessType>::destruct_func(char *)
// type: void()
...
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::convertToItem(RBX::AssetService::AccessType const&)const
...
// demangled: RBX::AssetService::AccessType const& rbx::any_cast<RBX::AssetService::AccessType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::AssetService::AccessType>::convertToValue(RBX::Name const&,RBX::AssetService::AccessType&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::AssetService::AccessType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::AssetService::AccessType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::AssetService::AccessType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::AssetService::AccessType>> *)
...
pub fn stub_4b55c4() {
    // IDA 0x4b55c4: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4b55ec — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_11InputObject14UserInputStateEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState> const>::doGetSingleton(void)
...
pub fn stub_4b56e0() {
    // IDA 0x4b56e0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b56e4() {
    // IDA 0x4b56e4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b58b8() {
    // IDA 0x4b58b8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b5958 — __ZNK3RBX10Reflection8EnumDescINS_11InputObject14UserInputStateEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::convertToString(RBX::InputObject::UserInputState const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::InputObject::UserInputState>(RBX::InputObject::UserInputState const&)
...
// demangled: rbx::implementation::typed_holder<RBX::InputObject::UserInputState>::singleton(void)
...
// demangled: rbx::implementation::typed_holder<RBX::InputObject::UserInputState>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::convertToItem(RBX::InputObject::UserInputState const&)const
...
// demangled: RBX::InputObject::UserInputState const& rbx::any_cast<RBX::InputObject::UserInputState const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputState>::convertToValue(RBX::Name const&,RBX::InputObject::UserInputState&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::InputObject::UserInputState>,std::_Select1st<std::pair<RBX::Name const* const,RBX::InputObject::UserInputState>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::InputObject::UserInputState>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::InputObject::UserInputState>> *)
...
pub fn stub_4b5fec() {
    // IDA 0x4b5fec: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4b6014 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_11InputObject13UserInputTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType> const>::doGetSingleton(void)
...
pub fn stub_4b6108() {
    // IDA 0x4b6108: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b610c() {
    // IDA 0x4b610c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4b62e0() {
    // IDA 0x4b62e0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b6380 — __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::lookup(char const*)const
...
pub fn stub_4b6380() -> ! {
    todo!("0x4b6380 __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE6lookupEPKc")
}

// 0x4b63b0 — __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE6lookupERKNS0_7VariantE
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::lookup(RBX::Reflection::Variant const&)const
...
pub fn stub_4b63b0() -> ! {
    todo!("0x4b63b0 __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE6lookupERKNS0_7VariantE")
}

// 0x4b63d0 — __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE14convertToValueEmRNS0_7VariantE
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
pub fn stub_4b63d0() -> ! {
    todo!("0x4b63d0 __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE14convertToValueEmRNS0_7VariantE")
}

// 0x4b642c — __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE15convertToStringEmRSs
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::convertToString(unsigned long,std::string &)const
...
pub fn stub_4b642c() -> ! {
    todo!("0x4b642c __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE15convertToStringEmRSs")
}

// 0x4b6570 — __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE15convertToStringERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::convertToString(RBX::InputObject::UserInputType const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
pub fn stub_4b6570() -> ! {
    todo!("0x4b6570 __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE15convertToStringERKS3_")
}

// 0x4b6710 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_11InputObject13UserInputTypeEEERS3_RKT_
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::InputObject::UserInputType>(RBX::InputObject::UserInputType const&)
...
// demangled: rbx::implementation::typed_holder<RBX::InputObject::UserInputType>::singleton(void)
...
// demangled: rbx::implementation::typed_holder<RBX::InputObject::UserInputType>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::convertToItem(RBX::InputObject::UserInputType const&)const
...
pub fn stub_4b67dc() -> ! {
    todo!("0x4b67dc __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE13convertToItemERKS3_")
}

// 0x4b68a8 — __ZN3rbx8any_castIRKN3RBX11InputObject13UserInputTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE
// demangled: RBX::InputObject::UserInputType const& rbx::any_cast<RBX::InputObject::UserInputType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::InputObject::UserInputType>::convertToValue(RBX::Name const&,RBX::InputObject::UserInputType&)const
...
pub fn stub_4b6998() -> ! {
    todo!("0x4b6998 __ZNK3RBX10Reflection8EnumDescINS_11InputObject13UserInputTypeEE14convertToValueERKNS_4NameERS3_")
}
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::InputObject::UserInputType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::InputObject::UserInputType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::InputObject::UserInputType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::InputObject::UserInputType>> *)
...
pub fn stub_4b6a14() {
    // IDA 0x4b6a14: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4b6a3c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_9Explosion13ExplosionTypeEEEE14doGetSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Explosion::ExplosionType> const>::doGetSingleton(void)
...
pub fn stub_4b6a3c() -> ! {
    todo!("0x4b6a3c __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_9Explosion13ExplosionTypeEEEE14doGetSingletonEv")
}
...
pub fn stub_4b6b2c() {
    // IDA 0x4b6b2c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4b6bcc — __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::Explosion::ExplosionType>::lookup(char const*)const
...
pub fn stub_4b6bcc() -> ! {
    todo!("0x4b6bcc __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE6lookupEPKc")
}

// 0x4b6bfc — __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE6lookupERKNS0_7VariantE
// demangled: RBX::Reflection::EnumDesc<RBX::Explosion::ExplosionType>::lookup(RBX::Reflection::Variant const&)const
...
pub fn stub_4b6bfc() -> ! {
    todo!("0x4b6bfc __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE6lookupERKNS0_7VariantE")
}

// 0x4b6c1c — __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE14convertToValueEmRNS0_7VariantE
// demangled: RBX::Reflection::EnumDesc<RBX::Explosion::ExplosionType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
pub fn stub_4b6c1c() -> ! {
    todo!("0x4b6c1c __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE14convertToValueEmRNS0_7VariantE")
}

// 0x4b6c78 — __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE15convertToStringERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Explosion::ExplosionType>::convertToString(RBX::Explosion::ExplosionType const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
pub fn stub_4b6c78() -> ! {
    todo!("0x4b6c78 __ZNK3RBX10Reflection8EnumDescINS_9Explosion13ExplosionTypeEE15convertToStringERKS3_")
}