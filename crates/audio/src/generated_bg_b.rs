//! audio generated_bg_b — global gap filler batch B — next 100 EA not yet in crates/audio/src, EA-sorted asc
//! Filter: global gap filler skeleton batch B — EA-sorted asc skip audio existing, rbx_core::SharedPtr not boost::shared_ptr
//! Batch: 100 stubs | skeleton batch | range 0x2528e0..0x25a170 EA-sorted asc batch B (audio gap filler, global next 100 after bg_a)
...
#[doc(alias = "__ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_9gregorian8bad_yearEEEE5cloneEv")]
pub fn stub_253178() -> ! {
...
pub fn stub_254824() -> ! {
    todo!("0x254824 RBX::MacSystemUtil::getGPUMake(void)")
}
...
pub fn stub_2549ec() -> ! {
    todo!("0x2549ec RBX::MacSystemUtil::getMaxRes(void)")
}
...
pub fn stub_254bf8() -> ! {
    todo!("0x254bf8 RBX::IsValueOutlier(double,unsigned int,double,double,RBX::Confidence)")
}
...
pub fn stub_254c68() -> ! {
    todo!("0x254c68 RBX::GetConfidenceInterval(double,double,RBX::Confidence,double *,double *)")
}
...
pub fn stub_254d18() -> ! {
    todo!("0x254d18 RBX::TCritical(unsigned int,RBX::Confidence)")
}
...
#[doc(alias = "__ZN13CookiesEngine8SetValueESsSs")]
pub fn stub_254e20() -> ! {
    todo!("0x254e20 CookiesEngine::SetValue(std::string,std::string)")
}
...
#[doc(alias = "__ZN13CookiesEngine18getCookiesFilePathEv")]
pub fn stub_254e98() -> ! {
    todo!("0x254e98 CookiesEngine::getCookiesFilePath(void)")
}
...
#[doc(alias = "__ZN13CookiesEngineC1ESbIwSt11char_traitsIwESaIwEE")]
pub fn stub_255070() -> ! {
    todo!("0x255070 CookiesEngine::CookiesEngine(std::basic_string<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t>>)")
}
...
#[doc(alias = "__ZN13CookiesEngine8GetValueESsPiPb")]
pub fn stub_255098() -> ! {
    todo!("0x255098 CookiesEngine::GetValue(std::string,int *,bool *)")
}
...
#[doc(alias = "__ZN13CookiesEngine11DeleteValueESs")]
pub fn stub_25529c() -> ! {
    todo!("0x25529c CookiesEngine::DeleteValue(std::string)")
}

// 0x2552f0 — __GLOBAL__I_a_54
// type: int()
#[doc(alias = "global constructor keyed to_a_54")]
#[doc(alias = "__GLOBAL__I_a_54")]
pub fn stub_2552f0() -> ! {
...
#[doc(alias = "__Z11convert_w2sRKSbIwSt11char_traitsIwESaIwEE")]
pub fn stub_255320() -> ! {
    todo!("0x255320 convert_w2s(std::basic_string<wchar_t,std::char_traits<wchar_t>,std::allocator<wchar_t>> const&)")
}

// 0x255474 — __Z11convert_s2wRKSs
// type: void __fastcall(const std::string *, char **)
#[doc(alias = "convert_s2w(std::string const&)")]
#[doc(alias = "__Z11convert_s2wRKSs")]
pub fn stub_255474() -> ! {
    todo!("0x255474 convert_s2w(std::string const&)")
}

// 0x2555bc — __Z7vformatPKcPv
// type: int __fastcall(std::string *, char *__format, va_list)
#[doc(alias = "vformat(char const*,void *)")]
#[doc(alias = "__Z7vformatPKcPv")]
pub fn stub_2555bc() -> ! {
    todo!("0x2555bc vformat(char const*,void *)")
}

// 0x2557cc — __Z13format_stringPKcz
// type: int(std::string *, char *, ...)
#[doc(alias = "format_string(char const*,...)")]
#[doc(alias = "__Z13format_stringPKcz")]
pub fn stub_2557cc() -> ! {
    todo!("0x2557cc format_string(char const*,...)")
}
...
#[doc(alias = "__ZN10SimpleJSON14ReadFromStreamEPKc")]
pub fn stub_2557ec() -> ! {
    todo!("0x2557ec SimpleJSON::ReadFromStream(char const*)")
}

// 0x255c70 — __ZL14needTrimSymbolc
// type: unsigned int __fastcall(char)
#[doc(alias = "needTrimSymbol(char)")]
#[doc(alias = "__ZL14needTrimSymbolc")]
pub fn stub_255c70() -> ! {
    todo!("0x255c70 needTrimSymbol(char)")
}
...
#[doc(alias = "__ZN10SimpleJSON9ParseBoolEPKc")]
pub fn stub_255c8c() -> ! {
    todo!("0x255c8c SimpleJSON::ParseBool(char const*)")
}
...
pub fn stub_257a10() {
    // IDA 0x257a10: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_257a50() {
    // IDA 0x257a50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_258800() {
    // IDA 0x258800: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
pub fn stub_2588e8() {
    // IDA 0x2588e8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_2589f0() {
    // IDA 0x2589f0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2589f4() {
    // IDA 0x2589f4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_2589f8() {
    // IDA 0x2589f8: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_258a18() {
    // IDA 0x258a18: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_258a30() {
    // IDA 0x258a30: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
#[doc(alias = "__ZNSt6vectorIN3RBX11HttpService15HttpContentTypeESaIS2_EE6resizeEmS2_")]
pub fn stub_258fbc() -> ! {
...
#[doc(alias = "__ZNSt6vectorIN3RBX11HttpService15HttpContentTypeESaIS2_EE9push_backERKS2_")]
pub fn stub_258ff0() -> ! {
...
#[doc(alias = "__ZNSt3mapIPKN3RBX4NameENS0_11HttpService15HttpContentTypeESt4lessIS3_ESaISt4pairIKS3_S5_EEEixERS9_")]
pub fn stub_259018() -> ! {
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_11HttpService15HttpContentTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS8_ERKS8_")]
pub fn stub_259070() -> ! {
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_11HttpService15HttpContentTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE9_M_insertEPSt18_Rb_tree_node_baseSG_RKS8_")]
pub fn stub_259124() -> ! {
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_11HttpService15HttpContentTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE16_M_insert_uniqueERKS8_")]
pub fn stub_25917c() -> ! {
...
#[doc(alias = "__ZNSt6vectorIN3RBX11HttpService15HttpContentTypeESaIS2_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS2_S4_EERKS2_")]
pub fn stub_2591e4() -> ! {
...
#[doc(alias = "__ZNSt12_Vector_baseIN3RBX11HttpService15HttpContentTypeESaIS2_EE11_M_allocateEm")]
pub fn stub_2592c8() -> ! {
...
#[doc(alias = "__ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX11HttpService15HttpContentTypeES6_EET0_T_S8_S7_")]
pub fn stub_2592e0() -> ! {
...
#[doc(alias = "__ZNSt6vectorIN3RBX11HttpService15HttpContentTypeESaIS2_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS2_S4_EEmRKS2_")]
pub fn stub_25931c() -> ! {
...
pub fn stub_259868() {
    // IDA 0x259868: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_259f64() {
    // IDA 0x259f64: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
