//! audio generated_99 — next 100 stubs EA-sorted, from ida/export.json
...
//! Batch: 100 stubs | skeleton batch | range 0xeeb014..0xef2c0c EA-sorted asc filler after 0xeeadec, skip existing, rbx_core::SharedPtr not boost
