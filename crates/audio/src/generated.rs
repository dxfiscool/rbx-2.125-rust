//! audio generated — 250 stubs sorted by EA, from ida/export.json
//! Filter: FMOD/Sound/Audio (2541 total, 2541 distinct EA) — 2011 distinct EA (2157 stubs) prior in lib.rs + 250 this batch = 2261 distinct (2407 stubs) total, 280 distinct remaining
//! Batch: 0x376198..0x37e05c | SharedPtr = rbx_core::SharedPtr (Arc) not boost::shared_ptr | strip '
