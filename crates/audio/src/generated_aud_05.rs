// Auto-generated skeletons for rbx-audio — gap filler (global EA-sorted, aud_05)
...
// Batch: +120 stubs | range 0x3971b4..0x39dbec | audio 23022 -> 23142 distinct
...
pub fn stub_3971b4() {
    // IDA 0x3971b4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3972ac() {
    // IDA 0x3972ac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3972bc() {
    // IDA 0x3972bc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3973a0() {
    // IDA 0x3973a0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_39750c() {
    // IDA 0x39750c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_397510() {
    // IDA 0x397510: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3975b0() {
    // IDA 0x3975b0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3975b8() {
    // IDA 0x3975b8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_39765c() {
    // IDA 0x39765c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_39798c() -> ! {
    todo!("0x39798c RBX::Reflection::TypedPropertyDescriptor<RBX::AnimationId>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_397b38() -> ! {
    todo!("0x397b38 RBX::Reflection::TypedPropertyDescriptor<RBX::AnimationId>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_397c64() -> ! {
    todo!("0x397c64 RBX::Reflection::TypedPropertyDescriptor<RBX::AnimationId>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_397e60() -> ! {
    todo!("0x397e60 RBX::Reflection::TypedPropertyDescriptor<RBX::AnimationId>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_3980d0() -> ! {
    todo!("0x3980d0 RBX::Reflection::PropDescriptor<RBX::Animation,RBX::AnimationId>::GetSetImpl<RBX::AnimationId (RBX::Animation::*)(void)const,void (RBX::Animation::*)(RBX::AnimationId)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_3980f8() -> ! {
    todo!("0x3980f8 RBX::Reflection::PropDescriptor<RBX::Animation,RBX::AnimationId>::GetSetImpl<RBX::AnimationId (RBX::Animation::*)(void)const,void (RBX::Animation::*)(RBX::AnimationId)>::setValue(RBX::Reflection::DescribedBase *,RBX::AnimationId const&)const")
}
...
pub fn stub_398e80() {
    // IDA 0x398e80: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_398f20() {
    // IDA 0x398f20: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_398f24() {
    // IDA 0x398f24: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_398f2c() {
    // IDA 0x398f2c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_398f34() {
    // IDA 0x398f34: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3991a8() {
    // IDA 0x3991a8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3991b0() {
    // IDA 0x3991b0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
