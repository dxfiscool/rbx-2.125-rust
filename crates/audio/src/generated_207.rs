//! audio generated_207 — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4c3d10..0x4c7570 | existing 27913 -> 28013 distinct
...
// demangled: rbx::implementation::typed_holder<RBX::Handles::VisualStyle>::singleton(void)
...
// demangled: rbx::implementation::typed_holder<RBX::Handles::VisualStyle>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Handles::VisualStyle>::convertToItem(RBX::Handles::VisualStyle const&)const
...
// demangled: RBX::Handles::VisualStyle const& rbx::any_cast<RBX::Handles::VisualStyle const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
pub fn stub_4c3e58() -> ! {
    todo!("0x4c3e58 __ZN3rbx8any_castIRKN3RBX7Handles11VisualStyleENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x4c3f48 — __ZNK3RBX10Reflection8EnumDescINS_7Handles11VisualStyleEE14convertToValueERKNS_4NameERS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Handles::VisualStyle>::convertToValue(RBX::Name const&,RBX::Handles::VisualStyle&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::Handles::VisualStyle>,std::_Select1st<std::pair<RBX::Name const* const,RBX::Handles::VisualStyle>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Handles::VisualStyle>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::Handles::VisualStyle>> *)
...
pub fn stub_4c3fc4() -> ! {
    todo!("0x4c3fc4 __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_7Handles11VisualStyleEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")
}

// 0x4c3fec — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_13FriendService15FriendEventTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType> const>::doGetSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::convertToString(RBX::FriendService::FriendEventType const&)const
...
// 0x4c46e8 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_13FriendService15FriendEventTypeEEERS3_RKT_
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::FriendService::FriendEventType>(RBX::FriendService::FriendEventType const&)
...
pub fn stub_4c46e8() -> ! {
    todo!("0x4c46e8 __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_13FriendService15FriendEventTypeEEERS3_RKT_")
}

// 0x4c4738 — __ZN3rbx14implementation12typed_holderIN3RBX13FriendService15FriendEventTypeEE9singletonEv
// demangled: rbx::implementation::typed_holder<RBX::FriendService::FriendEventType>::singleton(void)
...
pub fn stub_4c4738() -> ! {
    todo!("0x4c4738 __ZN3rbx14implementation12typed_holderIN3RBX13FriendService15FriendEventTypeEE9singletonEv")
}

// 0x4c47a4 — __ZNK3RBX10Reflection8EnumDescINS_13FriendService15FriendEventTypeEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::convertToItem(RBX::FriendService::FriendEventType const&)const
...
// 0x4c4870 — __ZN3rbx8any_castIRKN3RBX13FriendService15FriendEventTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE
// demangled: RBX::FriendService::FriendEventType const& rbx::any_cast<RBX::FriendService::FriendEventType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
pub fn stub_4c4870() -> ! {
    todo!("0x4c4870 __ZN3rbx8any_castIRKN3RBX13FriendService15FriendEventTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x4c4960 — __ZNK3RBX10Reflection8EnumDescINS_13FriendService15FriendEventTypeEE14convertToValueERKNS_4NameERS3_
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::convertToValue(RBX::Name const&,RBX::FriendService::FriendEventType&)const
...
pub fn stub_4c49dc() -> ! {
    todo!("0x4c49dc __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_13FriendService15FriendEventTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")
}

// 0x4c4a04 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_13FriendService12FriendStatusEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus> const>::doGetSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::convertToString(RBX::FriendService::FriendStatus const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::FriendService::FriendStatus>(RBX::FriendService::FriendStatus const&)
...
pub fn stub_4c5100() -> ! {
    todo!("0x4c5100 __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_13FriendService12FriendStatusEEERS3_RKT_")
}

// 0x4c5150 — __ZN3rbx14implementation12typed_holderIN3RBX13FriendService12FriendStatusEE9singletonEv
// demangled: rbx::implementation::typed_holder<RBX::FriendService::FriendStatus>::singleton(void)
...
pub fn stub_4c5150() -> ! {
    todo!("0x4c5150 __ZN3rbx14implementation12typed_holderIN3RBX13FriendService12FriendStatusEE9singletonEv")
}

// 0x4c51bc — __ZN3rbx14implementation12typed_holderIN3RBX13FriendService12FriendStatusEE14construct_funcEPKcPc
// demangled: rbx::implementation::typed_holder<RBX::FriendService::FriendStatus>::construct_func(char const*,char *)
...
pub fn stub_4c51bc() -> ! {
    todo!("0x4c51bc __ZN3rbx14implementation12typed_holderIN3RBX13FriendService12FriendStatusEE14construct_funcEPKcPc")
}
...
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::convertToItem(RBX::FriendService::FriendStatus const&)const
...
// demangled: RBX::FriendService::FriendStatus const& rbx::any_cast<RBX::FriendService::FriendStatus const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
pub fn stub_4c5298() -> ! {
    todo!("0x4c5298 __ZN3rbx8any_castIRKN3RBX13FriendService12FriendStatusENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x4c5388 — __ZNK3RBX10Reflection8EnumDescINS_13FriendService12FriendStatusEE14convertToValueERKNS_4NameERS3_
// demangled: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::convertToValue(RBX::Name const&,RBX::FriendService::FriendStatus&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>> *)
...
pub fn stub_4c5404() -> ! {
    todo!("0x4c5404 __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_13FriendService12FriendStatusEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")
}

// 0x4c542c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_15PyramidInstance12NumSidesEnumEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum> const>::doGetSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::convertToString(RBX::PyramidInstance::NumSidesEnum const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::PyramidInstance::NumSidesEnum>(RBX::PyramidInstance::NumSidesEnum const&)
...
pub fn stub_4c5b28() -> ! {
    todo!("0x4c5b28 __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_15PyramidInstance12NumSidesEnumEEERS3_RKT_")
}

// 0x4c5b78 — __ZN3rbx14implementation12typed_holderIN3RBX15PyramidInstance12NumSidesEnumEE9singletonEv
// demangled: rbx::implementation::typed_holder<RBX::PyramidInstance::NumSidesEnum>::singleton(void)
...
pub fn stub_4c5b78() -> ! {
    todo!("0x4c5b78 __ZN3rbx14implementation12typed_holderIN3RBX15PyramidInstance12NumSidesEnumEE9singletonEv")
}

// 0x4c5be4 — __ZN3rbx14implementation12typed_holderIN3RBX15PyramidInstance12NumSidesEnumEE14construct_funcEPKcPc
// demangled: rbx::implementation::typed_holder<RBX::PyramidInstance::NumSidesEnum>::construct_func(char const*,char *)
...
pub fn stub_4c5be4() -> ! {
    todo!("0x4c5be4 __ZN3rbx14implementation12typed_holderIN3RBX15PyramidInstance12NumSidesEnumEE14construct_funcEPKcPc")
}
...
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::convertToItem(RBX::PyramidInstance::NumSidesEnum const&)const
...
// demangled: RBX::PyramidInstance::NumSidesEnum const& rbx::any_cast<RBX::PyramidInstance::NumSidesEnum const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
pub fn stub_4c5cc0() -> ! {
    todo!("0x4c5cc0 __ZN3rbx8any_castIRKN3RBX15PyramidInstance12NumSidesEnumENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x4c5db0 — __ZNK3RBX10Reflection8EnumDescINS_15PyramidInstance12NumSidesEnumEE14convertToValueERKNS_4NameERS3_
// demangled: RBX::Reflection::EnumDesc<RBX::PyramidInstance::NumSidesEnum>::convertToValue(RBX::Name const&,RBX::PyramidInstance::NumSidesEnum&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::PyramidInstance::NumSidesEnum>,std::_Select1st<std::pair<RBX::Name const* const,RBX::PyramidInstance::NumSidesEnum>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::PyramidInstance::NumSidesEnum>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::PyramidInstance::NumSidesEnum>> *)
...
pub fn stub_4c5e2c() -> ! {
    todo!("0x4c5e2c __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_15PyramidInstance12NumSidesEnumEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")
}

// 0x4c5e54 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_13PrismInstance12NumSidesEnumEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum> const>::doGetSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::convertToString(RBX::PrismInstance::NumSidesEnum const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::PrismInstance::NumSidesEnum>(RBX::PrismInstance::NumSidesEnum const&)
...
pub fn stub_4c6550() -> ! {
    todo!("0x4c6550 __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_13PrismInstance12NumSidesEnumEEERS3_RKT_")
}

// 0x4c65a0 — __ZN3rbx14implementation12typed_holderIN3RBX13PrismInstance12NumSidesEnumEE9singletonEv
// demangled: rbx::implementation::typed_holder<RBX::PrismInstance::NumSidesEnum>::singleton(void)
...
pub fn stub_4c65a0() -> ! {
    todo!("0x4c65a0 __ZN3rbx14implementation12typed_holderIN3RBX13PrismInstance12NumSidesEnumEE9singletonEv")
}

// 0x4c660c — __ZN3rbx14implementation12typed_holderIN3RBX13PrismInstance12NumSidesEnumEE14construct_funcEPKcPc
// demangled: rbx::implementation::typed_holder<RBX::PrismInstance::NumSidesEnum>::construct_func(char const*,char *)
...
pub fn stub_4c660c() -> ! {
    todo!("0x4c660c __ZN3rbx14implementation12typed_holderIN3RBX13PrismInstance12NumSidesEnumEE14construct_funcEPKcPc")
}
...
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::convertToItem(RBX::PrismInstance::NumSidesEnum const&)const
...
// demangled: RBX::PrismInstance::NumSidesEnum const& rbx::any_cast<RBX::PrismInstance::NumSidesEnum const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
pub fn stub_4c66e8() -> ! {
    todo!("0x4c66e8 __ZN3rbx8any_castIRKN3RBX13PrismInstance12NumSidesEnumENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x4c67d8 — __ZNK3RBX10Reflection8EnumDescINS_13PrismInstance12NumSidesEnumEE14convertToValueERKNS_4NameERS3_
// demangled: RBX::Reflection::EnumDesc<RBX::PrismInstance::NumSidesEnum>::convertToValue(RBX::Name const&,RBX::PrismInstance::NumSidesEnum&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::PrismInstance::NumSidesEnum>,std::_Select1st<std::pair<RBX::Name const* const,RBX::PrismInstance::NumSidesEnum>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::PrismInstance::NumSidesEnum>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::PrismInstance::NumSidesEnum>> *)
...
pub fn stub_4c6854() -> ! {
    todo!("0x4c6854 __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_13PrismInstance12NumSidesEnumEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")
}

// 0x4c687c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_20ExtrudedPartInstance16VisualTrussStyleEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle> const>::doGetSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::convertToString(RBX::ExtrudedPartInstance::VisualTrussStyle const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::ExtrudedPartInstance::VisualTrussStyle>(RBX::ExtrudedPartInstance::VisualTrussStyle const&)
...
pub fn stub_4c6f78() -> ! {
    todo!("0x4c6f78 __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_20ExtrudedPartInstance16VisualTrussStyleEEERS3_RKT_")
}

// 0x4c6fc8 — __ZN3rbx14implementation12typed_holderIN3RBX20ExtrudedPartInstance16VisualTrussStyleEE9singletonEv
// demangled: rbx::implementation::typed_holder<RBX::ExtrudedPartInstance::VisualTrussStyle>::singleton(void)
...
pub fn stub_4c6fc8() -> ! {
    todo!("0x4c6fc8 __ZN3rbx14implementation12typed_holderIN3RBX20ExtrudedPartInstance16VisualTrussStyleEE9singletonEv")
}

// 0x4c7034 — __ZN3rbx14implementation12typed_holderIN3RBX20ExtrudedPartInstance16VisualTrussStyleEE14construct_funcEPKcPc
// demangled: rbx::implementation::typed_holder<RBX::ExtrudedPartInstance::VisualTrussStyle>::construct_func(char const*,char *)
...
pub fn stub_4c7034() -> ! {
    todo!("0x4c7034 __ZN3rbx14implementation12typed_holderIN3RBX20ExtrudedPartInstance16VisualTrussStyleEE14construct_funcEPKcPc")
}
...
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::convertToItem(RBX::ExtrudedPartInstance::VisualTrussStyle const&)const
...
// demangled: RBX::ExtrudedPartInstance::VisualTrussStyle const& rbx::any_cast<RBX::ExtrudedPartInstance::VisualTrussStyle const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
pub fn stub_4c7110() -> ! {
    todo!("0x4c7110 __ZN3rbx8any_castIRKN3RBX20ExtrudedPartInstance16VisualTrussStyleENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x4c7200 — __ZNK3RBX10Reflection8EnumDescINS_20ExtrudedPartInstance16VisualTrussStyleEE14convertToValueERKNS_4NameERS3_
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::convertToValue(RBX::Name const&,RBX::ExtrudedPartInstance::VisualTrussStyle&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::ExtrudedPartInstance::VisualTrussStyle>,std::_Select1st<std::pair<RBX::Name const* const,RBX::ExtrudedPartInstance::VisualTrussStyle>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ExtrudedPartInstance::VisualTrussStyle>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::ExtrudedPartInstance::VisualTrussStyle>> *)
...
pub fn stub_4c727c() -> ! {
    todo!("0x4c727c __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_20ExtrudedPartInstance16VisualTrussStyleEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")
}

// 0x4c72a4 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_21PersonalServerService13PrivilegeTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType> const>::doGetSingleton(void)
// type: void *()
