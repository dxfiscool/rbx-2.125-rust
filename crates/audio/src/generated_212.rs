//! audio generated_212 — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4d55e0..0x4dbe58 | existing 28413 -> 28513 distinct
...
// demangled: RBX::Reflection::EnumDesc<RBX::ChangeHistoryService::RuntimeUndoBehavior>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::ChangeHistoryService::RuntimeUndoBehavior>::convertToString(RBX::ChangeHistoryService::RuntimeUndoBehavior const&)const
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::ChangeHistoryService::RuntimeUndoBehavior>(RBX::ChangeHistoryService::RuntimeUndoBehavior const&)
...
// demangled: rbx::implementation::typed_holder<RBX::ChangeHistoryService::RuntimeUndoBehavior>::singleton(void)
...
// demangled: RBX::ChangeHistoryService::RuntimeUndoBehavior const& rbx::any_cast<RBX::ChangeHistoryService::RuntimeUndoBehavior const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::ChangeHistoryService::RuntimeUndoBehavior>::convertToValue(RBX::Name const&,RBX::ChangeHistoryService::RuntimeUndoBehavior&)const
...
// demangled: boost::function1<void,std::exception &>::move_assign(boost::function1<void,std::exception &>&)
