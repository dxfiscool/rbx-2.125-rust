//! audio generated_166 — next 150 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Audio|Sound (2541 distinct) exhausted — filler EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 150 stubs | skeleton batch | range 0x2c9db8..0x2d470c EA-sorted asc filler gap, rbx_core::SharedPtr not boost
...
#[doc(alias = "RBX::AdvLuaDragger::mouseDown(rbx_core::SharedPtr<RBX::PartInstance>,G3D::Vector3 const&,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>)")]
...
#[doc(alias = "RBX::AdvLuaDragTool::AdvLuaDragTool(RBX::PartInstance *,G3D::Vector3 const&,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>> const&,RBX::Workspace *,rbx_core::SharedPtr<RBX::Instance>)")]
