...
pub fn stub_0x3a2dec() {
    // IDA 0x3a2dec: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_0x3a67f4() {
    // IDA 0x3a67f4: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0x3a87dc() {
    // IDA 0x3a87dc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x3a9a98() {
    // IDA 0x3a9a98: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
