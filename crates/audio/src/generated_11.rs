//! audio generated_11 — next 120 stubs EA-sorted, from ida/export.json
...
//! Batch: 120 stubs | skeleton batch | range 0x17bc54..0x18daa0 EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
