//! audio generated_22 — next 120 stubs EA-sorted, from ida/export.json
...
//! Batch: 120 stubs | skeleton batch | range 0x211918..0x21c7e4 EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
