//! audio generated_100 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Sound|Audio exhausted (2544 distinct) — filler workspace EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0xef2dc8..0xef810c EA-sorted asc filler after 0xef2c0c, skip existing, rbx_core::SharedPtr not boost
