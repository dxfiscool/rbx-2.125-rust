//! audio generated_audio_watchdog_l — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio exhausted, global gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x549ab4..0x54e048 | existing 30913 -> 31013 distinct
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::on_error(std::exception &)
...
pub fn stub_549ab4() -> ! {
    todo!("0x549ab4 __ZN3rbx7signals6signalIFvN3RBX10GuiService10SpecialKeyESsEE8on_errorERSt9exception")
}

// 0x549adc — __ZN5boost13intrusive_ptrIN3rbx7signals6signalIFvN3RBX10GuiService10SpecialKeyESsEE4slotEEaSERKSA_
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot> const&)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::safe_static_init_mutex(void)
...
pub fn stub_549b00() -> ! {
    todo!("0x549b00 __ZN3rbx7signals6signalIFvN3RBX10GuiService10SpecialKeyESsEE22safe_static_init_mutexEv")
}

// 0x549b04 — __ZN3rbx7signals6signalIFvN3RBX10GuiService10SpecialKeyESsEE24safe_static_do_get_mutexEv
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::safe_static_do_get_mutex(void)
...
pub fn stub_549b04() -> ! {
    todo!("0x549b04 __ZN3rbx7signals6signalIFvN3RBX10GuiService10SpecialKeyESsEE24safe_static_do_get_mutexEv")
}
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::erase(boost::weak_ptr<RBX::GuiObject> const&)
#[doc(alias = "std::_Rb_tree<Weak<RBX::GuiObject>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<Weak<RBX::GuiObject>>,std::allocator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::erase(Weak<RBX::GuiObject> const&)")]
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::equal_range(boost::weak_ptr<RBX::GuiObject> const&)
#[doc(alias = "std::_Rb_tree<Weak<RBX::GuiObject>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<Weak<RBX::GuiObject>>,std::allocator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::equal_range(Weak<RBX::GuiObject> const&)")]
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::erase(std::_Rb_tree_iterator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::_Rb_tree_iterator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>)
// type: int __fastcall(int, _Rb_tree_node_base *)
#[doc(alias = "std::_Rb_tree<Weak<RBX::GuiObject>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<Weak<RBX::GuiObject>>,std::allocator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::erase(std::_Rb_tree_iterator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::_Rb_tree_iterator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>)")]
...
// demangled: void boost::function1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<boost::_bi::unspecified,boost::function<void ()(void)>,boost::_bi::list0>>(boost::_bi::bind_t<boost::_bi::unspecified,boost::function<void ()(void)>,boost::_bi::list0>)
...
// demangled: bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<boost::_bi::unspecified,boost::function<void ()(void)>,boost::_bi::list0>>(boost::_bi::bind_t<boost::_bi::unspecified,boost::function<void ()(void)>,boost::_bi::list0>,boost::detail::function::function_buffer &)const
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)
// type: int __fastcall(int, int, int)
#[doc(alias = "std::_Rb_tree<Weak<RBX::GuiObject>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<Weak<RBX::GuiObject>>,std::allocator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)")]
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "std::_Rb_tree<Weak<RBX::GuiObject>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<Weak<RBX::GuiObject>>,std::allocator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)")]
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_insert_unique(std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)
// type: int __fastcall(int, int, int)
#[doc(alias = "std::_Rb_tree<Weak<RBX::GuiObject>,std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<Weak<RBX::GuiObject>>,std::allocator<std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_insert_unique(std::pair<Weak<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)")]
...
// demangled: std::_Rb_tree<boost::weak_ptr<RBX::GuiObject>,std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>,std::_Select1st<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>,std::less<boost::weak_ptr<RBX::GuiObject>>,std::allocator<std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *>>>::_M_create_node(std::pair<boost::weak_ptr<RBX::GuiObject> const,RBX::GuiService::DialogWrapper *> const&)
...
// demangled: void boost::function0<void>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>)
// type: int __fastcall(int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, RBX::Lua::WeakFunctionRef *, int, int, int, int)
#[doc(alias = "void boost::function0<void>::assign_to<boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>)")]
...
// type: int __fastcall(int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, RBX::Lua::WeakFunctionRef *, int, int, int, int)
#[doc(alias = "bool boost::detail::function::basic_vtable0<void>::assign_to<boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>,boost::detail::function::function_buffer &)const")]
...
#[doc(alias = "void boost::detail::function::basic_vtable0<void>::assign_functor<boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
// demangled: void boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>::operator()<void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list0>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool) &,boost::_bi::list0 &,int)
// type: int __fastcall(int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "void boost::_bi::list3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>::operator()<void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool),boost::_bi::list0>(boost::_bi::type<void>,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,bool) &,boost::_bi::list0 &,int)")]
...
// demangled: boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>::list3(boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>)
// type: int __fastcall(int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: boost::_bi::storage3<boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>::storage3(boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>)
// type: int __fastcall(int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_bi::storage3<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>>::storage3(boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>,boost::_bi::value<bool>)")]
...
// demangled: boost::_bi::storage2<boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::storage2(boost::_bi::value<boost::weak_ptr<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>)
// type: int __fastcall(int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int)
#[doc(alias = "boost::_bi::storage2<boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>>::storage2(boost::_bi::value<Weak<RBX::GuiObject>>,boost::_bi::value<RBX::Lua::WeakFunctionRef>)")]
...
// demangled: std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>::list(std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>> const&)
...
// demangled: void std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>::_M_initialize_dispatch<std::_List_const_iterator<RBX::GuiService::DialogWrapper *>>(std::_List_const_iterator<RBX::GuiService::DialogWrapper *>,std::_List_const_iterator<RBX::GuiService::DialogWrapper *>,std::__false_type)
// type: std::_List_node_base *__fastcall(std::_List_node_base *result, _DWORD *, _DWORD *)
...
pub fn stub_54b530() -> ! {
    todo!("0x54b530 __ZNSt4listIPN3RBX10GuiService13DialogWrapperESaIS3_EE22_M_initialize_dispatchISt20_List_const_iteratorIS3_EEEvT_S9_St12__false_type")
}
...
// demangled: std::_Rb_tree<RBX::GuiService::CenterDialogType,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>,std::_Select1st<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>> const&)
// type: int __fastcall(int, int, int)
...
pub fn stub_54b554() -> ! {
    todo!("0x54b554 __ZNSt8_Rb_treeIN3RBX10GuiService16CenterDialogTypeESt4pairIKS2_St4listIPNS1_13DialogWrapperESaIS7_EEESt10_Select1stISA_ESt4lessIS2_ESaISA_EE16_M_insert_uniqueESt17_Rb_tree_iteratorISA_ERKSA_")
}
...
// demangled: std::_Rb_tree<RBX::GuiService::CenterDialogType,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>,std::_Select1st<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>> const&)
// type: int __fastcall(int, int, int, int)
...
pub fn stub_54b608() -> ! {
    todo!("0x54b608 __ZNSt8_Rb_treeIN3RBX10GuiService16CenterDialogTypeESt4pairIKS2_St4listIPNS1_13DialogWrapperESaIS7_EEESt10_Select1stISA_ESt4lessIS2_ESaISA_EE9_M_insertEPSt18_Rb_tree_node_baseSI_RKSA_")
}
...
// demangled: std::_Rb_tree<RBX::GuiService::CenterDialogType,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>,std::_Select1st<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::_M_insert_unique(std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>> const&)
// type: int __fastcall(int, int, int)
...
pub fn stub_54b654() -> ! {
    todo!("0x54b654 __ZNSt8_Rb_treeIN3RBX10GuiService16CenterDialogTypeESt4pairIKS2_St4listIPNS1_13DialogWrapperESaIS7_EEESt10_Select1stISA_ESt4lessIS2_ESaISA_EE16_M_insert_uniqueERKSA_")
}
...
// demangled: std::_Rb_tree<RBX::GuiService::CenterDialogType,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>,std::_Select1st<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::_M_create_node(std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>> const&)
// type: int __fastcall(int, int, int, int, void *, int)
...
// demangled: RBX::ScreenGui const* RBX::Instance::findConstFirstChildOfType<RBX::ScreenGui>(void)const
...
pub fn stub_54b7a0() -> ! {
    todo!("0x54b7a0 __ZNK3RBX8Instance25findConstFirstChildOfTypeINS_9ScreenGuiEEEPKT_v")
}

// 0x54ba48 — __ZN3RBX9CreatableINS_8InstanceEE6createINS_14CoreGuiServiceEEEN5boost10shared_ptrIT_EEv
// demangled: boost::shared_ptr<RBX::CoreGuiService> RBX::Creatable<RBX::Instance>::create<RBX::CoreGuiService>(void)
...
// demangled: boost::detail::shared_count::shared_count<RBX::CoreGuiService *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CoreGuiService *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int __fastcall(int, int, int, int, void *, int)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType> const>::initSingleton(void)
#[doc(alias = "RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType> const>::initSingleton(void)")]
#[doc(alias = "__ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService16CenterDialogTypeEEEE13initSingletonEv")]
pub fn stub_54bf8c() -> ! {
    todo!("0x54bf8c __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService16CenterDialogTypeEEEE13initSingletonEv")
}

// 0x54bf90 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService16CenterDialogTypeEEEE14doGetSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType> const>::doGetSingleton(void)
#[doc(alias = "RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType> const>::doGetSingleton(void)")]
#[doc(alias = "__ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService16CenterDialogTypeEEEE14doGetSingletonEv")]
pub fn stub_54bf90() -> ! {
    todo!("0x54bf90 __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService16CenterDialogTypeEEEE14doGetSingletonEv")
}

// 0x54c080 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService10SpecialKeyEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey> const>::initSingleton(void)
#[doc(alias = "RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey> const>::initSingleton(void)")]
#[doc(alias = "__ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService10SpecialKeyEEEE13initSingletonEv")]
pub fn stub_54c080() -> ! {
    todo!("0x54c080 __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService10SpecialKeyEEEE13initSingletonEv")
}

// 0x54c084 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService10SpecialKeyEEEE14doGetSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey> const>::doGetSingleton(void)
#[doc(alias = "RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey> const>::doGetSingleton(void)")]
#[doc(alias = "__ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService10SpecialKeyEEEE14doGetSingletonEv")]
pub fn stub_54c084() -> ! {
    todo!("0x54c084 __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_10GuiService10SpecialKeyEEEE14doGetSingletonEv")
}

// 0x54c174 — __ZN3rbx8any_castIN3RBX10GuiService16CenterDialogTypeENS1_7Region3EEEPT_PNS_13placement_anyIT0_EE
// demangled: RBX::GuiService::CenterDialogType * rbx::any_cast<RBX::GuiService::CenterDialogType,RBX::Region3>(rbx::placement_any<RBX::Region3> *)
...
#[doc(alias = "__ZN3rbx8any_castIN3RBX10GuiService16CenterDialogTypeENS1_7Region3EEEPT_PNS_13placement_anyIT0_EE")]
pub fn stub_54c174() -> ! {
    todo!("0x54c174 __ZN3rbx8any_castIN3RBX10GuiService16CenterDialogTypeENS1_7Region3EEEPT_PNS_13placement_anyIT0_EE")
}

// 0x54c1cc — __ZN3rbx8any_castIRN3RBX10GuiService16CenterDialogTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE
// demangled: RBX::GuiService::CenterDialogType & rbx::any_cast<RBX::GuiService::CenterDialogType &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
#[doc(alias = "RBX::GuiService::CenterDialogType & rbx::any_cast<RBX::GuiService::CenterDialogType &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")]
#[doc(alias = "__ZN3rbx8any_castIRN3RBX10GuiService16CenterDialogTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE")]
pub fn stub_54c1cc() -> ! {
    todo!("0x54c1cc __ZN3rbx8any_castIRN3RBX10GuiService16CenterDialogTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x54c2bc — __ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE6resizeEmS2_
// demangled: std::vector<RBX::GuiService::CenterDialogType,std::allocator<RBX::GuiService::CenterDialogType>>::resize(unsigned long,RBX::GuiService::CenterDialogType)
...
#[doc(alias = "__ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE6resizeEmS2_")]
pub fn stub_54c2bc() -> ! {
    todo!("0x54c2bc __ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE6resizeEmS2_")
}

// 0x54c2f0 — __ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE9push_backERKS2_
// demangled: std::vector<RBX::GuiService::CenterDialogType,std::allocator<RBX::GuiService::CenterDialogType>>::push_back(RBX::GuiService::CenterDialogType const&)
...
#[doc(alias = "__ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE9push_backERKS2_")]
pub fn stub_54c2f0() -> ! {
    todo!("0x54c2f0 __ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE9push_backERKS2_")
}

// 0x54c318 — __ZNSt3mapIPKN3RBX4NameENS0_10GuiService16CenterDialogTypeESt4lessIS3_ESaISt4pairIKS3_S5_EEEixERS9_
// demangled: std::map<RBX::Name const*,RBX::GuiService::CenterDialogType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>>::operator[](RBX::Name const* const&)
...
#[doc(alias = "__ZNSt3mapIPKN3RBX4NameENS0_10GuiService16CenterDialogTypeESt4lessIS3_ESaISt4pairIKS3_S5_EEEixERS9_")]
pub fn stub_54c318() -> ! {
    todo!("0x54c318 __ZNSt3mapIPKN3RBX4NameENS0_10GuiService16CenterDialogTypeESt4lessIS3_ESaISt4pairIKS3_S5_EEEixERS9_")
}
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>,std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType> const&)
// type: int __fastcall(int, _Rb_tree_node_base *)
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_10GuiService16CenterDialogTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS8_ERKS8_")]
pub fn stub_54c370() -> ! {
    todo!("0x54c370 __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_10GuiService16CenterDialogTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS8_ERKS8_")
}
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType> const&)
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_10GuiService16CenterDialogTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE9_M_insertEPSt18_Rb_tree_node_baseSG_RKS8_")]
pub fn stub_54c424() -> ! {
    todo!("0x54c424 __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_10GuiService16CenterDialogTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE9_M_insertEPSt18_Rb_tree_node_baseSG_RKS8_")
}
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::GuiService::CenterDialogType> const&)
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_10GuiService16CenterDialogTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE16_M_insert_uniqueERKS8_")]
pub fn stub_54c47c() -> ! {
    todo!("0x54c47c __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_10GuiService16CenterDialogTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE16_M_insert_uniqueERKS8_")
}
...
// demangled: std::vector<RBX::GuiService::CenterDialogType,std::allocator<RBX::GuiService::CenterDialogType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::GuiService::CenterDialogType*,std::vector<RBX::GuiService::CenterDialogType,std::allocator<RBX::GuiService::CenterDialogType>>>,RBX::GuiService::CenterDialogType const&)
...
#[doc(alias = "__ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS2_S4_EERKS2_")]
pub fn stub_54c4e4() -> ! {
    todo!("0x54c4e4 __ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS2_S4_EERKS2_")
}

// 0x54c5c8 — __ZNSt12_Vector_baseIN3RBX10GuiService16CenterDialogTypeESaIS2_EE11_M_allocateEm
// demangled: std::_Vector_base<RBX::GuiService::CenterDialogType,std::allocator<RBX::GuiService::CenterDialogType>>::_M_allocate(unsigned long)
...
#[doc(alias = "__ZNSt12_Vector_baseIN3RBX10GuiService16CenterDialogTypeESaIS2_EE11_M_allocateEm")]
pub fn stub_54c5c8() -> ! {
    todo!("0x54c5c8 __ZNSt12_Vector_baseIN3RBX10GuiService16CenterDialogTypeESaIS2_EE11_M_allocateEm")
}
...
// demangled: RBX::GuiService::CenterDialogType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::GuiService::CenterDialogType *,RBX::GuiService::CenterDialogType *>(RBX::GuiService::CenterDialogType *,RBX::GuiService::CenterDialogType *,RBX::GuiService::CenterDialogType *)
...
#[doc(alias = "__ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX10GuiService16CenterDialogTypeES6_EET0_T_S8_S7_")]
pub fn stub_54c5e0() -> ! {
    todo!("0x54c5e0 __ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX10GuiService16CenterDialogTypeES6_EET0_T_S8_S7_")
}
...
#[doc(alias = "__ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS2_S4_EEmRKS2_")]
pub fn stub_54c61c() -> ! {
    todo!("0x54c61c __ZNSt6vectorIN3RBX10GuiService16CenterDialogTypeESaIS2_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS2_S4_EEmRKS2_")
}

// 0x54c7ac — __ZN3rbx8any_castIN3RBX10GuiService10SpecialKeyENS1_7Region3EEEPT_PNS_13placement_anyIT0_EE
// demangled: RBX::GuiService::SpecialKey * rbx::any_cast<RBX::GuiService::SpecialKey,RBX::Region3>(rbx::placement_any<RBX::Region3> *)
#[doc(alias = "RBX::GuiService::SpecialKey * rbx::any_cast<RBX::GuiService::SpecialKey,RBX::Region3>(rbx::placement_any<RBX::Region3> *)")]
#[doc(alias = "__ZN3rbx8any_castIN3RBX10GuiService10SpecialKeyENS1_7Region3EEEPT_PNS_13placement_anyIT0_EE")]
pub fn stub_54c7ac() -> ! {
    todo!("0x54c7ac __ZN3rbx8any_castIN3RBX10GuiService10SpecialKeyENS1_7Region3EEEPT_PNS_13placement_anyIT0_EE")
}

// 0x54c804 — __ZN3rbx8any_castIRN3RBX10GuiService10SpecialKeyENS1_7Region3EEET_RNS_13placement_anyIT0_EE
// demangled: RBX::GuiService::SpecialKey & rbx::any_cast<RBX::GuiService::SpecialKey &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
#[doc(alias = "RBX::GuiService::SpecialKey & rbx::any_cast<RBX::GuiService::SpecialKey &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")]
#[doc(alias = "__ZN3rbx8any_castIRN3RBX10GuiService10SpecialKeyENS1_7Region3EEET_RNS_13placement_anyIT0_EE")]
pub fn stub_54c804() -> ! {
    todo!("0x54c804 __ZN3rbx8any_castIRN3RBX10GuiService10SpecialKeyENS1_7Region3EEET_RNS_13placement_anyIT0_EE")
}

// 0x54c8f4 — __ZNSt6vectorIN3RBX10GuiService10SpecialKeyESaIS2_EE6resizeEmS2_
// demangled: std::vector<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>::resize(unsigned long,RBX::GuiService::SpecialKey)
...
#[doc(alias = "__ZNSt6vectorIN3RBX10GuiService10SpecialKeyESaIS2_EE6resizeEmS2_")]
pub fn stub_54c8f4() -> ! {
    todo!("0x54c8f4 __ZNSt6vectorIN3RBX10GuiService10SpecialKeyESaIS2_EE6resizeEmS2_")
}

// 0x54c928 — __ZNSt6vectorIN3RBX10GuiService10SpecialKeyESaIS2_EE9push_backERKS2_
// demangled: std::vector<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>::push_back(RBX::GuiService::SpecialKey const&)
...
#[doc(alias = "__ZNSt6vectorIN3RBX10GuiService10SpecialKeyESaIS2_EE9push_backERKS2_")]
pub fn stub_54c928() -> ! {
    todo!("0x54c928 __ZNSt6vectorIN3RBX10GuiService10SpecialKeyESaIS2_EE9push_backERKS2_")
}

// 0x54c950 — __ZNSt3mapIPKN3RBX4NameENS0_10GuiService10SpecialKeyESt4lessIS3_ESaISt4pairIKS3_S5_EEEixERS9_
// demangled: std::map<RBX::Name const*,RBX::GuiService::SpecialKey,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>>::operator[](RBX::Name const* const&)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>,std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey> const&)
// type: int __fastcall(int, _Rb_tree_node_base *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey> const&)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey> const&)
...
// demangled: std::vector<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::GuiService::SpecialKey*,std::vector<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>>,RBX::GuiService::SpecialKey const&)
...
// demangled: std::_Vector_base<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>::_M_allocate(unsigned long)
...
// demangled: RBX::GuiService::SpecialKey * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::GuiService::SpecialKey *,RBX::GuiService::SpecialKey *>(RBX::GuiService::SpecialKey *,RBX::GuiService::SpecialKey *,RBX::GuiService::SpecialKey *)
...
// demangled: std::vector<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::GuiService::SpecialKey*,std::vector<RBX::GuiService::SpecialKey,std::allocator<RBX::GuiService::SpecialKey>>>,unsigned long,RBX::GuiService::SpecialKey const&)
...
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::PropDescriptor<bool (RBX::GuiService::*)(void)const,void (RBX::GuiService::*)(bool)>(char const*,char const*,bool (RBX::GuiService::*)(void)const,void (RBX::GuiService::*)(bool),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
pub fn stub_54cde4() -> ! {
    todo!("0x54cde4 __ZN3RBX10Reflection14PropDescriptorINS_10GuiServiceEbEC2IMS2_KFbvEMS2_FvbEEEPKcSA_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::GetSetImpl<bool (RBX::GuiService::*)(void)const,void (RBX::GuiService::*)(bool)>::getValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_54cf2c() -> ! {
    todo!("0x54cf2c __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE10GetSetImplIMS2_KFbvEMS2_FvbEE8getValueEPKNS0_13DescribedBaseE")
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::GuiService,bool>::GetSetImpl<bool (RBX::GuiService::*)(void)const,void (RBX::GuiService::*)(bool)>::setValue(RBX::Reflection::DescribedBase *,bool const&)const
...
pub fn stub_54cf50() -> ! {
    todo!("0x54cf50 __ZNK3RBX10Reflection14PropDescriptorINS_10GuiServiceEbE10GetSetImplIMS2_KFbvEMS2_FvbEE8setValueEPNS0_13DescribedBaseERKb")
}
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(int,int,int,int),4>::BoundFuncDesc(void (RBX::GuiService::*)(int,int,int,int),char const*,char const*,char const*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)
...
pub fn stub_54cf74() -> ! {
    todo!("0x54cf74 __ZN3RBX10Reflection13BoundFuncDescINS_10GuiServiceEFviiiiELi4EEC2EMS2_FviiiiEPKcS8_S8_S8_S8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")
}
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(int,int,int,int),4>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)
...
pub fn stub_54d1e4() -> ! {
    todo!("0x54d1e4 __ZN3RBX10Reflection13BoundFuncDescINS_10GuiServiceEFviiiiELi4EE16declareSignatureEPKcNS0_7VariantES6_S7_S6_S7_S6_S7_")
}
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(int,int,int,int),4>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
pub fn stub_54d35c() -> ! {
    todo!("0x54d35c __ZNK3RBX10Reflection13BoundFuncDescINS_10GuiServiceEFviiiiELi4EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")
}
...
// demangled: int RBX::Reflection::ArgHelper::getArg<int,4>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<int> const&,boost::disable_if<boost::is_same<int,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(boost::shared_ptr<RBX::Instance>),1>::declareSignature(char const*,RBX::Reflection::Variant)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(boost::shared_ptr<RBX::Instance>),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// demangled: RBX::Reflection::Call1Helper<RBX::GuiService,void (RBX::GuiService::*)(boost::shared_ptr<RBX::Instance>),boost::shared_ptr<RBX::Instance>,void>::call(RBX::GuiService*,void (RBX::GuiService::*)(boost::shared_ptr<RBX::Instance>),RBX::Reflection::Variant &,boost::shared_ptr<RBX::Instance> const&)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(boost::shared_ptr<RBX::Instance>,RBX::GuiService::CenterDialogType,RBX::Lua::WeakFunctionRef,RBX::Lua::WeakFunctionRef),4>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
