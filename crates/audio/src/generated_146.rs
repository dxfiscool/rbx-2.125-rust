//! audio generated_146 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: Sound|Audio|FMOD (2541 distinct) exhausted — filler EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0x244bcc..0x24a8b8 EA-sorted asc filler after 0x244bc0, skip existing, rbx_core::SharedPtr not boost
