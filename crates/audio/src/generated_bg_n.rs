//! audio generated_bg_n — global gap filler batch N — next 100 EA not yet in crates/audio/src, EA-sorted asc
//! Filter: global gap filler skeleton batch N — EA-sorted asc skip audio existing, rbx_core::SharedPtr not boost::shared_ptr
//! Batch: 100 stubs | skeleton batch | range 0x2a3898..0x2a675c EA-sorted asc batch N (audio gap filler, global next 100 after 0x2a3858)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,void ()(std::string,std::string),2>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,void ()(std::string,boost::shared_ptr<RBX::Instance>),2>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,void ()(void),0>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,void ()(int,boost::shared_ptr<RBX::Instance>,std::string),3>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,void ()(double),1>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,boost::shared_ptr<RBX::Reflection::Tuple const> ()(bool),1>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> ()(void),0>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::BoundProp<int,(RBX::Reflection::Mutability)1>::~BoundProp()
#[doc(alias = "RBX::Reflection::BoundProp<int,(RBX::Reflection::Mutability)1>::~BoundProp()")]
pub fn stub_2a3bc4() -> ! {
    todo!("0x2a3bc4 RBX::Reflection::BoundProp<int,(RBX::Reflection::Mutability)1>::~BoundProp()")
}

// 0x2a3be8 — __ZN3RBX10Reflection13BoundFuncDescINS_13ScriptContextEFvbELi1EED1Ev
// demangled: RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,void ()(bool),1>::~BoundFuncDesc()
...
// demangled: RBX::Reflection::EventDesc<RBX::ScriptContext,void ()(std::string,std::string,boost::shared_ptr<RBX::Instance>),rbx::signal<void ()(std::string,std::string,boost::shared_ptr<RBX::Instance>)>,rbx::signal<void ()(std::string,std::string,boost::shared_ptr<RBX::Instance>)> RBX::ScriptContext::*>::~EventDesc()
...
// demangled: LuaProfiler::hookCall(lua_State *,lua_Debug *)
...
// demangled: RBX::Lua::Bridge<RBX::Lua::Library,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Lua::Library,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Lua::EventInstance,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Lua::EventInstance,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<rbx::signals::connection,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<rbx::signals::connection,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::CoordinateFrame,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::CoordinateFrame,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Region3,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Region3,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Region3int16,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Region3int16,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector3int16,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector3int16,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector2int16,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector2int16,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector3,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector3,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector2,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Vector2,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::RbxRay,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::RbxRay,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Color3,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<G3D::Color3,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::BrickColor,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::BrickColor,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::UDim,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::UDim,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::UDim2,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::UDim2,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Faces,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Faces,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Axes,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::Axes,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::CellID,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::CellID,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::InputObject,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<RBX::InputObject,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<boost::intrusive_ptr<RBX::Lua::WeakThreadRef::Node>,true>::on_index(lua_State *)
...
// demangled: RBX::Lua::Bridge<boost::intrusive_ptr<RBX::Lua::WeakThreadRef::Node>,true>::on_newindex(lua_State *)
...
// demangled: RBX::Lua::Bridge<boost::shared_ptr<boost::function<boost::shared_ptr<RBX::Reflection::Tuple const> ()(boost::shared_ptr<RBX::Reflection::Tuple const>)>>,true>::on_index(lua_State *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIN5boost10shared_ptrINS2_8functionIFNS3_IKNS_10Reflection5TupleEEES8_EEEEELb1EE8on_indexEP9lua_State")]
pub fn stub_2a46ac() -> ! {
...
// demangled: RBX::Lua::Bridge<boost::shared_ptr<boost::function<boost::shared_ptr<RBX::Reflection::Tuple const> ()(boost::shared_ptr<RBX::Reflection::Tuple const>)>>,true>::on_newindex(lua_State *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIN5boost10shared_ptrINS2_8functionIFNS3_IKNS_10Reflection5TupleEEES8_EEEEELb1EE11on_newindexEP9lua_State")]
pub fn stub_2a46e0() -> ! {
...
// demangled: RBX::Lua::Bridge<boost::shared_ptr<boost::function<void ()(boost::shared_ptr<RBX::Reflection::Tuple const>,boost::function<void ()(RBX::Lua::IAsyncResult *)>)>>,true>::on_index(lua_State *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIN5boost10shared_ptrINS2_8functionIFvNS3_IKNS_10Reflection5TupleEEENS4_IFvPNS0_12IAsyncResultEEEEEEEEELb1EE8on_indexEP9lua_State")]
pub fn stub_2a4714() -> ! {
...
// demangled: RBX::Lua::Bridge<boost::shared_ptr<boost::function<void ()(boost::shared_ptr<RBX::Reflection::Tuple const>,boost::function<void ()(RBX::Lua::IAsyncResult *)>)>>,true>::on_newindex(lua_State *)
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIN5boost10shared_ptrINS2_8functionIFvNS3_IKNS_10Reflection5TupleEEENS4_IFvPNS0_12IAsyncResultEEEEEEEEELb1EE11on_newindexEP9lua_State")]
pub fn stub_2a4748() -> ! {
...
// demangled: RBX::Lua::SingletonBridge<RBX::Lua::AllEnumDescriptors const*,true>::registerClassLibrary(lua_State *)
...
// demangled: RBX::Lua::SingletonBridge<RBX::Reflection::EnumDescriptor const*,true>::registerClassLibrary(lua_State *)
...
// demangled: RBX::Lua::SingletonBridge<RBX::Reflection::EnumDescriptor::Item const*,true>::registerClassLibrary(lua_State *)
...
// demangled: RBX::Lua::SharedPtrBridge<RBX::Instance>::registerClassLibrary(lua_State *)
...
// demangled: RBX::Lua::ObjectBridge::registerInstanceClassLibrary(lua_State *)
...
// demangled: RBX::Lua::SharedPtrBridge<RBX::Instance>::push(lua_State *,boost::shared_ptr<RBX::Instance>)
...
// demangled: boost::shared_ptr<RBX::TaskScheduler::Job>::operator=(boost::shared_ptr<RBX::TaskScheduler::Job> const&)
...
// demangled: boost::shared_ptr<RBX::ScriptContext> RBX::shared_from<RBX::ScriptContext>(RBX::ScriptContext*)
...
// demangled: RobloxExtraSpace::eraseRefsFromAllNodes(void)
...
#[doc(alias = "__ZN3rbx11make_sharedISt6vectorIN3RBX10Reflection7VariantESaIS4_EEmEEN5boost10shared_ptrIT_EERKT0_")]
pub fn stub_2a4d18() -> ! {
    todo!("0x2a4d18 boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>> rbx::make_shared<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>,unsigned long>(unsigned long const&)")
}
...
// demangled: RBX::Lua::LuaArguments::pushTuple(RBX::Reflection::Tuple const&,lua_State *)
...
#[doc(alias = "__ZN5boost4bindIvP9lua_StateNS_8functionIFvNS_10shared_ptrIKN3RBX10Reflection5TupleEEEEEENS_3argILi1EEESB_EENS_3_bi6bind_tIT_PFSG_T0_T1_ENSE_9list_av_2IT2_T3_E4typeEEESK_SM_SN_")]
pub fn stub_2a5104() -> ! {
...
// demangled: RBX::Lua::LuaArguments::getValues(lua_State *)
...
#[doc(alias = "__ZNK5boost9function1IvNS_10shared_ptrIKN3RBX10Reflection5TupleEEEEclES6_")]
pub fn stub_2a5550() -> ! {
...
// demangled: boost::_bi::bind_t<void,void (*)(lua_State *,int,std::string),boost::_bi::list_av_3<boost::arg<1>,boost::arg<2>,std::string>::type> boost::bind<void,lua_State *,int,std::string,boost::arg<1>,boost::arg<2>,std::string>(void (*)(lua_State *,int,std::string),boost::arg<1>,boost::arg<2>,std::string)
...
// demangled: boost::scoped_ptr<RBX::Lua::Continuations>::reset(RBX::Lua::Continuations*)
...
// demangled: boost::function1<unsigned long,lua_State *>::operator()(lua_State *)const
...
// demangled: boost::function2<void,lua_State *,unsigned long>::operator()(lua_State *,unsigned long)const
...
// demangled: boost::function1<void,bool>::operator()(bool)const
...
// demangled: boost::shared_ptr<RBX::Stats::StatsService> RBX::shared_from<RBX::Stats::StatsService>(RBX::Stats::StatsService*)
...
// demangled: RBX::Stats::StatsService * RBX::ServiceProvider::create<RBX::Stats::StatsService>(RBX::Instance const*)
...
// demangled: rbx::safe_queue<RBX::ScriptContext::WaitingThread>::pop_if_present(RBX::ScriptContext::WaitingThread&)
...
// demangled: RBX::ScriptContext::ScriptStart::ScriptStart(RBX::ScriptContext::ScriptStart const&)
...
// demangled: RBX::Stats::StatsService * RBX::ServiceProvider::find<RBX::Stats::StatsService>(RBX::Instance const*)
...
// demangled: boost::thread::join(void)
...
// demangled: boost::shared_ptr<RBX::LuaStatsItem>::operator=(boost::shared_ptr<RBX::LuaStatsItem> const&)
...
// demangled: RBX::LuaStatsItem::create(RBX::ScriptContext *)
...
// demangled: boost::shared_ptr<RBX::RunService>::operator=(boost::shared_ptr<RBX::RunService> const&)
...
// demangled: boost::shared_ptr<RBX::StarterScript> RBX::Creatable<RBX::Instance>::create<RBX::StarterScript,RBX::ContentId>(RBX::ContentId)
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::ScriptContext>(boost::shared_ptr<RBX::ScriptContext> const&)
...
// demangled: boost::shared_ptr<RBX::CoreScript> RBX::Creatable<RBX::Instance>::create<RBX::CoreScript,RBX::ContentId>(RBX::ContentId)
