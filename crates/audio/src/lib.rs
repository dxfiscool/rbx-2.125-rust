...
//! Generated from ida/export.json filtered for FMOD (1882 funcs, 1250 stubs here).
...
pub fn stub_b0f74() -> ! {
    todo!("0xb0f74 `global constructor keyed to'FMOD::dspdistortion")
}
...
pub fn stub_b2474() -> ! {
    todo!("0xb2474 `global constructor keyed to'FMOD::dspecho_desc")
}
