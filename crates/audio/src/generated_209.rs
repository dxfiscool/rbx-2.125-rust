//! audio generated_209 — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4cae00..0x4ce5f8 | existing 28113 -> 28213 distinct
...
// demangled: RBX::Humanoid::Status const& rbx::any_cast<RBX::Humanoid::Status const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::convertToValue(RBX::Name const&,RBX::Humanoid::Status&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::Humanoid::Status>,std::_Select1st<std::pair<RBX::Name const* const,RBX::Humanoid::Status>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Humanoid::Status>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::Humanoid::Status>> *)
...
pub fn stub_4caf6c() {
    // IDA 0x4caf6c: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4caf94 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescIN3G3D7Vector34AxisEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<G3D::Vector3::Axis> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<G3D::Vector3::Axis> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::convertToString(G3D::Vector3::Axis const&)const
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<G3D::Vector3::Axis>(G3D::Vector3::Axis const&)
...
// demangled: rbx::implementation::typed_holder<G3D::Vector3::Axis>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<G3D::Vector3::Axis>::construct_func(char const*,char *)
...
// demangled: rbx::implementation::typed_holder<G3D::Vector3::Axis>::destruct_func(char *)
// type: void()
...
pub fn stub_4cb758() {
    // IDA 0x4cb758: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4cb75c — __ZNK3RBX10Reflection8EnumDescIN3G3D7Vector34AxisEE13convertToItemERKS4_
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::convertToItem(G3D::Vector3::Axis const&)const
// type: int __fastcall(int, int *)
...
// demangled: G3D::Vector3::Axis const& rbx::any_cast<G3D::Vector3::Axis const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<G3D::Vector3::Axis>::convertToValue(RBX::Name const&,G3D::Vector3::Axis&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,G3D::Vector3::Axis>,std::_Select1st<std::pair<RBX::Name const* const,G3D::Vector3::Axis>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,G3D::Vector3::Axis>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,G3D::Vector3::Axis>> *)
// type: void __fastcall(int, _DWORD *)
...
pub fn stub_4cb994() {
    // IDA 0x4cb994: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4cb9bc — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_6Legacy17SurfaceConstraintEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::convertToString(RBX::Legacy::SurfaceConstraint const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Legacy::SurfaceConstraint>(RBX::Legacy::SurfaceConstraint const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::Legacy::SurfaceConstraint>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::Legacy::SurfaceConstraint>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::Legacy::SurfaceConstraint>::destruct_func(char *)
// type: void()
...
pub fn stub_4cc180() {
    // IDA 0x4cc180: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4cc184 — __ZNK3RBX10Reflection8EnumDescINS_6Legacy17SurfaceConstraintEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::convertToItem(RBX::Legacy::SurfaceConstraint const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::Legacy::SurfaceConstraint const& rbx::any_cast<RBX::Legacy::SurfaceConstraint const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Legacy::SurfaceConstraint>::convertToValue(RBX::Name const&,RBX::Legacy::SurfaceConstraint&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::Legacy::SurfaceConstraint>,std::_Select1st<std::pair<RBX::Name const* const,RBX::Legacy::SurfaceConstraint>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Legacy::SurfaceConstraint>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::Legacy::SurfaceConstraint>> *)
// type: void __fastcall(int, _DWORD *)
...
pub fn stub_4cc3bc() {
    // IDA 0x4cc3bc: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4cc3e4 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_17KeywordFilterTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::KeywordFilterType> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::KeywordFilterType> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::convertToString(RBX::KeywordFilterType const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::KeywordFilterType>(RBX::KeywordFilterType const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::KeywordFilterType>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::KeywordFilterType>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::KeywordFilterType>::destruct_func(char *)
// type: void()
...
pub fn stub_4ccba8() {
    // IDA 0x4ccba8: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4ccbac — __ZNK3RBX10Reflection8EnumDescINS_17KeywordFilterTypeEE13convertToItemERKS2_
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::convertToItem(RBX::KeywordFilterType const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::KeywordFilterType const& rbx::any_cast<RBX::KeywordFilterType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::convertToValue(RBX::Name const&,RBX::KeywordFilterType&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::KeywordFilterType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::KeywordFilterType>> *)
// type: 
...
pub fn stub_4ccde4() {
    // IDA 0x4ccde4: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4cce0c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_5Joint9JointTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Joint::JointType> const>::initSingleton(void)
// type: 
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Joint::JointType> const>::doGetSingleton(void)
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::lookup(char const*)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::lookup(RBX::Reflection::Variant const&)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::convertToString(unsigned long,std::string &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::convertToString(RBX::Joint::JointType const&)const
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Joint::JointType>(RBX::Joint::JointType const&)
// type: 
...
// demangled: rbx::implementation::typed_holder<RBX::Joint::JointType>::singleton(void)
// type: 
...
// demangled: rbx::implementation::typed_holder<RBX::Joint::JointType>::construct_func(char const*,char *)
// type: 
...
// demangled: rbx::implementation::typed_holder<RBX::Joint::JointType>::destruct_func(char *)
// type: 
...
pub fn stub_4cd5d0() {
    // IDA 0x4cd5d0: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4cd5d4 — __ZNK3RBX10Reflection8EnumDescINS_5Joint9JointTypeEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::convertToItem(RBX::Joint::JointType const&)const
// type: 
...
// demangled: RBX::Joint::JointType const& rbx::any_cast<RBX::Joint::JointType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Joint::JointType>::convertToValue(RBX::Name const&,RBX::Joint::JointType&)const
// type: 
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::Joint::JointType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::Joint::JointType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Joint::JointType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::Joint::JointType>> *)
// type: 
...
pub fn stub_4cd80c() {
    // IDA 0x4cd80c: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4cd834 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_7Feature9TopBottomEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Feature::TopBottom> const>::initSingleton(void)
// type: 
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Feature::TopBottom> const>::doGetSingleton(void)
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::lookup(char const*)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::lookup(RBX::Reflection::Variant const&)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::convertToString(unsigned long,std::string &)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::convertToString(RBX::Feature::TopBottom const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Feature::TopBottom>(RBX::Feature::TopBottom const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::Feature::TopBottom>::singleton(void)
// type: 
#[doc(alias = "rbx::implementation::typed_holder<RBX::Feature::TopBottom>::singleton(void)")]
#[doc(alias = "__ZN3rbx14implementation12typed_holderIN3RBX7Feature9TopBottomEE9singletonEv")]
pub fn stub_4cdf80() -> ! {
...
// demangled: rbx::implementation::typed_holder<RBX::Feature::TopBottom>::construct_func(char const*,char *)
// type: 
#[doc(alias = "rbx::implementation::typed_holder<RBX::Feature::TopBottom>::construct_func(char const*,char *)")]
#[doc(alias = "__ZN3rbx14implementation12typed_holderIN3RBX7Feature9TopBottomEE14construct_funcEPKcPc")]
pub fn stub_4cdfec() -> ! {
...
// demangled: rbx::implementation::typed_holder<RBX::Feature::TopBottom>::destruct_func(char *)
// type: 
#[doc(alias = "rbx::implementation::typed_holder<RBX::Feature::TopBottom>::destruct_func(char *)")]
#[doc(alias = "__ZN3rbx14implementation12typed_holderIN3RBX7Feature9TopBottomEE13destruct_funcEPc")]
pub fn stub_4cdff8() {
    // IDA 0x4cdff8: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4cdffc — __ZNK3RBX10Reflection8EnumDescINS_7Feature9TopBottomEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::convertToItem(RBX::Feature::TopBottom const&)const
// type: 
...
// demangled: RBX::Feature::TopBottom const& rbx::any_cast<RBX::Feature::TopBottom const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: 
#[doc(alias = "RBX::Feature::TopBottom const& rbx::any_cast<RBX::Feature::TopBottom const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")]
#[doc(alias = "__ZN3rbx8any_castIRKN3RBX7Feature9TopBottomENS1_7Region3EEET_RNS_13placement_anyIT0_EE")]
pub fn stub_4ce0c8() -> ! {
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::TopBottom>::convertToValue(RBX::Name const&,RBX::Feature::TopBottom&)const
// type: 
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::Feature::TopBottom>,std::_Select1st<std::pair<RBX::Name const* const,RBX::Feature::TopBottom>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Feature::TopBottom>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::Feature::TopBottom>> *)
// type: 
...
#[doc(alias = "__ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_7Feature9TopBottomEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E")]
pub fn stub_4ce234() {
    // IDA 0x4ce234: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4ce25c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_7Feature9LeftRightEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Feature::LeftRight> const>::initSingleton(void)
// type: 
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Feature::LeftRight> const>::doGetSingleton(void)
// type: 
...
pub fn stub_4ce350() {
    // IDA 0x4ce350: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4ce354() {
    // IDA 0x4ce354: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4ce528() {
    // IDA 0x4ce528: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4ce5c8 — __ZNK3RBX10Reflection8EnumDescINS_7Feature9LeftRightEE6lookupEPKc
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::LeftRight>::lookup(char const*)const
// type: 
...
// demangled: RBX::Reflection::EnumDesc<RBX::Feature::LeftRight>::lookup(RBX::Reflection::Variant const&)const
// type: 
