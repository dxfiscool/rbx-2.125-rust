//! audio generated_63 — next 100 stubs EA-sorted, from ida/export.json
...
//! Batch: 100 stubs | skeleton batch | range 0x644ba0..0x64df60 EA-sorted asc filler global remaining, skip existing, rbx_core::SharedPtr not boost
