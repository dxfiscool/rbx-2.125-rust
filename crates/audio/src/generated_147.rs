//! audio generated_147 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: Sound|Audio|FMOD (2541 distinct), 1382 missing before batch, 100 here
//! Batch: 100 stubs | skeleton batch | range 0xa6e2c..0xb0608 EA-sorted
