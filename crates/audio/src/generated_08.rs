//! audio generated_08 — next 120 stubs EA-sorted, from ida/export.json
...
//! Batch: 120 stubs | skeleton batch | range 0x107a28..0x111e68 EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
