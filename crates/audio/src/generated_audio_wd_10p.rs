//! audio generated_audio_wd_10p — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio exhausted, global gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x5e4cb4..0x5e8b70 | existing 34012 -> 34112 distinct
...
// demangled: XmlElement::XmlElement<float>(RBX::Name const&,float)
#[doc(alias = "XmlElement::XmlElement<float>(RBX::Name const&,float)")]
#[doc(alias = "__ZN10XmlElementC2IfEERKN3RBX4NameET_")]
pub fn stub_5e4cb4() -> ! {
    todo!("0x5e4cb4 __ZN10XmlElementC2IfEERKN3RBX4NameET_")
}

// 0x5e4d8c — __ZN3RBX10Reflection4TypeC2IN3G3D15CoordinateFrameEEEPKcPT_
// demangled: RBX::Reflection::Type::Type<G3D::CoordinateFrame>(char const*,G3D::CoordinateFrame *)
// type: int(void)
#[doc(alias = "RBX::Reflection::Type::Type<G3D::CoordinateFrame>(char const*,G3D::CoordinateFrame *)")]
#[doc(alias = "__ZN3RBX10Reflection4TypeC2IN3G3D15CoordinateFrameEEEPKcPT_")]
pub fn stub_5e4d8c() -> ! {
    todo!("0x5e4d8c __ZN3RBX10Reflection4TypeC2IN3G3D15CoordinateFrameEEEPKcPT_")
}
...
// demangled: RBX::Reflection::Type::~Type()
...
// demangled: __ZN3RBX10Reflection9DescribedINS_17BasicPartInstanceELZNS_10sBasicPartEENS_14FactoryProductIS2_NS_14FormFactorPartELZNS_10sBasicPartEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EE15classDescriptorEv
...
// demangled: __ZN3RBX10Reflection9DescribedINS_14FormFactorPartELZNS_15sFormFactorPartEENS_17NonFactoryProductINS_12PartInstanceELZNS_15sFormFactorPartEEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EE15classDescriptorEv
// type: int __fastcall(int, int, int, int, int, __guard *, int, int, int)
...
// demangled: __ZN3RBX10Reflection9DescribedINS_12PartInstanceELZNS_5sPartEENS_17NonFactoryProductINS_10PVInstanceELZNS_5sPartEEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EE15classDescriptorEv
// type: int __fastcall(int, int, int, int, int, __guard *, int, int, int)
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>>::delete_buckets(void)
// type: int(void)
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>>::table(unsigned long,boost::hash<RBX::PartInstance *> const&,std::equal_to<RBX::PartInstance *> const&,std::allocator<boost::unordered::detail::ptr_node<RBX::PartInstance *>> const&)
// type: int(void)
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>>::reserve_for_insert(unsigned long)
// type: int(void)
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>>::min_buckets_for_size(unsigned long)const
// type: int(void)
...
// demangled: boost::unordered::detail::table_impl<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>>::rehash_impl(unsigned long)
// type: int(void)
...
// demangled: boost::unordered::detail::table_impl<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>>::place_in_bucket(boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::PartInstance *>,RBX::PartInstance *,boost::hash<RBX::PartInstance *>,std::equal_to<RBX::PartInstance *>>> &,boost::unordered::detail::ptr_bucket *)
// type: int(void)
...
// demangled: void boost::unordered::detail::array_constructor<std::allocator<boost::unordered::detail::ptr_bucket>>::construct<boost::unordered::detail::ptr_bucket>(boost::unordered::detail::ptr_bucket const&,unsigned long)
...
// demangled: boost::unordered::detail::allocator_traits<std::allocator<boost::unordered::detail::ptr_bucket>>::allocate(std::allocator<boost::unordered::detail::ptr_bucket>&,unsigned long)
// type: int(void)
...
// demangled: boost::unordered::detail::node_constructor<std::allocator<boost::unordered::detail::ptr_node<RBX::PartInstance *>>>::construct(void)
// type: int(void)
...
// demangled: std::_Vector_base<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>::_M_allocate(unsigned long)
...
// demangled: boost::shared_ptr<RBX::Instance> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<boost::shared_ptr<RBX::Instance> *,boost::shared_ptr<RBX::Instance> *>(boost::shared_ptr<RBX::Instance> *,boost::shared_ptr<RBX::Instance> *,boost::shared_ptr<RBX::Instance> *)
// type: int(void)
...
// demangled: G3D::Array<RBX::Primitive *,10,32ul>::resize(int,bool)
// type: int __fastcall(_DWORD, _DWORD, _DWORD)
...
// demangled: G3D::Array<RBX::Primitive *,10,32ul>::realloc(int)
// type: int(void)
...
// demangled: __ZN3RBX10Reflection9DescribedINS_13ModelInstanceELZNS_6sModelEENS_14FactoryProductIS2_NS_10PVInstanceELZNS_6sModelEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EE15classDescriptorEv
// type: int __fastcall(int, int, int, int, int, __guard *, int, int, int)
...
// demangled: boost::shared_ptr<RBX::FWBase>& boost::shared_ptr<RBX::FWBase>::operator=<RBX::FWPartInstance>(boost::shared_ptr<RBX::FWPartInstance> const&)
// type: int(void)
...
// demangled: boost::shared_ptr<RBX::FWPartInstance> RBX::shared_from<RBX::FWPartInstance>(RBX::FWPartInstance*)
// type: int(void)
...
pub fn stub_5e60ec() -> ! {
    todo!("0x5e60ec __ZN3RBX11shared_fromINS_14FWPartInstanceEEEN5boost10shared_ptrIT_EEPS4_")
}

// 0x5e6254 — __ZN5boost10shared_ptrIN3RBX9IFWHolderEEaSERKS3_
// demangled: boost::shared_ptr<RBX::IFWHolder>::operator=(boost::shared_ptr<RBX::IFWHolder> const&)
// type: int(void)
...
pub fn stub_5e6254() -> ! {
    todo!("0x5e6254 __ZN5boost10shared_ptrIN3RBX9IFWHolderEEaSERKS3_")
}
...
// demangled: boost::bad_weak_ptr::what(void)const
...
pub fn stub_5e6298() -> ! {
    todo!("0x5e6298 __ZNK5boost12bad_weak_ptr4whatEv")
}
...
// demangled: boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::bad_weak_ptr>>::clone(void)const
...
pub fn stub_5e6370() -> ! {
    todo!("0x5e6370 __ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_12bad_weak_ptrEEEE5cloneEv")
}

// 0x5e6430 — __ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_12bad_weak_ptrEEEEC1ERKS4_
// demangled: boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::bad_weak_ptr>>::clone_impl(boost::exception_detail::error_info_injector<boost::bad_weak_ptr> const&)
...
pub fn stub_5e6430() -> ! {
    todo!("0x5e6430 __ZN5boost16exception_detail10clone_implINS0_19error_info_injectorINS_12bad_weak_ptrEEEEC1ERKS4_")
}
...
pub fn stub_5e6568() -> ! {
    todo!("0x5e6568 __ZN5boost9unordered6detail10table_implINS1_3setISaIN3RBX7DumbPtrINS4_14FWPartInstanceEEEES7_NS_4hashIS7_EESt8equal_toIS7_EEEE12emplace_implINS1_13emplace_args1IS7_EEEESt4pairINS0_15iterator_detail8iteratorINS1_8ptr_nodeIS7_EEEEbERKS7_RKT_")
}
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::DumbPtr<RBX::FWPartInstance>>,RBX::DumbPtr<RBX::FWPartInstance>,boost::hash<RBX::DumbPtr<RBX::FWPartInstance>>,std::equal_to<RBX::DumbPtr<RBX::FWPartInstance>>>>::min_buckets_for_size(unsigned long)const
// type: int(void)
...
// demangled: boost::unordered::detail::table_impl<boost::unordered::detail::set<std::allocator<RBX::DumbPtr<RBX::FWPartInstance>>,RBX::DumbPtr<RBX::FWPartInstance>,boost::hash<RBX::DumbPtr<RBX::FWPartInstance>>,std::equal_to<RBX::DumbPtr<RBX::FWPartInstance>>>>::rehash_impl(unsigned long)
// type: int(void)
...
pub fn stub_5e68d0() -> ! {
    todo!("0x5e68d0 __ZN5boost9unordered6detail10table_implINS1_3setISaIN3RBX7DumbPtrINS4_14FWPartInstanceEEEES7_NS_4hashIS7_EESt8equal_toIS7_EEEE11rehash_implEm")
}
...
// demangled: boost::unordered::detail::table_impl<boost::unordered::detail::set<std::allocator<RBX::DumbPtr<RBX::FWPartInstance>>,RBX::DumbPtr<RBX::FWPartInstance>,boost::hash<RBX::DumbPtr<RBX::FWPartInstance>>,std::equal_to<RBX::DumbPtr<RBX::FWPartInstance>>>>::place_in_bucket(boost::unordered::detail::table<boost::unordered::detail::set<std::allocator<RBX::DumbPtr<RBX::FWPartInstance>>,RBX::DumbPtr<RBX::FWPartInstance>,boost::hash<RBX::DumbPtr<RBX::FWPartInstance>>,std::equal_to<RBX::DumbPtr<RBX::FWPartInstance>>>> &,boost::unordered::detail::ptr_bucket *)
// type: int(void)
...
// demangled: boost::unordered::detail::node_constructor<std::allocator<boost::unordered::detail::ptr_node<RBX::DumbPtr<RBX::FWPartInstance>>>>::construct(void)
// type: int(void)
...
pub fn stub_5e6988() -> ! {
    todo!("0x5e6988 __ZNK5boost9unordered6detail10table_implINS1_3setISaIN3RBX7DumbPtrINS4_14FWPartInstanceEEEES7_NS_4hashIS7_EESt8equal_toIS7_EEEE14find_node_implIS7_SC_EENS0_15iterator_detail8iteratorINS1_8ptr_nodeIS7_EEEEmRKT_RKT0_")
}

// 0x5e6a00 — __ZNK3RBX15ServiceProvider4findINS_9FWServiceEEEPT_v
// demangled: RBX::FWService * RBX::ServiceProvider::find<RBX::FWService>(void)const
...
pub fn stub_5e6a00() -> ! {
    todo!("0x5e6a00 __ZNK3RBX15ServiceProvider4findINS_9FWServiceEEEPT_v")
}

// 0x5e6b78 — __ZN3RBX17NonFactoryProductINS_8InstanceELZNS_10sFWServiceEEE15isNullClassNameEv
// demangled: __ZN3RBX17NonFactoryProductINS_8InstanceELZNS_10sFWServiceEEE15isNullClassNameEv
// type: int(void)
...
// demangled: __ZN3RBX4Name7declareILZNS_10sFWServiceEEEERKS0_v
// type: int(void)
...
// demangled: __ZN3RBX4Name9doDeclareILZNS_10sFWServiceEEEERKS0_v
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::FWService>(void)
...
pub fn stub_5e6d44() -> ! {
    todo!("0x5e6d44 __ZN3RBX15ServiceProvider19callDoGetClassIndexINS_9FWServiceEEEvv")
}

// 0x5e6d48 — __ZN3RBX15ServiceProvider15doGetClassIndexINS_9FWServiceEEEmv
// demangled: unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::FWService>(void)
...
pub fn stub_5e6d48() -> ! {
    todo!("0x5e6d48 __ZN3RBX15ServiceProvider15doGetClassIndexINS_9FWServiceEEEmv")
}

// 0x5e6e20 — __ZN3RBX11ComputePropINS_4PartENS_12PartInstance20OnDemandPartInstanceEE8getValueEv
// demangled: RBX::ComputeProp<RBX::Part,RBX::PartInstance::OnDemandPartInstance>::getValue(void)
// type: int(void)
...
pub fn stub_5e6e20() -> ! {
    todo!("0x5e6e20 __ZN3RBX11ComputePropINS_4PartENS_12PartInstance20OnDemandPartInstanceEE8getValueEv")
}

// 0x5e6f20 — __ZN3rbx7signals6signalIFvbEE4nextERN5boost13intrusive_ptrINS3_4slotEEE
// demangled: rbx::signals::signal<void ()(bool)>::next(boost::intrusive_ptr<rbx::signals::signal<void ()(bool)>::slot> &)
...
pub fn stub_5e6f20() -> ! {
    todo!("0x5e6f20 __ZN3rbx7signals6signalIFvbEE4nextERN5boost13intrusive_ptrINS3_4slotEEE")
}

// 0x5e7080 — __ZN3rbx7signals6signalIFvbEE8on_errorERSt9exception
// demangled: rbx::signals::signal<void ()(bool)>::on_error(std::exception &)
// type: int(void)
...
pub fn stub_5e7080() -> ! {
    todo!("0x5e7080 __ZN3rbx7signals6signalIFvbEE8on_errorERSt9exception")
}
...
// demangled: void boost::intrusive_ptr_release<rbx::signals::connection::islot,int,0,0>(rbx::intrusive_ptr_target<rbx::signals::connection::islot,int,0,0> const*)
...
pub fn stub_5e70a8() -> ! {
    todo!("0x5e70a8 __ZN5boost21intrusive_ptr_releaseIN3rbx7signals10connection5islotEiLi0ELi0EEEvPKNS1_20intrusive_ptr_targetIT_T0_XT1_EXT2_EEE")
}

// 0x5e70e8 — __ZNK5boost9function1IvRSt9exceptionEclES2_
// demangled: boost::function1<void,std::exception &>::operator()(std::exception &)const
// type: int(void)
...
pub fn stub_5e70e8() -> ! {
    todo!("0x5e70e8 __ZNK5boost9function1IvRSt9exceptionEclES2_")
}
...
// demangled: `non-virtual thunk to'boost::exception_detail::error_info_injector<boost::bad_function_call>::~error_info_injector()
...
// demangled: `non-virtual thunk to'boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::bad_function_call>>::~clone_impl()
...
// demangled: `virtual thunk to'boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::bad_function_call>>::~clone_impl()
...
// demangled: boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::bad_function_call>>::clone(void)const
...
pub fn stub_5e72a0() -> ! {
    todo!("0x5e72a0 __ZNK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_17bad_function_callEEEE5cloneEv")
}

// 0x5e7360 — __ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_17bad_function_callEEEE5cloneEv
// demangled: `virtual thunk to'boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::bad_function_call>>::clone(void)const
...
pub fn stub_5e7360() -> ! {
    todo!("0x5e7360 __ZTv0_n12_NK5boost16exception_detail10clone_implINS0_19error_info_injectorINS_17bad_function_callEEEE5cloneEv")
}
...
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(bool)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(bool)>::slot> const&)
// type: int(void)
...
pub fn stub_5e7388() -> ! {
    todo!("0x5e7388 __ZN5boost13intrusive_ptrIN3rbx7signals6signalIFvbEE4slotEEaSERKS7_")
}

// 0x5e73b0 — __ZN3rbx7signals6signalIFvbEE24safe_static_do_get_mutexEv
// demangled: rbx::signals::signal<void ()(bool)>::safe_static_do_get_mutex(void)
...
pub fn stub_5e73b0() -> ! {
    todo!("0x5e73b0 __ZN3rbx7signals6signalIFvbEE24safe_static_do_get_mutexEv")
}

// 0x5e74a8 — __ZN5boost11unique_lockINS_5mutexEE4lockEv
// demangled: boost::unique_lock<boost::mutex>::lock(void)
// type: int __fastcall(_DWORD)
#[doc(alias = "boost::unique_lock<boost::mutex>::lock(void)")]
#[doc(alias = "__ZN5boost11unique_lockINS_5mutexEE4lockEv")]
pub fn stub_5e74a8() -> ! {
    todo!("0x5e74a8 __ZN5boost11unique_lockINS_5mutexEE4lockEv")
}
...
// demangled: std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::_M_insert_aux(__gnu_cxx::__normal_iterator<boost::weak_ptr<RBX::PartInstance>*,std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>>,boost::weak_ptr<RBX::PartInstance> const&)
...
pub fn stub_5e75dc() -> ! {
    todo!("0x5e75dc __ZNSt6vectorIN5boost8weak_ptrIN3RBX12PartInstanceEEESaIS4_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS4_S6_EERKS4_")
}

// 0x5e7b24 — __ZNSt12_Vector_baseIN5boost8weak_ptrIN3RBX12PartInstanceEEESaIS4_EE11_M_allocateEm
// demangled: std::_Vector_base<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::_M_allocate(unsigned long)
// type: int(void)
...
pub fn stub_5e7b24() -> ! {
    todo!("0x5e7b24 __ZNSt12_Vector_baseIN5boost8weak_ptrIN3RBX12PartInstanceEEESaIS4_EE11_M_allocateEm")
}
...
// demangled: boost::weak_ptr<RBX::PartInstance> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *>(boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *)
// type: int(void)
...
pub fn stub_5e7b98() -> ! {
    todo!("0x5e7b98 __ZNSt6vectorIN5boost10shared_ptrIN3RBX12PartInstanceEEESaIS4_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS4_S6_EERKS4_")
}
...
// demangled: __ZN3RBX10Reflection9DescribedINS_16TouchTransmitterELZNS_17sTouchTransmitterEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sTouchTransmitterEES4_EELNS0_15ClassDescriptor13FunctionalityE3ELNS_8Security11PermissionsE0EE15classDescriptorEv
// type: int __fastcall(int, int, int, int, int, __guard *, int, int, int)
...
// demangled: RBX::Allocator<RBX::FWPartInstance>::operator new(unsigned long)
// type: int(void)
...
pub fn stub_5e86b8() -> ! {
    todo!("0x5e86b8 __ZN3RBX9AllocatorINS_14FWPartInstanceEEnwEm")
}
...
// demangled: boost::singleton_pool<RBX::FWPartInstance,56u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::malloc(void)
// type: int(void)
...
pub fn stub_5e8728() -> ! {
    todo!("0x5e8728 __ZN5boost14singleton_poolIN3RBX14FWPartInstanceELj56ENS_34default_user_allocator_malloc_freeENS_5mutexELj32ELj0EE6mallocEv")
}

// 0x5e8760 — __ZN5boost4poolINS_34default_user_allocator_malloc_freeEE18malloc_need_resizeEv
// demangled: boost::pool<boost::default_user_allocator_malloc_free>::malloc_need_resize(void)
// type: int(void)
...
pub fn stub_5e8760() -> ! {
    todo!("0x5e8760 __ZN5boost4poolINS_34default_user_allocator_malloc_freeEE18malloc_need_resizeEv")
}

// 0x5e8840 — __ZN3RBX9AllocatorINS_12PartInstance20OnDemandPartInstanceEE13releaseMemoryEv
// demangled: RBX::Allocator<RBX::PartInstance::OnDemandPartInstance>::releaseMemory(void)
...
pub fn stub_5e8840() -> ! {
    todo!("0x5e8840 __ZN3RBX9AllocatorINS_12PartInstance20OnDemandPartInstanceEE13releaseMemoryEv")
}
...
// demangled: boost::singleton_pool<RBX::PartInstance::OnDemandPartInstance,200u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::release_memory(void)
// type: int(void)
...
pub fn stub_5e885c() -> ! {
    todo!("0x5e885c __ZN5boost14singleton_poolIN3RBX12PartInstance20OnDemandPartInstanceELj200ENS_34default_user_allocator_malloc_freeENS_5mutexELj32ELj0EE14release_memoryEv")
}

// 0x5e8890 — __ZN5boost10shared_ptrIN3RBX16TouchTransmitterEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_
// demangled: boost::shared_ptr<RBX::TouchTransmitter>::shared_ptr<RBX::TouchTransmitter,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TouchTransmitter *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_5e8890() -> ! {
    todo!("0x5e8890 __ZN5boost10shared_ptrIN3RBX16TouchTransmitterEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_")
}
...
// demangled: boost::detail::shared_count::shared_count<RBX::TouchTransmitter *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TouchTransmitter *,RBX::Creatable<RBX::Instance>::Deleter)
// type: int __fastcall(int, int, int, int, void *, int)
