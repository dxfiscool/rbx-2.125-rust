//! audio generated_150 — next 120 stubs EA-sorted, from ida/export.json
//! Filter: Sound|Audio|FMOD (2544 distinct) exhausted — filler EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 120 stubs | skeleton batch | range 0x3dc44..0x41a90 EA-sorted asc filler gap, rbx_core::SharedPtr not boost
...
pub fn stub_3e558() -> ! {
    todo!("0x3e558 rbx_core::SharedPtr<boost::exception_detail::clone_base const>::shared_ptr<boost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>>(boost::exception_detail::clone_impl<boost::exception_detail::bad_exception_> *)")
}
...
pub fn stub_3eab0() -> ! {
    todo!("0x3eab0 rbx_core::SharedPtr<boost::exception_detail::clone_base const>::shared_ptr<boost::exception_detail::clone_impl<boost::exception_detail::bad_alloc_>>(boost::exception_detail::clone_impl<boost::exception_detail::bad_alloc_> *)")
}
...
pub fn stub_3ebb8() -> ! {
    todo!("0x3ebb8 void rbx_core::SharedPtr_weak_release<rbx::signals::connection::islot,int,0,0>(rbx::intrusive_ptr_target<rbx::signals::connection::islot,int,0,0> const*)")
}
