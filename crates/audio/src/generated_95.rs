//! audio generated_95 — next 100 stubs EA-sorted, from ida/export.json
...
//! Batch: 100 stubs | skeleton batch | range 0xed74d4..0xeda7e4 EA-sorted asc filler after 0xed74c4, skip existing, rbx_core::SharedPtr not boost
