...
// Batch: +150 stubs | range 0x35cc54..0x3633ac | audio 22012 -> 22162 distinct
...
pub fn stub_0x35cc54() -> ! {
    todo!("0x35cc54 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Name *>>,std::string,RBX::Name *,boost::hash<std::string>,std::equal_to<std::string>>>::table(unsigned long,boost::hash<std::string> const&,std::equal_to<std::string> const&,std::allocator<boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Name *>>> const&)")
}
...
pub fn stub_0x35cee0() -> ! {
    todo!("0x35cee0 RBX::normalIdToMask(RBX::NormalId)")
}
...
pub fn stub_0x35cef8() -> ! {
    todo!("0x35cef8 RBX::validNormalId(RBX::NormalId)")
}
...
pub fn stub_0x35cf08() -> ! {
    todo!("0x35cf08 RBX::normalIdOpposite(RBX::NormalId)")
}
...
pub fn stub_0x35cf24() -> ! {
    todo!("0x35cf24 RBX::normalIdToU(RBX::NormalId)")
}
...
pub fn stub_0x35d1e8() -> ! {
    todo!("0x35d1e8 RBX::normalIdToVector3(RBX::NormalId)")
}
...
pub fn stub_0x35d3a8() -> ! {
    todo!("0x35d3a8 RBX::normalIdToMatrix3Internal(RBX::NormalId)")
}
...
pub fn stub_0x35d5f4() -> ! {
    todo!("0x35d5f4 RBX::normalIdToMatrix3(RBX::NormalId)")
}
...
pub fn stub_0x35db90() -> ! {
    todo!("0x35db90 RBX::Profiling::init(bool)")
}
...
pub fn stub_0x35dbc0() -> ! {
    todo!("0x35dbc0 RBX::Profiling::setEnabled(bool)")
}
...
pub fn stub_0x35dbd0() -> ! {
    todo!("0x35dbd0 RBX::Profiling::isEnabled(void)")
}
...
pub fn stub_0x35dbf8() -> ! {
    todo!("0x35dbf8 RBX::Profiling::Profiler::Profiler(char const*)")
}
...
pub fn stub_0x35dc78() -> ! {
    todo!("0x35dc78 RBX::Profiling::CodeProfiler::CodeProfiler(char const*)")
}
...
pub fn stub_0x35dc9c() -> ! {
    todo!("0x35dc9c RBX::Profiling::CodeProfiler::log(bool,double)")
}
...
pub fn stub_0x35dd68() -> ! {
    todo!("0x35dd68 RBX::Profiling::Profiler::getWindow(double)const")
}
...
pub fn stub_0x35de30() -> ! {
    todo!("0x35de30 RBX::Profiling::Profiler::getFrames(int)const")
}
...
pub fn stub_0x35ded0() -> ! {
    todo!("0x35ded0 RBX::Profiling::Bucket::getActualFPS(void)const")
}
...
pub fn stub_0x35df00() -> ! {
    todo!("0x35df00 RBX::Profiling::Bucket::getNominalFPS(void)const")
}
...
pub fn stub_0x35df30() -> ! {
    todo!("0x35df30 RBX::Profiling::Bucket::getNominalFramePeriod(void)const")
}
...
pub fn stub_0x35df60() -> ! {
    todo!("0x35df60 RBX::Profiling::Mark::Mark(RBX::Profiling::CodeProfiler &,bool,bool)")
}
...
pub fn stub_0x35df64() -> ! {
    todo!("0x35df64 RBX::Profiling::Mark::Mark(RBX::Profiling::CodeProfiler &,bool,bool)")
}
...
pub fn stub_0x35e0dc() -> ! {
    todo!("0x35e0dc std::_Vector_base<int,std::allocator<int>>::_M_allocate(unsigned long)")
}

// 0x35e0f4 — __GLOBAL__I_a_132
#[doc(alias = "global constructor keyed to_a_132")]
#[doc(alias = "__GLOBAL__I_a_132")]
pub fn stub_0x35e0f4() -> ! {
...
pub fn stub_0x35e2c8() -> ! {
    todo!("0x35e2c8 RBX::ProtectedString::ProtectedString(void)")
}
...
pub fn stub_0x35e2cc() -> ! {
    todo!("0x35e2cc RBX::ProtectedString::ProtectedString(void)")
}
...
pub fn stub_0x35e458() -> ! {
    todo!("0x35e458 RBX::ProtectedString::ProtectedString(RBX::ProtectedString const&)")
}
...
pub fn stub_0x35e45c() -> ! {
    todo!("0x35e45c RBX::ProtectedString::ProtectedString(RBX::ProtectedString const&)")
}
...
pub fn stub_0x35e538() -> ! {
    todo!("0x35e538 RBX::ProtectedString::fromTrustedSource(std::string const&)")
}
...
pub fn stub_0x35e628() -> ! {
    todo!("0x35e628 RBX::ProtectedString::calculateHash(std::string *)const")
}
...
pub fn stub_0x35e8fc() -> ! {
    todo!("0x35e8fc RBX::ProtectedString::getOriginalHash(void)const")
}
...
pub fn stub_0x35e900() -> ! {
    todo!("0x35e900 RBX::ProtectedString::getSalt(void)const")
}
...
pub fn stub_0x35e90c() -> ! {
    todo!("0x35e90c RBX::ProtectedString::readUnprotectedChar(int,char *)const")
}
...
pub fn stub_0x35e92c() -> ! {
    todo!("0x35e92c RBX::ProtectedString::operator==(RBX::ProtectedString const&)const")
}
...
pub fn stub_0x35e940() -> ! {
    todo!("0x35e940 RBX::ProtectedString::operator=(RBX::ProtectedString const&)")
}
...
pub fn stub_0x35e958() -> ! {
    todo!("0x35e958 bool XmlNameValuePair::getValue<RBX::ProtectedString>(RBX::ProtectedString &)const")
}
...
pub fn stub_0x35eba0() -> ! {
    todo!("0x35eba0 RBX::StringConverter<RBX::ProtectedString>::convertToValue(std::string const&,RBX::ProtectedString&)")
}
...
pub fn stub_0x35ed7c() -> ! {
    todo!("0x35ed7c RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::ProtectedString>(void)")
}
...
pub fn stub_0x35ee60() -> ! {
    todo!("0x35ee60 RBX::Reflection::TypedPropertyDescriptor<RBX::ProtectedString>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}
...
pub fn stub_0x35f03c() -> ! {
    todo!("0x35f03c RBX::Reflection::TypedPropertyDescriptor<RBX::ProtectedString>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}
...
pub fn stub_0x35f280() -> ! {
    todo!("0x35f280 RBX::ProtectedString & RBX::Reflection::Variant::convert<RBX::ProtectedString>(void)")
}
...
pub fn stub_0x35f3f4() -> ! {
    todo!("0x35f3f4 RBX::Reflection::TypedPropertyDescriptor<RBX::ProtectedString>::getDataSize(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x35f658() -> ! {
    todo!("0x35f658 RBX::Reflection::TypedPropertyDescriptor<RBX::ProtectedString>::getStringValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x35f824() -> ! {
    todo!("0x35f824 RBX::Reflection::TypedPropertyDescriptor<RBX::ProtectedString>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x35faa8() -> ! {
    todo!("0x35faa8 RBX::ProtectedString & RBX::Reflection::Variant::genericConvert<RBX::ProtectedString>(void)")
}
...
pub fn stub_0x35fdd0() -> ! {
    todo!("0x35fdd0 RBX::ProtectedString * rbx::any_cast<RBX::ProtectedString,RBX::Region3>(rbx::placement_any<RBX::Region3> *)")
}
...
pub fn stub_0x35fe28() -> ! {
    todo!("0x35fe28 rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::ProtectedString>(RBX::ProtectedString const&)")
}
...
pub fn stub_0x35fe84() -> ! {
    todo!("0x35fe84 RBX::ProtectedString & rbx::any_cast<RBX::ProtectedString &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")
}
...
pub fn stub_0x35ff74() -> ! {
    todo!("0x35ff74 rbx::implementation::typed_holder<RBX::ProtectedString>::singleton(void)")
}
...
pub fn stub_0x35ffe0() -> ! {
    todo!("0x35ffe0 rbx::implementation::typed_holder<RBX::ProtectedString>::construct_func(char const*,char *)")
}
...
pub fn stub_0x35fff0() -> ! {
    todo!("0x35fff0 rbx::implementation::typed_holder<RBX::ProtectedString>::destruct_func(char *)")
}
...
pub fn stub_0x3600a4() -> ! {
    todo!("0x3600a4 RBX::Reflection::Type::Type<RBX::ProtectedString>(char const*,RBX::ProtectedString *)")
}
...
pub fn stub_0x3602a8() -> ! {
    todo!("0x3602a8 RBX::Quaternion::operator=(RBX::Quaternion const&)")
}
...
pub fn stub_0x360560() -> ! {
    todo!("0x360560 RBX::Rect::positionPoint(RBX::Rect::Location,RBX::Rect::Location)const")
}
...
pub fn stub_0x360678() -> ! {
    todo!("0x360678 RBX::Rect::positionChild(RBX::Rect const&,RBX::Rect::Location,RBX::Rect::Location)const")
}

// 0x3607f4 — __GLOBAL__I_a_135
#[doc(alias = "global constructor keyed to_a_135")]
#[doc(alias = "__GLOBAL__I_a_135")]
pub fn stub_0x3607f4() -> ! {
...
pub fn stub_0x36082c() -> ! {
    todo!("0x36082c RBX::RunService::RunService(void)")
}
...
pub fn stub_0x360dd4() -> ! {
    todo!("0x360dd4 RBX::RunService::stopTasks(void)")
}
...
pub fn stub_0x360f34() -> ! {
    todo!("0x360f34 RBX::RunService::start(void)")
}
...
pub fn stub_0x3616b8() -> ! {
    todo!("0x3616b8 RBX::RunService::getPhysicsJob(void)")
}
...
pub fn stub_0x3616bc() -> ! {
    todo!("0x3616bc RBX::RunService::raiseHeartbeat(double,RBX::Time::Interval const&)")
}
...
pub fn stub_0x361750() -> ! {
    todo!("0x361750 RBX::RunService::gameStepped(double)")
}
...
pub fn stub_0x3617b8() -> ! {
    todo!("0x3617b8 RBX::RunService::setRunState(RBX::RunState)")
}
...
pub fn stub_0x361818() -> ! {
    todo!("0x361818 RBX::RunService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x361824() -> ! {
    todo!("0x361824 RBX::RunService::smoothFps(void)const")
}
...
pub fn stub_0x36182c() -> ! {
    todo!("0x36182c RBX::RunService::heartbeatFps(void)const")
}
...
pub fn stub_0x361834() -> ! {
    todo!("0x361834 RBX::RunService::physicsAverageStep(void)const")
}
...
pub fn stub_0x36183c() -> ! {
    todo!("0x36183c RBX::RunService::heartbeatAverageStep(void)const")
}
...
pub fn stub_0x361844() -> ! {
    todo!("0x361844 RBX::RunService::physicsCpuFraction(void)const")
}
...
pub fn stub_0x36184c() -> ! {
    todo!("0x36184c RBX::RunService::heartbeatCpuFraction(void)const")
}
...
pub fn stub_0x3618a0() -> ! {
    todo!("0x3618a0 RBX::RunService::run(void)")
}
...
pub fn stub_0x3618cc() -> ! {
    todo!("0x3618cc RBX::RunService::pause(void)")
}
...
pub fn stub_0x3618d4() -> ! {
    todo!("0x3618d4 RBX::RunService::stop(void)")
}
...
pub fn stub_0x3618e0() -> ! {
    todo!("0x3618e0 rbx_core::SharedPtr<RBX::PhysicsJob>::operator=(rbx_core::SharedPtr<RBX::PhysicsJob> const&)")
}
...
pub fn stub_0x361a78() -> ! {
    todo!("0x361a78 rbx_core::SharedPtr<RBX::HeartbeatTask>::operator=(rbx_core::SharedPtr<RBX::HeartbeatTask> const&)")
}
...
pub fn stub_0x361ab0() -> ! {
    todo!("0x361ab0 rbx_core::SharedPtr<RBX::RunService> RBX::shared_from<RBX::RunService>(RBX::RunService*)")
}
...
pub fn stub_0x361c20() -> ! {
    todo!("0x361c20 rbx::signals::signal_with_args<1,void ()(RBX::Heartbeat const&)>::operator()(RBX::Heartbeat const&)")
}
...
pub fn stub_0x361d64() -> ! {
    todo!("0x361d64 rbx::signals::signal_with_args<1,void ()(double)>::operator()(double)")
}
...
pub fn stub_0x361eb0() -> ! {
    todo!("0x361eb0 rbx::signals::signal_with_args<1,void ()(RBX::Stepped const&)>::operator()(RBX::Stepped const&)")
}
...
pub fn stub_0x361ff4() -> ! {
    todo!("0x361ff4 rbx::signals::signal_with_args<2,void ()(double,double)>::operator()(double,double)")
}
...
pub fn stub_0x362158() -> ! {
    todo!("0x362158 rbx::signals::signal_with_args<1,void ()(RBX::RunTransition)>::operator()(RBX::RunTransition)")
}
...
pub fn stub_0x3627c4() -> ! {
    todo!("0x3627c4 rbx::signals::signal<void ()(RBX::RunTransition)>::next(rbx_core::SharedPtr<rbx::signals::signal<void ()(RBX::RunTransition)>::slot> &)")
}
...
pub fn stub_0x362924() -> ! {
    todo!("0x362924 rbx::signals::signal<void ()(RBX::RunTransition)>::on_error(std::exception &)")
}
...
pub fn stub_0x362d98() -> ! {
    todo!("0x362d98 rbx_core::SharedPtr<rbx::signals::signal<void ()(RBX::RunTransition)>::slot>::operator=(rbx_core::SharedPtr<rbx::signals::signal<void ()(RBX::RunTransition)>::slot> const&)")
}
...
pub fn stub_0x362dc0() -> ! {
    todo!("0x362dc0 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::lock_error>>::rethrow(void)const")
}
...
pub fn stub_0x362f88() -> ! {
    todo!("0x362f88 `virtual thunk to'boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::lock_error>>::rethrow(void)const")
}
...
pub fn stub_0x362f98() -> ! {
    todo!("0x362f98 `virtual thunk to'boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::lock_error>>::~clone_impl()")
}
...
pub fn stub_0x362fb8() -> ! {
    todo!("0x362fb8 `non-virtual thunk to'boost::exception_detail::error_info_injector<boost::lock_error>::~error_info_injector()")
}
...
pub fn stub_0x362fd0() -> ! {
    todo!("0x362fd0 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::lock_error>>::clone_impl(boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::lock_error>> const&,boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::lock_error>>::clone_tag)")
}
...
pub fn stub_0x3631a8() -> ! {
    todo!("0x3631a8 rbx::signals::signal<void ()(RBX::RunTransition)>::safe_static_init_mutex(void)")
}
...
pub fn stub_0x3631b0() -> ! {
    todo!("0x3631b0 void rbx_core::SharedPtr_add_ref<rbx::signals::connection::islot,int,0,0>(rbx::intrusive_ptr_target<rbx::signals::connection::islot,int,0,0> const*)")
}
...
pub fn stub_0x363224() -> ! {
    todo!("0x363224 rbx::signals::signal<void ()(double,double)>::next(rbx_core::SharedPtr<rbx::signals::signal<void ()(double,double)>::slot> &)")
}
...
pub fn stub_0x3633ac() -> ! {
    todo!("0x3633ac rbx_core::SharedPtr<rbx::signals::signal<void ()(double,double)>::slot>::operator=(rbx_core::SharedPtr<rbx::signals::signal<void ()(double,double)>::slot> const&)")
}