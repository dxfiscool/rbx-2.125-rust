//! audio generated_162 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Audio|Sound (2541 distinct) exhausted — filler EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0x2b3434..0x2b6d00 EA-sorted asc filler gap, rbx_core::SharedPtr not boost
...
pub fn stub_2b3d88() -> ! {
    todo!("0x2b3d88 boost::_bi::list2<boost::arg<1>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<RBX::Reflection::Tuple const>)>>>::list2(boost::arg<1>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<RBX::Reflection::Tuple const>)>>)")
}

// 0x2b3e50 — __ZN5boost9function1IvNS_10shared_ptrIKN3RBX10Reflection5TupleEEEE5dummy7nonnullEv
#[doc(alias = "boost::function1<void,boost::shared_ptr<RBX::Reflection::Tuple const>>::dummy::nonnull(void)")]
pub fn stub_2b3e50() -> ! {
    todo!("0x2b3e50 boost::function1<void,boost::shared_ptr<RBX::Reflection::Tuple const>>::dummy::nonnull(void)")
}
...
pub fn stub_2b3f54() -> ! {
    todo!("0x2b3f54 boost::function1<void,boost::shared_ptr<RBX::Reflection::Tuple const>>::assign_to_own(boost::function1<void,boost::shared_ptr<RBX::Reflection::Tuple const>> const&)")
}
...
pub fn stub_2b40a8() -> ! {
    todo!("0x2b40a8 __ZN5boost6threadC2INS_9function0IvEEEET_NS_12disable_if_cIXsr5boost13thread_detail14is_convertibleIRS4_NS_6detail13thread_move_tIS4_EEEE5valueEPNS0_5dummyEE4typeE")
}
...
pub fn stub_2b42d0() -> ! {
    todo!("0x2b42d0 boost::detail::thread_data<boost::function0<void>>::run(void)")
}
...
pub fn stub_2b42d8() -> ! {
    todo!("0x2b42d8 boost::detail::thread_data_base::notify_all_at_thread_exit(boost::condition_variable *,boost::mutex *)")
}

// 0x2b42f0 — __ZNK5boost9function0IvEclEv
#[doc(alias = "boost::function0<void>::operator()(void)const")]
pub fn stub_2b42f0() -> ! {
    todo!("0x2b42f0 boost::function0<void>::operator()(void)const")
}
...
pub fn stub_2b43d8() -> ! {
    todo!("0x2b43d8 boost::detail::shared_count::shared_count<boost::detail::thread_data<boost::function0<void>>>(boost::detail::thread_data<boost::function0<void>> *)")
}
...
pub fn stub_2b44d8() -> ! {
    todo!("0x2b44d8 boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::function0<void>>>::dispose(void)")
}
...
pub fn stub_2b44e8() -> ! {
    todo!("0x2b44e8 boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::function0<void>>>::get_deleter(std::type_info const&)")
}
...
pub fn stub_2b4be8() -> ! {
    todo!("0x2b4be8 rbx::implementation::typed_holder<boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>::singleton(void)")
}
...
#[doc(alias = "rbx::implementation::typed_holder<boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>::destruct_func(char *)")]
pub fn stub_2b4c58() -> ! {
    todo!("0x2b4c58 rbx::implementation::typed_holder<boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>::destruct_func(char *)")
}
...
pub fn stub_2b4fb8() -> ! {
    todo!("0x2b4fb8 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>,std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>>>::create_buckets(unsigned long)")
}
...
pub fn stub_2b50e4() -> ! {
    todo!("0x2b50e4 boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>(boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> *)")
}
...
pub fn stub_2b52c8() -> ! {
    todo!("0x2b52c8 boost::detail::sp_counted_impl_p<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>::~sp_counted_impl_p()")
}
...
pub fn stub_2b52d0() -> ! {
    todo!("0x2b52d0 boost::detail::sp_counted_impl_p<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>::dispose(void)")
}
...
pub fn stub_2b5378() -> ! {
    todo!("0x2b5378 boost::detail::sp_counted_impl_p<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>::get_untyped_deleter(void)")
}
...
pub fn stub_2b5380() -> ! {
    todo!("0x2b5380 rbx::detail::sp_ms_deleter<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>> * boost::get_deleter<rbx::detail::sp_ms_deleter<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>> const&)")
}
...
pub fn stub_2b53e0() -> ! {
    todo!("0x2b53e0 std::_Vector_base<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>::_M_allocate(unsigned long)")
}
...
pub fn stub_2b5408() -> ! {
    todo!("0x2b5408 boost::detail::sp_counted_impl_pd<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> *,rbx::detail::sp_ms_deleter<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>>::~sp_counted_impl_pd()")
}
...
pub fn stub_2b5438() -> ! {
    todo!("0x2b5438 boost::detail::sp_counted_impl_pd<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> *,rbx::detail::sp_ms_deleter<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>>::get_deleter(std::type_info const&)")
}
...
pub fn stub_2b5450() -> ! {
    todo!("0x2b5450 boost::detail::sp_counted_impl_pd<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> *,rbx::detail::sp_ms_deleter<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>>::get_untyped_deleter(void)")
}
...
pub fn stub_2b5458() -> ! {
    todo!("0x2b5458 rbx::implementation::typed_holder<boost::shared_ptr<RBX::Reflection::Tuple const>>::singleton(void)")
}

// 0x2b54c8 — __ZN3rbx14implementation12typed_holderIN5boost10shared_ptrIKN3RBX10Reflection5TupleEEEE13destruct_funcEPc
#[doc(alias = "rbx::implementation::typed_holder<boost::shared_ptr<RBX::Reflection::Tuple const>>::destruct_func(char *)")]
pub fn stub_2b54c8() -> ! {
    todo!("0x2b54c8 rbx::implementation::typed_holder<boost::shared_ptr<RBX::Reflection::Tuple const>>::destruct_func(char *)")
}
...
pub fn stub_2b56c0() -> ! {
    todo!("0x2b56c0 boost::detail::shared_count::shared_count<RBX::Reflection::Tuple>(RBX::Reflection::Tuple *)")
}
...
pub fn stub_2b57d0() -> ! {
    todo!("0x2b57d0 boost::detail::sp_counted_impl_p<RBX::Reflection::Tuple>::~sp_counted_impl_p()")
}
...
pub fn stub_2b57d8() -> ! {
    todo!("0x2b57d8 boost::detail::sp_counted_impl_p<RBX::Reflection::Tuple>::get_deleter(std::type_info const&)")
}
...
pub fn stub_2b67b0() -> ! {
    todo!("0x2b67b0 std::_List_base<boost::shared_ptr<RBX::LibraryService::LibraryStateObject>,std::allocator<boost::shared_ptr<RBX::LibraryService::LibraryStateObject>>>::_M_clear(void)")
}
