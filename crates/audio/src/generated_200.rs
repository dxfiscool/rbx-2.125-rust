//! audio generated_200 — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4a8174..0x4aacf0 | existing 27113 -> 27213 distinct
...
// demangled: RBX::Reflection::PropDescriptor<RBX::FaceInstance,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::FaceInstance::*)(void)const,void (RBX::FaceInstance::*)(RBX::NormalId)>::setValue(RBX::Reflection::DescribedBase *,RBX::NormalId const&)const
...
// demangled: global constructor keyed to_a_190
...
// demangled: RBX::FactoryRegistrator::FactoryRegistrator(void)
...
pub fn stub_4aa8c4() -> ! {
    todo!("0x4aa8c4 RBX::FactoryRegistrator::FactoryRegistrator(void)")
}
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::TaskScheduler::Job::SleepAdjustMethod>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::TaskScheduler::ThreadPoolConfig>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Controller::Button>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::GuiObject::TweenEasingStyle>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::GuiObject::TweenStatus>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::GuiObject::TweenEasingDirection>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::TextService::XAlignment>(void)
// type: int __fastcall(_DWORD)
