//! audio generated_121 — next 100 stubs EA-sorted, from ida/export.json
...
//! Batch: 100 stubs | skeleton batch | range 0xf2e474..0xf2eaa4 EA-sorted asc filler after 0xf2e464, skip existing, rbx_core::SharedPtr not boost
...
pub fn stub_f2e474() {
    // IDA 0xf2e474: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_f2e484() {
    // IDA 0xf2e484: Thumb import jump veneer for `j___ZN5boost3_bi5list5INS0_5valueISsEES3_NS2_IbEES4_NS2_INS_8functionIFvPSsPSt9exceptionEEEEEEclIPFvSsSsbbSA_ENS0_5list1IRNS_10shared_ptrIN3RBX5mutexEEEEEEEvNS0_4typeIvEERT_RT0_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>::operator()<void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list1<boost::shared_ptr<RBX::mutex> &>>(boost::_bi::type<void>,void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>) &,boost::_bi::list1<boost::shared_ptr<RBX::mutex> &> &,int).
}
...
pub fn stub_f2e494() {
    // IDA 0xf2e494: Thumb import jump veneer for `j___ZN5boost3_bi8storage2INS0_5valueISsEENS2_INS_10shared_ptrISiEEEEEC2ES3_S6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage2<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>>::storage2(boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>).
}
...
pub fn stub_f2e4a4() {
    // IDA 0xf2e4a4: Thumb import jump veneer for `j___ZN5boost3_bi8storage2INS0_5valueISsEENS2_IbEEEC2ES3_S4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage2<boost::_bi::value<std::string>,boost::_bi::value<bool>>::storage2(boost::_bi::value<std::string>,boost::_bi::value<bool>).
}
...
pub fn stub_f2e4b4() {
    // IDA 0xf2e4b4: Thumb import jump veneer for `j___ZN5boost3_bi8storage3INS0_5valueISsEENS2_INS_10shared_ptrISiEEEENS2_IbEEEC2ES3_S6_S7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage3<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>>::storage3(boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>).
}
...
pub fn stub_f2e4c4() {
    // IDA 0xf2e4c4: function ctor/assign from a bind_t functor. Box<dyn Fn> from closure captures — carrier no-op.
}
...
pub fn stub_f2e4d4() {
    // IDA 0xf2e4d4: Thumb import jump veneer for `j___ZN5boost3_bi8storage3INS0_5valueISsEES3_NS2_IbEEEC2ES3_S3_S4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage3<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>>::storage3(boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>).
}
...
pub fn stub_f2e4e4() {
    // IDA 0xf2e4e4: Thumb import jump veneer for `j___ZN5boost3_bi8storage4INS0_5valueISsEENS2_INS_10shared_ptrISiEEEENS2_IbEES7_EC2ES3_S6_S7_S7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage4<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>>::storage4(boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>).
}
...
pub fn stub_f2e4f4() {
    // IDA 0xf2e4f4: Thumb import jump veneer for `j___ZN5boost3_bi8storage4INS0_5valueISsEES3_NS2_IbEES4_EC2ES3_S3_S4_S4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::storage4<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>>::storage4(boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>).
}
...
pub fn stub_f2e504() {
    // IDA 0xf2e504: function ctor/assign from a bind_t functor. Box<dyn Fn> from closure captures — carrier no-op.
}
...
pub fn stub_f2e514() {
    // IDA 0xf2e514: function ctor/assign from a bind_t functor. Box<dyn Fn> from closure captures — carrier no-op.
}
...
pub fn stub_f2e534() {
    // IDA 0xf2e534: Thumb import jump veneer for `j___ZN5boost4bindIvSsSsbbNS_8functionIFvPSsPSt9exceptionEEESsSsbbS6_EENS_3_bi6bind_tIT_PFS9_T0_T1_T2_T3_T4_ENS7_9list_av_5IT5_T6_T7_T8_T9_E4typeEEESG_SI_SJ_SK_SL_SM_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::bind_t<void,void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list_av_5<std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>>::type> boost::bind<void,std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>,std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>>(void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>).
}
...
pub fn stub_f2e544() {
    // IDA 0xf2e544: Thumb import jump veneer for `j___ZN5boost4bindIvSsbNS_8functionIFvPSsPSt9exceptionEEESsbS6_EENS_3_bi6bind_tIT_PFS9_T0_T1_T2_ENS7_9list_av_3IT3_T4_T5_E4typeEEESE_SG_SH_SI_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::_bi::bind_t<void,void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list_av_3<std::string,bool,boost::function<void ()(std::string *,std::exception *)>>::type> boost::bind<void,std::string,bool,boost::function<void ()(std::string *,std::exception *)>,std::string,bool,boost::function<void ()(std::string *,std::exception *)>>(void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),std::string,bool,boost::function<void ()(std::string *,std::exception *)>).
}
...
pub fn stub_f2e554() {
    // IDA 0xf2e554: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_f2e594() {
    // IDA 0xf2e594: Thumb import jump veneer for `j___ZN5boost8functionIFvNS_10shared_ptrIN3RBX5mutexEEEEEC2INS_3_bi6bind_tIvPFvSsNS1_ISiEEbbNS0_IFvPSsPSt9exceptionEEEENS8_5list5INS8_5valueISsEENSJ_ISA_EENSJ_IbEESM_NSJ_ISF_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISQ_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost8functionIFvNS_10shared_ptrIN3RBX5mutexEEEEEC2INS_3_bi6bind_tIvPFvSsNS1_ISiEEbbNS0_IFvPSsPSt9exceptionEEEENS8_5list5INS8_5valueISsEENSJ_ISA_EENSJ_IbEESM_NSJ_ISF_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISQ_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e5a4() {
    // IDA 0xf2e5a4: Thumb import jump veneer for `j___ZN5boost8functionIFvNS_10shared_ptrIN3RBX5mutexEEEEEC2INS_3_bi6bind_tIvPFvSsSsbbNS0_IFvPSsPSt9exceptionEEEENS8_5list5INS8_5valueISsEESJ_NSI_IbEESK_NSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost8functionIFvNS_10shared_ptrIN3RBX5mutexEEEEEC2INS_3_bi6bind_tIvPFvSsSsbbNS0_IFvPSsPSt9exceptionEEEENS8_5list5INS8_5valueISsEESJ_NSI_IbEESK_NSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e5b4() {
    // IDA 0xf2e5b4: Thumb import jump veneer for `j___ZN5boost8functionIFvNS_10shared_ptrIN3RBX5mutexEEEEEC2INS_3_bi6bind_tIvPFvSsbNS0_IFvPSsPSt9exceptionEEEENS8_5list3INS8_5valueISsEENSI_IbEENSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost8functionIFvNS_10shared_ptrIN3RBX5mutexEEEEEC2INS_3_bi6bind_tIvPFvSsbNS0_IFvPSsPSt9exceptionEEEENS8_5list3INS8_5valueISsEENSI_IbEENSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e5f4() {
    // IDA 0xf2e5f4: Thumb import jump veneer for `j___ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEEC2INS_3_bi6bind_tIvPFvSsNS1_ISiEEbbNS_8functionIFvPSsPSt9exceptionEEEENS7_5list5INS7_5valueISsEENSJ_IS9_EENSJ_IbEESM_NSJ_ISF_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISQ_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEEC2INS_3_bi6bind_tIvPFvSsNS1_ISiEEbbNS_8functionIFvPSsPSt9exceptionEEEENS7_5list5INS7_5valueISsEENSJ_IS9_EENSJ_IbEESM_NSJ_ISF_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISQ_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e604() {
    // IDA 0xf2e604: Thumb import jump veneer for `j___ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEEC2INS_3_bi6bind_tIvPFvSsSsbbNS_8functionIFvPSsPSt9exceptionEEEENS7_5list5INS7_5valueISsEESJ_NSI_IbEESK_NSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEEC2INS_3_bi6bind_tIvPFvSsSsbbNS_8functionIFvPSsPSt9exceptionEEEENS7_5list5INS7_5valueISsEESJ_NSI_IbEESK_NSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e614() {
    // IDA 0xf2e614: Thumb import jump veneer for `j___ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEEC2INS_3_bi6bind_tIvPFvSsbNS_8functionIFvPSsPSt9exceptionEEEENS7_5list3INS7_5valueISsEENSI_IbEENSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: j___ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEEC2INS_3_bi6bind_tIvPFvSsbNS_8functionIFvPSsPSt9exceptionEEEENS7_5list3INS7_5valueISsEENSI_IbEENSI_ISE_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISO_EE5valueEEE5valueEiE4typeE.
}
...
pub fn stub_f2e634() {
    // IDA 0xf2e634: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvNS_10shared_ptrIN3RBX5mutexEEEE14assign_functorINS_3_bi6bind_tIvPFvSsNS3_ISiEEbbNS_8functionIFvPSsPSt9exceptionEEEENS9_5list5INS9_5valueISsEENSL_ISB_EENSL_IbEESO_NSL_ISH_EEEEEEEEvT_RNS1_15function_bufferEN4mpl_5bool_ILb0EEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::detail::function::basic_vtable1<void,boost::shared_ptr<RBX::mutex>>::assign_functor<boost::_bi::bind_t<void,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const.
}
...
pub fn stub_f2e664() {
    // IDA 0xf2e664: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvNS_10shared_ptrIN3RBX5mutexEEEE9assign_toINS_3_bi6bind_tIvPFvSsNS3_ISiEEbbNS_8functionIFvPSsPSt9exceptionEEEENS9_5list5INS9_5valueISsEENSL_ISB_EENSL_IbEESO_NSL_ISH_EEEEEEEEbT_RNS1_15function_bufferE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,boost::shared_ptr<RBX::mutex>>::assign_to<boost::_bi::bind_t<void,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &)const.
}
...
pub fn stub_f2e674() {
    // IDA 0xf2e674: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvNS_10shared_ptrIN3RBX5mutexEEEE9assign_toINS_3_bi6bind_tIvPFvSsNS3_ISiEEbbNS_8functionIFvPSsPSt9exceptionEEEENS9_5list5INS9_5valueISsEENSL_ISB_EENSL_IbEESO_NSL_ISH_EEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,boost::shared_ptr<RBX::mutex>>::assign_to<boost::_bi::bind_t<void,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,boost::shared_ptr<std::istream>,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<boost::shared_ptr<std::istream>>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const.
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable1<void,rbx_core::SharedPtr<RBX::mutex>>::assign_to<boost::_bi::bind_t<void,void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f2e694() {
    // IDA 0xf2e694: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvNS_10shared_ptrIN3RBX5mutexEEEE9assign_toINS_3_bi6bind_tIvPFvSsSsbbNS_8functionIFvPSsPSt9exceptionEEEENS9_5list5INS9_5valueISsEESL_NSK_IbEESM_NSK_ISG_EEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,boost::shared_ptr<RBX::mutex>>::assign_to<boost::_bi::bind_t<void,void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,std::string,bool,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list5<boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const.
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable1<void,rbx_core::SharedPtr<RBX::mutex>>::assign_to<boost::_bi::bind_t<void,void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list3<boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list3<boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f2e6b4() {
    // IDA 0xf2e6b4: Thumb import jump veneer for `j___ZNK5boost6detail8function13basic_vtable1IvNS_10shared_ptrIN3RBX5mutexEEEE9assign_toINS_3_bi6bind_tIvPFvSsbNS_8functionIFvPSsPSt9exceptionEEEENS9_5list3INS9_5valueISsEENSK_IbEENSK_ISG_EEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool boost::detail::function::basic_vtable1<void,boost::shared_ptr<RBX::mutex>>::assign_to<boost::_bi::bind_t<void,void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list3<boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>>(boost::_bi::bind_t<void,void (*)(std::string,bool,boost::function<void ()(std::string *,std::exception *)>),boost::_bi::list3<boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const.
}
...
pub fn stub_f2e6c4() {
    // IDA 0xf2e6c4: Thumb import jump veneer for `j___ZNK5boost9function2IvPSsPSt9exceptionEclES1_S3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::function2<void,std::string *,std::exception *>::operator()(std::string *,std::exception *)const.
}
...
pub fn stub_f2e6d4() {
    // IDA 0xf2e6d4: Thumb import jump veneer for `j___ZN3RBX7Extents2vvERKN3G3D7Vector3ES4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Extents::vv(G3D::Vector3 const&,G3D::Vector3 const&).
}
...
pub fn stub_f2e6e4() {
    // IDA 0xf2e6e4: Thumb import jump veneer for `j___ZNK3RBX4Face7getAxisEi` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Face::getAxis(int)const.
}
...
pub fn stub_f2e6f4() {
    // IDA 0xf2e6f4: Thumb import jump veneer for `j___ZN3rbx7signals6signalIFvRKN3RBX9HeartbeatEEE7connectIN5boost3_bi6bind_tIvNS9_4_mfi3mf1IvNS2_17HeartbeatInstanceES5_EENSA_5list2INSA_5valueIPSE_EENS9_3argILi1EEEEEEEEENS0_10connectionERKT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: rbx::signals::connection rbx::signals::signal<void ()(RBX::Heartbeat const&)>::connect<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>>(boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>> const&).
}
...
pub fn stub_f2e704() {
    // IDA 0xf2e704: Thumb import jump veneer for `j___ZN5boost3_bi6bind_tIvNS_4_mfi3mf1IvN3RBX17HeartbeatInstanceERKNS4_9HeartbeatEEENS0_5list2INS0_5valueIPS5_EENS_3argILi1EEEEEEclIS6_EEvRKT_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: void boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>::operator()<RBX::Heartbeat>(RBX::Heartbeat const&).
}
...
pub fn stub_f2e714() {
    // IDA 0xf2e714: Thumb import jump veneer for `j___ZN3RBX11IndexedMesh13lowersChangedEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::IndexedMesh::lowersChanged(void).
}
...
pub fn stub_f2e724() {
    // IDA 0xf2e724: Thumb import jump veneer for `j___ZN3RBX11IndexedTree13getTypedChildINS_11IndexedMeshEEEPT_i` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::IndexedMesh * RBX::IndexedTree::getTypedChild<RBX::IndexedMesh>(int).
}
...
pub fn stub_f2e734() {
    // IDA 0xf2e734: Thumb import jump veneer for `j___ZN3G3D5ArrayIPN3RBX11IndexedTreeELi10ELm32EE6appendERKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<RBX::IndexedTree *,10,32ul>::append(RBX::IndexedTree * const&).
}
...
pub fn stub_f2e744() {
    // IDA 0xf2e744: Thumb import jump veneer for `j___ZN3G3D5ArrayIPN3RBX11IndexedTreeELi10ELm32EE6resizeEib` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<RBX::IndexedTree *,10,32ul>::resize(int,bool).
}
...
pub fn stub_f2e754() {
    // IDA 0xf2e754: Thumb import jump veneer for `j___ZN3G3D5ArrayIPN3RBX11IndexedTreeELi10ELm32EE7reallocEi` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<RBX::IndexedTree *,10,32ul>::realloc(int).
}
...
pub fn stub_f2e764() {
    // IDA 0xf2e764: Thumb import jump veneer for `j___ZN3G3D5ArrayIPN3RBX11IndexedTreeELi10ELm32EEC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: G3D::Array<RBX::IndexedTree *,10,32ul>::Array(void).
}
...
pub fn stub_f2e774() {
    // IDA 0xf2e774: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_f2e784() {
    // IDA 0xf2e784: Thumb import jump veneer for `j___ZN3RBX10IndexArrayINS_11IndexedTreeEXadL_ZNS1_8getIndexEvEEE10fastRemoveEPS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::IndexArray<RBX::IndexedTree,&RBX::IndexedTree::getIndex>::fastRemove(RBX::IndexedTree*).
}
...
pub fn stub_f2e794() {
    // IDA 0xf2e794: Thumb import jump veneer for `j___ZN5boost10cb_details8iteratorINS_15circular_bufferIN3RBX18InterpolatedCFrame9FrameInfoESaIS5_EEENS0_15nonconst_traitsIS6_EEEmIEi` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>::operator-=(int).
}
...
#[doc(alias = "boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>::operator+=(int)")]
pub fn stub_f2e7a4() {
    // IDA 0xf2e7a4: Thumb import jump veneer for `j___ZN5boost10cb_details8iteratorINS_15circular_bufferIN3RBX18InterpolatedCFrame9FrameInfoESaIS5_EEENS0_15nonconst_traitsIS6_EEEpLEi` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>::operator+=(int).
}
...
pub fn stub_f2e7b4() {
    // IDA 0xf2e7b4: Thumb import jump veneer for `j___ZN5boost15circular_bufferIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE12set_capacityEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::set_capacity(unsigned long).
}
...
pub fn stub_f2e7c4() {
    // IDA 0xf2e7c4: Thumb import jump veneer for `j___ZN5boost15circular_bufferIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE5eraseENS_10cb_details8iteratorIS5_NS6_15nonconst_traitsIS4_EEEESA_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::erase(boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>,boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>).
}
...
pub fn stub_f2e7d4() {
    // IDA 0xf2e7d4: Thumb import jump veneer for `j___ZN5boost15circular_bufferIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE9push_backERKS3_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::push_back(RBX::InterpolatedCFrame::FrameInfo const&).
}
...
pub fn stub_f2e7e4() {
    // IDA 0xf2e7e4: Thumb import jump veneer for `j___ZN5boost31circular_buffer_space_optimizedIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE18check_low_capacityEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer_space_optimized<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::check_low_capacity(unsigned long).
}
...
pub fn stub_f2e7f4() {
    // IDA 0xf2e7f4: Thumb import jump veneer for `j___ZN5boost31circular_buffer_space_optimizedIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE19check_high_capacityEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer_space_optimized<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::check_high_capacity(void).
}
...
pub fn stub_f2e804() {
    // IDA 0xf2e804: Thumb import jump veneer for `j___ZN5boost31circular_buffer_space_optimizedIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE5clearEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer_space_optimized<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::clear(void).
}
...
pub fn stub_f2e814() {
    // IDA 0xf2e814: Thumb import jump veneer for `j___ZN5boost31circular_buffer_space_optimizedIN3RBX18InterpolatedCFrame9FrameInfoESaIS3_EE5eraseENS_10cb_details8iteratorINS_15circular_bufferIS3_S4_EENS6_15nonconst_traitsIS4_EEEESC_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::circular_buffer_space_optimized<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::erase(boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>,boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>).
}
...
pub fn stub_f2e824() {
    // IDA 0xf2e824: Thumb import jump veneer for `j___ZNK5boost10cb_details8iteratorINS_15circular_bufferIN3RBX18InterpolatedCFrame9FrameInfoESaIS5_EEENS0_15nonconst_traitsIS6_EEE17linearize_pointerIS9_EENT_7pointerERKNS1_IS7_SC_EE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::pointer boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>::linearize_pointer<boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>>(boost::cb_details::iterator<boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>,boost::cb_details::nonconst_traits<std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::pointer> const&)const.
}
...
pub fn stub_f2e834() {
    // IDA 0xf2e834: Thumb import jump veneer for `j___ZN3RBX10Reflection8EnumDescINS_17KeywordFilterTypeEE7addPairES2_PKc` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::Reflection::EnumDesc<RBX::KeywordFilterType>::addPair(RBX::KeywordFilterType,char const*).
}
...
pub fn stub_f2e844() {
    // IDA 0xf2e844: Thumb import jump veneer for `j___ZNSt12_Vector_baseIN3RBX17KeywordFilterTypeESaIS1_EE11_M_allocateEm` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Vector_base<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>::_M_allocate(unsigned long).
}
...
pub fn stub_f2e854() {
    // IDA 0xf2e854: Thumb import jump veneer for `j___ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX17KeywordFilterTypeES5_EET0_T_S7_S6_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::KeywordFilterType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::KeywordFilterType *,RBX::KeywordFilterType *>(RBX::KeywordFilterType *,RBX::KeywordFilterType *,RBX::KeywordFilterType *).
}
...
pub fn stub_f2e864() {
    // IDA 0xf2e864: Thumb import jump veneer for `j___ZNSt3mapIPKN3RBX4NameENS0_17KeywordFilterTypeESt4lessIS3_ESaISt4pairIKS3_S4_EEEixERS8_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::map<RBX::Name const*,RBX::KeywordFilterType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>>::operator[](RBX::Name const* const&).
}
...
pub fn stub_f2e874() {
    // IDA 0xf2e874: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX17KeywordFilterTypeESaIS1_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS1_S3_EERKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::KeywordFilterType*,std::vector<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>>,RBX::KeywordFilterType const&).
}
...
pub fn stub_f2e884() {
    // IDA 0xf2e884: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX17KeywordFilterTypeESaIS1_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS1_S3_EEmRKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::KeywordFilterType*,std::vector<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>>,unsigned long,RBX::KeywordFilterType const&).
}
...
pub fn stub_f2e894() {
    // IDA 0xf2e894: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX17KeywordFilterTypeESaIS1_EE6resizeEmS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>::resize(unsigned long,RBX::KeywordFilterType).
}
...
pub fn stub_f2e8a4() {
    // IDA 0xf2e8a4: Thumb import jump veneer for `j___ZNSt6vectorIN3RBX17KeywordFilterTypeESaIS1_EE9push_backERKS1_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::vector<RBX::KeywordFilterType,std::allocator<RBX::KeywordFilterType>>::push_back(RBX::KeywordFilterType const&).
}
...
pub fn stub_f2e8b4() {
    // IDA 0xf2e8b4: Thumb import jump veneer for `j___ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_17KeywordFilterTypeEESt10_Select1stIS7_ESt4lessIS3_ESaIS7_EE16_M_insert_uniqueERKS7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::KeywordFilterType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::KeywordFilterType> const&).
}
...
pub fn stub_f2e8c4() {
    // IDA 0xf2e8c4: Thumb import jump veneer for `j___ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_17KeywordFilterTypeEESt10_Select1stIS7_ESt4lessIS3_ESaIS7_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS7_ERKS7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::KeywordFilterType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>,std::pair<RBX::Name const* const,RBX::KeywordFilterType> const&).
}
...
pub fn stub_f2e8d4() {
    // IDA 0xf2e8d4: Thumb import jump veneer for `j___ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_17KeywordFilterTypeEESt10_Select1stIS7_ESt4lessIS3_ESaIS7_EE9_M_insertEPSt18_Rb_tree_node_baseSF_RKS7_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::KeywordFilterType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::KeywordFilterType>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::KeywordFilterType> const&).
}
...
pub fn stub_f2e8e4() {
    // IDA 0xf2e8e4: Thumb import jump veneer for `j___ZN5boost9unordered6detail5tableINS1_3mapISaISt4pairIKSsSsEESsSsNS_4hashISsEESt8equal_toISsEEEEC2EmRKS9_RKSB_RKSaINS1_8ptr_nodeIS6_EEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,std::string>>,std::string,std::string,boost::hash<std::string>,std::equal_to<std::string>>>::table(unsigned long,boost::hash<std::string> const&,std::equal_to<std::string> const&,std::allocator<boost::unordered::detail::ptr_node<std::pair<std::string const,std::string>>> const&).
}
...
pub fn stub_f2e8f4() {
    // IDA 0xf2e8f4: Thumb import jump veneer for `j___ZNK5boost9unordered6detail10table_implINS1_3mapISaISt4pairIKSsSsEESsSsNS_4hashISsEESt8equal_toISsEEEE14find_node_implISsSB_EENS0_15iterator_detail8iteratorINS1_8ptr_nodeIS6_EEEEmRKT_RKT0_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<std::string const,std::string>>> boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<std::string const,std::string>>,std::string,std::string,boost::hash<std::string>,std::equal_to<std::string>>>::find_node_impl<std::string,std::equal_to<std::string>>(unsigned long,std::string const&,std::equal_to<std::string> const&)const.
}
...
pub fn stub_f2e904() {
    // IDA 0xf2e904: Thumb import jump veneer for `j___ZNK5boost9unordered6detail5tableINS1_3mapISaISt4pairIKSsSsEESsSsNS_4hashISsEESt8equal_toISsEEEE9find_nodeERS5_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,std::string>>,std::string,std::string,boost::hash<std::string>,std::equal_to<std::string>>>::find_node(std::string const&)const.
}
...
pub fn stub_f2e914() {
    // IDA 0xf2e914: Thumb import jump veneer for `j___ZN3RBX13LuaWebService10checkCacheIN5boost10shared_ptrIKSt6vectorINS_10Reflection7VariantESaIS6_EEEEEEbRKSsNS2_8functionIFvT_EEENSD_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::checkCache<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>(std::string const&,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e924() {
    // IDA 0xf2e924: Thumb import jump veneer for `j___ZN3RBX13LuaWebService10checkCacheISsEEbRKSsN5boost8functionIFvT_EEENS5_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::checkCache<std::string>(std::string const&,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e934() {
    // IDA 0xf2e934: Thumb import jump veneer for `j___ZN3RBX13LuaWebService10checkCacheIbEEbRKSsN5boost8functionIFvT_EEENS5_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::checkCache<bool>(std::string const&,boost::function<void ()(bool)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e944() {
    // IDA 0xf2e944: Thumb import jump veneer for `j___ZN3RBX13LuaWebService10checkCacheIiEEbRKSsN5boost8functionIFvT_EEENS5_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::checkCache<int>(std::string const&,boost::function<void ()(int)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e954() {
    // IDA 0xf2e954: Thumb import jump veneer for `j___ZN3RBX13LuaWebService18TryDispatchRequestIN5boost10shared_ptrIKSt3mapISsNS_10Reflection7VariantESt4lessISsESaISt4pairIKSsS6_EEEEEEEbPNS_14AsyncHttpCacheINS0_23CachedLuaWebServiceInfoELb1EEERSA_NS2_8functionIFvT_EEENSL_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::TryDispatchRequest<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>(RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true> *,std::string const&,boost::function<void ()(boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e964() {
    // IDA 0xf2e964: Thumb import jump veneer for `j___ZN3RBX13LuaWebService18TryDispatchRequestIN5boost10shared_ptrIKSt6vectorINS_10Reflection7VariantESaIS6_EEEEEEbPNS_14AsyncHttpCacheINS0_23CachedLuaWebServiceInfoELb1EEERKSsNS2_8functionIFvT_EEENSH_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::TryDispatchRequest<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>(RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true> *,std::string const&,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e974() {
    // IDA 0xf2e974: Thumb import jump veneer for `j___ZN3RBX13LuaWebService18TryDispatchRequestISsEEbPNS_14AsyncHttpCacheINS0_23CachedLuaWebServiceInfoELb1EEERKSsN5boost8functionIFvT_EEENS9_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::TryDispatchRequest<std::string>(RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true> *,std::string const&,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e984() {
    // IDA 0xf2e984: Thumb import jump veneer for `j___ZN3RBX13LuaWebService18TryDispatchRequestIbEEbPNS_14AsyncHttpCacheINS0_23CachedLuaWebServiceInfoELb1EEERKSsN5boost8functionIFvT_EEENS9_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::TryDispatchRequest<bool>(RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true> *,std::string const&,boost::function<void ()(bool)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e994() {
    // IDA 0xf2e994: Thumb import jump veneer for `j___ZN3RBX13LuaWebService18TryDispatchRequestIiEEbPNS_14AsyncHttpCacheINS0_23CachedLuaWebServiceInfoELb1EEERKSsN5boost8functionIFvT_EEENS9_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::TryDispatchRequest<int>(RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true> *,std::string const&,boost::function<void ()(int)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e9a4() {
    // IDA 0xf2e9a4: Thumb import jump veneer for `j___ZN3RBX13LuaWebService21TryRawDispatchRequestISsEEbPNS_14AsyncHttpCacheINS0_26CachedRawLuaWebServiceInfoELb1EEERKSsN5boost8functionIFvT_EEENS9_IFvSsEEE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: bool RBX::LuaWebService::TryRawDispatchRequest<std::string>(RBX::AsyncHttpCache<RBX::LuaWebService::CachedRawLuaWebServiceInfo,true> *,std::string const&,boost::function<void ()(std::string)>,boost::function<void ()(std::string)>).
}
...
pub fn stub_f2e9b4() {
    // IDA 0xf2e9b4: Thumb import jump veneer for `j___ZN3RBX14AsyncHttpCacheINS_13LuaWebService23CachedLuaWebServiceInfoELb1EE13findCacheItemERKSsPS2_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true>::findCacheItem(std::string const&,RBX::LuaWebService::CachedLuaWebServiceInfo*).
}
...
pub fn stub_f2e9c4() {
    // IDA 0xf2e9c4: Thumb import jump veneer for `j___ZN3RBX14AsyncHttpCacheINS_13LuaWebService23CachedLuaWebServiceInfoELb1EEC2EPNS_8InstanceEN5boost8functionIFbRKSsPSsEEEii` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::AsyncHttpCache<RBX::LuaWebService::CachedLuaWebServiceInfo,true>::AsyncHttpCache(RBX::Instance *,boost::function<bool ()(std::string const&,std::string *)>,int,int).
}
...
pub fn stub_f2e9d4() {
    // IDA 0xf2e9d4: Thumb import jump veneer for `j___ZN3RBX14AsyncHttpCacheINS_13LuaWebService26CachedRawLuaWebServiceInfoELb1EE13findCacheItemERKSsPS2_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::AsyncHttpCache<RBX::LuaWebService::CachedRawLuaWebServiceInfo,true>::findCacheItem(std::string const&,RBX::LuaWebService::CachedRawLuaWebServiceInfo*).
}
...
pub fn stub_f2e9e4() {
    // IDA 0xf2e9e4: Thumb import jump veneer for `j___ZN3RBX14AsyncHttpCacheINS_13LuaWebService26CachedRawLuaWebServiceInfoELb1EEC2EPNS_8InstanceEN5boost8functionIFbRKSsPSsEEEii` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::AsyncHttpCache<RBX::LuaWebService::CachedRawLuaWebServiceInfo,true>::AsyncHttpCache(RBX::Instance *,boost::function<bool ()(std::string const&,std::string *)>,int,int).
}
...
pub fn stub_f2e9f4() {
    // IDA 0xf2e9f4: Thumb import jump veneer for `j___ZN3RBX8LRUCacheISsNS_13LuaWebService23CachedLuaWebServiceInfoEE6insertERKSsRKS2_m` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::LRUCache<std::string,RBX::LuaWebService::CachedLuaWebServiceInfo>::insert(std::string const&,RBX::LuaWebService::CachedLuaWebServiceInfo const&,unsigned long).
}
...
pub fn stub_f2ea04() {
    // IDA 0xf2ea04: Thumb import jump veneer for `j___ZN3RBX8LRUCacheISsNS_13LuaWebService23CachedLuaWebServiceInfoEEC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::LRUCache<std::string,RBX::LuaWebService::CachedLuaWebServiceInfo>::LRUCache(void).
}
...
pub fn stub_f2ea14() {
    // IDA 0xf2ea14: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_f2ea24() {
    // IDA 0xf2ea24: Thumb import jump veneer for `j___ZN3RBX8LRUCacheISsNS_13LuaWebService26CachedRawLuaWebServiceInfoEE23removeLeastRecentlyUsedEv` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::LRUCache<std::string,RBX::LuaWebService::CachedRawLuaWebServiceInfo>::removeLeastRecentlyUsed(void).
}
...
pub fn stub_f2ea34() {
    // IDA 0xf2ea34: Thumb import jump veneer for `j___ZN3RBX8LRUCacheISsNS_13LuaWebService26CachedRawLuaWebServiceInfoEE6insertERKSsRKS2_m` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::LRUCache<std::string,RBX::LuaWebService::CachedRawLuaWebServiceInfo>::insert(std::string const&,RBX::LuaWebService::CachedRawLuaWebServiceInfo const&,unsigned long).
}
...
pub fn stub_f2ea44() {
    // IDA 0xf2ea44: Thumb import jump veneer for `j___ZN3RBX8LRUCacheISsNS_13LuaWebService26CachedRawLuaWebServiceInfoEE6removeERKSs` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::LRUCache<std::string,RBX::LuaWebService::CachedRawLuaWebServiceInfo>::remove(std::string const&).
}
...
pub fn stub_f2ea54() {
    // IDA 0xf2ea54: Thumb import jump veneer for `j___ZN3RBX8LRUCacheISsNS_13LuaWebService26CachedRawLuaWebServiceInfoEEC2Ev` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: RBX::LRUCache<std::string,RBX::LuaWebService::CachedRawLuaWebServiceInfo>::LRUCache(void).
}
...
pub fn stub_f2ea64() {
    // IDA 0xf2ea64: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0xf2ea74 — j___ZN3RBX9weak_fromINS_13LuaWebServiceEEEN5boost8weak_ptrIT_EEPS4_
// type: int __fastcall(_DWORD, _DWORD)
#[doc(alias = "rbx_core::Weak<RBX::LuaWebService> RBX::weak_from<RBX::LuaWebService>(RBX::LuaWebService*)")]
pub fn stub_f2ea74() {
    // IDA 0xf2ea74: Thumb import jump veneer for `j___ZN3RBX9weak_fromINS_13LuaWebServiceEEEN5boost8weak_ptrIT_EEPS4_` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::weak_ptr<RBX::LuaWebService> RBX::weak_from<RBX::LuaWebService>(RBX::LuaWebService*).
}
...
pub fn stub_f2ea84() {
    // IDA 0xf2ea84: Thumb import jump veneer for `j___ZN3rbx8any_castIN5boost10shared_ptrIKSt3mapISsN3RBX10Reflection7VariantESt4lessISsESaISt4pairIKSsS6_EEEEENS4_7Region3EEET_RNS_13placement_anyIT0_EE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> rbx::any_cast<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>,RBX::Region3>(rbx::placement_any<RBX::Region3> &).
}
...
pub fn stub_f2ea94() {
    // IDA 0xf2ea94: Thumb import jump veneer for `j___ZN3rbx8any_castIN5boost10shared_ptrIKSt6vectorIN3RBX10Reflection7VariantESaIS6_EEEENS4_7Region3EEET_RNS_13placement_anyIT0_EE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> rbx::any_cast<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>,RBX::Region3>(rbx::placement_any<RBX::Region3> &).
}

// 0xf2eaa4 — j___ZN5boost10shared_ptrIN3RBX13LuaWebServiceEEC2IS2_EERKNS_8weak_ptrIT_EENS_6detail14sp_nothrow_tagE
// type: int __fastcall(_DWORD, _DWORD)
#[doc(alias = "rbx_core::SharedPtr<RBX::LuaWebService>::shared_ptr<RBX::LuaWebService>(rbx_core::Weak<RBX::LuaWebService> const&,boost::detail::sp_nothrow_tag)")]
pub fn stub_f2eaa4() {
    // IDA 0xf2eaa4: Thumb import jump veneer for `j___ZN5boost10shared_ptrIN3RBX13LuaWebServiceEEC2IS2_EERKNS_8weak_ptrIT_EENS_6detail14sp_nothrow_tagE` (16B, LDR.W PC trampoline); host has no import table - no-op carrier. Aliased: boost::shared_ptr<RBX::LuaWebService>::shared_ptr<RBX::LuaWebService>(boost::weak_ptr<RBX::LuaWebService> const&,boost::detail::sp_nothrow_tag).
}
