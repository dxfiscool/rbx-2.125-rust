//! audio generated_42 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Sound|Audio (2398) exhausted — filler workspace EA-sorted asc after 0x4314b4, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0x4314fc..0x437c38 EA-sorted asc after 0x4314b4, skip existing, rbx_core::SharedPtr not boost
