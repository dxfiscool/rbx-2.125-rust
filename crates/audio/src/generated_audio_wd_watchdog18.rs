...
/// `RBX::Reflection::EnumPropDescriptor<GuiTextButton, XAlignment>`
/// cutover (IDA 0x675630): name/category/attributes/permissions.
/// The member pair folds into the `x_alignment` field.
#[derive(Debug, Clone)]
pub struct GuiButtonXAlignProp {
    pub name: String,
    pub category: String,
    pub attributes: u32,
    pub permissions: u32,
}
impl GuiButtonXAlignProp {
    pub fn new(name: &str, category: &str, attributes: u32, permissions: u32) -> Self {
        Self {
            name: name.to_owned(),
            category: category.to_owned(),
...
/// `RBX::Reflection::EnumPropDescriptor<GuiTextButton, FontSize>`
/// cutover (IDA 0x676cc4): name/category/attributes/permissions.
/// The member pair folds into the `font_size` field.
#[derive(Debug, Clone)]
pub struct GuiButtonFontSizeProp {
    pub name: String,
    pub category: String,
    pub attributes: u32,
    pub permissions: u32,
}
impl GuiButtonFontSizeProp {
    pub fn new(name: &str, category: &str, attributes: u32, permissions: u32) -> Self {
        Self {
            name: name.to_owned(),
            category: category.to_owned(),
...
/// `RBX::Reflection::EnumPropDescriptor<TextLabel, XAlignment>`
/// cutover (IDA 0x67a838): name/category/attributes/permissions.
/// The member pair folds into the `x_alignment` field.
#[derive(Debug, Clone)]
pub struct TextLabelXAlignProp {
    pub name: String,
    pub category: String,
    pub attributes: u32,
    pub permissions: u32,
}
impl TextLabelXAlignProp {
    pub fn new(name: &str, category: &str, attributes: u32, permissions: u32) -> Self {
        Self {
            name: name.to_owned(),
            category: category.to_owned(),
