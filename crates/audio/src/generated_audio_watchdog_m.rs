//! audio generated_audio_watchdog_m — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio exhausted, global gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x54e1dc..0x55410c | existing 31012 -> 31112 distinct
...
// demangled: RBX::Lua::WeakFunctionRef RBX::Reflection::ArgHelper::getArg<RBX::Lua::WeakFunctionRef,3>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::Lua::WeakFunctionRef> const&,boost::disable_if<boost::is_same<RBX::Lua::WeakFunctionRef,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
#[doc(alias = "RBX::Lua::WeakFunctionRef RBX::Reflection::ArgHelper::getArg<RBX::Lua::WeakFunctionRef,3>(RBX::Reflection::FunctionDescriptor::Arguments &,Box<RBX::Lua::WeakFunctionRef> const&,boost::disable_if<boost::is_same<RBX::Lua::WeakFunctionRef,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")]
...
// demangled: RBX::Lua::WeakFunctionRef RBX::Reflection::ArgHelper::getArg<RBX::Lua::WeakFunctionRef,4>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::Lua::WeakFunctionRef> const&,boost::disable_if<boost::is_same<RBX::Lua::WeakFunctionRef,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
#[doc(alias = "RBX::Lua::WeakFunctionRef RBX::Reflection::ArgHelper::getArg<RBX::Lua::WeakFunctionRef,4>(RBX::Reflection::FunctionDescriptor::Arguments &,Box<RBX::Lua::WeakFunctionRef> const&,boost::disable_if<boost::is_same<RBX::Lua::WeakFunctionRef,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")]
...
// demangled: bool RBX::Reflection::ArgHelper::try_enum<2,RBX::GuiService::CenterDialogType>(RBX::Reflection::FunctionDescriptor::Arguments &,RBX::GuiService::CenterDialogType &,boost::enable_if<boost::is_enum<RBX::GuiService::CenterDialogType>,void>::type *)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(std::string,std::string,std::string,int,RBX::Lua::WeakFunctionRef),5>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// demangled: std::string RBX::Reflection::ArgHelper::getArg<std::string,3>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<std::string> const&,boost::disable_if<boost::is_same<std::string,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
#[doc(alias = "std::string RBX::Reflection::ArgHelper::getArg<std::string,3>(RBX::Reflection::FunctionDescriptor::Arguments &,Box<std::string> const&,boost::disable_if<boost::is_same<std::string,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")]
...
// demangled: RBX::Lua::WeakFunctionRef RBX::Reflection::ArgHelper::getArg<RBX::Lua::WeakFunctionRef,5>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::Lua::WeakFunctionRef> const&,boost::disable_if<boost::is_same<RBX::Lua::WeakFunctionRef,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
#[doc(alias = "RBX::Lua::WeakFunctionRef RBX::Reflection::ArgHelper::getArg<RBX::Lua::WeakFunctionRef,5>(RBX::Reflection::FunctionDescriptor::Arguments &,Box<RBX::Lua::WeakFunctionRef> const&,boost::disable_if<boost::is_same<RBX::Lua::WeakFunctionRef,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")]
...
// demangled: RBX::Reflection::EventDescImpl<0,RBX::GuiService,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::GuiService::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
...
// demangled: RBX::Reflection::EventDescImpl<0,RBX::GuiService,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::GuiService::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const
...
// demangled: RBX::Reflection::EventDescBase<RBX::GuiService,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::GuiService::*>::disconnectAll(RBX::Reflection::EventSource *)const
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(RBX::GuiService::SpecialKey),1>::BoundFuncDesc(void (RBX::GuiService::*)(RBX::GuiService::SpecialKey),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(RBX::GuiService::SpecialKey),1>::declareSignature(char const*,RBX::Reflection::Variant)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(RBX::GuiService::SpecialKey),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// demangled: RBX::GuiService::SpecialKey RBX::Reflection::ArgHelper::getArg<RBX::GuiService::SpecialKey,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::GuiService::SpecialKey> const&,boost::disable_if<boost::is_same<RBX::GuiService::SpecialKey,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
#[doc(alias = "RBX::GuiService::SpecialKey RBX::Reflection::ArgHelper::getArg<RBX::GuiService::SpecialKey,1>(RBX::Reflection::FunctionDescriptor::Arguments &,Box<RBX::GuiService::SpecialKey> const&,boost::disable_if<boost::is_same<RBX::GuiService::SpecialKey,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")]
...
// demangled: bool RBX::Reflection::ArgHelper::try_enum<1,RBX::GuiService::SpecialKey>(RBX::Reflection::FunctionDescriptor::Arguments &,RBX::GuiService::SpecialKey &,boost::enable_if<boost::is_enum<RBX::GuiService::SpecialKey>,void>::type *)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(std::string),1>::BoundFuncDesc(void (RBX::GuiService::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)
...
// demangled: RBX::Reflection::BoundFuncDesc<RBX::GuiService,void ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// demangled: RBX::Reflection::Call1Helper<RBX::GuiService,void (RBX::GuiService::*)(std::string),std::string,void>::call(RBX::GuiService*,void (RBX::GuiService::*)(std::string),RBX::Reflection::Variant &,std::string const&)
...
// demangled: RBX::Reflection::EventDescBase<RBX::GuiService,void ()(RBX::GuiService::SpecialKey,std::string),rbx::signal<void ()(RBX::GuiService::SpecialKey,std::string)>,rbx::signal<void ()(RBX::GuiService::SpecialKey,std::string)> RBX::GuiService::*>::disconnectAll(RBX::Reflection::EventSource *)const
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::disconnectAll(void)
...
// demangled: void RBX::Reflection::GenericSlotWrapper::execute2<RBX::GuiService::SpecialKey,std::string>(RBX::GuiService::SpecialKey const&,std::string const&)
...
// demangled: rbx::signals::connection rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::connect<boost::function<void ()(RBX::GuiService::SpecialKey,std::string)>>(boost::function<void ()(RBX::GuiService::SpecialKey,std::string)> const&)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::insert(rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot *)
...
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot>::operator=(rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot*)
...
// demangled: rbx::callable<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot,boost::function<void ()(RBX::GuiService::SpecialKey,std::string)>,2,void ()(RBX::GuiService::SpecialKey,std::string)>::callable<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>*>(boost::function<void ()(RBX::GuiService::SpecialKey,std::string)> const&,rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>*)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot::disconnect(void)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot::connected(void)const
...
// demangled: rbx::callable<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot,boost::function<void ()(RBX::GuiService::SpecialKey,std::string)>,2,void ()(RBX::GuiService::SpecialKey,std::string)>::call(RBX::GuiService::SpecialKey,std::string)
...
// demangled: `non-virtual thunk to'rbx::callable<rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot,boost::function<void ()(RBX::GuiService::SpecialKey,std::string)>,2,void ()(RBX::GuiService::SpecialKey,std::string)>::call(RBX::GuiService::SpecialKey,std::string)
...
// demangled: boost::function2<void,RBX::GuiService::SpecialKey,std::string>::operator()(RBX::GuiService::SpecialKey,std::string)const
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::remove(rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot *)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot::safe_static_init_mutex(void)
...
// demangled: rbx::signals::signal<void ()(RBX::GuiService::SpecialKey,std::string)>::slot::safe_static_do_get_mutex(void)
...
// demangled: RBX::Reflection::EventDescImpl<2,RBX::GuiService,void ()(std::string,std::string),rbx::signal<void ()(std::string,std::string)>,rbx::signal<void ()(std::string,std::string)> RBX::GuiService::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, boost::detail::sp_counted_base *, char, int, int, int, int, int, int, int)
...
// demangled: RBX::Reflection::EventDescImpl<2,RBX::GuiService,void ()(std::string,std::string),rbx::signal<void ()(std::string,std::string)>,rbx::signal<void ()(std::string,std::string)> RBX::GuiService::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const
...
// demangled: RBX::Reflection::EventDescBase<RBX::GuiService,void ()(std::string,std::string),rbx::signal<void ()(std::string,std::string)>,rbx::signal<void ()(std::string,std::string)> RBX::GuiService::*>::disconnectAll(RBX::Reflection::EventSource *)const
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::disconnectAll(void)
...
// demangled: void RBX::Reflection::GenericSlotWrapper::execute2<std::string,std::string>(std::string const&,std::string const&)
...
// demangled: void boost::function2<void,std::string,std::string>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf2<void,RBX::Reflection::GenericSlotWrapper,std::string const&,std::string const&>,boost::_bi::list3<boost::_bi::value<boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>>>>(boost::_bi::bind_t<void,boost::_mfi::mf2<void,RBX::Reflection::GenericSlotWrapper,std::string const&,std::string const&>,boost::_bi::list3<boost::_bi::value<boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>>>)
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
...
// demangled: void boost::_bi::bind_t<void,boost::_mfi::mf2<void,RBX::Reflection::GenericSlotWrapper,std::string const&,std::string const&>,boost::_bi::list3<boost::_bi::value<boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>>>::operator()<std::string,std::string>(std::string &,std::string &)
...
// demangled: rbx::signals::connection rbx::signals::signal<void ()(std::string,std::string)>::connect<boost::function<void ()(std::string,std::string)>>(boost::function<void ()(std::string,std::string)> const&)
// type: int __fastcall(char, boost::mutex *, int, int, int, int)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::insert(rbx::signals::signal<void ()(std::string,std::string)>::slot *)
// type: int __fastcall(int, int, int, int, boost::mutex *, char, int, int, int, int)
...
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(std::string,std::string)>::slot>::operator=(rbx::signals::signal<void ()(std::string,std::string)>::slot*)
...
// demangled: rbx::callable<rbx::signals::signal<void ()(std::string,std::string)>::slot,boost::function<void ()(std::string,std::string)>,2,void ()(std::string,std::string)>::callable<rbx::signals::signal<void ()(std::string,std::string)>*>(boost::function<void ()(std::string,std::string)> const&,rbx::signals::signal<void ()(std::string,std::string)>*)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::slot::disconnect(void)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::slot::connected(void)const
...
// demangled: rbx::callable<rbx::signals::signal<void ()(std::string,std::string)>::slot,boost::function<void ()(std::string,std::string)>,2,void ()(std::string,std::string)>::call(std::string,std::string)
...
// demangled: `non-virtual thunk to'rbx::callable<rbx::signals::signal<void ()(std::string,std::string)>::slot,boost::function<void ()(std::string,std::string)>,2,void ()(std::string,std::string)>::call(std::string,std::string)
...
// demangled: boost::function2<void,std::string,std::string>::operator()(std::string,std::string)const
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::remove(rbx::signals::signal<void ()(std::string,std::string)>::slot *)
// type: int __fastcall(int, char *)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::slot::safe_static_init_mutex(void)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string)>::slot::safe_static_do_get_mutex(void)
