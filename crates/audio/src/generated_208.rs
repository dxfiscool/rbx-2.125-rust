//! audio generated_208 — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4c7610..0x4cad34 | existing 28013 -> 28113 distinct
...
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::convertToString(RBX::PersonalServerService::PrivilegeType const&)const
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::PersonalServerService::PrivilegeType>(RBX::PersonalServerService::PrivilegeType const&)
...
// demangled: rbx::implementation::typed_holder<RBX::PersonalServerService::PrivilegeType>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::PersonalServerService::PrivilegeType>::construct_func(char const*,char *)
...
// demangled: rbx::implementation::typed_holder<RBX::PersonalServerService::PrivilegeType>::destruct_func(char *)
// type: void()
...
pub fn stub_4c7a68() {
    // IDA 0x4c7a68: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4c7a6c — __ZNK3RBX10Reflection8EnumDescINS_21PersonalServerService13PrivilegeTypeEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::convertToItem(RBX::PersonalServerService::PrivilegeType const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::PersonalServerService::PrivilegeType const& rbx::any_cast<RBX::PersonalServerService::PrivilegeType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// demangled: RBX::Reflection::EnumDesc<RBX::PersonalServerService::PrivilegeType>::convertToValue(RBX::Name const&,RBX::PersonalServerService::PrivilegeType&)const
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::PersonalServerService::PrivilegeType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::PersonalServerService::PrivilegeType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::PersonalServerService::PrivilegeType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::PersonalServerService::PrivilegeType>> *)
...
pub fn stub_4c7ca4() {
    // IDA 0x4c7ca4: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4c7ccc — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_13SocialService9StuffTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::SocialService::StuffType> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::SocialService::StuffType> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::convertToString(RBX::SocialService::StuffType const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::SocialService::StuffType>(RBX::SocialService::StuffType const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::SocialService::StuffType>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::SocialService::StuffType>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::SocialService::StuffType>::destruct_func(char *)
// type: void()
...
pub fn stub_4c8490() {
    // IDA 0x4c8490: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4c8494 — __ZNK3RBX10Reflection8EnumDescINS_13SocialService9StuffTypeEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::convertToItem(RBX::SocialService::StuffType const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::SocialService::StuffType const& rbx::any_cast<RBX::SocialService::StuffType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<RBX::SocialService::StuffType>::convertToValue(RBX::Name const&,RBX::SocialService::StuffType&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::SocialService::StuffType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::SocialService::StuffType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::SocialService::StuffType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::SocialService::StuffType>> *)
// type: void __fastcall(int, _DWORD *)
...
pub fn stub_4c86cc() {
    // IDA 0x4c86cc: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4c86f4 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_16KeyframeSequence8PriorityEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::convertToString(RBX::KeyframeSequence::Priority const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::KeyframeSequence::Priority>(RBX::KeyframeSequence::Priority const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::KeyframeSequence::Priority>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::KeyframeSequence::Priority>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::KeyframeSequence::Priority>::destruct_func(char *)
// type: void()
...
pub fn stub_4c8eb8() {
    // IDA 0x4c8eb8: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4c8ebc — __ZNK3RBX10Reflection8EnumDescINS_16KeyframeSequence8PriorityEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::convertToItem(RBX::KeyframeSequence::Priority const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::KeyframeSequence::Priority const& rbx::any_cast<RBX::KeyframeSequence::Priority const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<RBX::KeyframeSequence::Priority>::convertToValue(RBX::Name const&,RBX::KeyframeSequence::Priority&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::KeyframeSequence::Priority>,std::_Select1st<std::pair<RBX::Name const* const,RBX::KeyframeSequence::Priority>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::KeyframeSequence::Priority>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::KeyframeSequence::Priority>> *)
// type: void __fastcall(int, _DWORD *)
...
pub fn stub_4c90f4() {
    // IDA 0x4c90f4: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4c911c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_17BasicPartInstance14LegacyPartTypeEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToString(RBX::BasicPartInstance::LegacyPartType const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::BasicPartInstance::LegacyPartType>(RBX::BasicPartInstance::LegacyPartType const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::BasicPartInstance::LegacyPartType>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::BasicPartInstance::LegacyPartType>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::BasicPartInstance::LegacyPartType>::destruct_func(char *)
// type: void()
...
pub fn stub_4c98e0() {
    // IDA 0x4c98e0: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4c98e4 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToItem(RBX::BasicPartInstance::LegacyPartType const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::BasicPartInstance::LegacyPartType const& rbx::any_cast<RBX::BasicPartInstance::LegacyPartType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToValue(RBX::Name const&,RBX::BasicPartInstance::LegacyPartType&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// demangled: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>> *)
// type: void __fastcall(int, _DWORD *)
...
pub fn stub_4c9b1c() {
    // IDA 0x4c9b1c: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4c9b44 — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_8Humanoid13NameOcclusionEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion> const>::doGetSingleton(void)
// type: void *()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::~EnumDesc()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::convertToString(RBX::Humanoid::NameOcclusion const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Humanoid::NameOcclusion>(RBX::Humanoid::NameOcclusion const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::Humanoid::NameOcclusion>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::Humanoid::NameOcclusion>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::Humanoid::NameOcclusion>::destruct_func(char *)
// type: void()
...
pub fn stub_4ca308() {
    // IDA 0x4ca308: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4ca30c — __ZNK3RBX10Reflection8EnumDescINS_8Humanoid13NameOcclusionEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::convertToItem(RBX::Humanoid::NameOcclusion const&)const
// type: int __fastcall(int, int *)
...
// demangled: RBX::Humanoid::NameOcclusion const& rbx::any_cast<RBX::Humanoid::NameOcclusion const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
// type: char ****__fastcall(char ****)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::NameOcclusion>::convertToValue(RBX::Name const&,RBX::Humanoid::NameOcclusion&)const
// type: int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
pub fn stub_4ca544() {
    // IDA 0x4ca544: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}

// 0x4ca56c — __ZN3RBX10Reflection9SingletonIKNS0_8EnumDescINS_8Humanoid6StatusEEEE13initSingletonEv
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Humanoid::Status> const>::initSingleton(void)
// type: int()
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Humanoid::Status> const>::doGetSingleton(void)
// type: _UNKNOWN **()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::~EnumDesc()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::lookup(char const*)const
// type: int __fastcall(int, const char *const *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::lookup(RBX::Reflection::Variant const&)const
// type: int __fastcall(int, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::convertToString(unsigned long,std::string &)const
// type: int __fastcall(int, unsigned int, std::string *, int)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::convertToString(RBX::Humanoid::Status const&)const
// type: void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Humanoid::Status>(RBX::Humanoid::Status const&)
// type: void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// demangled: rbx::implementation::typed_holder<RBX::Humanoid::Status>::singleton(void)
// type: _DWORD *()
...
// demangled: rbx::implementation::typed_holder<RBX::Humanoid::Status>::construct_func(char const*,char *)
// type: _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// demangled: rbx::implementation::typed_holder<RBX::Humanoid::Status>::destruct_func(char *)
// type: void()
...
pub fn stub_4cad30() {
    // IDA 0x4cad30: 2-byte Thumb `bx lr` (bytes 7047) - void return, no-op carrier on host.
}

// 0x4cad34 — __ZNK3RBX10Reflection8EnumDescINS_8Humanoid6StatusEE13convertToItemERKS3_
// demangled: RBX::Reflection::EnumDesc<RBX::Humanoid::Status>::convertToItem(RBX::Humanoid::Status const&)const
// type: int __fastcall(int, int *)
