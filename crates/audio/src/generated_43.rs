//! audio generated_43 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: FMOD|Sound|Audio exhausted (2541 distinct) — filler workspace EA-sorted asc after 0x437c38, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0x4387e8..0x44158c EA-sorted asc after 0x437c38, skip existing, rbx_core::SharedPtr not boost
