//! audio generated_audio_watchdog_q — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio exhausted, global gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x580740..0x589cb4 | existing 31413 -> 31513 distinct
...
// demangled: RBX::InsertService::setAssetVersionUrl(std::string)
...
// demangled: RBX::InsertService::backendApproveAssetId(int)
...
// demangled: RBX::InsertService::backendApproveAssetVersionId(int)
// type: _DWORD __fastcall(RBX::InsertService *__hidden this, int)
...
// demangled: RBX::InsertService::getFreeModels(std::string,int,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::getFreeDecals(std::string,int,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::getBaseSets(boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::getUserSets(int,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::setAdvancedResults(bool,bool)
...
// demangled: RBX::InsertService::getCollection(int,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::loadAsset(int,boost::function<void ()(boost::shared_ptr<RBX::Instance>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::loadAssetVersion(int,boost::function<void ()(boost::shared_ptr<RBX::Instance>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::insert(boost::shared_ptr<RBX::Instance>)
...
// demangled: RBX::InsertService::InsertService(void)
...
// demangled: RBX::InsertService::dispatchRequest(std::string const&,boost::function<void ()(boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)
...
// demangled: RBX::InsertService::backendInsertRequested(std::string,RBX::ContentId)
...
// demangled: RBX::InsertService::backendInsertAssetRequested(std::string,int,int)
...
// demangled: RBX::InsertService::backendInsertAssetVersionRequested(std::string,int,int)
...
// demangled: RBX::InsertService::insertResultsReady(std::string,boost::shared_ptr<RBX::Instance>)
...
// demangled: RBX::InsertService::insertResultsError(std::string,std::string)
...
// demangled: RBX::InsertService::privateLoadAsset(int,bool,boost::function<void ()(boost::shared_ptr<RBX::Instance>)>,boost::function<void ()(std::string)>)
...
// demangled: RBX::InsertService::backendInsertReady(std::string,boost::shared_ptr<RBX::Instance>)
...
// demangled: RBX::InsertService::BackendInsertReadyHelper(boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>)
#[doc(alias = "RBX::InsertService::BackendInsertReadyHelper(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>)")]
...
// demangled: RBX::InsertService::safeInsert(RBX::ContentId,boost::function<void ()(boost::shared_ptr<RBX::Instance>)>)
...
// demangled: RBX::InsertService::RemoteInsertItemsLoadedHelper(boost::weak_ptr<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>,boost::function<void ()(boost::shared_ptr<RBX::Instance>)>)
...
#[doc(alias = "RBX::InsertService::RemoteInsertItemsLoadedHelper(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")]
...
// demangled: RBX::InsertService::remoteInsertItemsLoaded(RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>,boost::function<void ()(boost::shared_ptr<RBX::Instance>)>)
...
// demangled: RBX::UnsafeScriptStripperCollector(std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> *,RBX::ScriptInformationProvider *,boost::shared_ptr<RBX::Instance>)
...
#[doc(alias = "RBX::unsafeScriptStripper(Weak<RBX::DataModel>,__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Instance> *,std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,float,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,Weak<RBX::ScriptInformationProvider>,rbx_core::SharedPtr<RBX::Instance>)")]
...
// demangled: void RBX::Reflection::resume_adapter<boost::shared_ptr<RBX::Instance>>(boost::function<void ()(RBX::Reflection::Variant)>,boost::shared_ptr<RBX::Instance>)
...
// demangled: void RBX::Reflection::resume_adapter<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>(boost::function<void ()(RBX::Reflection::Variant)>,boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>)
...
// demangled: RBX::CallResultFunction(boost::function<void ()(boost::shared_ptr<RBX::Instance>)>,boost::shared_ptr<RBX::Instance>)
...
// demangled: boost::function<void ()(boost::shared_ptr<RBX::Instance>)>::operator=(boost::function<void ()(boost::shared_ptr<RBX::Instance>)> const&)
...
// demangled: std::map<std::string,RBX::InsertService::Callback,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::InsertService::Callback>>>::operator[](std::string const&)
// type: int(void)
...
// demangled: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::ModelInstance>(boost::shared_ptr<RBX::ModelInstance> const&)
// type: int(void)
...
// demangled: RBX::Reflection::RemoteEventDescImpl<2,RBX::InsertService,void ()(std::string,boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(std::string,boost::shared_ptr<RBX::Instance>)>>::fireAndReplicateEvent(RBX::InsertService*,std::string,boost::shared_ptr<RBX::Instance>)
...
// demangled: boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>),boost::_bi::list_av_3<boost::weak_ptr<RBX::InsertService>,std::string,boost::arg<1>>::type> boost::bind<void,boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>,boost::weak_ptr<RBX::InsertService>,std::string,boost::arg<1>>(void (*)(boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>),boost::weak_ptr<RBX::InsertService>,std::string,boost::arg<1>)
// type: int(void)
#[doc(alias = "boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list_av_3<Weak<RBX::InsertService>,std::string,boost::arg<1>>::type> boost::bind<void,Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>,Weak<RBX::InsertService>,std::string,boost::arg<1>>(void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),Weak<RBX::InsertService>,std::string,boost::arg<1>)")]
...
// demangled: boost::weak_ptr<RBX::InsertService> RBX::weak_from<RBX::InsertService>(RBX::InsertService*)
// type: int(void)
#[doc(alias = "Weak<RBX::InsertService> RBX::weak_from<RBX::InsertService>(RBX::InsertService*)")]
...
// demangled: boost::shared_ptr<RBX::ScriptInformationProvider> RBX::shared_from<RBX::ScriptInformationProvider>(RBX::ScriptInformationProvider*)
// type: int(void)
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list_av_4<Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>::type> boost::bind<void,Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>(void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")]
...
// demangled: RBX::InsertService::~InsertService()
...
#[doc(alias = "void boost::function2<void,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>::assign_to<boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>)")]
...
#[doc(alias = "bool boost::detail::function::basic_vtable2<void,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>::assign_to<boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>,boost::detail::function::function_buffer &)const")]
...
#[doc(alias = "void boost::detail::function::basic_vtable2<void,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>::assign_functor<boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
#[doc(alias = "void boost::_bi::list4<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>::operator()<void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list2<RBX::AsyncHttpQueue::RequestResult&,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>&>>(boost::_bi::type<void>,void (*)(Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>) &,boost::_bi::list2<RBX::AsyncHttpQueue::RequestResult&,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>&> &,int)")]
...
// demangled: boost::_bi::list4<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<RBX::Instance>)>>>::list4(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<RBX::Instance>)>>)
...
// demangled: boost::_bi::storage4<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<RBX::Instance>)>>>::storage4(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<RBX::Instance>)>>)
...
// demangled: boost::_bi::storage3<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>,boost::arg<2>>::storage3(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>,boost::arg<2>)
#[doc(alias = "boost::_bi::storage3<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>>::storage3(boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>)")]
...
// demangled: boost::_bi::storage2<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>>::storage2(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::arg<1>)
#[doc(alias = "boost::_bi::storage2<boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>>::storage2(boost::_bi::value<Weak<RBX::InsertService>>,boost::arg<1>)")]
...
// type: int(void)
#[doc(alias = "void boost::function1<void,rbx_core::SharedPtr<RBX::Instance>>::assign_to<boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>>)")]
...
// type: int(void)
#[doc(alias = "bool boost::detail::function::basic_vtable1<void,rbx_core::SharedPtr<RBX::Instance>>::assign_to<boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>>,boost::detail::function::function_buffer &)const")]
...
// type: int __fastcall(int, int, int, int, void *, int, int, int, int, int)
#[doc(alias = "void boost::detail::function::basic_vtable1<void,rbx_core::SharedPtr<RBX::Instance>>::assign_functor<boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>>>(boost::_bi::bind_t<void,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
// demangled: void boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>::operator()<void (*)(boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>),boost::_bi::list1<boost::shared_ptr<RBX::Instance>&>>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>) &,boost::_bi::list1<boost::shared_ptr<RBX::Instance>&> &,int)
// type: int(void)
#[doc(alias = "void boost::_bi::list3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>::operator()<void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance>&>>(boost::_bi::type<void>,void (*)(Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>) &,boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance>&> &,int)")]
...
// demangled: boost::_bi::list3<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>::list3(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>)
// type: int(void)
...
// demangled: boost::_bi::storage3<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>::storage3(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>)
// type: int __fastcall(int)
#[doc(alias = "boost::_bi::storage3<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>>::storage3(boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>,boost::arg<1>)")]
...
// demangled: boost::_bi::storage2<boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>>::storage2(boost::_bi::value<boost::weak_ptr<RBX::InsertService>>,boost::_bi::value<std::string>)
// type: int __fastcall(int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int)
#[doc(alias = "boost::_bi::storage2<boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>>::storage2(boost::_bi::value<Weak<RBX::InsertService>>,boost::_bi::value<std::string>)")]
...
// demangled: boost::shared_ptr<RBX::InsertService>::shared_ptr<RBX::InsertService>(boost::weak_ptr<RBX::InsertService> const&,boost::detail::sp_nothrow_tag)
// type: int(void)
...
// demangled: RBX::Reflection::RemoteEventDescImpl<2,RBX::InsertService,void ()(std::string,boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(std::string,boost::shared_ptr<RBX::Instance>)>>::replicateEvent(RBX::Reflection::EventSource *,std::string,boost::shared_ptr<RBX::Instance>)
// type: int(void)
...
// demangled: rbx::signals::signal<void ()(std::string,boost::shared_ptr<RBX::Instance>)>::safe_static_do_get_mutex(void)
...
// demangled: rbx::signals::signal_with_args<3,void ()(std::string,int,int)>::operator()(std::string,int,int)
// type: int(void)
...
pub fn stub_589a2c() -> ! {
    todo!("0x589a2c __ZN3rbx7signals16signal_with_argsILi3EFvSsiiEEclESsii")
}

// 0x589cb4 — __ZN3rbx7signals6signalIFvSsiiEE4nextERN5boost13intrusive_ptrINS3_4slotEEE
// demangled: rbx::signals::signal<void ()(std::string,int,int)>::next(boost::intrusive_ptr<rbx::signals::signal<void ()(std::string,int,int)>::slot> &)
