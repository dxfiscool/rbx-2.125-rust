//! audio generated_201 — 100 stubs EA-sorted asc gap filler not yet in audio (FMOD|Sound|Audio 2541/2541 complete, gap filler)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in audio | rbx_core::SharedPtr not boost
//! Range 0x4aad24..0x4ad850 | existing 27213 -> 27313 distinct
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::TextService::YAlignment>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::TextService::FontSize>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::TextService::Font>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Camera::CameraType>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Camera::CameraMode>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Camera::CameraPanMode>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::LegacyController::InputType>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::DataModelArbiter::ConcurrencyModel>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::DebugSettings::ErrorReporting>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::EThrottle::EThrottleType>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::NormalId>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<G3D::Vector3::Axis>(void)
// type: int(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Humanoid::Status>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::DataModel::CreatorType>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::DataModel::Genre>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::DataModel::GearGenreSetting>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::DataModel::GearType>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Instance::SaveFilter>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::FriendService::FriendStatus>(void)
// type: int(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::FriendService::FriendEventType>(void)
// type: int(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::SkateboardPlatform::MoveState>(void)
// type: int(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::SurfaceType>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::PartInstance::FormFactor>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::UserInputService::SwipeDirection>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Material>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Time::SampleMethod>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::GuiService::SpecialKey>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::GuiService::CenterDialogType>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::ChatService::ChatColor>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::MarketplaceService::CurrencyType>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Voxel::CellMaterial>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Voxel::CellBlock>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Voxel::CellOrientation>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Voxel::WaterCellForce>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Voxel::WaterCellDirection>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::AssetService::AccessType>(void)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::HttpService::HttpContentType>(void)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::StarterGuiService::CoreGuiType>(void)
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_17BasicPartInstanceENS_14FormFactorPartELZNS_10sBasicPartEENS_8InstanceEE7CreatorD1Ev")]
pub fn stub_4ab5f4() {
    // IDA 0x4ab5f4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_8SparklesENS_8InstanceELZNS_9sSparklesEES2_E7CreatorD1Ev")]
pub fn stub_4ab5f8() {
    // IDA 0x4ab5f8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_9AnimationENS_8InstanceELZNS_10sAnimationEES2_E7CreatorD1Ev")]
pub fn stub_4ab5fc() {
    // IDA 0x4ab5fc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_16BindableFunctionENS_8InstanceELZNS_17sBindableFunctionEES2_E7CreatorD1Ev")]
pub fn stub_4ab600() {
    // IDA 0x4ab600: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_13BindableEventENS_8InstanceELZNS_14sBindableEventEES2_E7CreatorD1Ev")]
pub fn stub_4ab604() {
    // IDA 0x4ab604: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_13BindableEventENS_8InstanceELZNS_14sBindableEventEES2_E7CreatorD2Ev")]
pub fn stub_4ab608() {
    // IDA 0x4ab608: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: rbx_core::SharedPtr<RBX::BindableEvent> RBX::Creatable<RBX::Instance>::create<RBX::BindableEvent>(void)
#[doc(alias = "rbx_core::SharedPtr<RBX::BindableEvent> RBX::Creatable<RBX::Instance>::create<RBX::BindableEvent>(void)")]
#[doc(alias = "__ZN3RBX9CreatableINS_8InstanceEE6createINS_13BindableEventEEEN5boost10shared_ptrIT_EEv")]
pub fn stub_4ab854() -> ! {
    todo!("0x4ab854 rbx_core::SharedPtr<RBX::BindableEvent> RBX::Creatable<RBX::Instance>::create<RBX::BindableEvent>(void)")
}

// 0x4ab904 — __ZN3RBX13BindableEventC2Ev
// demangled: RBX::BindableEvent::BindableEvent(void)
// type: _DWORD __fastcall(RBX::BindableEvent *__hidden this)
#[doc(alias = "RBX::BindableEvent::BindableEvent(void)")]
#[doc(alias = "__ZN3RBX13BindableEventC2Ev")]
pub fn stub_4ab904() -> ! {
    todo!("0x4ab904 RBX::BindableEvent::BindableEvent(void)")
}
...
#[doc(alias = "__ZThn32_NK3RBX14FactoryProductINS_13BindableEventENS_8InstanceELZNS_14sBindableEventEES2_E12getClassNameEv")]
pub fn stub_4abaa4() {
    // IDA 0x4abaa4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>::safe_static_init_mutex(void)
...
// demangled: rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>::safe_static_do_get_mutex(void)
...
#[doc(alias = "__ZN3RBX10Reflection9DescribedINS_13BindableEventELZNS_14sBindableEventEENS_14FactoryProductIS2_NS_8InstanceELZNS_14sBindableEventEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev")]
pub fn stub_4abd44() {
    // IDA 0x4abd44: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX10Reflection9DescribedINS_13BindableEventELZNS_14sBindableEventEENS_14FactoryProductIS2_NS_8InstanceELZNS_14sBindableEventEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev")]
pub fn stub_4abd48() {
    // IDA 0x4abd48: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn32_N3RBX10Reflection9DescribedINS_13BindableEventELZNS_14sBindableEventEENS_14FactoryProductIS2_NS_8InstanceELZNS_14sBindableEventEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev")]
pub fn stub_4abde8() {
    // IDA 0x4abde8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn32_N3RBX10Reflection9DescribedINS_13BindableEventELZNS_14sBindableEventEENS_14FactoryProductIS2_NS_8InstanceELZNS_14sBindableEventEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev")]
pub fn stub_4abdf0() {
    // IDA 0x4abdf0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn36_N3RBX10Reflection9DescribedINS_13BindableEventELZNS_14sBindableEventEENS_14FactoryProductIS2_NS_8InstanceELZNS_14sBindableEventEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev")]
pub fn stub_4abe94() {
    // IDA 0x4abe94: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn36_N3RBX10Reflection9DescribedINS_13BindableEventELZNS_14sBindableEventEENS_14FactoryProductIS2_NS_8InstanceELZNS_14sBindableEventEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev")]
pub fn stub_4abe9c() {
    // IDA 0x4abe9c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4abf40 — __ZN5boost10shared_ptrIN3RBX13BindableEventEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_
// demangled: rbx_core::SharedPtr<RBX::BindableEvent>::shared_ptr<RBX::BindableEvent,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4abf40() -> ! {
    todo!("0x4abf40 rbx_core::SharedPtr<RBX::BindableEvent>::shared_ptr<RBX::BindableEvent,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::BindableEvent,RBX::BindableEvent>(rbx_core::SharedPtr<RBX::BindableEvent> const*,RBX::BindableEvent *)const
...
// demangled: boost::detail::shared_count::shared_count<RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4ac0f0() {
    // IDA 0x4ac0f0: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}

// 0x4ac1f8 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX13BindableEventENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// demangled: boost::detail::sp_counted_impl_pd<RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
...
pub fn stub_4ac1f8() {
    // IDA 0x4ac1f8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_4ac1fc() {
    // IDA 0x4ac1fc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4ac200 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX13BindableEventENS2_9CreatableINS2_8InstanceEE7DeleterEE7disposeEv
// demangled: boost::detail::sp_counted_impl_pd<RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
pub fn stub_4ac200() {
    // IDA 0x4ac200: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
...
pub fn stub_4ac220() {
    // IDA 0x4ac220: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::BindableEvent *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
...
pub fn stub_4ac238() {
    // IDA 0x4ac238: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX14FactoryProductINS_16BindableFunctionENS_8InstanceELZNS_17sBindableFunctionEES2_E7CreatorD2Ev")]
pub fn stub_4ac590() {
    // IDA 0x4ac590: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: rbx_core::SharedPtr<RBX::BindableFunction> RBX::Creatable<RBX::Instance>::create<RBX::BindableFunction>(void)
...
pub fn stub_4ac7dc() -> ! {
    todo!("0x4ac7dc rbx_core::SharedPtr<RBX::BindableFunction> RBX::Creatable<RBX::Instance>::create<RBX::BindableFunction>(void)")
}

// 0x4ac88c — __ZN3RBX16BindableFunctionC2Ev
// demangled: RBX::BindableFunction::BindableFunction(void)
...
pub fn stub_4ac88c() -> ! {
    todo!("0x4ac88c RBX::BindableFunction::BindableFunction(void)")
}
...
#[doc(alias = "__ZThn32_NK3RBX14FactoryProductINS_16BindableFunctionENS_8InstanceELZNS_17sBindableFunctionEES2_E12getClassNameEv")]
pub fn stub_4aca48() {
    // IDA 0x4aca48: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// demangled: std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::~deque()
// type: int __fastcall(int *, int, int, int)
...
// demangled: std::_Deque_base<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::~_Deque_base()
...
// demangled: std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_destroy_data_aux(std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>)
...
pub fn stub_4acbe0() -> ! {
    todo!("0x4acbe0 std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_destroy_data_aux(std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>)")
}

// 0x4ace68 — __ZNSt11_Deque_baseIN3RBX16BindableFunction10InvocationESaIS2_EE17_M_initialize_mapEm
// demangled: std::_Deque_base<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_initialize_map(unsigned long)
...
pub fn stub_4ace68() -> ! {
    todo!("0x4ace68 std::_Deque_base<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_initialize_map(unsigned long)")
}

// 0x4acfe4 — __ZNSt11_Deque_baseIN3RBX16BindableFunction10InvocationESaIS2_EE15_M_allocate_mapEm
// demangled: std::_Deque_base<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_allocate_map(unsigned long)
...
pub fn stub_4acfe4() -> ! {
    todo!("0x4acfe4 std::_Deque_base<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_allocate_map(unsigned long)")
}

// 0x4acffc — __ZNSt11_Deque_baseIN3RBX16BindableFunction10InvocationESaIS2_EE15_M_create_nodesEPPS2_S6_
// demangled: std::_Deque_base<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::_M_create_nodes(RBX::BindableFunction::Invocation**,RBX::BindableFunction::Invocation**)
// type: int __fastcall(int, int, int, int, void *, int)
...
pub fn stub_4acffc() {
    // IDA 0x4acffc: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}

// 0x4ad0f0 — __ZNSt5dequeIN3RBX16BindableFunction10InvocationESaIS2_EEC2ERKS4_
// demangled: std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::deque(std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>> const&)
...
pub fn stub_4ad0f0() -> ! {
    todo!("0x4ad0f0 std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>>::deque(std::deque<RBX::BindableFunction::Invocation,std::allocator<RBX::BindableFunction::Invocation>> const&)")
}
...
// demangled: std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*> std::__uninitialized_copy_aux<std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation const&,RBX::BindableFunction::Invocation const*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>>(std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation const&,RBX::BindableFunction::Invocation const*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation const&,RBX::BindableFunction::Invocation const*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>,std::__false_type)
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int, int, int, int, int)
...
pub fn stub_4ad224() -> ! {
    todo!("0x4ad224 std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*> std::__uninitialized_copy_aux<std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation const&,RBX::BindableFunction::Invocation const*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>>(std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation const&,RBX::BindableFunction::Invocation const*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation const&,RBX::BindableFunction::Invocation const*>,std::_Deque_iterator<RBX::BindableFunction::Invocation,RBX::BindableFunction::Invocation&,RBX::BindableFunction::Invocation*>,std::__false_type)")
}
...
#[doc(alias = "__ZN3RBX10Reflection9DescribedINS_16BindableFunctionELZNS_17sBindableFunctionEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sBindableFunctionEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev")]
pub fn stub_4ad58c() {
    // IDA 0x4ad58c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZN3RBX10Reflection9DescribedINS_16BindableFunctionELZNS_17sBindableFunctionEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sBindableFunctionEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev")]
pub fn stub_4ad590() {
    // IDA 0x4ad590: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn32_N3RBX10Reflection9DescribedINS_16BindableFunctionELZNS_17sBindableFunctionEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sBindableFunctionEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev")]
pub fn stub_4ad630() {
    // IDA 0x4ad630: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn32_N3RBX10Reflection9DescribedINS_16BindableFunctionELZNS_17sBindableFunctionEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sBindableFunctionEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev")]
pub fn stub_4ad638() {
    // IDA 0x4ad638: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn36_N3RBX10Reflection9DescribedINS_16BindableFunctionELZNS_17sBindableFunctionEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sBindableFunctionEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev")]
pub fn stub_4ad6dc() {
    // IDA 0x4ad6dc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
#[doc(alias = "__ZThn36_N3RBX10Reflection9DescribedINS_16BindableFunctionELZNS_17sBindableFunctionEENS_14FactoryProductIS2_NS_8InstanceELZNS_17sBindableFunctionEES4_EELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev")]
pub fn stub_4ad6e4() {
    // IDA 0x4ad6e4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x4ad788 — __ZN5boost10shared_ptrIN3RBX16BindableFunctionEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_
// demangled: rbx_core::SharedPtr<RBX::BindableFunction>::shared_ptr<RBX::BindableFunction,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BindableFunction *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4ad788() -> ! {
    todo!("0x4ad788 rbx_core::SharedPtr<RBX::BindableFunction>::shared_ptr<RBX::BindableFunction,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BindableFunction *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::BindableFunction,RBX::BindableFunction>(rbx_core::SharedPtr<RBX::BindableFunction> const*,RBX::BindableFunction *)const
...
pub fn stub_4ad850() {
    // IDA 0x4ad850: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
