//! audio generated_156 — next 100 stubs EA-sorted, from ida/export.json
//! Filter: Sound|Audio|FMOD (2541 distinct) exhausted — filler EA-sorted asc, skip existing, rbx_core::SharedPtr not boost
//! Batch: 100 stubs | skeleton batch | range 0x55370..0x59a6c EA-sorted asc filler gap, rbx_core::SharedPtr not boost
