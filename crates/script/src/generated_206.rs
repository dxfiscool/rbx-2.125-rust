...
pub fn stub_0x2eafd4() -> ! {
    todo!("0x2eafd4 RBX::MegaDragger::MegaDragger(RBX::PartInstance *,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>> const&,RBX::RootInstance *,RBX::DRAG::JoinType)")
}
