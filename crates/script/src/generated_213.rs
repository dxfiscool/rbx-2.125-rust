...
pub fn stub_0x3821f0() -> ! {
    todo!("0x3821f0 rbx_core::SharedPtr<RBX::StandardOut>::~shared_ptr()")
}
...
pub fn stub_0x3824d0() -> ! {
    todo!("0x3824d0 rbx_core::SharedPtr<RBX::StandardOut>::shared_ptr<RBX::StandardOut>(RBX::StandardOut *)")
}
...
pub fn stub_0x3825b8() -> ! {
    todo!("0x3825b8 void boost::enable_shared_from_this<RBX::StandardOut>::_internal_accept_owner<RBX::StandardOut,RBX::StandardOut>(rbx_core::SharedPtr<RBX::StandardOut> const*,RBX::StandardOut *)const")
}
...
pub fn stub_0x382a88() -> ! {
    todo!("0x382a88 boost::detail::sp_counted_impl_p<RBX::StandardOut>::~sp_counted_impl_p()_2")
}
...
pub fn stub_0x385280() -> ! {
    todo!("0x385280 rbx::signals::signal<void ()(RBX::Stepped const&)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::IStepped,RBX::Stepped const&>,boost::_bi::list2<boost::_bi::value<RBX::IStepped*>,boost::arg<1>>>>::~callable_slot()_2")
}
...
pub fn stub_0x3856a8() -> ! {
    todo!("0x3856a8 rbx::signals::signal<void ()(RBX::Stepped const&)>::slot::~slot()_2")
}
...
pub fn stub_0x3857a8() -> ! {
    todo!("0x3857a8 rbx::callable<rbx::signals::signal<void ()(RBX::Stepped const&)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::IStepped,RBX::Stepped const&>,boost::_bi::list2<boost::_bi::value<RBX::IStepped*>,boost::arg<1>>>,1,void ()(RBX::Stepped const&)>::~callable()_2")
}
...
pub fn stub_0x386088() -> ! {
    todo!("0x386088 RBX::BaseThreadPool::~BaseThreadPool()_2")
}
...
pub fn stub_0x38608c() -> ! {
    todo!("0x38608c RBX::BaseThreadPool::~BaseThreadPool()_3")
}
...
pub fn stub_0x3865f8() -> ! {
    todo!("0x3865f8 RBX::ThreadPool::ThreadPool(int,RBX::BaseThreadPool::ShutdownPolicy)_2")
}
...
pub fn stub_0x386790() -> ! {
    todo!("0x386790 RBX::PriorityThreadPool::PriorityThreadPool(int,RBX::BaseThreadPool::ShutdownPolicy)_2")
}
...
pub fn stub_0x387448() -> ! {
    todo!("0x387448 RBX::PriorityThreadPool::PriorityThreadPoolData::~PriorityThreadPoolData()_2")
}
...
pub fn stub_0x387550() -> ! {
    todo!("0x387550 RBX::ThreadPool::~ThreadPool()_2")
}
...
pub fn stub_0x3875f4() -> ! {
    todo!("0x3875f4 RBX::PriorityThreadPool::~PriorityThreadPool()_2")
}
...
pub fn stub_0x3886f0() -> ! {
    todo!("0x3886f0 boost::detail::sp_counted_impl_p<boost::thread>::~sp_counted_impl_p()_2")
}
...
pub fn stub_0x388cec() -> ! {
    todo!("0x388cec boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>,rbx_core::SharedPtr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>>>::~thread_data()_2")
}
...
pub fn stub_0x389664() -> ! {
    todo!("0x389664 boost::detail::sp_counted_impl_p<RBX::mutex>::~sp_counted_impl_p()_2")
}
