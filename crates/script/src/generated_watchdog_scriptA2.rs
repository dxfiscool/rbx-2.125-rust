//! script generated_watchdog_scriptA2 — 100 stubs EA-sorted asc global dedup (Script/Lua filter exhausted, gap filler)
//! Filter: Lua|Script|lua_|ScriptContext|ScriptAnalyzer -> 4978 total, 0 remaining before batch (all already in script crate or global) — gap filler from remaining EAs
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: +100 stubs | range 0x75a1d4..0x75fc48 | EA-sorted asc distinct not yet in global_eas.txt (global dedup)
...
pub fn stub_0x75a1d4(handle: &crate::slot::InstanceHandle) {
// RBX::Body::resetImpulseAccumulators() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75a208(handle: &crate::slot::InstanceHandle) {
// RBX::Body::resetForceAccumulators() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75a240(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::SleepStage getter.
cell.get()
}
...
pub fn stub_0x75a540(vec: &mut crate::slot::VecModel, index: usize) -> bool {
...
pub fn stub_0x75a6a8() -> crate::slot::VecModel {
...
pub fn stub_0x75a6c0(vec: &mut crate::slot::VecModel) -> usize {
...
pub fn stub_0x75a7a0(vec: &mut crate::slot::VecModel, index: usize) -> bool {
// std sequence _M_erase/assign — removes at index.
vec.fast_remove(index)
}
...
pub fn stub_0x75a908(vec: &mut crate::slot::VecModel, index: usize) -> bool {
// std sequence _M_erase/assign — removes at index.
vec.fast_remove(index)
}
...
pub fn stub_0x75aa70() -> crate::slot::VecModel {
// std::_Vector_base ctor — empty storage.
crate::slot::VecModel::new()
}
...
pub fn stub_0x75aa88(vec: &mut crate::slot::VecModel) -> usize {
// std sequence _M_insert — grows and returns the index.
vec.append()
}
...
pub fn stub_0x75ab68(vec: &mut crate::slot::VecModel) -> usize {
...
pub fn stub_0x75aba0(map: &mut crate::slot::TreeMapModel) {
...
pub fn stub_0x75abbc() -> crate::slot::PortedFn {
// IDA 0x75abbc: std::deque<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_reallocate_map(unsigned long, bool).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75abbc, "std::deque<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_reallocate_map(unsigned long, bool)")
}
...
pub fn stub_0x75ac94() -> crate::slot::PortedFn {
// IDA 0x75ac94: std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_allocate_map(unsigned long).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75ac94, "std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_allocate_map(unsigned long)")
}
...
pub fn stub_0x75acac() -> crate::slot::PortedFn {
// IDA 0x75acac: std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::~_Deque_base().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75acac, "std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::~_Deque_base()")
}
...
pub fn stub_0x75acd8() -> crate::slot::PortedFn {
// IDA 0x75acd8: std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_initialize_map(unsigned long).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75acd8, "std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_initialize_map(unsigned long)")
}
...
pub fn stub_0x75ae30() -> crate::slot::PortedFn {
// IDA 0x75ae30: std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_create_nodes(RBX::Assembly***, RBX::Assembly***).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75ae30, "std::_Deque_base<RBX::Assembly*, std::allocator<RBX::Assembly*>>::_M_create_nodes(RBX::Assembly***, ~")
}
...
pub fn stub_0x75b24c(handle: &crate::slot::InstanceHandle) {
// RBX::SnapJoint::compatibleSurfaces(RBX::Primitive*, RBX::Primitive*, RBX::NormalId, RBX::N~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75b2a0(handle: &crate::slot::InstanceHandle) {
// RBX::SnapJoint::canBuildJoint(RBX::Primitive*, RBX::Primitive*, RBX::NormalId, RBX::Normal~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75b4a8(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::SpatialFilter(RBX::IStage*, RBX::World*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75b4ac(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::SpatialFilter(RBX::IStage*, RBX::World*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75b664(handle: crate::slot::InstanceHandle) {
// RBX::SpatialFilter dtor.
drop(handle);
}
...
pub fn stub_0x75b704(handle: crate::slot::InstanceHandle) {
// RBX::SpatialFilter dtor.
drop(handle);
}
...
pub fn stub_0x75b708(handle: crate::slot::InstanceHandle) {
// RBX::SpatialFilter dtor.
drop(handle);
}
...
pub fn stub_0x75b8ec(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::changePhase(RBX::SpatialFilter::MoveInstructions&) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75ba70(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::moveInto(RBX::SpatialFilter::MoveInstructions&) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75bd10(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::addressMatch(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75bd34(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::SpatialFilter getter.
cell.get()
}
...
pub fn stub_0x75bdc0(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::inClientSimRegion(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75be24(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::filterAssembly(RBX::Assembly*, bool) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75bf20(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::filterAssemblies() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c1d0(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::moveAll(RBX::Assembly::FilterPhase) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c3b8(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::filterStep() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c3d8(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::onMovingAssemblyRootAdded(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c4a8(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::onFixedAssemblyRootAdded(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c570(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialFilter::onAssemblyRootRemoving(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c5f4(handle: &crate::slot::InstanceHandle) {
// RBX::IPipelined::downstreamOfStage(RBX::IStage*) const — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75c804(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::SpatialFilter getter.
cell.get()
}
...
pub fn stub_0x75c808(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::IStage getter.
cell.get()
}
...
pub fn stub_0x75c868(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::IWorldStage getter.
cell.get()
}
...
pub fn stub_0x75cb98(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
...
pub fn stub_0x75cc00(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x75cc58(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
...
pub fn stub_0x75cc80() -> crate::slot::PortedFn {
// IDA 0x75cc80: std::_Rb_tree<RBX::Assembly*, RBX::Assembly*, std::_Identity<RBX::Assembly*>, std::less<RBX::Assembly*>, std::allocator<~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75cc80, "std::_Rb_tree<RBX::Assembly*, RBX::Assembly*, std::_Identity<RBX::Assembly*>, std::less<RBX::Assembl~")
}
...
pub fn stub_0x75cccc(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0x75cd2c(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0x75cf18(handle: crate::slot::InstanceHandle) {
// RBX::IStage dtor.
drop(handle);
}
...
pub fn stub_0x75cf3c(handle: crate::slot::InstanceHandle) {
// RBX::IStage dtor.
drop(handle);
}
...
pub fn stub_0x75d45c(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::SpatialHashStatic getter.
cell.get()
}
...
pub fn stub_0x75d534(handle: &crate::slot::InstanceHandle) {
// RBX::SpatialHashStatic::computeMinMax(int, RBX::Extents const&, RBX::Vector3int32&, RBX::V~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75d8ec(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::StepJointsStage(RBX::IStage*, RBX::World*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75d8f0(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::StepJointsStage(RBX::IStage*, RBX::World*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75da80(handle: crate::slot::InstanceHandle) {
// RBX::StepJointsStage dtor.
drop(handle);
}
...
pub fn stub_0x75db20(handle: crate::slot::InstanceHandle) {
// RBX::StepJointsStage dtor.
drop(handle);
}
...
pub fn stub_0x75db24(handle: crate::slot::InstanceHandle) {
// RBX::StepJointsStage dtor.
drop(handle);
}
...
pub fn stub_0x75dd0c(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::removeJoint(RBX::Joint*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75dd9c(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::onSimulateAssemblyAdded(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75ddb8(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::onSimulateAssemblyRemoving(RBX::Assembly*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75ddd4(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::onEdgeAdded(RBX::Edge*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75de3c(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::onEdgeRemoving(RBX::Edge*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75de84(handle: &crate::slot::InstanceHandle) {
// RBX::StepJointsStage::jointsStepWorld() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75dfd4(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::StepJointsStage getter.
cell.get()
}
...
pub fn stub_0x75e0a0(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::TreeStage(RBX::IStage*, RBX::World*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75e0a4(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::TreeStage(RBX::IStage*, RBX::World*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75e21c(handle: crate::slot::InstanceHandle) {
// RBX::TreeStage dtor.
drop(handle);
}
...
pub fn stub_0x75e2bc(handle: crate::slot::InstanceHandle) {
// RBX::TreeStage dtor.
drop(handle);
}
...
pub fn stub_0x75e2c0(handle: crate::slot::InstanceHandle) {
// RBX::TreeStage dtor.
drop(handle);
}
...
pub fn stub_0x75e4bc(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::validateTree(RBX::SpanningNode*) — engine-side; linkage preserved via the alias.
let _ = handle;
}

// 0x75e4c8 — __ZThn16_N3RBX9TreeStage12validateTreeEPNS_12SpanningNodeE
// type: _DWORD __fastcall(RBX::TreeStage *__hidden this, RBX::SpanningNode *)
#[doc(alias = "non-virtual thunk to RBX::TreeStage::validateTree(RBX::SpanningNode *)")]
#[doc(alias = "__ZThn16_N3RBX9TreeStage12validateTreeEPNS_12SpanningNodeE")]
pub fn stub_0x75e4c8(handle: &mut crate::slot::ThunkHandle) {
...
pub fn stub_0x75e4d4() -> crate::slot::PortedFn {
// IDA 0x75e4d4: RBX::chainToGround(RBX::Primitive*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75e4d4, "RBX::chainToGround(RBX::Primitive*)")
}
...
pub fn stub_0x75e52c(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onSpanningEdgeAdding(RBX::SpanningEdge*, RBX::SpanningNode*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75e69c(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::dirtyMechanism(RBX::Mechanism*) — engine-side; linkage preserved via the alias.
let _ = handle;
}

// 0x75e710 — __ZThn16_N3RBX9TreeStage20onSpanningEdgeAddingEPNS_12SpanningEdgeEPNS_12SpanningNodeE
// type: _DWORD __fastcall(RBX::TreeStage *__hidden this, RBX::SpanningEdge *, RBX::SpanningNode *)
#[doc(alias = "non-virtual thunk to RBX::TreeStage::onSpanningEdgeAdding(RBX::SpanningEdge *,RBX::SpanningNode *)")]
#[doc(alias = "__ZThn16_N3RBX9TreeStage20onSpanningEdgeAddingEPNS_12SpanningEdgeEPNS_12SpanningNodeE")]
pub fn stub_0x75e710(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run primary.
let _ = handle.delta;
}
...
pub fn stub_0x75e718(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onSpanningEdgeAdded(RBX::SpanningEdge*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75edb8(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::sendClumpChangedMessage(RBX::Primitive*) — engine-side; linkage preserved via the alias.
let _ = handle;
}

// 0x75ee8c — __ZThn16_N3RBX9TreeStage19onSpanningEdgeAddedEPNS_12SpanningEdgeE
// type: _DWORD __fastcall(RBX::TreeStage *__hidden this, RBX::SpanningEdge *)
#[doc(alias = "non-virtual thunk to RBX::TreeStage::onSpanningEdgeAdded(RBX::SpanningEdge *)")]
#[doc(alias = "__ZThn16_N3RBX9TreeStage19onSpanningEdgeAddedEPNS_12SpanningEdgeE")]
pub fn stub_0x75ee8c(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run primary.
let _ = handle.delta;
}
...
pub fn stub_0x75ee94() -> crate::slot::PortedFn {
// IDA 0x75ee94: RBX::assertNotInPipeline(RBX::Assembly*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75ee94, "RBX::assertNotInPipeline(RBX::Assembly*)")
}
...
pub fn stub_0x75eef8(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onSpanningEdgeRemoving(RBX::SpanningEdge*) — engine-side; linkage preserved via the alias.
let _ = handle;
}

// 0x75ef20 — __ZThn16_N3RBX9TreeStage22onSpanningEdgeRemovingEPNS_12SpanningEdgeE
// type: _DWORD __fastcall(RBX::TreeStage *__hidden this, RBX::SpanningEdge *)
#[doc(alias = "non-virtual thunk to RBX::TreeStage::onSpanningEdgeRemoving(RBX::SpanningEdge *)")]
#[doc(alias = "__ZThn16_N3RBX9TreeStage22onSpanningEdgeRemovingEPNS_12SpanningEdgeE")]
pub fn stub_0x75ef20(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run primary.
let _ = handle.delta;
}
...
pub fn stub_0x75ef28(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onSpanningEdgeRemoved(RBX::SpanningEdge*, RBX::SpanningNode*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f22c(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::destroyClump(RBX::Primitive*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f258(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::destroyAssembly(RBX::Primitive*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f29c(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::destroyMechanism(RBX::Primitive*) — engine-side; linkage preserved via the alias.
let _ = handle;
}

// 0x75f320 — __ZThn16_N3RBX9TreeStage21onSpanningEdgeRemovedEPNS_12SpanningEdgeEPNS_12SpanningNodeE
// type: _DWORD __fastcall(RBX::TreeStage *__hidden this, RBX::SpanningEdge *, RBX::SpanningNode *)
#[doc(alias = "non-virtual thunk to RBX::TreeStage::onSpanningEdgeRemoved(RBX::SpanningEdge *,RBX::SpanningNode *)")]
#[doc(alias = "__ZThn16_N3RBX9TreeStage21onSpanningEdgeRemovedEPNS_12SpanningEdgeEPNS_12SpanningNodeE")]
pub fn stub_0x75f320(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run primary.
let _ = handle.delta;
}
...
pub fn stub_0x75f328(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::removeFromPipeline(RBX::Mechanism*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f3e8(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::cleanMechanism(RBX::Mechanism*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f500(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::assemble() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f540(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onEdgeAdded(RBX::Edge*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f660(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onEdgeRemoving(RBX::Edge*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f798(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onPrimitiveAdded(RBX::Primitive*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f804(handle: &crate::slot::InstanceHandle) {
// RBX::TreeStage::onPrimitiveRemoving(RBX::Primitive*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x75f874(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::TreeStage getter.
cell.get()
}
...
pub fn stub_0x75f880(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::TreeStage getter.
cell.get()
}
...
pub fn stub_0x75f884(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0x75f8ac(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x75f914(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x75f96c(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0x75f994() -> crate::slot::PortedFn {
// IDA 0x75f994: std::_Rb_tree<RBX::Mechanism*, RBX::Mechanism*, std::_Identity<RBX::Mechanism*>, std::less<RBX::Mechanism*>, std::alloca~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x75f994, "std::_Rb_tree<RBX::Mechanism*, RBX::Mechanism*, std::_Identity<RBX::Mechanism*>, std::less<RBX::Mech~")
}
...
pub fn stub_0x75f9e0(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0x75fc48(handle: &crate::slot::InstanceHandle) {
// RBX::WedgePoly::buildMesh() — engine-side; linkage preserved via the alias.
let _ = handle;
}
