...
pub fn stub_0xd8a17c() -> ! {
    todo!("0xd8a17c std::_List_base<std::pair<Ogre::ScriptLoader *,Ogre::SharedPtr<std::list<Ogre::SharedPtr<std::vector<Ogre::FileInfo,Ogre::STLAllocator<Ogre::FileInfo,Ogre::CategorisedAllocPolicy<(")
}
...
pub fn stub_0xd8a180() -> ! {
    todo!("0xd8a180 std::_List_base<std::pair<Ogre::ScriptLoader *,Ogre::SharedPtr<std::list<Ogre::SharedPtr<std::vector<Ogre::FileInfo,Ogre::STLAllocator<Ogre::FileInfo,Ogre::CategorisedAllocPolicy<(")
}
...
pub fn stub_0xd8a9bc() -> ! {
    todo!("0xd8a9bc std::_Rb_tree<float,std::pair<float const,Ogre::ScriptLoader *>,std::_Select1st<std::pair<float const,Ogre::ScriptLoader *>>,std::less<float>,Ogre::STLAllocator<std::pair<float con")
}
...
pub fn stub_0xd8a9c0() -> ! {
    todo!("0xd8a9c0 std::_Rb_tree<float,std::pair<float const,Ogre::ScriptLoader *>,std::_Select1st<std::pair<float const,Ogre::ScriptLoader *>>,std::less<float>,Ogre::STLAllocator<std::pair<float con")
}
...
pub fn stub_0xd8abd4() -> ! {
    todo!("0xd8abd4 std::_Rb_tree<float,std::pair<float const,Ogre::ScriptLoader *>,std::_Select1st<std::pair<float const,Ogre::ScriptLoader *>>,std::less<float>,Ogre::STLAllocator<std::pair<float con")
}
...
pub fn stub_0xdc86d8() -> ! {
    todo!("0xdc86d8 Ogre::ScriptCompilerListener::preConversion(Ogre::ScriptCompiler *,Ogre::SharedPtr<std::list<Ogre::SharedPtr<Ogre::ConcreteNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::ConcreteNo")
}
...
pub fn stub_0xdc86dc() -> ! {
    todo!("0xdc86dc Ogre::ScriptCompilerListener::postConversion(Ogre::ScriptCompiler *,Ogre::SharedPtr<std::list<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::AbstractN")
}
...
pub fn stub_0xdd65e0() -> ! {
    todo!("0xdd65e0 Ogre::ScriptCompiler::compile(Ogre::SharedPtr<std::list<Ogre::SharedPtr<Ogre::ConcreteNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::ConcreteNode>,Ogre::CategorisedAllocPolicy<(Ogr")
}
...
pub fn stub_0xdd6910() -> ! {
    todo!("0xdd6910 Ogre::ScriptCompiler::convertToAST(Ogre::SharedPtr<std::list<Ogre::SharedPtr<Ogre::ConcreteNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::ConcreteNode>,Ogre::CategorisedAllocPolicy")
}
...
pub fn stub_0xdd6ab8() -> ! {
    todo!("0xdd6ab8 Ogre::ScriptCompiler::processImports(Ogre::SharedPtr<std::list<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::CategorisedAllocPoli")
}
...
pub fn stub_0xdd78b8() -> ! {
    todo!("0xdd78b8 Ogre::ScriptCompiler::processObjects(std::list<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::CategorisedAllocPolicy<(Ogre::Memory")
}
...
pub fn stub_0xdd7ca4() -> ! {
    todo!("0xdd7ca4 Ogre::ScriptCompiler::processVariables(std::list<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::STLAllocator<Ogre::SharedPtr<Ogre::AbstractNode>,Ogre::CategorisedAllocPolicy<(Ogre::Memo")
}
