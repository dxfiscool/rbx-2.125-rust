...
// Batch: +150 stubs | range 0x237370..0x251058 | script 19772->19922 total (filler 0x237370 asc, not-in-script gaps)
...
pub fn stub_0x237370() -> ! { todo!("0x237370 _tls_destructor") }

// 0x237c98 — __GLOBAL__I_a_38
#[doc(alias = "global constructor keyed to_a_38")]
pub fn stub_0x237c98() -> ! { todo!("0x237c98 global constructor keyed to_a_38") }

// 0x23a570 — __GLOBAL__I_a_39
// type: int *()
#[doc(alias = "global constructor keyed to_a_39")]
pub fn stub_0x23a570() -> ! { todo!("0x23a570 global constructor keyed to_a_39") }
...
pub fn stub_0x23afa8() -> ! { todo!("0x23afa8 global constructor keyed to_a_40") }
...
pub fn stub_0x23b544() -> ! { todo!("0x23b544 anonymous namespace::system_error_category::~system_error_category()") }
...
pub fn stub_0x23b548() -> ! { todo!("0x23b548 anonymous namespace::generic_error_category::~generic_error_category()") }
...
pub fn stub_0x23b558() -> ! { todo!("0x23b558 anonymous namespace::generic_error_category::name(void)const") }
...
pub fn stub_0x23b564() -> ! { todo!("0x23b564 anonymous namespace::generic_error_category::message(int)const") }
...
pub fn stub_0x23b7d8() -> ! { todo!("0x23b7d8 anonymous namespace::system_error_category::name(void)const") }
...
pub fn stub_0x23b7e4() -> ! { todo!("0x23b7e4 anonymous namespace::system_error_category::message(int)const") }
...
pub fn stub_0x23b838() -> ! { todo!("0x23b838 anonymous namespace::system_error_category::default_error_condition(int)const") }

// 0x23ca88 — __GLOBAL__I_a_41
// type: void()
#[doc(alias = "global constructor keyed to_a_41")]
pub fn stub_0x23ca88() -> ! { todo!("0x23ca88 global constructor keyed to_a_41") }
...
pub fn stub_0x23e5dc() -> ! { todo!("0x23e5dc RBX::Debugable::doCrash(char const*)") }
...
pub fn stub_0x23e638() -> ! { todo!("0x23e638 RBX::DebugNameString::DebugNameString(char const*,int)") }
...
pub fn stub_0x23e644() -> ! { todo!("0x23e644 RBX::DebugNameString::getNameIncrement(char const*)") }

// 0x23e66c — __Z10DebugBreakv
// type: void __fastcall __noreturn()
#[doc(alias = "DebugBreak(void)")]
pub fn stub_0x23e66c() -> ! { todo!("0x23e66c DebugBreak(void)") }
...
pub fn stub_0x23f42c() -> ! { todo!("0x23f42c RBX::set_thread_name(char const*)") }
...
pub fn stub_0x248ba0() -> ! { todo!("0x248ba0 boost::detail::sp_counted_impl_pd<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data *,boost::detail::do_heap_delete<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data>>::~sp_counted_impl_pd()") }
...
pub fn stub_0x248bb0() -> ! { todo!("0x248bb0 boost::detail::sp_counted_impl_pd<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data *,boost::detail::do_heap_delete<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data>>::dispose(void)") }
...
pub fn stub_0x248bc4() -> ! { todo!("0x248bc4 boost::detail::sp_counted_impl_pd<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data *,boost::detail::do_heap_delete<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data>>::get_deleter(std::type_info const&)") }
...
pub fn stub_0x248bdc() -> ! { todo!("0x248bdc boost::detail::sp_counted_impl_pd<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data *,boost::detail::do_heap_delete<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data>>::get_untyped_deleter(void)") }

// 0x248be0 — __GLOBAL__I_a_50
// type: void __fastcall(int, int, int, int, void *, int)
#[doc(alias = "global constructor keyed to_a_50")]
pub fn stub_0x248be0() -> ! { todo!("0x248be0 global constructor keyed to_a_50") }
...
pub fn stub_0x248e38() -> ! { todo!("0x248e38 RBX::TaskScheduler::Job::averageDutyCycle(void)const") }
...
pub fn stub_0x248eb0() -> ! { todo!("0x248eb0 RBX::TaskScheduler::Job::averageStepsPerSecond(void)const") }

// 0x248f10 — __ZNK3RBX13TaskScheduler3Job15averageStepTimeEv
// type: __int64 __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::averageStepTime(void)const")]
pub fn stub_0x248f10() -> ! { todo!("0x248f10 RBX::TaskScheduler::Job::averageStepTime(void)const") }

// 0x248f20 — __ZNK3RBX13TaskScheduler3Job12averageErrorEv
// type: __int64 __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::averageError(void)const")]
pub fn stub_0x248f20() -> ! { todo!("0x248f20 RBX::TaskScheduler::Job::averageError(void)const") }
...
pub fn stub_0x248f2c() -> ! { todo!("0x248f2c RBX::TaskScheduler::Job::removeCoordinator(rbx_core::SharedPtr<RBX::Tasks::Coordinator>)") }
...
pub fn stub_0x2490ac() -> ! { todo!("0x2490ac RBX::TaskScheduler::Job::addCoordinator(rbx_core::SharedPtr<RBX::Tasks::Coordinator>)") }
...
pub fn stub_0x249184() -> ! { todo!("0x249184 RBX::TaskScheduler::Job::isDisabled(void)") }
...
pub fn stub_0x249270() -> ! { todo!("0x249270 RBX::TaskScheduler::Job::Job(char const*,rbx_core::SharedPtr<RBX::TaskScheduler::Arbiter>,RBX::Time::Interval)") }
...
pub fn stub_0x249920() -> ! { todo!("0x249920 RBX::TaskScheduler::Job::~Job()") }
...
pub fn stub_0x24a1f8() -> ! { todo!("0x24a1f8 RBX::TaskScheduler::Job::computeStandardError(RBX::TaskScheduler::Job::Stats const&,double)") }
...
pub fn stub_0x24a210() -> ! { todo!("0x24a210 RBX::TaskScheduler::Job::computeStandardSleepTime(RBX::TaskScheduler::Job::Stats const&,double)") }
...
pub fn stub_0x24a408() -> ! { todo!("0x24a408 RBX::TaskScheduler::Job::Stats::Stats(RBX::TaskScheduler::Job&,RBX::Time)") }
...
pub fn stub_0x24a440() -> ! { todo!("0x24a440 RBX::TaskScheduler::Job::startWaiting(void)") }
...
pub fn stub_0x24a448() -> ! { todo!("0x24a448 RBX::TaskScheduler::Job::startSleeping(void)") }

// 0x24a468 — __ZN3RBX13TaskScheduler3Job14updateWakeTimeEv
// type: int __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::updateWakeTime(void)")]
pub fn stub_0x24a468() -> ! { todo!("0x24a468 RBX::TaskScheduler::Job::updateWakeTime(void)") }
...
pub fn stub_0x24a4c0() -> ! { todo!("0x24a4c0 RBX::TaskScheduler::Job::updateError(RBX::Time const&)") }
...
pub fn stub_0x24a598() -> ! { todo!("0x24a598 RBX::TaskScheduler::Job::notifyCoordinatorsPreStep(void)") }

// 0x24a684 — __ZN3RBX13TaskScheduler3Job7preStepEv
// type: void __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::preStep(void)")]
pub fn stub_0x24a684() -> ! { todo!("0x24a684 RBX::TaskScheduler::Job::preStep(void)") }
...
pub fn stub_0x24a8b8() -> ! { todo!("0x24a8b8 RBX::TaskScheduler::Job::postStep(RBX::TaskScheduler::StepResult)") }
...
pub fn stub_0x24ab18() -> ! { todo!("0x24ab18 RBX::TaskScheduler::Job::notifyCoordinatorsPostStep(void)") }
...
pub fn stub_0x24ac08() -> ! { todo!("0x24ac08 RBX::TaskScheduler::Job::updatePriority(void)") }
...
pub fn stub_0x24ad00() -> ! { todo!("0x24ad00 std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>::push_back(rbx_core::SharedPtr<RBX::Tasks::Coordinator> const&)") }
...
pub fn stub_0x24ad90() -> ! { todo!("0x24ad90 RBX::WindowAverageDutyCycle<(RBX::Time::SampleMethod)1>::sample(RBX::Time::Interval)") }
...
pub fn stub_0x24ae08() -> ! { todo!("0x24ae08 RBX::WindowAverageTimeInterval<(RBX::Time::SampleMethod)1>::sample(void)") }
...
pub fn stub_0x24ae88() -> ! { todo!("0x24ae88 boost::circular_buffer<double,std::allocator<double>>::allocate(unsigned long)") }
...
pub fn stub_0x24afb0() -> ! { todo!("0x24afb0 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::~clone_impl()") }
...
pub fn stub_0x24b070() -> ! { todo!("0x24b070 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::rethrow(void)const") }
...
pub fn stub_0x24b120() -> ! { todo!("0x24b120 virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::rethrow(void)const") }
...
pub fn stub_0x24b130() -> ! { todo!("0x24b130 virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::~clone_impl()") }
...
pub fn stub_0x24b208() -> ! { todo!("0x24b208 non-virtual thunk toboost::exception_detail::error_info_injector<std::length_error>::~error_info_injector()") }
...
pub fn stub_0x24b2c8() -> ! { todo!("0x24b2c8 void RBX::WindowAverage<double,double>::sample<RBX::FOnBeforeDrop>(double,RBX::FOnBeforeDrop &)") }
...
pub fn stub_0x24b364() -> ! { todo!("0x24b364 RBX::WindowAverageTimeInterval<(RBX::Time::SampleMethod)1>::WindowAverageTimeInterval(RBX::Time::Interval)") }
...
pub fn stub_0x24b45c() -> ! { todo!("0x24b45c RBX::RunningAverage<double,double>::RunningAverage(double,double,unsigned int)") }
...
pub fn stub_0x24b5a4() -> ! { todo!("0x24b5a4 boost::detail::shared_count::shared_count<boost::circular_buffer<double,std::allocator<double>>>(boost::circular_buffer<double,std::allocator<double>> *)") }
...
pub fn stub_0x24b6c8() -> ! { todo!("0x24b6c8 boost::detail::sp_counted_impl_p<boost::circular_buffer<double,std::allocator<double>>>::~sp_counted_impl_p()") }
...
pub fn stub_0x24b6d8() -> ! { todo!("0x24b6d8 boost::detail::sp_counted_impl_p<boost::circular_buffer<double,std::allocator<double>>>::dispose(void)") }
...
pub fn stub_0x24b714() -> ! { todo!("0x24b714 boost::detail::sp_counted_impl_p<boost::circular_buffer<double,std::allocator<double>>>::get_deleter(std::type_info const&)") }
...
pub fn stub_0x24b718() -> ! { todo!("0x24b718 boost::detail::sp_counted_impl_p<boost::circular_buffer<double,std::allocator<double>>>::get_untyped_deleter(void)") }
...
pub fn stub_0x24b71c() -> ! { todo!("0x24b71c __gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>> std::__find_if<__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>>,boost::_bi::bind_t<bool,boost::_mfi::mf1<bool,RBX::Tasks::Coordinator,RBX::TaskScheduler::Job *>,boost::_bi::list2<boost::arg<1>,boost::_bi::value<RBX::TaskScheduler::Job *>>>>(__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>>,__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>>,boost::_bi::bind_t<bool,boost::_mfi::mf1<bool,RBX::Tasks::Coordinator,RBX::TaskScheduler::Job *>,boost::_bi::list2<boost::arg<1>,boost::_bi::value<RBX::TaskScheduler::Job *>>>,std::random_access_iterator_tag)") }
...
pub fn stub_0x24b860() -> ! { todo!("0x24b860 std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>::_M_insert_aux(__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>*,std::vector<rbx_core::SharedPtr<RBX::Tasks::Coordinator>,std::allocator<rbx_core::SharedPtr<RBX::Tasks::Coordinator>>>>,rbx_core::SharedPtr<RBX::Tasks::Coordinator> const&)") }
...
pub fn stub_0x24beb0() -> ! { todo!("0x24beb0 rbx_core::SharedPtr<RBX::Tasks::Coordinator> * std::__copy<false,std::random_access_iterator_tag>::copy<rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,rbx_core::SharedPtr<RBX::Tasks::Coordinator> *>(rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,rbx_core::SharedPtr<RBX::Tasks::Coordinator> *,rbx_core::SharedPtr<RBX::Tasks::Coordinator> *)") }

// 0x24bf64 — __GLOBAL__I_a_51
#[doc(alias = "global constructor keyed to_a_51")]
pub fn stub_0x24bf64() -> ! { todo!("0x24bf64 global constructor keyed to_a_51") }

// 0x24c02c — __ZN3RBX13TaskScheduler13endAllThreadsEv
// type: int __fastcall(int this)
#[doc(alias = "RBX::TaskScheduler::endAllThreads(void)")]
pub fn stub_0x24c02c() -> ! { todo!("0x24c02c RBX::TaskScheduler::endAllThreads(void)") }
...
pub fn stub_0x24c048() -> ! { todo!("0x24c048 RBX::TaskScheduler::setThreadCount(RBX::TaskScheduler::ThreadPoolConfig)") }
...
pub fn stub_0x24c1ec() -> ! { todo!("0x24c1ec RBX::TaskScheduler::Thread::runJob(void)") }
...
pub fn stub_0x24c43c() -> ! { todo!("0x24c43c RBX::TaskScheduler::conflictsWithScheduledJob(RBX::TaskScheduler::Job *)const") }
...
pub fn stub_0x24c5bc() -> ! { todo!("0x24c5bc RBX::TaskScheduler::enableThreads(std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>> &)") }
...
pub fn stub_0x24c660() -> ! { todo!("0x24c660 RBX::TaskScheduler::Thread::loop(void)") }
...
pub fn stub_0x24cd18() -> ! { todo!("0x24cd18 RBX::TaskScheduler::getJobsInfo(std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>>> &)") }
...
pub fn stub_0x24ce78() -> ! { todo!("0x24ce78 RBX::TaskScheduler::setJobsExtendedStatsWindow(double)") }
...
pub fn stub_0x24d05c() -> ! { todo!("0x24d05c setJobExtendedStatsWindow(rbx_core::SharedPtr<RBX::TaskScheduler::Job>,double)") }
...
pub fn stub_0x24d0ec() -> ! { todo!("0x24d0ec RBX::TaskScheduler::getJobsByName(std::string const&,std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>>> &)") }
...
pub fn stub_0x24d284() -> ! { todo!("0x24d284 RBX::TaskScheduler::Thread::join(void)") }
...
pub fn stub_0x24d2dc() -> ! { todo!("0x24d2dc std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>::push_back(rbx_core::SharedPtr<RBX::TaskScheduler::Thread> const&)") }
...
pub fn stub_0x24d368() -> ! { todo!("0x24d368 RBX::TaskScheduler::Thread::create(RBX::TaskScheduler*)") }
...
pub fn stub_0x24d770() -> ! { todo!("0x24d770 std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>>>::push_back(rbx_core::SharedPtr<RBX::TaskScheduler::Job const> const&)") }
...
pub fn stub_0x24d7fc() -> ! { todo!("0x24d7fc std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Job>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Job>>>::push_back(rbx_core::SharedPtr<RBX::TaskScheduler::Job> const&)") }
...
pub fn stub_0x24dff8() -> ! { todo!("0x24dff8 std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>>>::_M_insert_aux(__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>*,std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Job const>>>>,rbx_core::SharedPtr<RBX::TaskScheduler::Job const> const&)") }
...
pub fn stub_0x24e590() -> ! { todo!("0x24e590 rbx_core::SharedPtr<RBX::TaskScheduler::Job const> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<rbx_core::SharedPtr<RBX::TaskScheduler::Job const> *,rbx_core::SharedPtr<RBX::TaskScheduler::Job const> *>(rbx_core::SharedPtr<RBX::TaskScheduler::Job const> *,rbx_core::SharedPtr<RBX::TaskScheduler::Job const> *,rbx_core::SharedPtr<RBX::TaskScheduler::Job const> *)") }
...
pub fn stub_0x24e648() -> ! { todo!("0x24e648 RBX::RunningAverageTimeInterval<(RBX::Time::SampleMethod)2>::sample(void)") }
...
pub fn stub_0x24e6a8() -> ! { todo!("0x24e6a8 rbx_core::SharedPtr<RBX::TaskScheduler::Thread> * std::__copy<false,std::random_access_iterator_tag>::copy<rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *>(rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *)") }
...
pub fn stub_0x24e75c() -> ! { todo!("0x24e75c rbx_core::SharedPtr<RBX::TaskScheduler::Thread>::shared_ptr<RBX::TaskScheduler::Thread>(rbx_core::WeakPtr<RBX::TaskScheduler::Thread> const&)") }
...
pub fn stub_0x24e870() -> ! { todo!("0x24e870 boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::reset(RBX::TaskScheduler::Job **)") }
...
pub fn stub_0x24e98c() -> ! { todo!("0x24e98c std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>::_M_insert_aux(__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>*,std::vector<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>,std::allocator<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> const&)") }
...
pub fn stub_0x24ef24() -> ! { todo!("0x24ef24 rbx_core::SharedPtr<RBX::TaskScheduler::Thread> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *>(rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *,rbx_core::SharedPtr<RBX::TaskScheduler::Thread> *)") }
...
pub fn stub_0x24efe0() -> ! { todo!("0x24efe0 boost::circular_buffer<double,std::allocator<double>>::set_capacity(unsigned long)") }
...
pub fn stub_0x24f190() -> ! { todo!("0x24f190 boost::exception_detail::error_info_injector<std::length_error>::~error_info_injector()") }
...
pub fn stub_0x24f248() -> ! { todo!("0x24f248 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::clone_impl(boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>> const&)") }
...
pub fn stub_0x24f388() -> ! { todo!("0x24f388 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::clone_impl(boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>> const&,boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::clone_tag)") }
...
pub fn stub_0x24f520() -> ! { todo!("0x24f520 boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list_av_1<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>::type> boost::bind<void,RBX::TaskScheduler::Thread,rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>(void (RBX::TaskScheduler::Thread::*)(void),rbx_core::SharedPtr<RBX::TaskScheduler::Thread>)") }
...
pub fn stub_0x24f6c0() -> ! { todo!("0x24f6c0 boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>::list1(boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>)") }
...
pub fn stub_0x24f808() -> ! { todo!("0x24f808 __ZN5boost9function0IvEC2INS_3_bi6bind_tIvNS_4_mfi3mf0IvN3RBX13TaskScheduler6ThreadEEENS3_5list1INS3_5valueINS_10shared_ptrIS9_EEEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISI_EE5valueEEE5valueEiE4typeE") }
...
pub fn stub_0x24f93c() -> ! { todo!("0x24f93c void boost::function0<void>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>>(boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>)") }
...
pub fn stub_0x24fa7c() -> ! { todo!("0x24fa7c boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)") }
...
pub fn stub_0x24faa0() -> ! { todo!("0x24faa0 boost::detail::function::void_function_obj_invoker0<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>,void>::invoke(boost::detail::function::function_buffer &)") }
...
pub fn stub_0x24fbf4() -> ! { todo!("0x24fbf4 bool boost::detail::function::basic_vtable0<void>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>>(boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const") }
...
pub fn stub_0x24fdac() -> ! { todo!("0x24fdac boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::TaskScheduler::Thread>,boost::_bi::list1<boost::_bi::value<rbx_core::SharedPtr<RBX::TaskScheduler::Thread>>>>>::manager(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type,mpl_::bool_<false>)") }
...
pub fn stub_0x24ff48() -> ! { todo!("0x24ff48 boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::function0<void>>>::~sp_counted_impl_p()") }
...
pub fn stub_0x24ff58() -> ! { todo!("0x24ff58 void boost::enable_shared_from_this<RBX::TaskScheduler::Thread>::_internal_accept_owner<RBX::TaskScheduler::Thread,RBX::TaskScheduler::Thread>(rbx_core::SharedPtr<RBX::TaskScheduler::Thread> const*,RBX::TaskScheduler::Thread *)const") }
...
pub fn stub_0x2500b0() -> ! { todo!("0x2500b0 boost::detail::shared_count::shared_count<RBX::TaskScheduler::Thread>(RBX::TaskScheduler::Thread *)") }
...
pub fn stub_0x2501bc() -> ! { todo!("0x2501bc RBX::TaskScheduler::Thread::~Thread()") }
...
pub fn stub_0x2503f4() -> ! { todo!("0x2503f4 boost::detail::sp_counted_impl_p<RBX::TaskScheduler::Thread>::~sp_counted_impl_p()") }
...
pub fn stub_0x250404() -> ! { todo!("0x250404 boost::detail::sp_counted_impl_p<RBX::TaskScheduler::Thread>::dispose(void)") }
...
pub fn stub_0x2504a8() -> ! { todo!("0x2504a8 boost::detail::sp_counted_impl_p<RBX::TaskScheduler::Thread>::get_deleter(std::type_info const&)") }
...
pub fn stub_0x2504ac() -> ! { todo!("0x2504ac boost::detail::sp_counted_impl_p<RBX::TaskScheduler::Thread>::get_untyped_deleter(void)") }
...
pub fn stub_0x2504b0() -> ! { todo!("0x2504b0 boost::thread::timed_join(boost::posix_time::ptime const&)") }
...
pub fn stub_0x250588() -> ! { todo!("0x250588 boost::date_time::counted_time_system<boost::date_time::counted_time_rep<boost::posix_time::millisec_posix_time_system_config>>::add_time_duration(boost::date_time::counted_time_rep<boost::posix_time::millisec_posix_time_system_config> const&,boost::posix_time::time_duration)") }
...
pub fn stub_0x2506f8() -> ! { todo!("0x2506f8 void boost::throw_exception<std::runtime_error>(std::runtime_error const&)") }
...
pub fn stub_0x250848() -> ! { todo!("0x250848 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::~clone_impl()") }
...
pub fn stub_0x250900() -> ! { todo!("0x250900 boost::exception_detail::error_info_injector<std::runtime_error>::~error_info_injector()") }
...
pub fn stub_0x2509b8() -> ! { todo!("0x2509b8 non-virtual thunk toboost::exception_detail::error_info_injector<std::runtime_error>::~error_info_injector()") }
...
pub fn stub_0x250a70() -> ! { todo!("0x250a70 non-virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::~clone_impl()") }
...
pub fn stub_0x250b28() -> ! { todo!("0x250b28 virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::~clone_impl()") }
...
pub fn stub_0x250bf8() -> ! { todo!("0x250bf8 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::clone(void)const") }
...
pub fn stub_0x250cb8() -> ! { todo!("0x250cb8 virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::clone(void)const") }
...
pub fn stub_0x250e40() -> ! { todo!("0x250e40 boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::clone_impl(boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>> const&,boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::runtime_error>>::clone_tag)") }
...
pub fn stub_0x250fc8() -> ! { todo!("0x250fc8 boost::CV::simple_exception_policy<unsigned short,(unsigned short)1,(unsigned short)31,boost::gregorian::bad_day_of_month>::on_error(unsigned short,unsigned short,boost::CV::violation_enum)") }
...
pub fn stub_0x25104c() -> ! { todo!("0x25104c boost::gregorian::bad_day_of_month::~bad_day_of_month()") }
...
pub fn stub_0x251058() -> ! { todo!("0x251058 boost::gregorian::bad_day_of_month::bad_day_of_month(void)") }
