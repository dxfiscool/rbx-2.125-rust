...
pub fn stub_0x244bcc() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::Limits::Counter")
}
...
pub fn stub_0x244c74(handle: crate::slot::InstanceHandle) {
...
pub fn stub_0x244c78(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0x244c84() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::Limits::Counter")
}
...
pub fn stub_0x244c98() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::Limits::Counter")
}
...
pub fn stub_0x244cb0() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::Limits::Counter")
}

#[doc(alias = "global constructor keyed to_a_46")]
pub fn stub_0x244cb4() -> crate::slot::PortedFn {
// IDA 0x244cb4: __GLOBAL__I_a_46.
// loader/host import; dispatch lives outside this crate
crate::slot::PortedFn::new(0x244cb4, "__GLOBAL__I_a_46")
}
...
pub fn stub_0x244d7c(handle: &crate::slot::InstanceHandle) {
// RBX::roblox_allocator::malloc(unsigned long) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x244dac(handle: &crate::slot::InstanceHandle) {
// RBX::roblox_allocator::free(char *) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x244db8(vec: crate::slot::VecModel) {
...
pub fn stub_0x244dcc(vec: crate::slot::VecModel) {
// sequence dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0x244de0() -> crate::slot::PortedFn {
// IDA 0x244de0: global constructor keyed to_a_47.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x244de0, "global constructor keyed to_a_47")
}
...
pub fn stub_0x244e94() -> crate::slot::SlotConnection {
// IDA 0x244e94: signal::connect<bind_t> (cf. 0x39d700) — links the
...
pub fn stub_0x244fd4() -> crate::slot::SlotConnection {
// IDA 0x244fd4: signal::connect<bind_t> (cf. 0x39d700) — links the
// bound callable_slot into the signal and returns the
// rbx::signals::connection. was: boost::bind/_mfi.
crate::slot::SlotConnection::new()
}
...
pub fn stub_0x245118() -> crate::slot::SlotConnection {
// IDA 0x245118: signal::connect<bind_t> (cf. 0x39d700) — links the
// bound callable_slot into the signal and returns the
// rbx::signals::connection. was: boost::bind/_mfi.
crate::slot::SlotConnection::new()
}
...
// was: bool __fastcall(int32_t, int32_t **, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int)
#[doc(alias = "rbx::signals::connection::operator!=(rbx::signals::connection const&)const")]
pub fn stub_0x2452d0() -> crate::slot::SlotConnection {
// IDA 0x2452d0: signal::connect<bind_t> (cf. 0x39d700) — links the
// bound callable_slot into the signal and returns the
// rbx::signals::connection. was: boost::bind/_mfi.
crate::slot::SlotConnection::new()
}
...
pub fn stub_0x245488() -> crate::slot::SlotConnection {
// IDA 0x245488: signal::connect<bind_t> (cf. 0x39d700) — links the
// bound callable_slot into the signal and returns the
// rbx::signals::connection. was: boost::bind/_mfi.
crate::slot::SlotConnection::new()
}
...
pub fn stub_0x24551c(msg: String) {
// exception dtor.
drop(msg);
}
...
pub fn stub_0x245544() -> crate::slot::PortedFn {
// IDA 0x245544: Init::initStaticData(void).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x245544, "Init::initStaticData(void)")
}

#[doc(alias = "global constructor keyed to_a_48")]
pub fn stub_0x245548() -> crate::slot::PortedFn {
// IDA 0x245548: __GLOBAL__I_a_48.
// loader/host import; dispatch lives outside this crate
crate::slot::PortedFn::new(0x245548, "__GLOBAL__I_a_48")
}
...
pub fn stub_0x2456a0(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::Tasks::SequenceBase getter.
cell.get()
}
...
pub fn stub_0x2456d8(handle: &crate::slot::InstanceHandle) {
// RBX::Tasks::SequenceBase::advance(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x245708(handle: &crate::slot::InstanceHandle) {
// RBX::Tasks::SequenceBase::onAdded(RBX::TaskScheduler::Job *) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x2457f0(handle: &crate::slot::InstanceHandle) {
// RBX::Tasks::SequenceBase::onRemoved(RBX::TaskScheduler::Job *) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x245848(vec: &mut crate::slot::VecModel) -> usize {
// std sequence _M_insert — grows and returns the index.
vec.append()
}

#[doc(alias = "global constructor keyed to_a_49")]
pub fn stub_0x245940() -> crate::slot::PortedFn {
// IDA 0x245940: __GLOBAL__I_a_49.
// loader/host import; dispatch lives outside this crate
crate::slot::PortedFn::new(0x245940, "__GLOBAL__I_a_49")
}
...
pub fn stub_0x245a08(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::TaskScheduler getter.
cell.get()
}
...
pub fn stub_0x245ab0(handle: &crate::slot::InstanceHandle) {
// RBX::ExclusiveArbiter::areExclusive(RBX::TaskScheduler::Job *,RBX::TaskScheduler::Job *) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x245b68(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::static_init(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x245c64(handle: crate::slot::InstanceHandle) {
// RBX::TaskScheduler dtor.
drop(handle);
}
...
pub fn stub_0x245c70(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::singleton(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x245c94() -> crate::slot::InstanceHandle {
// RBX::TaskScheduler ctor.
crate::slot::InstanceHandle::new("RBX::TaskScheduler")
}
...
pub fn stub_0x246308(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::sampleRunningJobCount(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x246358(handle: crate::slot::InstanceHandle) {
// RBX::TaskScheduler dtor.
drop(handle);
}
...
pub fn stub_0x2467d0() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
...
pub fn stub_0x246a48() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x246da8() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x246e98(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::scheduleJob(RBX::TaskScheduler::Job &) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x246f90() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x24710c(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::incrementThreadCount(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x24711c(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::decrementThreadCount(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x247130(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::TaskScheduler getter.
cell.get()
}
...
pub fn stub_0x247154(handle: &crate::slot::InstanceHandle) {
// RBX::TaskScheduler::wakeSleepingJobs(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x247220() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Thread")
}

#[doc(alias = "rbx::thread_specific_reference<RBX::TaskScheduler::Job>::~thread_specific_reference()")]
pub fn stub_0x247bd8(handle: crate::slot::InstanceHandle) {
...
pub fn stub_0x247be8(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::TaskScheduler::Job getter.
cell.get()
}
...
pub fn stub_0x247db0(handle: &crate::slot::InstanceHandle) {
// RBX::RunningAverage<int,double>::sample(int) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x247e74(handle: &crate::slot::InstanceHandle) {
// RBX::ExclusiveArbiter::arbiterName(void) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x247e90(cell: &crate::slot::PropCell) -> crate::slot::PropValue {
// RBX::ExclusiveArbiter getter.
cell.get()
}
...
pub fn stub_0x247e94() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x247fac() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x248020() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x248050() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x248104() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::TaskScheduler::Job")
}
...
pub fn stub_0x248224() -> crate::slot::SharedCount {
...
pub fn stub_0x24831c(count: crate::slot::SharedCount) {
...
pub fn stub_0x248320(count: crate::slot::SharedCount) {
// shared_count dtor — releases the counter.
drop(count);
}
...
pub fn stub_0x24832c() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x24834c() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x248350() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x248358() -> crate::slot::PortedFn {
// IDA 0x248358: boost::detail::thread_data<boost::function0<void>>::~thread_data().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248358, "boost::detail::thread_data<boost::function0<void>>::~thread_data()")
}
...
pub fn stub_0x248448() -> crate::slot::PortedFn {
// IDA 0x248448: boost::condition_variable::condition_variable(void).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248448, "boost::condition_variable::condition_variable(void)")
}
...
pub fn stub_0x248620() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
...
pub fn stub_0x248778() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x24877c(slot: &crate::slot::FnSlot) -> crate::slot::FnSlot {
...
pub fn stub_0x2487dc(slot: &crate::slot::FnSlot) {
...
pub fn stub_0x2487f8(msg: &str) -> String {
...
pub fn stub_0x248938() -> crate::slot::PortedFn {
// IDA 0x248938: boost::function0<void>::dummy::nonnull(void).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248938, "boost::function0<void>::dummy::nonnull(void)")
}
...
pub fn stub_0x248940() -> crate::slot::InstanceHandle {
// RBX::mutex ctor.
...
pub fn stub_0x248a8c() -> crate::slot::PortedFn {
// IDA 0x248a8c: boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::~thread_specific_ptr().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248a8c, "boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::~thread_specific_ptr()")
}
...
pub fn stub_0x248b80() -> crate::slot::PortedFn {
// IDA 0x248b80: boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::~delete_data().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248b80, "boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::~delete_data()")
}
...
pub fn stub_0x248b84() -> crate::slot::PortedFn {
// IDA 0x248b84: boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::~delete_data() [0x248b84].
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248b84, "boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::~delete_data() [0x248b84]")
}
...
pub fn stub_0x248b90() -> crate::slot::PortedFn {
// IDA 0x248b90: boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::operator()(void *).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x248b90, "boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::operator()(void *)")
}
