...
// Batch: +150 stubs | range 0x2400f4..0x2504a8 | existing 8091 -> 8241 total (filler after 0x23f50c, EA-sorted ascending)
...
// was: __int64 __fastcall(RBX::TaskScheduler::Job *this)
...
// was: bool __fastcall(RBX::TaskScheduler::Job *this)
...
// was: char *__fastcall(int, volatile int *, int, int, int, pthread_mutex_t *, struct _Unwind_Exception *lpuexcpt, int, int, int, char, int, pthread_mutex_t *, int, int, int, int, int)
...
// was: void __fastcall(RBX::TaskScheduler::Job *__hidden this)
...
// was: void __fastcall(RBX::TaskScheduler::Job *this, int, int)
#[doc(alias = "RBX::TaskScheduler::Job::~Job()")]
...
// was: int __fastcall(int result, int, double *, unsigned int, unsigned int)
...
// was: void __fastcall(RBX::TaskScheduler::Job *this, const RBX::TaskScheduler::Job::Stats *, double, struct _Unwind_Exception *lpuexcpt)
...
// was: RBX::TaskScheduler::Job::Stats *__fastcall(RBX::TaskScheduler::Job::Stats *this, RBX::TaskScheduler::Job *, Time)
...
// was: int __fastcall(RBX::TaskScheduler::Job *this)
...
// was: int __fastcall(RBX::TaskScheduler::Job *this, const RBX::Time *)
...
// was: void __fastcall(RBX::TaskScheduler::Job *this)
...
// was: void __fastcall(int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, boost::detail::sp_counted_base *, int, int, int, int)
...
// was: double *__fastcall(RBX::TaskScheduler::Job *this)
...
// was: int __fastcall(__int64 *, unsigned int, unsigned int)
...
// was: void __fastcall(std::logic_error *, int, int, int, void *, int)
...
// was: void __fastcall __noreturn(int)
...
// was: void __fastcall __noreturn(_DWORD *)
...
// was: void __fastcall(_DWORD *, int, int, int, void *, int)
...
// was: int __fastcall(__int64 *, unsigned int, unsigned int, int)
...
// was: int __fastcall(int, unsigned int, unsigned int)
...
// was: int *__fastcall(int *, int, int, unsigned int, unsigned int, unsigned int, int, int, int, int)
...
// was: _DWORD *__fastcall(_DWORD *, int, int (*)(void), int, int)
...
// was: void __fastcall(int, char *, int *, int, int, int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, boost::detail::sp_counted_base *, void *, int, int, int, int, int, int, int, void *, int)
...
// was: _DWORD *__fastcall(int, int, _DWORD *)
...
// was: void __fastcall(int, int, int, int, boost::detail::sp_counted_base *, pthread_mutex_t *, int, int, int, int)
...
// was: int __fastcall(RBX::TaskScheduler::Thread *this)
...
// was: int __fastcall(int, __int64 *, int)
...
// was: void __fastcall(RBX::TaskScheduler *this, double)
...
// was: int *__fastcall(int *result, unsigned int, unsigned int)
...
// was: void __fastcall(int, const void **, int)
...
// was: pthread_t __fastcall(RBX::TaskScheduler::Thread *this)
...
// was: void __fastcall(RBX::TaskScheduler::Thread *this, RBX::TaskScheduler *)
...
// was: void __fastcall(_DWORD *, void (__fastcall **)(int *, _DWORD, _DWORD), int **)
...
// was: int __fastcall(char **, unsigned int)
...
// was: std::logic_error *__fastcall(std::logic_error *, int, int, int, void *, int)
#[doc(alias = "boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::~clone_impl()")]
...
// was: int __fastcall(std::logic_error *, int, int, int, void *, int)
...
// was: void __fastcall(int, struct _Unwind_Exception *, boost::detail::sp_counted_base *, int)
...
// was: _DWORD *__fastcall(_DWORD *, unsigned int *, int, int, struct _Unwind_Exception *lpuexcpt, boost::detail::sp_counted_base *, int, int, int, int)
...
// was: int __fastcall(int, int *, _DWORD *, int, int, int, int, struct _Unwind_Exception *lpuexcpt, boost::detail::sp_counted_base *, void *, int, int, int, int)
