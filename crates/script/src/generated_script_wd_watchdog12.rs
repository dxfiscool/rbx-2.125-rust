...
pub fn stub_0x5478d4(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType>::convertToValue(RBX::Name con~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547950(handle: crate::slot::InstanceHandle) {
...
pub fn stub_0x547b24(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToString(RBX::GuiService::S~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547cc4() -> crate::lua::ScriptVariant {
...
pub fn stub_0x547d14(handle: &crate::slot::InstanceHandle) {
// rbx::implementation::typed_holder<RBX::GuiService::SpecialKey>::singleton() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547d80(handle: &crate::slot::InstanceHandle) {
// rbx::implementation::typed_holder<RBX::GuiService::SpecialKey>::construct_func(char const*~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547d8c(handle: &crate::slot::InstanceHandle) {
// rbx::implementation::typed_holder<RBX::GuiService::SpecialKey>::destruct_func(char*) — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547d90(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToItem(RBX::GuiService::Spe~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547e5c(any: &crate::lua::ScriptVariant) -> crate::lua::ScriptVariant {
...
pub fn stub_0x547f4c(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey>::convertToValue(RBX::Name const&, R~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x547fc8(handle: crate::slot::InstanceHandle) {
// RBX::Reflection::EnumDesc dtor.
drop(handle);
}
...
pub fn stub_0x548450() -> crate::slot::PortedFn {
// IDA 0x548450: boost::detail::weak_count::weak_count(boost::detail::weak_count const&).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x548450, "boost::detail::weak_count::weak_count(boost::detail::weak_count const&)")
}
...
pub fn stub_0x548ae8() -> crate::slot::InstanceHandle {
...
pub fn stub_0x548b18() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
...
pub fn stub_0x548f4c() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::NotificationObject")
}
...
pub fn stub_0x549014() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::NotificationObject")
}
...
pub fn stub_0x5490fc() -> crate::slot::SharedCount {
...
pub fn stub_0x549204(count: crate::slot::SharedCount) {
...
pub fn stub_0x549208(count: crate::slot::SharedCount) {
// shared_count dtor — releases the counter.
drop(count);
}
...
pub fn stub_0x54920c() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x54922c() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x549244() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x549248(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Described<RBX::NotificationBox, RBX::sNotificationBox, RBX::FactoryProduc~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x549368(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
...
pub fn stub_0x5493d0(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x549428(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54949c(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x5494f4() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("rbx::signals::signal<void (std::string, std::string)>::slot")
}
...
pub fn stub_0x549654(handle: &crate::slot::InstanceHandle) {
// rbx::signals::signal_with_args<2, void (std::string, std::string)>::fireItem(rbx::signals:~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54980c(msg: &str) -> String {
...
pub fn stub_0x549834(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
...
pub fn stub_0x549858(handle: &crate::slot::InstanceHandle) {
// rbx::signals::signal<void (std::string, std::string)>::safe_static_init_mutex() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54985c(handle: &crate::slot::InstanceHandle) {
// rbx::signals::signal<void (std::string, std::string)>::safe_static_do_get_mutex() — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x549954() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("rbx::signals::signal<void (RBX::GuiService::SpecialKey, std::string)>::slot")
}
...
pub fn stub_0x549ab4(msg: &str) -> String {
// exception ctor — carries the message (thrown via panic
// at the throw site, cf. LuaTableKeysMustBeStrings).
msg.to_owned()
}
...
pub fn stub_0x549adc(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
// shared/intrusive_ptr operator= — atomic retain + alias;
// the host copy carries the same identity.
*handle
}
...
pub fn stub_0x549b00(handle: &crate::slot::InstanceHandle) {
// rbx::signals::signal<void (RBX::GuiService::SpecialKey, std::string)>::safe_static_init_mu~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x549b04(handle: &crate::slot::InstanceHandle) {
// rbx::signals::signal<void (RBX::GuiService::SpecialKey, std::string)>::safe_static_do_get_~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x549bfc() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x549c24() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x549c70() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x549cd4() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x549cf0() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x549d18() -> crate::slot::BoundCall {
...
pub fn stub_0x549ddc() -> crate::slot::BoundCall {
// boost::bind (cf. 0x39d700 args) — captures receiver +
// member functor + 1 placeholders as a host closure.
// was: boost::_bi::bind_t/_mfi.
crate::slot::BoundCall::new(1)
...
pub fn stub_0x549ea4(slot: &mut crate::slot::FnSlot) -> bool {
...
pub fn stub_0x549f7c(slot: &crate::slot::FnSlot) -> crate::slot::FnSlot {
...
pub fn stub_0x549f98(slot: &crate::slot::FnSlot) {
...
pub fn stub_0x549fa0(slot: &mut crate::slot::FnSlot) -> bool {
// boost::function basic_vtable assign — always stores into
// the functor slot. was: boost::function<R(ARGS)>.
slot.assign()
}
...
pub fn stub_0x54a068(slot: &mut crate::slot::FnSlot) -> bool {
// boost::function basic_vtable assign — always stores into
// the functor slot. was: boost::function<R(ARGS)>.
slot.assign()
}
...
pub fn stub_0x54a12c(slot: &mut crate::slot::FnSlot) -> bool {
// boost::function basic_vtable assign — always stores into
// the functor slot. was: boost::function<R(ARGS)>.
slot.assign()
}
...
pub fn stub_0x54a1e0(slot: &crate::slot::FnSlot) -> crate::slot::FnSlot {
// boost::function functor_manager::manage — clone/destroy op
// over the type-erased buffer; the host clones the slot.
slot.clone_op()
}
...
pub fn stub_0x54a314() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x54a3c8() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x54a414() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x54a47c() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("RBX::GuiObject")
}
...
pub fn stub_0x54a568() -> crate::slot::PortedFn {
// IDA 0x54a568: boost::function0<void>::swap(boost::function0<void>&).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x54a568, "boost::function0<void>::swap(boost::function0<void>&)")
}
...
pub fn stub_0x54b464() -> crate::slot::PortedFn {
// IDA 0x54b464: std::list<RBX::GuiService::DialogWrapper*, std::allocator<RBX::GuiService::DialogWrapper*>>::list(std::list<RBX::GuiServ~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x54b464, "std::list<RBX::GuiService::DialogWrapper*, std::allocator<RBX::GuiService::DialogWrapper*>>::list(st~")
}
...
pub fn stub_0x54b530() -> crate::slot::PortedFn {
// IDA 0x54b530: void std::list<RBX::GuiService::DialogWrapper*, std::allocator<RBX::GuiService::DialogWrapper*>>::_M_initialize_dispatch~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x54b530, "void std::list<RBX::GuiService::DialogWrapper*, std::allocator<RBX::GuiService::DialogWrapper*>>::_M~")
}
...
pub fn stub_0x54b554(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54b608(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54b654(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54b6bc() -> crate::slot::PortedFn {
// IDA 0x54b6bc: std::_Rb_tree<RBX::GuiService::CenterDialogType, std::pair<RBX::GuiService::CenterDialogType const, std::list<RBX::GuiSe~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0x54b6bc, "std::_Rb_tree<RBX::GuiService::CenterDialogType, std::pair<RBX::GuiService::CenterDialogType const, ~")
}
...
pub fn stub_0x54b7a0(handle: &crate::slot::InstanceHandle) {
// RBX::ScreenGui const* RBX::Instance::findConstFirstChildOfType<RBX::ScreenGui>() const — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54b808(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Described<RBX::ScreenGui, RBX::sScreenGui, RBX::FactoryProduct<RBX::Scree~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54b928(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Described<RBX::GuiLayerCollector, RBX::sLayerCollector, RBX::NonFactoryPr~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54ba48() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
...
pub fn stub_0x54baf8(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
// shared/intrusive_ptr operator= — atomic retain + alias;
// the host copy carries the same identity.
*handle
}
...
pub fn stub_0x54bb2c() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x54bc34(count: crate::slot::SharedCount) {
// shared_count dtor — releases the counter.
drop(count);
}
...
pub fn stub_0x54bc38() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x54bc58() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x54bc70() -> crate::slot::SharedCount {
// shared_count ctor — one strong, one weak (self).
crate::slot::SharedCount::new()
}
...
pub fn stub_0x54bc74(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Described<RBX::GuiService, RBX::sGuiService, RBX::NonFactoryProduct<RBX::~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54bd90(handle: crate::slot::InstanceHandle) {
...
pub fn stub_0x54bd94(handle: crate::slot::InstanceHandle) {
// RBX::Reflection::Described dtor.
drop(handle);
}
...
pub fn stub_0x54be34(handle: &mut crate::slot::ThunkHandle) {
...
pub fn stub_0x54be3c(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (delta 32, this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run the dtor body.
let _ = handle.delta;
debug_assert_eq!(handle.delta, 32);
...
pub fn stub_0x54bee0(handle: &mut crate::slot::ThunkHandle) {
...
pub fn stub_0x54bee8(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (delta 36, this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run the dtor body.
let _ = handle.delta;
debug_assert_eq!(handle.delta, 36);
...
pub fn stub_0x54bf8c(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType> co~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54bf90(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::CenterDialogType> co~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54c080(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey> const>::~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54c084(handle: &crate::slot::InstanceHandle) {
// RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::GuiService::SpecialKey> const>::~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54c174(any: &crate::lua::ScriptVariant) -> crate::lua::ScriptVariant {
// rbx::any_cast — extracts the payload; the host clone
// preserves the value flow.
any.clone()
}
...
pub fn stub_0x54c1cc(any: &crate::lua::ScriptVariant) -> crate::lua::ScriptVariant {
// rbx::any_cast — extracts the payload; the host clone
// preserves the value flow.
any.clone()
}
...
pub fn stub_0x54c2bc(vec: &mut crate::slot::VecModel, n: usize) {
...
pub fn stub_0x54c2f0(vec: &mut crate::slot::VecModel) -> usize {
...
pub fn stub_0x54c318(map: &mut crate::slot::TreeMapModel, key: &str) -> Option<String> {
...
pub fn stub_0x54c370(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54c424(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54c47c(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0x54c4e4(vec: &mut crate::slot::VecModel) -> usize {
...
pub fn stub_0x54c5c8() -> crate::slot::VecModel {
...
pub fn stub_0x54c5e0(handle: &crate::slot::InstanceHandle) {
// RBX::GuiService::CenterDialogType* std::__copy_backward<false, std::random_access_iterator~ — engine-side; linkage preserved via the alias.
let _ = handle;
}
...
pub fn stub_0x54c61c(vec: &mut crate::slot::VecModel, index: usize) -> bool {
...
pub fn stub_0x54c7ac(any: &crate::lua::ScriptVariant) -> crate::lua::ScriptVariant {
// rbx::any_cast — extracts the payload; the host clone
// preserves the value flow.
any.clone()
}
...
pub fn stub_0x54c804(any: &crate::lua::ScriptVariant) -> crate::lua::ScriptVariant {
// rbx::any_cast — extracts the payload; the host clone
// preserves the value flow.
any.clone()
}
...
pub fn stub_0x54c8f4(vec: &mut crate::slot::VecModel, n: usize) {
// Array::resize — truncates or value-fills.
vec.resize(n);
}
...
pub fn stub_0x54c928(vec: &mut crate::slot::VecModel) -> usize {
// Array/vector append — grows and returns the index.
vec.append()
}
