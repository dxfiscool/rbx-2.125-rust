...
// Filter: Lua|Script|Yield|lua (5401 filtered, 0 remaining) -> global gap filler EA-sorted asc next 150 not yet in script crate
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: +150 stubs | range 0x11059c..0x158178 | script 15541->15691 distinct
...
#[doc(alias = "__Z16_MemoryWriteProcPvjjS_")]
pub fn stub_0x11073c() -> ! {
    todo!("0x11073c _MemoryWriteProc(void *,unsigned int,unsigned int,void *)")
}
...
#[doc(alias = "__Z15_MemoryReadProcPvjjS_")]
pub fn stub_0x1107f0() -> ! {
    todo!("0x1107f0 _MemoryReadProc(void *,unsigned int,unsigned int,void *)")
}

// 0x1109e8 — __Z9_TellProcPv
// type: __int32 __fastcall(FILE *)
#[doc(alias = "_TellProc(void *)")]
#[doc(alias = "__Z9_TellProcPv")]
pub fn stub_0x1109e8() -> ! {
    todo!("0x1109e8 _TellProc(void *)")
}

// 0x1109f8 — __Z9_SeekProcPvli
// type: _DWORD __fastcall(void *, int, int)
#[doc(alias = "_SeekProc(void *,long,int)")]
#[doc(alias = "__Z9_SeekProcPvli")]
pub fn stub_0x1109f8() -> ! {
    todo!("0x1109f8 _SeekProc(void *,long,int)")
}
...
#[doc(alias = "__Z10_WriteProcPvjjS_")]
pub fn stub_0x110a08() -> ! {
    todo!("0x110a08 _WriteProc(void *,unsigned int,unsigned int,void *)")
}

// 0x110a18 — __Z9_ReadProcPvjjS_
// type: _DWORD __fastcall(void *, unsigned int, unsigned int, void *)
#[doc(alias = "_ReadProc(void *,unsigned int,unsigned int,void *)")]
#[doc(alias = "__Z9_ReadProcPvjjS_")]
pub fn stub_0x110a18() -> ! {
    todo!("0x110a18 _ReadProc(void *,unsigned int,unsigned int,void *)")
}
...
#[doc(alias = "__ZN10PluginListC2Ev")]
pub fn stub_0x110f98() -> ! {
    todo!("0x110f98 PluginList::PluginList(void)")
}
...
#[doc(alias = "__Z17FreeImage_stricmpPKcS0_")]
pub fn stub_0x110fc8() -> ! {
    todo!("0x110fc8 FreeImage_stricmp(char const*,char const*)")
}
...
#[doc(alias = "__ZN10PluginList18FindNodeFromFormatEPKc")]
pub fn stub_0x11100c() -> ! {
    todo!("0x11100c PluginList::FindNodeFromFormat(char const*)")
}
...
#[doc(alias = "__ZN10PluginList7AddNodeEPFvP6PluginiEPvPKcS6_S6_S6_")]
pub fn stub_0x111070() -> ! {
    todo!("0x111070 PluginList::AddNode(void (*)(Plugin *,int),void *,char const*,char const*,char const*,char const*)")
}
...
#[doc(alias = "__ZN10PluginList15FindNodeFromFIFEi")]
pub fn stub_0x1113f8() -> ! {
    todo!("0x1113f8 PluginList::FindNodeFromFIF(int)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE4findERS1_")]
pub fn stub_0x1118a0() -> ! {
    todo!("0x1118a0 std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::find(int const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE13_Rb_tree_implIS8_Lb0EEC2ERKSaISt13_Rb_tree_nodeIS4_EERKS8_")]
pub fn stub_0x1118fc() -> ! {
    todo!("0x1118fc std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::_Rb_tree_impl<std::less<int>,false>::_Rb_tree_impl(std::allocator<std::_Rb_tree_node<std::pair<int const,PluginNode *>>> const&,std::less<int> const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE11lower_boundERS1_")]
pub fn stub_0x11193c() -> ! {
    todo!("0x11193c std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::lower_bound(int const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE8_M_eraseEPSt13_Rb_tree_nodeIS4_E")]
pub fn stub_0x111970() -> ! {
    todo!("0x111970 std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::_M_erase(std::_Rb_tree_node<std::pair<int const,PluginNode *>> *)")
}
...
#[doc(alias = "__ZN9__gnu_cxx13new_allocatorISt13_Rb_tree_nodeISt4pairIKiP10PluginNodeEEE8allocateEmPKv")]
pub fn stub_0x1119ac() -> ! {
    todo!("0x1119ac __gnu_cxx::new_allocator<std::_Rb_tree_node<std::pair<int const,PluginNode *>>>::allocate(unsigned long,void const*)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE14_M_create_nodeERKS4_")]
pub fn stub_0x1119dc() -> ! {
    todo!("0x1119dc std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::_M_create_node(std::pair<int const,PluginNode *> const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE9_M_insertEPSt18_Rb_tree_node_baseSC_RKS4_")]
pub fn stub_0x111a0c() -> ! {
    todo!("0x111a0c std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<int const,PluginNode *> const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE16_M_insert_uniqueERKS4_")]
pub fn stub_0x111a90() -> ! {
    todo!("0x111a90 std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::_M_insert_unique(std::pair<int const,PluginNode *> const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiSt4pairIKiP10PluginNodeESt10_Select1stIS4_ESt4lessIiESaIS4_EE16_M_insert_uniqueESt17_Rb_tree_iteratorIS4_ERKS4_")]
pub fn stub_0x111b50() -> ! {
    todo!("0x111b50 std::_Rb_tree<int,std::pair<int const,PluginNode *>,std::_Select1st<std::pair<int const,PluginNode *>>,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<int const,PluginNode *>>,std::pair<int const,PluginNode *> const&)")
}
...
#[doc(alias = "__ZNSt3mapIiP10PluginNodeSt4lessIiESaISt4pairIKiS1_EEEixERS5_")]
pub fn stub_0x111c74() -> ! {
    todo!("0x111c74 std::map<int,PluginNode *,std::less<int>,std::allocator<std::pair<int const,PluginNode *>>>::operator[](int const&)")
}

// 0x111ce0 — __ZL16init_destinationP20jpeg_compress_struct
#[doc(alias = "init_destination(jpeg_compress_struct *)")]
#[doc(alias = "__ZL16init_destinationP20jpeg_compress_struct")]
pub fn stub_0x111ce0() -> ! {
    todo!("0x111ce0 init_destination(jpeg_compress_struct *)")
}

// 0x111d14 — __ZL11init_sourceP22jpeg_decompress_struct
#[doc(alias = "init_source(jpeg_decompress_struct *)")]
#[doc(alias = "__ZL11init_sourceP22jpeg_decompress_struct")]
pub fn stub_0x111d14() -> ! {
    todo!("0x111d14 init_source(jpeg_decompress_struct *)")
}

// 0x111d24 — __ZL11term_sourceP22jpeg_decompress_struct
#[doc(alias = "term_source(jpeg_decompress_struct *)")]
#[doc(alias = "__ZL11term_sourceP22jpeg_decompress_struct")]
pub fn stub_0x111d24() -> ! {
    todo!("0x111d24 term_source(jpeg_decompress_struct *)")
}
...
#[doc(alias = "__Z18jpeg_freeimage_srcP22jpeg_decompress_structPvP11FreeImageIO")]
pub fn stub_0x111d28() -> ! {
    todo!("0x111d28 jpeg_freeimage_src(jpeg_decompress_struct *,void *,FreeImageIO *)")
}
...
#[doc(alias = "__Z18jpeg_freeimage_dstP20jpeg_compress_structPvP11FreeImageIO")]
pub fn stub_0x111df4() -> ! {
    todo!("0x111df4 jpeg_freeimage_dst(jpeg_compress_struct *,void *,FreeImageIO *)")
}

// 0x111e68 — __ZL6Formatv
// type: _DWORD __fastcall()
#[doc(alias = "Format(void)")]
#[doc(alias = "__ZL6Formatv")]
