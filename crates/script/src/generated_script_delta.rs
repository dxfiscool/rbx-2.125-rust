...
pub fn stub_0xd60a00() -> ! {
    todo!("0xd60a00 Ogre::RenderSystem::_createRenderWindows(std::vector<Ogre::RenderWindowDescription,Ogre::STLAllocator<Ogre::RenderWindowDescription,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>> const&,std::vector&<Ogre::RenderWindow *,Ogre::STLAllocator<Ogre::RenderWindow,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>)")
}
...
pub fn stub_0xe7c3c0() -> ! {
    todo!("0xe7c3c0 Ogre::GLES2RenderSystem::getErrorDescription(long)const")
}