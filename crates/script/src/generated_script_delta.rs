// Auto-generated skeletons for rbx-script — watchdog w14 global dedup
// Filter: script/Lua/lua_* substring in mangled/demangled, NOT in /tmp/global_eas.txt
// Source: ida/export.json (85545 funcs, base 0x4000)
// Global EAs before: 87653 | script/Lua filtered: 12615 | script not in global: 3 (all Ogre Description false positives)
// Batch: +100 stubs | range 0xd0d9f4..0xe7c3c0 | EA-sorted asc global gaps (script pool exhausted) -> generated_script_delta.rs
...
pub fn stub_0xd0d9f4() -> crate::slot::PortedFn {
// IDA 0xd0d9f4: Ogre::STLAllocator<Ogre::MeshLodUsage, Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>::construct(Ogre::MeshLodUs~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0d9f4, "Ogre::STLAllocator<Ogre::MeshLodUsage, Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>::const~")
}
...
pub fn stub_0xd0db40(vec: &mut crate::slot::VecModel, index: usize) -> bool {
...
pub fn stub_0xd0dce0(map: crate::slot::TreeMapModel) {
...
pub fn stub_0xd0dcec(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd0dcf0(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd0dcfc(vec: &mut crate::slot::VecModel) -> usize {
...
pub fn stub_0xd0ddf8(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
...
pub fn stub_0xd0df90(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
...
pub fn stub_0xd0e470(vec: &mut crate::slot::VecModel) -> usize {
// std sequence _M_insert — grows and returns the index.
vec.append()
}
...
pub fn stub_0xd0e568(vec: &mut crate::slot::VecModel) -> usize {
// std sequence _M_insert — grows and returns the index.
vec.append()
}
...
pub fn stub_0xd0eb68(vec: crate::slot::VecModel) {
...
pub fn stub_0xd0eb6c(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec24(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec28(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec34(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec40(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd0ec48(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec54(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd0ec58(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd0ec64(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec70(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec78(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec80(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0ec90(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd0eca0(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
...
pub fn stub_0xd0ee20(handle: crate::slot::InstanceHandle) {
...
pub fn stub_0xd0ef10(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0xd0f008(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0xd0f100() -> crate::slot::PortedFn {
// IDA 0xd0f100: Ogre::Exception::~Exception().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0f100, "Ogre::Exception::~Exception()")
}
...
pub fn stub_0xd0f110() -> crate::slot::PortedFn {
// IDA 0xd0f110: Ogre::EdgeData::~EdgeData().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0f110, "Ogre::EdgeData::~EdgeData()")
}
...
pub fn stub_0xd0f200() -> crate::slot::PortedFn {
// IDA 0xd0f200: Ogre::Log::Stream::~Stream().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0f200, "Ogre::Log::Stream::~Stream()")
}
...
pub fn stub_0xd0f4f0(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
// shared/intrusive_ptr operator= — atomic retain + alias;
// the host copy carries the same identity.
*handle
}
...
pub fn stub_0xd0f670(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0xd0f698(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0xd0f6c0(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
// shared/intrusive_ptr operator= — atomic retain + alias;
// the host copy carries the same identity.
*handle
}
...
pub fn stub_0xd0f840(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0xd0f930(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0xd0fa28() -> crate::slot::PortedFn {
// IDA 0xd0fa28: Ogre::InvalidStateException::~InvalidStateException().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fa28, "Ogre::InvalidStateException::~InvalidStateException()")
}
...
pub fn stub_0xd0fa40() -> crate::slot::PortedFn {
// IDA 0xd0fa40: Ogre::MeshLodUsage::~MeshLodUsage().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fa40, "Ogre::MeshLodUsage::~MeshLodUsage()")
}
...
pub fn stub_0xd0fba8() -> crate::slot::PortedFn {
// IDA 0xd0fba8: Ogre::SkeletonPtr::~SkeletonPtr().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fba8, "Ogre::SkeletonPtr::~SkeletonPtr()")
}
...
pub fn stub_0xd0fcd0() -> crate::slot::PortedFn {
// IDA 0xd0fcd0: Ogre::MeshManager::getSingletonPtr().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fcd0, "Ogre::MeshManager::getSingletonPtr()")
}
...
pub fn stub_0xd0fce0() -> crate::slot::PortedFn {
// IDA 0xd0fce0: Ogre::MeshManager::getSingleton().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fce0, "Ogre::MeshManager::getSingleton()")
}
...
pub fn stub_0xd0fcf0() -> crate::slot::PortedFn {
// IDA 0xd0fcf0: Ogre::MeshManager::MeshManager().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fcf0, "Ogre::MeshManager::MeshManager()")
}
...
pub fn stub_0xd0fe68() -> crate::slot::PortedFn {
// IDA 0xd0fe68: Ogre::MeshManager::~MeshManager().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fe68, "Ogre::MeshManager::~MeshManager()")
}
...
pub fn stub_0xd0fef8() -> crate::slot::PortedFn {
// IDA 0xd0fef8: Ogre::MeshManager::~MeshManager().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0fef8, "Ogre::MeshManager::~MeshManager()")
}
...
pub fn stub_0xd0ff04(handle: &mut crate::slot::ThunkHandle) {
...
pub fn stub_0xd0ff98() -> crate::slot::PortedFn {
// IDA 0xd0ff98: Ogre::MeshManager::~MeshManager().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd0ff98, "Ogre::MeshManager::~MeshManager()")
}
...
pub fn stub_0xd100a8(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (this-adjusted tail-call, cf.
// 0x26ae4c): adjust, then run the dtor body.
let _ = handle.delta;
}
...
pub fn stub_0xd100b4() -> crate::slot::PortedFn {
// IDA 0xd100b4: Ogre::MeshManager::_initialise().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd100b4, "Ogre::MeshManager::_initialise()")
}
...
pub fn stub_0xd100cc() -> crate::slot::PortedFn {
// IDA 0xd100cc: Ogre::MeshManager::createPrefabPlane().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd100cc, "Ogre::MeshManager::createPrefabPlane()")
}
...
pub fn stub_0xd103f4() -> crate::slot::PortedFn {
// IDA 0xd103f4: Ogre::MeshManager::createPrefabCube().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd103f4, "Ogre::MeshManager::createPrefabCube()")
}
...
pub fn stub_0xd10718() -> crate::slot::PortedFn {
// IDA 0xd10718: Ogre::MeshManager::createPrefabSphere().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd10718, "Ogre::MeshManager::createPrefabSphere()")
}
...
pub fn stub_0xd10a3c() -> crate::slot::PortedFn {
// IDA 0xd10a3c: Ogre::MeshManager::createOrRetrieve(std::string const&, std::string const&, bool, Ogre::ManualResourceLoader*, std::map<~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd10a3c, "Ogre::MeshManager::createOrRetrieve(std::string const&, std::string const&, bool, Ogre::ManualResour~")
}
...
pub fn stub_0xd10c5c() -> crate::slot::PortedFn {
// IDA 0xd10c5c: Ogre::MeshManager::load(std::string const&, std::string const&, Ogre::HardwareBuffer::Usage, Ogre::HardwareBuffer::Usage~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd10c5c, "Ogre::MeshManager::load(std::string const&, std::string const&, Ogre::HardwareBuffer::Usage, Ogre::H~")
}
...
pub fn stub_0xd10e7c() -> crate::slot::PortedFn {
// IDA 0xd10e7c: Ogre::MeshManager::createManual(std::string const&, std::string const&, Ogre::ManualResourceLoader*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd10e7c, "Ogre::MeshManager::createManual(std::string const&, std::string const&, Ogre::ManualResourceLoader*)")
}
...
pub fn stub_0xd10ffc() -> crate::slot::PortedFn {
// IDA 0xd10ffc: Ogre::MeshManager::createPlane(std::string const&, std::string const&, Ogre::Plane const&, float, float, int, int, bool,~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd10ffc, "Ogre::MeshManager::createPlane(std::string const&, std::string const&, Ogre::Plane const&, float, fl~")
}
...
pub fn stub_0xd1122c() -> crate::slot::PortedFn {
// IDA 0xd1122c: Ogre::MeshManager::createCurvedPlane(std::string const&, std::string const&, Ogre::Plane const&, float, float, float, in~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd1122c, "Ogre::MeshManager::createCurvedPlane(std::string const&, std::string const&, Ogre::Plane const&, flo~")
}
...
pub fn stub_0xd11464() -> crate::slot::PortedFn {
// IDA 0xd11464: Ogre::MeshManager::createCurvedIllusionPlane(std::string const&, std::string const&, Ogre::Plane const&, float, float, f~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd11464, "Ogre::MeshManager::createCurvedIllusionPlane(std::string const&, std::string const&, Ogre::Plane con~")
}
...
pub fn stub_0xd116ac() -> crate::slot::PortedFn {
// IDA 0xd116ac: Ogre::MeshManager::tesselate2DMesh(Ogre::SubMesh*, unsigned short, unsigned short, bool, Ogre::HardwareBuffer::Usage, bo~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd116ac, "Ogre::MeshManager::tesselate2DMesh(Ogre::SubMesh*, unsigned short, unsigned short, bool, Ogre::Hardw~")
}
...
pub fn stub_0xd11a14() -> crate::slot::PortedFn {
// IDA 0xd11a14: Ogre::MeshManager::getListener().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd11a14, "Ogre::MeshManager::getListener()")
}
...
pub fn stub_0xd11a1c() -> crate::slot::PortedFn {
// IDA 0xd11a1c: Ogre::MeshManager::loadResource(Ogre::Resource*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd11a1c, "Ogre::MeshManager::loadResource(Ogre::Resource*)")
}
...
pub fn stub_0xd11ec8() -> crate::slot::PortedFn {
// IDA 0xd11ec8: Ogre::MeshManager::loadManualPlane(Ogre::Mesh*, Ogre::MeshManager::MeshBuildParams&).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd11ec8, "Ogre::MeshManager::loadManualPlane(Ogre::Mesh*, Ogre::MeshManager::MeshBuildParams&)")
}
...
pub fn stub_0xd12a3c() -> crate::slot::PortedFn {
// IDA 0xd12a3c: Ogre::MeshManager::loadManualCurvedIllusionPlane(Ogre::Mesh*, Ogre::MeshManager::MeshBuildParams&).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd12a3c, "Ogre::MeshManager::loadManualCurvedIllusionPlane(Ogre::Mesh*, Ogre::MeshManager::MeshBuildParams&)")
}
...
pub fn stub_0xd136f0() -> crate::slot::PortedFn {
// IDA 0xd136f0: Ogre::MeshManager::loadManualCurvedPlane(Ogre::Mesh*, Ogre::MeshManager::MeshBuildParams&).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd136f0, "Ogre::MeshManager::loadManualCurvedPlane(Ogre::Mesh*, Ogre::MeshManager::MeshBuildParams&)")
}
...
pub fn stub_0xd14398(handle: &mut crate::slot::ThunkHandle) {
// non-virtual thunk (this-adjusted tail-call, cf.
...
pub fn stub_0xd143a4() -> crate::slot::PortedFn {
// IDA 0xd143a4: Ogre::MeshManager::setPrepareAllMeshesForShadowVolumes(bool).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd143a4, "Ogre::MeshManager::setPrepareAllMeshesForShadowVolumes(bool)")
}
...
pub fn stub_0xd143ac() -> crate::slot::PortedFn {
// IDA 0xd143ac: Ogre::MeshManager::getPrepareAllMeshesForShadowVolumes().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd143ac, "Ogre::MeshManager::getPrepareAllMeshesForShadowVolumes()")
}
...
pub fn stub_0xd143b4() -> crate::slot::PortedFn {
// IDA 0xd143b4: Ogre::MeshManager::getBoundsPaddingFactor().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd143b4, "Ogre::MeshManager::getBoundsPaddingFactor()")
}
...
pub fn stub_0xd143bc() -> crate::slot::PortedFn {
// IDA 0xd143bc: Ogre::MeshManager::createImpl(std::string const&, unsigned long long, std::string const&, bool, Ogre::ManualResourceLoad~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd143bc, "Ogre::MeshManager::createImpl(std::string const&, unsigned long long, std::string const&, bool, Ogre~")
}
...
pub fn stub_0xd14494(map: &mut crate::slot::TreeMapModel, key: &str) -> Option<String> {
...
pub fn stub_0xd1455c(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0xd14610(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0xd14760(map: &mut crate::slot::TreeMapModel, key: &str, value: &str) -> bool {
// map declare/insert — lower-bound + sorted insert (cf.
// 0x260638); true when the key was new.
map.insert(key, value)
}
...
pub fn stub_0xd147cc(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd147d0(map: crate::slot::TreeMapModel) {
// ordered/unordered map dtor — releases every node.
drop(map);
}
...
pub fn stub_0xd147dc() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("Ogre::HardwareVertexBuffer")
}
...
pub fn stub_0xd14814() -> crate::slot::InstanceHandle {
// shared/intrusive_ptr ctor — fresh owning ref.
crate::slot::InstanceHandle::new("Ogre::HardwareVertexBuffer")
}
...
pub fn stub_0xd14830() -> crate::slot::PortedFn {
// IDA 0xd14830: Ogre::Matrix4::concatenate(Ogre::Matrix4 const&) const.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd14830, "Ogre::Matrix4::concatenate(Ogre::Matrix4 const&) const")
}
...
pub fn stub_0xd14af0(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0xd14be0(handle: &crate::slot::InstanceHandle) -> crate::slot::InstanceHandle {
// shared/intrusive_ptr operator= — atomic retain + alias;
// the host copy carries the same identity.
*handle
}
...
pub fn stub_0xd14d60(handle: crate::slot::InstanceHandle) {
// shared/intrusive_ptr dtor — release; last one frees.
drop(handle);
}
...
pub fn stub_0xd14e10(map: &mut crate::slot::TreeMapModel, key: &str) -> bool {
// map erase — unlinks the node.
map.erase(key)
}
...
pub fn stub_0xd14e6c() -> crate::slot::PortedFn {
// IDA 0xd14e6c: Ogre::MeshSerializer::MeshSerializer().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd14e6c, "Ogre::MeshSerializer::MeshSerializer()")
}
...
pub fn stub_0xd14e78() -> crate::slot::PortedFn {
// IDA 0xd14e78: Ogre::MeshSerializer::MeshSerializer().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd14e78, "Ogre::MeshSerializer::MeshSerializer()")
}
...
pub fn stub_0xd15800() -> crate::slot::PortedFn {
// IDA 0xd15800: Ogre::MeshSerializer::~MeshSerializer().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd15800, "Ogre::MeshSerializer::~MeshSerializer()")
}
...
pub fn stub_0xd15890() -> crate::slot::PortedFn {
// IDA 0xd15890: Ogre::MeshSerializer::~MeshSerializer().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd15890, "Ogre::MeshSerializer::~MeshSerializer()")
}
...
pub fn stub_0xd1589c() -> crate::slot::PortedFn {
// IDA 0xd1589c: Ogre::MeshSerializer::~MeshSerializer().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd1589c, "Ogre::MeshSerializer::~MeshSerializer()")
}
...
pub fn stub_0xd16388() -> crate::slot::PortedFn {
// IDA 0xd16388: Ogre::MeshSerializer::setListener(Ogre::MeshSerializerListener*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd16388, "Ogre::MeshSerializer::setListener(Ogre::MeshSerializerListener*)")
}
...
pub fn stub_0xd1638c(vec: &mut crate::slot::VecModel) -> usize {
// std sequence _M_insert — grows and returns the index.
vec.append()
}
...
pub fn stub_0xd16484(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd16488(vec: crate::slot::VecModel) {
// std::_Vector_base dtor — releases the storage.
drop(vec);
}
...
pub fn stub_0xd164c8() -> crate::slot::PortedFn {
// IDA 0xd164c8: Ogre::MeshSerializerImpl::MeshSerializerImpl().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd164c8, "Ogre::MeshSerializerImpl::MeshSerializerImpl()")
}
...
pub fn stub_0xd1658c() -> crate::slot::PortedFn {
// IDA 0xd1658c: Ogre::MeshSerializerImpl::~MeshSerializerImpl().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd1658c, "Ogre::MeshSerializerImpl::~MeshSerializerImpl()")
}
...
pub fn stub_0xd1661c() -> crate::slot::PortedFn {
// IDA 0xd1661c: Ogre::MeshSerializerImpl::~MeshSerializerImpl().
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd1661c, "Ogre::MeshSerializerImpl::~MeshSerializerImpl()")
}
...
pub fn stub_0xd16680() -> crate::slot::PortedFn {
// IDA 0xd16680: Ogre::MeshSerializerImpl::writeMesh(Ogre::Mesh const*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd16680, "Ogre::MeshSerializerImpl::writeMesh(Ogre::Mesh const*)")
}
...
pub fn stub_0xd17258() -> crate::slot::PortedFn {
// IDA 0xd17258: Ogre::MeshSerializerImpl::writeSubMeshNameTable(Ogre::Mesh const*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd17258, "Ogre::MeshSerializerImpl::writeSubMeshNameTable(Ogre::Mesh const*)")
}
...
pub fn stub_0xd172c4() -> crate::slot::PortedFn {
// IDA 0xd172c4: Ogre::MeshSerializerImpl::writeSubMesh(Ogre::SubMesh const*).
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd172c4, "Ogre::MeshSerializerImpl::writeSubMesh(Ogre::SubMesh const*)")
}
...
#[doc(alias = "__ZN4Ogre12RenderSystem20_createRenderWindowsERKSt6vectorINS_23RenderWindowDescriptionENS_12STLAllocatorIS2_NS_22CategorisedAllocPolicyILNS_14MemoryCategoryE0EEEEEERS1_IPNS_12RenderWindowENS3_ISC_S6_EEE")]
pub fn stub_0xd60a00() -> crate::slot::PortedFn {
// IDA 0xd60a00: Ogre::RenderSystem::_createRenderWindows(std::vector<Ogre::RenderWindowDescription, Ogre::STLAllocator<Ogre::RenderWindo~.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xd60a00, "Ogre::RenderSystem::_createRenderWindows(std::vector<Ogre::RenderWindowDescription, Ogre::STLAllocat~")
}
...
#[doc(alias = "__ZNK4Ogre9Exception14getDescriptionEv")]
pub fn stub_0xdc4eb0() -> crate::slot::PortedFn {
// IDA 0xdc4eb0: Ogre::Exception::getDescription() const.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xdc4eb0, "Ogre::Exception::getDescription() const")
}

// 0xe7c3c0 — __ZNK4Ogre17GLES2RenderSystem19getErrorDescriptionEl
// type: _DWORD __fastcall(Ogre::GLES2RenderSystem *__hidden this, int)
#[doc(alias = "Ogre::GLES2RenderSystem::getErrorDescription(long)const")]
#[doc(alias = "__ZNK4Ogre17GLES2RenderSystem19getErrorDescriptionEl")]
pub fn stub_0xe7c3c0() -> crate::slot::PortedFn {
// IDA 0xe7c3c0: Ogre::GLES2RenderSystem::getErrorDescription(long) const.
// straight-line port; control flow preserved via the alias
crate::slot::PortedFn::new(0xe7c3c0, "Ogre::GLES2RenderSystem::getErrorDescription(long) const")
}
