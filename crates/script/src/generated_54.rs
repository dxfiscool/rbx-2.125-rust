...
pub fn stub_0x4ff388() -> ! {
    todo!("0x4ff388 rbx_core::SharedPtr<RBX::ProfanityFilter>::shared_ptr<RBX::ProfanityFilter>(RBX::ProfanityFilter *)")
}
...
pub fn stub_0x4ff45c() -> ! {
    todo!("0x4ff45c boost::detail::shared_count::shared_count<RBX::ProfanityFilter>(RBX::ProfanityFilter *)")
}
...
pub fn stub_0x4ff568() -> ! {
    todo!("0x4ff568 boost::detail::sp_counted_impl_p<RBX::ProfanityFilter>::~sp_counted_impl_p()")
}
...
pub fn stub_0x4ff570() -> ! {
    todo!("0x4ff570 boost::detail::sp_counted_impl_p<RBX::ProfanityFilter>::dispose(void)")
}
...
pub fn stub_0x4ff614() -> ! {
    todo!("0x4ff614 boost::detail::sp_counted_impl_p<RBX::ProfanityFilter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_0x4ff618() -> ! {
    todo!("0x4ff618 boost::detail::sp_counted_impl_p<RBX::ProfanityFilter>::get_untyped_deleter(void)")
}
...
pub fn stub_0x4ff61c() -> ! {
    todo!("0x4ff61c rbx_core::SharedPtr<RBX::ProfanityFilter>::shared_ptr<RBX::ProfanityFilter>(rbx_core::Weak<RBX::ProfanityFilter> const&,boost::detail::sp_nothrow_tag)")
}
...
pub fn stub_0x4ff698() -> ! {
    todo!("0x4ff698 RBX::ScopedSingleton<RBX::ProfanityFilter>::safe_static_init_s_instance(void)")
}
...
pub fn stub_0x4ff69c() -> ! {
    todo!("0x4ff69c RBX::ScopedSingleton<RBX::ProfanityFilter>::safe_static_do_get_s_instance(void)")
}

// 0x4ff700 — __ZN5boost8weak_ptrIN3RBX15ProfanityFilterEED1Ev
#[doc(alias = "rbx_core::Weak<RBX::ProfanityFilter>::~weak_ptr()")]
pub fn stub_0x4ff700() -> ! {
    todo!("0x4ff700 rbx_core::Weak<RBX::ProfanityFilter>::~weak_ptr()")
}
...
pub fn stub_0x4ff714() -> ! {
    todo!("0x4ff714 RBX::ScopedSingleton<RBX::ProfanityFilter>::safe_static_init_sync(void)")
}
...
pub fn stub_0x4ff718() -> ! {
    todo!("0x4ff718 RBX::ScopedSingleton<RBX::ProfanityFilter>::safe_static_do_get_sync(void)")
}

// 0x4ff808 — __ZN3RBX5mutexD1Ev
// type: void __fastcall(RBX::mutex *__hidden this)
#[doc(alias = "RBX::mutex::~mutex()")]
pub fn stub_0x4ff808() -> ! {
    todo!("0x4ff808 RBX::mutex::~mutex()")
}
...
pub fn stub_0x4ff818() -> ! {
    todo!("0x4ff818 boost::singleton_pool<RBX::POLY::BlockMesh,36u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::get_pool(void)")
}

// 0x4ff9dc — __ZN3RBX8NullVerbD1Ev
// type: void __fastcall(RBX::NullVerb *__hidden this)
#[doc(alias = "RBX::NullVerb::~NullVerb()")]
pub fn stub_0x4ff9dc() -> ! {
    todo!("0x4ff9dc RBX::NullVerb::~NullVerb()")
}
