...
pub fn stub_0x2ca7c() {
    // IDA 0x2ca7c: bind thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2cb64() {
    // IDA 0x2cb64: bind thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2cc54() {
    // IDA 0x2cc54: bind thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2cd44() {
    // IDA 0x2cd44: bind thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2ce2c() {
    // IDA 0x2ce2c: bind thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2d280() {
    // IDA 0x2d280: bind thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2d370() {
    // IDA 0x2d370: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2d458() {
    // IDA 0x2d458: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2d544() {
    // IDA 0x2d544: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2d644() {
    // IDA 0x2d644: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2d660() {
    // IDA 0x2d660: invoker thunk; dispatches a stored closure — carrier no-op.
}
...
pub fn stub_0x2d67c() {
    // IDA 0x2d67c: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2d768() {
    // IDA 0x2d768: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2d884() {
    // IDA 0x2d884: bind argument-list dispatch; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2d964() {
    // IDA 0x2d964: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2da9c() {
    // IDA 0x2da9c: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2db54() {
    // IDA 0x2db54: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2dc24() {
    // IDA 0x2dc24: thread-spawn plumbing; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x2dfac() {
    // IDA 0x2dfac: thread-data lifecycle; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x2e0f4() {
    // IDA 0x2e0f4: thread-data lifecycle; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x2e1bc() {
    // IDA 0x2e1bc: thread-data lifecycle; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x2e284() {
    // IDA 0x2e284: thread-data run forwards to the bound call; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x2e2a0() {
    // IDA 0x2e2a0: bind argument-list dispatch; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2e518() {
    // IDA 0x2e518: accept_owner thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e5ec() {
    // IDA 0x2e5ec: shared_count ctor thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e6e0() {
    // IDA 0x2e6e0: sp_counted dtor thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e6e4() {
    // IDA 0x2e6e4: sp_counted dtor thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e6e8() {
    // IDA 0x2e6e8: sp_counted dispose thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e6f8() {
    // IDA 0x2e6f8: sp_counted get_deleter thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e6fc() {
    // IDA 0x2e6fc: sp_counted get_untyped_deleter thunk; refcount owned by SharedPtr (Arc) — carrier no-op.
}
...
pub fn stub_0x2e700() {
    // IDA 0x2e700: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2e970() {
    // IDA 0x2e970: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2ebbc() {
    // IDA 0x2ebbc: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2edec() {
    // IDA 0x2edec: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2efb4() {
    // IDA 0x2efb4: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2f1d8() {
    // IDA 0x2f1d8: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2f2d0() {
    // IDA 0x2f2d0: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2f2ec() {
    // IDA 0x2f2ec: invoker thunk; dispatches a stored closure — carrier no-op.
}
...
pub fn stub_0x2f300() {
    // IDA 0x2f300: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable0<void>::assign_to<boost::_bi::bind_t<void,void (*)(int,rbx_core::SharedPtr<RBX::Game>),boost::_bi::list2<boost::_bi::value<int>,boost::_bi::value<rbx_core::SharedPtr<RBX::Game>>>>>(boost::_bi::bind_t<void,void (*)(int,rbx_core::SharedPtr<RBX::Game>),boost::_bi::list2<boost::_bi::value<int>,boost::_bi::value<rbx_core::SharedPtr<RBX::Game>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_0x2f3e8() {
    // IDA 0x2f3e8: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2f4fc() {
    // IDA 0x2f4fc: bind argument-list dispatch; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2f5d4() {
    // IDA 0x2f5d4: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2f708() {
    // IDA 0x2f708: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2f8bc() {
    // IDA 0x2f8bc: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x2f9bc() {
    // IDA 0x2f9bc: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2f9d8() {
    // IDA 0x2f9d8: invoker thunk; dispatches a stored closure — carrier no-op.
}
...
pub fn stub_0x2f9ec() {
    // IDA 0x2f9ec: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable0<void>::assign_to<boost::_bi::bind_t<void,void (*)(int,rbx_core::SharedPtr<RBX::Game>,JoinGameRequest),boost::_bi::list3<boost::_bi::value<int>,boost::_bi::value<rbx_core::SharedPtr<RBX::Game>>,boost::_bi::value<JoinGameRequest>>>>(boost::_bi::bind_t<void,void (*)(int,rbx_core::SharedPtr<RBX::Game>,JoinGameRequest),boost::_bi::list3<boost::_bi::value<int>,boost::_bi::value<rbx_core::SharedPtr<RBX::Game>>,boost::_bi::value<JoinGameRequest>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_0x2fad8() {
    // IDA 0x2fad8: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2fbf4() {
    // IDA 0x2fbf4: bind argument-list dispatch; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2fcd4() {
    // IDA 0x2fcd4: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x2fe0c() {
    // IDA 0x2fe0c: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x2fec4() {
    // IDA 0x2fec4: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x30080() {
    // IDA 0x30080: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}
...
pub fn stub_0x3017c() {
    // IDA 0x3017c: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x30198() {
    // IDA 0x30198: invoker thunk; dispatches a stored closure — carrier no-op.
}
...
pub fn stub_0x301ac() {
    // IDA 0x301ac: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable0<void>::assign_to<boost::_bi::bind_t<void,void (*)(int,std::string const&,rbx_core::SharedPtr<RBX::Game>),boost::_bi::list3<boost::_bi::value<int>,boost::_bi::value<char const*>,boost::_bi::value<rbx_core::SharedPtr<RBX::Game>>>>>(boost::_bi::bind_t<void,void (*)(int,std::string const&,rbx_core::SharedPtr<RBX::Game>),boost::_bi::list3<boost::_bi::value<int>,boost::_bi::value<char const*>,boost::_bi::value<rbx_core::SharedPtr<RBX::Game>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_0x30298() {
    // IDA 0x30298: vtable assign thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x303b8() {
    // IDA 0x303b8: bind argument-list dispatch; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x30534() {
    // IDA 0x30534: functor_manager thunk; closure buffer ops fold into Box<dyn Fn> — carrier no-op.
}
...
pub fn stub_0x3066c() {
    // IDA 0x3066c: bind argument-list plumbing; captures fold into closures — carrier no-op.
}
...
pub fn stub_0x3073c() {
    // IDA 0x3073c: thread-spawn plumbing; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x30878() {
    // IDA 0x30878: thread-data lifecycle; std::thread covers it — carrier no-op.
}
...
pub fn stub_0x30a24() {
    // IDA 0x30a24: function-bind ctor/assign thunk; binds are plain closures — carrier no-op.
}

#[cfg(test)]
mod bind_plumbing_tests {
    use super::*;
