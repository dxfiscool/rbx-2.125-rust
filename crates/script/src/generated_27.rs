// Auto-generated skeletons for rbx-script — filler EA-sorted after 0x139e0 (next 120) [circular refill]
// Filter: Lua|Script|Yield (case-sensitive) -> 4456 funcs, all already stubbed globally (0 remaining)
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: +120 stubs | range 0x21c804..0x22f154 | existing 7651 -> 7771 total (filler circular from 0x139e0)
