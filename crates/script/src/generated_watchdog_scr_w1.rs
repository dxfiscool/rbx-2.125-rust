//! script generated_watchdog_scr_w1 — 40 stubs EA-sorted asc gap filler not yet in script (fallback: global gaps exhausted, per-crate gap)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 40 not in script | rbx_core::SharedPtr not boost
//! Range 0x84e0..0xb340 | per-crate distinct, cross-crate duplicates allowed
...
// 0x84e0 — start — void __fastcall __noreturn(int, int, int, int, int argc, char *argv)
#[doc(alias = "start")]
pub fn stub_84e0() -> ! {
    todo!("0x84e0 start")
}

// 0x850c — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings9AASamplesEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::AASamples>::EnumDesc(void) — int __fastcall(int)
...
// 0x86d0 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings12GraphicsModeEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::GraphicsMode>::EnumDesc(void) — int __fastcall(int)
...
// 0x88c4 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings20FrameRateManagerModeEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::FrameRateManagerMode>::EnumDesc(void) — int __fastcall(int)
...
// 0x8a88 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings16AntialiasingModeEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::AntialiasingMode>::EnumDesc(void) — int __fastcall(int)
...
// 0x8c4c — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings10ShadowModeEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::ShadowMode>::EnumDesc(void) — int __fastcall(int)
...
// 0x8e24 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings12QualityLevelEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::QualityLevel>::EnumDesc(void) — RBX::Reflection::EnumDescriptor *__fastcall(RBX::Reflection::EnumDescriptor *)
...
// 0x9100 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings16ResolutionPresetEEC2Ev — RBX::Reflection::EnumDesc<RBX::CRenderSettings::ResolutionPreset>::EnumDesc(void) — RBX::Reflection::EnumDescriptor *__fastcall(RBX::Reflection::EnumDescriptor *)
...
// 0x9608 — __ZN19CRenderSettingsItem15setGraphicsModeEN3RBX15CRenderSettings12GraphicsModeE — CRenderSettingsItem::setGraphicsMode(RBX::CRenderSettings::GraphicsMode) — int __fastcall(int result, int)
...
// 0x9628 — __ZN19CRenderSettingsItem23setFrameRateManagerModeEN3RBX15CRenderSettings20FrameRateManagerModeE — CRenderSettingsItem::setFrameRateManagerMode(RBX::CRenderSettings::FrameRateManagerMode) — int __fastcall(int result, int)
...
// 0x9648 — __ZN19CRenderSettingsItem15setQualityLevelEN3RBX15CRenderSettings12QualityLevelE — CRenderSettingsItem::setQualityLevel(RBX::CRenderSettings::QualityLevel) — int __fastcall(int result, int)
...
// 0x9668 — __ZN19CRenderSettingsItem23setAlwaysDrawConnectorsEb — CRenderSettingsItem::setAlwaysDrawConnectors(bool) — int __fastcall(int this, int)
...
// 0x96ac — __ZN19CRenderSettingsItem18setShowAggregationEb — CRenderSettingsItem::setShowAggregation(bool) — int __fastcall(int this, int)
...
// 0x96d0 — __ZN19CRenderSettingsItem12setAASamplesEN3RBX15CRenderSettings9AASamplesE — CRenderSettingsItem::setAASamples(RBX::CRenderSettings::AASamples) — int __fastcall(int result, int)
...
// 0x96fc — __ZN19CRenderSettingsItem13setShadowModeEN3RBX15CRenderSettings10ShadowModeE — CRenderSettingsItem::setShadowMode(RBX::CRenderSettings::ShadowMode) — int __fastcall(int result, int)
...
// 0x971c — __ZN19CRenderSettingsItem19setAntialiasingModeEN3RBX15CRenderSettings16AntialiasingModeE — CRenderSettingsItem::setAntialiasingMode(RBX::CRenderSettings::AntialiasingMode) — int __fastcall(int result, int)
...
// 0x973c — __ZN19CRenderSettingsItem25setDebugShowBoundingBoxesEb — CRenderSettingsItem::setDebugShowBoundingBoxes(bool) — int __fastcall(int this, int)
...
// 0x9760 — __ZN19CRenderSettingsItem12setEnableFRMEb — CRenderSettingsItem::setEnableFRM(bool) — int __fastcall(int this, int)
...
// 0x9784 — __ZNK19CRenderSettingsItem28getDebugDisableInterpolationEv — CRenderSettingsItem::getDebugDisableInterpolation(void)const — int __fastcall(CRenderSettingsItem *this)
...
// 0x9794 — __ZN19CRenderSettingsItem28setDebugDisableInterpolationEb — CRenderSettingsItem::setDebugDisableInterpolation(bool) — char *__fastcall(CRenderSettingsItem *this, char)
...
// 0x97a4 — __ZN19CRenderSettingsItem23setResolutionPreferenceEN3RBX15CRenderSettings16ResolutionPresetE — CRenderSettingsItem::setResolutionPreference(RBX::CRenderSettings::ResolutionPreset) — int __fastcall(int result, int)
...
// 0x97c0 — __ZN19CRenderSettingsItem19setTextureCacheSizeEj — CRenderSettingsItem::setTextureCacheSize(unsigned int) — int __fastcall(int this, unsigned int)
...
// 0x97c8 — __ZN19CRenderSettingsItem16setMeshCacheSizeEj — CRenderSettingsItem::setMeshCacheSize(unsigned int) — int __fastcall(int this, unsigned int)
...
// 0x97d0 — __ZN19CRenderSettingsItemC2Ev — CRenderSettingsItem::CRenderSettingsItem(void) — void __fastcall(CRenderSettingsItem *this)
...
// 0x9ac8 — __ZN19CRenderSettingsItem19setAutoQualityLevelEi — CRenderSettingsItem::setAutoQualityLevel(int) — int __fastcall(int this, int)
...
// 0x9b08 — __ZN19CRenderSettingsItem21setEagerBulkExecutionEb — CRenderSettingsItem::setEagerBulkExecution(bool) — int __fastcall(int this, int)
...
// 0x9b2c — __ZNSt12length_errorD1Ev — std::length_error::~length_error() — void __cdecl(std::length_error *__hidden this)
...
// 0x9b30 — __ZNSt12out_of_rangeD0Ev — std::out_of_range::~out_of_range() — void __cdecl(std::out_of_range *__hidden this)
...
// 0x9b44 — __ZNSt12out_of_rangeD2Ev — std::out_of_range::~out_of_range() — void __cdecl(std::out_of_range *__hidden this)
#[doc(alias = "std::out_of_range::~out_of_range()")]
...
// 0x9b48 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings9AASamplesEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::AASamples>::addPair(RBX::CRenderSettings::AASamples,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0x9ea8 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings12GraphicsModeEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::GraphicsMode>::addPair(RBX::CRenderSettings::GraphicsMode,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0xa208 — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings12GraphicsModeEE9addLegacyEiPKcS3_ — RBX::Reflection::EnumDesc<RBX::CRenderSettings::GraphicsMode>::addLegacy(int,char const*,RBX::CRenderSettings::GraphicsMode) — _DWORD *__fastcall(int, unsigned int, int, int)
...
// 0xa25c — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings20FrameRateManagerModeEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::FrameRateManagerMode>::addPair(RBX::CRenderSettings::FrameRateManagerMode,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0xa5bc — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings16AntialiasingModeEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::AntialiasingMode>::addPair(RBX::CRenderSettings::AntialiasingMode,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0xa91c — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings10ShadowModeEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::ShadowMode>::addPair(RBX::CRenderSettings::ShadowMode,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0xac7c — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings12QualityLevelEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::QualityLevel>::addPair(RBX::CRenderSettings::QualityLevel,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0xafdc — __ZN3RBX10Reflection8EnumDescINS_15CRenderSettings16ResolutionPresetEE7addPairES3_PKc — RBX::Reflection::EnumDesc<RBX::CRenderSettings::ResolutionPreset>::addPair(RBX::CRenderSettings::ResolutionPreset,char const*) — void __fastcall(_DWORD *, int, const char *)
...
// 0xb33c — __ZNK3RBX15CRenderSettings15getGraphicsModeEv — RBX::CRenderSettings::getGraphicsMode(void)const — int __fastcall(RBX::CRenderSettings *this)
...
// 0xb340 — __ZN3RBX10Reflection18EnumPropDescriptorI19CRenderSettingsItemNS_15CRenderSettings12GraphicsModeEED1Ev — RBX::Reflection::EnumPropDescriptor<CRenderSettingsItem,RBX::CRenderSettings::GraphicsMode>::~EnumPropDescriptor() — _DWORD *__fastcall(_DWORD *)
