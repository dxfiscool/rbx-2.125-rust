...
// Filter: Script|Lua|Yield|lua (case-sensitive) — 5401 filtered, all already stubbed (13753 existing)
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: +100 stubs | range 0x156d4..0x19a30 | global filler EA-sorted asc after 0x156ac | rbx_core::SharedPtr not boost
