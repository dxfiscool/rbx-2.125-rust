// Auto-generated skeletons for rbx-script — shard 205 EA-sorted asc next 150 not yet in script
// Filter: Script|Lua|Yield|lua (5401 filtered, all already stubbed) — global gap filler EA-sorted asc
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: +150 stubs | range 0x1ec270..0x2e8128 | script 20502->20652 distinct (filler 0x1ec270 asc, not-in-script 65043->64893)
...
#[doc(alias = "std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>::operator=(std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>> const&)")]
pub fn stub_0x2e71b4() -> ! {
    todo!("0x2e71b4 std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>::operator=(std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>> const&)")
}
...
#[doc(alias = "rbx_core::Weak<RBX::PartInstance>* std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>::_M_allocate_and_copy<__gnu_cxx::__normal_iterator<rbx_core::Weak<RBX::PartInstance> const*,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>>>(unsigned long,__gnu_cxx::__normal_iterator<rbx_core::Weak<RBX::PartInstance> const*,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>>,__gnu_cxx::__normal_iterator<rbx_core::Weak<RBX::PartInstance> const*,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>>)")]
pub fn stub_0x2e7eb4() -> ! {
    todo!("0x2e7eb4 rbx_core::Weak<RBX::PartInstance>* std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>::_M_allocate_and_copy<__gnu_cxx::__normal_iterator<rbx_core::Weak<RBX::PartInstance> const*,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>>>(unsigned long,__gnu_cxx::__normal_iterator<rbx_core::Weak<RBX::PartInstance> const*,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>>,__gnu_cxx::__normal_iterator<rbx_core::Weak<RBX::PartInstance> const*,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>>>)")
}

// 0x2e8078 — __ZNSt6__copyILb0ESt26random_access_iterator_tagE4copyIPN5boost8weak_ptrIN3RBX12PartInstanceEEES8_EET0_T_SA_S9_
#[doc(alias = "rbx_core::Weak<RBX::PartInstance> * std::__copy<false,std::random_access_iterator_tag>::copy<rbx_core::Weak<RBX::PartInstance> *,rbx_core::Weak<RBX::PartInstance> *>(rbx_core::Weak<RBX::PartInstance> *,rbx_core::Weak<RBX::PartInstance> *,rbx_core::Weak<RBX::PartInstance> *)")]
pub fn stub_0x2e8078() -> ! {
    todo!("0x2e8078 rbx_core::Weak<RBX::PartInstance> * std::__copy<false,std::random_access_iterator_tag>::copy<rbx_core::Weak<RBX::PartInstance> *,rbx_core::Weak<RBX::PartInstance> *>(rbx_core::Weak<RBX::PartInstance> *,rbx_core::Weak<RBX::PartInstance> *,rbx_core::Weak<RBX::PartInstance> *)")
}
...
#[doc(alias = "rbx_core::Weak<RBX::PartInstance>* std::__copy<false,std::random_access_iterator_tag>::copy<rbx_core::Weak<RBX::PartInstance> const*,rbx_core::Weak<RBX::PartInstance>*>(rbx_core::Weak<RBX::PartInstance> const*,rbx_core::Weak<RBX::PartInstance> const*,rbx_core::Weak<RBX::PartInstance>*)")]
pub fn stub_0x2e80d0() -> ! {
    todo!("0x2e80d0 rbx_core::Weak<RBX::PartInstance>* std::__copy<false,std::random_access_iterator_tag>::copy<rbx_core::Weak<RBX::PartInstance> const*,rbx_core::Weak<RBX::PartInstance>*>(rbx_core::Weak<RBX::PartInstance> const*,rbx_core::Weak<RBX::PartInstance> const*,rbx_core::Weak<RBX::PartInstance>*)")
}
