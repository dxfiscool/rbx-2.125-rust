...
pub fn stub_0x4fbc68() -> ! {
    todo!("0x4fbc68 RBX::Game::setupDataModel(std::string const&)")
}
...
pub fn stub_0x4fc660() -> ! {
    todo!("0x4fc660 RBX::Game::shutdownGameDataModel(void)")
}
...
pub fn stub_0x4fc774() -> ! {
    todo!("0x4fc774 rbx_core::SharedPtr<RBX::ProfanityFilter>::~shared_ptr()")
}
...
pub fn stub_0x4fc788() -> ! {
    todo!("0x4fc788 rbx_core::SharedPtr<RBX::ProfanityFilter>::operator=(rbx_core::SharedPtr<RBX::ProfanityFilter> const&)")
}
...
pub fn stub_0x4fc7c0() -> ! {
    todo!("0x4fc7c0 RBX::ScopedSingleton<RBX::ProfanityFilter>::getInstance(void)")
}
...
pub fn stub_0x4fcd04() -> ! {
    todo!("0x4fcd04 void rbx_core::SharedPtr<RBX::CommonVerbs>::reset<RBX::CommonVerbs>(RBX::CommonVerbs *)")
}
...
pub fn stub_0x4fcd30() -> ! {
    todo!("0x4fcd30 std::vector<RBX::Verb *,std::allocator<RBX::Verb *>>::push_back(RBX::Verb * const&)")
}
...
pub fn stub_0x4fcd5c() -> ! {
    todo!("0x4fcd5c rbx_core::SharedPtr<RBX::OverlayDataModel>::operator=(rbx_core::SharedPtr<RBX::OverlayDataModel> const&)")
}
...
pub fn stub_0x4fd1e8() -> ! {
    todo!("0x4fd1e8 void RBX::shutdownDM<RBX::OverlayDataModel>(rbx_core::SharedPtr<RBX::OverlayDataModel> &)")
}
...
pub fn stub_0x4fdf80() -> ! {
    todo!("0x4fdf80 std::vector<RBX::Verb *,std::allocator<RBX::Verb *>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::Verb **,std::vector<RBX::Verb *,std::allocator<RBX::Verb *>>>,RBX::Verb * const&)")
}
...
pub fn stub_0x4fe060() -> ! {
    todo!("0x4fe060 std::_Vector_base<RBX::Verb *,std::allocator<RBX::Verb *>>::_M_allocate(unsigned long)")
}
...
pub fn stub_0x4fe078() -> ! {
    todo!("0x4fe078 rbx_core::SharedPtr<RBX::CommonVerbs>::shared_ptr<RBX::CommonVerbs>(RBX::CommonVerbs *)")
}
...
pub fn stub_0x4fe14c() -> ! {
    todo!("0x4fe14c boost::detail::shared_count::shared_count<RBX::CommonVerbs>(RBX::CommonVerbs *)")
}
...
pub fn stub_0x4fe258() -> ! {
    todo!("0x4fe258 RBX::CommonVerbs::~CommonVerbs()")
}
...
pub fn stub_0x4fec88() -> ! {
    todo!("0x4fec88 boost::detail::sp_counted_impl_p<RBX::CommonVerbs>::~sp_counted_impl_p()")
}
...
pub fn stub_0x4fec90() -> ! {
    todo!("0x4fec90 boost::detail::sp_counted_impl_p<RBX::CommonVerbs>::dispose(void)")
}
...
pub fn stub_0x4fed34() -> ! {
    todo!("0x4fed34 boost::detail::sp_counted_impl_p<RBX::CommonVerbs>::get_deleter(std::type_info const&)")
}
...
pub fn stub_0x4fed38() -> ! {
    todo!("0x4fed38 boost::detail::sp_counted_impl_p<RBX::CommonVerbs>::get_untyped_deleter(void)")
}
