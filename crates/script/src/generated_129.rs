...
// Batch: +100 stubs | range 0x40f14c..0x4b14f8 EA-sorted asc next 100 uncovered (global uncovered 440->340, filler 13285->13385, rbx_core::SharedPtr not boost) [skeleton batch]
...
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::WeldTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::~sp_counted_impl_pd() [0x40fb48]")]
...
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::GlueTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::~sp_counted_impl_pd() [0x410548]")]
...
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::FlatTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::~sp_counted_impl_pd() [0x410f48]")]
...
#[doc(alias = "boost::exception_detail::error_info_injector<boost::io::bad_format_string>::~error_info_injector() [0x43fc24]")]
...
// type: int __fastcall(int, int, int, int)
#[doc(alias = "boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::io::bad_format_string>>::~clone_impl() [0x43fcf8]")]
...
// type: int __fastcall(int, int, int, int)
#[doc(alias = "non-virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::io::bad_format_string>>::~clone_impl() [0x43fef8]")]
...
// type: int __fastcall(int, int, int, int)
#[doc(alias = "boost::exception_detail::error_info_injector<boost::io::bad_format_string>::~error_info_injector() [0x43ff20]")]
...
#[doc(alias = "boost::detail::sp_counted_impl_p<RBX::Limits::Counter>::~sp_counted_impl_p() [0x473f1c]")]
...
#[doc(alias = "boost::detail::sp_counted_impl_p<DummyJob>::~sp_counted_impl_p() [0x483cb8]")]
...
#[doc(alias = "boost::detail::sp_counted_impl_p<DummyArbiter>::~sp_counted_impl_p() [0x483e98]")]
...
pub fn stub_0x4b1244() -> ! {
    todo!("0x4b1244 boost::shared_ptr<RBX::CustomEvent> RBX::shared_from<RBX::CustomEvent>(RBX::CustomEvent*)")
}
...
pub fn stub_0x4b13b4() -> ! {
    todo!("0x4b13b4 boost::shared_ptr<RBX::CustomEventReceiver>::shared_ptr<RBX::CustomEventReceiver>(boost::weak_ptr<RBX::CustomEventReceiver> const&,boost::detail::sp_nothrow_tag)")
}
...
pub fn stub_0x4b1430() -> ! {
    todo!("0x4b1430 std::list<boost::weak_ptr<RBX::CustomEventReceiver>,std::allocator<boost::weak_ptr<RBX::CustomEventReceiver>>>::list(std::list<boost::weak_ptr<RBX::CustomEventReceiver>,std::allocator<boost::weak_ptr<RBX::CustomEventReceiver>>> const&)")
}
