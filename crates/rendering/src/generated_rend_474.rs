...
pub fn stub_74779c() -> ! {
    todo!("0x74779c RBX::PolyContact::updateContactPoints(void)")
}
...
pub fn stub_7477cc() -> ! {
    todo!("0x7477cc RBX::PolyContact::computeIsColliding(float)")
}
...
pub fn stub_747834() -> ! {
    todo!("0x747834 RBX::PolyContact::updateClosestFeatures(void)")
}
...
pub fn stub_747904() -> ! {
    todo!("0x747904 RBX::PolyContact::worstFeatureOverlap(void)")
}
...
pub fn stub_7479b8() -> ! {
    todo!("0x7479b8 RBX::PolyContact::matchClosestFeatures(RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_747dc0() -> ! {
    todo!("0x747dc0 RBX::PolyPolyContact::PolyPolyContact(RBX::Primitive *,RBX::Primitive *)")
}
...
pub fn stub_747dc4() -> ! {
    todo!("0x747dc4 RBX::PolyPolyContact::PolyPolyContact(RBX::Primitive *,RBX::Primitive *)")
}
...
pub fn stub_747ea8() -> ! {
    todo!("0x747ea8 RBX::PolyPolyContact::~PolyPolyContact()")
}
...
pub fn stub_747f5c() -> ! {
    todo!("0x747f5c RBX::PolyPolyContact::~PolyPolyContact()")
}
...
pub fn stub_747f60() -> ! {
    todo!("0x747f60 RBX::PolyPolyContact::~PolyPolyContact()")
}
...
pub fn stub_748038() -> ! {
    todo!("0x748038 RBX::PolyPolyContact::resetBestPair(RBX::PolyPair *)")
}
...
pub fn stub_748068() -> ! {
    todo!("0x748068 RBX::PolyPolyContact::findClosestFeatures(RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_74813c() -> ! {
    todo!("0x74813c RBX::PolyPolyContact::findBestPair(void)")
}
...
pub fn stub_748344() -> ! {
    todo!("0x748344 RBX::PolyPolyContact::generateDataForMovingAssemblyStage(void)")
}
...
pub fn stub_748348() -> ! {
    todo!("0x748348 RBX::FaceFacePair::allocateClone(void)")
}
...
pub fn stub_748380() -> ! {
    todo!("0x748380 RBX::FaceFacePair::test(void)")
}
...
pub fn stub_74870c() -> ! {
    todo!("0x74870c RBX::FaceFacePair::findOtherFace(RBX::POLY::Vertex const*)")
}
...
pub fn stub_748934() -> ! {
    todo!("0x748934 RBX::FaceFacePair::loadConnectors(RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_7492c0() -> ! {
    todo!("0x7492c0 RBX::FaceFacePair::vertexInside(RBX::Primitive *,RBX::Primitive *,RBX::POLY::Vertex const*,RBX::POLY::Face const*,RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_7494ec() -> ! {
    todo!("0x7494ec RBX::FaceFacePair::newFaceEdgeConnector(unsigned long,RBX::POLY::Vertex const*,RBX::POLY::Vertex const*)")
}
...
pub fn stub_74979c() -> ! {
    todo!("0x74979c RBX::EdgeEdgePair::allocateClone(void)")
}
...
pub fn stub_7497d0() -> ! {
    todo!("0x7497d0 RBX::EdgeEdgePair::test(void)")
}
...
pub fn stub_749cc8() -> ! {
    todo!("0x749cc8 RBX::EdgeEdgePair::loadConnectors(RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_749d3c() -> ! {
    todo!("0x749d3c RBX::EdgeEdgePair::newEdgeEdgeConnector(void)")
}
...
pub fn stub_749f78() -> ! {
    todo!("0x749f78 RBX::Allocator<RBX::PolyPolyContact>::Allocator(void)")
}
...
pub fn stub_749fdc() -> ! {
    todo!("0x749fdc RBX::EdgeEdgePair::~EdgeEdgePair()")
}
...
pub fn stub_749fe0() -> ! {
    todo!("0x749fe0 RBX::FaceFacePair::~FaceFacePair()")
}
...
pub fn stub_749fe4() -> ! {
    todo!("0x749fe4 RBX::FixedArray<RBX::FaceFacePair::VertexStatus,40ul>::operator[](unsigned long)")
}
...
pub fn stub_74a044() -> ! {
    todo!("0x74a044 RBX::FixedArray<RBX::FaceFacePair::VertexStatus,40ul>::push_back(RBX::FaceFacePair::VertexStatus const&)")
}
...
pub fn stub_74a0b4() -> ! {
    todo!("0x74a0b4 RBX::FaceFacePair::isFaceFace(void)const")
}
...
pub fn stub_74a0b8() -> ! {
    todo!("0x74a0b8 RBX::FaceFacePair::~FaceFacePair()")
}
...
pub fn stub_74a0bc() -> ! {
    todo!("0x74a0bc RBX::EdgeEdgePair::isFaceFace(void)const")
}
...
pub fn stub_74a0c0() -> ! {
    todo!("0x74a0c0 RBX::EdgeEdgePair::~EdgeEdgePair()")
}
...
pub fn stub_74a0c4() -> ! {
    todo!("0x74a0c4 RBX::Allocator<RBX::PolyPolyContact>::releaseMemory(void)")
}
...
pub fn stub_74a0e0() -> ! {
    todo!("0x74a0e0 boost::singleton_pool<RBX::PolyPolyContact,216u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::release_memory(void)")
}
...
pub fn stub_74a110() -> ! {
    todo!("0x74a110 RBX::PolyPair::~PolyPair()")
}
...
pub fn stub_74a4b8() -> ! {
    todo!("0x74a4b8 RBX::Primitive::Primitive(RBX::Geometry::GeometryType)")
}
...
pub fn stub_74a4bc() -> ! {
    todo!("0x74a4bc RBX::Primitive::Primitive(RBX::Geometry::GeometryType)")
}
...
pub fn stub_74a8c8() -> ! {
    todo!("0x74a8c8 RBX::Primitive::newGeometry(RBX::Geometry::GeometryType)")
}
...
pub fn stub_74aa18() -> ! {
    todo!("0x74aa18 RBX::Primitive::computeJointK(void)")
}
...
pub fn stub_74aa5c() -> ! {
    todo!("0x74aa5c RBX::Primitive::~Primitive()")
}
...
pub fn stub_74aafc() -> ! {
    todo!("0x74aafc RBX::Primitive::~Primitive()")
}
...
pub fn stub_74ab08() -> ! {
    todo!("0x74ab08 RBX::Primitive::~Primitive()")
}
...
pub fn stub_74ae14() -> ! {
    todo!("0x74ae14 RBX::Primitive::setNetworkIsSleeping(bool)")
}
...
pub fn stub_74ae2c() -> ! {
    todo!("0x74ae2c RBX::Primitive::onBuoyancyChanged(bool)")
}
...
pub fn stub_74ae38() -> ! {
    todo!("0x74ae38 RBX::Primitive::getSizeMultiplier(void)const")
}
...
pub fn stub_74aeb4() -> ! {
    todo!("0x74aeb4 RBX::Primitive::setSizeMultiplier(RBX::Primitive::SizeMultiplier)")
}
...
pub fn stub_74af24() -> ! {
    todo!("0x74af24 RBX::Primitive::getGuid(void)const")
}
...
pub fn stub_74af80() -> ! {
    todo!("0x74af80 RBX::Primitive::setGuid(RBX::Guid const&)")
}
...
pub fn stub_74aff4() -> ! {
    todo!("0x74aff4 RBX::Primitive::computeFuzzyExtents(void)")
}
...
pub fn stub_74b1b4() -> ! {
    todo!("0x74b1b4 RBX::Primitive::getConstFirstJoint(void)const")
}
...
pub fn stub_74b1c8() -> ! {
    todo!("0x74b1c8 RBX::Primitive::getConstNextJoint(RBX::Joint const*)const")
}
...
pub fn stub_74b1d4() -> ! {
    todo!("0x74b1d4 RBX::EdgeList::getNext(RBX::Primitive const*,RBX::Edge *)const")
}
...
pub fn stub_74b2a4() -> ! {
    todo!("0x74b2a4 RBX::EdgeList::insertEdge(RBX::Edge *)")
}
...
pub fn stub_74b348() -> ! {
    todo!("0x74b348 RBX::EdgeList::removeEdge(RBX::Edge *)")
}
...
pub fn stub_74b47c() -> ! {
    todo!("0x74b47c RBX::Primitive::getJoint(int)")
}
...
pub fn stub_74b484() -> ! {
    todo!("0x74b484 RBX::Primitive::getConstJoint(int)const")
}
...
pub fn stub_74b48c() -> ! {
    todo!("0x74b48c RBX::Primitive::getContact(int)")
}
...
pub fn stub_74b494() -> ! {
    todo!("0x74b494 RBX::Primitive::insertEdge(RBX::Edge *)")
}
...
pub fn stub_74b5f8() -> ! {
    todo!("0x74b5f8 RBX::Primitive::removeEdge(RBX::Edge *)")
}
...
pub fn stub_74b75c() -> ! {
    todo!("0x74b75c RBX::Primitive::getFirstEdge(void)const")
}
...
pub fn stub_74b780() -> ! {
    todo!("0x74b780 RBX::Primitive::getNextEdge(RBX::Edge *)const")
}
...
pub fn stub_74b7c8() -> ! {
    todo!("0x74b7c8 RBX::Primitive::getFirstJoint(void)")
}
...
pub fn stub_74b7dc() -> ! {
    todo!("0x74b7dc RBX::Primitive::getNextJoint(RBX::Joint *)")
}
...
pub fn stub_74b7e8() -> ! {
    todo!("0x74b7e8 RBX::Primitive::getFirstContact(void)")
}
...
pub fn stub_74b7fc() -> ! {
    todo!("0x74b7fc RBX::Primitive::getNextContact(RBX::Contact *)")
}
...
pub fn stub_74b808() -> ! {
    todo!("0x74b808 RBX::Primitive::getFirstRigidAt(RBX::Joint *)")
}
...
pub fn stub_74b858() -> ! {
    todo!("0x74b858 RBX::Primitive::getFirstRigid(void)")
}
...
pub fn stub_74b86c() -> ! {
    todo!("0x74b86c RBX::Primitive::getNextRigid(RBX::RigidJoint *)")
}
...
pub fn stub_74b88c() -> ! {
    todo!("0x74b88c RBX::Primitive::getJoint(RBX::Primitive*,RBX::Primitive*,int)")
}
...
pub fn stub_74b9cc() -> ! {
    todo!("0x74b9cc RBX::Primitive::getContact(RBX::Primitive*,RBX::Primitive*)")
}
...
pub fn stub_74baf8() -> ! {
    todo!("0x74baf8 RBX::Primitive::onNewOverlap(RBX::Primitive*,RBX::Primitive*)")
}
...
pub fn stub_74bc08() -> ! {
    todo!("0x74bc08 RBX::Primitive::onStopOverlap(RBX::Primitive*,RBX::Primitive*)")
}
...
pub fn stub_74bd18() -> ! {
    todo!("0x74bd18 RBX::Primitive::getClump(void)")
}
...
pub fn stub_74bd1c() -> ! {
    todo!("0x74bd1c RBX::Primitive::getConstClump(void)const")
}
...
pub fn stub_74bd20() -> ! {
    todo!("0x74bd20 RBX::Primitive::getAssembly(void)")
}
...
pub fn stub_74bd24() -> ! {
    todo!("0x74bd24 RBX::Primitive::getConstAssembly(void)const")
}
...
pub fn stub_74bd28() -> ! {
    todo!("0x74bd28 RBX::Primitive::getMechanism(void)")
}
...
pub fn stub_74bd2c() -> ! {
    todo!("0x74bd2c RBX::Primitive::getConstMechanism(void)const")
}
...
pub fn stub_74bd30() -> ! {
    todo!("0x74bd30 RBX::Primitive::getGeometryType(void)const")
}
...
pub fn stub_74bda0() -> ! {
    todo!("0x74bda0 RBX::Primitive::getCollideType(void)const")
}
...
pub fn stub_74be08() -> ! {
    todo!("0x74be08 RBX::Primitive::getSize(void)const")
}
...
pub fn stub_74be10() -> ! {
    todo!("0x74be10 RBX::Primitive::getGeometryParameter(std::string const&)const")
}
...
pub fn stub_74be1c() -> ! {
    todo!("0x74be1c RBX::Primitive::setGeometryType(RBX::Geometry::GeometryType)")
}
...
pub fn stub_74bfe8() -> ! {
    todo!("0x74bfe8 RBX::Primitive::setMassInertia(float)")
}
...
pub fn stub_74c044() -> ! {
    todo!("0x74c044 RBX::Primitive::setGeometryParameter(std::string const&,int)")
}
...
pub fn stub_74c190() -> ! {
    todo!("0x74c190 RBX::Primitive::getCanThrottle(void)const")
}
...
pub fn stub_74c19c() -> ! {
    todo!("0x74c19c RBX::Primitive::setCanThrottle(bool)")
}
...
pub fn stub_74c24c() -> ! {
    todo!("0x74c24c RBX::Primitive::setEngineType(RBX::Primitive::EngineType)")
}
...
pub fn stub_74c288() -> ! {
    todo!("0x74c288 RBX::Primitive::setOwner(RBX::IMoving *)")
}
