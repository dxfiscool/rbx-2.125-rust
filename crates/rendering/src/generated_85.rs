...
pub fn stub_e435a0() -> ! {
    todo!("0xe435a0 Ogre::TextAreaOverlayElement::getTypeName(void)const")
}
...
pub fn stub_e44b50() -> ! {
    todo!("0xe44b50 Ogre::TextAreaOverlayElement::setMetricsMode(Ogre::GuiMetricsMode)")
}
...
pub fn stub_e4542c() -> ! {
    todo!("0xe4542c Ogre::Texture::loadRawData(Ogre::SharedPtr<Ogre::DataStream> &,unsigned short,unsigned short,Ogre::PixelFormat)")
}
