...
pub fn stub_40ccc8() -> ! {
    todo!("0x40ccc8 RBX::TToolVerb<RBX::HingeTool,RBX::RunStateVerb>::isChecked(void)const")
}
...
pub fn stub_40cd00() -> ! {
    todo!("0x40cd00 RBX::TToolVerb<RBX::HingeTool,RBX::RunStateVerb>::doIt(RBX::IDataState *)")
}
...
pub fn stub_40ce14() -> ! {
    todo!("0x40ce14 RBX::TToolVerb<RBX::HingeTool,RBX::RunStateVerb>::newMouseCommand(void)")
}
...
pub fn stub_40cfbc() -> ! {
    todo!("0x40cfbc RBX::HingeTool::isSticky(void)const")
}
...
pub fn stub_40d084() -> ! {
    todo!("0x40d084 RBX::HingeTool::getCursorName(void)const")
}
...
pub fn stub_40d0a0() -> ! {
    todo!("0x40d0a0 boost::shared_ptr<RBX::HingeTool>::shared_ptr<RBX::HingeTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")
}
...
pub fn stub_40d168() -> ! {
    todo!("0x40d168 void boost::enable_shared_from_this<RBX::MouseCommand>::_internal_accept_owner<RBX::HingeTool,RBX::HingeTool>(boost::shared_ptr<RBX::HingeTool> const*,RBX::HingeTool *)const")
}
...
pub fn stub_40d24c() -> ! {
    todo!("0x40d24c boost::detail::shared_count::shared_count<RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")
}
...
pub fn stub_40d344() -> ! {
    todo!("0x40d344 boost::detail::sp_counted_impl_pd<RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_40d348() -> ! {
    todo!("0x40d348 boost::detail::sp_counted_impl_pd<RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_40d34c() -> ! {
    todo!("0x40d34c boost::detail::sp_counted_impl_pd<RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::dispose(void)")
}
...
pub fn stub_40d35c() -> ! {
    todo!("0x40d35c boost::detail::sp_counted_impl_pd<RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_40d374() -> ! {
    todo!("0x40d374 boost::detail::sp_counted_impl_pd<RBX::HingeTool *,RBX::Creatable<RBX::MouseCommand>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_40d6c8() -> ! {
    todo!("0x40d6c8 RBX::TToolVerb<RBX::UniversalTool,RBX::RunStateVerb>::isChecked(void)const")
}
...
pub fn stub_40d700() -> ! {
    todo!("0x40d700 RBX::TToolVerb<RBX::UniversalTool,RBX::RunStateVerb>::doIt(RBX::IDataState *)")
}
...
pub fn stub_40d814() -> ! {
    todo!("0x40d814 RBX::TToolVerb<RBX::UniversalTool,RBX::RunStateVerb>::newMouseCommand(void)")
}
...
pub fn stub_40daa0() -> ! {
    todo!("0x40daa0 boost::shared_ptr<RBX::UniversalTool>::shared_ptr<RBX::UniversalTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::UniversalTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")
}
...
pub fn stub_40db68() -> ! {
    todo!("0x40db68 void boost::enable_shared_from_this<RBX::MouseCommand>::_internal_accept_owner<RBX::UniversalTool,RBX::UniversalTool>(boost::shared_ptr<RBX::UniversalTool> const*,RBX::UniversalTool *)const")
}
...
pub fn stub_40e4a0() -> ! {
    todo!("0x40e4a0 boost::shared_ptr<RBX::InletTool>::shared_ptr<RBX::InletTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::InletTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")
}
...
pub fn stub_40e568() -> ! {
    todo!("0x40e568 void boost::enable_shared_from_this<RBX::MouseCommand>::_internal_accept_owner<RBX::InletTool,RBX::InletTool>(boost::shared_ptr<RBX::InletTool> const*,RBX::InletTool *)const")
}
...
pub fn stub_40eea0() -> ! {
    todo!("0x40eea0 boost::shared_ptr<RBX::StudsTool>::shared_ptr<RBX::StudsTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::StudsTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")
}
...
pub fn stub_40ef68() -> ! {
    todo!("0x40ef68 void boost::enable_shared_from_this<RBX::MouseCommand>::_internal_accept_owner<RBX::StudsTool,RBX::StudsTool>(boost::shared_ptr<RBX::StudsTool> const*,RBX::StudsTool *)const")
}
