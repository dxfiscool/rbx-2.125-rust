//! rendering — generated_06 — next 150 stubs (EA-sorted)
//! Filter: Ogre|G3D|Gfx|Render|Adorn (15642 total, 1834 prior, 150 this batch, 13658 remaining)
//! Range: 0x26e870..0x3a99bc
...
// was: RBX::Region3* RBX::Lua::Bridge<RBX::Region3,true>::pushNewObject<RBX::Region3>(lua_State *,RBX::Region3)
pub fn stub_26e870() -> ! {
...
// was: boost::circular_buffer<RBX::InterpolatedCFrame::FrameInfo,std::allocator<RBX::InterpolatedCFrame::FrameInfo>>::push_back(RBX::InterpolatedCFrame::FrameInfo const&)
pub fn stub_325c38() -> ! {
...
// was: rbx::signals::signal<void ()(void)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::ArcHandles,void ()(G3D::Vector3::Axis,float,float)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::ArcHandles,void ()(G3D::Vector3::Axis,float,float)>*>>>>::~callable_slot()
pub fn stub_3a9990() -> ! {
