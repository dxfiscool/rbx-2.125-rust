//! rendering — generated_494 — 100 stubs EA-sorted Ogre/GLES2 continuation 0xd0d9f4..0xd172c4 after 0xd02cec shard
//! Source: ida/export.json (85545 funcs) Ogre|GLES2 (9839 total) EA asc >0xd0d848 next 100 — global dedup fallback (all Ogre already globally stubbed, per-file unique)
//! Filter: Ogre|GLES2 strict (9839 total) — EA-sorted continuation
...
#[doc(alias = "__ZN4Ogre14MeshSerializer10importMeshERNS_9SharedPtrINS_10DataStreamEEEPNS_4MeshE")]
// was: Ogre::MeshSerializer::importMesh(Ogre::SharedPtr<Ogre::DataStream> &,Ogre::Mesh *)
pub fn stub_d159d8() -> ! {
    todo!("0xd159d8 Ogre::MeshSerializer::importMesh(Ogre::SharedPtr<Ogre::DataStream> &,Ogre::Mesh *)")
}
...
#[doc(alias = "__ZN4Ogre18MeshSerializerImpl10importMeshERNS_9SharedPtrINS_10DataStreamEEEPNS_4MeshEPNS_22MeshSerializerListenerE")]
// was: Ogre::MeshSerializerImpl::importMesh(Ogre::SharedPtr<Ogre::DataStream> &,Ogre::Mesh *,Ogre::MeshSerializerListener *)
pub fn stub_d16628() -> ! {
    todo!("0xd16628 Ogre::MeshSerializerImpl::importMesh(Ogre::SharedPtr<Ogre::DataStream> &,Ogre::Mesh *,Ogre::MeshSerializerListener *)")
}
