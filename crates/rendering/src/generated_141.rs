...
pub fn stub_f52394() -> ! {
    todo!("0xf52394 boost::function2<void,RBX::BillboardGui *,RBX::Adorn *>::clear(void)")
}
...
pub fn stub_f5b1a4() -> ! {
    todo!("0xf5b1a4 void boost::_bi::list2<boost::arg<1>,boost::_bi::value<RBX::Adorn *>>::operator()<void (*)(boost::shared_ptr<RBX::Instance>,RBX::Adorn *),boost::_bi::list1<boost::shared_ptr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(boost::shared_ptr<RBX::Instance>,RBX::Adorn *) &,boost::_bi::list1<boost::shared_ptr<RBX::Instance> const&> &,int)")
}
...
pub fn stub_f67c14() -> ! {
    todo!("0xf67c14 OgreRbxMutex::OgreRbxMutex(int)")
}
