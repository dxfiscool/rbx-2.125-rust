//! rendering shard 477 — 100 stubs 0x7a19f4..0x87b874 EA-sorted asc global gap filler not yet in rbx_rendering (Ogre|Gfx|Render|G3D, 15288 total, 4674 prior +100 this batch = 4774 total, rbx_core::SharedPtr not boost, // 0xADDR mangled + doc alias + todo)
...
// was: _DWORD __fastcall(RBX::Soundscape::CollisionSound *__hidden this, FMOD::System *, FMOD::ChannelGroup *, const G3D::Vector3 *, const G3D::Vector3 *, boost::detail::sp_counted_base *) (boost -> rbx_core::SharedPtr)
