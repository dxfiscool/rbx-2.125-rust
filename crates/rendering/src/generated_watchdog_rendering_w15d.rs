//! rendering shard watchdog_rendering_w15d — 120 stubs EA-sorted asc Ogre::Entity|SceneManager (w15d)
//! Filter: Ogre::Entity, Ogre::SceneManager — strict class boundary
//! Each stub preserves IDA ea + mangled + demangled for rg.
//! Uses rbx_core::SharedPtr (not boost::shared_ptr).
//! Source: ida/export.json (85545 funcs) rendering filter Ogre::Entity|SceneManager
...
// 0xd964ec — __ZN4Ogre4Root24_pushCurrentSceneManagerEPNS_12SceneManagerE
// type: _DWORD __fastcall(Ogre::Root *__hidden this, Ogre::SceneManager *)
...
// type: _DWORD __fastcall(Ogre::Root *__hidden this, Ogre::SceneManagerFactory *)
...
// type: void __fastcall(Ogre::EntityFactory *__hidden this)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, const std::string *)
...
// type: void __fastcall(Ogre::SceneManager *__hidden this)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, unsigned __int8)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, const std::string *, const std::string *, const std::string *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::Entity *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::ManualObject *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::BillboardChain *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::RibbonTrail *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, const std::string *, const std::string *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, const std::string *, unsigned int, const std::string *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, unsigned int, const std::string *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::ParticleSystem *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::SceneNode *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, const Ogre::Pass *, bool, bool)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, Ogre::RenderSystem *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, bool, const Ogre::Plane *, const std::string *, float, float, unsigned __int8, float, int, int, const std::string *)
...
// type: int __fastcall(int, int, int, int, float, float, int, float, int, int, int)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, bool, const std::string *, float, unsigned __int8, const Ogre::Quaternion *, const std::string *)
...
// type: _DWORD __fastcall(Ogre::SceneManager *__hidden this, bool, const std::string *, float, float, float, unsigned __int8, const Ogre::Quaternion *, int, int, int, const std::string *)
...
// type: int __fastcall(int, int, int, int, float, float, int, int, int, int, int, int)
