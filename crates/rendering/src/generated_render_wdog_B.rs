...
pub fn stub_68eea4() -> ! {
    todo!("0x68eea4 std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>::resize(unsigned long,RBX::TouchDebouncer::Item)")
}
...
pub fn stub_68eef0() -> ! {
    todo!("0x68eef0 std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>::push_back(RBX::TouchDebouncer::Item const&)")
}
...
pub fn stub_68ef8c() -> ! {
    todo!("0x68ef8c std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::TouchDebouncer::Item*,std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>>,RBX::TouchDebouncer::Item const&)")
}
...
pub fn stub_68f554() -> ! {
    todo!("0x68f554 std::_Vector_base<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>::_M_allocate(unsigned long)")
}
...
pub fn stub_68f578() -> ! {
    todo!("0x68f578 RBX::TouchDebouncer::Item * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::TouchDebouncer::Item *,RBX::TouchDebouncer::Item *>(RBX::TouchDebouncer::Item *,RBX::TouchDebouncer::Item *,RBX::TouchDebouncer::Item *)")
}
...
pub fn stub_68f5e8() -> ! {
    todo!("0x68f5e8 std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>::_M_erase_at_end(RBX::TouchDebouncer::Item*)")
}
...
pub fn stub_68f618() -> ! {
    todo!("0x68f618 std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::TouchDebouncer::Item*,std::vector<RBX::TouchDebouncer::Item,std::allocator<RBX::TouchDebouncer::Item>>>,unsigned long,RBX::TouchDebouncer::Item const&)")
}
...
pub fn stub_68fec8() -> ! {
    todo!("0x68fec8 void std::__uninitialized_fill_n_aux<RBX::TouchDebouncer::Item *,unsigned long,RBX::TouchDebouncer::Item>(RBX::TouchDebouncer::Item *,unsigned long,RBX::TouchDebouncer::Item const&,std::__false_type)")
}
...
pub fn stub_6907e4() -> ! {
    todo!("0x6907e4 RBX::Controller::getButton(RBX::Controller::Button)")
}
...
pub fn stub_6909b8() -> ! {
    todo!("0x6909b8 RBX::StringConverter<RBX::Controller::Button>::convertToValue(std::string const&,RBX::Controller::Button&)")
}
...
pub fn stub_690a08() -> ! {
    todo!("0x690a08 RBX::Controller::getHardwareDevice(void)const")
}
...
pub fn stub_690aa0() -> ! {
    todo!("0x690aa0 RBX::ButtonBindingWidget::ButtonBindingWidget(RBX::Controller::Button,RBX::Controller*)")
}
...
pub fn stub_690cb0() -> ! {
    todo!("0x690cb0 RBX::ButtonBindingWidget::onClick(RBX::GuiEvent const&)")
}
...
pub fn stub_690d7c() -> ! {
    todo!("0x690d7c RBX::Controller::setButton(RBX::Controller::Button,bool)")
}
...
pub fn stub_690de8() -> ! {
    todo!("0x690de8 RBX::ButtonBindingWidget::getSize(RBX::Canvas)const")
}
...
pub fn stub_691524() -> ! {
    todo!("0x691524 RBX::Controller::Controller(void)")
}
...
pub fn stub_691774() -> ! {
    todo!("0x691774 RBX::Controller::~Controller()")
}
...
// was: RBX::Controller::~Controller()
pub fn stub_691814() -> ! {
    todo!("0x691814 RBX::Controller::~Controller()")
}
...
// was: RBX::Controller::~Controller()
pub fn stub_691830() -> ! {
    todo!("0x691830 RBX::Controller::~Controller()")
}
...
pub fn stub_691a1c() -> ! {
    todo!("0x691a1c RBX::Controller::isButtonBound(RBX::Controller::Button)const")
}
...
pub fn stub_691a40() -> ! {
    todo!("0x691a40 RBX::Controller::getButton(RBX::Controller::Button)const")
}
...
pub fn stub_691b90() -> ! {
    todo!("0x691b90 RBX::Controller::showHUDActions(void)")
}
...
pub fn stub_691f20() -> ! {
    todo!("0x691f20 RBX::Controller::onAncestorChanged(RBX::AncestorChanged const&)")
}
...
pub fn stub_691f58() -> ! {
    todo!("0x691f58 RBX::Controller::hideHUDActions(void)")
}
...
pub fn stub_691fa8() -> ! {
    todo!("0x691fa8 RBX::VehicleController::VehicleController(void)")
}
...
pub fn stub_6920f8() -> ! {
    todo!("0x6920f8 RBX::VehicleController::setVehicleSeat(RBX::VehicleSeat *)")
}
...
pub fn stub_692420() -> ! {
    todo!("0x692420 RBX::VehicleController::onStepped(RBX::Stepped const&)")
}
...
pub fn stub_692604() -> ! {
    todo!("0x692604 RBX::HumanoidController::HumanoidController(void)")
}
...
pub fn stub_69275c() -> ! {
    todo!("0x69275c RBX::HumanoidController::updateCamera(RBX::Stepped const&,RBX::NavKeys const&)")
}
...
pub fn stub_6927f4() -> ! {
    todo!("0x6927f4 RBX::HumanoidController::updateMovement(RBX::Stepped const&,RBX::Humanoid *,RBX::NavKeys const&)")
}
...
pub fn stub_692a04() -> ! {
    todo!("0x692a04 RBX::HumanoidController::onStepped(RBX::Stepped const&)")
}
...
pub fn stub_692ba4() -> ! {
    todo!("0x692ba4 RBX::ControllerService::ControllerService(void)")
}
...
// was: RBX::ControllerService::ControllerService(void)
pub fn stub_692ba8() -> ! {
    todo!("0x692ba8 RBX::ControllerService::ControllerService(void)")
}
...
pub fn stub_6935c8() -> ! {
    todo!("0x6935c8 std::basic_string<char,std::char_traits<char>,std::allocator<char>> std::operator+<char,std::char_traits<char>,std::allocator<char>>(char const*,std::basic_string<char,std::char_traits<char>,std::allocator<char>> const&)")
}
...
pub fn stub_693838() -> ! {
    todo!("0x693838 boost::shared_ptr<RBX::ButtonBindingWidget> RBX::Creatable<RBX::Instance>::create<RBX::ButtonBindingWidget,RBX::Controller::Button,RBX::Controller*>(RBX::Controller::Button,RBX::Controller*)")
}
...
pub fn stub_693dbc() -> ! {
    todo!("0x693dbc boost::shared_ptr<RBX::HumanoidController> RBX::Creatable<RBX::Instance>::create<RBX::HumanoidController>(void)")
}
...
pub fn stub_693e70() -> ! {
    todo!("0x693e70 RBX::Controller::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_693e7c() -> ! {
    todo!("0x693e7c RBX::ButtonBindingWidget::~ButtonBindingWidget()")
}
...
// was: RBX::ButtonBindingWidget::~ButtonBindingWidget()
pub fn stub_693fb4() -> ! {
    todo!("0x693fb4 RBX::ButtonBindingWidget::~ButtonBindingWidget()")
}
...
pub fn stub_694128() -> ! {
    todo!("0x694128 RBX::Widget::onLoseFocus(void)")
}
...
pub fn stub_694130() -> ! {
    todo!("0x694130 RBX::GuiItem::canLoseFocus(void)")
}
...
pub fn stub_694134() -> ! {
    todo!("0x694134 RBX::GuiItem::getChildPosition(RBX::GuiItem const*,RBX::Canvas)const")
}
...
pub fn stub_694194() -> ! {
    todo!("0x694194 RBX::Widget::getFontSize(void)const")
}
...
pub fn stub_694198() -> ! {
    todo!("0x694198 RBX::GuiItem::isVisible(void)const")
}
...
pub fn stub_69419c() -> ! {
    todo!("0x69419c RBX::Widget::getFontColor(void)")
}
