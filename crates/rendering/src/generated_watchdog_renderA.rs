...
pub fn stub_0x94c058() -> ! {
    todo!("0x94c058 RBX::DrawAdorn::zeroPlaneGrid(RBX::Adorn *,RBX::Camera const&,int,int,G3D::Color4 const&,G3D::Color4 const&)")
}
...
pub fn stub_0x94d01c() -> ! {
    todo!("0x94d01c RBX::DrawAdorn::circularGridAtCoord(RBX::Adorn *,G3D::CoordinateFrame const&,G3D::Vector3 const&,G3D::Vector3 const&,RBX::NormalId,G3D::Color4 const&,int)")
}
...
pub fn stub_0x94d374() -> ! {
    todo!("0x94d374 RBX::DrawAdorn::handlePosInObject(G3D::Vector3 const&,RBX::Extents const&,RBX::HandleType,RBX::NormalId)")
}
