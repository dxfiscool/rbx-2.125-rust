...
pub fn stub_64c5f0() -> ! {
    todo!("0x64c5f0 RBX::Stats::TypedPercentItem::update(void)")
}
...
pub fn stub_64cf58() -> ! {
    todo!("0x64cf58 boost::function0<float>::operator()(void)const")
}
...
pub fn stub_64d5f8() -> ! {
    todo!("0x64d5f8 RBX::Stats::TypedMemItem::update(void)")
}
...
pub fn stub_64dde8() -> ! {
    todo!("0x64dde8 RBX::Stats::TypedStatsItem<unsigned long>::update(void)")
}
