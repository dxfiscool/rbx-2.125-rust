...
#[doc(alias = "RBX::TextureTrail::getPosition(boost::weak_ptr<RBX::PartInstance> const&,G3D::Vector3 *)")]
// was: RBX::TextureTrail::getPosition(boost::weak_ptr<RBX::PartInstance> const&,G3D::Vector3 *)
pub fn stub_85e380() -> ! {
    todo!("0x85e380 RBX::TextureTrail::getPosition(boost::weak_ptr<RBX::PartInstance> const&,G3D::Vector3 *)")
}
...
#[doc(alias = "RBX::FloorWire::buildTrailSegments(RBX::Workspace const*,boost::shared_ptr<RBX::PartInstance> const&,boost::shared_ptr<RBX::PartInstance> const&,std::vector<G3D::Vector3,std::allocator<G3D::Vector3>> *)")]
...
pub fn stub_867f68() -> ! {
    todo!("0x867f68 RBX::FloorWire::buildTrailSegments(RBX::Workspace const*,boost::shared_ptr<RBX::PartInstance> const&,boost::shared_ptr<RBX::PartInstance> const&,std::vector<G3D::Vector3,std::allocator<G3D::Vector3>> *)")
}
...
#[doc(alias = "RBX::FloorWire::computeSurfacePosition(boost::shared_ptr<RBX::PartInstance> const&,RBX::RbxRay const&,G3D::Vector3 *)")]
// was: RBX::FloorWire::computeSurfacePosition(boost::shared_ptr<RBX::PartInstance> const&,RBX::RbxRay const&,G3D::Vector3 *)
pub fn stub_8685e0() -> ! {
    todo!("0x8685e0 RBX::FloorWire::computeSurfacePosition(boost::shared_ptr<RBX::PartInstance> const&,RBX::RbxRay const&,G3D::Vector3 *)")
}
...
pub fn stub_87164c() -> ! {
    todo!("0x87164c G3D::Vector3int16::isBetweenInclusive(G3D::Vector3int16 const&,G3D::Vector3int16 const&)const")
}
...
pub fn stub_87edc4() -> ! {
    todo!("0x87edc4 boost::shared_ptr<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::operator=(boost::shared_ptr<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token> const&)")
}
...
pub fn stub_87fb74() -> ! {
    todo!("0x87fb74 std::vector<G3D::Vector3,std::allocator<G3D::Vector3>>::operator=(std::vector<G3D::Vector3,std::allocator<G3D::Vector3>> const&)")
}
...
pub fn stub_87fef4() -> ! {
    todo!("0x87fef4 G3D::Vector3 * std::__copy<false,std::random_access_iterator_tag>::copy<G3D::Vector3 *,G3D::Vector3 *>(G3D::Vector3 *,G3D::Vector3 *,G3D::Vector3 *)")
}
...
pub fn stub_87ff50() -> ! {
    todo!("0x87ff50 G3D::Vector3* std::__copy<false,std::random_access_iterator_tag>::copy<G3D::Vector3 const*,G3D::Vector3*>(G3D::Vector3 const*,G3D::Vector3 const*,G3D::Vector3*)")
}
...
pub fn stub_880160() -> ! {
    todo!("0x880160 boost::shared_ptr<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::shared_ptr<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>(RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token *)")
}
...
pub fn stub_880234() -> ! {
    todo!("0x880234 boost::detail::shared_count::shared_count<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>(RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token *)")
}
...
pub fn stub_880768() -> ! {
    todo!("0x880768 std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::lower_bound(G3D::Vector3 const&)")
}
...
pub fn stub_8807c4() -> ! {
    todo!("0x8807c4 std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::upper_bound(G3D::Vector3 const&)")
}
...
pub fn stub_880820() -> ! {
    todo!("0x880820 boost::detail::sp_counted_impl_p<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::~sp_counted_impl_p()")
}
...
// was: boost::detail::sp_counted_impl_p<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::~sp_counted_impl_p()
pub fn stub_880824() -> ! {
    todo!("0x880824 boost::detail::sp_counted_impl_p<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::~sp_counted_impl_p()")
}
...
pub fn stub_880828() -> ! {
    todo!("0x880828 boost::detail::sp_counted_impl_p<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::dispose(void)")
}
...
pub fn stub_8808d0() -> ! {
    todo!("0x8808d0 boost::detail::sp_counted_impl_p<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::get_deleter(std::type_info const&)")
}
...
pub fn stub_8808d4() -> ! {
    todo!("0x8808d4 boost::detail::sp_counted_impl_p<RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::Token>::get_untyped_deleter(void)")
}
...
pub fn stub_8808d8() -> ! {
    todo!("0x8808d8 std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *> const&)")
}
...
pub fn stub_880a80() -> ! {
    todo!("0x880a80 std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *> const&)")
}
...
// was: std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::_M_insert_unique(std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *> const&)
pub fn stub_880b24() -> ! {
    todo!("0x880b24 std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::_M_insert_unique(std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *> const&)")
}
...
pub fn stub_880bf8() -> ! {
    todo!("0x880bf8 RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount::ValueCount(G3D::Vector3 const&)")
}
...
pub fn stub_880d28() -> ! {
    todo!("0x880d28 RBX::POLY::MegaClusterMesh::MegaClusterMesh(G3D::Vector3 const&)")
}
...
pub fn stub_880f24() -> ! {
    todo!("0x880f24 std::_Rb_tree<G3D::Vector3,std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>,std::_Select1st<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>,RBX::Vector3Comparer,std::allocator<std::pair<G3D::Vector3 const,RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::ValueCount *>>>::find(G3D::Vector3 const&)")
}
...
pub fn stub_880fc8() -> ! {
    todo!("0x880fc8 RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::safe_static_init_staticData(void)")
}
...
pub fn stub_880fcc() -> ! {
    todo!("0x880fcc RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::safe_static_do_get_staticData(void)")
}
...
pub fn stub_8810dc() -> ! {
    todo!("0x8810dc RBX::GeometryPool<G3D::Vector3,RBX::POLY::MegaClusterMesh,RBX::Vector3Comparer>::StaticData::~StaticData()")
}
...
pub fn stub_8815fc() -> ! {
    todo!("0x8815fc RBX::PolyCellContact::PolyCellContact(RBX::Primitive *,RBX::Primitive *,G3D::Vector3int16 const&)")
}
...
// was: RBX::PolyCellContact::PolyCellContact(RBX::Primitive *,RBX::Primitive *,G3D::Vector3int16 const&)
pub fn stub_881600() -> ! {
    todo!("0x881600 RBX::PolyCellContact::PolyCellContact(RBX::Primitive *,RBX::Primitive *,G3D::Vector3int16 const&)")
}
...
pub fn stub_881f48() -> ! {
    todo!("0x881f48 RBX::CellFaceFacePair::computeVertices(RBX::FixedArray<G3D::Vector3,40ul> &,G3D::CoordinateFrame const&)")
}
...
pub fn stub_882090() -> ! {
    todo!("0x882090 RBX::CellFaceFacePair::closestVertex(RBX::POLY::Face const*,RBX::FixedArray<G3D::Vector3,40ul> const&,RBX::POLY::Vertex const*&)")
}
...
pub fn stub_8827b0() -> ! {
    todo!("0x8827b0 RBX::CellFaceFacePair::loadVertices(RBX::FixedArray<RBX::CellFaceFacePair::VertexStatus,40ul> *,G3D::CoordinateFrame *,RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_8828fc() -> ! {
    todo!("0x8828fc RBX::CellFaceFacePair::checkOneSideIntersection(RBX::POLY::Vertex const*,RBX::POLY::Vertex const*,G3D::CoordinateFrame const&,RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_882a50() -> ! {
    todo!("0x882a50 RBX::CellFaceFacePair::checkTwoSideIntersections(RBX::POLY::Vertex const*,RBX::POLY::Vertex const*,G3D::CoordinateFrame const&,RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_882bd0() -> ! {
    todo!("0x882bd0 RBX::CellFaceFacePair::validateOneSideIntersection(RBX::POLY::Vertex const*,RBX::POLY::Vertex const*,G3D::CoordinateFrame const&,RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
...
pub fn stub_882d24() -> ! {
    todo!("0x882d24 RBX::CellFaceFacePair::testVerticesInside(unsigned long,RBX::FixedArray<RBX::CellFaceFacePair::VertexStatus,40ul> &,G3D::CoordinateFrame const&,RBX::FixedArray<RBX::PolyConnector *,40ul> &)")
}
