//! rendering generated_render_wdog_C — gap-filler EA-sorted 100 stubs
//! Filter: Ogre|rendering|G3D|Gfx (16388 total, all 16388 already stubbed — gap filler from remaining unstubbed)
//! Range: 0x838cbc..0x83fef0 (100 stubs, gap-filler)
...
// was: __ZThn32_NK3RBX14FactoryProductINS_5FrameENS_9GuiObjectELZNS_6sFrameEENS_8InstanceEE12getClassNameEv
pub fn stub_838dc8() -> ! {
...
// was: __ZN3RBX14FactoryProductINS_5FrameENS_9GuiObjectELZNS_6sFrameEENS_8InstanceEE17static_getCreatorEv
pub fn stub_838fd8() -> ! {
...
// was: RBX::NotificationObject::~NotificationObject()
pub fn stub_83904c() -> ! {
    todo!("0x83904c RBX::NotificationObject::~NotificationObject()")
}
...
// was: RBX::FriendService::setCreateFriendRequestUrl(std::string)
pub fn stub_839508() -> ! {
    todo!("0x839508 RBX::FriendService::setCreateFriendRequestUrl(std::string)")
}
...
// was: RBX::FriendService::setDeleteFriendRequestUrl(std::string)
pub fn stub_839660() -> ! {
    todo!("0x839660 RBX::FriendService::setDeleteFriendRequestUrl(std::string)")
}
...
// was: RBX::FriendService::setMakeFriendUrl(std::string)
pub fn stub_8397b8() -> ! {
    todo!("0x8397b8 RBX::FriendService::setMakeFriendUrl(std::string)")
}
...
// was: RBX::FriendService::setBreakFriendUrl(std::string)
pub fn stub_839910() -> ! {
    todo!("0x839910 RBX::FriendService::setBreakFriendUrl(std::string)")
}
...
// was: RBX::FriendService::setGetFriendsUrl(std::string)
pub fn stub_839a68() -> ! {
    todo!("0x839a68 RBX::FriendService::setGetFriendsUrl(std::string)")
}
...
// was: RBX::FriendService::setEnable(bool)
pub fn stub_839bc0() -> ! {
    todo!("0x839bc0 RBX::FriendService::setEnable(bool)")
}
...
// was: RBX::FriendService::setFriendsOnlineUrl(std::string)
pub fn stub_839bc8() -> ! {
    todo!("0x839bc8 RBX::FriendService::setFriendsOnlineUrl(std::string)")
}

// 0x839bd0 — __ZN3RBX13FriendServiceC1Ev
#[doc(alias = "RBX::FriendService::FriendService(void)")]
#[doc(alias = "__ZN3RBX13FriendServiceC1Ev")]
// was: RBX::FriendService::FriendService(void)
pub fn stub_839bd0() -> ! {
    todo!("0x839bd0 RBX::FriendService::FriendService(void)")
}
...
// was: RBX::FriendService::FriendService(void)
pub fn stub_839bd4() -> ! {
    todo!("0x839bd4 RBX::FriendService::FriendService(void)")
}
...
pub fn stub_839f90() -> ! {
    todo!("0x839f90 RBX::FriendService::processServiceResults(int,std::string *,std::exception const*,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>)")
}
...
pub fn stub_83a374() -> ! {
    todo!("0x83a374 RBX::FriendService::getFriendsOnline(int,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>)")
}
...
// was: RBX::countNumberParams(std::string const&)
pub fn stub_83a7a4() -> ! {
    todo!("0x83a7a4 RBX::countNumberParams(std::string const&)")
}
...
#[doc(alias = "__ZN3RBX13FriendService17onServiceProviderEPNS_15ServiceProviderES2_")]
// was: RBX::FriendService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)
pub fn stub_83a7e8() -> ! {
    todo!("0x83a7e8 RBX::FriendService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
// was: RBX::FriendService::friendStatusReplicationChanged(int,int,RBX::FriendService::FriendStatus)
pub fn stub_83a9bc() -> ! {
    todo!("0x83a9bc RBX::FriendService::friendStatusReplicationChanged(int,int,RBX::FriendService::FriendStatus)")
}
...
// was: RBX::FriendService::friendEventReplicationChanged(int,int,RBX::FriendService::FriendEventType)
pub fn stub_83aa1c() -> ! {
    todo!("0x83aa1c RBX::FriendService::friendEventReplicationChanged(int,int,RBX::FriendService::FriendEventType)")
}
...
// was: RBX::FriendService::issueFriendRequestOrMakeFriendship(int,int)
pub fn stub_83aa40() -> ! {
    todo!("0x83aa40 RBX::FriendService::issueFriendRequestOrMakeFriendship(int,int)")
}
...
// was: RBX::FriendService::getFriendStatus(int,int)const
pub fn stub_83b410() -> ! {
    todo!("0x83b410 RBX::FriendService::getFriendStatus(int,int)const")
}
...
// was: RBX::DontCareResponse(std::string *,std::exception *)
pub fn stub_83b4b8() -> ! {
    todo!("0x83b4b8 RBX::DontCareResponse(std::string *,std::exception *)")
}
...
// was: RBX::FriendService::storeAndReplicateFriendStatus(int,int,RBX::FriendService::FriendStatus)
pub fn stub_83b4bc() -> ! {
    todo!("0x83b4bc RBX::FriendService::storeAndReplicateFriendStatus(int,int,RBX::FriendService::FriendStatus)")
}
...
// was: RBX::FriendService::rejectFriendRequestOrBreakFriendship(int,int)
pub fn stub_83b54c() -> ! {
    todo!("0x83b54c RBX::FriendService::rejectFriendRequestOrBreakFriendship(int,int)")
}
...
pub fn stub_83bf28() -> ! {
    todo!("0x83bf28 RBX::FriendService::ProcessBulkFriendResponse(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *)")
}
...
pub fn stub_83c430() -> ! {
    todo!("0x83c430 RBX::FriendService::StoreFriendsHelper(boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>)")
}
...
// was: RBX::FriendService::playerAdded(int)
pub fn stub_83c52c() -> ! {
    todo!("0x83c52c RBX::FriendService::playerAdded(int)")
}
...
// was: RBX::FriendService::playerRemoving(int)
pub fn stub_83cc44() -> ! {
    todo!("0x83cc44 RBX::FriendService::playerRemoving(int)")
}
...
// was: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::EnumDesc(void)
pub fn stub_83cd38() -> ! {
...
// was: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::EnumDesc(void)
pub fn stub_83cf40() -> ! {
...
// was: RBX::Reflection::BoundFuncDesc<RBX::FriendService,void ()(std::string),1>::~BoundFuncDesc()
pub fn stub_83d130() -> ! {
...
// was: RBX::Reflection::BoundFuncDesc<RBX::FriendService,void ()(bool),1>::~BoundFuncDesc()
pub fn stub_83d170() -> ! {
...
// was: RBX::Reflection::RemoteEventDesc<RBX::FriendService,void ()(int,int,RBX::FriendService::FriendEventType),rbx::remote_signal<void ()(int,int,RBX::FriendService::FriendEventType)>>::~RemoteEventDesc()
pub fn stub_83d1b0() -> ! {
...
// was: RBX::Reflection::RemoteEventDesc<RBX::FriendService,void ()(int,int,RBX::FriendService::FriendStatus),rbx::remote_signal<void ()(int,int,RBX::FriendService::FriendStatus)>>::~RemoteEventDesc()
pub fn stub_83d1d4() -> ! {
...
pub fn stub_83d1f8() -> ! {
    todo!("0x83d1f8 boost::_bi::bind_t<void,boost::_mfi::mf5<void,RBX::FriendService,int,std::string *,std::exception const*,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>>,boost::_bi::list_av_6<RBX::FriendService*,int,boost::arg<1>,boost::arg<2>,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>>::type> boost::bind<void,RBX::FriendService,int,std::string *,std::exception const*,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>,RBX::FriendService*,int,boost::arg<1>,boost::arg<2>,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>>(void (RBX::FriendService::*)(int,std::string *,std::exception const*,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>),RBX::FriendService*,int,boost::arg<1>,boost::arg<2>,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>)")
}
...
// was: std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::operator[](int const&)
pub fn stub_83d3c8() -> ! {
    todo!("0x83d3c8 std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::operator[](int const&)")
}
...
pub fn stub_83d420() -> ! {
    todo!("0x83d420 boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>),boost::_bi::list_av_3<boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>::type> boost::bind<void,boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>(void (*)(boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>),boost::weak_ptr<RBX::FriendService>,int,boost::shared_ptr<std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>)")
}
...
pub fn stub_83d694() -> ! {
    todo!("0x83d694 boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list_av_5<boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,boost::arg<1>,boost::arg<2>>::type> boost::bind<void,boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *,boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,boost::arg<1>,boost::arg<2>>(void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,boost::arg<1>,boost::arg<2>)")
}
...
pub fn stub_83d8bc() -> ! {
    todo!("0x83d8bc boost::weak_ptr<RBX::FriendService> RBX::weak_from<RBX::FriendService>(RBX::FriendService*)")
}
...
// was: std::map<int,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::operator[](int const&)
pub fn stub_83dab4() -> ! {
    todo!("0x83dab4 std::map<int,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::operator[](int const&)")
}
...
// was: RBX::Reflection::EnumDesc<RBX::FriendService::FriendStatus>::addPair(RBX::FriendService::FriendStatus,char const*)
pub fn stub_83dbd8() -> ! {
...
// was: RBX::Reflection::EnumDesc<RBX::FriendService::FriendEventType>::addPair(RBX::FriendService::FriendEventType,char const*)
pub fn stub_83df38() -> ! {
...
// was: RBX::FriendService::~FriendService()
pub fn stub_83e298() -> ! {
    todo!("0x83e298 RBX::FriendService::~FriendService()")
}
...
// was: RBX::FriendService::~FriendService()
pub fn stub_83e29c() -> ! {
    todo!("0x83e29c RBX::FriendService::~FriendService()")
}
...
// was: __ZNK3RBX14FactoryProductINS_13FriendServiceENS_8InstanceELZNS_14sFriendServiceEES2_E12getClassNameEv
pub fn stub_83e33c() -> ! {
...
// was: __ZThn32_NK3RBX14FactoryProductINS_13FriendServiceENS_8InstanceELZNS_14sFriendServiceEES2_E12getClassNameEv
pub fn stub_83e3f8() -> ! {
...
// was: std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::resize(unsigned long,RBX::FriendService::FriendEventType)
pub fn stub_83e4b4() -> ! {
    todo!("0x83e4b4 std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::resize(unsigned long,RBX::FriendService::FriendEventType)")
}
...
// was: std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::push_back(RBX::FriendService::FriendEventType const&)
pub fn stub_83e4e8() -> ! {
    todo!("0x83e4e8 std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::push_back(RBX::FriendService::FriendEventType const&)")
}
...
// was: std::map<RBX::Name const*,RBX::FriendService::FriendEventType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::operator[](RBX::Name const* const&)
pub fn stub_83e510() -> ! {
    todo!("0x83e510 std::map<RBX::Name const*,RBX::FriendService::FriendEventType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::operator[](RBX::Name const* const&)")
}
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType> const&)
pub fn stub_83e568() -> ! {
    todo!("0x83e568 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType> const&)")
}
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType> const&)
pub fn stub_83e61c() -> ! {
    todo!("0x83e61c std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType> const&)")
}
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType> const&)
pub fn stub_83e674() -> ! {
    todo!("0x83e674 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::FriendService::FriendEventType> const&)")
}
...
// was: std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendEventType*,std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>>,RBX::FriendService::FriendEventType const&)
pub fn stub_83e6dc() -> ! {
    todo!("0x83e6dc std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendEventType*,std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>>,RBX::FriendService::FriendEventType const&)")
}
...
// was: std::_Vector_base<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::_M_allocate(unsigned long)
pub fn stub_83e7c0() -> ! {
    todo!("0x83e7c0 std::_Vector_base<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::_M_allocate(unsigned long)")
}
...
// was: RBX::FriendService::FriendEventType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::FriendService::FriendEventType *,RBX::FriendService::FriendEventType *>(RBX::FriendService::FriendEventType *,RBX::FriendService::FriendEventType *,RBX::FriendService::FriendEventType *)
pub fn stub_83e7d8() -> ! {
    todo!("0x83e7d8 RBX::FriendService::FriendEventType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::FriendService::FriendEventType *,RBX::FriendService::FriendEventType *>(RBX::FriendService::FriendEventType *,RBX::FriendService::FriendEventType *,RBX::FriendService::FriendEventType *)")
}
...
// was: std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendEventType*,std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>>,unsigned long,RBX::FriendService::FriendEventType const&)
pub fn stub_83e814() -> ! {
    todo!("0x83e814 std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendEventType*,std::vector<RBX::FriendService::FriendEventType,std::allocator<RBX::FriendService::FriendEventType>>>,unsigned long,RBX::FriendService::FriendEventType const&)")
}
...
// was: std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::resize(unsigned long,RBX::FriendService::FriendStatus)
pub fn stub_83e9a4() -> ! {
    todo!("0x83e9a4 std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::resize(unsigned long,RBX::FriendService::FriendStatus)")
}
...
// was: std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::push_back(RBX::FriendService::FriendStatus const&)
pub fn stub_83e9d8() -> ! {
    todo!("0x83e9d8 std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::push_back(RBX::FriendService::FriendStatus const&)")
}
...
// was: std::map<RBX::Name const*,RBX::FriendService::FriendStatus,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::operator[](RBX::Name const* const&)
pub fn stub_83ea00() -> ! {
    todo!("0x83ea00 std::map<RBX::Name const*,RBX::FriendService::FriendStatus,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::operator[](RBX::Name const* const&)")
}
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus> const&)
pub fn stub_83ea58() -> ! {
    todo!("0x83ea58 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus> const&)")
}
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus> const&)
pub fn stub_83eb0c() -> ! {
    todo!("0x83eb0c std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus> const&)")
}
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus> const&)
pub fn stub_83eb64() -> ! {
    todo!("0x83eb64 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::FriendService::FriendStatus> const&)")
}
...
// was: std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendStatus*,std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>>,RBX::FriendService::FriendStatus const&)
pub fn stub_83ebcc() -> ! {
    todo!("0x83ebcc std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendStatus*,std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>>,RBX::FriendService::FriendStatus const&)")
}
...
// was: std::_Vector_base<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::_M_allocate(unsigned long)
pub fn stub_83ecb0() -> ! {
    todo!("0x83ecb0 std::_Vector_base<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::_M_allocate(unsigned long)")
}
...
// was: RBX::FriendService::FriendStatus * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::FriendService::FriendStatus *,RBX::FriendService::FriendStatus *>(RBX::FriendService::FriendStatus *,RBX::FriendService::FriendStatus *,RBX::FriendService::FriendStatus *)
pub fn stub_83ecc8() -> ! {
    todo!("0x83ecc8 RBX::FriendService::FriendStatus * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::FriendService::FriendStatus *,RBX::FriendService::FriendStatus *>(RBX::FriendService::FriendStatus *,RBX::FriendService::FriendStatus *,RBX::FriendService::FriendStatus *)")
}
...
// was: std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendStatus*,std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>>,unsigned long,RBX::FriendService::FriendStatus const&)
pub fn stub_83ed04() -> ! {
    todo!("0x83ed04 std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::FriendService::FriendStatus*,std::vector<RBX::FriendService::FriendStatus,std::allocator<RBX::FriendService::FriendStatus>>>,unsigned long,RBX::FriendService::FriendStatus const&)")
}
...
// was: RBX::Reflection::RemoteEventDescImpl<3,RBX::FriendService,void ()(int,int,RBX::FriendService::FriendStatus),rbx::remote_signal<void ()(int,int,RBX::FriendService::FriendStatus)>>::replicateEvent(RBX::Reflection::EventSource *,int,int,RBX::FriendService::FriendStatus)
pub fn stub_83ee94() -> ! {
...
// was: rbx::signals::signal_with_args<3,void ()(int,int,RBX::FriendService::FriendStatus)>::operator()(int,int,RBX::FriendService::FriendStatus)
pub fn stub_83f028() -> ! {
    todo!("0x83f028 rbx::signals::signal_with_args<3,void ()(int,int,RBX::FriendService::FriendStatus)>::operator()(int,int,RBX::FriendService::FriendStatus)")
}
...
pub fn stub_83f174() -> ! {
    todo!("0x83f174 rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::next(boost::intrusive_ptr<rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::slot> &)")
}
...
// was: rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::on_error(std::exception &)
pub fn stub_83f2d4() -> ! {
    todo!("0x83f2d4 rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::on_error(std::exception &)")
}
...
pub fn stub_83f2fc() -> ! {
    todo!("0x83f2fc boost::intrusive_ptr<rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::slot> const&)")
}
...
// was: rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::safe_static_init_mutex(void)
pub fn stub_83f320() -> ! {
    todo!("0x83f320 rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::safe_static_init_mutex(void)")
}
...
// was: rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::safe_static_do_get_mutex(void)
pub fn stub_83f324() -> ! {
    todo!("0x83f324 rbx::signals::signal<void ()(int,int,RBX::FriendService::FriendStatus)>::safe_static_do_get_mutex(void)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::_M_erase(std::_Rb_tree_node<std::pair<int const,RBX::FriendService::FriendStatus>> *)
pub fn stub_83f41c() -> ! {
    todo!("0x83f41c std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::_M_erase(std::_Rb_tree_node<std::pair<int const,RBX::FriendService::FriendStatus>> *)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::_Rb_tree(std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>> const&)
pub fn stub_83f444() -> ! {
    todo!("0x83f444 std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::_Rb_tree(std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>> const&)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::_M_copy(std::_Rb_tree_node<std::pair<int const,RBX::FriendService::FriendStatus>> const*,std::_Rb_tree_node<std::pair<int const,RBX::FriendService::FriendStatus>>*)
pub fn stub_83f488() -> ! {
    todo!("0x83f488 std::_Rb_tree<int,std::pair<int const,RBX::FriendService::FriendStatus>,std::_Select1st<std::pair<int const,RBX::FriendService::FriendStatus>>,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>::_M_copy(std::_Rb_tree_node<std::pair<int const,RBX::FriendService::FriendStatus>> const*,std::_Rb_tree_node<std::pair<int const,RBX::FriendService::FriendStatus>>*)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)
pub fn stub_83f5dc() -> ! {
    todo!("0x83f5dc std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)
pub fn stub_83f690() -> ! {
    todo!("0x83f690 std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_insert_unique(std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)
pub fn stub_83f6dc() -> ! {
    todo!("0x83f6dc std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_insert_unique(std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_create_node(std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)
pub fn stub_83f744() -> ! {
    todo!("0x83f744 std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::_M_create_node(std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>> const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE5eraseERKi")]
// was: std::_Rb_tree<int,int,std::_Identity<int>,std::less<int>,std::allocator<int>>::erase(int const&)
pub fn stub_83f828() -> ! {
    todo!("0x83f828 std::_Rb_tree<int,int,std::_Identity<int>,std::less<int>,std::allocator<int>>::erase(int const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE11equal_rangeERKi")]
// was: std::_Rb_tree<int,int,std::_Identity<int>,std::less<int>,std::allocator<int>>::equal_range(int const&)
pub fn stub_83f850() -> ! {
    todo!("0x83f850 std::_Rb_tree<int,int,std::_Identity<int>,std::less<int>,std::allocator<int>>::equal_range(int const&)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeIiiSt9_IdentityIiESt4lessIiESaIiEE5eraseESt17_Rb_tree_iteratorIiES7_")]
// was: std::_Rb_tree<int,int,std::_Identity<int>,std::less<int>,std::allocator<int>>::erase(std::_Rb_tree_iterator<int>,std::_Rb_tree_iterator<int>)
pub fn stub_83f89c() -> ! {
    todo!("0x83f89c std::_Rb_tree<int,int,std::_Identity<int>,std::less<int>,std::allocator<int>>::erase(std::_Rb_tree_iterator<int>,std::_Rb_tree_iterator<int>)")
}
...
// was: std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::erase(std::_Rb_tree_iterator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>)
pub fn stub_83f8fc() -> ! {
    todo!("0x83f8fc std::_Rb_tree<int,std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>,std::_Select1st<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>,std::less<int>,std::allocator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>>::erase(std::_Rb_tree_iterator<std::pair<int const,std::map<int,RBX::FriendService::FriendStatus,std::less<int>,std::allocator<std::pair<int const,RBX::FriendService::FriendStatus>>>>>)")
}
...
// was: __ZN5boost8functionIFvPSsPSt9exceptionEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrIN3RBX13FriendServiceEEEiSt3setIiSt4lessIiESaIiEES1_S3_ENS7_5list5INS7_5valueISC_EENSL_IiEENSL_ISH_EENS_3argILi1EEENSP_ILi2EEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISU_EE5valueEEE5valueEiE4typeE
pub fn stub_83f928() -> ! {
    todo!("0x83f928 __ZN5boost8functionIFvPSsPSt9exceptionEEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrIN3RBX13FriendServiceEEEiSt3setIiSt4lessIiESaIiEES1_S3_ENS7_5list5INS7_5valueISC_EENSL_IiEENSL_ISH_EENS_3argILi1EEENSP_ILi2EEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISU_EE5valueEEE5valueEiE4typeE")
}
...
// was: __ZN5boost9function2IvPSsPSt9exceptionEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrIN3RBX13FriendServiceEEEiSt3setIiSt4lessIiESaIiEES1_S3_ENS6_5list5INS6_5valueISB_EENSK_IiEENSK_ISG_EENS_3argILi1EEENSO_ILi2EEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralIST_EE5valueEEE5valueEiE4typeE
pub fn stub_83fa84() -> ! {
    todo!("0x83fa84 __ZN5boost9function2IvPSsPSt9exceptionEC2INS_3_bi6bind_tIvPFvNS_8weak_ptrIN3RBX13FriendServiceEEEiSt3setIiSt4lessIiESaIiEES1_S3_ENS6_5list5INS6_5valueISB_EENSK_IiEENSK_ISG_EENS_3argILi1EEENSO_ILi2EEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralIST_EE5valueEEE5valueEiE4typeE")
}
...
pub fn stub_83fbe4() -> ! {
    todo!("0x83fbe4 void boost::function2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::FriendService>>,boost::_bi::value<int>,boost::_bi::value<std::set<int,std::less<int>,std::allocator<int>>>,boost::arg<1>,boost::arg<2>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::FriendService>>,boost::_bi::value<int>,boost::_bi::value<std::set<int,std::less<int>,std::allocator<int>>>,boost::arg<1>,boost::arg<2>>>)")
}
...
// was: bool boost::detail::function::basic_vtable2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::FriendService>>,boost::_bi::value<int>,boost::_bi::value<std::set<int,std::less<int>,std::allocator<int>>>,boost::arg<1>,boost::arg<2>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::FriendService>>,boost::_bi::value<int>,boost::_bi::value<std::set<int,std::less<int>,std::allocator<int>>>,boost::arg<1>,boost::arg<2>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const
pub fn stub_83fef0() -> ! {
    todo!("0x83fef0 bool boost::detail::function::basic_vtable2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::FriendService>>,boost::_bi::value<int>,boost::_bi::value<std::set<int,std::less<int>,std::allocator<int>>>,boost::arg<1>,boost::arg<2>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::FriendService>,int,std::set<int,std::less<int>,std::allocator<int>>,std::string *,std::exception *),boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::FriendService>>,boost::_bi::value<int>,boost::_bi::value<std::set<int,std::less<int>,std::allocator<int>>>,boost::arg<1>,boost::arg<2>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")
}
