...
pub fn stub_884390() -> ! {
    todo!("0x884390 RBX::Allocator<RBX::PolyCellContact>::releaseMemory(void)")
}
...
pub fn stub_8843ac() -> ! {
    todo!("0x8843ac boost::singleton_pool<RBX::PolyCellContact,232u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::release_memory(void)")
}
...
pub fn stub_8843dc() -> ! {
    todo!("0x8843dc RBX::Allocator<RBX::EdgeEdgeConnector>::Allocator(void)")
}
...
pub fn stub_884440() -> ! {
    todo!("0x884440 RBX::EdgeEdgeConnector::getConnectorType(void)const")
}
...
pub fn stub_884444() -> ! {
    todo!("0x884444 RBX::Allocator<RBX::EdgeEdgeConnector>::releaseMemory(void)")
}
...
pub fn stub_884460() -> ! {
    todo!("0x884460 boost::singleton_pool<RBX::EdgeEdgeConnector,328u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::release_memory(void)")
}
...
pub fn stub_884490() -> ! {
    todo!("0x884490 RBX::PolyCellPair::~PolyCellPair()")
}
...
pub fn stub_884494() -> ! {
    todo!("0x884494 RBX::PolyCellPair::~PolyCellPair()")
}
...
pub fn stub_884498() -> ! {
    todo!("0x884498 RBX::Allocator<RBX::FaceEdgeConnector>::Allocator(void)")
}
...
pub fn stub_8844fc() -> ! {
    todo!("0x8844fc RBX::FaceEdgeConnector::getConnectorType(void)const")
}
...
pub fn stub_884500() -> ! {
    todo!("0x884500 RBX::Allocator<RBX::FaceEdgeConnector>::releaseMemory(void)")
}
...
pub fn stub_88451c() -> ! {
    todo!("0x88451c boost::singleton_pool<RBX::FaceEdgeConnector,368u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::release_memory(void)")
}
...
pub fn stub_88454c() -> ! {
    todo!("0x88454c RBX::Allocator<RBX::FaceVertexConnector>::Allocator(void)")
}
...
pub fn stub_8845b0() -> ! {
    todo!("0x8845b0 RBX::FaceVertexConnector::getConnectorType(void)const")
}
...
pub fn stub_8845b4() -> ! {
    todo!("0x8845b4 RBX::Allocator<RBX::FaceVertexConnector>::releaseMemory(void)")
}
...
pub fn stub_8845d0() -> ! {
    todo!("0x8845d0 boost::singleton_pool<RBX::FaceVertexConnector,304u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::release_memory(void)")
}
...
pub fn stub_884c40() -> ! {
    todo!("0x884c40 RBX::PluginManager::createPlugin(void)")
}
...
pub fn stub_885030() -> ! {
    todo!("0x885030 RBX::Plugin::activate(bool)")
}
...
pub fn stub_885068() -> ! {
    todo!("0x885068 RBX::Plugin::createToolbar(std::string)")
}
...
pub fn stub_885190() -> ! {
    todo!("0x885190 RBX::Toolbar::createButton(std::string,std::string,std::string)")
}
...
pub fn stub_8855bc() -> ! {
    todo!("0x8855bc RBX::Button::setActive(bool)")
}
...
pub fn stub_8856ec() -> ! {
    todo!("0x8856ec RBX::Button::Button(void)")
}
...
pub fn stub_885880() -> ! {
    todo!("0x885880 RBX::Toolbar::reset(void)")
}
...
pub fn stub_8858a4() -> ! {
    todo!("0x8858a4 RBX::PluginManager::singleton(void)")
}
...
pub fn stub_8858cc() -> ! {
    todo!("0x8858cc RBX::Toolbar::Toolbar(void)")
}
...
pub fn stub_885a20() -> ! {
    todo!("0x885a20 RBX::Toolbar::getButton(void *)")
}
...
pub fn stub_885a60() -> ! {
    todo!("0x885a60 RBX::Plugin::Plugin(void)")
}
...
pub fn stub_885c04() -> ! {
    todo!("0x885c04 RBX::Plugin::~Plugin()")
}
...
pub fn stub_885ca4() -> ! {
    todo!("0x885ca4 RBX::Plugin::~Plugin()")
}
...
pub fn stub_885ca8() -> ! {
    todo!("0x885ca8 non-virtual thunk toRBX::Plugin::~Plugin()")
}
...
pub fn stub_885cb0() -> ! {
    todo!("0x885cb0 non-virtual thunk toRBX::Plugin::~Plugin()")
}
...
pub fn stub_885cb8() -> ! {
    todo!("0x885cb8 RBX::Plugin::~Plugin()")
}
...
pub fn stub_885df0() -> ! {
    todo!("0x885df0 non-virtual thunk toRBX::Plugin::~Plugin()")
}
...
pub fn stub_885df8() -> ! {
    todo!("0x885df8 non-virtual thunk toRBX::Plugin::~Plugin()")
}
...
pub fn stub_885edc() -> ! {
    todo!("0x885edc RBX::PluginManager::PluginManager(void)")
}
...
pub fn stub_886368() -> ! {
    todo!("0x886368 RBX::PluginManager::DeactivatePlugins(void)")
}
...
pub fn stub_886388() -> ! {
    todo!("0x886388 non-virtual thunk toRBX::PluginManager::DeactivatePlugins(void)")
}
...
pub fn stub_8865c8() -> ! {
    todo!("0x8865c8 RBX::PluginManager::StateDataEntry::getToolbar(std::string,RBX::IStudioPluginHost *)")
}
...
pub fn stub_886808() -> ! {
    todo!("0x886808 RBX::PluginManager::StateDataEntry::hideStudioUI(bool,RBX::IStudioPluginHost *)")
}
...
pub fn stub_886950() -> ! {
    todo!("0x886950 RBX::PluginManager::StateDataEntry::fireButtonClick(void *)")
}
...
pub fn stub_886984() -> ! {
    todo!("0x886984 RBX::PluginManager::createToolbar(RBX::Plugin *,std::string)")
}
...
pub fn stub_886b40() -> ! {
    todo!("0x886b40 non-virtual thunk toRBX::PluginManager::createToolbar(RBX::Plugin *,std::string)")
}
...
pub fn stub_886cb8() -> ! {
    todo!("0x886cb8 RBX::Reflection::BoundFuncDesc<RBX::PluginManager,boost::shared_ptr<RBX::Instance> ()(void),0>::~BoundFuncDesc()")
}
...
pub fn stub_886cdc() -> ! {
    todo!("0x886cdc RBX::Reflection::BoundFuncDesc<RBX::Plugin,boost::shared_ptr<RBX::Instance> ()(void),0>::~BoundFuncDesc()")
}
...
pub fn stub_886d64() -> ! {
    todo!("0x886d64 RBX::Reflection::BoundFuncDesc<RBX::Plugin,boost::shared_ptr<RBX::Instance> ()(std::string),1>::~BoundFuncDesc()")
}
...
pub fn stub_886da4() -> ! {
    todo!("0x886da4 RBX::Reflection::BoundFuncDesc<RBX::Toolbar,boost::shared_ptr<RBX::Instance> ()(std::string,std::string,std::string),3>::~BoundFuncDesc()")
}
...
pub fn stub_886e58() -> ! {
    todo!("0x886e58 boost::shared_ptr<RBX::PluginManager>::~shared_ptr()")
}
...
pub fn stub_886e6c() -> ! {
    todo!("0x886e6c boost::shared_ptr<RBX::Button> RBX::Creatable<RBX::Instance>::create<RBX::Button>(void)")
}
...
pub fn stub_886f1c() -> ! {
    todo!("0x886f1c std::map<void *,boost::shared_ptr<RBX::Button>,std::less<void *>,std::allocator<std::pair<void * const,boost::shared_ptr<RBX::Button>>>>::operator[](void * const&)")
}
...
pub fn stub_887064() -> ! {
    todo!("0x887064 boost::shared_ptr<RBX::Button>::operator=(boost::shared_ptr<RBX::Button> const&)")
}
...
pub fn stub_88709c() -> ! {
    todo!("0x88709c boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::PluginMouse>(boost::shared_ptr<RBX::PluginMouse> const&)")
}
...
pub fn stub_8870d0() -> ! {
    todo!("0x8870d0 boost::shared_ptr<RBX::PluginMouse> RBX::Creatable<RBX::Instance>::create<RBX::PluginMouse>(void)")
}
...
pub fn stub_887180() -> ! {
    todo!("0x887180 boost::shared_ptr<RBX::Plugin> RBX::Creatable<RBX::Instance>::create<RBX::Plugin>(void)")
}
...
pub fn stub_887230() -> ! {
    todo!("0x887230 boost::shared_ptr<RBX::Toolbar> RBX::Creatable<RBX::Instance>::create<RBX::Toolbar>(void)")
}
...
pub fn stub_8872e0() -> ! {
    todo!("0x8872e0 std::map<std::string,boost::shared_ptr<RBX::Toolbar>,std::less<std::string>,std::allocator<std::pair<std::string const,boost::shared_ptr<RBX::Toolbar>>>>::operator[](std::string const&)")
}
...
pub fn stub_8874fc() -> ! {
    todo!("0x8874fc boost::shared_ptr<RBX::Toolbar>::operator=(boost::shared_ptr<RBX::Toolbar> const&)")
}
...
pub fn stub_887534() -> ! {
    todo!("0x887534 RBX::PluginManager::~PluginManager()")
}
...
pub fn stub_887538() -> ! {
    todo!("0x887538 RBX::PluginManager::~PluginManager()")
}
...
pub fn stub_887600() -> ! {
    todo!("0x887600 non-virtual thunk toRBX::PluginManager::~PluginManager()")
}
...
pub fn stub_887608() -> ! {
    todo!("0x887608 non-virtual thunk toRBX::PluginManager::~PluginManager()")
}
...
pub fn stub_8876d4() -> ! {
    todo!("0x8876d4 non-virtual thunk toRBX::PluginManager::~PluginManager()")
}
...
pub fn stub_8876dc() -> ! {
    todo!("0x8876dc non-virtual thunk toRBX::PluginManager::~PluginManager()")
}
...
pub fn stub_8877ac() -> ! {
    todo!("0x8877ac RBX::Button::~Button()")
}
...
pub fn stub_8878c0() -> ! {
    todo!("0x8878c0 RBX::Button::~Button()")
}
...
pub fn stub_8879f8() -> ! {
    todo!("0x8879f8 non-virtual thunk toRBX::Button::~Button()")
}
...
pub fn stub_887b08() -> ! {
    todo!("0x887b08 non-virtual thunk toRBX::Button::~Button()")
}
...
pub fn stub_887c40() -> ! {
    todo!("0x887c40 non-virtual thunk toRBX::Button::~Button()")
}
...
pub fn stub_887d50() -> ! {
    todo!("0x887d50 non-virtual thunk toRBX::Button::~Button()")
}
...
pub fn stub_887e78() -> ! {
    todo!("0x887e78 RBX::Toolbar::~Toolbar()")
}
...
pub fn stub_887f64() -> ! {
    todo!("0x887f64 RBX::Toolbar::~Toolbar()")
}
...
pub fn stub_888070() -> ! {
    todo!("0x888070 non-virtual thunk toRBX::Toolbar::~Toolbar()")
}
...
pub fn stub_888158() -> ! {
    todo!("0x888158 non-virtual thunk toRBX::Toolbar::~Toolbar()")
}
...
pub fn stub_888268() -> ! {
    todo!("0x888268 non-virtual thunk toRBX::Toolbar::~Toolbar()")
}
...
pub fn stub_888350() -> ! {
    todo!("0x888350 non-virtual thunk toRBX::Toolbar::~Toolbar()")
}
...
pub fn stub_888450() -> ! {
    todo!("0x888450 std::_Rb_tree<void *,std::pair<void * const,boost::shared_ptr<RBX::Button>>,std::_Select1st<std::pair<void * const,boost::shared_ptr<RBX::Button>>>,std::less<void *>,std::allocator<std::pair<void * const,boost::shared_ptr<RBX::Button>>>>::_M_erase(std::_Rb_tree_node<std::pair<void * const,boost::shared_ptr<RBX::Button>>> *)")
}
