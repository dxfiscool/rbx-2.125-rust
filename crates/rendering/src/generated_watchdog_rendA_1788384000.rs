//! rendering — generated_watchdog_rendA_1788384000 — 100 stubs Ogre|G3D|Render EA-sorted asc, globally deduped via /tmp/global_eas.txt
//! Source: ida/export.json (85545 funcs) filter Ogre|G3D|Render, skip EAs in /tmp/global_eas.txt — next 100 EA-sorted asc
...
pub fn stub_8e12cc() -> ! {
    todo!("0x8e12cc RBX::GuiBase2d::recalculateAbsoluteSizeAndPosition(G3D::Rect2D const&)")
}
...
pub fn stub_8e13a4() -> ! {
    todo!("0x8e13a4 RBX::GuiBase2d::setAbsolutePosition(G3D::Vector2 const&)")
}
...
pub fn stub_8e13f0() -> ! {
    todo!("0x8e13f0 RBX::GuiBase2d::setAbsoluteSize(G3D::Vector2 const&)")
}
...
pub fn stub_8e158c() -> ! {
    todo!("0x8e158c RBX::GuiBase2d::handleResize(G3D::Rect2D const&,bool)")
}
...
pub fn stub_8e997c() -> ! {
    todo!("0x8e997c RBX::Voxel::Grid::getVoxelLikelyThisChunk(RBX::SpatialRegion::Id const&,RBX::Voxel::Grid::Chunk const&,G3D::Vector3int16 const&)const")
}
...
pub fn stub_8e9a08() -> ! {
    todo!("0x8e9a08 RBX::Voxel::Grid::fillLocalAreaInfo(G3D::Vector3int16 const&,RBX::Voxel::Water::RelevantNeighbors const&,RBX::Voxel::Water::LocalAreaInfo *)const")
}
...
pub fn stub_8e9cd0() -> ! {
    todo!("0x8e9cd0 RBX::Voxel::Grid::setCell(G3D::Vector3int16 const&,RBX::Voxel::Cell,RBX::Voxel::CellMaterial)")
}
...
pub fn stub_8e9f34() -> ! {
    todo!("0x8e9f34 RBX::Voxel::Grid::getRegion(G3D::Vector3int16 const&,G3D::Vector3int16 const&)const")
}
...
pub fn stub_8ea008() -> ! {
    todo!("0x8ea008 RBX::Voxel::Grid::getCellInternal(G3D::Vector3int16 const&)const")
}
...
pub fn stub_8ea068() -> ! {
    todo!("0x8ea068 RBX::Voxel::Grid::getCellMaterialInternal(G3D::Vector3int16 const&)const")
}
...
pub fn stub_8ea0dc() -> ! {
    todo!("0x8ea0dc RBX::Voxel::Grid::getWaterCellInternal(G3D::Vector3int16 const&)const")
}
...
pub fn stub_8ea2f0() -> ! {
    todo!("0x8ea2f0 bool RBX::Voxel::Water::cellHasWater<RBX::Voxel::Grid::Chunk>(RBX::Voxel::Grid::Chunk const*,RBX::Voxel::Cell const&,G3D::Vector3int16 const&)")
}
...
pub fn stub_8ed314() -> ! {
    todo!("0x8ed314 RBX::OnScreenProfiler::GetRandomColor(G3D::Color4 *)")
}
...
pub fn stub_8f1c30() -> ! {
    todo!("0x8f1c30 RBX::OnScreenProfiler::AddText(RBX::Adorn *,char const*,float &,float,float,float,G3D::Color4 const&,G3D::Vector2 *)")
}
...
pub fn stub_8f2008() -> ! {
    todo!("0x8f2008 RBX::OnScreenProfiler::DrawBar(RBX::Adorn *,G3D::Vector2 &,float,G3D::Color4 const&,G3D::Color4 const&,float,float)")
}
...
pub fn stub_949adc() -> ! {
    todo!("0x949adc RBX::RbxRay::intersectionPlane(G3D::Plane const&)const")
}
...
pub fn stub_949be4() -> ! {
    todo!("0x949be4 RBX::RbxG3D::SpecData::SpecData(void)")
}
...
pub fn stub_949bf0() -> ! {
    todo!("0x949bf0 RBX::RbxG3D::SpecData::SpecData(void)")
}
...
pub fn stub_949d08() -> ! {
    todo!("0x949d08 RBX::Frustum::Frustum(G3D::Vector3 const&,G3D::Vector3 const&,G3D::Vector3 const&,float,float,float,float)")
}
...
pub fn stub_949d40() -> ! {
    todo!("0x949d40 RBX::Frustum::Frustum(G3D::Vector3 const&,G3D::Vector3 const&,G3D::Vector3 const&,float,float,float,float)")
}
...
pub fn stub_94a45c() -> ! {
    todo!("0x94a45c RBX::Frustum::containsPoint(G3D::Vector3 const&)const")
}
...
pub fn stub_94a548() -> ! {
    todo!("0x94a548 RBX::Frustum::containsAABB(RBX::Extents const&,G3D::CoordinateFrame const&)const")
}
...
pub fn stub_94a620() -> ! {
    todo!("0x94a620 RBX::Frustum::intersectsSphere(G3D::Vector3 const&,float)const")
}
...
pub fn stub_94b738() -> ! {
    todo!("0x94b738 RBX::DrawAdorn::cylinder(RBX::Adorn *,G3D::CoordinateFrame const&,int,float,float,G3D::Color4 const&,bool)")
}
...
pub fn stub_94b79c() -> ! {
    todo!("0x94b79c RBX::DrawAdorn::surfaceBorder(RBX::Adorn *,G3D::Vector3 const&,float,int,G3D::Color4 const&)")
}
...
pub fn stub_94b974() -> ! {
    todo!("0x94b974 RBX::DrawAdorn::surfaceGridAtCoord(RBX::Adorn *,G3D::CoordinateFrame &,G3D::Vector4 const&,G3D::Vector3 const&,G3D::Vector3 const&,G3D::Color4 const&,int)")
}
