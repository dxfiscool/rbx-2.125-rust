...
pub fn stub_b58340() -> ! {
    todo!("0xb58340 RBX::Network::Replicator::ItemSender::~ItemSender()")
}
...
pub fn stub_b58408() -> ! {
    todo!("0xb58408 RBX::Network::Replicator::ItemSender::send(RBX::Network::Item &)")
}
...
pub fn stub_b58444() -> ! {
    todo!("0xb58444 RBX::Network::Replicator::ItemSender::getNumberOfBytesUsed(void)const")
}
...
pub fn stub_b58ea8() -> ! {
    todo!("0xb58ea8 RBX::Network::Replicator::ReferencePropertyChangedItem::~ReferencePropertyChangedItem()")
}
...
#[doc(alias = "RBX::Network::Replicator::ReferencePropertyChangedItem::~ReferencePropertyChangedItem()")]
pub fn stub_b58ecc() -> ! {
    todo!("0xb58ecc RBX::Network::Replicator::ReferencePropertyChangedItem::~ReferencePropertyChangedItem()")
}
...
pub fn stub_b599c8() -> ! {
    todo!("0xb599c8 RBX::Network::Replicator::StreamJob::StreamRegionIterator::sortNextNRegions(unsigned int)")
}
...
pub fn stub_b59af0() -> ! {
    todo!("0xb59af0 RBX::Network::Replicator::StreamJob::StreamRegionIterator::updateWorldExtents(void)")
}
...
pub fn stub_b59db4() -> ! {
    todo!("0xb59db4 RBX::Network::Replicator::StreamJob::StreamRegionIterator::getNextRegion(RBX::StreamRegion::Id &)")
}
...
pub fn stub_b59f98() -> ! {
    todo!("0xb59f98 RBX::Network::Replicator::StreamJob::StreamJob(RBX::Network::Replicator&)")
}
...
#[doc(alias = "RBX::Network::Replicator::StreamJob::StreamJob(RBX::Network::Replicator&)")]
pub fn stub_b59fa4() -> ! {
    todo!("0xb59fa4 RBX::Network::Replicator::StreamJob::StreamJob(RBX::Network::Replicator&)")
}
...
pub fn stub_b5a4b8() -> ! {
    todo!("0xb5a4b8 RBX::Network::Replicator::StreamJob::~StreamJob()")
}
...
#[doc(alias = "RBX::Network::Replicator::StreamJob::~StreamJob()")]
pub fn stub_b5a558() -> ! {
    todo!("0xb5a558 RBX::Network::Replicator::StreamJob::~StreamJob()")
}
...
#[doc(alias = "RBX::Network::Replicator::StreamJob::~StreamJob()")]
pub fn stub_b5a564() -> ! {
    todo!("0xb5a564 RBX::Network::Replicator::StreamJob::~StreamJob()")
}
...
pub fn stub_b5a950() -> ! {
    todo!("0xb5a950 RBX::Network::Replicator::StreamJob::clearPendingItems(void)")
}
...
pub fn stub_b5aa14() -> ! {
    todo!("0xb5aa14 RBX::Network::Replicator::StreamJob::updateClientQuota(int,short)")
}
...
pub fn stub_b5ad04() -> ! {
    todo!("0xb5ad04 RBX::Network::Replicator::StreamJob::isInitialDataCollected(void)const")
}
...
pub fn stub_b5adec() -> ! {
    todo!("0xb5adec RBX::Network::Replicator::StreamJob::isRegionInPendingStreamItemQueue(RBX::StreamRegion::Id const&)const")
}
...
pub fn stub_b5ae38() -> ! {
    todo!("0xb5ae38 RBX::Network::Replicator::StreamJob::isInStreamedRegions(RBX::Extents const&)")
}
...
pub fn stub_b5b71c() -> ! {
    todo!("0xb5b71c RBX::Network::Replicator::StreamJob::setupListeners(RBX::Network::Player *)")
}
...
pub fn stub_b5bf08() -> ! {
    todo!("0xb5bf08 RBX::Network::Replicator::StreamJob::adjustSimulationOwnershipRange(RBX::Region2::WeightedPoint *)")
}
...
pub fn stub_b5bf90() -> ! {
    todo!("0xb5bf90 RBX::Network::Replicator::StreamJob::error(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b5d1a4() -> ! {
    todo!("0xb5d1a4 RBX::Network::Replicator::StreamJob::sendPackets(int)")
}
...
pub fn stub_b5e218() -> ! {
    todo!("0xb5e218 RBX::Network::Replicator::StreamJob::coarsePrimitiveMovement(RBX::Primitive *,RBX::SpatialHash<RBX::Primitive,RBX::Contact,RBX::ContactManager,4>::CoarseMovementCallback::UpdateInfo const&)")
}
...
pub fn stub_b5f4dc() -> ! {
    todo!("0xb5f4dc RBX::Network::Replicator::StreamJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b60388() -> ! {
    todo!("0xb60388 std::deque<RBX::Network::Replicator::StreamJob::StreamDataItem *,std::allocator<RBX::Network::Replicator::StreamJob::StreamDataItem *>>::_M_reallocate_map(unsigned long,bool)")
}
...
pub fn stub_b623b0() -> ! {
    todo!("0xb623b0 std::_Deque_base<RBX::Network::Replicator::StreamJob::StreamDataItem *,std::allocator<RBX::Network::Replicator::StreamJob::StreamDataItem *>>::_M_initialize_map(unsigned long)")
}
...
pub fn stub_b62598() -> ! {
    todo!("0xb62598 RBX::Network::Replicator::StreamJob::StreamDataItem::~StreamDataItem()")
}
...
#[doc(alias = "RBX::Network::Replicator::StreamJob::StreamDataItem::~StreamDataItem()")]
pub fn stub_b626d4() -> ! {
    todo!("0xb626d4 RBX::Network::Replicator::StreamJob::StreamDataItem::~StreamDataItem()")
}
...
pub fn stub_b628e0() -> ! {
    todo!("0xb628e0 RBX::Network::Replicator::JoinDataItem::~JoinDataItem()")
}
...
pub fn stub_b632d0() -> ! {
    todo!("0xb632d0 RBX::Network::ClientReplicator::GCJob::GCJob(RBX::Network::Replicator &)")
}
...
#[doc(alias = "RBX::Network::ClientReplicator::GCJob::GCJob(RBX::Network::Replicator &)")]
pub fn stub_b632dc() -> ! {
    todo!("0xb632dc RBX::Network::ClientReplicator::GCJob::GCJob(RBX::Network::Replicator &)")
}
...
pub fn stub_b63630() -> ! {
    todo!("0xb63630 RBX::Network::ClientReplicator::GCJob::~GCJob()")
}
...
#[doc(alias = "RBX::Network::ClientReplicator::GCJob::~GCJob()")]
pub fn stub_b636d0() -> ! {
    todo!("0xb636d0 RBX::Network::ClientReplicator::GCJob::~GCJob()")
}
...
#[doc(alias = "RBX::Network::ClientReplicator::GCJob::~GCJob()")]
pub fn stub_b636dc() -> ! {
    todo!("0xb636dc RBX::Network::ClientReplicator::GCJob::~GCJob()")
}
...
pub fn stub_b63b54() -> ! {
    todo!("0xb63b54 RBX::Network::ClientReplicator::GCJob::error(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b647e8() -> ! {
    todo!("0xb647e8 RBX::Network::ClientReplicator::GCJob::gcRegion(RBX::StreamRegion::Id const&,RBX::Network::ClientReplicator::GCJob::RegionRemovalItem *)")
}
...
pub fn stub_b64c68() -> ! {
    todo!("0xb64c68 RBX::Network::ClientReplicator::GCJob::insertRegion(RBX::StreamRegion::Id const&)")
}
...
pub fn stub_b64cb0() -> ! {
    todo!("0xb64cb0 RBX::Network::ClientReplicator::GCJob::coarsePrimitiveMovement(RBX::Primitive *,RBX::SpatialHash<RBX::Primitive,RBX::Contact,RBX::ContactManager,4>::CoarseMovementCallback::UpdateInfo const&)")
}
...
pub fn stub_b655f4() -> ! {
    todo!("0xb655f4 RBX::Network::ClientReplicator::GCJob::render3dAdorn(RBX::Adorn *)")
}
...
pub fn stub_b65764() -> ! {
    todo!("0xb65764 RBX::Network::ClientReplicator::GCJob::updateMaxRegionDistance(void)")
}
...
pub fn stub_b6597c() -> ! {
    todo!("0xb6597c void std::list<boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>,std::allocator<boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>>>::sort<bool (*)(boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>,boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>)>(bool (*)(boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>,boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>))")
}
...
pub fn stub_b66080() -> ! {
    todo!("0xb66080 bool RBX::StreamRegion::IdExtents::intersectsContainer<boost::unordered::unordered_map<RBX::StreamRegion::Id,RBX::Network::RegionInfo,RBX::StreamRegion::Id::boost_compatible_hash_value,std::equal_to<RBX::StreamRegion::Id>,std::allocator<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>>(boost::unordered::unordered_map<RBX::StreamRegion::Id,RBX::Network::RegionInfo,RBX::StreamRegion::Id::boost_compatible_hash_value,std::equal_to<RBX::StreamRegion::Id>,std::allocator<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>> const&,RBX::StreamRegion::Id*)const")
}
...
pub fn stub_b66aa8() -> ! {
    todo!("0xb66aa8 RBX::Network::ClientReplicator::GCJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b670bc() -> ! {
    todo!("0xb670bc std::pair<boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>,bool> boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>,RBX::StreamRegion::Id,RBX::Network::RegionInfo,RBX::StreamRegion::Id::boost_compatible_hash_value,std::equal_to<RBX::StreamRegion::Id>>>::emplace_impl<boost::unordered::detail::emplace_args1<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>>(RBX::StreamRegion::Id const&,boost::unordered::detail::emplace_args1<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>> const&)")
}
...
pub fn stub_b672f0() -> ! {
    todo!("0xb672f0 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>,RBX::StreamRegion::Id,RBX::Network::RegionInfo,RBX::StreamRegion::Id::boost_compatible_hash_value,std::equal_to<RBX::StreamRegion::Id>>>::reserve_for_insert(unsigned long)")
}
...
pub fn stub_b67498() -> ! {
    todo!("0xb67498 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>,RBX::StreamRegion::Id,RBX::Network::RegionInfo,RBX::StreamRegion::Id::boost_compatible_hash_value,std::equal_to<RBX::StreamRegion::Id>>>::create_buckets(unsigned long)")
}
...
pub fn stub_b6835c() -> ! {
    todo!("0xb6835c boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::StreamRegion::Id const,RBX::Network::RegionInfo>>,RBX::StreamRegion::Id,RBX::Network::RegionInfo,RBX::StreamRegion::Id::boost_compatible_hash_value,std::equal_to<RBX::StreamRegion::Id>>>::erase_key(RBX::StreamRegion::Id const&)")
}
...
pub fn stub_b685a8() -> ! {
    todo!("0xb685a8 RBX::Network::ClientReplicator::GCJob::RegionRemovalItem::~RegionRemovalItem()")
}
...
#[doc(alias = "RBX::Network::ClientReplicator::GCJob::RegionRemovalItem::~RegionRemovalItem()")]
pub fn stub_b685cc() -> ! {
    todo!("0xb685cc RBX::Network::ClientReplicator::GCJob::RegionRemovalItem::~RegionRemovalItem()")
}
