...
pub fn stub_b2ed78() -> ! {
    todo!("0xb2ed78 RBX::Reflection::BoundFuncDesc<RBX::Network::Replicator,boost::shared_ptr<RBX::Instance> ()(void),0>::~BoundFuncDesc()")
}
...
pub fn stub_b2ee54() -> ! {
    todo!("0xb2ee54 RBX::Reflection::BoundFuncDesc<RBX::Network::Replicator,boost::shared_ptr<RBX::Instance> ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_b2f510() -> ! {
    todo!("0xb2f510 RBX::Reflection::EventDescImpl<2,RBX::Network::Replicator,void ()(std::string,bool),rbx::signal<void ()(std::string,bool)>,rbx::signal<void ()(std::string,bool)> RBX::Network::Replicator::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_b32510() -> ! {
    todo!("0xb32510 RBX::Network::Replicator::PingJob::PingJob(RBX::Network::Replicator&)")
}
...
pub fn stub_b32864() -> ! {
    todo!("0xb32864 RBX::Network::Replicator::PingJob::~PingJob()")
}
...
#[doc(alias = "RBX::Network::Replicator::PingJob::~PingJob()")]
pub fn stub_b32930() -> ! {
    todo!("0xb32930 RBX::Network::Replicator::PingJob::~PingJob()")
}
...
pub fn stub_b32a10() -> ! {
    todo!("0xb32a10 RBX::Network::Replicator::PingJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b32a2c() -> ! {
    todo!("0xb32a2c RBX::Network::Replicator::PingJob::error(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b32b18() -> ! {
    todo!("0xb32b18 RBX::Network::Replicator::ProcessPacketsJob::ProcessPacketsJob(RBX::Network::Replicator&)")
}
...
pub fn stub_b32ed4() -> ! {
    todo!("0xb32ed4 RBX::Network::Replicator::ProcessPacketsJob::~ProcessPacketsJob()")
}
...
#[doc(alias = "RBX::Network::Replicator::ProcessPacketsJob::~ProcessPacketsJob()")]
pub fn stub_b32fa0() -> ! {
    todo!("0xb32fa0 RBX::Network::Replicator::ProcessPacketsJob::~ProcessPacketsJob()")
}
...
pub fn stub_b33080() -> ! {
    todo!("0xb33080 RBX::Network::Replicator::ProcessPacketsJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b33128() -> ! {
    todo!("0xb33128 RBX::Network::Replicator::ProcessPacketsJob::error(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b33f20() -> ! {
    todo!("0xb33f20 RBX::Network::Replicator::JoinDataItem::~JoinDataItem()")
}
...
pub fn stub_b34b1c() -> ! {
    todo!("0xb34b1c RBX::Network::PhysicsReceiver::start(boost::shared_ptr<RBX::Network::PhysicsReceiver>)")
}
...
pub fn stub_b34b20() -> ! {
    todo!("0xb34b20 RBX::Network::DirectPhysicsReceiver::~DirectPhysicsReceiver()")
}
...
#[doc(alias = "RBX::Network::DirectPhysicsReceiver::~DirectPhysicsReceiver()")]
pub fn stub_b34b44() -> ! {
    todo!("0xb34b44 RBX::Network::DirectPhysicsReceiver::~DirectPhysicsReceiver()")
}
...
pub fn stub_b34f70() -> ! {
    todo!("0xb34f70 RBX::Network::ReplicatorStats::~ReplicatorStats()")
}
...
pub fn stub_b35228() -> ! {
    todo!("0xb35228 RBX::Network::ReplicatorStats::PhysicsSenderStats::~PhysicsSenderStats()")
}
...
pub fn stub_b37590() -> ! {
    todo!("0xb37590 RBX::Network::PersistentDataStore::setNumber(std::string const&,double)")
}
...
pub fn stub_b376a4() -> ! {
    todo!("0xb376a4 RBX::Network::PersistentDataStore::getString(std::string const&)")
}
...
pub fn stub_b3778c() -> ! {
    todo!("0xb3778c RBX::Network::PersistentDataStore::setString(std::string const&,std::string const&)")
}
...
pub fn stub_b3786c() -> ! {
    todo!("0xb3786c RBX::Network::PersistentDataStore::getBoolean(std::string const&)")
}
...
pub fn stub_b3793c() -> ! {
    todo!("0xb3793c RBX::Network::PersistentDataStore::setBoolean(std::string const&,bool)")
}
...
pub fn stub_b37cd4() -> ! {
    todo!("0xb37cd4 RBX::Network::PersistentDataStore::setInstance(std::string const&,boost::shared_ptr<RBX::Instance>)")
}
...
pub fn stub_b39228() -> ! {
    todo!("0xb39228 RBX::Network::PhysicsPacketCache::PhysicsPacketCache(void)")
}
...
#[doc(alias = "RBX::Network::PhysicsPacketCache::PhysicsPacketCache(void)")]
pub fn stub_b39234() -> ! {
    todo!("0xb39234 RBX::Network::PhysicsPacketCache::PhysicsPacketCache(void)")
}
...
pub fn stub_b395fc() -> ! {
    todo!("0xb395fc RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
#[doc(alias = "RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")]
pub fn stub_b3969c() -> ! {
    todo!("0xb3969c RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
pub fn stub_b396a8() -> ! {
    todo!("0xb396a8 `non-virtual thunk to'RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
#[doc(alias = "non-virtual thunk toRBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")]
pub fn stub_b3974c() -> ! {
    todo!("0xb3974c `non-virtual thunk to'RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
#[doc(alias = "RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")]
pub fn stub_b397f0() -> ! {
    todo!("0xb397f0 RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
#[doc(alias = "non-virtual thunk toRBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")]
pub fn stub_b399ec() -> ! {
    todo!("0xb399ec `non-virtual thunk to'RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
#[doc(alias = "non-virtual thunk toRBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")]
pub fn stub_b399f8() -> ! {
    todo!("0xb399f8 `non-virtual thunk to'RBX::Network::PhysicsPacketCache::~PhysicsPacketCache()")
}
...
pub fn stub_b39a04() -> ! {
    todo!("0xb39a04 RBX::Network::PhysicsPacketCache::insert(RBX::Assembly const*)")
}
...
pub fn stub_b3a434() -> ! {
    todo!("0xb3a434 RBX::Network::PhysicsPacketCache::insertChildAssembly(RBX::Assembly const*)")
}
...
pub fn stub_b3ad00() -> ! {
    todo!("0xb3ad00 RBX::Network::PhysicsPacketCache::remove(RBX::Assembly const*)")
}
...
pub fn stub_b3af80() -> ! {
    todo!("0xb3af80 RBX::Network::PhysicsPacketCache::removeChildAssembly(RBX::Assembly const*)")
}
...
pub fn stub_b3bd24() -> ! {
    todo!("0xb3bd24 RBX::Network::PhysicsPacketCache::onAddingAssembly(boost::shared_ptr<RBX::Instance>)")
}
...
pub fn stub_b3c02c() -> ! {
    todo!("0xb3c02c RBX::Network::PhysicsPacketCache::onRemovedAssembly(boost::shared_ptr<RBX::Instance>)")
}
...
pub fn stub_b3cb4c() -> ! {
    todo!("0xb3cb4c RBX::Network::InstancePacketCache::onAncestorChanged(boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>)")
}
...
#[doc(alias = "rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>,rbx_core::SharedPtr<RBX::Instance>)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf2<void,RBX::Network::InstancePacketCache,rbx_core::SharedPtr<RBX::Instance>,rbx_core::SharedPtr<RBX::Instance>>,boost::_bi::list3<boost::_bi::value<RBX::Network::InstancePacketCache*>,boost::arg<1>,boost::arg<2>>>>::~callable_slot()")]
pub fn stub_b3f944() -> ! {
    todo!("0xb3f944 rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf2<void,RBX::Network::InstancePacketCache,boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>>,boost::_bi::list3<boost::_bi::value<RBX::Network::InstancePacketCache*>,boost::arg<1>,boost::arg<2>>>>::~callable_slot()")
}
...
pub fn stub_b3fa6c() -> ! {
    todo!("0xb3fa6c `non-virtual thunk to'rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf2<void,RBX::Network::InstancePacketCache,boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>>,boost::_bi::list3<boost::_bi::value<RBX::Network::InstancePacketCache*>,boost::arg<1>,boost::arg<2>>>,2,void ()(boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>)>::call(boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>)")
}
...
pub fn stub_b3fee0() -> ! {
    todo!("0xb3fee0 boost::_mfi::mf2<void,RBX::Network::InstancePacketCache,boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>>::operator()(RBX::Network::InstancePacketCache*,boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Instance>)const")
}
...
pub fn stub_b4068c() -> ! {
    todo!("0xb4068c boost::_bi::storage2<boost::_bi::value<boost::shared_ptr<RBX::Network::InstancePacketCache::CachedBitStream>>,boost::arg<1>>::storage2(boost::_bi::value<boost::shared_ptr<RBX::Network::InstancePacketCache::CachedBitStream>>,boost::arg<1>)")
}
...
pub fn stub_b40de8() -> ! {
    todo!("0xb40de8 void boost::detail::sp_pointer_construct<RBX::Network::InstancePacketCache::CachedBitStream,RBX::Network::InstancePacketCache::CachedBitStream>(boost::shared_ptr<RBX::Network::InstancePacketCache::CachedBitStream> *,RBX::Network::InstancePacketCache::CachedBitStream *,boost::detail::shared_count &)")
}
