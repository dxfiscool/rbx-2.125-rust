...
//! Batch: +100 stubs | range 0xa23780..0xa51130 | existing 16729 -> 16829 total (filler global ascending EA-sorted, rbx_core::SharedPtr not boost)
...
// demangled: std::map<RBX::Name const*,RBX::ICreator const*,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ICreator const*>>>::erase(RBX::Name const* const&)
...
pub fn stub_a239f0() -> ! {
    todo!("0xa239f0 std::map<RBX::Name const*,RBX::ICreator const*,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ICreator const*>>>::erase(RBX::Name const* const&)")
}

// 0xa23aa8 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX11LocalScriptENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// demangled: boost::detail::sp_counted_impl_pd<RBX::LocalScript *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
// type: void()
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::LocalScript *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::LocalScript *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::LocalScript *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::CylinderMesh *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
// type: int __fastcall(int)
...
// demangled: G3D::Array<RBX::Region2::WeightedPoint,10,32ul>::append(RBX::Region2::WeightedPoint const&)
...
// demangled: G3D::Array<RBX::Region2::WeightedPoint,10,32ul>::resize(int,bool)
...
// demangled: G3D::Array<RBX::Region2::WeightedPoint,10,32ul>::realloc(int)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::Teams *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
// type: int __fastcall(int, RBX::Instance *)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::Teams *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
// type: int __fastcall(int, int)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::Teams *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
// type: int __fastcall(int)
...
// demangled: RBX::Teams * RBX::ServiceProvider::find<RBX::Teams>(void)const
...
pub fn stub_a26b68() -> ! {
    todo!("0xa26b68 RBX::Teams * RBX::ServiceProvider::find<RBX::Teams>(void)const")
}

// 0xa27140 — __ZN3rbx7signals6signalIFvbiEE6insertEPNS3_4slotE
// demangled: rbx::signals::signal<void ()(bool,int)>::insert(rbx::signals::signal<void ()(bool,int)>::slot *)
...
pub fn stub_a27140() -> ! {
    todo!("0xa27140 rbx::signals::signal<void ()(bool,int)>::insert(rbx::signals::signal<void ()(bool,int)>::slot *)")
}

// 0xa27404 — __ZN3rbx7signals6signalIFvbiEE5mutexEv
// demangled: rbx::signals::signal<void ()(bool,int)>::mutex(void)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(bool,int)>::mutex(void)")]
pub fn stub_a27404() -> ! {
    todo!("0xa27404 rbx::signals::signal<void ()(bool,int)>::mutex(void)")
}
...
// demangled: rbx::signals::signal<void ()(bool,int)>::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(bool,int)>::safe_static_init_mutex(void)")]
pub fn stub_a27680() -> ! {
    todo!("0xa27680 rbx::signals::signal<void ()(bool,int)>::safe_static_init_mutex(void)")
}

// 0xa27828 — __ZN3rbx7signals6signalIFvbiEE4slot10disconnectEv
// demangled: rbx::signals::signal<void ()(bool,int)>::slot::disconnect(void)
...
pub fn stub_a27828() -> ! {
    todo!("0xa27828 rbx::signals::signal<void ()(bool,int)>::slot::disconnect(void)")
}

// 0xa279a8 — __ZNK3rbx7signals6signalIFvbiEE4slot9connectedEv
// demangled: rbx::signals::signal<void ()(bool,int)>::slot::connected(void)const
...
// demangled: rbx::signals::signal<void ()(bool,int)>::remove(rbx::signals::signal<void ()(bool,int)>::slot *)
...
pub fn stub_a27dc8() -> ! {
    todo!("0xa27dc8 rbx::signals::signal<void ()(bool,int)>::remove(rbx::signals::signal<void ()(bool,int)>::slot *)")
}

// 0xa27eb4 — __ZN3rbx7signals6signalIFvbiEE4slot22safe_static_init_mutexEv
// demangled: rbx::signals::signal<void ()(bool,int)>::slot::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(bool,int)>::slot::safe_static_init_mutex(void)")]
pub fn stub_a27eb4() -> ! {
    todo!("0xa27eb4 rbx::signals::signal<void ()(bool,int)>::slot::safe_static_init_mutex(void)")
}

// 0xa28234 — __ZN3rbx7signals6signalIFvbiEE4slotD1Ev
// demangled: rbx::signals::signal<void ()(bool,int)>::slot::~slot()
// type: int __fastcall(int)
#[doc(alias = "rbx::signals::signal<void ()(bool,int)>::slot::~slot()")]
pub fn stub_a28234() -> ! {
    todo!("0xa28234 rbx::signals::signal<void ()(bool,int)>::slot::~slot()")
}
...
#[doc(alias = "rbx::signals::signal<void ()(bool,int)>::slot::~slot()")]
pub fn stub_a28290() -> ! {
    todo!("0xa28290 rbx::signals::signal<void ()(bool,int)>::slot::~slot()")
}

// 0xa28398 — __ZN3rbx7signals6signalIFvvEE5mutexEv
// demangled: rbx::signals::signal<void ()(void)>::mutex(void)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(void)>::mutex(void)")]
pub fn stub_a28398() -> ! {
    todo!("0xa28398 rbx::signals::signal<void ()(void)>::mutex(void)")
}

// 0xa28848 — __ZN3rbx7signals6signalIFvSsEE6insertEPNS3_4slotE
// demangled: rbx::signals::signal<void ()(std::string)>::insert(rbx::signals::signal<void ()(std::string)>::slot *)
...
pub fn stub_a28848() -> ! {
    todo!("0xa28848 rbx::signals::signal<void ()(std::string)>::insert(rbx::signals::signal<void ()(std::string)>::slot *)")
}

// 0xa28b08 — __ZN3rbx7signals6signalIFvSsEE5mutexEv
// demangled: rbx::signals::signal<void ()(std::string)>::mutex(void)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string)>::mutex(void)")]
pub fn stub_a28b08() -> ! {
    todo!("0xa28b08 rbx::signals::signal<void ()(std::string)>::mutex(void)")
}
...
// demangled: rbx::signals::signal<void ()(std::string)>::slot::disconnect(void)
// type: void __fastcall(int, int, int, int, boost::mutex *, char, int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string)>::slot::disconnect(void)")]
pub fn stub_a28e38() -> ! {
    todo!("0xa28e38 rbx::signals::signal<void ()(std::string)>::slot::disconnect(void)")
}

// 0xa28fb8 — __ZNK3rbx7signals6signalIFvSsEE4slot9connectedEv
// demangled: rbx::signals::signal<void ()(std::string)>::slot::connected(void)const
// type: bool __fastcall(int)
...
// demangled: rbx::signals::signal<void ()(std::string)>::remove(rbx::signals::signal<void ()(std::string)>::slot *)
// type: int __fastcall(char **, char *, int, int (*)(const char *, ...))
#[doc(alias = "rbx::signals::signal<void ()(std::string)>::remove(rbx::signals::signal<void ()(std::string)>::slot *)")]
pub fn stub_a29158() -> ! {
    todo!("0xa29158 rbx::signals::signal<void ()(std::string)>::remove(rbx::signals::signal<void ()(std::string)>::slot *)")
}

// 0xa29248 — __ZN3rbx7signals6signalIFvSsEE4slotD1Ev
// demangled: rbx::signals::signal<void ()(std::string)>::slot::~slot()
// type: int __fastcall(int)
#[doc(alias = "rbx::signals::signal<void ()(std::string)>::slot::~slot()")]
pub fn stub_a29248() -> ! {
    todo!("0xa29248 rbx::signals::signal<void ()(std::string)>::slot::~slot()")
}

// 0xa29454 — __ZN3rbx7signals6signalIFvSsN3G3D7Vector3EEE6insertEPNS5_4slotE
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::insert(rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot *)
// type: void __fastcall(int32_t **, int, int, int, boost::mutex *, char, int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::insert(rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot *)")]
pub fn stub_a29454() -> ! {
    todo!("0xa29454 rbx::signals::signal<void ()(std::string,G3D::Vector3)>::insert(rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot *)")
}

// 0xa29714 — __ZN3rbx7signals6signalIFvSsN3G3D7Vector3EEE5mutexEv
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::mutex(void)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::mutex(void)")]
pub fn stub_a29714() -> ! {
    todo!("0xa29714 rbx::signals::signal<void ()(std::string,G3D::Vector3)>::mutex(void)")
}
...
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::safe_static_init_mutex(void)")]
pub fn stub_a29990() -> ! {
    todo!("0xa29990 rbx::signals::signal<void ()(std::string,G3D::Vector3)>::safe_static_init_mutex(void)")
}

// 0xa29bdc — __ZN3rbx7signals6signalIFvSsN3G3D7Vector3EEE4slot10disconnectEv
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::disconnect(void)
// type: void __fastcall(int, int, int, int, boost::mutex *, char, int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::disconnect(void)")]
pub fn stub_a29bdc() -> ! {
    todo!("0xa29bdc rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::disconnect(void)")
}

// 0xa29d5c — __ZNK3rbx7signals6signalIFvSsN3G3D7Vector3EEE4slot9connectedEv
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::connected(void)const
// type: bool __fastcall(int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::connected(void)const")]
pub fn stub_a29d5c() -> ! {
    todo!("0xa29d5c rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::connected(void)const")
}

// 0xa29f90 — __ZN3rbx7signals6signalIFvSsN3G3D7Vector3EEE6removeEPNS5_4slotE
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::remove(rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot *)
// type: int __fastcall(char **, char *, int, int (*)(const char *, ...))
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::remove(rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot *)")]
pub fn stub_a29f90() -> ! {
    todo!("0xa29f90 rbx::signals::signal<void ()(std::string,G3D::Vector3)>::remove(rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot *)")
}

// 0xa2a07c — __ZN3rbx7signals6signalIFvSsN3G3D7Vector3EEE4slot22safe_static_init_mutexEv
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::safe_static_init_mutex(void)")]
pub fn stub_a2a07c() -> ! {
    todo!("0xa2a07c rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::safe_static_init_mutex(void)")
}

// 0xa2a160 — __ZN3rbx7signals6signalIFvSsN3G3D7Vector3EEE4slotD1Ev
// demangled: rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::~slot()
// type: int __fastcall(int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::~slot()")]
pub fn stub_a2a160() -> ! {
    todo!("0xa2a160 rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::~slot()")
}
...
#[doc(alias = "rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::~slot()")]
pub fn stub_a2a1bc() -> ! {
    todo!("0xa2a1bc rbx::signals::signal<void ()(std::string,G3D::Vector3)>::slot::~slot()")
}

// 0xa2a2c4 — __ZN3rbx7signals6signalIFvSsSsSsEE6insertEPNS3_4slotE
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::insert(rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot *)
// type: void __fastcall(int32_t **, int, int, int, boost::mutex *, char, int, int, int, int)
...
pub fn stub_a2a2c4() -> ! {
    todo!("0xa2a2c4 rbx::signals::signal<void ()(std::string,std::string,std::string)>::insert(rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot *)")
}

// 0xa2a584 — __ZN3rbx7signals6signalIFvSsSsSsEE5mutexEv
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::mutex(void)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,std::string)>::mutex(void)")]
pub fn stub_a2a584() -> ! {
    todo!("0xa2a584 rbx::signals::signal<void ()(std::string,std::string,std::string)>::mutex(void)")
}
...
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,std::string)>::safe_static_init_mutex(void)")]
pub fn stub_a2a800() -> ! {
    todo!("0xa2a800 rbx::signals::signal<void ()(std::string,std::string,std::string)>::safe_static_init_mutex(void)")
}

// 0xa2aa4c — __ZN3rbx7signals6signalIFvSsSsSsEE4slot10disconnectEv
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::disconnect(void)
// type: void __fastcall(int, int, int, int, boost::mutex *, char, int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::disconnect(void)")]
pub fn stub_a2aa4c() -> ! {
    todo!("0xa2aa4c rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::disconnect(void)")
}

// 0xa2abcc — __ZNK3rbx7signals6signalIFvSsSsSsEE4slot9connectedEv
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::connected(void)const
// type: bool __fastcall(int)
...
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::remove(rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot *)
// type: int __fastcall(char **, char *, int, int (*)(const char *, ...))
...
pub fn stub_a2b09c() -> ! {
    todo!("0xa2b09c rbx::signals::signal<void ()(std::string,std::string,std::string)>::remove(rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot *)")
}

// 0xa2b188 — __ZN3rbx7signals6signalIFvSsSsSsEE4slot22safe_static_init_mutexEv
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::safe_static_init_mutex(void)")]
pub fn stub_a2b188() -> ! {
    todo!("0xa2b188 rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::safe_static_init_mutex(void)")
}

// 0xa2b26c — __ZN3rbx7signals6signalIFvSsSsSsEE4slotD1Ev
// demangled: rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::~slot()
// type: int __fastcall(int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::~slot()")]
pub fn stub_a2b26c() -> ! {
    todo!("0xa2b26c rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::~slot()")
}
...
#[doc(alias = "rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::~slot()")]
pub fn stub_a2b2c8() -> ! {
    todo!("0xa2b2c8 rbx::signals::signal<void ()(std::string,std::string,std::string)>::slot::~slot()")
}
...
// demangled: boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *),boost::_bi::list2<boost::arg<1>,boost::arg<2>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)
...
// demangled: boost::detail::function::void_function_obj_invoker2<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *),boost::_bi::list2<boost::arg<1>,boost::arg<2>>>,void,std::string *,std::exception *>::invoke(boost::detail::function::function_buffer &,std::string *,std::exception *)
...
// demangled: boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>,std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>>>::operator[](std::string const&)
// type: _DWORD *__fastcall(_DWORD *, const std::string *)
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>,std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>>>::reserve_for_insert(unsigned long)
...
// demangled: boost::unordered::detail::node_constructor<std::allocator<boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>>>>::construct(void)
// type: int __fastcall(int)
...
// demangled: boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>,std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>>>::~table()
...
pub fn stub_a2c1f4() -> ! {
    todo!("0xa2c1f4 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>,std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>>>::~table()")
}

// 0xa2c370 — __ZNSt8_Rb_treeISsSsSt9_IdentityISsESt4lessISsESaISsEE9_M_insertEPSt18_Rb_tree_node_baseS7_RKSs
// demangled: std::_Rb_tree<std::string,std::string,std::_Identity<std::string>,std::less<std::string>,std::allocator<std::string>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::string const&)
...
// demangled: std::_Rb_tree<int,std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>,std::_Select1st<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>,std::less<int>,std::allocator<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>,std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>> const&)
...
// demangled: std::_Rb_tree<int,std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>,std::_Select1st<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>,std::less<int>,std::allocator<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>>::_M_insert_unique(std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>> const&)
...
// demangled: std::_Rb_tree<int,std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>,std::_Select1st<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>,std::less<int>,std::allocator<std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>>>>::_M_create_node(std::pair<int const,std::set<std::string,std::less<std::string>,std::allocator<std::string>>> const&)
...
// demangled: rbx::signals::signal<void ()(std::string,bool)>::mutex(void)
// type: int __fastcall(int, int, int, int)
#[doc(alias = "rbx::signals::signal<void ()(std::string,bool)>::mutex(void)")]
pub fn stub_a2efb0() -> ! {
    todo!("0xa2efb0 rbx::signals::signal<void ()(std::string,bool)>::mutex(void)")
}

// 0xa2f0c8 — __ZN3rbx7signals6signalIFvSsbEE22safe_static_init_mutexEv
// demangled: rbx::signals::signal<void ()(std::string,bool)>::safe_static_init_mutex(void)
// type: void()
#[doc(alias = "rbx::signals::signal<void ()(std::string,bool)>::safe_static_init_mutex(void)")]
pub fn stub_a2f0c8() -> ! {
    todo!("0xa2f0c8 rbx::signals::signal<void ()(std::string,bool)>::safe_static_init_mutex(void)")
}

// 0xa2f1b0 — __ZNK3RBX8Instance25findConstFirstChildOfTypeINS_8HumanoidEEEPKT_v
// demangled: RBX::Humanoid const* RBX::Instance::findConstFirstChildOfType<RBX::Humanoid>(void)const
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::InsertService *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
// type: void()
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::InsertService *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
// type: int __fastcall(int, RBX::Instance *)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::InsertService *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
// type: int __fastcall(int, int)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::InsertService *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
// type: int __fastcall(int)
...
// demangled: RBX::InsertService * RBX::ServiceProvider::find<RBX::InsertService>(void)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int, int, int, int, int)
#[doc(alias = "RBX::InsertService * RBX::ServiceProvider::find<RBX::InsertService>(void)const")]
pub fn stub_a317c4() -> ! {
    todo!("0xa317c4 RBX::InsertService * RBX::ServiceProvider::find<RBX::InsertService>(void)const")
}

// 0xa31da0 — __ZNK3RBX15ServiceProvider4findINS_25ScriptInformationProviderEEEPT_v
// demangled: RBX::ScriptInformationProvider * RBX::ServiceProvider::find<RBX::ScriptInformationProvider>(void)const
...
// demangled: void RBX::ServiceProvider::callDoGetClassIndex<RBX::ScriptInformationProvider>(void)
// type: void()
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::ScriptInformationProvider *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
// type: void __fastcall(void *)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::ScriptInformationProvider *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
// type: int __fastcall(int, int)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::ScriptInformationProvider *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
// type: int __fastcall(int)
...
// demangled: RBX::Reflection::RefPropertyDescriptor::hasStringValue(void)const
// type: int __fastcall(RBX::Reflection::RefPropertyDescriptor *this)
...
// demangled: RBX::Reflection::Type::Type<RBX::Instance *>(char const*,char const*,RBX::Instance * *)
...
// demangled: boost::tokenizer<boost::char_separator<char,std::char_traits<char>>,__gnu_cxx::__normal_iterator<char const*,std::string>,std::string>::begin(void)const
