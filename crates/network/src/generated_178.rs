//! network generated_178 — RakNet + RBX::Network + global gap filler (auto-generated, do not edit manually)
//! Filter: RakNet|Network|Replicator|Socket|HTTP -> 6073 funcs, 49 remaining before batch (filtered gap filler) + 101 global gap filler; batch EA-sorted asc 150 not yet in network after 0x4a7a94
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: +150 stubs | range 0x4a7aa8..0xf62c34 | existing 19969 -> 20119 total (rbx_core::SharedPtr not boost)
...
pub fn stub_4a7aa8() -> Option<u32> {
    // IDA 0x4a7aa8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a7b58(this: u32) -> u32 {
    // IDA 0x4a7b58: this-adjustment thunk (this -= 132) then tail-call.
    this.wrapping_sub(132)
}
...
pub fn stub_4a7b6c(this: u32) -> u32 {
    // IDA 0x4a7b6c: this-adjustment thunk (this -= 132) then tail-call.
    this.wrapping_sub(132)
}
...
pub fn stub_4a7b74() -> Option<u32> {
    // IDA 0x4a7b74: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a7b78() -> Option<u32> {
    // IDA 0x4a7b78: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a7c14(handle: u32) -> String {
    // IDA 0x4a7c14: string query off the handle.
    let _ = handle;
    String::new()
}
...
pub fn stub_4a7c9c() -> Option<u32> {
    // IDA 0x4a7c9c: allocates a fresh handle; None on OOM.
    Some(0)
}
// 0x4a7de0 — __ZN3RBX9CreatableINS_8InstanceEE6createINS_20ExtrudedPartInstanceEEEN5boost10shared_ptrIT_EEv
// demangled: boost::shared_ptr<RBX::ExtrudedPartInstance> RBX::Creatable<RBX::Instance>::create<RBX::ExtrudedPartInstance>(void)
#[doc(alias = "rbx_core::SharedPtr<RBX::ExtrudedPartInstance> RBX::Creatable<RBX::Instance>::create<RBX::ExtrudedPartInstance>(void)")]
pub fn stub_4a7de0() -> Option<u32> {
    // IDA 0x4a7de0: nullable object query (id when live, None when unset).
    None
}
// 0x4a7e94 — __ZN5boost10shared_ptrIN3RBX20ExtrudedPartInstanceEEC2IS2_NS1_9CreatableINS1_8InstanceEE7DeleterEEEPT_T0_
// demangled: boost::shared_ptr<RBX::ExtrudedPartInstance>::shared_ptr<RBX::ExtrudedPartInstance,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ExtrudedPartInstance *,RBX::Creatable<RBX::Instance>::Deleter)
...
pub fn stub_4a7e94() -> Option<u32> {
    // IDA 0x4a7e94: nullable object query (id when live, None when unset).
    None
}
...
// demangled: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance>(boost::shared_ptr<RBX::ExtrudedPartInstance> const*,RBX::ExtrudedPartInstance *)const
...
pub fn stub_4a7f5c(has_weak: bool) -> bool {
    // IDA 0x4a7f5c: adopts the shared owner only when no weak owner exists.
    !has_weak
}
// 0x4a8044 — __ZN5boost6detail12shared_countC2IPN3RBX20ExtrudedPartInstanceENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
// demangled: boost::detail::shared_count::shared_count<RBX::ExtrudedPartInstance *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ExtrudedPartInstance *,RBX::Creatable<RBX::Instance>::Deleter)
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::ExtrudedPartInstance *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)
...
pub fn stub_4a8154(slot: &mut Option<u32>) {
    // IDA 0x4a8154: disposes the managed object (intrusive counts engine-side).
    *slot = None;
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::ExtrudedPartInstance *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)
...
pub fn stub_4a8174() -> bool {
    // IDA 0x4a8174: deleter query misses for this control block.
    false
}
...
// demangled: boost::detail::sp_counted_impl_pd<RBX::ExtrudedPartInstance *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)
...
pub fn stub_4a818c() -> bool {
    // IDA 0x4a818c: deleter query misses for this control block.
    false
}
...
pub fn stub_4a8190(handle: u32) -> String {
    // IDA 0x4a8190: string query off the handle.
    let _ = handle;
    String::new()
}
...
pub fn stub_4a8194(handle: u32) -> String {
    // IDA 0x4a8194: string query off the handle.
    let _ = handle;
    String::new()
}
...
pub fn stub_4a8274() -> Option<u32> {
    // IDA 0x4a8274: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a84b8() -> Option<u32> {
    // IDA 0x4a84b8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a852c(this: u32) -> u32 {
    // IDA 0x4a852c: this-adjustment thunk (this -= 32) then tail-call.
...
pub fn stub_4a8540(this: u32) -> u32 {
    // IDA 0x4a8540: this-adjustment thunk (this -= 36) then tail-call.
...
pub fn stub_4a8554(this: u32) -> u32 {
    // IDA 0x4a8554: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a855c(this: u32) -> u32 {
    // IDA 0x4a855c: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
pub fn stub_4a8564(this: u32) -> u32 {
    // IDA 0x4a8564: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a8578(this: u32) -> u32 {
    // IDA 0x4a8578: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a862c(this: u32) -> u32 {
    // IDA 0x4a862c: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
pub fn stub_4a8640(this: u32) -> u32 {
    // IDA 0x4a8640: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
pub fn stub_4a86f4() -> Option<u32> {
    // IDA 0x4a86f4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a8760(this: u32) -> u32 {
    // IDA 0x4a8760: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a8774(this: u32) -> u32 {
    // IDA 0x4a8774: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a8828(this: u32) -> u32 {
    // IDA 0x4a8828: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
pub fn stub_4a883c(this: u32) -> u32 {
    // IDA 0x4a883c: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
pub fn stub_4a88f0(name: &str) -> GenDesc {
    // IDA 0x4a88f0: registers the property descriptor.
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::~EnumPropDescriptor()
...
pub fn stub_4a8aa4(d: GenDesc) {
    // IDA 0x4a8aa4: prop descriptor dtor.
    let _ = d;
}
// 0x4a8ad0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_20ExtrudedPartInstanceENS2_16VisualTrussStyleEE10isReadOnlyEv
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::isReadOnly(void)const
...
pub fn stub_4a8ad0(d: &GenDesc) -> bool {
    // IDA 0x4a8ad0: read-only when no setter was installed.
    !d.writable
}
// 0x4a8ae0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_20ExtrudedPartInstanceENS2_16VisualTrussStyleEE11isWriteOnlyEv
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::isWriteOnly(void)const
...
pub fn stub_4a8ae0(d: &GenDesc) -> bool {
    // IDA 0x4a8ae0: write-only when no getter was installed.
    !d.readable
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4a8af0(name: &str) -> GenDesc {
    // IDA 0x4a8af0: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const
...
pub fn stub_4a8b18(name: &str) -> GenDesc {
    // IDA 0x4a8b18: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const
...
pub fn stub_4a8b3c(name: &str) -> GenDesc {
    // IDA 0x4a8b3c: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const
...
pub fn stub_4a8c88(name: &str) -> GenDesc {
    // IDA 0x4a8c88: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4a8cac — __ZNK3RBX10Reflection18EnumPropDescriptorINS_20ExtrudedPartInstanceENS2_16VisualTrussStyleEE14hasStringValueEv
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::hasStringValue(void)const
...
pub fn stub_4a8cac(name: &str) -> GenDesc {
    // IDA 0x4a8cac: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::getStringValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4a8cb0(name: &str) -> GenDesc {
    // IDA 0x4a8cb0: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const
...
pub fn stub_4a8cd4(name: &str) -> GenDesc {
    // IDA 0x4a8cd4: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const
...
pub fn stub_4a8d14(name: &str) -> GenDesc {
    // IDA 0x4a8d14: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const
...
pub fn stub_4a8d34(name: &str) -> GenDesc {
    // IDA 0x4a8d34: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::getIndexValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4a8f74(name: &str) -> GenDesc {
    // IDA 0x4a8f74: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const
...
pub fn stub_4a8f90(name: &str) -> GenDesc {
    // IDA 0x4a8f90: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::getEnumValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4a8fc4(name: &str) -> GenDesc {
    // IDA 0x4a8fc4: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::setEnumValue(RBX::Reflection::DescribedBase *,int)const
...
pub fn stub_4a8fcc(name: &str) -> GenDesc {
    // IDA 0x4a8fcc: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::getEnumItem(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4a9018(name: &str) -> GenDesc {
    // IDA 0x4a9018: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const
...
pub fn stub_4a9038(name: &str) -> GenDesc {
    // IDA 0x4a9038: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4a906c — __ZNK3RBX10Reflection8EnumDescINS_20ExtrudedPartInstance16VisualTrussStyleEE14convertToIndexES3_
// demangled: RBX::Reflection::EnumDesc<RBX::ExtrudedPartInstance::VisualTrussStyle>::convertToIndex(RBX::ExtrudedPartInstance::VisualTrussStyle)const
// type: int(void)
...
pub fn stub_4a906c() -> Option<u32> {
    // IDA 0x4a906c: nullable object query (id when live, None when unset).
    None
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::setIntValue(RBX::Reflection::DescribedBase *,int)const
// type: int(void)
...
pub fn stub_4a90dc(name: &str) -> GenDesc {
    // IDA 0x4a90dc: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::GetSetImpl<RBX::ExtrudedPartInstance::VisualTrussStyle (RBX::ExtrudedPartInstance::*)(void)const,void (RBX::ExtrudedPartInstance::*)(RBX::ExtrudedPartInstance::VisualTrussStyle)>::isReadOnly(void)const
...
pub fn stub_4a911c(d: &GenDesc) -> bool {
    // IDA 0x4a911c: read-only when no setter was installed.
    !d.writable
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::GetSetImpl<RBX::ExtrudedPartInstance::VisualTrussStyle (RBX::ExtrudedPartInstance::*)(void)const,void (RBX::ExtrudedPartInstance::*)(RBX::ExtrudedPartInstance::VisualTrussStyle)>::isWriteOnly(void)const
...
pub fn stub_4a9120(d: &GenDesc) -> bool {
    // IDA 0x4a9120: write-only when no getter was installed.
    !d.readable
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::GetSetImpl<RBX::ExtrudedPartInstance::VisualTrussStyle (RBX::ExtrudedPartInstance::*)(void)const,void (RBX::ExtrudedPartInstance::*)(RBX::ExtrudedPartInstance::VisualTrussStyle)>::getValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_4a9124(d: &GenDesc) -> i32 {
    // IDA 0x4a9124: virtual getter dispatch; returns the scalar.
    d.value
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::ExtrudedPartInstance,RBX::ExtrudedPartInstance::VisualTrussStyle>::GetSetImpl<RBX::ExtrudedPartInstance::VisualTrussStyle (RBX::ExtrudedPartInstance::*)(void)const,void (RBX::ExtrudedPartInstance::*)(RBX::ExtrudedPartInstance::VisualTrussStyle)>::setValue(RBX::Reflection::DescribedBase *,RBX::ExtrudedPartInstance::VisualTrussStyle const&)const")]
pub fn stub_4a9144(d: &mut GenDesc, v: i32) {
    // IDA 0x4a9144: virtual setter dispatch; stores the scalar.
    d.value = v;
}
// 0x4a9168 — __GLOBAL__I_a_189
// demangled: global constructor keyed to_a_189
#[doc(alias = "global constructor keyed to_a_189")]
pub fn stub_4a9168() {
    // IDA 0x4a9168: static initializer registration (runs before main).
}
// 0x4a94fc — __ZN3RBX12FaceInstance7setFaceENS_8NormalIdE
// demangled: RBX::FaceInstance::setFace(RBX::NormalId)
#[doc(alias = "RBX::FaceInstance::setFace(RBX::NormalId)")]
pub fn stub_4a94fc() -> Option<u32> {
    // IDA 0x4a94fc: nullable object query (id when live, None when unset).
    None
}
// 0x4a9518 — __ZN3RBX12FaceInstanceC2Ev
// demangled: RBX::FaceInstance::FaceInstance(void)
// type: _DWORD __fastcall(RBX::FaceInstance *__hidden this)
#[doc(alias = "RBX::FaceInstance::FaceInstance(void)")]
pub fn stub_4a9518() -> Option<u32> {
    // IDA 0x4a9518: nullable object query (id when live, None when unset).
    None
}
// 0x4a9668 — __ZNK3RBX12FaceInstance12askSetParentEPKNS_8InstanceE
// demangled: RBX::FaceInstance::askSetParent(RBX::Instance const*)const
// type: _DWORD __fastcall(RBX::FaceInstance *__hidden this, const RBX::Instance *)
#[doc(alias = "RBX::FaceInstance::askSetParent(RBX::Instance const*)const")]
pub fn stub_4a9668() -> Option<u32> {
    // IDA 0x4a9668: nullable object query (id when live, None when unset).
    None
}
// 0x4a96a4 — __ZN3RBX12FaceInstance14render3dSelectEPNS_5AdornENS_11SelectStateE
// demangled: RBX::FaceInstance::render3dSelect(RBX::Adorn *,RBX::SelectState)
#[doc(alias = "RBX::FaceInstance::render3dSelect(RBX::Adorn *,RBX::SelectState)")]
pub fn stub_4a96a4() -> Option<u32> {
    // IDA 0x4a96a4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a971c(fire: &dyn Fn()) {
    // IDA 0x4a971c: bind/call thunk tail-calls the operator() (mf0, no args).
    fire();
}
// 0x4a9724 — __ZNK3RBX12FaceInstance7getFaceEv
// demangled: RBX::FaceInstance::getFace(void)const
// type: _DWORD __fastcall(RBX::FaceInstance *__hidden this)
#[doc(alias = "RBX::FaceInstance::getFace(void)const")]
pub fn stub_4a9724() -> Option<u32> {
    // IDA 0x4a9724: nullable object query (id when live, None when unset).
    None
}
// 0x4a9728 — __ZN3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEED1Ev
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::~EnumPropDescriptor()
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::~EnumPropDescriptor()")]
pub fn stub_4a9728(d: GenDesc) {
    // IDA 0x4a9728: prop descriptor dtor.
    let _ = d;
}
// 0x4a974c — __ZN3RBX12FaceInstanceD1Ev
// demangled: RBX::FaceInstance::~FaceInstance()
// type: void __fastcall(RBX::FaceInstance *__hidden this)
#[doc(alias = "RBX::FaceInstance::~FaceInstance()")]
pub fn stub_4a974c() {
    // IDA 0x4a974c: dtor releases the owned control block/slots.
}
...
#[doc(alias = "RBX::FaceInstance::~FaceInstance()")]
pub fn stub_4a9808() {
    // IDA 0x4a9808: dtor releases the owned control block/slots.
}
...
pub fn stub_4a98d4(fire: &dyn Fn()) {
    // IDA 0x4a98d4: bind/call thunk tail-calls the operator() (mf0, no args).
    fire();
}
...
// type: void __fastcall(RBX::FaceInstance *__hidden this)
#[doc(alias = "non-virtual thunk to RBX::FaceInstance::~FaceInstance()")]
pub fn stub_4a998c(fire: &dyn Fn()) {
    // IDA 0x4a998c: bind/call thunk tail-calls the operator() (mf0, no args).
    fire();
}
...
// type: void __fastcall(RBX::FaceInstance *__hidden this)
#[doc(alias = "non-virtual thunk to RBX::FaceInstance::~FaceInstance()")]
pub fn stub_4a9a5c(fire: &dyn Fn()) {
    // IDA 0x4a9a5c: bind/call thunk tail-calls the operator() (mf0, no args).
    fire();
}
...
// type: void __fastcall(RBX::FaceInstance *__hidden this)
#[doc(alias = "non-virtual thunk to RBX::FaceInstance::~FaceInstance()")]
pub fn stub_4a9b14(fire: &dyn Fn()) {
    // IDA 0x4a9b14: bind/call thunk tail-calls the operator() (mf0, no args).
    fire();
}
...
pub fn stub_4a9be4() -> Option<u32> {
    // IDA 0x4a9be4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a9be8() -> Option<u32> {
    // IDA 0x4a9be8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_4a9c88(this: u32) -> u32 {
    // IDA 0x4a9c88: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a9c90(this: u32) -> u32 {
    // IDA 0x4a9c90: this-adjustment thunk (this -= 32) then tail-call.
    this.wrapping_sub(32)
}
...
pub fn stub_4a9d34(this: u32) -> u32 {
    // IDA 0x4a9d34: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
pub fn stub_4a9d3c(this: u32) -> u32 {
    // IDA 0x4a9d3c: this-adjustment thunk (this -= 36) then tail-call.
    this.wrapping_sub(36)
}
...
// type: int __fastcall(int, int, int, int, int, int, int, int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::EnumPropDescriptor<RBX::NormalId (RBX::FaceInstance::*)(void)const,void (RBX::FaceInstance::*)(RBX::NormalId)>(char const*,char const*,RBX::NormalId (RBX::FaceInstance::*)(void)const,void (RBX::FaceInstance::*)(RBX::NormalId),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
pub fn stub_4a9de0(name: &str) -> GenDesc {
    // IDA 0x4a9de0: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4a9f94 — __ZN3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEED0Ev
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::~EnumPropDescriptor()
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::~EnumPropDescriptor()")]
pub fn stub_4a9f94(d: GenDesc) {
    // IDA 0x4a9f94: prop descriptor dtor.
    let _ = d;
}
// 0x4a9fc0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE10isReadOnlyEv
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::isReadOnly(void)const
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::isReadOnly(void)const")]
pub fn stub_4a9fc0(d: &GenDesc) -> bool {
    // IDA 0x4a9fc0: read-only when no setter was installed.
    !d.writable
}
// 0x4a9fd0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE11isWriteOnlyEv
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::isWriteOnly(void)const
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::isWriteOnly(void)const")]
pub fn stub_4a9fd0(d: &GenDesc) -> bool {
    // IDA 0x4a9fd0: write-only when no getter was installed.
    !d.readable
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4a9fe0(name: &str) -> GenDesc {
    // IDA 0x4a9fe0: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const
...
pub fn stub_4aa008(name: &str) -> GenDesc {
    // IDA 0x4aa008: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const
...
pub fn stub_4aa02c(name: &str) -> GenDesc {
    // IDA 0x4aa02c: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4aa178 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE9copyValueEPKNS0_13DescribedBaseEPS5_
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const
...
pub fn stub_4aa178(name: &str) -> GenDesc {
    // IDA 0x4aa178: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4aa19c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE14hasStringValueEv
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::hasStringValue(void)const
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::hasStringValue(void)const")]
pub fn stub_4aa19c(name: &str) -> GenDesc {
    // IDA 0x4aa19c: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::getStringValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4aa1a0(name: &str) -> GenDesc {
    // IDA 0x4aa1a0: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const
// type: int __fastcall(int, const char *const *, int *)
...
pub fn stub_4aa1c4(name: &str) -> GenDesc {
    // IDA 0x4aa1c4: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const
...
pub fn stub_4aa204(name: &str) -> GenDesc {
    // IDA 0x4aa204: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const
// type: int __fastcall(int, int, XmlElement *this)
...
pub fn stub_4aa224(name: &str) -> GenDesc {
    // IDA 0x4aa224: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::getIndexValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4aa464(name: &str) -> GenDesc {
    // IDA 0x4aa464: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const
...
pub fn stub_4aa480(name: &str) -> GenDesc {
    // IDA 0x4aa480: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4aa4b4 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE12getEnumValueEPKNS0_13DescribedBaseE
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::getEnumValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4aa4b4(name: &str) -> GenDesc {
    // IDA 0x4aa4b4: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4aa4bc — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE12setEnumValueEPNS0_13DescribedBaseEi
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::setEnumValue(RBX::Reflection::DescribedBase *,int)const
...
pub fn stub_4aa4bc(name: &str) -> GenDesc {
    // IDA 0x4aa4bc: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4aa508 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE11getEnumItemEPKNS0_13DescribedBaseE
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::getEnumItem(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4aa508(name: &str) -> GenDesc {
    // IDA 0x4aa508: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const
...
pub fn stub_4aa528(name: &str) -> GenDesc {
    // IDA 0x4aa528: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
// 0x4aa55c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12FaceInstanceENS_8NormalIdEE11setIntValueEPNS0_13DescribedBaseEi
// demangled: RBX::Reflection::EnumPropDescriptor<RBX::FaceInstance,RBX::NormalId>::setIntValue(RBX::Reflection::DescribedBase *,int)const
// type: int(void)
...
pub fn stub_4aa55c(name: &str) -> GenDesc {
    // IDA 0x4aa55c: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::FaceInstance,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::FaceInstance::*)(void)const,void (RBX::FaceInstance::*)(RBX::NormalId)>::isReadOnly(void)const
...
pub fn stub_4aa59c(d: &GenDesc) -> bool {
    // IDA 0x4aa59c: read-only when no setter was installed.
    !d.writable
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::FaceInstance,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::FaceInstance::*)(void)const,void (RBX::FaceInstance::*)(RBX::NormalId)>::isWriteOnly(void)const
...
pub fn stub_4aa5a0(d: &GenDesc) -> bool {
    // IDA 0x4aa5a0: write-only when no getter was installed.
    !d.readable
}
...
// demangled: RBX::Reflection::PropDescriptor<RBX::FaceInstance,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::FaceInstance::*)(void)const,void (RBX::FaceInstance::*)(RBX::NormalId)>::getValue(RBX::Reflection::DescribedBase const*)const
...
pub fn stub_4aa5a4(d: &GenDesc) -> i32 {
    // IDA 0x4aa5a4: virtual getter dispatch; returns the scalar.
    d.value
}
...
pub fn stub_f542a4() {
    // IDA 0xf542a4: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f542b4() {
    // IDA 0xf542b4: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0xf542c4 — j___ZN5boost6detail12shared_countC2IN3RBX14AsyncHttpCacheINS3_15ContentProvider13CachedContentELb0EEEEEPT_
// demangled: boost::detail::shared_count::shared_count<RBX::AsyncHttpCache<RBX::ContentProvider::CachedContent,false>>(RBX::AsyncHttpCache<RBX::ContentProvider::CachedContent,false> *)
// type: int __fastcall(int, int, int, int, void *, int)
...
pub fn stub_f542c4() -> Option<u32> {
    // IDA 0xf542c4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f542e4(slot: &mut GenFunctor, op: u32) {
    // IDA 0xf542e4: clone/destroy dispatch (0 = destroy).
...
pub fn stub_f542f4(slot: &mut GenFunctor, op: u32) {
    // IDA 0xf542f4: clone/destroy dispatch (0 = destroy).
    if op == 0 { slot.has = false; }
}
...
pub fn stub_f54304(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf54304: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f54314(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf54314: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f54394(slot: &mut GenFunctor) -> bool {
    // IDA 0xf54394: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f543a4(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf543a4: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f54404(slot: &mut GenFunctor) -> bool {
    // IDA 0xf54404: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
// demangled: boost::function2<void,RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>>::clear(void)
...
pub fn stub_f54414() -> Option<u32> {
    // IDA 0xf54414: nullable object query (id when live, None when unset).
    None
}
// 0xf54424 — j___ZN5boost9function3IvN3RBX14AsyncHttpQueue13RequestResultEPSiNS_10shared_ptrIKSsEEE13assign_to_ownERKS8_
// demangled: boost::function3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>>::assign_to_own(boost::function3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>> const&)
...
pub fn stub_f54424(slot: &mut GenFunctor) -> bool {
    // IDA 0xf54424: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f54434(slot: &mut GenFunctor) -> bool {
    // IDA 0xf54434: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f54444(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf54444: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f54584(has_weak: bool) -> bool {
    // IDA 0xf54584: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f54594(slot: &mut GenFunctor) {
    // IDA 0xf54594: installs the functor with the nothrow tag.
    slot.has = true;
}
...
pub fn stub_f545a4(slot: &mut GenFunctor) -> bool {
    // IDA 0xf545a4: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
// type: int __fastcall(int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int)
#[doc(alias = "bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>)>,rbx_core::SharedPtr<std::string const>),boost::_bi::list2<boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>)>>,boost::_bi::value<rbx_core::SharedPtr<std::string const>>>>>(boost::_bi::bind_t<void,void (*)(boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>)>,rbx_core::SharedPtr<std::string const>),boost::_bi::list2<boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>)>>,boost::_bi::value<rbx_core::SharedPtr<std::string const>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f545b4(slot: &mut GenFunctor) -> bool {
    // IDA 0xf545b4: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f545d4(slot: &mut GenFunctor) {
    // IDA 0xf545d4: installs the functor with the nothrow tag.
    slot.has = true;
}
...
// demangled: bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(RBX::ContentId const&,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>)>),boost::_bi::list4<boost::_bi::value<RBX::ContentId>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>)>>>>>(boost::_bi::bind_t<void,void (*)(RBX::ContentId const&,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>)>),boost::_bi::list4<boost::_bi::value<RBX::ContentId>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>)>>>>,boost::detail::function::function_buffer &)const
#[doc(alias = "bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(RBX::ContentId const&,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>),boost::_bi::list4<boost::_bi::value<RBX::ContentId>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>>>>>(boost::_bi::bind_t<void,void (*)(RBX::ContentId const&,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>),boost::_bi::list4<boost::_bi::value<RBX::ContentId>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>>>>,boost::detail::function::function_buffer &)const")]
pub fn stub_f545e4(slot: &mut GenFunctor) -> bool {
    // IDA 0xf545e4: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(RBX::ContentId const&,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>),boost::_bi::list4<boost::_bi::value<RBX::ContentId>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>>>>>(boost::_bi::bind_t<void,void (*)(RBX::ContentId const&,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>),boost::_bi::list4<boost::_bi::value<RBX::ContentId>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f545f4(slot: &mut GenFunctor) -> bool {
    // IDA 0xf545f4: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f54644() -> Option<u32> {
    // IDA 0xf54644: nullable object query (id when live, None when unset).
    None
}
// 0xf54654 — j___ZNK5boost9function3IvN3RBX14AsyncHttpQueue13RequestResultEPSiNS_10shared_ptrIKSsEEEclES3_S4_S7_
// demangled: boost::function3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>>::operator()(RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>)const
...
pub fn stub_f54654() -> Option<u32> {
    // IDA 0xf54654: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f55654(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf55654: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f55724() {
    // IDA 0xf55724: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f55764(slot: &mut GenFunctor, op: u32) {
    // IDA 0xf55764: clone/destroy dispatch (0 = destroy).
    if op == 0 { slot.has = false; }
}
...
pub fn stub_f55784(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf55784: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f55834(slot: &mut GenFunctor) -> bool {
    // IDA 0xf55834: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f55844(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf55844: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f55924(slot: &mut GenFunctor) {
    // IDA 0xf55924: installs the functor with the nothrow tag.
    slot.has = true;
}
...
// demangled: bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>),boost::_bi::list6<boost::_bi::value<boost::weak_ptr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>),boost::_bi::list6<boost::_bi::value<boost::weak_ptr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>,boost::detail::function::function_buffer &)const
#[doc(alias = "bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>),boost::_bi::list6<boost::_bi::value<rbx_core::WeakPtr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>),boost::_bi::list6<boost::_bi::value<rbx_core::WeakPtr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>,boost::detail::function::function_buffer &)const")]
pub fn stub_f55934(slot: &mut GenFunctor) -> bool {
    // IDA 0xf55934: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
// demangled: bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>),boost::_bi::list6<boost::_bi::value<boost::weak_ptr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>>(boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>),boost::_bi::list6<boost::_bi::value<boost::weak_ptr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const
#[doc(alias = "bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>),boost::_bi::list6<boost::_bi::value<rbx_core::WeakPtr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::ScriptContext>,std::string,std::string,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>),boost::_bi::list6<boost::_bi::value<rbx_core::WeakPtr<RBX::ScriptContext>>,boost::_bi::value<std::string>,boost::_bi::value<std::string>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f55944(slot: &mut GenFunctor) -> bool {
    // IDA 0xf55944: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
// demangled: void boost::_bi::list5<boost::_bi::value<boost::weak_ptr<RBX::CacheableContentProvider>>,boost::arg<1>,boost::arg<2>,boost::arg<3>,boost::_bi::value<std::string>>::operator()<void (*)(boost::weak_ptr<RBX::CacheableContentProvider>,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>,std::string),boost::_bi::list3<RBX::AsyncHttpQueue::RequestResult&,std::istream *&,boost::shared_ptr<std::string const>&>>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::CacheableContentProvider>,RBX::AsyncHttpQueue::RequestResult,std::istream *,boost::shared_ptr<std::string const>,std::string) &,boost::_bi::list3<RBX::AsyncHttpQueue::RequestResult&,std::istream *&,boost::shared_ptr<std::string const>&> &,int)
...
pub fn stub_f58bc4(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf58bc4: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f58c24() {
    // IDA 0xf58c24: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f58c54(slot: &mut GenFunctor, op: u32) {
    // IDA 0xf58c54: clone/destroy dispatch (0 = destroy).
    if op == 0 { slot.has = false; }
}
...
pub fn stub_f58c94(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf58c94: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f58d14(slot: &mut GenFunctor) -> bool {
    // IDA 0xf58d14: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_f58d24(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf58d24: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f58e74(slot: &mut GenFunctor) {
    // IDA 0xf58e74: installs the functor with the nothrow tag.
    slot.has = true;
}
...
// type: int(void)
#[doc(alias = "bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::CacheableContentProvider>,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>,std::string),boost::_bi::list5<boost::_bi::value<rbx_core::WeakPtr<RBX::CacheableContentProvider>>,boost::arg<1>,boost::arg<2>,boost::arg<3>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::CacheableContentProvider>,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>,std::string),boost::_bi::list5<boost::_bi::value<rbx_core::WeakPtr<RBX::CacheableContentProvider>>,boost::arg<1>,boost::arg<2>,boost::arg<3>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &)const")]
pub fn stub_f58e84(slot: &mut GenFunctor) -> bool {
    // IDA 0xf58e84: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
#[doc(alias = "bool boost::detail::function::basic_vtable3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::CacheableContentProvider>,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>,std::string),boost::_bi::list5<boost::_bi::value<rbx_core::WeakPtr<RBX::CacheableContentProvider>>,boost::arg<1>,boost::arg<2>,boost::arg<3>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::CacheableContentProvider>,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>,std::string),boost::_bi::list5<boost::_bi::value<rbx_core::WeakPtr<RBX::CacheableContentProvider>>,boost::arg<1>,boost::arg<2>,boost::arg<3>,boost::_bi::value<std::string>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
pub fn stub_f58e94(slot: &mut GenFunctor) -> bool {
    // IDA 0xf58e94: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
// 0xf5bca4 — j___ZN3RBX4HttpC2ERKSs
// demangled: RBX::Http::Http(std::string const&)
// type: _DWORD __fastcall(RBX::Http *__hidden this, const std::string *)
#[doc(alias = "RBX::Http::Http(std::string const&)")]
pub fn stub_f5bca4() {
    // IDA 0xf5bca4: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0xf60b84 — j___ZN3RBX4HttpD2Ev
// demangled: RBX::Http::~Http()
// type: void __fastcall(RBX::Http *__hidden this)
#[doc(alias = "RBX::Http::~Http()")]
pub fn stub_f60b84() {
    // IDA 0xf60b84: dtor releases the owned control block/slots.
}
...
pub fn stub_f625b4(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf625b4: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f627d4() {
    // IDA 0xf627d4: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0xf62924 — j___ZN5boost6detail8function22functor_manager_commonINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX13ModelInstanceEEENS6_14AsyncHttpQueue13RequestResultENS5_ISt6vectorINS5_INS6_8InstanceEEESaISD_EEEEENS3_5list3INS3_5valueIS8_EENS_3argILi1EEENSM_ILi2EEEEEEEE12manage_smallERKNS1_15function_bufferERSS_NS1_30functor_manager_operation_typeE
...
pub fn stub_f62924(slot: &mut GenFunctor, op: u32) {
    // IDA 0xf62924: clone/destroy dispatch (0 = destroy).
    if op == 0 { slot.has = false; }
}
// 0xf62974 — j___ZN5boost8functionIFvN3RBX14AsyncHttpQueue13RequestResultENS_10shared_ptrISt6vectorINS4_INS1_8InstanceEEESaIS7_EEEEEEC2INS_3_bi6bind_tIvPFvNS4_INS1_13ModelInstanceEEES3_SA_ENSE_5list3INSE_5valueISH_EENS_3argILi1EEENSN_ILi2EEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISS_EE5valueEEE5valueEiE4typeE
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, pthread_mutex_t *, int, int, int, int, int, int, int, int)
#[doc(alias = "j___ZN5boost8functionIFvN3RBX14AsyncHttpQueue13RequestResultENS_10shared_ptrISt6vectorINS4_INS1_8InstanceEEESaIS7_EEEEEEC2INS_3_bi6bind_tIvPFvNS4_INS1_13ModelInstanceEEES3_SA_ENSE_5list3INSE_5valueISH_EENS_3argILi1EEENSN_ILi2EEEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralISS_EE5valueEEE5valueEiE4typeE")]
pub fn stub_f62974(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf62974: jump stub: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
// 0xf62a94 — j___ZN5boost9function2IvN3RBX14AsyncHttpQueue13RequestResultENS_10shared_ptrISt6vectorINS4_INS1_8InstanceEEESaIS7_EEEEE9assign_toINS_3_bi6bind_tIvPFvNS4_INS1_13ModelInstanceEEES3_SA_ENSD_5list3INSD_5valueISG_EENS_3argILi1EEENSM_ILi2EEEEEEEEEvT_
// demangled: void boost::function2<void,RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>>::assign_to<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::ModelInstance>,RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>),boost::_bi::list3<boost::_bi::value<boost::shared_ptr<RBX::ModelInstance>>,boost::arg<1>,boost::arg<2>>>>(boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::ModelInstance>,RBX::AsyncHttpQueue::RequestResult,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>),boost::_bi::list3<boost::_bi::value<boost::shared_ptr<RBX::ModelInstance>>,boost::arg<1>,boost::arg<2>>>)
...
pub fn stub_f62a94(slot: &mut GenFunctor) -> bool {
    // IDA 0xf62a94: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
// 0xf62c34 — j___ZNK5boost6detail8function13basic_vtable2IvN3RBX14AsyncHttpQueue13RequestResultENS_10shared_ptrISt6vectorINS6_INS3_8InstanceEEESaIS9_EEEEE9assign_toINS_3_bi6bind_tIvPFvNS6_INS3_13ModelInstanceEEES5_SC_ENSF_5list3INSF_5valueISI_EENS_3argILi1EEENSO_ILi2EEEEEEEEEbT_RNS1_15function_bufferENS1_16function_obj_tagE
...
pub fn stub_f62c34(slot: &mut GenFunctor) -> bool {
    // IDA 0xf62c34: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
