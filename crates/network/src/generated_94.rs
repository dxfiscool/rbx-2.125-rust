...
//! Filter: RakNet|RBX::Network (case-insensitive) -> 4797 funcs, 4797 already stubbed (0 remaining before batch); filler global ascending
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: +100 stubs | range 0x7f69f0..0x82cda8 | existing 13099 -> 13199 total (filler global ascending EA-sorted, rbx_core::SharedPtr not boost)
...
// type: int __fastcall(_DWORD *, int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int)
...
pub fn stub_824fd4() -> ! {
    todo!("0x824fd4 l_alloc(void *,void *,unsigned long,unsigned long)")
}
...
pub fn stub_8264d0() -> ! {
    todo!("0x8264d0 patchlistaux(FuncState *,int,int,int,int)")
}

// 0x826534 — __ZL7fixjumpP9FuncStateii
#[doc(alias = "fixjump(FuncState *,int,int)")]
pub fn stub_826534() -> ! {
    todo!("0x826534 fixjump(FuncState *,int,int)")
}
...
pub fn stub_8273f4() -> ! {
    todo!("0x8273f4 discharge2reg(FuncState *,expdesc *,int)")
}

// 0x8274ac — __ZL10need_valueP9FuncStatei
#[doc(alias = "need_value(FuncState *,int)")]
pub fn stub_8274ac() -> ! {
    todo!("0x8274ac need_value(FuncState *,int)")
}
...
pub fn stub_827b2c() -> ! {
    todo!("0x827b2c symbexec(Proto const*,int,int)")
}

// 0x828404 — __ZL12checkArgModePK5Protoi9OpArgMask
#[doc(alias = "checkArgMode(Proto const*,int,OpArgMask)")]
pub fn stub_828404() -> ! {
    todo!("0x828404 checkArgMode(Proto const*,int,OpArgMask)")
}
...
pub fn stub_82b248() -> ! {
    todo!("0x82b248 check_next(LexState *,char const*)")
}

// 0x82b288 — __ZL12read_numeralP8LexStateP7SemInfo
#[doc(alias = "read_numeral(LexState *,SemInfo *)")]
pub fn stub_82b288() -> ! {
    todo!("0x82b288 read_numeral(LexState *,SemInfo *)")
}
...
pub fn stub_82cd30() -> ! {
    todo!("0x82cd30 check_match(LexState *,int,int,int)")
}

// 0x82cda8 — __ZL9breakstatP8LexState
#[doc(alias = "breakstat(LexState *)")]
pub fn stub_82cda8() -> ! {
    todo!("0x82cda8 breakstat(LexState *)")
}
