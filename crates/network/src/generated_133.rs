...
//! Batch: +100 stubs | range 0x589f58..0x5c1318 | existing 15829 -> 15929 total (filler global ascending EA-sorted, rbx_core::SharedPtr not boost)
...
pub fn stub_594708() -> ! {
    todo!("0x594708 rbx::callable<rbx::signals::signal<void ()(std::string,RBX::ContentId)>::slot,boost::function<void ()(std::string,RBX::ContentId)>,2,void ()(std::string,RBX::ContentId)>::~callable()")
}

// 0x594818 — __ZN3rbx8callableINS_7signals6signalIFvSsN3RBX9ContentIdEEE4slotEN5boost8functionIS5_EELi2ES5_ED0Ev
#[doc(alias = "rbx::callable<rbx::signals::signal<void ()(std::string,RBX::ContentId)>::slot,boost::function<void ()(std::string,RBX::ContentId)>,2,void ()(std::string,RBX::ContentId)>::~callable()")]
pub fn stub_594818() -> ! {
    todo!("0x594818 rbx::callable<rbx::signals::signal<void ()(std::string,RBX::ContentId)>::slot,boost::function<void ()(std::string,RBX::ContentId)>,2,void ()(std::string,RBX::ContentId)>::~callable()")
}
...
pub fn stub_594948() -> ! {
    todo!("0x594948 boost::function2<void,std::string,RBX::ContentId>::assign_to_own(boost::function2<void,std::string,RBX::ContentId> const&)")
}
...
#[doc(alias = "RBX::AsyncKeyframeLoaderHelper(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>)")]
pub fn stub_5bb1ec() -> ! {
    todo!("0x5bb1ec RBX::AsyncKeyframeLoaderHelper(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>)")
}
...
#[doc(alias = "RBX::KeyframeLoaderHelper(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>,bool)")]
pub fn stub_5bb30c() -> ! {
    todo!("0x5bb30c RBX::KeyframeLoaderHelper(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>,bool)")
}

// 0x5bb8cc — __ZN3RBXL24CopyKeyframeSequenceDataEN5boost8weak_ptrINS_16KeyframeSequenceEEENS0_10shared_ptrIS2_EE
#[doc(alias = "RBX::CopyKeyframeSequenceData(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>)")]
pub fn stub_5bb8cc() -> ! {
    todo!("0x5bb8cc RBX::CopyKeyframeSequenceData(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>)")
}
...
// type: int(void)
#[doc(alias = "Weak<RBX::KeyframeSequenceProvider> RBX::weak_from<RBX::KeyframeSequenceProvider>(RBX::KeyframeSequenceProvider*)")]
pub fn stub_5bbf48() -> ! {
    todo!("0x5bbf48 Weak<RBX::KeyframeSequenceProvider> RBX::weak_from<RBX::KeyframeSequenceProvider>(RBX::KeyframeSequenceProvider*)")
}
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>),boost::_bi::list_av_4<boost::arg<1>,boost::arg<2>,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>>::type> boost::bind<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>,boost::arg<1>,boost::arg<2>,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>>(void (*)(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>),boost::arg<1>,boost::arg<2>,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>)")]
pub fn stub_5bc150() -> ! {
...
#[doc(alias = "void boost::function3<void,RBX::AsyncHttpQueue::RequestResult,std::istream *,rbx_core::SharedPtr<std::string const>>::assign_to<boost::_bi::bind_t<void,void (*)(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::KeyframeSequenceProvider>>,boost::_bi::value<Weak<RBX::KeyframeSequence>>>>>(boost::_bi::bind_t<void,void (*)(RBX::AsyncHttpQueue::RequestResult,std::istream *,Weak<RBX::KeyframeSequenceProvider>,Weak<RBX::KeyframeSequence>),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::KeyframeSequenceProvider>>,boost::_bi::value<Weak<RBX::KeyframeSequence>>>>)")]
pub fn stub_5bdef8() -> ! {
...
// type: int __fastcall(int, boost::detail::sp_counted_base *, int, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int, int)
#[doc(alias = "boost::_bi::bind_t<void,void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list_av_2<Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>>::type> boost::bind<void,Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>,Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>>(void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>)")]
pub fn stub_5c0288() -> ! {
    todo!("0x5c0288 boost::_bi::bind_t<void,void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list_av_2<Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>>::type> boost::bind<void,Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>,Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>>(void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>)")
}
...
#[doc(alias = "boost::_bi::list2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>::list2(boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>)")]
pub fn stub_5c049c() -> ! {
    todo!("0x5c049c boost::_bi::list2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>::list2(boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>)")
}
...
#[doc(alias = "boost::_bi::storage2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>::storage2(boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>)")]
pub fn stub_5c05b4() -> ! {
    todo!("0x5c05b4 boost::_bi::storage2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>::storage2(boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>)")
}
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
pub fn stub_5c0b0c() -> ! {
    todo!("0x5c0b0c boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")
}
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(Weak<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list2<boost::_bi::value<Weak<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>>>::manager(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type,mpl_::bool_<false>)")]
pub fn stub_5c102c() -> ! {
...
// type: int(void)
#[doc(alias = "rbx_core::SharedPtr<RBX::KeyframeSequence>::shared_ptr<RBX::KeyframeSequence>(Weak<RBX::KeyframeSequence> const&,boost::detail::sp_nothrow_tag)")]
pub fn stub_5c11ec() -> ! {
    todo!("0x5c11ec rbx_core::SharedPtr<RBX::KeyframeSequence>::shared_ptr<RBX::KeyframeSequence>(Weak<RBX::KeyframeSequence> const&,boost::detail::sp_nothrow_tag)")
}

// 0x5c1268 — __ZN5boost10shared_ptrIN3RBX24KeyframeSequenceProviderEEC2IS2_EERKNS_8weak_ptrIT_EENS_6detail14sp_nothrow_tagE
// type: int(void)
#[doc(alias = "rbx_core::SharedPtr<RBX::KeyframeSequenceProvider>::shared_ptr<RBX::KeyframeSequenceProvider>(Weak<RBX::KeyframeSequenceProvider> const&,boost::detail::sp_nothrow_tag)")]
pub fn stub_5c1268() -> ! {
    todo!("0x5c1268 rbx_core::SharedPtr<RBX::KeyframeSequenceProvider>::shared_ptr<RBX::KeyframeSequenceProvider>(Weak<RBX::KeyframeSequenceProvider> const&,boost::detail::sp_nothrow_tag)")
}
