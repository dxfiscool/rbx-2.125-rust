//! network generated_net_28 — auto-generated, do not edit manually
//! Filter: RakNet|Network|Replicator|Socket|HTTP -> 5185 total, 300 remaining before this batch — next 100 EA-sorted asc not yet in network
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: +100 stubs | range 0xf5e5c4..0xf61c74 | 25500->25600 network distinct (rbx_core::SharedPtr not boost) — preserves ea + mangled + demangled for rg
...
// type: int __fastcall(int, int, int, int, pthread_mutex_t *, pthread_mutex_t *, pthread_mutex_t *, pthread_mutex_t *, struct _Unwind_Exception *lpuexcpt, int, int, int, int, RBX::TaskScheduler::Job *, int, pthread_mutex_t *, int, int, int, int, int, int)
...
// type: int __fastcall(int, int, int, int, pthread_mutex_t *, pthread_mutex_t *, pthread_mutex_t *, pthread_mutex_t *, struct _Unwind_Exception *lpuexcpt, int, int, int, int, char, int, int, int, int, int, int, int, int, int, RBX::TaskScheduler::Job *, int, int, int, int, int, int)
...
// type: int __fastcall(int, int, int, int, int, pthread_mutex_t *, pthread_mutex_t *, pthread_mutex_t *, struct _Unwind_Exception *lpuexcpt, pthread_mutex_t *, int, int, int, int, int, int, int, int)
