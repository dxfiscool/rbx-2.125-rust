...
pub fn stub_f52224(target: &mut Option<u64>, src: Option<u64>) {
    // IDA 0xf52224: intrusive_ptr assign (release/acquire engine-side).
    *target = src;
}
...
pub fn stub_f52284(fire: &dyn Fn(&GenMessage), msg: &GenMessage) {
    // IDA 0xf52284: bind/call thunk forwards the message into the bound member (mf1).
    fire(msg);
}
...
pub fn stub_f52694() -> Option<u32> {
    // IDA 0xf52694: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5bc64() -> u32 {
    // IDA 0xf5bc64: compile-time class index.
    0x504c4159
}
...
pub fn stub_f5c2e4() -> Option<u32> {
    // IDA 0xf5c2e4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5e294(map: &mut HashMap<u32, f32>, part: u32) -> bool {
    // IDA 0xf5e294: erases the node chain for one key.
...
pub fn stub_f5e2a4(map: &mut HashMap<u32, f32>, part: u32, error: f32) -> bool {
    // IDA 0xf5e2a4: node construct + hash insert; false when key exists.
...
pub fn stub_f5e2b4(map: &mut HashMap<u32, f32>, part: u32, error: f32) -> bool {
    // IDA 0xf5e2b4: node construct + hash insert; false when key exists.
    if map.contains_key(&part) { return false; }
    map.insert(part, error);
    true
}
...
pub fn stub_f5e2c4(map: &mut HashMap<u32, f32>, n: usize) {
    // IDA 0xf5e2c4: grows buckets ahead of the insert batch.
    map.reserve(n);
}
...
pub fn stub_f5e2d4(map: &mut HashMap<u32, f32>, n: usize) {
    // IDA 0xf5e2d4: grows buckets ahead of the insert batch.
    map.reserve(n);
}
...
pub fn stub_f5e2e4(map: &mut HashMap<u32, f32>) {
    // IDA 0xf5e2e4: destroys every node in the table.
    map.clear();
}
...
pub fn stub_f5e2f4(top: &mut GenTopN, part: u32) {
    // IDA 0xf5e2f4: mf1 apply: addNugget(sender, part).
    top.map.insert(part, 0.0);
    gen_refresh_top(top);
}
...
pub fn stub_f5e304(top: &mut GenTopN, part: u32) {
    // IDA 0xf5e304: mf1 apply: addNugget(sender, part).
    top.map.insert(part, 0.0);
    gen_refresh_top(top);
}
...
pub fn stub_f5e314(vec: &mut Vec<u32>, pos: usize, value: u32) {
    // IDA 0xf5e314: vector insert with reallocation around the new element.
...
pub fn stub_f5e324(parts: &[u32], top: &mut GenTopN) {
    // IDA 0xf5e324: for_each over the physics set with the addNugget binder.
...
pub fn stub_f5e354() {
    // IDA 0xf5e354: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e364() {
    // IDA 0xf5e364: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e374() -> Option<u32> {
    // IDA 0xf5e374: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5e384() -> Option<u32> {
    // IDA 0xf5e384: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5e3b4() {
    // IDA 0xf5e3b4: EnumDesc dtor releases the item map.
}
...
pub fn stub_f5e3c4() {
    // IDA 0xf5e3c4: EnumDesc dtor releases the item map.
}
...
pub fn stub_f5e3d4() {
    // IDA 0xf5e3d4: EnumDesc dtor releases the item map.
}
...
pub fn stub_f5e3e4() {
    // IDA 0xf5e3e4: EnumDesc dtor releases the item map.
}
...
pub fn stub_f5e444(value: i32) -> i32 {
    // IDA 0xf5e444: EnumDesc item passthrough (validated upstream).
    value
}
...
pub fn stub_f5e454(value: i32) -> &'static str {
    // IDA 0xf5e454: EnumDesc value->name (table engine-side).
    "Valid"
}
...
pub fn stub_f5e464(value: i32) -> i32 {
    // IDA 0xf5e464: EnumDesc item passthrough (validated upstream).
    value
}
...
pub fn stub_f5e474(value: i32) -> &'static str {
    // IDA 0xf5e474: EnumDesc value->name (table engine-side).
    "Valid"
}
...
pub fn stub_f5e484(value: i32) -> i32 {
    // IDA 0xf5e484: EnumDesc item passthrough (validated upstream).
    value
}
...
pub fn stub_f5e494(value: i32) -> &'static str {
    // IDA 0xf5e494: EnumDesc value->name (table engine-side).
    "Valid"
}
...
pub fn stub_f5e4a4(value: i32) -> i32 {
    // IDA 0xf5e4a4: EnumDesc item passthrough (validated upstream).
    value
}
...
pub fn stub_f5e4b4(value: i32) -> &'static str {
    // IDA 0xf5e4b4: EnumDesc value->name (table engine-side).
    "Valid"
}
...
pub fn stub_f5e4c4(value: i32) -> i32 {
    // IDA 0xf5e4c4: EnumDesc item passthrough (validated upstream).
    value
}
...
pub fn stub_f5e4d4(value: i32) -> &'static str {
    // IDA 0xf5e4d4: EnumDesc value->name (table engine-side).
    "Valid"
}
...
pub fn stub_f5e504(map: &mut HashMap<u32, i32>, key: u32) -> bool {
    // IDA 0xf5e504: Rb_tree erase of one node.
...
pub fn stub_f5e514(map: &mut HashMap<u32, i32>, key: u32) -> bool {
    // IDA 0xf5e514: Rb_tree erase of one node.
    map.remove(&key).is_some()
}
...
pub fn stub_f5e524(map: &mut HashMap<u32, i32>, key: u32) -> bool {
    // IDA 0xf5e524: Rb_tree erase of one node.
    map.remove(&key).is_some()
}
...
pub fn stub_f5e534(map: &mut HashMap<u32, i32>, key: u32) -> bool {
    // IDA 0xf5e534: Rb_tree erase of one node.
    map.remove(&key).is_some()
}
...
pub fn stub_f5e714() {
    // IDA 0xf5e714: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e724(vec: &mut Vec<u32>, pos: usize, value: u32) {
    // IDA 0xf5e724: vector insert with reallocation around the new element.
    let at = pos.min(vec.len());
    vec.insert(at, value);
}
...
pub fn stub_f5e734() {
    // IDA 0xf5e734: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e744() {
    // IDA 0xf5e744: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e754() {
    // IDA 0xf5e754: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e764() {
    // IDA 0xf5e764: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5e7f4(fire: &dyn Fn(i32, i32), a: i32, b: i32) {
    // IDA 0xf5e7f4: bind/call thunk forwards the pair (mf2).
    fire(a, b);
}
...
pub fn stub_f5e804(name: &str) -> GenDesc {
    // IDA 0xf5e804: registers the bound descriptor under name.
...
pub fn stub_f5e814(name: &str) -> GenDesc {
    // IDA 0xf5e814: registers the bound descriptor under name.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5e824(d: GenDesc) {
    // IDA 0xf5e824: descriptor dtor unlinks listeners, frees holders.
    let _ = d;
}
...
pub fn stub_f5e834(name: &str) -> GenDesc {
    // IDA 0xf5e834: registers the bound descriptor under name.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5e854(name: &str, scriptable: bool) -> GenDesc {
    // IDA 0xf5e854: registers the event descriptor.
...
pub fn stub_f5e864(name: &str, scriptable: bool) -> GenDesc {
    // IDA 0xf5e864: registers the event descriptor.
    GenDesc { name: name.to_owned(), scriptable, ..GenDesc::default() }
}
...
pub fn stub_f5e874(name: &str, scriptable: bool) -> GenDesc {
    // IDA 0xf5e874: registers the event descriptor.
    GenDesc { name: name.to_owned(), scriptable, ..GenDesc::default() }
}
...
pub fn stub_f5eae4(s: &mut GenSignalState) -> u64 {
    // IDA 0xf5eae4: wraps the functor in a slot node and inserts it.
    gen_connect(s)
}
...
pub fn stub_f5eaf4(s: &mut GenSignalState) -> u64 {
    // IDA 0xf5eaf4: wraps the functor in a slot node and inserts it.
    gen_connect(s)
}
...
pub fn stub_f5eb04(s: &mut GenSignalState) -> u64 {
    // IDA 0xf5eb04: wraps the functor in a slot node and inserts it.
    gen_connect(s)
}
...
pub fn stub_f5eb24() -> Option<u32> {
    // IDA 0xf5eb24: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5eb64(has_weak: bool) -> bool {
    // IDA 0xf5eb64: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5eb74(has_weak: bool) -> bool {
    // IDA 0xf5eb74: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5ebf4() -> Option<u32> {
    // IDA 0xf5ebf4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5ec34() -> Option<u32> {
    // IDA 0xf5ec34: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5ec54() -> Option<u32> {
    // IDA 0xf5ec54: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5ec64() {
    // IDA 0xf5ec64: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5ec74() {
    // IDA 0xf5ec74: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5ec84() {
    // IDA 0xf5ec84: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5ec94() {
    // IDA 0xf5ec94: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5eca4() {
    // IDA 0xf5eca4: dtor releases the owned control block/slots.
}
...
pub fn stub_f5ecb4() -> Option<u32> {
    // IDA 0xf5ecb4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5ecc4() {
    // IDA 0xf5ecc4: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5ecf4(slot: &mut Option<u32>) {
    // IDA 0xf5ecf4: releases the owned ref (intrusive release engine-side).
    *slot = None;
}
...
pub fn stub_f5ed14(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0xf5ed14: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_f5ed44(slot: &mut Option<u32>, v: u32) {
    // IDA 0xf5ed44: adopts the raw pointer into the shared control block.
    *slot = Some(v);
}
...
pub fn stub_f5ed54(map: &mut HashMap<u32, f32>, part: u32) -> bool {
    // IDA 0xf5ed54: erases the node chain for one key.
    map.remove(&part).is_some()
}
...
pub fn stub_f5ed64(map: &mut HashMap<u32, f32>, part: u32, error: f32) -> bool {
    // IDA 0xf5ed64: node construct + hash insert; false when key exists.
    if map.contains_key(&part) { return false; }
    map.insert(part, error);
    true
}
...
pub fn stub_f5ed74(map: &mut HashMap<u32, f32>, n: usize) {
    // IDA 0xf5ed74: grows buckets ahead of the insert batch.
    map.reserve(n);
}
...
pub fn stub_f5ed84(map: &mut HashMap<u32, f32>, n: usize) {
    // IDA 0xf5ed84: grows buckets ahead of the insert batch.
    map.reserve(n);
}
...
pub fn stub_f5eda4() -> Option<u32> {
    // IDA 0xf5eda4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5ede4(has_weak: bool) -> bool {
    // IDA 0xf5ede4: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5edf4(has_weak: bool) -> bool {
    // IDA 0xf5edf4: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5ee04() -> Option<u32> {
    // IDA 0xf5ee04: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5ee14() {
    // IDA 0xf5ee14: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5f404(has_weak: bool) -> bool {
    // IDA 0xf5f404: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5f444() {
    // IDA 0xf5f444: dtor releases the owned control block/slots.
}
...
pub fn stub_f5f464() {
    // IDA 0xf5f464: dtor releases the owned control block/slots.
}
...
pub fn stub_f5f474() -> Option<u32> {
    // IDA 0xf5f474: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f484() -> Option<u32> {
    // IDA 0xf5f484: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f494(slot: &mut Option<u32>, v: u32) {
    // IDA 0xf5f494: adopts the raw pointer into the shared control block.
    *slot = Some(v);
}
...
pub fn stub_f5f4a4(slot: &mut Option<u32>, v: u32) {
    // IDA 0xf5f4a4: adopts the raw pointer into the shared control block.
    *slot = Some(v);
}
...
pub fn stub_f5f4c4() {
    // IDA 0xf5f4c4: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_f5f5a4(has_weak: bool) -> bool {
    // IDA 0xf5f5a4: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5f5b4(has_weak: bool) -> bool {
    // IDA 0xf5f5b4: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_f5f5d4() -> Option<u32> {
    // IDA 0xf5f5d4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f5f4() -> Option<u32> {
    // IDA 0xf5f5f4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f604() -> Option<u32> {
    // IDA 0xf5f604: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f614() -> Option<u32> {
    // IDA 0xf5f614: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f624() {
    // IDA 0xf5f624: dtor releases the owned control block/slots.
}
...
pub fn stub_f5f634() -> Option<u32> {
    // IDA 0xf5f634: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f784(map: &mut HashMap<u32, f32>, part: u32) -> bool {
    // IDA 0xf5f784: erases the node chain for one key.
    map.remove(&part).is_some()
}
...
pub fn stub_f5f794(map: &mut HashMap<u32, f32>, part: u32, error: f32) -> bool {
    // IDA 0xf5f794: node construct + hash insert; false when key exists.
    if map.contains_key(&part) { return false; }
    map.insert(part, error);
    true
}
...
pub fn stub_f5f7a4(map: &mut HashMap<u32, f32>, part: u32, error: f32) -> bool {
    // IDA 0xf5f7a4: node construct + hash insert; false when key exists.
    if map.contains_key(&part) { return false; }
    map.insert(part, error);
    true
}
...
pub fn stub_f5f7b4(map: &mut HashMap<u32, f32>, n: usize) {
    // IDA 0xf5f7b4: grows buckets ahead of the insert batch.
    map.reserve(n);
}
...
pub fn stub_f5f7c4(map: &mut HashMap<u32, f32>, n: usize) {
    // IDA 0xf5f7c4: grows buckets ahead of the insert batch.
    map.reserve(n);
}
...
pub fn stub_f5f7d4(map: &mut HashMap<u32, f32>) {
    // IDA 0xf5f7d4: destroys every node in the table.
    map.clear();
}
...
pub fn stub_f5f7e4() -> Option<u32> {
    // IDA 0xf5f7e4: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f804() -> Option<u32> {
    // IDA 0xf5f804: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f814() -> Option<u32> {
    // IDA 0xf5f814: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f834() -> Option<u32> {
    // IDA 0xf5f834: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f844() -> Option<u32> {
    // IDA 0xf5f844: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f854() -> Option<u32> {
    // IDA 0xf5f854: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_f5f864(parts: &[u32], top: &mut GenTopN) {
    // IDA 0xf5f864: for_each over the physics set with the addNugget binder.
    for &p in parts { top.map.insert(p, 0.0); }
    gen_refresh_top(top);
}
...
pub fn stub_f5f914(name: &str) -> GenDesc {
    // IDA 0xf5f914: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5f924(name: &str) -> GenDesc {
    // IDA 0xf5f924: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5f934(name: &str) -> GenDesc {
    // IDA 0xf5f934: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5f944(name: &str) -> GenDesc {
    // IDA 0xf5f944: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5f954(name: &str) -> GenDesc {
    // IDA 0xf5f954: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5f964(name: &str) -> GenDesc {
    // IDA 0xf5f964: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
...
pub fn stub_f5f974(name: &str) -> GenDesc {
    // IDA 0xf5f974: registers the property descriptor.
    GenDesc { name: name.to_owned(), readable: true, writable: true, ..GenDesc::default() }
}
