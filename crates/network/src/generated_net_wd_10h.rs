//! network generated_net_wd_10h — 100 stubs EA-sorted asc gap filler not yet in crates/network/src after 0x40705c (gap filler global ascending)
//! Source: ida/export.json (85545 funcs, base 0x4000) EA-sorted asc next 100 not in network after 0x40705c | rbx_core::SharedPtr not boost
//! Range 0x4071e0..0x40a5b8 | EA-sorted asc distinct gap filler
...
// type: void __fastcall(_QWORD *, int)
#[doc(alias = "boost::shared_ptr<RBX::AnchorTool> RBX::shared_from<RBX::AnchorTool>(RBX::AnchorTool*)")]
...
// type: int *__fastcall(int *, int, int, int)
#[doc(alias = "boost::shared_ptr<RBX::AnchorTool>::shared_ptr<RBX::AnchorTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::AnchorTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")]
