...
//! Batch: +100 stubs | range 0xc71088..0xc76a94 | existing 13829 -> 13929 total (filler global ascending EA-sorted, rbx_core::SharedPtr not boost)
...
// type: _DWORD __fastcall(Ogre::CompositionTechnique *__hidden this, Ogre::Compositor *)
...
// type: void __fastcall(Ogre::CompositionTechnique *__hidden this)
...
// type: _DWORD __fastcall(Ogre::CompositionTechnique *__hidden this)
...
// type: _DWORD __fastcall(Ogre::CompositionTechnique *__hidden this, const std::string *)
...
// type: _DWORD __fastcall(Ogre::CompositionTechnique *__hidden this, bool)
...
#[doc(alias = "`global constructor keyed to'_a_664")]
pub fn stub_c71afc() -> ! {
...
// type: _DWORD __fastcall(Ogre::Compositor *__hidden this, Ogre::ResourceManager *, const std::string *, unsigned __int64, const std::string *, bool, Ogre::ManualResourceLoader *)
...
// type: void __fastcall(Ogre::Compositor *__hidden this)
...
// type: _DWORD __fastcall(Ogre::Compositor *__hidden this)
...
// type: _DWORD __fastcall(Ogre *__hidden this, const std::string *, unsigned int)
...
#[doc(alias = "`global constructor keyed to'_a_665")]
pub fn stub_c74ff8() -> ! {
    todo!("0xc74ff8 `global constructor keyed to'_a_665")
}

// 0xc7502c — __ZN4Ogre15CompositorChain13getCompositorERKSs
// type: _DWORD __fastcall(Ogre::CompositorChain *__hidden this, const std::string *)
...
#[doc(alias = "`global constructor keyed to'_a_666")]
pub fn stub_c7509c() -> ! {
    todo!("0xc7509c `global constructor keyed to'_a_666")
}

// 0xc750d0 — __ZN4Ogre18CompositorInstance13getCompositorEv
// type: _DWORD __fastcall(Ogre::CompositorInstance *__hidden this)
...
// type: _DWORD __fastcall(Ogre::CompositorInstance *__hidden this, const std::string *, unsigned int)
...
// type: void __fastcall(Ogre::CompositorInstance *this, const std::string *, std::string *, int)
...
#[doc(alias = "`global constructor keyed to'_a_667")]
pub fn stub_c7542c() -> ! {
    todo!("0xc7542c `global constructor keyed to'_a_667")
}

// 0xc75460 — __ZN4Ogre17CompositorManager12getSingletonEv
// type: _DWORD __fastcall(Ogre::CompositorManager *__hidden this)
...
// type: void __fastcall(Ogre::CompositorManager *__hidden this)
...
// type: _DWORD __fastcall(Ogre::CompositorManager *__hidden this, bool)
...
// type: void __fastcall(Ogre::CompositorManager::TextureDefLess *__hidden this)
...
#[doc(alias = "`global constructor keyed to'_a_668")]
pub fn stub_c7699c() -> ! {
