...
pub fn stub_9fab00() {
    // IDA 0x9fab00: `BoundCallbackDesc::Setter<ServerReplicator>` D1; no crate state.
}
...
#[doc(alias = "RBX::Reflection::BoundCallbackDesc<RBX::Network::FilterResult ()(rbx_core::SharedPtr<RBX::Instance>)>::Setter<RBX::Network::ServerReplicator>::~Setter()")]
pub fn stub_9fab04() {
    // IDA 0x9fab04: `BoundCallbackDesc::Setter<ServerReplicator>` D0; no crate state.
}
...
pub fn stub_9fab10() {
    // IDA 0x9fab10: `BoundCallbackDesc::Setter::setCallback`; the stored callback stays engine-side.
}
...
pub fn stub_9fab4c<T>(slot: &mut Option<Box<T>>, functor: T) {
    // IDA 0x9fab4c: `function<FilterResult>::operator=`; stores the functor.
...
pub fn stub_9fae44() {
    // IDA 0x9fae44: `CallbackDescImpl<Instance()>` D1; descriptor state stays engine-side.
}
...
#[doc(alias = "RBX::Reflection::CallbackDescImpl<RBX::Network::FilterResult ()(rbx_core::SharedPtr<RBX::Instance>),1>::~CallbackDescImpl()")]
pub fn stub_9faf84() {
    // IDA 0x9faf84: `CallbackDescImpl<Instance()>` D0; descriptor state stays engine-side.
}
...
pub fn stub_9fb0e0() {
    // IDA 0x9fb0e0: `CallbackDescImpl<Instance,Instance>` C2; descriptor state stays engine-side.
}
...
pub fn stub_9fb45c() {
    // IDA 0x9fb45c: `BoundCallbackDesc<Instance,Instance>` D0; descriptor state stays engine-side.
}
...
pub fn stub_9fb5b8() {
    // IDA 0x9fb5b8: `CallbackDescImpl::setGenericCallback`; the stored callback stays engine-side.
}
...
pub fn stub_9fba3c() {
    // IDA 0x9fba3c: `CallbackDesc::clearCallback`; the stored callback stays engine-side.
}
...
pub fn stub_9fbb30() {
    // IDA 0x9fbb30: `boost::bind` over the `(Instance,Instance)` FilterResult functor; the bind object stays engine-side.
}
...
pub fn stub_9fbf98(call: impl FnOnce() -> bool) -> bool {
    // IDA 0x9fbf98: `CallbackDescImpl::callGeneric` — invoke the stored callback.
    call()
}
...
pub fn stub_9fc950(call: impl FnOnce() -> bool) -> bool {
    // IDA 0x9fc950: `CallbackDesc::callGeneric` — invoke the stored callback.
    call()
}
...
pub fn stub_9fcf30(value: bool) -> bool {
    // IDA 0x9fcf30: `CallbackDesc::convertResult` — the result codec stays engine-side.
    value
}
...
pub fn stub_9fd950(op: crate::functor::FunctorOp) -> crate::functor::ManageOutcome {
    // IDA 0x9fd950: same small-object `manage` shape as 0xa368fc for the `FilterResult(*)(Tuple-fn,Instance,Instance)` bind.
    crate::functor::manage_small(op, "bind_t<FilterResult(*)(Tuple-fn,Instance,Instance)>")
}
...
pub fn stub_9fd974<R, A, B>(slot: &mut dyn FnMut(A, B) -> R, a: A, b: B) -> R {
    // IDA 0x9fd974: `function_obj_invoker2` — bound filter fn plus `(Instance,Instance)`.
...
pub fn stub_9fd990<T>(slot: &mut Option<Box<T>>, functor: T) -> bool {
    // IDA 0x9fd990: `basic_vtable2::assign_to` — functor words into the buffer, `return 1`.
    crate::functor::assign_to(slot, functor)
}
...
pub fn stub_9fdc30<R, A, B>(slot: &mut dyn FnMut(A, B) -> R, a: A, b: B) -> R {
    // IDA 0x9fdc30: `list3::operator()` returning `FilterResult` — bound filter fn plus `(Instance,Instance)`.
    crate::functor::invoke_ret2(slot, a, b)
}
...
pub fn stub_9fe290(op: crate::functor::FunctorOp) -> crate::functor::ManageOutcome {
    // IDA 0x9fe290: small-object `manage_small` for the `(Instance,Instance)` bind.
    crate::functor::manage_small(op, "bind_t<FilterResult(*)(Tuple-fn,Instance,Instance)>")
}
...
pub fn stub_9fe368() {
    // IDA 0x9fe368: `CallbackDesc<Instance,Instance>` D1; descriptor state stays engine-side.
}
