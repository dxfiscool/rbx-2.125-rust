...
pub fn stub_b07458() -> ! {
    todo!("0xb07458 boost::shared_ptr<RBX::Network::InstancePacketCache> RBX::shared_from<RBX::Network::InstancePacketCache>(RBX::Network::InstancePacketCache*)")
}
...
pub fn stub_b076ec() -> ! {
    todo!("0xb076ec boost::shared_ptr<RBX::Network::ClusterPacketCache> RBX::shared_from<RBX::Network::ClusterPacketCache>(RBX::Network::ClusterPacketCache*)")
}
...
pub fn stub_b07f30() -> ! {
    todo!("0xb07f30 boost::shared_ptr<RBX::Network::SharedStringDictionary>::shared_ptr<RBX::Network::SharedStringDictionary>(RBX::Network::SharedStringDictionary *)")
}
...
pub fn stub_b08350() -> ! {
    todo!("0xb08350 boost::shared_ptr<RBX::Network::SharedStringDictionary>::operator=(boost::shared_ptr<RBX::Network::SharedStringDictionary> const&)")
}
...
pub fn stub_b0a3e0() -> ! {
    todo!("0xb0a3e0 boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,RBX::Instance::CombinedSignalType,RBX::Instance::ICombinedSignalData const*),boost::_bi::list_av_4<boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,boost::arg<1>,boost::arg<2>>::type> boost::bind<void,boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,RBX::Instance::CombinedSignalType,RBX::Instance::ICombinedSignalData const*,boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,boost::arg<1>,boost::arg<2>>(void (*)(boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,RBX::Instance::CombinedSignalType,RBX::Instance::ICombinedSignalData const*),boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,boost::arg<1>,boost::arg<2>)")
}
...
pub fn stub_b0c50c() -> ! {
    todo!("0xb0c50c boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::Instance>),boost::_bi::list_av_1<boost::shared_ptr<RBX::Network::Replicator>>::type> boost::bind<void,boost::shared_ptr<RBX::Instance>,boost::shared_ptr<RBX::Network::Replicator>>(void (*)(boost::shared_ptr<RBX::Instance>),boost::shared_ptr<RBX::Network::Replicator>)")
}
...
pub fn stub_b0c974() -> ! {
    todo!("0xb0c974 RBX::Network::Replicator::ProcessPacketsJob::wake(void)")
}
...
pub fn stub_b0cc30() -> ! {
    todo!("0xb0cc30 RBX::Network::Replicator::getClassName(void)const")
}
...
pub fn stub_b0cc40() -> ! {
    todo!("0xb0cc40 RBX::Network::Replicator::requestCharacter(void)")
}
...
pub fn stub_b0ce80() -> ! {
    todo!("0xb0ce80 RBX::Network::Replicator::postProcessPacket(void)")
}
...
pub fn stub_b0cea8() -> ! {
    todo!("0xb0cea8 RBX::Network::Replicator::onSentMarker(long)")
}
...
pub fn stub_b0ceb0() -> ! {
    todo!("0xb0ceb0 RBX::Network::Replicator::processSendStats(unsigned int)")
}
...
pub fn stub_b0cf08() -> ! {
    todo!("0xb0cf08 RBX::Network::Replicator::SendDataJob::~SendDataJob()")
}
...
#[doc(alias = "RBX::Network::Replicator::SendDataJob::~SendDataJob()")]
pub fn stub_b0cfd4() -> ! {
    todo!("0xb0cfd4 RBX::Network::Replicator::SendDataJob::~SendDataJob()")
}
...
pub fn stub_b0d0b4() -> ! {
    todo!("0xb0d0b4 RBX::Network::Replicator::SendDataJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)")
}
...
pub fn stub_b14580() -> ! {
    todo!("0xb14580 void boost::function1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::Instance>),boost::_bi::list1<boost::_bi::value<boost::shared_ptr<RBX::Network::Replicator>>>>>(boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::Instance>),boost::_bi::list1<boost::_bi::value<boost::shared_ptr<RBX::Network::Replicator>>>>)")
}
...
pub fn stub_b14a14() -> ! {
    todo!("0xb14a14 boost::detail::function::void_function_obj_invoker1<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::Instance>),boost::_bi::list1<boost::_bi::value<boost::shared_ptr<RBX::Network::Replicator>>>>,void,RBX::DataModel *>::invoke(boost::detail::function::function_buffer &,RBX::DataModel *)")
}
...
pub fn stub_b1b4d4() -> ! {
    todo!("0xb1b4d4 boost::_mfi::mf1<void,RBX::Network::Replicator,boost::shared_ptr<RBX::Instance>>::operator()(RBX::Network::Replicator*,boost::shared_ptr<RBX::Instance>)const")
}
...
pub fn stub_b1be34() -> ! {
    todo!("0xb1be34 void boost::_bi::list4<boost::_bi::value<boost::weak_ptr<RBX::Network::Replicator>>,boost::_bi::value<RBX::Network::Replicator::ReplicationData *>,boost::arg<1>,boost::arg<2>>::operator()<void (*)(boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,RBX::Instance::CombinedSignalType,RBX::Instance::ICombinedSignalData const*),boost::_bi::list2<RBX::Instance::CombinedSignalType&,RBX::Instance::ICombinedSignalData const*&>>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::Network::Replicator>,RBX::Network::Replicator::ReplicationData *,RBX::Instance::CombinedSignalType,RBX::Instance::ICombinedSignalData const*) &,boost::_bi::list2<RBX::Instance::CombinedSignalType&,RBX::Instance::ICombinedSignalData const*&> &,int)")
}
