//! network generated_netA_watchdog_47 — auto-generated, do not edit manually
//! Source: ida/export.json (85545 funcs, base 0x4000) EA 0x9c3778 | rbx_core::SharedPtr (not boost)
...
pub fn stub_9c3778(node: &crate::physics::PrimitiveNode, visit: &mut dyn FnMut(u32)) {
    // IDA 0x9c3794..0x9c3850: invoke the
    // `sendChildPrimitiveCoordinateFrame` bind on the primitive, then visit
    // each child primitive that is not its assembly root (IDA 0x9c3824).
