...
pub fn stub_246e98() -> Option<u32> {
    // IDA 0x246e98: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_246f90() {
    // IDA 0x246f90: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24710c() {
    // IDA 0x24710c: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0x24711c — __ZN3RBX13TaskScheduler20decrementThreadCountEv
// type: int __fastcall(int32_t *this, volatile int *)
#[doc(alias = "RBX::TaskScheduler::decrementThreadCount(void)")]
pub fn stub_24711c() {
    // IDA 0x24711c: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_247130() {
    // IDA 0x247130: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_247154() -> Option<u32> {
    // IDA 0x247154: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_247220() -> Option<u32> {
    // IDA 0x247220: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_247bd8() {
    // IDA 0x247bd8: dtor releases the owned control block/slots.
}
...
pub fn stub_247be8() -> Option<u32> {
    // IDA 0x247be8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_247db0() {
    // IDA 0x247db0: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_247e74() {
    // IDA 0x247e74: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0x247e90 — __ZN3RBX16ExclusiveArbiter11isThrottledEv
// type: int __fastcall(RBX::ExclusiveArbiter *this)
#[doc(alias = "RBX::ExclusiveArbiter::isThrottled(void)")]
pub fn stub_247e90() {
    // IDA 0x247e90: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_247e94() -> Option<u32> {
    // IDA 0x247e94: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_247fac() -> Option<u32> {
    // IDA 0x247fac: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248020(map: &mut HashMap<u32, i32>, key: u32) -> bool {
    // IDA 0x248020: Rb_tree erase of one node.
...
pub fn stub_248050() -> Option<u32> {
    // IDA 0x248050: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248104() -> Option<u32> {
    // IDA 0x248104: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248224() {
    // IDA 0x248224: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24831c() {
    // IDA 0x24831c: counted-impl dtor frees the control block.
}
// 0x248320 — __ZN5boost6detail17sp_counted_impl_pIN3RBX6CEventEED0Ev
// type: void __fastcall(void *)
#[doc(alias = "boost::detail::sp_counted_impl_p<RBX::CEvent>::~sp_counted_impl_p()")]
pub fn stub_248320() {
    // IDA 0x248320: counted-impl dtor frees the control block.
}
...
pub fn stub_24832c() {
    // IDA 0x24832c: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24834c() -> bool {
    // IDA 0x24834c: deleter query misses for this control block.
    false
}
...
pub fn stub_248350() -> bool {
    // IDA 0x248350: deleter query misses for this control block.
    false
}
...
pub fn stub_248358() {
    // IDA 0x248358: dtor releases the owned control block/slots.
}
...
pub fn stub_248448() {
    // IDA 0x248448: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_248620(has_weak: bool) -> bool {
    // IDA 0x248620: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_248778() -> bool {
    // IDA 0x248778: deleter query misses for this control block.
    false
}
...
pub fn stub_24877c(slot: &mut GenFunctor, op: u32) {
    // IDA 0x24877c: clone/destroy dispatch (0 = destroy).
...
pub fn stub_2487dc(slot: &GenFunctor, fire: &dyn Fn()) {
    // IDA 0x2487dc: invokes the stored bind functor.
    if slot.has { fire(); }
}
...
pub fn stub_2487f8(msg: &str) -> GenDateError {
    // IDA 0x2487f8: copy ctor captures the message into the injector.
    let _ = msg;
...
pub fn stub_248938() {
    // IDA 0x248938: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0x248940 — __ZN3RBX5mutexC2Ev
// type: pthread_mutex_t *__fastcall(pthread_mutex_t *this)
#[doc(alias = "RBX::mutex::mutex(void)")]
pub fn stub_248940() {
    // IDA 0x248940: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_248a8c() {
    // IDA 0x248a8c: dtor releases the owned control block/slots.
}
...
pub fn stub_248b80() {
    // IDA 0x248b80: dtor releases the owned control block/slots.
}
// 0x248b84 — __ZN5boost19thread_specific_ptrIPN3RBX13TaskScheduler3JobEE11delete_dataD0Ev
// type: void __fastcall(void *)
#[doc(alias = "boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data::~delete_data()")]
pub fn stub_248b84() {
    // IDA 0x248b84: dtor releases the owned control block/slots.
}
...
pub fn stub_248b90() -> Option<u32> {
    // IDA 0x248b90: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248ba0() {
    // IDA 0x248ba0: counted-impl dtor frees the control block.
}
...
#[doc(alias = "boost::detail::sp_counted_impl_pd<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data *,boost::detail::do_heap_delete<boost::thread_specific_ptr<RBX::TaskScheduler::Job *>::delete_data>>::~sp_counted_impl_pd()")]
pub fn stub_248ba4() {
    // IDA 0x248ba4: counted-impl dtor frees the control block.
}
...
pub fn stub_248bb0() -> Option<u32> {
    // IDA 0x248bb0: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248bc4() -> bool {
    // IDA 0x248bc4: deleter query misses for this control block.
    false
}
...
pub fn stub_248bdc() -> bool {
    // IDA 0x248bdc: deleter query misses for this control block.
    false
}
...
pub fn stub_248be0() {
    // IDA 0x248be0: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_248e38() -> Option<u32> {
    // IDA 0x248e38: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248eb0() -> Option<u32> {
    // IDA 0x248eb0: nullable object query (id when live, None when unset).
    None
}
// 0x248f10 — __ZNK3RBX13TaskScheduler3Job15averageStepTimeEv
// type: __int64 __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::averageStepTime(void)const")]
pub fn stub_248f10() -> Option<u32> {
    // IDA 0x248f10: nullable object query (id when live, None when unset).
    None
}
// 0x248f20 — __ZNK3RBX13TaskScheduler3Job12averageErrorEv
// type: __int64 __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::averageError(void)const")]
pub fn stub_248f20() -> Option<u32> {
    // IDA 0x248f20: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_248f2c() -> Option<u32> {
    // IDA 0x248f2c: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_2490ac() -> Option<u32> {
    // IDA 0x2490ac: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_249184() -> Option<u32> {
    // IDA 0x249184: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_249270() -> Option<u32> {
    // IDA 0x249270: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_249920(j: GenJob) {
    // IDA 0x249920: job dtor.
    let _ = j;
}
// 0x2499c0 — __ZN3RBX13TaskScheduler3JobD1Ev
// type: void __fastcall(RBX::TaskScheduler::Job *__hidden this)
#[doc(alias = "RBX::TaskScheduler::Job::~Job()")]
pub fn stub_2499c0(j: GenJob) {
    // IDA 0x2499c0: job dtor.
    let _ = j;
}
// 0x2499cc — __ZN3RBX13TaskScheduler3JobD2Ev
// type: void __fastcall(RBX::TaskScheduler::Job *this, int, int)
#[doc(alias = "RBX::TaskScheduler::Job::~Job()")]
pub fn stub_2499cc(j: GenJob) {
    // IDA 0x2499cc: job dtor.
    let _ = j;
}
...
pub fn stub_24a1f8() -> Option<u32> {
    // IDA 0x24a1f8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a210() -> Option<u32> {
    // IDA 0x24a210: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a408() -> Option<u32> {
    // IDA 0x24a408: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a440() -> Option<u32> {
    // IDA 0x24a440: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a448() -> Option<u32> {
    // IDA 0x24a448: nullable object query (id when live, None when unset).
    None
}
// 0x24a468 — __ZN3RBX13TaskScheduler3Job14updateWakeTimeEv
// type: int __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::updateWakeTime(void)")]
pub fn stub_24a468() -> Option<u32> {
    // IDA 0x24a468: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a4c0() -> Option<u32> {
    // IDA 0x24a4c0: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a598() -> Option<u32> {
    // IDA 0x24a598: nullable object query (id when live, None when unset).
    None
}
// 0x24a684 — __ZN3RBX13TaskScheduler3Job7preStepEv
// type: void __fastcall(RBX::TaskScheduler::Job *this)
#[doc(alias = "RBX::TaskScheduler::Job::preStep(void)")]
pub fn stub_24a684() -> Option<u32> {
    // IDA 0x24a684: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24a8b8() -> Option<u32> {
    // IDA 0x24a8b8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24ab18() -> Option<u32> {
    // IDA 0x24ab18: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24ac08() -> Option<u32> {
    // IDA 0x24ac08: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24ad00() -> Option<u32> {
    // IDA 0x24ad00: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24ad90() {
    // IDA 0x24ad90: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24ae08() {
    // IDA 0x24ae08: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24ae88() {
    // IDA 0x24ae88: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24afb0() {
    // IDA 0x24afb0: dtor releases the owned control block/slots.
}
...
pub fn stub_24b070(e: &GenDateError) -> ! {
    // IDA 0x24b070: __noreturn rethrow of the stored exception.
    panic!("rethrow: {}", e);
}
...
pub fn stub_24b120(e: &GenDateError) -> ! {
    // IDA 0x24b120: __noreturn rethrow of the stored exception.
    panic!("rethrow: {}", e);
}
...
pub fn stub_24b130() {
    // IDA 0x24b130: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24b208(this: u32) -> u32 {
    // IDA 0x24b208: this-adjustment thunk (this -= 8) then tail-call.
    this.wrapping_sub(8)
}
...
pub fn stub_24b2c8() {
    // IDA 0x24b2c8: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24b364() {
    // IDA 0x24b364: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24b45c() {
    // IDA 0x24b45c: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24b5a4() {
    // IDA 0x24b5a4: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24b6c8() {
    // IDA 0x24b6c8: counted-impl dtor frees the control block.
}
// 0x24b6cc — __ZN5boost6detail17sp_counted_impl_pINS_15circular_bufferIdSaIdEEEED0Ev
// type: void __fastcall(void *)
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::circular_buffer<double,std::allocator<double>>>::~sp_counted_impl_p()")]
pub fn stub_24b6cc() {
    // IDA 0x24b6cc: counted-impl dtor frees the control block.
}
...
pub fn stub_24b6d8() {
    // IDA 0x24b6d8: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24b714() -> bool {
    // IDA 0x24b714: deleter query misses for this control block.
    false
}
...
pub fn stub_24b718() -> bool {
    // IDA 0x24b718: deleter query misses for this control block.
    false
}
...
pub fn stub_24b71c() -> Option<u32> {
    // IDA 0x24b71c: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24b860(vec: &mut Vec<u32>, pos: usize, value: u32) {
    // IDA 0x24b860: vector insert with reallocation around the new element.
...
pub fn stub_24bdf8(v: &mut Vec<u32>, count: usize) {
    // IDA 0x24bdf8: shifts the tail backward (memmove semantics).
...
pub fn stub_24beb0() -> Option<u32> {
    // IDA 0x24beb0: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24bf64() {
    // IDA 0x24bf64: faithful no-op shell; control block / ref traffic stays engine-side.
}
// 0x24c02c — __ZN3RBX13TaskScheduler13endAllThreadsEv
// type: int __fastcall(int this)
#[doc(alias = "RBX::TaskScheduler::endAllThreads(void)")]
pub fn stub_24c02c() {
    // IDA 0x24c02c: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24c048() {
    // IDA 0x24c048: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24c1ec() -> Option<u32> {
    // IDA 0x24c1ec: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24c43c() -> Option<u32> {
    // IDA 0x24c43c: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24c5bc() {
    // IDA 0x24c5bc: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24c660() {
    // IDA 0x24c660: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24cd18() -> Option<u32> {
    // IDA 0x24cd18: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24ce78() -> Option<u32> {
    // IDA 0x24ce78: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24d05c() -> Option<u32> {
    // IDA 0x24d05c: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24d0ec() -> Option<u32> {
    // IDA 0x24d0ec: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24d284() {
    // IDA 0x24d284: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24d2dc() -> Option<u32> {
    // IDA 0x24d2dc: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24d368() {
    // IDA 0x24d368: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24d770() -> Option<u32> {
    // IDA 0x24d770: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24d7fc() -> Option<u32> {
    // IDA 0x24d7fc: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24d88c(fire: &dyn Fn(u32), inst: u32) {
    // IDA 0x24d88c: bind/call thunk forwards the instance id (mf1).
    fire(inst);
}
...
pub fn stub_24d9a4(vec: &mut Vec<u32>, pos: usize, value: u32) {
    // IDA 0x24d9a4: vector insert with reallocation around the new element.
    let at = pos.min(vec.len());
    vec.insert(at, value);
}
...
pub fn stub_24df3c(v: &mut Vec<u32>, count: usize) {
    // IDA 0x24df3c: shifts the tail backward (memmove semantics).
    let n = count.min(v.len());
    v.rotate_right(n);
}
...
pub fn stub_24dff8(vec: &mut Vec<u32>, pos: usize, value: u32) {
    // IDA 0x24dff8: vector insert with reallocation around the new element.
    let at = pos.min(vec.len());
    vec.insert(at, value);
}
...
pub fn stub_24e590(v: &mut Vec<u32>, count: usize) {
    // IDA 0x24e590: shifts the tail backward (memmove semantics).
    let n = count.min(v.len());
    v.rotate_right(n);
}
...
pub fn stub_24e648() {
    // IDA 0x24e648: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_24e6a8() -> Option<u32> {
    // IDA 0x24e6a8: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24e75c() -> Option<u32> {
    // IDA 0x24e75c: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24e870(slot: &mut Option<u32>) {
    // IDA 0x24e870: releases the owned ref (intrusive release engine-side).
    *slot = None;
}
...
pub fn stub_24e98c(vec: &mut Vec<u32>, pos: usize, value: u32) {
    // IDA 0x24e98c: vector insert with reallocation around the new element.
    let at = pos.min(vec.len());
    vec.insert(at, value);
}
...
pub fn stub_24ef24(v: &mut Vec<u32>, count: usize) {
    // IDA 0x24ef24: shifts the tail backward (memmove semantics).
    let n = count.min(v.len());
    v.rotate_right(n);
}
...
pub fn stub_24efe0() {
    // IDA 0x24efe0: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
#[doc(alias = "boost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<std::length_error>>::~clone_impl()")]
pub fn stub_24f0d8() {
    // IDA 0x24f0d8: dtor releases the owned control block/slots.
}
...
pub fn stub_24f190() {
    // IDA 0x24f190: dtor releases the owned control block/slots.
}
...
pub fn stub_24f248(msg: &str) -> GenDateError {
    // IDA 0x24f248: copy ctor captures the message into the injector.
    let _ = msg;
    GenDateError { kind: "injected" }
}
...
pub fn stub_24f388(msg: &str) -> GenDateError {
    // IDA 0x24f388: copy ctor captures the message into the injector.
    let _ = msg;
    GenDateError { kind: "injected" }
}
...
pub fn stub_24f520() -> Option<u32> {
    // IDA 0x24f520: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24f6c0() -> Option<u32> {
    // IDA 0x24f6c0: nullable object query (id when live, None when unset).
    None
}
...
pub fn stub_24f808(data: &[u8]) -> bool {
    // IDA 0x24f808: consumes the input buffer; false on malformed input.
    !data.is_empty()
}
...
pub fn stub_24f93c(slot: &mut GenFunctor) -> bool {
    // IDA 0x24f93c: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_24fa7c(slot: &mut GenFunctor, op: u32) {
    // IDA 0x24fa7c: clone/destroy dispatch (0 = destroy).
    if op == 0 { slot.has = false; }
}
...
pub fn stub_24faa0(slot: &GenFunctor, fire: &dyn Fn()) {
    // IDA 0x24faa0: invokes the stored bind functor.
    if slot.has { fire(); }
}
...
pub fn stub_24fac0(slot: &mut GenFunctor) -> bool {
    // IDA 0x24fac0: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_24fbf4(slot: &mut GenFunctor) -> bool {
    // IDA 0x24fbf4: copies the bind functor into the function buffer.
    slot.has = true;
    true
}
...
pub fn stub_24fdac(slot: &mut GenFunctor, op: u32) {
    // IDA 0x24fdac: clone/destroy dispatch (0 = destroy).
    if op == 0 { slot.has = false; }
}
...
pub fn stub_24ff48() {
    // IDA 0x24ff48: counted-impl dtor frees the control block.
}
...
pub fn stub_24ff58(has_weak: bool) -> bool {
    // IDA 0x24ff58: adopts the shared owner only when no weak owner exists.
    !has_weak
}
...
pub fn stub_2500b0() {
    // IDA 0x2500b0: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_2501bc() {
    // IDA 0x2501bc: dtor releases the owned control block/slots.
}
...
pub fn stub_2503f4() {
    // IDA 0x2503f4: counted-impl dtor frees the control block.
}
// 0x2503f8 — __ZN5boost6detail17sp_counted_impl_pIN3RBX13TaskScheduler6ThreadEED0Ev
// type: void __fastcall(void *)
#[doc(alias = "boost::detail::sp_counted_impl_p<RBX::TaskScheduler::Thread>::~sp_counted_impl_p()")]
pub fn stub_2503f8() {
    // IDA 0x2503f8: counted-impl dtor frees the control block.
}
...
pub fn stub_250404() {
    // IDA 0x250404: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_2504a8() -> bool {
    // IDA 0x2504a8: deleter query misses for this control block.
    false
}
...
pub fn stub_2504ac() -> bool {
    // IDA 0x2504ac: deleter query misses for this control block.
    false
}
...
pub fn stub_2504b0() {
    // IDA 0x2504b0: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_250588() {
    // IDA 0x250588: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_2506f8(e: GenDateError) -> ! {
    // IDA 0x2506f8: __noreturn __cxa_allocate_exception + __cxa_throw.
    panic!("throw: {}", e);
}
...
pub fn stub_250848() {
    // IDA 0x250848: dtor releases the owned control block/slots.
}
...
pub fn stub_250900() {
    // IDA 0x250900: dtor releases the owned control block/slots.
}
...
pub fn stub_2509b8(this: u32) -> u32 {
    // IDA 0x2509b8: this-adjustment thunk (this -= 8) then tail-call.
    this.wrapping_sub(8)
}
...
pub fn stub_250a70(this: u32) -> u32 {
    // IDA 0x250a70: this-adjustment thunk (this -= 8) then tail-call.
    this.wrapping_sub(8)
}
...
pub fn stub_250b28() {
    // IDA 0x250b28: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
pub fn stub_250bf8(e: &GenDateError) -> GenDateError {
    // IDA 0x250bf8: virtual clone of the stored exception.
    e.clone()
}
...
pub fn stub_250cb8() {
    // IDA 0x250cb8: faithful no-op shell; control block / ref traffic stays engine-side.
}
...
#[doc(alias = "boost::exception_detail::error_info_injector<std::runtime_error>::~error_info_injector()")]
pub fn stub_250d80() {
    // IDA 0x250d80: dtor releases the owned control block/slots.
}
...
pub fn stub_250e40(msg: &str) -> GenDateError {
    // IDA 0x250e40: copy ctor captures the message into the injector.
    let _ = msg;
    GenDateError { kind: "injected" }
}
...
pub fn stub_250fc8(value: u32) -> GenDateError {
    // IDA 0x250fc8: __noreturn policy hook: builds bad_month/day then throw_exception (throw elided, error returned).
    let _ = value;
