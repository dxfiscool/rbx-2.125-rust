//! Auto-generated skeletons for rbx-network — RakNet EA-sorted asc
//! Filter: RakNet -> 944 funcs (strict), 589 already stubbed before batch; batch EA-sorted asc next 100 filtered
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: +100 stubs | range 0xad36dc..0xb21844 | existing 589 -> 689 total (filtered EA-sorted asc, rbx_core::SharedPtr not boost)
...
// demangled: bool boost::multi_index::multi_index_container<RBX::Network::InterpolatingPhysicsReceiver::Nugget,boost::multi_index::indexed_by<boost::multi_index::hashed_unique<boost::multi_index::tag<RBX::Network:
// type: int __fastcall(int, char **, char *, int, int, void *, int, int, void *, int)
...
pub fn stub_adbe10() -> ! {
    todo!("0xadbe10 bool boost::multi_index::multi_index_container<RBX::Network::InterpolatingPhysicsReceiver::Nugget,bo")
}
...
// demangled: RBX::Network::Replicator::Replicator(RakNet::SystemAddress,boost::shared_ptr<RBX::Network::ConcurrentRakPeer>,RBX::NetworkSettings *,bool)
...
#[doc(alias = "RBX::Network::Replicator::Replicator(RakNet::SystemAddress,rbx_core::SharedPtr<RBX::Network::ConcurrentRakPeer>,RBX::NetworkSettings *,bool)")]
pub fn stub_ae10b8() -> ! {
    todo!("0xae10b8 RBX::Network::Replicator::Replicator(RakNet::SystemAddress,boost::shared_ptr<RBX::Network::Concurren")
}

// 0xae1f8c — __ZN3RBX7Network10Replicator18pushIncomingPacketEPN6RakNet6PacketE
// demangled: RBX::Network::Replicator::pushIncomingPacket(RakNet::Packet *)
...
// demangled: RBX::Network::Replicator::sendFilteredChatMessage(RakNet::SystemAddress const&,boost::shared_ptr<RakNet::BitStream> const&,std::string const&,std::string const&)
// type: void __fastcall(struct _Unwind_Exception *, int, int *, _DWORD *, int)
#[doc(alias = "RBX::Network::Replicator::sendFilteredChatMessage(RakNet::SystemAddress const&,rbx_core::SharedPtr<RakNet::BitStream> const&,std::string const&,std::string const&)")]
pub fn stub_aec7d4() -> ! {
    todo!("0xaec7d4 RBX::Network::Replicator::sendFilteredChatMessage(RakNet::SystemAddress const&,boost::shared_ptr<Rak")
}

// 0xaee424 — __ZN3RBX7Network10Replicator24serializeEventInvocationERKNS_10Reflection15EventInvocationERN6RakNet9BitStreamE
// demangled: RBX::Network::Replicator::serializeEventInvocation(RBX::Reflection::EventInvocation const&,RakNet::BitStream &)
// type: void __fastcall(RBX::Network::Replicator *this, const RBX::Reflection::EventInvocation *, RakNet::BitStream *)
#[doc(alias = "RBX::Network::Replicator::serializeEventInvocation(RBX::Reflection::EventInvocation const&,RakNet::BitStream &)")]
pub fn stub_aee424() -> ! {
    todo!("0xaee424 RBX::Network::Replicator::serializeEventInvocation(RBX::Reflection::EventInvocation const&,RakNet::B")
}

// 0xaee750 — __ZN3RBX7Network10Replicator14serializeValueERKNS_10Reflection4TypeERKNS2_7VariantERN6RakNet9BitStreamE
// demangled: RBX::Network::Replicator::serializeValue(RBX::Reflection::Type const&,RBX::Reflection::Variant const&,RakNet::BitStream &)
// type: int __fastcall(RBX::Network::IdSerializer *, int, int, RakNet::BitStream *)
#[doc(alias = "RBX::Network::Replicator::serializeValue(RBX::Reflection::Type const&,RBX::Reflection::Variant const&,RakNet::BitStream &)")]
pub fn stub_aee750() -> ! {
    todo!("0xaee750 RBX::Network::Replicator::serializeValue(RBX::Reflection::Type const&,RBX::Reflection::Variant const")
}

// 0xaf0ba8 — __ZN3RBX7Network10Replicator22serializePropertyValueERKNS_10Reflection13ConstPropertyERN6RakNet9BitStreamEb
// demangled: RBX::Network::Replicator::serializePropertyValue(RBX::Reflection::ConstProperty const&,RakNet::BitStream &,bool)
// type: void __fastcall(RBX::Network::Replicator *, const RBX::Reflection::PropertyDescriptor **, RBX::Network *, int)
#[doc(alias = "RBX::Network::Replicator::serializePropertyValue(RBX::Reflection::ConstProperty const&,RakNet::BitStream &,bool)")]
pub fn stub_af0ba8() -> ! {
    todo!("0xaf0ba8 RBX::Network::Replicator::serializePropertyValue(RBX::Reflection::ConstProperty const&,RakNet::BitSt")
}

// 0xaf1a48 — __ZN3RBX7Network10Replicator26deserializeEventInvocationERN6RakNet9BitStreamERNS_10Reflection15EventInvocationE
// demangled: RBX::Network::Replicator::deserializeEventInvocation(RakNet::BitStream &,RBX::Reflection::EventInvocation &)
// type: int __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *, struct _Unwind_Exception *)
#[doc(alias = "RBX::Network::Replicator::deserializeEventInvocation(RakNet::BitStream &,RBX::Reflection::EventInvocation &)")]
pub fn stub_af1a48() -> ! {
    todo!("0xaf1a48 RBX::Network::Replicator::deserializeEventInvocation(RakNet::BitStream &,RBX::Reflection::EventInvoc")
}

// 0xaf1e48 — __ZN3RBX7Network10Replicator16deserializeValueERN6RakNet9BitStreamERKNS_10Reflection4TypeERNS5_7VariantE
// demangled: RBX::Network::Replicator::deserializeValue(RakNet::BitStream &,RBX::Reflection::Type const&,RBX::Reflection::Variant &)
// type: int __fastcall(RBX::Network::IdSerializer *, RakNet::BitStream *, int, int)
#[doc(alias = "RBX::Network::Replicator::deserializeValue(RakNet::BitStream &,RBX::Reflection::Type const&,RBX::Reflection::Variant &)")]
pub fn stub_af1e48() -> ! {
    todo!("0xaf1e48 RBX::Network::Replicator::deserializeValue(RakNet::BitStream &,RBX::Reflection::Type const&,RBX::Ref")
}

// 0xaf4ab0 — __ZN3RBX7Network10Replicator18deserializeVariantERN6RakNet9BitStreamERNS_10Reflection7VariantE
// demangled: RBX::Network::Replicator::deserializeVariant(RakNet::BitStream &,RBX::Reflection::Variant &)
// type: int __fastcall(RBX::Network::IdSerializer *, RakNet::BitStream *this, int)
...
// demangled: RBX::Network::Replicator::deserializePropertyValue(RakNet::BitStream &,RBX::Reflection::Property,bool)
// type: void __fastcall(RBX::Network::IdSerializer *, pthread_mutex_t *lpuexcpt, int, pthread_mutex_t *, struct _Unwind_Exception *lpuexcpta, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int)
#[doc(alias = "RBX::Network::Replicator::deserializePropertyValue(RakNet::BitStream &,RBX::Reflection::Property,bool)")]
pub fn stub_af4b58() -> ! {
    todo!("0xaf4b58 RBX::Network::Replicator::deserializePropertyValue(RakNet::BitStream &,RBX::Reflection::Property,boo")
}
...
// demangled: RBX::Network::Replicator::writeChangedProperty(RBX::Instance const*,RBX::Reflection::PropertyDescriptor const&,RakNet::BitStream &)
...
pub fn stub_af6a9c() -> ! {
    todo!("0xaf6a9c RBX::Network::Replicator::writeChangedProperty(RBX::Instance const*,RBX::Reflection::PropertyDescrip")
}
...
// demangled: RBX::Network::Replicator::writeChangedRefProperty(RBX::Instance const*,RBX::Reflection::RefPropertyDescriptor const&,RBX::Guid::Data const&,RakNet::BitStream &)
...
pub fn stub_af6f9c() -> ! {
    todo!("0xaf6f9c RBX::Network::Replicator::writeChangedRefProperty(RBX::Instance const*,RBX::Reflection::RefPropertyD")
}

// 0xafcf70 — __ZN3RBX7Network10Replicator26readNonCacheablePropertiesERN6RakNet9BitStreamEPNS_8InstanceE
// demangled: RBX::Network::Replicator::readNonCacheableProperties(RakNet::BitStream &,RBX::Instance *)
...
// demangled: RBX::Network::Replicator::readPropertiesInternal(RBX::Reflection::Property &,RakNet::BitStream &,bool)
// type: void __fastcall(_DWORD *, RBX::Reflection::MemberDescriptor **, int, int, int, pthread_mutex_t *, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int)
#[doc(alias = "RBX::Network::Replicator::readPropertiesInternal(RBX::Reflection::Property &,RakNet::BitStream &,bool)")]
pub fn stub_afd10c() -> ! {
    todo!("0xafd10c RBX::Network::Replicator::readPropertiesInternal(RBX::Reflection::Property &,RakNet::BitStream &,boo")
}

// 0xafd694 — __ZN3RBX7Network10Replicator23readCacheablePropertiesERN6RakNet9BitStreamEPNS_8InstanceE
// demangled: RBX::Network::Replicator::readCacheableProperties(RakNet::BitStream &,RBX::Instance *)
// type: int *__fastcall(RBX::Network::Replicator *this, RakNet::BitStream *, RBX::Instance *)
...
// demangled: RBX::Network::Replicator::readInstanceNew(RakNet::BitStream &,bool)
// type: void __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *, pthread_mutex_t *)
...
// demangled: RBX::Network::Replicator::receiveCluster(RakNet::BitStream &,RBX::Instance *)
...
// demangled: RBX::Network::Replicator::readItem(RakNet::BitStream &,RBX::Network::Item::ItemType)
...
// demangled: RBX::Network::Replicator::readInstanceDelete(RakNet::BitStream &)
...
// demangled: RBX::Network::Replicator::readChangedProperty(RakNet::BitStream &)
// type: void __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *)
...
// demangled: RBX::Network::Replicator::readMarker(RakNet::BitStream &)
...
// demangled: RBX::Network::Replicator::readDataPing(RakNet::BitStream &)
// type: void __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *)
...
// demangled: RBX::Network::Replicator::readEventInvocation(RakNet::BitStream &)
// type: void __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *)
...
// demangled: RBX::Network::Replicator::readJoinData(RakNet::BitStream &)
...
// demangled: RBX::Network::Replicator::readChangedProperty(RakNet::BitStream &,RBX::Reflection::Property)
// type: void __fastcall(int *, RakNet::BitStream *, RBX::Reflection::MemberDescriptor **)
...
// demangled: RBX::Network::Replicator::processPacket(RakNet::Packet *)
...
// demangled: RBX::Network::Replicator::OnReceive(RakNet::Packet *)
...
// demangled: RBX::Network::Replicator::OnInternalPacket(RakNet::InternalPacket *,unsigned int,RakNet::SystemAddress,unsigned int,int)
...
pub fn stub_b04828() -> ! {
    todo!("0xb04828 RBX::Network::Replicator::OnInternalPacket(RakNet::InternalPacket *,unsigned int,RakNet::SystemAddre")
}
...
// demangled: RBX::Network::Replicator::NewInstanceItem::write(RakNet::BitStream &)
// type: int __fastcall(RBX::Network::Replicator::NewInstanceItem *this, RakNet::BitStream *)
...
// demangled: boost::_bi::bind_t<void,boost::_mfi::mf4<void,RBX::Network::Replicator,RakNet::SystemAddress const&,boost::shared_ptr<RakNet::BitStream> const&,std::string const&,std::string const&>,boost::_bi::list_
...
pub fn stub_b07980() -> ! {
    todo!("0xb07980 boost::_bi::bind_t<void,boost::_mfi::mf4<void,RBX::Network::Replicator,RakNet::SystemAddress const&,")
}

// 0xb0891c — __ZN3RBX7Network16serializeGenericISsEEvRKNS_10Reflection7VariantERN6RakNet9BitStreamE
// demangled: void RBX::Network::serializeGeneric<std::string>(RBX::Reflection::Variant const&,RakNet::BitStream &)
...
// demangled: RBX::Network::SenderDictionary<RBX::SystemAddress>::send(RakNet::BitStream &,RBX::SystemAddress const&)
...
pub fn stub_b08aa8() -> ! {
    todo!("0xb08aa8 RBX::Network::SenderDictionary<RBX::SystemAddress>::send(RakNet::BitStream &,RBX::SystemAddress cons")
}

// 0xb08b80 — __ZN3RBX7Network16serializeGenericINS_9ContentIdEEEvRKNS_10Reflection7VariantERN6RakNet9BitStreamE
// demangled: void RBX::Network::serializeGeneric<RBX::ContentId>(RBX::Reflection::Variant const&,RakNet::BitStream &)
...
pub fn stub_b08b80() -> ! {
    todo!("0xb08b80 void RBX::Network::serializeGeneric<RBX::ContentId>(RBX::Reflection::Variant const&,RakNet::BitStrea")
}

// 0xb08d10 — __ZNK3RBX7Network16DescriptorSenderINS_10Reflection4TypeEE4sendERN6RakNet9BitStreamEPKS3_
// demangled: RBX::Network::DescriptorSender<RBX::Reflection::Type>::send(RakNet::BitStream &,RBX::Reflection::Type const*)const
...
pub fn stub_b08d10() -> ! {
    todo!("0xb08d10 RBX::Network::DescriptorSender<RBX::Reflection::Type>::send(RakNet::BitStream &,RBX::Reflection::Typ")
}

// 0xb08fa0 — __ZN3RBX7Network18deserializeGenericIbEEvRNS_10Reflection7VariantERN6RakNet9BitStreamE
// demangled: void RBX::Network::deserializeGeneric<bool>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(int, int)
...
// demangled: void RBX::Network::deserializeGeneric<int>(RBX::Reflection::Variant &,RakNet::BitStream &)
...
// demangled: void RBX::Network::deserializeGeneric<long>(RBX::Reflection::Variant &,RakNet::BitStream &)
...
// demangled: void RBX::Network::deserializeGeneric<float>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(_DWORD *, int)
...
// demangled: void RBX::Network::deserializeGeneric<double>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(int, int)
...
// demangled: void RBX::Network::deserializeGeneric<RBX::UDim>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(int, int)
...
// demangled: void RBX::Network::deserializeGeneric<RBX::UDim2>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(int, int)
...
// demangled: void RBX::Network::deserializeGeneric<RBX::Faces>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(_DWORD *, int)
...
// demangled: void RBX::Network::deserializeGeneric<RBX::Axes>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int *__fastcall(int **, int)
...
// demangled: void RBX::Network::deserializeGeneric<RBX::BrickColor>(RBX::Reflection::Variant &,RakNet::BitStream &)
...
// demangled: void RBX::Network::deserializeGeneric<G3D::Color3>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int *__fastcall(int **, int)
...
// demangled: void RBX::Network::deserializeGeneric<G3D::Vector2>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(_DWORD *, int)
...
// demangled: void RBX::Network::deserializeGeneric<G3D::Vector3>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(int, int)
...
// demangled: void RBX::Network::deserializeGeneric<G3D::Vector3int16>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(int, int)
#[doc(alias = "void RBX::Network::deserializeGeneric<G3D::Vector3int16>(RBX::Reflection::Variant &,RakNet::BitStream &)")]
pub fn stub_b09900() -> ! {
    todo!("0xb09900 void RBX::Network::deserializeGeneric<G3D::Vector3int16>(RBX::Reflection::Variant &,RakNet::BitStrea")
}

// 0xb099c8 — __ZN3RBX7Network18deserializeGenericIN3G3D12Vector2int16EEEvRNS_10Reflection7VariantERN6RakNet9BitStreamE
// demangled: void RBX::Network::deserializeGeneric<G3D::Vector2int16>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: int __fastcall(_DWORD *, int)
#[doc(alias = "void RBX::Network::deserializeGeneric<G3D::Vector2int16>(RBX::Reflection::Variant &,RakNet::BitStream &)")]
pub fn stub_b099c8() -> ! {
    todo!("0xb099c8 void RBX::Network::deserializeGeneric<G3D::Vector2int16>(RBX::Reflection::Variant &,RakNet::BitStrea")
}

// 0xb09a80 — __ZN3RBX7Network18deserializeGenericINS_9ContentIdEEEvRNS_10Reflection7VariantERN6RakNet9BitStreamE
// demangled: void RBX::Network::deserializeGeneric<RBX::ContentId>(RBX::Reflection::Variant &,RakNet::BitStream &)
// type: void __fastcall(RBX::Name *, int)
...
// demangled: rbx::timestamped_safe_queue<RakNet::Packet *>::pop_if_waited(RBX::Time::Interval,RakNet::Packet *&)
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::decodeCells<RBX::OneQuarterClusterChunkCellIterator,RakNet::BitStream,RBX::Network::CellUpdateFilter>(RBX::MegaClusterInstance*,RakNet::BitStream
// type: int __fastcall(int, RBX::MegaClusterInstance *, RakNet::BitStream *this, int)
...
pub fn stub_b0ac2c() -> ! {
    todo!("0xb0ac2c void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::decodeCells<RBX::OneQuarterClusterChunkCellIt")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::decodeCells<RBX::ClusterCellIterator,RakNet::BitStream,RBX::Network::CellUpdateFilter>(RBX::MegaClusterInstance*,RakNet::BitStream &,RBX::Network
// type: int __fastcall(int, RBX::MegaClusterInstance *, RakNet::BitStream *this, int)
...
pub fn stub_b0b000() -> ! {
    todo!("0xb0b000 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::decodeCells<RBX::ClusterCellIterator,RakNet::")
}

// 0xb0b70c — __ZN3RBX7Network18DescriptorReceiverINS_10Reflection15ClassDescriptorEE5learnERN6RakNet9BitStreamE
// demangled: RBX::Network::DescriptorReceiver<RBX::Reflection::ClassDescriptor>::learn(RakNet::BitStream &)
// type: void __fastcall(_DWORD *, int, int, int, int, int, int, int, int, int, int, int, char, char, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: RBX::Network::DescriptorReceiver<RBX::Reflection::PropertyDescriptor>::learn(RakNet::BitStream &)
// type: void __fastcall(_DWORD *, int, int, int, int, int, int, int, int, int, int, int, char, char, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: RBX::Network::DescriptorReceiver<RBX::Reflection::EventDescriptor>::learn(RakNet::BitStream &)
// type: void __fastcall(_DWORD *, int, int, int, int, int, int, int, int, int, int, int, char, char, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: RBX::Network::DescriptorReceiver<RBX::Reflection::Type>::learn(RakNet::BitStream &)
// type: void __fastcall(_DWORD *, int, int, int, int, int, int, int, int, int, int, int, char, char, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: RBX::Network::DescriptorSender<RBX::Reflection::ClassDescriptor>::teach(RakNet::BitStream &)const
...
// demangled: RBX::Network::DescriptorSender<RBX::Reflection::PropertyDescriptor>::teach(RakNet::BitStream &)const
// type: void __fastcall(int, int, int, int, int, int, int, int, int, char, int, int, struct _Unwind_Exception *lpuexcpt)
...
// demangled: RBX::Network::DescriptorSender<RBX::Reflection::EventDescriptor>::teach(RakNet::BitStream &)const
// type: void __fastcall(int, int, int, int, int, int, int, int, int, char, int, int, struct _Unwind_Exception *lpuexcpt)
...
// demangled: RBX::Network::DescriptorSender<RBX::Reflection::Type>::teach(RakNet::BitStream &)const
// type: void __fastcall(int, int, int, int, int, int, int, int, int, char, int, int, struct _Unwind_Exception *lpuexcpt)
...
// demangled: RBX::Network::Replicator::serializeSFFlags(RakNet::BitStream &)
// type: void __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *)
...
// demangled: RBX::Network::Replicator::deserializeSFFlags(RakNet::BitStream &)
// type: void __fastcall(RBX::Network::Replicator *this, RakNet::BitStream *)
...
// demangled: RakNet::PluginInterface2::OnAttach(void)
// type: void __fastcall(RakNet::PluginInterface2 *this)
...
// demangled: RakNet::PluginInterface2::Update(void)
// type: void __fastcall(RakNet::PluginInterface2 *this)
...
// demangled: RakNet::PluginInterface2::OnRakPeerShutdown(void)
// type: void __fastcall(RakNet::PluginInterface2 *this)
...
// demangled: RakNet::PluginInterface2::OnNewConnection(RakNet::SystemAddress const&,RakNet::RakNetGUID,bool)
// type: void()
...
// demangled: RakNet::PluginInterface2::OnDirectSocketReceive(char const*,unsigned int,RakNet::SystemAddress)
// type: void()
...
// demangled: RakNet::PluginInterface2::OnAck(unsigned int,RakNet::SystemAddress,unsigned int)
// type: void()
...
// demangled: void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeCells<RBX::OneQuarterClusterChunkCellIterator,RakNet::BitStream>(RBX::Voxel::Grid const*,RBX::OneQuarterClusterChunkCellIterator &,RakNet::BitStrea
...
pub fn stub_b15f50() -> ! {
    todo!("0xb15f50 void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeCells<RBX::OneQuarterClusterChunkCellIterator,R")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeCells<RBX::OneQuarterClusterChunkCellIterator,RakNet::BitStream>(RBX::MegaClusterInstance const*,RBX::OneQuarterClusterChunkCellIterator &,
// type: unsigned int __fastcall(int, const G3D::Vector3int16 *, int, RakNet::BitStream *, signed int)
...
pub fn stub_b16410() -> ! {
    todo!("0xb16410 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeCells<RBX::OneQuarterClusterChunkCellIt")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeFromPosition<RBX::OneQuarterClusterChunkCellIterator,RakNet::BitStream>(RBX::MegaClusterInstance const*,G3D::Vector3int16 &,RBX::SpatialReg
...
pub fn stub_b168d0() -> ! {
    todo!("0xb168d0 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeFromPosition<RBX::OneQuarterClusterChun")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeFromPosition<RBX::OneQuarterClusterChunkCellIterator,RakNet::BitStream>(RBX::Voxel::Grid const*,G3D::Vector3int16 &,RBX::SpatialRegion::Id const&,R
// type: unsigned int __fastcall(int, int, _WORD *, unsigned __int16 *, int *, int, __int16 *, RakNet::BitStream *)
...
pub fn stub_b16e90() -> ! {
    todo!("0xb16e90 void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeFromPosition<RBX::OneQuarterClusterChunkCellIte")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeCells<RBX::Network::ClusterUpdateBuffer,RakNet::BitStream>(RBX::Voxel::Grid const*,RBX::Network::ClusterUpdateBuffer &,RakNet::BitStream *,int)cons
...
pub fn stub_b173b0() -> ! {
    todo!("0xb173b0 void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeCells<RBX::Network::ClusterUpdateBuffer,RakNet:")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeCells<RBX::Network::ClusterUpdateBuffer,RakNet::BitStream>(RBX::MegaClusterInstance const*,RBX::Network::ClusterUpdateBuffer &,RakNet::BitS
// type: unsigned int __fastcall(int, const G3D::Vector3int16 *, RBX::Network::ClusterUpdateBuffer *, RakNet::BitStream *, signed int)
...
pub fn stub_b17764() -> ! {
    todo!("0xb17764 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeCells<RBX::Network::ClusterUpdateBuffer")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeFromPosition<RBX::Network::ClusterUpdateBuffer,RakNet::BitStream>(RBX::MegaClusterInstance const*,G3D::Vector3int16 &,RBX::SpatialRegion::I
...
pub fn stub_b17b18() -> ! {
    todo!("0xb17b18 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeFromPosition<RBX::Network::ClusterUpdat")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeFromPosition<RBX::Network::ClusterUpdateBuffer,RakNet::BitStream>(RBX::Voxel::Grid const*,G3D::Vector3int16 &,RBX::SpatialRegion::Id const&,RBX::Vo
...
pub fn stub_b180c4() -> ! {
    todo!("0xb180c4 void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeFromPosition<RBX::Network::ClusterUpdateBuffer,")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeCells<RBX::ClusterCellIterator,RakNet::BitStream>(RBX::Voxel::Grid const*,RBX::ClusterCellIterator &,RakNet::BitStream *,int)const
...
pub fn stub_b18564() -> ! {
    todo!("0xb18564 void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeCells<RBX::ClusterCellIterator,RakNet::BitStrea")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeCells<RBX::ClusterCellIterator,RakNet::BitStream>(RBX::MegaClusterInstance const*,RBX::ClusterCellIterator &,RakNet::BitStream *,int)const
// type: unsigned int __fastcall(G3D::Vector3int16 *, const G3D::Vector3int16 *, int *, RakNet::BitStream *, signed int)
...
pub fn stub_b189a4() -> ! {
    todo!("0xb189a4 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeCells<RBX::ClusterCellIterator,RakNet::")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeFromPosition<RBX::ClusterCellIterator,RakNet::BitStream>(RBX::MegaClusterInstance const*,G3D::Vector3int16 &,RBX::SpatialRegion::Id const&,
...
pub fn stub_b18de4() -> ! {
    todo!("0xb18de4 void RBX::Voxel::Serializer<RBX::MegaClusterInstance>::encodeFromPosition<RBX::ClusterCellIterator,R")
}
...
// demangled: void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeFromPosition<RBX::ClusterCellIterator,RakNet::BitStream>(RBX::Voxel::Grid const*,G3D::Vector3int16 &,RBX::SpatialRegion::Id const&,RBX::Voxel::Regi
...
pub fn stub_b193d8() -> ! {
    todo!("0xb193d8 void RBX::Voxel::Serializer<RBX::Voxel::Grid>::encodeFromPosition<RBX::ClusterCellIterator,RakNet::B")
}
...
// demangled: rbx::signals::signal<void ()(RakNet::SystemAddress const&,boost::shared_ptr<RakNet::BitStream> const&,std::string const&,std::string const&)>::insert(rbx::signals::signal<void ()(RakNet::SystemAddress
...
pub fn stub_b21580() -> ! {
    todo!("0xb21580 rbx::signals::signal<void ()(RakNet::SystemAddress const&,boost::shared_ptr<RakNet::BitStream> const")
}
...
// demangled: boost::intrusive_ptr<rbx::signals::signal<void ()(RakNet::SystemAddress const&,boost::shared_ptr<RakNet::BitStream> const&,std::string const&,std::string const&)>::slot>::operator=(rbx::signals::signa
...
pub fn stub_b21844() -> ! {
    todo!("0xb21844 boost::intrusive_ptr<rbx::signals::signal<void ()(RakNet::SystemAddress const&,boost::shared_ptr<Rak")
}