//! Auto-generated skeletons for rbx-network — EA-sorted ascending filtered
//! Filter: RakNet|RBX::Network (case-insensitive) -> 4479 funcs, 1640 already stubbed (2839 remaining before batch); filtered EA-sorted asc next 100 uncovered
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: +100 stubs | range 0x959734..0x960234 | existing 8890 -> 8990 total (filtered EA-sorted asc, rbx_core::SharedPtr not boost)
...
// demangled: rbx::implementation::typed_holder<RBX::Network::Player::ChatMode>::construct_func(char const*,char *)
...
// demangled: rbx::implementation::typed_holder<RBX::Network::Player::ChatMode>::destruct_func(char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::ChatMode>::convertToItem(RBX::Network::Player::ChatMode const&)const
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType> const>::initSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::~EnumDesc()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::convertToValue(unsigned long,RBX::Reflection::Variant &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::convertToString(unsigned long,std::string &)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::convertToString(RBX::Network::Player::MembershipType const&)const
...
// demangled: RBX::Reflection::Variant& RBX::Reflection::Variant::operator=<RBX::Network::Player::MembershipType>(RBX::Network::Player::MembershipType const&)
...
// demangled: rbx::implementation::typed_holder<RBX::Network::Player::MembershipType>::construct_func(char const*,char *)
...
// demangled: rbx::implementation::typed_holder<RBX::Network::Player::MembershipType>::destruct_func(char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::Player::MembershipType>::convertToItem(RBX::Network::Player::MembershipType const&)const
...
// demangled: RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::Network::FilterResult> const>::initSingleton(void)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::FilterResult>::~EnumDesc()
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::FilterResult>::lookup(char const*)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::FilterResult>::lookup(RBX::Reflection::Variant const&)const
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::FilterResult>::convertToString(RBX::Network::FilterResult const&)const
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
// demangled: rbx::implementation::typed_holder<RBX::Network::FilterResult>::construct_func(char const*,char *)
...
// demangled: RBX::Reflection::EnumDesc<RBX::Network::FilterResult>::convertToItem(RBX::Network::FilterResult const&)const
...
// demangled: RBX::Network::ServerReplicator::setPropSyncExpiration(double)
...
// demangled: RBX::Network::ServerReplicator::findTargetPlayer(void)const
...
// demangled: RBX::Network::ServerReplicator::getRemotePlayer(void)const
// type: _DWORD __fastcall(RBX::Network::ServerReplicator *__hidden this)
...
// demangled: RBX::Network::ServerReplicator::isProtectedStringEnabled(void)
// type: _DWORD __fastcall(RBX::Network::ServerReplicator *__hidden this)
...
// demangled: RBX::Network::serializeEnum(RBX::Reflection::EnumDescriptor const*,RBX::Reflection::Variant const&,RakNet::BitStream &)
...
pub fn stub_95d5d0(stream: &mut crate::bitstream::BitStream, value_index: u32, enum_count: u32, bits: u8) {
 // IDA 0x95d5d0: value index over `bits` bits.
 crate::custom_serializer::serialize_enum(stream, value_index, enum_count, bits)
}

// 0x95d694 — __ZN3RBX7Network15deserializeEnumEPKNS_10Reflection14EnumDescriptorERNS1_7VariantERN6RakNet9BitStreamE
// demangled: RBX::Network::deserializeEnum(RBX::Reflection::EnumDescriptor const*,RBX::Reflection::Variant &,RakNet::BitStream &)
...
// demangled: RBX::Network::serializeEnumProperty(RBX::Reflection::ConstProperty const&,RakNet::BitStream &)
...
pub fn stub_95d968(stream: &mut crate::bitstream::BitStream, value: u32, enum_count: u32, bits: u8) {
 // IDA 0x95d968: property value over `bits` bits.
 crate::custom_serializer::serialize_enum_property(stream, value, enum_count, bits)
}

// 0x95da34 — __ZN3RBX7Network23deserializeEnumPropertyERNS_10Reflection8PropertyERN6RakNet9BitStreamE
// demangled: RBX::Network::deserializeEnumProperty(RBX::Reflection::Property &,RakNet::BitStream &)
...
// demangled: RBX::operator<<(RakNet::BitStream &,int)
...
// demangled: RakNet::BitStream & RBX::operator>><long>(RakNet::BitStream &,long &)
...
// demangled: RBX::operator<<(RakNet::BitStream &,unsigned long long const&)
...
// demangled: RakNet::BitStream & RBX::operator>><unsigned long long>(RakNet::BitStream &,unsigned long long &)
...
// demangled: RBX::operator<<(RakNet::BitStream &,long)
// type: int __fastcall(int, __guard *)
...
// demangled: RakNet::BitStream & RBX::operator>><int>(RakNet::BitStream &,int &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,unsigned int)
// type: int __fastcall(int, __guard *)
...
// demangled: RakNet::BitStream & RBX::operator>><unsigned int>(RakNet::BitStream &,unsigned int &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><unsigned long>(RakNet::BitStream &,unsigned long &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><char>(RakNet::BitStream &,char &)
...
// demangled: RBX::operator<<(RakNet::BitStream &,unsigned char)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><unsigned char>(RakNet::BitStream &,unsigned char &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,bool)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><bool>(RakNet::BitStream &,bool &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,float)
// type: int __fastcall(int, __guard *)
...
// demangled: RakNet::BitStream & RBX::operator>><float>(RakNet::BitStream &,float &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,double)
...
// demangled: RakNet::BitStream & RBX::operator>><double>(RakNet::BitStream &,double &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,std::string const&)
...
// demangled: RakNet::BitStream & RBX::operator>><std::string>(RakNet::BitStream &,std::string &)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::ContentId const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::ContentId>(RakNet::BitStream &,RBX::ContentId &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::BrickColor const&)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::UDim const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::UDim2 const&)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::RbxRay const&)
// type: int __fastcall(_DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,G3D::Vector3 const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::Faces const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::Axes const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,G3D::Color3 const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::Network::writeBrickVector(RakNet::BitStream &,G3D::Vector3 const&)
...
// demangled: RBX::Network::readBrickVector(RakNet::BitStream &,G3D::Vector3 &)
...
// demangled: RBX::operator<<(RakNet::BitStream &,G3D::Vector2 const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><G3D::Vector2>(RakNet::BitStream &,G3D::Vector2 &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::StreamRegion::Id const&)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::StreamRegion::Id>(RakNet::BitStream &,RBX::StreamRegion::Id &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><G3D::Vector3>(RakNet::BitStream &,G3D::Vector3 &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,short)
// type: int __fastcall(int, __guard *)
...
// demangled: RakNet::BitStream & RBX::operator>><short>(RakNet::BitStream &,short &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,G3D::Vector3int16 const&)
// type: int __fastcall(int)
...
// demangled: RakNet::BitStream & RBX::operator>><G3D::Vector3int16>(RakNet::BitStream &,G3D::Vector3int16 &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,G3D::Vector2int16 const&)
// type: int __fastcall(int)
...
// demangled: RakNet::BitStream & RBX::operator>><G3D::Vector2int16>(RakNet::BitStream &,G3D::Vector2int16 &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,G3D::CoordinateFrame const&)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><G3D::CoordinateFrame>(RakNet::BitStream &,G3D::CoordinateFrame &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::UDim>(RakNet::BitStream &,RBX::UDim &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::UDim2>(RakNet::BitStream &,RBX::UDim2 &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::RbxRay>(RakNet::BitStream &,RBX::RbxRay &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::Faces>(RakNet::BitStream &,RBX::Faces &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::Axes>(RakNet::BitStream &,RBX::Axes &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::BrickColor>(RakNet::BitStream &,RBX::BrickColor &)
// type: int __fastcall(RakNet::BitStream *this)
...
// demangled: RakNet::BitStream & RBX::operator>><G3D::Color3>(RakNet::BitStream &,G3D::Color3 &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: RBX::operator<<(RakNet::BitStream &,RBX::SystemAddress)
...
// demangled: RakNet::BitStream & RBX::operator>><RBX::SystemAddress>(RakNet::BitStream &,RBX::SystemAddress &)
// type: int __fastcall(_DWORD, _DWORD)
...
// demangled: void RBX::Network::serialize<RBX::ContentId>(RBX::Reflection::ConstProperty const&,RakNet::BitStream &)
// type: int __fastcall(_DWORD, _DWORD)
#[doc(alias = "void RBX::Network::serialize<RBX::ContentId>(RBX::Reflection::ConstProperty const&,RakNet::BitStream &)")]
pub fn stub_95fe40(stream: &mut crate::bitstream::BitStream, id: &str) {
 // IDA 0x95fe40: property ContentId via the string writer.
 crate::custom_serializer::write_content_id(stream, id)
}
