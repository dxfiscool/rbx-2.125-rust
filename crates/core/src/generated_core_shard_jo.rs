...
pub fn stub_1db720() {
    // IDA 0x1db720: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Stream_GetLongLE")]
// 0x1db764 — _FT_Stream_GetLongLE
pub fn stub_1db764() {
    // IDA 0x1db764: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Stream_ReadChar")]
// 0x1db7a8 — _FT_Stream_ReadChar
pub fn stub_1db7a8() {
    // IDA 0x1db7a8: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1db830() {
    // IDA 0x1db830: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Stream_ReadShortLE")]
// 0x1db8c8 — _FT_Stream_ReadShortLE
pub fn stub_1db8c8() {
    // IDA 0x1db8c8: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Stream_ReadOffset")]
// 0x1db960 — _FT_Stream_ReadOffset
pub fn stub_1db960() {
    // IDA 0x1db960: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Stream_ReadLong")]
// 0x1db9fc — _FT_Stream_ReadLong
pub fn stub_1db9fc() {
    // IDA 0x1db9fc: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_raccess_guess_apple_generic")]
// 0x1dbaa4 — _raccess_guess_apple_generic
pub fn stub_1dbaa4() {
    // IDA 0x1dbaa4: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_raccess_guess_apple_single")]
// 0x1dbea8 — _raccess_guess_apple_single
pub fn stub_1dbea8() {
    // IDA 0x1dbea8: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_raccess_guess_apple_double")]
// 0x1dbee0 — _raccess_guess_apple_double
pub fn stub_1dbee0() {
    // IDA 0x1dbee0: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD, _DWORD)
pub fn stub_1dbf18() {
    // IDA 0x1dbf18: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_ft_trig_downscale")]
// 0x1dbfc0 — _ft_trig_downscale
pub fn stub_1dbfc0() {
    // IDA 0x1dbfc0: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_ft_trig_prenorm")]
// 0x1dc020 — _ft_trig_prenorm
pub fn stub_1dc020() {
    // IDA 0x1dc020: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_ft_trig_pseudo_polarize")]
// 0x1dc0b4 — _ft_trig_pseudo_polarize
pub fn stub_1dc0b4() {
    // IDA 0x1dc0b4: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD)
pub fn stub_1dc2f0() {
    // IDA 0x1dc2f0: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_ft_mem_qalloc")]
// 0x1dc370 — _ft_mem_qalloc
pub fn stub_1dc370() {
    // IDA 0x1dc370: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD, _DWORD)
pub fn stub_1dc3b4() {
    // IDA 0x1dc3b4: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD)
pub fn stub_1dc3c4() {
    // IDA 0x1dc3c4: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD, _DWORD)
pub fn stub_1dc400() {
    // IDA 0x1dc400: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD)
pub fn stub_1dc508() {
    // IDA 0x1dc508: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD, _DWORD)
pub fn stub_1dc534() {
    // IDA 0x1dc534: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_ft_cmap_done_internal")]
// 0x1dc574 — _ft_cmap_done_internal
pub fn stub_1dc574() {
    // IDA 0x1dc574: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_memory_stream_close")]
// 0x1dc5a8 — _memory_stream_close
pub fn stub_1dc5a8() {
    // IDA 0x1dc5a8: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_destroy_charmaps")]
// 0x1dc5d4 — _destroy_charmaps
pub fn stub_1dc5d4() {
    // IDA 0x1dc5d4: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_destroy_size")]
// 0x1dc640 — _destroy_size
pub fn stub_1dc640() {
    // IDA 0x1dc640: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD)
pub fn stub_1dc69c() {
    // IDA 0x1dc69c: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_ft_glyphslot_set_bitmap")]
// 0x1dc6f8 — _ft_glyphslot_set_bitmap
pub fn stub_1dc6f8() {
    // IDA 0x1dc6f8: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_FT_Stream_Free")]
// 0x1dc714 — _FT_Stream_Free
pub fn stub_1dc714() {
    // IDA 0x1dc714: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_FT_GlyphLoader_Reset")]
// 0x1dc748 — _FT_GlyphLoader_Reset
pub fn stub_1dc748() {
    // IDA 0x1dc748: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_FT_GlyphLoader_Done")]
// 0x1dc7c8 — _FT_GlyphLoader_Done
pub fn stub_1dc7c8() {
    // IDA 0x1dc7c8: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_ft_glyphslot_done")]
// 0x1dc7f0 — _ft_glyphslot_done
pub fn stub_1dc7f0() {
    // IDA 0x1dc7f0: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
// type: int __fastcall(_DWORD)
pub fn stub_1dc864() {
    // IDA 0x1dc864: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1dc8d4() {
    // IDA 0x1dc8d4: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD, _DWORD)
pub fn stub_1dcb10() {
    // IDA 0x1dcb10: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_List_Add")]
// 0x1dcb34 — _FT_List_Add
pub fn stub_1dcb34() {
    // IDA 0x1dcb34: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_List_Remove")]
// 0x1dcb58 — _FT_List_Remove
pub fn stub_1dcb58() {
    // IDA 0x1dcb58: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD)
pub fn stub_1dcb78() {
    // IDA 0x1dcb78: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_List_Up")]
// 0x1dcc28 — _FT_List_Up
pub fn stub_1dcc28() {
    // IDA 0x1dcc28: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Set_Renderer")]
// 0x1dcc68 — _FT_Set_Renderer
pub fn stub_1dcc68() {
    // IDA 0x1dcc68: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Render_Glyph_Internal")]
// 0x1dcdd0 — _FT_Render_Glyph_Internal
pub fn stub_1dcdd0() {
    // IDA 0x1dcdd0: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_FT_Render_Glyph")]
// 0x1dcec0 — _FT_Render_Glyph
pub fn stub_1dcec0() {
    // IDA 0x1dcec0: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(_DWORD, _DWORD)
pub fn stub_1dddc8() {
    // IDA 0x1dddc8: FreeType PFR/autofit/renderer helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1de674() {
    // IDA 0x1de674: FreeType PFR/autofit/renderer helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1df110() {
    // IDA 0x1df110: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(int, int, char *__s, int, int)
pub fn stub_1dfcec() {
    // IDA 0x1dfcec: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
// type: int __fastcall(int, int, char *__s, int, int)
pub fn stub_1e1814() {
    // IDA 0x1e1814: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1e1ee4() {
    // IDA 0x1e1ee4: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1ed148() {
    // IDA 0x1ed148: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_1f023c() {
    // IDA 0x1f023c: FreeType CID/PCF/stream/charmap helper owned by the rendering crate — carrier no-op in core.
}
