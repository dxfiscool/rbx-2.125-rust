//! generated watchdog core 1788382897 - 100 core stubs EA-sorted, global dedup against 64155 existing 0x-prefixed stubs.
//! Source: ida/export.json filtered excludes Reflection|Instance|DataModel|Workspace|Ogre|G3D|RakNet|Network|Replicator|Lua|Script|Yield|FMOD|Audio|Sound + boost, EA-sorted, next 100 uncovered after global dedup.
//! Sanitized: boost::shared_ptr -> rbx_core::SharedPtr, single quotes removed.
...
pub fn stub_0x74a8c8() {
    // IDA 0x74a8c8: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::Primitive::computeJointK(void)")]
// 0x74aa18 - __ZN3RBX9Primitive13computeJointKEv
pub fn stub_0x74aa18() {
    // IDA 0x74aa18: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::Primitive::~Primitive()")]
// 0x74aa5c - __ZN3RBX9PrimitiveD0Ev
pub fn stub_0x74aa5c() {
...
pub fn stub_0x74cb38() {
    // IDA 0x74cb38: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Primitive::setSpecificGravity(float)")]
// 0x74cc78 - __ZN3RBX9Primitive18setSpecificGravityEf
pub fn stub_0x74cc78() {
    // IDA 0x74cc78: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Primitive::computeIsGrounded(void)const")]
// 0x74cc90 - __ZNK3RBX9Primitive17computeIsGroundedEv
pub fn stub_0x74cc90() {
