...
pub fn stub_76404c() {
    // IDA 0x76404c: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::insertJoint(RBX::Joint *)")]
// 0x764230 — __ZN3RBX5World11insertJointEPNS_5JointE
pub fn stub_764230() {
    // IDA 0x764230: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::destroyJoint(RBX::Joint *)")]
// 0x7643d8 — __ZN3RBX5World12destroyJointEPNS_5JointE
pub fn stub_7643d8() {
    // IDA 0x7643d8: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::removeFromBreakable(RBX::Joint *)")]
// 0x764440 — __ZN3RBX5World19removeFromBreakableEPNS_5JointE
pub fn stub_764440() {
    // IDA 0x764440: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::removeJoint(RBX::Joint *)")]
// 0x7644b8 — __ZN3RBX5World11removeJointEPNS_5JointE
pub fn stub_7644b8() {
    // IDA 0x7644b8: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::notifyMoved(RBX::Primitive *)")]
// 0x7644e0 — __ZN3RBX5World11notifyMovedEPNS_9PrimitiveE
pub fn stub_7644e0() {
    // IDA 0x7644e0: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::jointCoordsChanged(RBX::Joint *)")]
// 0x764528 — __ZN3RBX5World18jointCoordsChangedEPNS_5JointE
pub fn stub_764528() {
    // IDA 0x764528: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::insertContact(RBX::Contact *)")]
// 0x7646b4 — __ZN3RBX5World13insertContactEPNS_7ContactE
pub fn stub_7646b4() {
    // IDA 0x7646b4: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::destroyContact(RBX::Contact *)")]
// 0x7646cc — __ZN3RBX5World14destroyContactEPNS_7ContactE
pub fn stub_7646cc() {
    // IDA 0x7646cc: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_764854() {
    // IDA 0x764854: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::insertPrimitive(RBX::Primitive *)")]
// 0x76485c — __ZN3RBX5World15insertPrimitiveEPNS_9PrimitiveE
pub fn stub_76485c() {
    // IDA 0x76485c: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::World::removePrimitive(RBX::Primitive *,bool)")]
// 0x764b38 — __ZN3RBX5World15removePrimitiveEPNS_9PrimitiveEb
pub fn stub_764b38() {
    // IDA 0x764b38: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_76cd58() {
    // IDA 0x76cd58: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_77a7dc() {
    // IDA 0x77a7dc: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_77aa10() {
    // IDA 0x77aa10: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_77ab14() {
    // IDA 0x77ab14: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_77ac24() {
    // IDA 0x77ac24: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_77ac70() {
    // IDA 0x77ac70: script/reflection wiring owned by the script/datamodel crates — carrier no-op in core.
}
...
pub fn stub_77ad60() {
    // IDA 0x77ad60: script/reflection wiring owned by the script/datamodel crates — carrier no-op in core.
}
...
pub fn stub_77ad64() {
    // IDA 0x77ad64: script/reflection wiring owned by the script/datamodel crates — carrier no-op in core.
}

#[doc(alias = "rbx::signals::signal<void ()(lua_State *)>::slot::~slot()")]
// 0x77ae54 — __ZN3rbx7signals6signalIFvP9lua_StateEE4slotD1Ev
pub fn stub_77ae54() {
    // IDA 0x77ae54: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "rbx::signals::signal<void ()(lua_State *)>::slot::~slot()")]
// 0x77ae80 — __ZN3rbx7signals6signalIFvP9lua_StateEE4slotD0Ev
pub fn stub_77ae80() {
    // IDA 0x77ae80: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "rbx::signals::signal<void ()(int)>::disconnectAll(void)")]
// 0x780eb0 — __ZN3rbx7signals6signalIFviEE13disconnectAllEv
pub fn stub_780eb0() {
    // IDA 0x780eb0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_78a098() {
    // IDA 0x78a098: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "XmlAttribute::XmlAttribute<int>(RBX::Name const&,int)")]
// 0x78a16c — __ZN12XmlAttributeC2IiEERKN3RBX4NameET_
pub fn stub_78a16c() {
    // IDA 0x78a16c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_78a230() {
    // IDA 0x78a230: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "XmlNameValuePair::XmlNameValuePair(RBX::Name const&,char const*)")]
// 0x78a2ec — __ZN16XmlNameValuePairC2ERKN3RBX4NameEPKc
pub fn stub_78a2ec() {
    // IDA 0x78a2ec: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_78a824() {
    // IDA 0x78a824: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_78a880() {
    // IDA 0x78a880: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_78ac98() {
    // IDA 0x78ac98: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7986c0() {
    // IDA 0x7986c0: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "XmlElement::findAttribute(RBX::Name const&)const")]
// 0x79894c — __ZNK10XmlElement13findAttributeERKN3RBX4NameE
pub fn stub_79894c() {
    // IDA 0x79894c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7989a4() {
    // IDA 0x7989a4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_798af0() {
    // IDA 0x798af0: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_798b64() {
    // IDA 0x798b64: XML serialization helper. Serializer owned by higher crates — carrier no-op in core.
}
...
pub fn stub_798b7c() {
    // IDA 0x798b7c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
