//! core watchdog p — 100 core stubs EA-sorted, sixteenth gap filler after watchdog_o 0x392c78.
//! Source: ida/export.json (85545 funcs) global EA asc not yet in rbx_core — next 100 uncovered after 0x392c78 (watchdog_o max).
