...
// was: RBX::Reflection::Call1Helper<RBX::KeyframeSequenceProvider,RBX::ContentId (RBX::KeyframeSequenceProvider::*)(rbx_core::SharedPtr<RBX::Instance>),rbx_core::SharedPtr<RBX::Instance>,RBX::ContentId>::call(RBX::KeyframeSequenceProvider*,RBX::ContentId (RBX::KeyframeSequenceProvider::*)(rbx_core::SharedPtr<RBX::Instance>),RBX::Reflection::Variant &,rbx_core::SharedPtr<RBX::Instance> const&)
pub fn stub_5c001c() {
    // IDA 0x5c001c: script/reflection wiring owned by the script/datamodel crates — carrier no-op in core.
}
...
pub fn stub_5c049c() {
    // IDA 0x5c049c: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_5c05b4() {
    // IDA 0x5c05b4: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_5c06d0() {
    // IDA 0x5c06d0: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_5c0830() {
    // IDA 0x5c0830: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_5c0994() {
    // IDA 0x5c0994: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
// was: boost::detail::function::void_function_obj_invoker1<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list2<boost::_bi::value<rbx_core::WeakPtr<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>>,void,RBX::DataModel *>::invoke(boost::detail::function::function_buffer &,RBX::DataModel *)
pub fn stub_5c0b28() {
    // IDA 0x5c0b28: invoker::invoke unpacked the buffer and called the bound functor. Closure call at the live site — carrier no-op.
}
...
pub fn stub_5c0b44() {
    // IDA 0x5c0b44: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
// was: bool boost::detail::function::basic_vtable1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list2<boost::_bi::value<rbx_core::WeakPtr<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::WeakPtr<RBX::KeyframeSequence>,rbx_core::SharedPtr<RBX::KeyframeSequence>),boost::_bi::list2<boost::_bi::value<rbx_core::WeakPtr<RBX::KeyframeSequence>>,boost::_bi::value<rbx_core::SharedPtr<RBX::KeyframeSequence>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const
pub fn stub_5c0ca8() {
    // IDA 0x5c0ca8: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_5c0e08() {
    // IDA 0x5c0e08: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_5c0f1c() {
    // IDA 0x5c0f1c: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_5c11ec() {
    // IDA 0x5c11ec: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_5c1268() {
    // IDA 0x5c1268: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_5c12e8() {
    // IDA 0x5c12e8: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5c1318() {
    // IDA 0x5c1318: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5c2874() {
    // IDA 0x5c2874: boost::date_time. std::time-style duration — carrier no-op.
}
...
pub fn stub_5c2eec() {
    // IDA 0x5c2eec: enable_shared_from_this::shared_from. Arc::clone from self — carrier no-op.
}
...
pub fn stub_5c4cac() {
    // IDA 0x5c4cac: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_5c501c() {
    // IDA 0x5c501c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5c5354() {
    // IDA 0x5c5354: boost::date_time. std::time-style duration — carrier no-op.
}
...
pub fn stub_5c549c() {
    // IDA 0x5c549c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5c5d80() {
    // IDA 0x5c5d80: boost::date_time. std::time-style duration — carrier no-op.
}
...
pub fn stub_5c5de4() {
    // IDA 0x5c5de4: boost::date_time. std::time-style duration — carrier no-op.
}
...
pub fn stub_5c5e9c() {
    // IDA 0x5c5e9c: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c5ecc() {
    // IDA 0x5c5ecc: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c5efc() {
    // IDA 0x5c5efc: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c5f2c() {
    // IDA 0x5c5f2c: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c5fb8() {
    // IDA 0x5c5fb8: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c641c() {
    // IDA 0x5c641c: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c6460() {
    // IDA 0x5c6460: boost tokenizer/lexical_cast/iostream buf. str::parse/Iterator/String — carrier no-op.
}
...
pub fn stub_5c9708() {
    // IDA 0x5c9708: Creatable factory/Deleter (cf. CreatableInstanceDeleter in shared_ptr.rs). Arc::new — carrier no-op.
}
...
pub fn stub_5c9f04() {
    // IDA 0x5c9f04: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_5c9fcc() {
    // IDA 0x5c9fcc: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
pub fn stub_5ca0b4() {
    // IDA 0x5ca0b4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5ca1bc() {
    // IDA 0x5ca1bc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: boost::detail::sp_counted_impl_pd<RBX::Hint *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
pub fn stub_5ca1c0() {
    // IDA 0x5ca1c0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_5ca1c4() {
    // IDA 0x5ca1c4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5ca1e4() {
    // IDA 0x5ca1e4: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5ca1fc() {
    // IDA 0x5ca1fc: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5ca804() {
    // IDA 0x5ca804: Creatable factory create<Message> (cf. CreatableInstanceDeleter in shared_ptr.rs). Arc::new at the live site — carrier no-op.
}
...
pub fn stub_5ca8b4() {
    // IDA 0x5ca8b4: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_5ca97c() {
    // IDA 0x5ca97c: wired the weak owner from the shared_count (IDA 0x2e518). Arc construction adopts owners — carrier no-op.
}
...
pub fn stub_5caa64() {
    // IDA 0x5caa64: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5cab6c() {
    // IDA 0x5cab6c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: boost::detail::sp_counted_impl_pd<RBX::Message *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()
pub fn stub_5cab70() {
    // IDA 0x5cab70: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_5cab74() {
    // IDA 0x5cab74: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5cab94() {
    // IDA 0x5cab94: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5cabac() {
    // IDA 0x5cabac: control-block ctor/dispose (Arc internals; cf. shared_ptr.rs). Drop glue — no-op.
}
...
pub fn stub_5cc74c() {
    // IDA 0x5cc74c: RBXL/G3D model-geometry helper owned by the datamodel/rendering crates — carrier no-op in core.
}
...
pub fn stub_5cc7ec() {
    // IDA 0x5cc7ec: RBXL/G3D model-geometry helper owned by the datamodel/rendering crates — carrier no-op in core.
}
...
pub fn stub_5ccac0() {
    // IDA 0x5ccac0: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5cce3c() {
    // IDA 0x5cce3c: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5ccebc() {
    // IDA 0x5ccebc: RBXL joint factory (joint creation owned by the datamodel crate). Arc::new at the live site — carrier no-op.
}
...
pub fn stub_5ccf3c() {
    // IDA 0x5ccf3c: RBXL joint factory (joint creation owned by the datamodel crate). Arc::new at the live site — carrier no-op.
}
...
pub fn stub_5cd44c() {
    // IDA 0x5cd44c: RBXL/G3D model-geometry helper owned by the datamodel/rendering crates — carrier no-op in core.
}
...
pub fn stub_5cd668() {
    // IDA 0x5cd668: RBXL/G3D model-geometry helper owned by the datamodel/rendering crates — carrier no-op in core.
}
...
pub fn stub_5cdc0c() {
    // IDA 0x5cdc0c: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
// was: void RBX::Instance::visitDescendants<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,G3D::CoordinateFrame const*,G3D::Vector3 const*),boost::_bi::list3<boost::arg<1>,boost::_bi::value<G3D::CoordinateFrame*>,boost::_bi::value<G3D::Vector3*>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,G3D::CoordinateFrame const*,G3D::Vector3 const*),boost::_bi::list3<boost::arg<1>,boost::_bi::value<G3D::CoordinateFrame*>,boost::_bi::value<G3D::Vector3*>>> const&)const
pub fn stub_5cdd14() {
    // IDA 0x5cdd14: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
// was: void RBX::Instance::visitDescendants<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *),boost::_bi::list3<boost::arg<1>,boost::_bi::value<RBX::PartInstance **>,boost::_bi::value<float *>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *),boost::_bi::list3<boost::arg<1>,boost::_bi::value<RBX::PartInstance **>,boost::_bi::value<float *>>> const&)const
pub fn stub_5cde48() {
    // IDA 0x5cde48: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
// was: void RBX::Instance::visitDescendants<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &),boost::_bi::list2<boost::arg<1>,boost::reference_wrapper<RBX::Extents>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &),boost::_bi::list2<boost::arg<1>,boost::reference_wrapper<RBX::Extents>>> const&)const
pub fn stub_5cdf50() {
    // IDA 0x5cdf50: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
// was: void RBX::Instance::visitDescendants<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &,G3D::CoordinateFrame const&),boost::_bi::list3<boost::arg<1>,boost::reference_wrapper<RBX::Extents>,boost::reference_wrapper<G3D::CoordinateFrame const>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &,G3D::CoordinateFrame const&),boost::_bi::list3<boost::arg<1>,boost::reference_wrapper<RBX::Extents>,boost::reference_wrapper<G3D::CoordinateFrame const>>> const&)const
pub fn stub_5ce058() {
    // IDA 0x5ce058: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_5ce160() {
    // IDA 0x5ce160: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_5ce23c() {
    // IDA 0x5ce23c: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_5ce310() {
    // IDA 0x5ce310: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_5ce574() {
    // IDA 0x5ce574: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_5ce650() {
    // IDA 0x5ce650: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_5d3fe4() {
    // IDA 0x5d3fe4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5d4528() {
    // IDA 0x5d4528: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_5d7738() {
    // IDA 0x5d7738: Creatable factory/Deleter (cf. CreatableInstanceDeleter in shared_ptr.rs). Arc::new — carrier no-op.
}
...
pub fn stub_5d77ec() {
    // IDA 0x5d77ec: shared_ptr ctor/op= (addref new, release old; derived-to-base coercion). Arc move — carrier no-op.
}
...
pub fn stub_5dae40() {
    // IDA 0x5dae40: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5daf54() {
    // IDA 0x5daf54: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5db0c8() {
    // IDA 0x5db0c8: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5dbb84() {
    // IDA 0x5dbb84: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5de610() {
    // IDA 0x5de610: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_5de7fc() {
    // IDA 0x5de7fc: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5e01dc() {
    // IDA 0x5e01dc: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5e0ff8() {
    // IDA 0x5e0ff8: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5e15c0() {
    // IDA 0x5e15c0: vector<SharedPtr<PartInstance>>::push_back. Vec::push at the live site — monomorph artifact, no-op carrier.
}
...
pub fn stub_5e1610() {
    // IDA 0x5e1610: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5e1780() {
    // IDA 0x5e1780: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5e1f50() {
    // IDA 0x5e1f50: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_5e1fa0() {
    // IDA 0x5e1fa0: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_5e20e4() {
    // IDA 0x5e20e4: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_5e2888() {
    // IDA 0x5e2888: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_5e3fd0() {
    // IDA 0x5e3fd0: boost::exception/std-error machinery. thiserror/std::error — carrier no-op.
}
...
pub fn stub_681fd8() {
    // IDA 0x681fd8: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_682190() {
    // IDA 0x682190: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_6dea0c() {
    // IDA 0x6dea0c: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_773188() {
    // IDA 0x773188: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_773814() {
    // IDA 0x773814: script/reflection wiring owned by the script/datamodel crates — carrier no-op in core.
}
...
pub fn stub_777400() {
    // IDA 0x777400: function::operator() invoked the erased target. Closure call at the live site — carrier no-op.
}
...
pub fn stub_7774cc() {
    // IDA 0x7774cc: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_7775e4() {
    // IDA 0x7775e4: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_777708() {
    // IDA 0x777708: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_777a6c() {
    // IDA 0x777a6c: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_79d5a8() {
    // IDA 0x79d5a8: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7a3bbc() {
    // IDA 0x7a3bbc: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_7a8d40() {
    // IDA 0x7a8d40: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_7a8e5c() {
    // IDA 0x7a8e5c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: rbx::signals::signal<void ()(RBX::Network::ChatMessage const&)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::ChatOutput,RBX::Network::ChatMessage const&>,boost::_bi::list2<boost::_bi::value<RBX::ChatOutput*>,boost::arg<1>>>>::~callable_slot()
pub fn stub_7a8e88() {
    // IDA 0x7a8e88: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7a9078() {
    // IDA 0x7a9078: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_7a9080() {
    // IDA 0x7a9080: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7a9088() {
    // IDA 0x7a9088: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_7a9384() {
    // IDA 0x7a9384: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: rbx::callable<rbx::signals::signal<void ()(RBX::Network::ChatMessage const&)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::ChatOutput,RBX::Network::ChatMessage const&>,boost::_bi::list2<boost::_bi::value<RBX::ChatOutput*>,boost::arg<1>>>,1,void ()(RBX::Network::ChatMessage const&)>::~callable()
pub fn stub_7a93b0() {
    // IDA 0x7a93b0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7c64f4() {
    // IDA 0x7c64f4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: rbx::signals::signal<void ()(RBX::Humanoid::Status)>::callable_slot<boost::function<void ()(RBX::Humanoid::Status)>>::~callable_slot()
pub fn stub_7c6604() {
    // IDA 0x7c6604: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7c6850() {
    // IDA 0x7c6850: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_7c6858() {
    // IDA 0x7c6858: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7c6860() {
    // IDA 0x7c6860: function::operator() invoked the erased target. Closure call at the live site — carrier no-op.
}
...
pub fn stub_7c6b08() {
    // IDA 0x7c6b08: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: rbx::callable<rbx::signals::signal<void ()(RBX::Humanoid::Status)>::slot,boost::function<void ()(RBX::Humanoid::Status)>,1,void ()(RBX::Humanoid::Status)>::~callable()
pub fn stub_7c6c18() {
    // IDA 0x7c6c18: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7c6e48() {
    // IDA 0x7c6e48: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_7c93d0() {
    // IDA 0x7c93d0: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_7c94c4() {
    // IDA 0x7c94c4: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_7c9800() {
    // IDA 0x7c9800: rbx signals plumbing (cf. Signal in signal.rs). Registration/dispatch lives in Signal — carrier no-op.
}
...
pub fn stub_7c9810() {
    // IDA 0x7c9810: function::operator() invoked the erased target. Closure call at the live site — carrier no-op.
}
...
pub fn stub_7c9b18() {
    // IDA 0x7c9b18: function vtable assign_to/clear copied or dropped the erased target. Box<dyn Fn> move/drop — carrier no-op.
}
...
pub fn stub_7cf624() {
    // IDA 0x7cf624: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7cf76c() {
    // IDA 0x7cf76c: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7cf838() {
    // IDA 0x7cf838: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7cf8cc() {
    // IDA 0x7cf8cc: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7cf96c() {
    // IDA 0x7cf96c: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7d14d4() {
    // IDA 0x7d14d4: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_7d1800() {
    // IDA 0x7d1800: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: rbx::signals::signal<void ()(bool)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HUMAN::HumanoidState,bool>,boost::_bi::list2<boost::_bi::value<RBX::HUMAN::HumanoidState*>,boost::arg<1>>>>::~callable_slot()
pub fn stub_7d182c() {
    // IDA 0x7d182c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7d1900() {
    // IDA 0x7d1900: boost::bind free function built a bind_t functor. Closure captures — carrier no-op.
}
...
pub fn stub_7d1924() {
    // IDA 0x7d1924: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7d1948() {
    // IDA 0x7d1948: bind listN::operator() forwarded bound + call args into the target. Closure capture+call — carrier no-op.
}
...
pub fn stub_7d1968() {
    // IDA 0x7d1968: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: rbx::callable<rbx::signals::signal<void ()(bool)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HUMAN::HumanoidState,bool>,boost::_bi::list2<boost::_bi::value<RBX::HUMAN::HumanoidState*>,boost::arg<1>>>,1,void ()(bool)>::~callable()
pub fn stub_7d1994() {
    // IDA 0x7d1994: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7d8e48() {
    // IDA 0x7d8e48: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7d9cb8() {
    // IDA 0x7d9cb8: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_7ddd4c() {
    // IDA 0x7ddd4c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7ddf24() {
    // IDA 0x7ddf24: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
// was: boost::iostreams::detail::execute_traits<boost::iostreams::detail::copy_operation<boost::reference_wrapper<std::istream>,boost::reference_wrapper<boost::iostreams::filtering_stream<boost::iostreams::output,char,std::char_traits<char>,std::allocator<char>,boost::iostreams::public_>>>,boost::result_of<boost::iostreams::detail::copy_operation<boost::reference_wrapper<std::istream>,boost::reference_wrapper<boost::iostreams::filtering_stream<boost::iostreams::output,char,std::char_traits<char>,std::allocator<char>,boost::iostreams::public_>>> ()(void)>::type>::result_type boost::iostreams::detail::execute_all<boost::iostreams::detail::copy_operation<boost::reference_wrapper<std::istream>,boost::reference_wrapper<boost::iostreams::filtering_stream<boost::iostreams::output,char,std::char_traits<char>,std::allocator<char>,boost::iostreams::public_>>>,boost::iostreams::detail::device_close_all_operation<boost::reference_wrapper<std::istream>>>(boost::iostreams::detail::copy_operation<boost::reference_wrapper<std::istream>,boost::reference_wrapper<boost::iostreams::filtering_stream<boost::iostreams::output,char,std::char_traits<char>,std::allocator<char>,boost::iostreams::public_>>>,boost::iostreams::detail::device_close_all_operation<boost::reference_wrapper<std::istream>>)
pub fn stub_7de024() {
    // IDA 0x7de024: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7de0ec() {
    // IDA 0x7de0ec: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7de110() {
    // IDA 0x7de110: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7de7c8() {
    // IDA 0x7de7c8: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7de7f4() {
    // IDA 0x7de7f4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7de80c() {
    // IDA 0x7de80c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7de840() {
    // IDA 0x7de840: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7dec30() {
    // IDA 0x7dec30: boost::exception/std-error machinery. thiserror/std::error — carrier no-op.
}
