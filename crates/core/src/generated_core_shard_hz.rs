//! core shard HZ — 100 core stubs EA-sorted, continuation after HY 0x3575dc (EA-sorted ascending, next 100 uncovered).
//! Source: `ida/export.json` EA-sorted ascending, next 100 after 0x3575dc not yet in rbx_core.
