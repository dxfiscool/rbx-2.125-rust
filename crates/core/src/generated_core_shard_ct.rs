...
pub fn stub_716120() {
    // IDA 0x716120: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::VerbContainer::~VerbContainer()")]
// 0x7161c0 — __ZN3RBX13VerbContainerD1Ev
pub fn stub_7161c0() {
    // IDA 0x7161c0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::VerbContainer::~VerbContainer()")]
// 0x7161c4 — __ZN3RBX13VerbContainerD2Ev
pub fn stub_7161c4() {
    // IDA 0x7161c4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::VerbContainer::getVerb(std::string const&)")]
// 0x7162a4 — __ZN3RBX13VerbContainer7getVerbERKSs
pub fn stub_7162a4() {
    // IDA 0x7162a4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::VerbContainer::getVerb(RBX::Name const&)")]
// 0x7162bc — __ZN3RBX13VerbContainer7getVerbERKNS_4NameE
pub fn stub_7162bc() {
    // IDA 0x7162bc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_716310() {
    // IDA 0x716310: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_716368() {
    // IDA 0x716368: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_716390() {
    // IDA 0x716390: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7163dc() {
    // IDA 0x7163dc: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_71643c() {
    // IDA 0x71643c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_716464() {
    // IDA 0x716464: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_716518() {
    // IDA 0x716518: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
