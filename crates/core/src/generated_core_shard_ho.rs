...
pub fn stub_0xf67514() {
    // IDA 0xf67514: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf67524() {
    // IDA 0xf67524: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf67e84() {
    // IDA 0xf67e84: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf67e94() {
    // IDA 0xf67e94: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_0xf67ea4() {
    // IDA 0xf67ea4: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_0xf67eb4() {
    // IDA 0xf67eb4: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_0xf67ec4() {
    // IDA 0xf67ec4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf67ed4() {
    // IDA 0xf67ed4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf69184() {
    // IDA 0xf69184: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf691d4() {
    // IDA 0xf691d4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf69cb4() {
    // IDA 0xf69cb4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf69cc4() {
    // IDA 0xf69cc4: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_0xf69cd4() {
    // IDA 0xf69cd4: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_0xf69ce4() {
    // IDA 0xf69ce4: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_0xf69cf4() {
    // IDA 0xf69cf4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf69d04() {
    // IDA 0xf69d04: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf6a4f4() {
    // IDA 0xf6a4f4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf6a504() {
    // IDA 0xf6a504: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf6a514() {
    // IDA 0xf6a514: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf6a604() {
    // IDA 0xf6a604: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6a614() {
    // IDA 0xf6a614: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6a624() {
    // IDA 0xf6a624: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6a634() {
    // IDA 0xf6a634: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6a9d4() {
    // IDA 0xf6a9d4: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6a9e4() {
    // IDA 0xf6a9e4: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6a9f4() {
    // IDA 0xf6a9f4: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6aa04() {
    // IDA 0xf6aa04: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ac84() {
    // IDA 0xf6ac84: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ac94() {
    // IDA 0xf6ac94: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6aca4() {
    // IDA 0xf6aca4: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6acb4() {
    // IDA 0xf6acb4: unordered container node/table helper (IDA 0x2a9ac8 class). HashMap/HashSet — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6acc4() {
    // IDA 0xf6acc4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6acd4() {
    // IDA 0xf6acd4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ace4() {
    // IDA 0xf6ace4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6acf4() {
    // IDA 0xf6acf4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ad54() {
    // IDA 0xf6ad54: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ad64() {
    // IDA 0xf6ad64: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ad74() {
    // IDA 0xf6ad74: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6ad84() {
    // IDA 0xf6ad84: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b024() {
    // IDA 0xf6b024: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b034() {
    // IDA 0xf6b034: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b044() {
    // IDA 0xf6b044: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::find_last_not_of(char,unsigned long)const")]
// 0xf6b054 — __ZNKSs16find_last_not_ofEcm
pub fn stub_0xf6b054() {
    // IDA 0xf6b054: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b064() {
    // IDA 0xf6b064: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::find(char const*,unsigned long,unsigned long)const")]
// 0xf6b074 — __ZNKSs4findEPKcmm
pub fn stub_0xf6b074() {
    // IDA 0xf6b074: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::find(char,unsigned long)const")]
// 0xf6b084 — __ZNKSs4findEcm
pub fn stub_0xf6b084() {
    // IDA 0xf6b084: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::rfind(char const*,unsigned long,unsigned long)const")]
// 0xf6b094 — __ZNKSs5rfindEPKcmm
pub fn stub_0xf6b094() {
    // IDA 0xf6b094: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::rfind(char,unsigned long)const")]
// 0xf6b0a4 — __ZNKSs5rfindEcm
pub fn stub_0xf6b0a4() {
    // IDA 0xf6b0a4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::substr(unsigned long,unsigned long)const")]
// 0xf6b0b4 — __ZNKSs6substrEmm
pub fn stub_0xf6b0b4() {
    // IDA 0xf6b0b4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::compare(char const*)const")]
// 0xf6b0c4 — __ZNKSs7compareEPKc
pub fn stub_0xf6b0c4() {
    // IDA 0xf6b0c4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::compare(std::string const&)const")]
// 0xf6b0d4 — __ZNKSs7compareERKSs
pub fn stub_0xf6b0d4() {
    // IDA 0xf6b0d4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b0e4() {
    // IDA 0xf6b0e4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b0f4() {
    // IDA 0xf6b0f4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::__basic_file<char>::is_open(void)const")]
// 0xf6b104 — __ZNKSt12__basic_fileIcE7is_openEv
pub fn stub_0xf6b104() {
    // IDA 0xf6b104: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::runtime_error::what(void)const")]
// 0xf6b114 — __ZNKSt13runtime_error4whatEv
pub fn stub_0xf6b114() {
    // IDA 0xf6b114: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b124() {
    // IDA 0xf6b124: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::locale::id::_M_id(void)const")]
// 0xf6b134 — __ZNKSt6locale2id5_M_idEv
pub fn stub_0xf6b134() {
    // IDA 0xf6b134: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::locale::operator==(std::locale const&)const")]
// 0xf6b144 — __ZNKSt6localeeqERKS_
pub fn stub_0xf6b144() {
    // IDA 0xf6b144: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b154() {
    // IDA 0xf6b154: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b164() {
    // IDA 0xf6b164: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b174() {
    // IDA 0xf6b174: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b184() {
    // IDA 0xf6b184: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b194() {
    // IDA 0xf6b194: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "std::istream & std::istream::_M_extract<bool>(bool &)")]
// 0xf6b1a4 — __ZNSi10_M_extractIbEERSiRT_
pub fn stub_0xf6b1a4() {
    // IDA 0xf6b1a4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "std::istream & std::istream::_M_extract<float>(float &)")]
// 0xf6b1b4 — __ZNSi10_M_extractIfEERSiRT_
pub fn stub_0xf6b1b4() {
    // IDA 0xf6b1b4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf6b1c4() {
    // IDA 0xf6b1c4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "std::istream & std::istream::_M_extract<long>(long &)")]
// 0xf6b1d4 — __ZNSi10_M_extractIlEERSiRT_
pub fn stub_0xf6b1d4() {
    // IDA 0xf6b1d4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0xf6b1e4() {
    // IDA 0xf6b1e4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::get(char &)")]
// 0xf6b1f4 — __ZNSi3getERc
pub fn stub_0xf6b1f4() {
    // IDA 0xf6b1f4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::get(void)")]
// 0xf6b204 — __ZNSi3getEv
pub fn stub_0xf6b204() {
    // IDA 0xf6b204: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::peek(void)")]
// 0xf6b214 — __ZNSi4peekEv
pub fn stub_0xf6b214() {
    // IDA 0xf6b214: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::read(char *,int)")]
// 0xf6b224 — __ZNSi4readEPci
pub fn stub_0xf6b224() {
    // IDA 0xf6b224: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::seekg(std::fpos<__mbstate_t>)")]
// 0xf6b234 — __ZNSi5seekgESt4fposI11__mbstate_tE
pub fn stub_0xf6b234() {
    // IDA 0xf6b234: libstdc++ template instantiation (mangled-only context). Std container/algorithm — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::seekg(long long,std::_Ios_Seekdir)")]
// 0xf6b244 — __ZNSi5seekgExSt12_Ios_Seekdir
pub fn stub_0xf6b244() {
    // IDA 0xf6b244: libstdc++ template instantiation (mangled-only context). Std container/algorithm — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::tellg(void)")]
// 0xf6b254 — __ZNSi5tellgEv
pub fn stub_0xf6b254() {
    // IDA 0xf6b254: libstdc++ template instantiation (mangled-only context). Std container/algorithm — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::getline(char *,int,char)")]
// 0xf6b264 — __ZNSi7getlineEPcic
pub fn stub_0xf6b264() {
    // IDA 0xf6b264: libstdc++ template instantiation (mangled-only context). Std container/algorithm — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::istream::operator>>(int &)")]
// 0xf6b274 — __ZNSirsERi
pub fn stub_0xf6b274() {
    // IDA 0xf6b274: libstdc++ template instantiation (mangled-only context). Std container/algorithm — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::ostream::put(char)")]
// 0xf6b284 — __ZNSo3putEc
pub fn stub_0xf6b284() {
    // IDA 0xf6b284: iostream input/output helper. std::io Read/Write/BufRead -- carrier no-op.
}

#[doc(alias = "std::ostream::flush(void)")]
// 0xf6b294 — __ZNSo5flushEv
pub fn stub_0xf6b294() {
    // IDA 0xf6b294: iostream input/output helper. std::io Read/Write/BufRead -- carrier no-op.
}

#[doc(alias = "std::ostream::tellp(void)")]
// 0xf6b2a4 — __ZNSo5tellpEv
pub fn stub_0xf6b2a4() {
    // IDA 0xf6b2a4: iostream input/output helper. std::io Read/Write/BufRead -- carrier no-op.
}

#[doc(alias = "std::ostream::write(char const*,int)")]
// 0xf6b2b4 — __ZNSo5writeEPKci
pub fn stub_0xf6b2b4() {
    // IDA 0xf6b2b4: iostream input/output helper. std::io Read/Write/BufRead -- carrier no-op.
}
...
pub fn stub_0xf6b2c4() {
    // IDA 0xf6b2c4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::ostream & std::ostream::_M_insert<bool>(bool)")]
// 0xf6b2d4 — __ZNSo9_M_insertIbEERSoT_
pub fn stub_0xf6b2d4() {
    // IDA 0xf6b2d4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::ostream & std::ostream::_M_insert<double>(double)")]
// 0xf6b2e4 — __ZNSo9_M_insertIdEERSoT_
pub fn stub_0xf6b2e4() {
    // IDA 0xf6b2e4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::ostream & std::ostream::_M_insert<long>(long)")]
// 0xf6b2f4 — __ZNSo9_M_insertIlEERSoT_
pub fn stub_0xf6b2f4() {
    // IDA 0xf6b2f4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b304() {
    // IDA 0xf6b304: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::ostream & std::ostream::_M_insert<long long>(long long)")]
// 0xf6b314 — __ZNSo9_M_insertIxEERSoT_
pub fn stub_0xf6b314() {
    // IDA 0xf6b314: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b324() {
    // IDA 0xf6b324: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b334() {
    // IDA 0xf6b334: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::ostream::operator<<(int)")]
// 0xf6b344 — __ZNSolsEi
pub fn stub_0xf6b344() {
    // IDA 0xf6b344: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::_M_leak_hard(void)")]
// 0xf6b354 — __ZNSs12_M_leak_hardEv
pub fn stub_0xf6b354() {
    // IDA 0xf6b354: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b364() {
    // IDA 0xf6b364: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::at(unsigned long)")]
// 0xf6b374 — __ZNSs2atEm
pub fn stub_0xf6b374() {
    // IDA 0xf6b374: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::end(void)")]
// 0xf6b384 — __ZNSs3endEv
pub fn stub_0xf6b384() {
    // IDA 0xf6b384: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b394() {
    // IDA 0xf6b394: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_0xf6b3a4() {
    // IDA 0xf6b3a4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "std::string::swap(std::string &)")]
// 0xf6b3b4 — __ZNSs4swapERSs
pub fn stub_0xf6b3b4() {
    // IDA 0xf6b3b4: function swap/move_assign exchanges the erased target. Box<dyn Fn> swap — carrier no-op.
}

#[doc(alias = "std::string::erase(unsigned long,unsigned long)")]
// 0xf6b3c4 — __ZNSs5eraseEmm
pub fn stub_0xf6b3c4() {
    // IDA 0xf6b3c4: function swap/move_assign exchanges the erased target. Box<dyn Fn> swap — carrier no-op.
}

#[doc(alias = "std::string::append(char const*,unsigned long)")]
// 0xf6b3d4 — __ZNSs6appendEPKcm
pub fn stub_0xf6b3d4() {
    // IDA 0xf6b3d4: function swap/move_assign exchanges the erased target. Box<dyn Fn> swap — carrier no-op.
}

#[doc(alias = "std::string::append(std::string const&)")]
// 0xf6b3e4 — __ZNSs6appendERKSs
pub fn stub_0xf6b3e4() {
    // IDA 0xf6b3e4: function swap/move_assign exchanges the erased target. Box<dyn Fn> swap — carrier no-op.
}
