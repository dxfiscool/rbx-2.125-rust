//! core watchdog l — 100 core stubs EA-sorted, twelfth gap filler after watchdog_k 0x2d1304.
//! Source: `ida/export.json` (85545 funcs) global EA asc not yet in rbx_core — next 100 uncovered after 0x2d1304 (watchdog_k max).
