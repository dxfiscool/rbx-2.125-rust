...
pub fn stub_736564() {
    // IDA 0x736564: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7365cc() {
    // IDA 0x7365cc: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_736624() {
    // IDA 0x736624: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_73664c() {
    // IDA 0x73664c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_736698() {
    // IDA 0x736698: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_7366f8() {
    // IDA 0x7366f8: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

// 0x736720 — __ZNK3RBX10IPipelined9getKernelEv
#[doc(alias = "RBX::IPipelined::getKernel(void)const")]
pub fn stub_736720() {
    // IDA 0x736720: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_736788() {
    // IDA 0x736788: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

// 0x736808 — __ZN3RBX10IPipelined11putInKernelEPNS_6KernelE
#[doc(alias = "RBX::IPipelined::putInKernel(RBX::Kernel *)")]
pub fn stub_736808() {
    // IDA 0x736808: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

// 0x73680c — __ZN3RBX10IPipelined10putInStageEPNS_6IStageE
#[doc(alias = "RBX::IPipelined::putInStage(RBX::IStage *)")]
pub fn stub_73680c() {
    // IDA 0x73680c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

// 0x73693c — __ZN3RBX10IPipelined16removeFromKernelEv
#[doc(alias = "RBX::IPipelined::removeFromKernel(void)")]
pub fn stub_73693c() {
    // IDA 0x73693c: physics world/stage/poly geometry type. Collision-world internals owned by higher crates — carrier no-op in core.
}

// 0x7369e8 — __ZN3RBX10IPipelined15removeFromStageEPNS_6IStageE
#[doc(alias = "RBX::IPipelined::removeFromStage(RBX::IStage *)")]
pub fn stub_7369e8() {
    // IDA 0x7369e8: physics world/stage/poly geometry type. Collision-world internals owned by higher crates — carrier no-op in core.
}

// 0x736b10 — __ZN3RBX10IPipelined13putInPipelineEPNS_6IStageE
#[doc(alias = "RBX::IPipelined::putInPipeline(RBX::IStage *)")]
pub fn stub_736b10() {
    // IDA 0x736b10: physics world/stage/poly geometry type. Collision-world internals owned by higher crates — carrier no-op in core.
}

// 0x736bb0 — __ZN3RBX10IPipelined18removeFromPipelineEPNS_6IStageE
#[doc(alias = "RBX::IPipelined::removeFromPipeline(RBX::IStage *)")]
pub fn stub_736bb0() {
    // IDA 0x736bb0: physics world/stage/poly geometry type. Collision-world internals owned by higher crates — carrier no-op in core.
}

// 0x736ccc — __ZN3RBX11IWorldStage11onEdgeAddedEPNS_4EdgeE
#[doc(alias = "RBX::IWorldStage::onEdgeAdded(RBX::Edge *)")]
pub fn stub_736ccc() {
    // IDA 0x736ccc: physics world/stage/poly geometry type. Collision-world internals owned by higher crates — carrier no-op in core.
}

// 0x736d38 — __ZN3RBX11IWorldStage14onEdgeRemovingEPNS_4EdgeE
#[doc(alias = "RBX::IWorldStage::onEdgeRemoving(RBX::Edge *)")]
pub fn stub_736d38() {
    // IDA 0x736d38: physics world/stage/poly geometry type. Collision-world internals owned by higher crates — carrier no-op in core.
}

// 0x736da4 — __ZN3RBX11IWorldStageD1Ev
#[doc(alias = "RBX::IWorldStage::~IWorldStage()")]
pub fn stub_736da4() {
    // IDA 0x736da4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x736dc8 — __ZN3RBX11IWorldStageD0Ev
#[doc(alias = "RBX::IWorldStage::~IWorldStage()")]
pub fn stub_736dc8() {
    // IDA 0x736dc8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x7374b8 — __ZN3RBX5JointC2Ev
#[doc(alias = "RBX::Joint::Joint(void)")]
pub fn stub_7374b8() {
    // IDA 0x7374b8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x737730 — __ZN3RBX5JointD0Ev
#[doc(alias = "RBX::Joint::~Joint()")]
pub fn stub_737730() {
    // IDA 0x737730: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x7377d0 — __ZN3RBX5JointD1Ev
#[doc(alias = "RBX::Joint::~Joint()")]
pub fn stub_7377d0() {
    // IDA 0x7377d0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7377d4() {
    // IDA 0x7377d4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x7377dc — __ZN3RBX5JointD2Ev
#[doc(alias = "RBX::Joint::~Joint()")]
pub fn stub_7377dc() {
    // IDA 0x7377dc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// was: non-virtual thunk to RBX::Joint::~Joint()
pub fn stub_737924() {
    // IDA 0x737924: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x73792c — __ZN3RBX5Joint18getJointWorldCoordEi
#[doc(alias = "RBX::Joint::getJointWorldCoord(int)")]
pub fn stub_73792c() {
    // IDA 0x73792c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x7379c0 — __ZN3RBX5Joint11notifyMovedEv
#[doc(alias = "RBX::Joint::notifyMoved(void)")]
pub fn stub_7379c0() {
    // IDA 0x7379c0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7379ec() {
    // IDA 0x7379ec: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_737a24() {
    // IDA 0x737a24: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_737a80() {
    // IDA 0x737a80: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

// 0x737a84 — __ZN3RBX5Joint13setJointOwnerEPNS_11IJointOwnerE
#[doc(alias = "RBX::Joint::setJointOwner(RBX::IJointOwner *)")]
pub fn stub_737a84() {
    // IDA 0x737a84: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

// 0x737afc — __ZNK3RBX5Joint13getJointOwnerEv
#[doc(alias = "RBX::Joint::getJointOwner(void)const")]
pub fn stub_737afc() {
    // IDA 0x737afc: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

// 0x737b00 — __ZN3RBX5Joint12setPrimitiveEiPNS_9PrimitiveE
#[doc(alias = "RBX::Joint::setPrimitive(int,RBX::Primitive *)")]
pub fn stub_737b00() {
    // IDA 0x737b00: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_737c74() {
    // IDA 0x737c74: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_737f80() {
    // IDA 0x737f80: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_737fc8() {
    // IDA 0x737fc8: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_737fe8() {
    // IDA 0x737fe8: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

// 0x738008 — __ZN3RBX13getJointSize2EPKNS_5JointE
#[doc(alias = "RBX::getJointSize2(RBX::Joint const*)")]
pub fn stub_738008() {
    // IDA 0x738008: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_738028() {
    // IDA 0x738028: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
pub fn stub_73825c() {
    // IDA 0x73825c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x738268 — __ZN3RBX5Joint9otherNodeEPNS_12SpanningNodeE
#[doc(alias = "RBX::Joint::otherNode(RBX::SpanningNode *)")]
pub fn stub_738268() {
    // IDA 0x738268: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_738284() {
    // IDA 0x738284: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_7382a4() {
    // IDA 0x7382a4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_738d4c() {
    // IDA 0x738d4c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_73a0f0() {
    // IDA 0x73a0f0: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

// 0x73a0f4 — __ZN3RBX10JointStageC2EPNS_6IStageEPNS_5WorldE
#[doc(alias = "RBX::JointStage::JointStage(RBX::IStage *,RBX::World *)")]
pub fn stub_73a0f4() {
    // IDA 0x73a0f4: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
