//! core shard CD — 100 core stubs EA-sorted, next uncovered after CC 0x5fd740 (strict RBX|boost|std|rbx earliest gap 0x5fd7e4).
...
pub fn stub_5fe448() {
    // IDA 0x5fe448: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_5fe498() {
    // IDA 0x5fe498: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_600914() {
    // IDA 0x600914: erased holder via typed_holder singleton (IDA 0xc90c family). Box<dyn Any>-style store — carrier no-op.
}

#[doc(alias = "RBX::StarterGuiService::CoreGuiType & rbx::any_cast<RBX::StarterGuiService::CoreGuiType &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")]
// 0x600970 — __ZN3rbx8any_castIRN3RBX17StarterGuiService11CoreGuiTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE
pub fn stub_600970() {
    // IDA 0x600970: erased holder via typed_holder singleton (IDA 0xc90c family). Box<dyn Any>-style store — carrier no-op.
}
...
pub fn stub_600a64() {
    // IDA 0x600a64: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_604698() {
    // IDA 0x604698: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_605a90() {
    // IDA 0x605a90: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_60e4e8() {
    // IDA 0x60e4e8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_60ec58() {
    // IDA 0x60ec58: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}

#[doc(alias = "RBX::Scale9Frame::Scale9Frame(void)")]
// 0x60ec94 — __ZN3RBX11Scale9FrameC1Ev
pub fn stub_60ec94() {
    // IDA 0x60ec94: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_6104fc() {
    // IDA 0x6104fc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_61054c() {
    // IDA 0x61054c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::ScreenGui::canProcessMeAndDescendants(void)const")]
// 0x610588 — __ZNK3RBX9ScreenGui26canProcessMeAndDescendantsEv
pub fn stub_610588() {
    // IDA 0x610588: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_61058c() {
    // IDA 0x61058c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
