//! core watchdog s — 100 core stubs EA-sorted, twentieth gap filler after watchdog_r 0x3b5e98.
//! Source: ida/export.json (85545 funcs) global EA asc not yet in rbx_core — next 100 uncovered after 0x3b5e98 (watchdog_r max).
...
pub fn stub_3b611c() {
    // IDA 0x3b611c: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_3b6238() {
    // IDA 0x3b6238: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_3b9d24() {
    // IDA 0x3b9d24: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3b9d2c() {
    // IDA 0x3b9d2c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3b9d34() {
    // IDA 0x3b9d34: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3b9ed8() {
    // IDA 0x3b9ed8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3b9ee8() {
    // IDA 0x3b9ee8: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_3b9efc() {
    // IDA 0x3b9efc: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
pub fn stub_3ba158() {
    // IDA 0x3ba158: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3ba2d0() {
    // IDA 0x3ba2d0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3ba3cc() {
    // IDA 0x3ba3cc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3ba508() {
    // IDA 0x3ba508: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3ba638() {
    // IDA 0x3ba638: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3ba7b0() {
    // IDA 0x3ba7b0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3ba8b4() {
    // IDA 0x3ba8b4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3baa60() {
    // IDA 0x3baa60: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3baecc() {
    // IDA 0x3baecc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bb8e8() {
    // IDA 0x3bb8e8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bb964() {
    // IDA 0x3bb964: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bbe50() {
    // IDA 0x3bbe50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bbecc() {
    // IDA 0x3bbecc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x3bbf78 — __ZN3RBX17BasicPartInstanceC1Ev
#[doc(alias = "RBX::BasicPartInstance::BasicPartInstance(void)")]
pub fn stub_3bbf78() {
    // IDA 0x3bbf78: XML serialization helper. Serializer owned by higher crates — carrier no-op in core.
}

// 0x3bbff0 — __ZN3RBX17BasicPartInstanceC2Ev
#[doc(alias = "RBX::BasicPartInstance::BasicPartInstance(void)")]
pub fn stub_3bbff0() {
    // IDA 0x3bbff0: XML serialization helper. Serializer owned by higher crates — carrier no-op in core.
}
...
pub fn stub_3bc170() {
    // IDA 0x3bc170: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x3bc180 — __ZNK3RBX17BasicPartInstance11getPartTypeEv
#[doc(alias = "RBX::BasicPartInstance::getPartType(void)const")]
pub fn stub_3bc180() {
    // IDA 0x3bc180: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc1e0() {
    // IDA 0x3bc1e0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

// 0x3bc1ec — __ZNK3RBX17BasicPartInstance16partNeeds3dAdornEv
#[doc(alias = "RBX::BasicPartInstance::partNeeds3dAdorn(void)const")]
pub fn stub_3bc1ec() {
    // IDA 0x3bc1ec: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc220() {
    // IDA 0x3bc220: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc484() {
    // IDA 0x3bc484: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc48c() {
    // IDA 0x3bc48c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc6a8() {
    // IDA 0x3bc6a8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc6d8() {
    // IDA 0x3bc6d8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bc6dc() {
    // IDA 0x3bc6dc: simulation/instance gameplay wiring owned by the datamodel crate — carrier no-op in core.
}
...
pub fn stub_3bcba4() {
    // IDA 0x3bcba4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bcfbc() {
    // IDA 0x3bcfbc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bd46c() {
    // IDA 0x3bd46c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bd64c() {
    // IDA 0x3bd64c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_3bd65c() {
    // IDA 0x3bd65c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
