...
pub fn stub_0x2584a8() {
    // IDA 0x2584a8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258544() {
    // IDA 0x258544: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258a34() {
    // IDA 0x258a34: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258c78() {
    // IDA 0x258c78: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258c7c() {
    // IDA 0x258c7c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258d1c() {
    // IDA 0x258d1c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258d24() {
    // IDA 0x258d24: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258dc8() {
    // IDA 0x258dc8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x258dd0() {
    // IDA 0x258dd0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x2594ac — __ZN3RBX10Reflection9BoundPropIbLNS0_10MutabilityE1EEC2INS_11HttpServiceEEEPKcS7_MT_bNS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE — RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundProp<RBX::HttpService>(char const*,char const*,bool RBX::HttpService::*,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
pub fn stub_0x2594ac() {
    // IDA 0x2594ac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x25963c — __ZNK3RBX10Reflection9BoundPropIbLNS0_10MutabilityE1EE15BoundPropGetSetINS_11HttpServiceEE10isReadOnlyEv — RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::isReadOnly(void)const
pub fn stub_0x25963c() {
    // IDA 0x25963c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x259640 — __ZNK3RBX10Reflection9BoundPropIbLNS0_10MutabilityE1EE15BoundPropGetSetINS_11HttpServiceEE11isWriteOnlyEv — RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::isWriteOnly(void)const
pub fn stub_0x259640() {
    // IDA 0x259640: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x259644 — __ZNK3RBX10Reflection9BoundPropIbLNS0_10MutabilityE1EE15BoundPropGetSetINS_11HttpServiceEE8getValueEPKNS0_13DescribedBaseE — RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::getValue(RBX::Reflection::DescribedBase const*)const
pub fn stub_0x259644() {
    // IDA 0x259644: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x259650 — __ZNK3RBX10Reflection9BoundPropIbLNS0_10MutabilityE1EE15BoundPropGetSetINS_11HttpServiceEE8setValueEPNS0_13DescribedBaseERKb — RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::setValue(RBX::Reflection::DescribedBase *,bool const&)const
pub fn stub_0x259650() {
    // IDA 0x259650: script/reflection wiring owned by the script/datamodel crates — carrier no-op in core.
}
...
// 0x25a5a8 — __ZN3RBX10Reflection18BoundYieldFuncDescINS_11HttpServiceEFSsSsSsNS2_15HttpContentTypeEESsLi3EED0Ev — RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string,std::string,RBX::HttpService::HttpContentType),std::string,3>::~BoundYieldFuncDesc()
...
// 0x25acb8 — __ZN3RBX10Reflection18BoundYieldFuncDescINS_11HttpServiceEFSsSsESsLi1EE16declareSignatureEPKcNS0_7VariantE — RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string),std::string,1>::declareSignature(char const*,RBX::Reflection::Variant)
pub fn stub_0x25acb8() {
    // IDA 0x25acb8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string),std::string,1>::~BoundYieldFuncDesc()")]
// 0x25ace8 — __ZN3RBX10Reflection18BoundYieldFuncDescINS_11HttpServiceEFSsSsESsLi1EED0Ev — RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string),std::string,1>::~BoundYieldFuncDesc()
...
// 0x25bc38 — __ZNK3RBX5Light12askSetParentEPKNS_8InstanceE — RBX::Light::askSetParent(RBX::Instance const*)const
pub fn stub_0x25bc38() {
    // IDA 0x25bc38: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Light::askAddChild(RBX::Instance const*)const")]
// 0x25bc60 — __ZNK3RBX5Light11askAddChildEPKNS_8InstanceE — RBX::Light::askAddChild(RBX::Instance const*)const
pub fn stub_0x25bc60() {
    // IDA 0x25bc60: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Light,bool>::~PropDescriptor()")]
// 0x25c0cc — __ZN3RBX10Reflection14PropDescriptorINS_5LightEbED1Ev — RBX::Reflection::PropDescriptor<RBX::Light,bool>::~PropDescriptor()
...
// 0x25c100 — __ZN3RBX10Reflection14PropDescriptorINS_5LightEN3G3D6Color3EED1Ev — RBX::Reflection::PropDescriptor<RBX::Light,G3D::Color3>::~PropDescriptor()
...
// 0x25c128 — __ZN3RBX10Reflection14PropDescriptorINS_5LightEfED1Ev — RBX::Reflection::PropDescriptor<RBX::Light,float>::~PropDescriptor()
...
// 0x25c150 — __ZN3RBX10Reflection14PropDescriptorINS_10PointLightEfED1Ev — RBX::Reflection::PropDescriptor<RBX::PointLight,float>::~PropDescriptor()
...
// 0x25c178 — __ZN3RBX10Reflection14PropDescriptorINS_9SpotLightEfED1Ev — RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::~PropDescriptor()
...
// 0x25c1ac — __ZN3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEED1Ev — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::~EnumPropDescriptor()
...
pub fn stub_0x25c1d0() {
    // IDA 0x25c1d0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c1f8() {
    // IDA 0x25c1f8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c220() {
    // IDA 0x25c220: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c230() {
    // IDA 0x25c230: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c240() {
    // IDA 0x25c240: C++ this-adjusting/virtual thunk (mangled-only context). Drop glue — no-op.
}
...
pub fn stub_0x25c250() {
    // IDA 0x25c250: C++ this-adjusting/virtual thunk (mangled-only context). Drop glue — no-op.
}
...
pub fn stub_0x25c260() {
    // IDA 0x25c260: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c264() {
    // IDA 0x25c264: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c268() {
    // IDA 0x25c268: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c304() {
    // IDA 0x25c304: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c38c() {
    // IDA 0x25c38c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25c960() {
    // IDA 0x25c960: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25cba4() {
    // IDA 0x25cba4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25cc18() {
    // IDA 0x25cc18: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25ccb4() {
    // IDA 0x25ccb4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25cd3c() {
    // IDA 0x25cd3c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25d310() {
    // IDA 0x25d310: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25d554() {
    // IDA 0x25d554: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25daa4() {
    // IDA 0x25daa4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25daac() {
    // IDA 0x25daac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25db50() {
    // IDA 0x25db50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25db58() {
    // IDA 0x25db58: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dbfc() {
    // IDA 0x25dbfc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dc00() {
    // IDA 0x25dc00: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dca0() {
    // IDA 0x25dca0: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dca8() {
    // IDA 0x25dca8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dd4c() {
    // IDA 0x25dd4c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dd54() {
    // IDA 0x25dd54: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25ddf8() {
    // IDA 0x25ddf8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25ddfc() {
    // IDA 0x25ddfc: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25de9c() {
    // IDA 0x25de9c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dea4() {
    // IDA 0x25dea4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25df48() {
    // IDA 0x25df48: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25df50() {
    // IDA 0x25df50: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
pub fn stub_0x25dff4() {
    // IDA 0x25dff4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::~EnumPropDescriptor()")]
// 0x25e1a8 — __ZN3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEED0Ev — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::~EnumPropDescriptor()
pub fn stub_0x25e1a8() {
    // IDA 0x25e1a8: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::isReadOnly(void)const")]
// 0x25e1d4 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE10isReadOnlyEv — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::isReadOnly(void)const
pub fn stub_0x25e1d4() {
    // IDA 0x25e1d4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}

#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::isWriteOnly(void)const")]
// 0x25e1e4 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE11isWriteOnlyEv — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::isWriteOnly(void)const
pub fn stub_0x25e1e4() {
    // IDA 0x25e1e4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x25e1f4 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE11equalValuesEPKNS0_13DescribedBaseES7_ — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const
pub fn stub_0x25e1f4() {
    // IDA 0x25e1f4: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x25e21c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE10getVariantEPKNS0_13DescribedBaseERNS0_7VariantE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const
pub fn stub_0x25e21c() {
    // IDA 0x25e21c: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x25e240 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE10setVariantEPNS0_13DescribedBaseERKNS0_7VariantE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const
pub fn stub_0x25e240() {
    // IDA 0x25e240: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e38c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE9copyValueEPKNS0_13DescribedBaseEPS5_ — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const
pub fn stub_0x25e38c() {
    // IDA 0x25e38c: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::hasStringValue(void)const")]
// 0x25e3b0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE14hasStringValueEv — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::hasStringValue(void)const
pub fn stub_0x25e3b0() {
    // IDA 0x25e3b0: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e3b4 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE14getStringValueEPKNS0_13DescribedBaseE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getStringValue(RBX::Reflection::DescribedBase const*)const
pub fn stub_0x25e3b4() {
    // IDA 0x25e3b4: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e3d8 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE14setStringValueEPNS0_13DescribedBaseERKSs — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const
pub fn stub_0x25e3d8() {
    // IDA 0x25e3d8: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
// 0x25e418 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE10writeValueEPKNS0_13DescribedBaseEP10XmlElement — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const
pub fn stub_0x25e418() {
    // IDA 0x25e418: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
// 0x25e438 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE9readValueEPNS0_13DescribedBaseEPK10XmlElementRNS_16IReferenceBinderE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const
pub fn stub_0x25e438() {
    // IDA 0x25e438: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
// 0x25e678 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE13getIndexValueEPKNS0_13DescribedBaseE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getIndexValue(RBX::Reflection::DescribedBase const*)const
pub fn stub_0x25e678() {
    // IDA 0x25e678: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
// 0x25e694 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE13setIndexValueEPNS0_13DescribedBaseEm — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const
pub fn stub_0x25e694() {
    // IDA 0x25e694: libstdc++ container/algorithm internals. Vec/BTreeMap/VecDeque/Iterator — monomorph artifact, no-op carrier.
}
...
// 0x25e6c8 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE12getEnumValueEPKNS0_13DescribedBaseE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getEnumValue(RBX::Reflection::DescribedBase const*)const
pub fn stub_0x25e6c8() {
    // IDA 0x25e6c8: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e6d0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE12setEnumValueEPNS0_13DescribedBaseEi — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setEnumValue(RBX::Reflection::DescribedBase *,int)const
pub fn stub_0x25e6d0() {
    // IDA 0x25e6d0: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e71c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE11getEnumItemEPKNS0_13DescribedBaseE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getEnumItem(RBX::Reflection::DescribedBase const*)const
pub fn stub_0x25e71c() {
    // IDA 0x25e71c: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e73c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE14setStringValueEPNS0_13DescribedBaseERKNS_4NameE — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const
pub fn stub_0x25e73c() {
    // IDA 0x25e73c: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::Reflection::EnumDesc<RBX::NormalId>::convertToIndex(RBX::NormalId)const")]
// 0x25e770 — __ZNK3RBX10Reflection8EnumDescINS_8NormalIdEE14convertToIndexES2_ — RBX::Reflection::EnumDesc<RBX::NormalId>::convertToIndex(RBX::NormalId)const
pub fn stub_0x25e770() {
    // IDA 0x25e770: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e7e0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_9SpotLightENS_8NormalIdEE11setIntValueEPNS0_13DescribedBaseEi — RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setIntValue(RBX::Reflection::DescribedBase *,int)const
pub fn stub_0x25e7e0() {
    // IDA 0x25e7e0: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e820 — __ZNK3RBX10Reflection14PropDescriptorINS_9SpotLightENS_8NormalIdEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE10isReadOnlyEv — RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::isReadOnly(void)const
pub fn stub_0x25e820() {
    // IDA 0x25e820: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e824 — __ZNK3RBX10Reflection14PropDescriptorINS_9SpotLightENS_8NormalIdEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE11isWriteOnlyEv — RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::isWriteOnly(void)const
pub fn stub_0x25e824() {
    // IDA 0x25e824: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e828 — __ZNK3RBX10Reflection14PropDescriptorINS_9SpotLightENS_8NormalIdEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE8getValueEPKNS0_13DescribedBaseE — RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::getValue(RBX::Reflection::DescribedBase const*)const
pub fn stub_0x25e828() {
    // IDA 0x25e828: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e848 — __ZNK3RBX10Reflection14PropDescriptorINS_9SpotLightENS_8NormalIdEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE8setValueEPNS0_13DescribedBaseERKS3_ — RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::setValue(RBX::Reflection::DescribedBase *,RBX::NormalId const&)const
pub fn stub_0x25e848() {
    // IDA 0x25e848: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}
...
// 0x25e86c — __ZN3RBX10Reflection14PropDescriptorINS_9SpotLightEfEC2IMS2_KFfvEMS2_FvfEEEPKcSA_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE — RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::PropDescriptor<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>(char const*,char const*,float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
pub fn stub_0x25e86c() {
    // IDA 0x25e86c: physics-engine collision/contact helper (Body/Primitive/Contact graph). Owned by higher crates — carrier no-op in core.
}

#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::~PropDescriptor()")]
// 0x25e980 — __ZN3RBX10Reflection14PropDescriptorINS_9SpotLightEfED0Ev — RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::~PropDescriptor()
pub fn stub_0x25e980() {
    // IDA 0x25e980: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
...
// 0x25e9ac — __ZNK3RBX10Reflection14PropDescriptorINS_9SpotLightEfE10GetSetImplIMS2_KFfvEMS2_FvfEE10isReadOnlyEv — RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::GetSetImpl<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>::isReadOnly(void)const
pub fn stub_0x25e9ac() {
    // IDA 0x25e9ac: C++ dtor/thunk (deleting dtors adjust this, run member dtors, release). Drop glue — no-op.
}
