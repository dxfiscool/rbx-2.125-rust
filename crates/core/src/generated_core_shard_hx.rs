//! core shard HX — 100 core stubs EA-sorted, continuation after HW 0x1825b0 (EA-sorted ascending, next 100 uncovered).
//! Source: `ida/export.json` EA-sorted ascending, next 100 after 0x1825b0 not yet in rbx_core.
...
pub fn stub_23e1e0() -> ! {
    todo!("0x23e1e0 __Z23RbxTotalUsableCoreCountj")
}

#[doc(alias = "__Z20GetDXVideoMemorySizev")]
// 0x23e568 — __Z20GetDXVideoMemorySizev
pub fn stub_23e568() -> ! {
    todo!("0x23e568 __Z20GetDXVideoMemorySizev")
}
...
pub fn stub_23f294() -> ! {
    todo!("0x23f294 __Z8RBXCRASHv")
}

#[doc(alias = "__Z8RBXCRASHPKc")]
// 0x23f2a0 — __Z8RBXCRASHPKc
pub fn stub_23f2a0() -> ! {
    todo!("0x23f2a0 __Z8RBXCRASHPKc")
}
