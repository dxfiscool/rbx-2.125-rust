//! core shard jr — 150 core stubs EA-sorted, 0x2197e4..0x22cff0 (EA-sorted asc next 150 core utility gaps not yet in rbx_core after jq 0x2197cc, rbx_core::SharedPtr not boost).
//! Source: `ida/export.json` (85545 funcs) filtered where demangled/mangled excludes Reflection|Instance|DataModel|Workspace|Ogre|G3D|RakNet|Network|Replicator|Lua|Script|FMOD|Audio, EA-sorted ascending, next 150 not yet in rbx_core (core utility gap filler, rbx_core::SharedPtr not boost).
