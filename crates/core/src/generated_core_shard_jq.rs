//! core shard jq — 100 core stubs EA-sorted, 0x20f380..0x2197cc (EA-sorted asc next 100 core utility gaps not yet in rbx_core after jp 0x20f1d8, rbx_core::SharedPtr not boost).
...
pub fn stub_20f380() {
    // IDA 0x20f380: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_tt_cmap2_get_subheader")]
// 0x20f3a0 — _tt_cmap2_get_subheader
pub fn stub_20f3a0() {
    // IDA 0x20f3a0: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_tt_cmap2_char_index")]
// 0x20f41c — _tt_cmap2_char_index
pub fn stub_20f41c() {
    // IDA 0x20f41c: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_tt_cmap2_char_next")]
// 0x20f4c0 — _tt_cmap2_char_next
pub fn stub_20f4c0() {
    // IDA 0x20f4c0: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_tt_cmap2_get_info")]
// 0x20f6dc — _tt_cmap2_get_info
pub fn stub_20f6dc() {
    // IDA 0x20f6dc: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_tt_cmap4_init")]
// 0x20f700 — _tt_cmap4_init
pub fn stub_20f700() {
    // IDA 0x20f700: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_20f730() {
    // IDA 0x20f730: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_20f9e8() {
    // IDA 0x20f9e8: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}

#[doc(alias = "_tt_cmap4_char_map_linear")]
// 0x20fd7c — _tt_cmap4_char_map_linear
pub fn stub_20fd7c() {
    // IDA 0x20fd7c: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_20ff84() {
    // IDA 0x20ff84: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_tt_cmap4_char_index")]
// 0x21074c — _tt_cmap4_char_index
pub fn stub_21074c() {
    // IDA 0x21074c: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_tt_cmap4_char_next")]
// 0x210798 — _tt_cmap4_char_next
pub fn stub_210798() {
    // IDA 0x210798: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_tt_cmap4_get_info")]
// 0x210804 — _tt_cmap4_get_info
pub fn stub_210804() {
    // IDA 0x210804: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}

#[doc(alias = "_tt_cmap6_char_index")]
// 0x210828 — _tt_cmap6_char_index
pub fn stub_210828() {
    // IDA 0x210828: bind_t/storage/list/value ctor captured bound args (cf. IDA functor_manager family). Closure captures — carrier no-op.
}
...
pub fn stub_211498() {
    // IDA 0x211498: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_211918() {
    // IDA 0x211918: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
...
pub fn stub_211e08() {
    // IDA 0x211e08: FreeType font-raster helper owned by the rendering crate — carrier no-op in core.
}
