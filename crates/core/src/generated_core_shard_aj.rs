//! core shard AJ — 120 core stubs high-EA descending (highest uncovered first after global deduplication).
//! Source: `ida/export.json` filtered where demangled/mangled excludes Reflection|Instance|DataModel|Workspace|Ogre|G3D|RakNet|Network|Replicator|Lua|Script|Yield|FMOD|Audio|Sound, EA-sorted descending, next 120 uncovered from high EA.
