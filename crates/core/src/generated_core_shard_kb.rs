//! core shard kb — 150 stubs EA-sorted asc global gap filler not yet in core (core/boost-independent, fallback filter).
//! Source: `ida/export.json` (85545 funcs) global EA-sorted ascending, next 150 core not yet in rbx_core (fallback excludes Reflection|Instance|DataModel|Workspace|Ogre|G3D|RakNet|Network|Replicator|Lua|Script|Yield|FMOD|Audio|Sound, boost-independent).
...
pub fn stub_0x111e78() -> ! {
    todo!("0x111e78 __ZL11Descriptionv")
}
