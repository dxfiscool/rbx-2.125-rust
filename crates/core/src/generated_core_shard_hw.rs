//! core shard HW — 100 core stubs EA-sorted, continuation after HV 0x174910 (EA-sorted ascending, next 100 uncovered).
//! Source: `ida/export.json` EA-sorted ascending, next 100 after 0x174910 not yet in rbx_core.
