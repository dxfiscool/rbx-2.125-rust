// Auto-generated shard Y — next 100 RBX::Reflection stubs — EA-sorted from 0x786e7c
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 9560->9660 total, showing next 100)
...
// was: boost::function2<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>,lua_State *,lua_Debug *>::clear(void)
...
pub fn stub_786e7c() -> ! {
    todo!("0x786e7c boost::function2<rbx_core::SharedPtr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>,lua_State *,lua_Debug *>::clear(void)")
}
...
pub fn stub_78a3a4() -> ! {
    todo!("0x78a3a4 MemoryBinder::announceID(XmlNameValuePair const*,RBX::Reflection::DescribedBase *)")
}
...
pub fn stub_78a3ac() -> ! {
    todo!("0x78a3ac MemoryBinder::announceIDREF(XmlNameValuePair const*,RBX::Reflection::DescribedBase *,RBX::IIDREF const*)")
}
...
pub fn stub_78a568() -> ! {
    todo!("0x78a568 MemoryBinder::processID(XmlNameValuePair const*,RBX::Reflection::DescribedBase *)")
}
...
pub fn stub_78a6e0() -> ! {
    todo!("0x78a6e0 MemoryBinder::processIDREF(XmlNameValuePair const*,RBX::Reflection::DescribedBase *,RBX::IIDREF const*)")
}
...
pub fn stub_78b5d8() -> ! {
    todo!("0x78b5d8 ArchiveBinder::processID(XmlNameValuePair const*,RBX::Reflection::DescribedBase *)")
}
...
pub fn stub_78b7b4() -> ! {
    todo!("0x78b7b4 ArchiveBinder::processIDREF(XmlNameValuePair const*,RBX::Reflection::DescribedBase *,RBX::IIDREF const*)")
}
...
pub fn stub_78c444() -> ! {
    todo!("0x78c444 RBX::WebParser::loadList(XmlElement const*,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> &)")
}
...
pub fn stub_78c588() -> ! {
    todo!("0x78c588 RBX::WebParser::parseWebGenericResponse(std::istream &,RBX::Reflection::Variant &)")
}
...
pub fn stub_78c73c() -> ! {
    todo!("0x78c73c RBX::WebParser::parseWebGenericResponse(XmlElement const*,RBX::Reflection::Variant &)")
}
...
pub fn stub_78c970() -> ! {
    todo!("0x78c970 RBX::WebParser::loadTable(XmlElement const*,std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> &)")
}
...
pub fn stub_78cb60() -> ! {
    todo!("0x78cb60 RBX::WebParser::loadValue(XmlElement const*,RBX::Reflection::Variant &)")
}
...
pub fn stub_78d360() -> ! {
    todo!("0x78d360 RBX::WebParser::loadEntry(XmlElement const*,std::string &,RBX::Reflection::Variant &)")
}
...
// was: RBX::WebParser::populateValueTableFromPtree(boost::property_tree::basic_ptree<std::string,std::string,std::less<std::string>> const&,boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>> &)
#[doc(alias = "RBX::WebParser::populateValueTableFromPtree(boost::property_tree::basic_ptree<std::string,std::string,std::less<std::string>> const&,rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>> &)")]
...
pub fn stub_78d3cc() -> ! {
    todo!("0x78d3cc RBX::WebParser::populateValueTableFromPtree(boost::property_tree::basic_ptree<std::string,std::string,std::less<std::string>> const&,rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>> &)")
}
...
// was: RBX::WebParser::parseWebJSONResponse(std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>> &,boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>> &)
#[doc(alias = "RBX::WebParser::parseWebJSONResponse(std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>> &,rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>> &)")]
...
pub fn stub_78d980() -> ! {
    todo!("0x78d980 RBX::WebParser::parseWebJSONResponse(std::basic_stringstream<char,std::char_traits<char>,std::allocator<char>> &,rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>> &)")
}
...
pub fn stub_7984a0() -> ! {
    todo!("0x7984a0 rbx_core::SharedPtr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>::operator=(rbx_core::SharedPtr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> const&)")
}
...
pub fn stub_7984d8() -> ! {
    todo!("0x7984d8 rbx_core::SharedPtr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>>>(std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> *)")
}
...
pub fn stub_7bd57c() -> crate::enum_desc::EnumDesc {
...
pub fn stub_7bd580() -> crate::enum_desc::EnumDesc {
...
pub fn stub_7bd75c() -> crate::enum_desc::EnumDesc {
...
pub fn stub_7bd760() -> crate::enum_desc::EnumDesc {
...
// was: RBX::Reflection::BoundFuncDesc<RBX::Humanoid,boost::shared_ptr<RBX::Instance> ()(boost::shared_ptr<RBX::Instance>),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// was: RBX::Reflection::EventDescImpl<1,RBX::Humanoid,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>,rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)> RBX::Humanoid::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
...
// was: RBX::Reflection::RemoteEventDesc<RBX::Humanoid,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>>::isBroadcast(void)const
...
// was: RBX::Reflection::RemoteEventDesc<RBX::Humanoid,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>>::sendEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const
...
// was: RBX::Reflection::EventDescBase<RBX::Humanoid,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>,rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)> RBX::Humanoid::*>::disconnectAll(RBX::Reflection::EventSource *)const
