//! Auto-generated refl 14 — 100 stubs EA-sorted asc 0x95ba30..0x9a265c (RBX::Reflection namespace, EA asc not yet in crates/*/src)
...
// type: unsigned int __fastcall(_DWORD *, int, RakNet::BitStream *)
...
// type: void __fastcall(_DWORD *, int, RakNet::BitStream *this)
...
// type: unsigned int __fastcall(_DWORD *, RakNet::BitStream *)
...
// type: void __fastcall(int, RakNet::BitStream *this)
...
pub fn stub_0x96481c() -> ! {
    todo!("0x96481c std::_Rb_tree<RBX::Reflection::Type const*,std::pair<RBX::Reflection::Type const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflection::Type const* const,unsig...")
}
...
pub fn stub_0x9649d0() -> ! {
    todo!("0x9649d0 std::_Rb_tree<RBX::Reflection::Type const*,std::pair<RBX::Reflection::Type const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflection::Type const* const,unsig...")
}
...
pub fn stub_0x964ac0() -> ! {
    todo!("0x964ac0 std::_Rb_tree<RBX::Reflection::EventDescriptor const*,std::pair<RBX::Reflection::EventDescriptor const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflection::E...")
}
...
pub fn stub_0x964c74() -> ! {
    todo!("0x964c74 std::_Rb_tree<RBX::Reflection::EventDescriptor const*,std::pair<RBX::Reflection::EventDescriptor const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflection::E...")
}
...
pub fn stub_0x964d64() -> ! {
    todo!("0x964d64 std::_Rb_tree<RBX::Reflection::PropertyDescriptor const*,std::pair<RBX::Reflection::PropertyDescriptor const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflect...")
}
...
pub fn stub_0x964f18() -> ! {
    todo!("0x964f18 std::_Rb_tree<RBX::Reflection::PropertyDescriptor const*,std::pair<RBX::Reflection::PropertyDescriptor const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflect...")
}
...
pub fn stub_0x965008() -> ! {
    todo!("0x965008 std::_Rb_tree<RBX::Reflection::ClassDescriptor const*,std::pair<RBX::Reflection::ClassDescriptor const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflection::C...")
}
...
pub fn stub_0x9651bc() -> ! {
    todo!("0x9651bc std::_Rb_tree<RBX::Reflection::ClassDescriptor const*,std::pair<RBX::Reflection::ClassDescriptor const* const,unsigned int>,std::_Select1st<std::pair<RBX::Reflection::C...")
}
...
pub fn stub_0x965efc() -> ! {
    todo!("0x965efc boost::unordered::unordered_map<char const*,RBX::Reflection::EventDescriptor *,RBX::Reflection::StringHashPredicate,RBX::Reflection::StringEqualPredicate,std::allocator...")
}
...
pub fn stub_0x970f5c() -> ! {
    todo!("0x970f5c RBX::Reflection::EventDesc<RBX::Network::Client,void ()(std::string,int,std::string),rbx::signal<void ()(std::string,int,std::string)>,rbx::signal<void ()(std::string,i...")
}
...
pub fn stub_0x971418() -> ! {
    todo!("0x971418 RBX::Reflection::EventDescImpl<3,RBX::Network::Client,void ()(std::string,int,std::string),rbx::signal<void ()(std::string,int,std::string)>,rbx::signal<void ()(std::st...")
}
...
pub fn stub_0x97189c() -> ! {
    todo!("0x97189c RBX::Reflection::EventDescImpl<3,RBX::Network::Client,void ()(std::string,int,std::string),rbx::signal<void ()(std::string,int,std::string)>,rbx::signal<void ()(std::st...")
}
...
pub fn stub_0x971bec() -> ! {
    todo!("0x971bec RBX::Reflection::EventDescBase<RBX::Network::Client,void ()(std::string,int,std::string),rbx::signal<void ()(std::string,int,std::string)>,rbx::signal<void ()(std::stri...")
}
...
pub fn stub_0x971db4() -> ! {
    todo!("0x971db4 RBX::Reflection::EventDescBase<RBX::Network::Client,void ()(std::string,int,std::string),rbx::signal<void ()(std::string,int,std::string)>,rbx::signal<void ()(std::stri...")
}
...
pub fn stub_0x971f88() -> ! {
    todo!("0x971f88 boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,std::string const&,int const&,std::string const&>,boost::_bi::list_av_4<boost::shared_...")
}

// 0x9723f4 — __ZN3RBX10Reflection18GenericSlotWrapper8execute3ISsiSsEEvRKT_RKT0_RKT1_
// type: int __fastcall(int, const std::string *, _DWORD *, const std::string *)
...
pub fn stub_0x972c28() -> ! {
    todo!("0x972c28 void boost::function3<void,std::string,int,std::string>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,std::string const&,...")
}
...
pub fn stub_0x9730a0() -> ! {
    todo!("0x9730a0 boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,std::string const&,int const&,std::string con...")
}
...
pub fn stub_0x9730c4() -> ! {
    todo!("0x9730c4 boost::detail::function::void_function_obj_invoker3<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,std::string const&,int const&,std:...")
}
...
pub fn stub_0x9730f0() -> ! {
    todo!("0x9730f0 bool boost::detail::function::basic_vtable3<void,std::string,int,std::string>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapp...")
}
...
pub fn stub_0x9733d8() -> ! {
    todo!("0x9733d8 boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,std::string const&,int const&,std::string con...")
}
...
pub fn stub_0x9744e0() -> ! {
    todo!("0x9744e0 RBX::Reflection::EventDesc<RBX::Network::Client,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Network::Client::*>::Event...")
}
...
pub fn stub_0x9747c8() -> ! {
    todo!("0x9747c8 RBX::Reflection::EventDescImpl<1,RBX::Network::Client,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Network::Client::*>:...")
}
...
pub fn stub_0x974c4c() -> ! {
    todo!("0x974c4c RBX::Reflection::EventDescImpl<1,RBX::Network::Client,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Network::Client::*>:...")
}
...
pub fn stub_0x974e54() -> ! {
    todo!("0x974e54 RBX::Reflection::EventDescBase<RBX::Network::Client,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Network::Client::*>::d...")
}
...
pub fn stub_0x974e70() -> ! {
    todo!("0x974e70 RBX::Reflection::EventDescBase<RBX::Network::Client,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Network::Client::*>::c...")
}
...
pub fn stub_0x977bdc() -> ! {
    todo!("0x977bdc RBX::Reflection::BoundFuncDesc<RBX::Network::Client,void ()(int),1>::BoundFuncDesc(void (RBX::Network::Client::*)(int),char const*,char const*,int,RBX::Security::Permis...")
}
...
pub fn stub_0x97896c() -> ! {
    todo!("0x97896c int RBX::Reflection::ArgHelper::getArg<int,5>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<int> const&,boost::disable_if<boost::is_same<int,boost:...")
}
...
pub fn stub_0x978b28() -> ! {
    todo!("0x978b28 RBX::Reflection::BoundProp<std::string,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::Network::Client>::setValue(RBX::Reflection::DescribedBase *,std::string con...")
}
...
// type: int __fastcall(double *, int *, int, int)
...
// type: int __fastcall(__guard *, int *, int, int)
...
// type: void __fastcall(_DWORD *, int, int, int, pthread_mutex_t *, int, pthread_mutex_t *, int, int, int, int, int, int, int)
#[doc(alias = "void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Stats::TypedStatsItem<float>,RBX::Stats::TypedStatsItem<float>>(boost::shared_ptr<RBX::Stats::TypedStatsItem<float>> const*,RBX::Stats::TypedStatsItem<float> *)const")]
...
// type: void __fastcall(_DWORD *, int, int, int, pthread_mutex_t *, int, pthread_mutex_t *, int, int, int, int, int, int, int)
#[doc(alias = "void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Stats::TypedStatsItem<unsigned long long>,RBX::Stats::TypedStatsItem<unsigned long long>>(boost::shared_ptr<RBX::Stats::TypedStatsItem<unsigned long long>> const*,RBX::Stats::TypedStatsItem<unsigned long long> *)const")]
