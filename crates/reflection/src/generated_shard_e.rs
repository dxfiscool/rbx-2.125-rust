// Auto-generated shard E — next 100 RBX::Reflection stubs — EA-sorted after 0x654528
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 7401 stubbed total in crate, 6713 matching filtered -> 9458 remaining, showing next 100)
...
pub fn stub_0x654758() {
    // IDA 0x654758: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6549b8() {
    // IDA 0x6549b8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x654df4() {
    // IDA 0x654df4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6550a4() {
    // IDA 0x6550a4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6553e0() {
    // IDA 0x6553e0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x655bb8() {
    // IDA 0x655bb8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x655f98() {
    // IDA 0x655f98: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x65795c() {
    // IDA 0x65795c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x657980() {
    // IDA 0x657980: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6579ac() {
    // IDA 0x6579ac: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6579d0() -> ! {
    todo!("0x6579d0 RBX::Reflection::PropDescriptor<RBX::StudioTool,bool>::PropDescriptor<bool (RBX::StudioTool::*)(void)const,void (RBX::StudioTool::*)(bool)>(char const*,char const*,bool (RBX::StudioTool::*)(void)const,void (RBX::StudioTool::*)(bool),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x657ae4 — __ZN3RBX10Reflection14PropDescriptorINS_10StudioToolEbED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::StudioTool,bool>::~PropDescriptor()")]
pub fn stub_0x657ae4() {
    // IDA 0x657ae4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x657b18() -> ! {
    todo!("0x657b18 RBX::Reflection::PropDescriptor<RBX::StudioTool,bool>::GetSetImpl<bool (RBX::StudioTool::*)(void)const,void (RBX::StudioTool::*)(bool)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x657b3c() -> ! {
    todo!("0x657b3c RBX::Reflection::PropDescriptor<RBX::StudioTool,bool>::GetSetImpl<bool (RBX::StudioTool::*)(void)const,void (RBX::StudioTool::*)(bool)>::setValue(RBX::Reflection::DescribedBase *,bool const&)const")
}

// 0x657b60 — __ZN3RBX10Reflection9EventDescINS_10StudioToolEFvvEN3rbx6signalIS3_EEMS2_S6_ED0Ev
#[doc(alias = "RBX::Reflection::EventDesc<RBX::StudioTool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::StudioTool::*>::~EventDesc()")]
pub fn stub_0x657b60() {
    // IDA 0x657b60: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x657e18() -> ! {
    todo!("0x657e18 RBX::Reflection::EventDescImpl<0,RBX::StudioTool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::StudioTool::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}
...
pub fn stub_0x657e8c() -> ! {
    todo!("0x657e8c RBX::Reflection::EventDescBase<RBX::StudioTool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::StudioTool::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}
...
#[doc(alias = "RBX::Reflection::EventDesc<RBX::StudioTool,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::StudioTool::*>::~EventDesc()")]
pub fn stub_0x658024() {
    // IDA 0x658024: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x658a7c() -> ! {
    todo!("0x658a7c RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Surface>(void)")
}
...
pub fn stub_0x658b70() -> ! {
    todo!("0x658b70 RBX::Surface::isSurfaceDescriptor(RBX::Reflection::PropertyDescriptor const&)")
}

// 0x658e20 — __ZN3RBX10Reflection5TTypeINS_7SurfaceEED1Ev
#[doc(alias = "RBX::Reflection::TType<RBX::Surface>::~TType()")]
pub fn stub_0x658e20() {
    // IDA 0x658e20: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x658e24() -> ! {
    todo!("0x658e24 RBX::SurfaceType & RBX::Reflection::Variant::genericConvert<RBX::SurfaceType>(void)")
}
...
pub fn stub_0x658f8c() -> ! {
    todo!("0x658f8c RBX::LegacyController::InputType & RBX::Reflection::Variant::genericConvert<RBX::LegacyController::InputType>(void)")
}
...
pub fn stub_0x659600() -> ! {
    todo!("0x659600 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x659628() -> ! {
    todo!("0x659628 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x659650() -> ! {
    todo!("0x659650 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x6597a8() -> ! {
    todo!("0x6597a8 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x6597d0() -> ! {
    todo!("0x6597d0 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::getStringValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x659820() -> ! {
    todo!("0x659820 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x659884() -> ! {
    todo!("0x659884 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}
...
pub fn stub_0x6598a4() -> ! {
    todo!("0x6598a4 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}
...
pub fn stub_0x659afc() -> ! {
    todo!("0x659afc RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::getIndexValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x659b44() -> ! {
    todo!("0x659b44 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const")
}
...
pub fn stub_0x659ba0() -> ! {
    todo!("0x659ba0 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::getEnumValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x659ba8() -> ! {
    todo!("0x659ba8 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::setEnumValue(RBX::Reflection::DescribedBase *,int)const")
}
...
pub fn stub_0x659c1c() -> ! {
    todo!("0x659c1c RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::getEnumItem(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x659c6c() -> ! {
    todo!("0x659c6c RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::LegacyController::InputType>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const")
}
...
pub fn stub_0x659e7c() -> ! {
    todo!("0x659e7c RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x659ea4() -> ! {
    todo!("0x659ea4 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x659ecc() -> ! {
    todo!("0x659ecc RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x65a024() -> ! {
    todo!("0x65a024 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x65a04c() -> ! {
    todo!("0x65a04c RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::getStringValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x65a09c() -> ! {
    todo!("0x65a09c RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x65a100() -> ! {
    todo!("0x65a100 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}
...
pub fn stub_0x65a120() -> ! {
    todo!("0x65a120 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}
...
pub fn stub_0x65a378() -> ! {
    todo!("0x65a378 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::getIndexValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x65a3c0() -> ! {
    todo!("0x65a3c0 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const")
}
...
pub fn stub_0x65a41c() -> ! {
    todo!("0x65a41c RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::getEnumValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x65a424() -> ! {
    todo!("0x65a424 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::setEnumValue(RBX::Reflection::DescribedBase *,int)const")
}
...
pub fn stub_0x65a498() -> ! {
    todo!("0x65a498 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::getEnumItem(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x65a4e8() -> ! {
    todo!("0x65a4e8 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)2,RBX::SurfaceType>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const")
}
