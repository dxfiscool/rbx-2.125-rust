...
pub fn stub_0x5c2c90() {
    // IDA 0x5c2c90: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2cb4() {
    // IDA 0x5c2cb4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2ce0() {
    // IDA 0x5c2ce0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2d14() {
    // IDA 0x5c2d14: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2d38() {
    // IDA 0x5c2d38: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2d5c() {
    // IDA 0x5c2d5c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2d80() {
    // IDA 0x5c2d80: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2e04() {
    // IDA 0x5c2e04: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c2e84() {
    // IDA 0x5c2e84: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c3670() -> bool {
    // IDA 0x5c3670: BoundPropGetSet::isReadOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x5c3674() -> bool {
    // IDA 0x5c3674: BoundPropGetSet::isWriteOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x5c3868() -> bool {
    // IDA 0x5c3868: BoundPropGetSet::isReadOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x5c386c() -> bool {
    // IDA 0x5c386c: BoundPropGetSet::isWriteOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x5c3abc() -> bool {
    // IDA 0x5c3abc: BoundPropGetSet::isReadOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x5c3ac0() -> bool {
    // IDA 0x5c3ac0: BoundPropGetSet::isWriteOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Lighting,bool>::~PropDescriptor()")]
pub fn stub_0x5c3c40() {
    // IDA 0x5c3c40: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c3c6c() -> bool {
    // IDA 0x5c3c6c: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5c3c70() -> bool {
    // IDA 0x5c3c70: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Lighting,G3D::Color3>::~PropDescriptor()")]
pub fn stub_0x5c3dd0() {
    // IDA 0x5c3dd0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c3dfc() -> bool {
    // IDA 0x5c3dfc: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5c3e00() -> bool {
    // IDA 0x5c3e00: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Lighting,void ()(double),1>::~BoundFuncDesc()")]
pub fn stub_0x5c4010() {
    // IDA 0x5c4010: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Lighting,double ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x5c4224() {
    // IDA 0x5c4224: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Lighting,G3D::Vector3 ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x5c443c() {
    // IDA 0x5c443c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Lighting,float ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x5c464c() {
    // IDA 0x5c464c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Lighting,float>::~PropDescriptor()")]
pub fn stub_0x5c4868() {
    // IDA 0x5c4868: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c4894() -> bool {
    // IDA 0x5c4894: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5c4898() -> bool {
    // IDA 0x5c4898: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Lighting,std::string>::~PropDescriptor()")]
pub fn stub_0x5c49f4() {
    // IDA 0x5c49f4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c4a20() -> bool {
    // IDA 0x5c4a20: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5c4a24() -> bool {
    // IDA 0x5c4a24: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Lighting,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::Lighting::*>::~EventDesc()")]
pub fn stub_0x5c4bf8() {
    // IDA 0x5c4bf8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c7230() {
    // IDA 0x5c7230: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c7274() {
    // IDA 0x5c7274: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::LocalBackpack,bool ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x5c77e8() {
    // IDA 0x5c77e8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::LocalBackpack,void ()(bool),1>::~BoundFuncDesc()")]
pub fn stub_0x5c7a98() {
    // IDA 0x5c7a98: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c8820() {
    // IDA 0x5c8820: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5c9fcc() {
    // IDA 0x5c9fcc: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x5ca97c() {
    // IDA 0x5ca97c: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x5cb148() -> ! {
    todo!("0x5cb148 RBX::Reflection::PropDescriptor<RBX::Message,std::string>::PropDescriptor<std::string const& (RBX::Message::*)(void)const,void (RBX::Message::*)(std::string const&)>(char const*,char const*,std::string const& (RBX::Message::*)(void)const,void (RBX::Message::*)(std::string const&),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x5cb25c — __ZN3RBX10Reflection14PropDescriptorINS_7MessageESsED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Message,std::string>::~PropDescriptor()")]
pub fn stub_0x5cb25c() {
    // IDA 0x5cb25c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cb288() -> bool {
    // IDA 0x5cb288: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5cb28c() -> bool {
    // IDA 0x5cb28c: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x5cb290() -> ! {
    todo!("0x5cb290 RBX::Reflection::PropDescriptor<RBX::Message,std::string>::GetSetImpl<std::string const& (RBX::Message::*)(void)const,void (RBX::Message::*)(std::string const&)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5cb2c0() -> ! {
    todo!("0x5cb2c0 RBX::Reflection::PropDescriptor<RBX::Message,std::string>::GetSetImpl<std::string const& (RBX::Message::*)(void)const,void (RBX::Message::*)(std::string const&)>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x5cdb10() {
    // IDA 0x5cdb10: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cdb34() {
    // IDA 0x5cdb34: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cdb60() {
    // IDA 0x5cdb60: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cdb84() {
    // IDA 0x5cdb84: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cdba8() {
    // IDA 0x5cdba8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cdbcc() {
    // IDA 0x5cdbcc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ce8cc() {
    // IDA 0x5ce8cc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ceae8() {
    // IDA 0x5ceae8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cecf8() {
    // IDA 0x5cecf8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cee04() -> ! {
    todo!("0x5cee04 RBX::Reflection::BoundFuncDesc<RBX::ModelInstance,void ()(void),0>::BoundFuncDesc(void (RBX::ModelInstance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x5cef08 — __ZN3RBX10Reflection13BoundFuncDescINS_13ModelInstanceEFvvELi0EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::ModelInstance,void ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x5cef08() {
    // IDA 0x5cef08: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cefbc() -> ! {
    todo!("0x5cefbc RBX::Reflection::BoundFuncDesc<RBX::ModelInstance,void ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x5cefdc() -> ! {
    todo!("0x5cefdc RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::RefPropDescriptor<RBX::PartInstance* (RBX::ModelInstance::*)(void)const,void (RBX::ModelInstance::*)(RBX::PartInstance*)>(char const*,char const*,RBX::PartInstance* (RBX::ModelInstance::*)(void)const,void (RBX::ModelInstance::*)(RBX::PartInstance*),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x5cf080() -> ! {
    todo!("0x5cf080 RBX::Reflection::RefType<RBX::PartInstance *>::singleton(void)")
}

// 0x5cf178 — __ZN3RBX10Reflection17RefPropDescriptorINS_13ModelInstanceENS_12PartInstanceEED0Ev
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::~RefPropDescriptor()")]
pub fn stub_0x5cf178() {
    // IDA 0x5cf178: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cf1a8() {
    // IDA 0x5cf1a8: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5cf1b8() {
    // IDA 0x5cf1b8: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5cf1c8() -> ! {
    todo!("0x5cf1c8 RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5cf1f0() -> ! {
    todo!("0x5cf1f0 RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x5cf3d0() -> ! {
    todo!("0x5cf3d0 RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x5cf3f4() -> ! {
    todo!("0x5cf3f4 RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}
...
pub fn stub_0x5cf4c8() -> ! {
    todo!("0x5cf4c8 RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}
...
pub fn stub_0x5cf4ec() -> ! {
    todo!("0x5cf4ec RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::getRefValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5cf500() -> ! {
    todo!("0x5cf500 RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::setRefValue(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")
}
...
pub fn stub_0x5cf57c() -> ! {
    todo!("0x5cf57c RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::setRefValueUnsafe(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")
}
...
pub fn stub_0x5cf59c() -> ! {
    todo!("0x5cf59c RBX::Reflection::RefPropDescriptor<RBX::ModelInstance,RBX::PartInstance>::assignIDREF(RBX::Reflection::DescribedBase *,RBX::InstanceHandle const&)const")
}
...
pub fn stub_0x5cf684() -> bool {
    // IDA 0x5cf684: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5cf688() -> bool {
    // IDA 0x5cf688: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x5cf68c() -> ! {
    todo!("0x5cf68c RBX::Reflection::PropDescriptor<RBX::ModelInstance,RBX::PartInstance *>::GetSetImpl<RBX::PartInstance * (RBX::ModelInstance::*)(void)const,void (RBX::ModelInstance::*)(RBX::PartInstance *)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5cf6ac() -> ! {
    todo!("0x5cf6ac RBX::Reflection::PropDescriptor<RBX::ModelInstance,RBX::PartInstance *>::GetSetImpl<RBX::PartInstance * (RBX::ModelInstance::*)(void)const,void (RBX::ModelInstance::*)(RBX::PartInstance *)>::setValue(RBX::Reflection::DescribedBase *,RBX::PartInstance * const&)const")
}

// 0x5cf6d0 — __ZN3RBX10Reflection7RefTypeIPNS_12PartInstanceEED1Ev
#[doc(alias = "RBX::Reflection::RefType<RBX::PartInstance *>::~RefType()")]
pub fn stub_0x5cf6d0() {
    // IDA 0x5cf6d0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cf6d4() -> ! {
    todo!("0x5cf6d4 RBX::Reflection::Type::Type<RBX::PartInstance *>(char const*,char const*,RBX::PartInstance * *)")
}

// 0x5cf780 — __ZN3RBX10Reflection7RefTypeIPNS_12PartInstanceEED0Ev
#[doc(alias = "RBX::Reflection::RefType<RBX::PartInstance *>::~RefType()")]
pub fn stub_0x5cf780() {
    // IDA 0x5cf780: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cf898() {
    // IDA 0x5cf898: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5cf8c4() -> bool {
    // IDA 0x5cf8c4: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5cf8c8() -> bool {
    // IDA 0x5cf8c8: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x5d1ad4() {
    // IDA 0x5d1ad4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1af8() {
    // IDA 0x5d1af8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1b1c() {
    // IDA 0x5d1b1c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1b40() {
    // IDA 0x5d1b40: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1b88() {
    // IDA 0x5d1b88: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1bb4() {
    // IDA 0x5d1bb4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1be0() {
    // IDA 0x5d1be0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1c04() {
    // IDA 0x5d1c04: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1c28() {
    // IDA 0x5d1c28: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::TextureId>::~PropDescriptor()")]
pub fn stub_0x5d1fac() {
    // IDA 0x5d1fac: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d1fd8() -> bool {
    // IDA 0x5d1fd8: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5d1fdc() -> bool {
    // IDA 0x5d1fdc: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,int>::~PropDescriptor()")]
pub fn stub_0x5d2138() {
    // IDA 0x5d2138: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d2164() {
    // IDA 0x5d2164: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d2168() {
    // IDA 0x5d2168: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::Mouse,RBX::NormalId>::~EnumPropDescriptor()")]
pub fn stub_0x5d2458() {
    // IDA 0x5d2458: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d2484() {
    // IDA 0x5d2484: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d2494() {
    // IDA 0x5d2494: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d2660() -> bool {
    // IDA 0x5d2660: EnumPropDescriptor::hasStringValue -- hardcoded `return 1` (decompiled 0x10244/0x10dc8/0x11650).
    true
}
...
pub fn stub_0x5d2a60() {
    // IDA 0x5d2a60: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d2a64() {
    // IDA 0x5d2a64: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d2ba8() -> ! {
    todo!("0x5d2ba8 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::RefPropDescriptor<RBX::PartInstance* (RBX::Mouse::*)(void)const,int>(char const*,char const*,RBX::PartInstance* (RBX::Mouse::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x5d2c4c — __ZN3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEED0Ev
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::~RefPropDescriptor()")]
pub fn stub_0x5d2c4c() {
    // IDA 0x5d2c4c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d2c7c() {
    // IDA 0x5d2c7c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d2c8c() {
    // IDA 0x5d2c8c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}

// 0x5d2c9c — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE11equalValuesEPKNS0_13DescribedBaseES7_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5d2c9c() -> ! {
    todo!("0x5d2c9c RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}

// 0x5d2cc4 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE10getVariantEPKNS0_13DescribedBaseERNS0_7VariantE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")]
pub fn stub_0x5d2cc4() -> ! {
    todo!("0x5d2cc4 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}

// 0x5d2ddc — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE10setVariantEPNS0_13DescribedBaseERKNS0_7VariantE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")]
pub fn stub_0x5d2ddc() -> ! {
    todo!("0x5d2ddc RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}

// 0x5d2ea4 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE9copyValueEPKNS0_13DescribedBaseEPS5_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")]
pub fn stub_0x5d2ea4() -> ! {
    todo!("0x5d2ea4 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}

// 0x5d2ec8 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE10writeValueEPKNS0_13DescribedBaseEP10XmlElement
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")]
pub fn stub_0x5d2ec8() -> ! {
    todo!("0x5d2ec8 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}

// 0x5d2f9c — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE9readValueEPNS0_13DescribedBaseEPK10XmlElementRNS_16IReferenceBinderE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")]
pub fn stub_0x5d2f9c() -> ! {
    todo!("0x5d2f9c RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}

// 0x5d2fc0 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE11getRefValueEPKNS0_13DescribedBaseE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::getRefValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5d2fc0() -> ! {
    todo!("0x5d2fc0 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::getRefValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5d2fd4 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE11setRefValueEPNS0_13DescribedBaseES6_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::setRefValue(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")]
pub fn stub_0x5d2fd4() -> ! {
    todo!("0x5d2fd4 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::setRefValue(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")
}

// 0x5d3050 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_12PartInstanceEE17setRefValueUnsafeEPNS0_13DescribedBaseES6_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::setRefValueUnsafe(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")]
pub fn stub_0x5d3050() -> ! {
    todo!("0x5d3050 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::setRefValueUnsafe(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")
}
...
pub fn stub_0x5d3070() -> ! {
    todo!("0x5d3070 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PartInstance>::assignIDREF(RBX::Reflection::DescribedBase *,RBX::InstanceHandle const&)const")
}
...
pub fn stub_0x5d3158() {
    // IDA 0x5d3158: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d315c() {
    // IDA 0x5d315c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::PartInstance *>::GetImpl<RBX::PartInstance * (RBX::Mouse::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5d3160() -> ! {
    todo!("0x5d3160 RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::PartInstance *>::GetImpl<RBX::PartInstance * (RBX::Mouse::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5d3180 — __ZNK3RBX10Reflection14PropDescriptorINS_5MouseEPNS_12PartInstanceEE7GetImplIMS2_KFS4_vEE8setValueEPNS0_13DescribedBaseERKS4_
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::PartInstance *>::GetImpl<RBX::PartInstance * (RBX::Mouse::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,RBX::PartInstance * const&)const")]
pub fn stub_0x5d3180() -> ! {
    todo!("0x5d3180 RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::PartInstance *>::GetImpl<RBX::PartInstance * (RBX::Mouse::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,RBX::PartInstance * const&)const")
}
...
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::RefPropDescriptor<RBX::PVInstance* (RBX::Mouse::*)(void)const,void (RBX::Mouse::*)(RBX::PVInstance*)>(char const*,char const*,RBX::PVInstance* (RBX::Mouse::*)(void)const,void (RBX::Mouse::*)(RBX::PVInstance*),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
pub fn stub_0x5d32a0() -> ! {
    todo!("0x5d32a0 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::RefPropDescriptor<RBX::PVInstance* (RBX::Mouse::*)(void)const,void (RBX::Mouse::*)(RBX::PVInstance*)>(char const*,char const*,RBX::PVInstance* (RBX::Mouse::*)(void)const,void (RBX::Mouse::*)(RBX::PVInstance*),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x5d3344 — __ZN3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEED0Ev
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::~RefPropDescriptor()")]
pub fn stub_0x5d3344() {
    // IDA 0x5d3344: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d3374() {
    // IDA 0x5d3374: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d3384() {
    // IDA 0x5d3384: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}

// 0x5d3394 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE11equalValuesEPKNS0_13DescribedBaseES7_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5d3394() -> ! {
    todo!("0x5d3394 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}

// 0x5d33bc — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE10getVariantEPKNS0_13DescribedBaseERNS0_7VariantE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")]
pub fn stub_0x5d33bc() -> ! {
    todo!("0x5d33bc RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}

// 0x5d34d4 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE10setVariantEPNS0_13DescribedBaseERKNS0_7VariantE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")]
pub fn stub_0x5d34d4() -> ! {
    todo!("0x5d34d4 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}

// 0x5d359c — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE9copyValueEPKNS0_13DescribedBaseEPS5_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")]
pub fn stub_0x5d359c() -> ! {
    todo!("0x5d359c RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}

// 0x5d35c0 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE10writeValueEPKNS0_13DescribedBaseEP10XmlElement
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")]
pub fn stub_0x5d35c0() -> ! {
    todo!("0x5d35c0 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}

// 0x5d3694 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE9readValueEPNS0_13DescribedBaseEPK10XmlElementRNS_16IReferenceBinderE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")]
pub fn stub_0x5d3694() -> ! {
    todo!("0x5d3694 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}

// 0x5d36b8 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE11getRefValueEPKNS0_13DescribedBaseE
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::getRefValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5d36b8() -> ! {
    todo!("0x5d36b8 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::getRefValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5d36cc — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE11setRefValueEPNS0_13DescribedBaseES6_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::setRefValue(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")]
pub fn stub_0x5d36cc() -> ! {
    todo!("0x5d36cc RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::setRefValue(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")
}

// 0x5d3748 — __ZNK3RBX10Reflection17RefPropDescriptorINS_5MouseENS_10PVInstanceEE17setRefValueUnsafeEPNS0_13DescribedBaseES6_
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::setRefValueUnsafe(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")]
pub fn stub_0x5d3748() -> ! {
    todo!("0x5d3748 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::setRefValueUnsafe(RBX::Reflection::DescribedBase *,RBX::Reflection::DescribedBase *)const")
}
...
pub fn stub_0x5d3768() -> ! {
    todo!("0x5d3768 RBX::Reflection::RefPropDescriptor<RBX::Mouse,RBX::PVInstance>::assignIDREF(RBX::Reflection::DescribedBase *,RBX::InstanceHandle const&)const")
}
...
pub fn stub_0x5d3850() -> bool {
    // IDA 0x5d3850: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5d3854() -> bool {
    // IDA 0x5d3854: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
// 0x5d389c — __ZN3RBX10Reflection14PropDescriptorINS_5MouseENS_6RbxRayEEC2IMS2_KFS3_vEiEEPKcS9_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::PropDescriptor<RBX::RbxRay (RBX::Mouse::*)(void)const,int>(char const*,char const*,RBX::RbxRay (RBX::Mouse::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
pub fn stub_0x5d389c() -> ! {
    todo!("0x5d389c RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::PropDescriptor<RBX::RbxRay (RBX::Mouse::*)(void)const,int>(char const*,char const*,RBX::RbxRay (RBX::Mouse::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x5d39a8 — __ZN3RBX10Reflection14PropDescriptorINS_5MouseENS_6RbxRayEED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::~PropDescriptor()")]
pub fn stub_0x5d39a8() {
    // IDA 0x5d39a8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d39d4() {
    // IDA 0x5d39d4: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d39d8() {
    // IDA 0x5d39d8: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::GetImpl<RBX::RbxRay (RBX::Mouse::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5d39dc() -> ! {
    todo!("0x5d39dc RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::GetImpl<RBX::RbxRay (RBX::Mouse::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5d3a04 — __ZNK3RBX10Reflection14PropDescriptorINS_5MouseENS_6RbxRayEE7GetImplIMS2_KFS3_vEE8setValueEPNS0_13DescribedBaseERKS3_
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::GetImpl<RBX::RbxRay (RBX::Mouse::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,RBX::RbxRay const&)const")]
pub fn stub_0x5d3a04() -> ! {
    todo!("0x5d3a04 RBX::Reflection::PropDescriptor<RBX::Mouse,RBX::RbxRay>::GetImpl<RBX::RbxRay (RBX::Mouse::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,RBX::RbxRay const&)const")
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Mouse,G3D::CoordinateFrame>::~PropDescriptor()")]
pub fn stub_0x5d3c30() {
    // IDA 0x5d3c30: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d3c5c() {
    // IDA 0x5d3c5c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5d3c60() {
    // IDA 0x5d3c60: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
// 0x5d3dac — __ZN3RBX10Reflection9EventDescINS_5MouseEFvSsEN3rbx6signalIS3_EEMS2_S6_EC2ES7_PKcSA_NS0_10Descriptor10AttributesE
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::EventDesc(rbx::signal<void ()(std::string)> RBX::Mouse::*,char const*,char const*,RBX::Reflection::Descriptor::Attributes)")]
pub fn stub_0x5d3dac() -> ! {
    todo!("0x5d3dac RBX::Reflection::EventDesc<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::EventDesc(rbx::signal<void ()(std::string)> RBX::Mouse::*,char const*,char const*,RBX::Reflection::Descriptor::Attributes)")
}

// 0x5d3f30 — __ZN3RBX10Reflection9EventDescINS_5MouseEFvSsEN3rbx6signalIS3_EEMS2_S6_ED0Ev
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::~EventDesc()")]
pub fn stub_0x5d3f30() {
    // IDA 0x5d3f30: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d3fe4() -> ! {
    todo!("0x5d3fe4 RBX::Reflection::EventDescImpl<1,RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}

// 0x5d4138 — __ZNK3RBX10Reflection13EventDescImplILi1ENS_5MouseEFvSsEN3rbx6signalIS3_EEMS2_S6_E9fireEventEPNS0_11EventSourceERKSt6vectorINS0_7VariantESaISC_EE
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")]
pub fn stub_0x5d4138() -> ! {
    todo!("0x5d4138 RBX::Reflection::EventDescImpl<1,RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}

// 0x5d42dc — __ZNK3RBX10Reflection13EventDescBaseINS_5MouseEFvSsEN3rbx6signalIS3_EEMS2_S6_E13disconnectAllEPNS0_11EventSourceE
#[doc(alias = "RBX::Reflection::EventDescBase<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::disconnectAll(RBX::Reflection::EventSource *)const")]
pub fn stub_0x5d42dc() -> ! {
    todo!("0x5d42dc RBX::Reflection::EventDescBase<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}

// 0x5d42f0 — __ZN3RBX10Reflection9EventDescINS_5MouseEFvSsEN3rbx6signalIS3_EEMS2_S6_EC2ES7_PKcSA_NS_8Security11PermissionsENS0_10Descriptor10AttributesE
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::EventDesc(rbx::signal<void ()(std::string)> RBX::Mouse::*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
pub fn stub_0x5d42f0() -> ! {
    todo!("0x5d42f0 RBX::Reflection::EventDesc<RBX::Mouse,void ()(std::string),rbx::signal<void ()(std::string)>,rbx::signal<void ()(std::string)> RBX::Mouse::*>::EventDesc(rbx::signal<void ()(std::string)> RBX::Mouse::*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x5d4474 — __ZN3RBX10Reflection9EventDescINS_5MouseEFvvEN3rbx6signalIS3_EEMS2_S6_ED0Ev
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Mouse,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Mouse::*>::~EventDesc()")]
pub fn stub_0x5d4474() {
    // IDA 0x5d4474: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5d4528() -> ! {
    todo!("0x5d4528 RBX::Reflection::EventDescImpl<0,RBX::Mouse,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Mouse::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}

// 0x5d472c — __ZNK3RBX10Reflection13EventDescImplILi0ENS_5MouseEFvvEN3rbx6signalIS3_EEMS2_S6_E9fireEventEPNS0_11EventSourceERKSt6vectorINS0_7VariantESaISC_EE
#[doc(alias = "RBX::Reflection::EventDescImpl<0,RBX::Mouse,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Mouse::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")]
pub fn stub_0x5d472c() -> ! {
    todo!("0x5d472c RBX::Reflection::EventDescImpl<0,RBX::Mouse,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Mouse::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}

// 0x5d47a0 — __ZNK3RBX10Reflection13EventDescBaseINS_5MouseEFvvEN3rbx6signalIS3_EEMS2_S6_E13disconnectAllEPNS0_11EventSourceE
#[doc(alias = "RBX::Reflection::EventDescBase<RBX::Mouse,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Mouse::*>::disconnectAll(RBX::Reflection::EventSource *)const")]
pub fn stub_0x5d47a0() -> ! {
    todo!("0x5d47a0 RBX::Reflection::EventDescBase<RBX::Mouse,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Mouse::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}
...
pub fn stub_0x5d78b4() {
    // IDA 0x5d78b4: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x5e0164() -> bool {
    // IDA 0x5e0164: TypedPropertyDescriptor::hasStringValue -- per-type constant `return 0` (decompiled tails: 1 for most, 0 for BrickColor/SystemAddress/CoordinateFrame/Region3int16/Ref).
    false
}
...
pub fn stub_0x5e0538() {
    // IDA 0x5e0538: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e055c() {
    // IDA 0x5e055c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0580() {
    // IDA 0x5e0580: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0c64() {
    // IDA 0x5e0c64: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0c98() {
    // IDA 0x5e0c98: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0cbc() {
    // IDA 0x5e0cbc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0ce0() {
    // IDA 0x5e0ce0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0d6c() {
    // IDA 0x5e0d6c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0d98() {
    // IDA 0x5e0d98: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0dc4() {
    // IDA 0x5e0dc4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0e08() {
    // IDA 0x5e0e08: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0e2c() {
    // IDA 0x5e0e2c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0e50() {
    // IDA 0x5e0e50: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0e74() {
    // IDA 0x5e0e74: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0ebc() {
    // IDA 0x5e0ebc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0eec() {
    // IDA 0x5e0eec: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0f1c() {
    // IDA 0x5e0f1c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e0f64() {
    // IDA 0x5e0f64: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5e2880 — __ZN3RBX10Reflection5TTypeIN3G3D15CoordinateFrameEED1Ev
#[doc(alias = "RBX::Reflection::TType<G3D::CoordinateFrame>::~TType()")]
pub fn stub_0x5e2880() {
    // IDA 0x5e2880: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e2fb0() {
    // IDA 0x5e2fb0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5e2fb4 — __ZN3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEED0Ev
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::PartInstance::FormFactor>::~EnumDesc()")]
pub fn stub_0x5e2fb4() {
    // IDA 0x5e2fb4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x5e3054 — __ZNK3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEE6lookupEPKc
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::PartInstance::FormFactor>::lookup(char const*)const")]
pub fn stub_0x5e3054(desc: &crate::enum_desc::EnumDesc, name: &str) -> usize {
    // IDA 0x5e3054: EnumDesc<T>::lookup(char const*) -- Name::lookup intern, search name_to_value then legacy_names; hit: return convertToItem(value); miss: return 0 (decompiled 0x957a18).
    desc.lookup_value(name).and_then(|v| usize::try_from(v).ok()).and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}

// 0x5e3084 — __ZNK3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEE6lookupERKNS0_7VariantE
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::PartInstance::FormFactor>::lookup(RBX::Reflection::Variant const&)const")]
pub fn stub_0x5e3084(desc: &crate::enum_desc::EnumDesc, value: i32) -> usize {
    // IDA 0x5e3084: EnumDesc<T>::lookup(Variant) -- rbx::any_cast<T> the payload, then convertToItem (decompiled 0xb97c). Variant is unmodeled in this crate; the caller passes the already-cast enum value, and this is convertToItem exactly.
...
// 0x5e30a4 — __ZNK3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEE14convertToValueEmRNS0_7VariantE
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::PartInstance::FormFactor>::convertToValue(unsigned long,RBX::Reflection::Variant &)const")]
pub fn stub_0x5e30a4() {
    // IDA 0x5e30a4: EnumDesc<T>::convertToValue(index, Variant&) -- writes the converted value into a Variant out-param; Variant is unmodeled in this crate: cutover no-op. See the (desc, name, &mut i32) sibling for the lookup semantics.
}

// 0x5e30d8 — __ZNK3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEE15convertToStringEmRSs
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::PartInstance::FormFactor>::convertToString(unsigned long,std::string &)const")]
pub fn stub_0x5e30d8(desc: &crate::enum_desc::EnumDesc, index: usize, out: &mut String) -> bool {
    // IDA 0x5e30d8: EnumDesc<T>::convertToString(index, string&) -- if index < items.size(): out = items[index].name, return true; else return false, out untouched (decompiled 0x957bd4).
...
pub fn stub_0x5e321c() {
    // IDA 0x5e321c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5e3220 — __ZN3RBX10Reflection8EnumDescINS_8MaterialEED0Ev
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::Material>::~EnumDesc()")]
pub fn stub_0x5e3220() {
    // IDA 0x5e3220: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e32c0(desc: &crate::enum_desc::EnumDesc, name: &str) -> usize {
    // IDA 0x5e32c0: EnumDesc<T>::lookup(char const*) -- Name::lookup intern, search name_to_value then legacy_names; hit: return convertToItem(value); miss: return 0 (decompiled 0x957a18).
    desc.lookup_value(name).and_then(|v| usize::try_from(v).ok()).and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}
...
pub fn stub_0x5e32f0(desc: &crate::enum_desc::EnumDesc, value: i32) -> usize {
    // IDA 0x5e32f0: EnumDesc<T>::lookup(Variant) -- rbx::any_cast<T> the payload, then convertToItem (decompiled 0xb97c). Variant is unmodeled in this crate; the caller passes the already-cast enum value, and this is convertToItem exactly.
    assert!(value >= 0, "value>=0 ../App/include/reflection/enumconverter.h:273");
    assert!((value as usize) < desc.len(), "(size_t)value<enumToItem.size() ../App/include/reflection/enumconverter.h:274");
    usize::try_from(value).ok().and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}
...
pub fn stub_0x5e3310() {
    // IDA 0x5e3310: EnumDesc<T>::convertToValue(index, Variant&) -- writes the converted value into a Variant out-param; Variant is unmodeled in this crate: cutover no-op. See the (desc, name, &mut i32) sibling for the lookup semantics.
}
...
pub fn stub_0x5e3344(desc: &crate::enum_desc::EnumDesc, index: usize, out: &mut String) -> bool {
    // IDA 0x5e3344: EnumDesc<T>::convertToString(index, string&) -- if index < items.size(): out = items[index].name, return true; else return false, out untouched (decompiled 0x957bd4).
    if let Some(item) = desc.items.get(index) {
        *out = item.name.clone();
        true
    } else {
...
pub fn stub_0x5e3ba8(desc: &crate::enum_desc::EnumDesc, value: i32) -> String {
    // IDA 0x5e3ba8: EnumDesc<T>::convertToString(value) -- ReleaseAssert(value>=0) (:262), ReleaseAssert(value<enumToItem.size()) (:263); out of range yields "" (decompiled 0xc76c).
...
pub fn stub_0x5e3e14(desc: &crate::enum_desc::EnumDesc, value: i32) -> usize {
    // IDA 0x5e3e14: EnumDesc<T>::convertToItem(value) -- ReleaseAssert(value>=0) (:273), ReleaseAssert(value<enumToItem.size()) (:274); return items_by_value[value] or 0 (decompiled 0x95807c).
    assert!(value >= 0, "value>=0 ../App/include/reflection/enumconverter.h:273");
    assert!((value as usize) < desc.len(), "(size_t)value<enumToItem.size() ../App/include/reflection/enumconverter.h:274");
    usize::try_from(value).ok().and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}
...
pub fn stub_0x5e4264(desc: &crate::enum_desc::EnumDesc, name: &str, out: &mut i32) -> bool {
    // IDA 0x5e4264: EnumDesc<T>::convertToValue(Name, T&) -- search name_to_value then legacy_names; hit: *out = value, return true; miss: return false, out untouched (decompiled 0xcc34). Name interning is elided: the model keys owned strings.
...
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::Material>::~EnumDesc()")]
pub fn stub_0x5e42e0() {
    // IDA 0x5e42e0: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e44b4(desc: &crate::enum_desc::EnumDesc, value: i32) -> String {
    // IDA 0x5e44b4: EnumDesc<T>::convertToString(value) -- ReleaseAssert(value>=0) (:262), ReleaseAssert(value<enumToItem.size()) (:263); out of range yields "" (decompiled 0xc76c).
    assert!(value >= 0, "value>=0 ../App/include/reflection/enumconverter.h:262");
    assert!((value as usize) < desc.len(), "(size_t)value<enumToItem.size() ../App/include/reflection/enumconverter.h:263");
    desc.lookup_name(value).unwrap_or("").to_owned()
}
...
pub fn stub_0x5e4720(desc: &crate::enum_desc::EnumDesc, value: i32) -> usize {
    // IDA 0x5e4720: EnumDesc<T>::convertToItem(value) -- ReleaseAssert(value>=0) (:273), ReleaseAssert(value<enumToItem.size()) (:274); return items_by_value[value] or 0 (decompiled 0x95807c).
    assert!(value >= 0, "value>=0 ../App/include/reflection/enumconverter.h:273");
    assert!((value as usize) < desc.len(), "(size_t)value<enumToItem.size() ../App/include/reflection/enumconverter.h:274");
    usize::try_from(value).ok().and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}

// 0x5e48dc — __ZNK3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEE14convertToValueERKNS_4NameERS3_
...
pub fn stub_0x5e48dc(desc: &crate::enum_desc::EnumDesc, name: &str, out: &mut i32) -> bool {
    // IDA 0x5e48dc: EnumDesc<T>::convertToValue(Name, T&) -- search name_to_value then legacy_names; hit: *out = value, return true; miss: return false, out untouched (decompiled 0xcc34). Name interning is elided: the model keys owned strings.
    match desc.lookup_value(name) {
        Some(v) => { *out = v; true }
        None => false,
    }
...
// 0x5e4958 — __ZN3RBX10Reflection8EnumDescINS_12PartInstance10FormFactorEED2Ev
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::PartInstance::FormFactor>::~EnumDesc()")]
pub fn stub_0x5e4958() {
    // IDA 0x5e4958: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}

// 0x5e4c10 — __ZNK5boost8weak_ptrIN3RBX10Reflection13DescribedBaseEE7expiredEv
#[doc(alias = "rbx_core::Weak<RBX::Reflection::DescribedBase>::expired(void)const")]
pub fn stub_0x5e4c10() -> ! {
    todo!("0x5e4c10 rbx_core::Weak<RBX::Reflection::DescribedBase>::expired(void)const")
}
...
#[doc(alias = "RBX::Reflection::TType<G3D::CoordinateFrame>::~TType()")]
pub fn stub_0x5e4e38() {
    // IDA 0x5e4e38: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x5e4e40 — __ZN3RBX10Reflection4TypeD1Ev
#[doc(alias = "RBX::Reflection::Type::~Type()")]
pub fn stub_0x5e4e40() {
    // IDA 0x5e4e40: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e8958() {
    // IDA 0x5e8958: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}

// 0x5e8b8c — __ZN3RBX10Reflection9EventDescINS_12PartInstanceEFvvEN3rbx6signalIS3_EEMS2_FRS6_vEED0Ev
#[doc(alias = "RBX::Reflection::EventDesc<RBX::PartInstance,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)>& (RBX::PartInstance::*)(void)>::~EventDesc()")]
pub fn stub_0x5e8b8c() {
    // IDA 0x5e8b8c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e8c40() -> ! {
    todo!("0x5e8c40 RBX::Reflection::EventDescImpl<0,RBX::PartInstance,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)>& (RBX::PartInstance::*)(void)>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_0x5e8e60() -> ! {
    todo!("0x5e8e60 RBX::Reflection::EventDescriptor::isBroadcast(void)const")
}
...
pub fn stub_0x5e9160() {
    // IDA 0x5e9160: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5e9230() -> ! {
    todo!("0x5e9230 std::_Vector_base<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>::_Vector_base(unsigned long,std::allocator<RBX::Reflection::Variant> const&)")
}
...
pub fn stub_0x5e9268() -> ! {
    todo!("0x5e9268 boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>>,boost::_bi::value<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>>::list2(boost::_bi::value<rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>>,boost::_bi::value<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>)")
}
...
pub fn stub_0x5e9368() -> ! {
    todo!("0x5e9368 boost::_bi::storage2<boost::_bi::value<rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>>,boost::_bi::value<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>>::storage2(boost::_bi::value<rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>>,boost::_bi::value<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>)")
}
...
pub fn stub_0x5ea1cc() -> ! {
    todo!("0x5ea1cc RBX::Reflection::EventDesc<RBX::PartInstance,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::PartInstance::TouchedSignal,RBX::PartInstance::TouchedSignal& (RBX::PartInstance::*)(void)>::EventDesc(RBX::PartInstance::TouchedSignal& (RBX::PartInstance::*)(void),char const*,char const*,RBX::Reflection::Descriptor::Attributes)")
}
...
#[doc(alias = "RBX::Reflection::EventDesc<RBX::PartInstance,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::PartInstance::TouchedSignal,RBX::PartInstance::TouchedSignal& (RBX::PartInstance::*)(void)>::~EventDesc()")]
pub fn stub_0x5ea35c() {
    // IDA 0x5ea35c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ea410() -> ! {
    todo!("0x5ea410 RBX::Reflection::EventDescImpl<1,RBX::PartInstance,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::PartInstance::TouchedSignal,RBX::PartInstance::TouchedSignal& (RBX::PartInstance::*)(void)>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_0x5ea5b0() -> ! {
    todo!("0x5ea5b0 RBX::Reflection::EventDescImpl<1,RBX::PartInstance,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::PartInstance::TouchedSignal,RBX::PartInstance::TouchedSignal& (RBX::PartInstance::*)(void)>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}
...
#[doc(alias = "RBX::Reflection::EventDesc<RBX::PartInstance,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>& (RBX::PartInstance::*)(void)>::~EventDesc()")]
pub fn stub_0x5ec154() {
    // IDA 0x5ec154: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::SystemAddress>::~PropDescriptor()")]
pub fn stub_0x5ece30() {
    // IDA 0x5ece30: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ece5c() {
    // IDA 0x5ece5c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ece6c() {
    // IDA 0x5ece6c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ece7c() -> ! {
    todo!("0x5ece7c RBX::Reflection::TypedPropertyDescriptor<RBX::SystemAddress>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5eceb0() -> ! {
    todo!("0x5eceb0 RBX::Reflection::TypedPropertyDescriptor<RBX::SystemAddress>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x5ecedc() -> ! {
    todo!("0x5ecedc RBX::Reflection::TypedPropertyDescriptor<RBX::SystemAddress>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x5ed040() -> ! {
    todo!("0x5ed040 RBX::Reflection::TypedPropertyDescriptor<RBX::SystemAddress>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x5ed230() {
    // IDA 0x5ed230: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5ed254 — __ZN3RBX10Reflection23TypedPropertyDescriptorINS_13SystemAddressEED0Ev
#[doc(alias = "RBX::Reflection::TypedPropertyDescriptor<RBX::SystemAddress>::~TypedPropertyDescriptor()")]
pub fn stub_0x5ed254() {
    // IDA 0x5ed254: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ed280() -> bool {
    // IDA 0x5ed280: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5ed284() -> bool {
    // IDA 0x5ed284: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::PartInstance,bool ()(RBX::NormalId,int),2>::~BoundFuncDesc()")]
pub fn stub_0x5ed500() {
    // IDA 0x5ed500: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ed670() -> ! {
    todo!("0x5ed670 RBX::NormalId RBX::Reflection::ArgHelper::getArg<RBX::NormalId,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::NormalId> const&,boost::disable_if<boost::is_same<RBX::NormalId,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x5ed800() -> ! {
    todo!("0x5ed800 int RBX::Reflection::ArgHelper::getArg<int,2>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<int> const&,boost::disable_if<boost::is_same<int,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x5edae0() {
    // IDA 0x5edae0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5edae8 — __ZN3RBX10Reflection8EnumDescINS_8NormalIdEED0Ev
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::NormalId>::~EnumDesc()")]
pub fn stub_0x5edae8() {
    // IDA 0x5edae8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5edb88(desc: &crate::enum_desc::EnumDesc, name: &str) -> usize {
    // IDA 0x5edb88: EnumDesc<T>::lookup(char const*) -- Name::lookup intern, search name_to_value then legacy_names; hit: return convertToItem(value); miss: return 0 (decompiled 0x957a18).
    desc.lookup_value(name).and_then(|v| usize::try_from(v).ok()).and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}
...
pub fn stub_0x5edbb8(desc: &crate::enum_desc::EnumDesc, value: i32) -> usize {
    // IDA 0x5edbb8: EnumDesc<T>::lookup(Variant) -- rbx::any_cast<T> the payload, then convertToItem (decompiled 0xb97c). Variant is unmodeled in this crate; the caller passes the already-cast enum value, and this is convertToItem exactly.
    assert!(value >= 0, "value>=0 ../App/include/reflection/enumconverter.h:273");
    assert!((value as usize) < desc.len(), "(size_t)value<enumToItem.size() ../App/include/reflection/enumconverter.h:274");
    usize::try_from(value).ok().and_then(|s| desc.items_by_value.get(s).copied().flatten()).unwrap_or(0)
}
...
pub fn stub_0x5edbd8() {
    // IDA 0x5edbd8: EnumDesc<T>::convertToValue(index, Variant&) -- writes the converted value into a Variant out-param; Variant is unmodeled in this crate: cutover no-op. See the (desc, name, &mut i32) sibling for the lookup semantics.
}
...
pub fn stub_0x5edc10(desc: &crate::enum_desc::EnumDesc, value: i32) -> String {
    // IDA 0x5edc10: EnumDesc<T>::convertToString(value) -- ReleaseAssert(value>=0) (:262), ReleaseAssert(value<enumToItem.size()) (:263); out of range yields "" (decompiled 0xc76c).
    assert!(value >= 0, "value>=0 ../App/include/reflection/enumconverter.h:262");
    assert!((value as usize) < desc.len(), "(size_t)value<enumToItem.size() ../App/include/reflection/enumconverter.h:263");
    desc.lookup_name(value).unwrap_or("").to_owned()
}
...
pub fn stub_0x5edf68(desc: &crate::enum_desc::EnumDesc, name: &str, out: &mut i32) -> bool {
    // IDA 0x5edf68: EnumDesc<T>::convertToValue(Name, T&) -- search name_to_value then legacy_names; hit: *out = value, return true; miss: return false, out untouched (decompiled 0xcc34). Name interning is elided: the model keys owned strings.
    match desc.lookup_value(name) {
        Some(v) => { *out = v; true }
        None => false,
    }
...
pub fn stub_0x5ee060() {
    // IDA 0x5ee060: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,int>::~PropDescriptor()")]
pub fn stub_0x5ee344() {
    // IDA 0x5ee344: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ee370() {
    // IDA 0x5ee370: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ee380() {
    // IDA 0x5ee380: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ee390() -> ! {
    todo!("0x5ee390 RBX::Reflection::TypedPropertyDescriptor<int>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5ee3b8() -> ! {
    todo!("0x5ee3b8 RBX::Reflection::TypedPropertyDescriptor<int>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x5ee3e0() -> ! {
    todo!("0x5ee3e0 RBX::Reflection::TypedPropertyDescriptor<int>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x5ee530() -> ! {
    todo!("0x5ee530 RBX::Reflection::TypedPropertyDescriptor<int>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x5ee568() {
    // IDA 0x5ee568: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ee590() {
    // IDA 0x5ee590: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ee594() {
    // IDA 0x5ee594: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::Faces>::~PropDescriptor()")]
pub fn stub_0x5ee908() {
    // IDA 0x5ee908: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ee934() {
    // IDA 0x5ee934: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ee944() {
    // IDA 0x5ee944: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ee954() -> ! {
    todo!("0x5ee954 RBX::Reflection::TypedPropertyDescriptor<RBX::Faces>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5ee97c() -> ! {
    todo!("0x5ee97c RBX::Reflection::TypedPropertyDescriptor<RBX::Faces>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x5ee9a4() -> ! {
    todo!("0x5ee9a4 RBX::Reflection::TypedPropertyDescriptor<RBX::Faces>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x5eeafc() -> ! {
    todo!("0x5eeafc RBX::Reflection::TypedPropertyDescriptor<RBX::Faces>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x5eecd4() {
    // IDA 0x5eecd4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5eecf8 — __ZN3RBX10Reflection23TypedPropertyDescriptorINS_5FacesEED0Ev
#[doc(alias = "RBX::Reflection::TypedPropertyDescriptor<RBX::Faces>::~TypedPropertyDescriptor()")]
pub fn stub_0x5eecf8() {
    // IDA 0x5eecf8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5eed24() {
    // IDA 0x5eed24: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5eed28() {
    // IDA 0x5eed28: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,bool>::~PropDescriptor()")]
pub fn stub_0x5ef0a4() {
    // IDA 0x5ef0a4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ef0d0() {
    // IDA 0x5ef0d0: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ef0e0() {
    // IDA 0x5ef0e0: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ef0f0() -> ! {
    todo!("0x5ef0f0 RBX::Reflection::TypedPropertyDescriptor<bool>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5ef118() {
    // IDA 0x5ef118: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ef144() -> bool {
    // IDA 0x5ef144: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5ef148() -> bool {
    // IDA 0x5ef148: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x5ef194() -> ! {
    todo!("0x5ef194 RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::EnumPropDescriptor<RBX::Material (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::Material)>(char const*,char const*,RBX::Material (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::Material),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x5ef348 — __ZN3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEED0Ev
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::~EnumPropDescriptor()")]
pub fn stub_0x5ef348() {
    // IDA 0x5ef348: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5ef374() {
    // IDA 0x5ef374: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ef384() {
    // IDA 0x5ef384: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5ef550() -> ! {
    todo!("0x5ef550 RBX::Reflection::EnumPropertyDescriptor::getDataSize(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5ef554() -> bool {
    // IDA 0x5ef554: EnumPropDescriptor::hasStringValue -- hardcoded `return 1` (decompiled 0x10244/0x10dc8/0x11650).
    true
}
...
// 0x5ef81c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEE13getIndexValueEPKNS0_13DescribedBaseE
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::getIndexValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5ef81c() -> ! {
    todo!("0x5ef81c RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::getIndexValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5ef838 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEE13setIndexValueEPNS0_13DescribedBaseEm
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const")]
pub fn stub_0x5ef838() -> ! {
    todo!("0x5ef838 RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const")
}

// 0x5ef86c — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEE12getEnumValueEPKNS0_13DescribedBaseE
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::getEnumValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5ef86c() -> ! {
    todo!("0x5ef86c RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::getEnumValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5ef874 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEE12setEnumValueEPNS0_13DescribedBaseEi
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setEnumValue(RBX::Reflection::DescribedBase *,int)const")]
pub fn stub_0x5ef874() -> ! {
    todo!("0x5ef874 RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setEnumValue(RBX::Reflection::DescribedBase *,int)const")
}

// 0x5ef8c0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEE11getEnumItemEPKNS0_13DescribedBaseE
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::getEnumItem(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5ef8c0() -> ! {
    todo!("0x5ef8c0 RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::getEnumItem(RBX::Reflection::DescribedBase const*)const")
}

// 0x5ef8e0 — __ZNK3RBX10Reflection18EnumPropDescriptorINS_12PartInstanceENS_8MaterialEE14setStringValueEPNS0_13DescribedBaseERKNS_4NameE
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const")]
pub fn stub_0x5ef8e0() -> ! {
    todo!("0x5ef8e0 RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const")
}
...
pub fn stub_0x5ef918() -> ! {
    todo!("0x5ef918 __gnu_cxx::__normal_iterator<RBX::Reflection::EnumDescriptor::Item const* const*,std::vector<RBX::Reflection::EnumDescriptor::Item const*,std::allocator<RBX::Reflection::EnumDescriptor::Item const*>>> std::__find_if<__gnu_cxx::__normal_iterator<RBX::Reflection::EnumDescriptor::Item const* const*,std::vector<RBX::Reflection::EnumDescriptor::Item const*,std::allocator<RBX::Reflection::EnumDescriptor::Item const*>>>,boost::_bi::bind_t<bool,bool (*)(RBX::Reflection::EnumDescriptor::Item const*,int),boost::_bi::list2<boost::arg<1>,boost::_bi::value<int>>>>(__gnu_cxx::__normal_iterator<RBX::Reflection::EnumDescriptor::Item const* const*,std::vector<RBX::Reflection::EnumDescriptor::Item const*,std::allocator<RBX::Reflection::EnumDescriptor::Item const*>>>,__gnu_cxx::__normal_iterator<RBX::Reflection::EnumDescriptor::Item const* const*,std::vector<RBX::Reflection::EnumDescriptor::Item const*,std::allocator<RBX::Reflection::EnumDescriptor::Item const*>>>,boost::_bi::bind_t<bool,bool (*)(RBX::Reflection::EnumDescriptor::Item const*,int),boost::_bi::list2<boost::arg<1>,boost::_bi::value<int>>>,std::random_access_iterator_tag)")
}
...
#[doc(alias = "RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setIntValue(RBX::Reflection::DescribedBase *,int)const")]
pub fn stub_0x5efa28() -> ! {
    todo!("0x5efa28 RBX::Reflection::EnumPropDescriptor<RBX::PartInstance,RBX::Material>::setIntValue(RBX::Reflection::DescribedBase *,int)const")
}

// 0x5efa68 — __ZNK3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_8MaterialEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE10isReadOnlyEv
...
pub fn stub_0x5efa68() -> bool {
    // IDA 0x5efa68: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5efa6c() -> bool {
    // IDA 0x5efa6c: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::Material>::GetSetImpl<RBX::Material (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::Material)>::getValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5efa70() -> ! {
    todo!("0x5efa70 RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::Material>::GetSetImpl<RBX::Material (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::Material)>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5efa90 — __ZNK3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_8MaterialEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE8setValueEPNS0_13DescribedBaseERKS3_
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::Material>::GetSetImpl<RBX::Material (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::Material)>::setValue(RBX::Reflection::DescribedBase *,RBX::Material const&)const")]
pub fn stub_0x5efa90() -> ! {
    todo!("0x5efa90 RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::Material>::GetSetImpl<RBX::Material (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::Material)>::setValue(RBX::Reflection::DescribedBase *,RBX::Material const&)const")
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::PropDescriptor<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>(char const*,char const*,RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
pub fn stub_0x5efba8() -> ! {
    todo!("0x5efba8 RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::PropDescriptor<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>(char const*,char const*,RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
// 0x5efde0 — __ZN3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_10BrickColorEED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::~PropDescriptor()")]
pub fn stub_0x5efde0() {
    // IDA 0x5efde0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5efe0c() {
    // IDA 0x5efe0c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5efe1c() {
    // IDA 0x5efe1c: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5efe2c() -> ! {
    todo!("0x5efe2c RBX::Reflection::TypedPropertyDescriptor<RBX::BrickColor>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x5efe60() -> ! {
    todo!("0x5efe60 RBX::Reflection::TypedPropertyDescriptor<RBX::BrickColor>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x5efe8c() -> ! {
    todo!("0x5efe8c RBX::Reflection::TypedPropertyDescriptor<RBX::BrickColor>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x5effe8() -> ! {
    todo!("0x5effe8 RBX::Reflection::TypedPropertyDescriptor<RBX::BrickColor>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x5f01c4() {
    // IDA 0x5f01c4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5f01e8 — __ZN3RBX10Reflection23TypedPropertyDescriptorINS_10BrickColorEED0Ev
#[doc(alias = "RBX::Reflection::TypedPropertyDescriptor<RBX::BrickColor>::~TypedPropertyDescriptor()")]
pub fn stub_0x5f01e8() {
    // IDA 0x5f01e8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x5f0214 — __ZNK3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_10BrickColorEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE10isReadOnlyEv
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>::isReadOnly(void)const")]
pub fn stub_0x5f0214() -> bool {
    // IDA 0x5f0214: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}

// 0x5f0218 — __ZNK3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_10BrickColorEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE11isWriteOnlyEv
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>::isWriteOnly(void)const")]
pub fn stub_0x5f0218() -> bool {
    // IDA 0x5f0218: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}

// 0x5f021c — __ZNK3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_10BrickColorEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE8getValueEPKNS0_13DescribedBaseE
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>::getValue(RBX::Reflection::DescribedBase const*)const")]
pub fn stub_0x5f021c() -> ! {
    todo!("0x5f021c RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x5f0244 — __ZNK3RBX10Reflection14PropDescriptorINS_12PartInstanceENS_10BrickColorEE10GetSetImplIMS2_KFS3_vEMS2_FvS3_EE8setValueEPNS0_13DescribedBaseERKS3_
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>::setValue(RBX::Reflection::DescribedBase *,RBX::BrickColor const&)const")]
pub fn stub_0x5f0244() -> ! {
    todo!("0x5f0244 RBX::Reflection::PropDescriptor<RBX::PartInstance,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(RBX::BrickColor)>::setValue(RBX::Reflection::DescribedBase *,RBX::BrickColor const&)const")
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,G3D::Color3>::~PropDescriptor()")]
pub fn stub_0x5f04a0() {
    // IDA 0x5f04a0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5f04cc() {
    // IDA 0x5f04cc: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5f04dc() {
    // IDA 0x5f04dc: isReadOnly/isWriteOnly -- virtual forward to the bound member descriptor (cf. EnumPropDescriptor shape at decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x5f08d4() {
    // IDA 0x5f08d4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x5f08f8 — __ZN3RBX10Reflection23TypedPropertyDescriptorIN3G3D6Color3EED0Ev
#[doc(alias = "RBX::Reflection::TypedPropertyDescriptor<G3D::Color3>::~TypedPropertyDescriptor()")]
pub fn stub_0x5f08f8() {
    // IDA 0x5f08f8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x5f0924() -> bool {
    // IDA 0x5f0924: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x5f0928() -> bool {
    // IDA 0x5f0928: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
// 0x5f0978 — __ZN3RBX10Reflection14PropDescriptorINS_12PartInstanceEfEC2IMS2_KFfvEMS2_FvfEEEPKcSA_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PartInstance,float>::PropDescriptor<float (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(float)>(char const*,char const*,float (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
pub fn stub_0x5f0978() -> ! {
    todo!("0x5f0978 RBX::Reflection::PropDescriptor<RBX::PartInstance,float>::PropDescriptor<float (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(float)>(char const*,char const*,float (RBX::PartInstance::*)(void)const,void (RBX::PartInstance::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}// 0x6fd950 — __ZN3RBX10Reflection5TTypeIdED0Ev
#[doc(alias = "RBX::Reflection::TType<double>::~TType()")]
pub fn stub_0x6fd950() -> ! {
    todo!("0x6fd950 RBX::Reflection::TType<double>::~TType()")
}

// 0x6fda3c — __ZN3RBX10Reflection4TypeC2IfEEPKcPT_
#[doc(alias = "RBX::Reflection::Type::Type<float>(char const*,float *)")]
pub fn stub_0x6fda3c() -> ! {
    todo!("0x6fda3c RBX::Reflection::Type::Type<float>(char const*,float *)")
}

// 0x6fdadc — __ZN3RBX10Reflection5TTypeIfED0Ev
#[doc(alias = "RBX::Reflection::TType<float>::~TType()")]
pub fn stub_0x6fdadc() {
    // IDA 0x6fdadc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x6fdbc8 — __ZN3RBX10Reflection4TypeC2IbEEPKcPT_
#[doc(alias = "RBX::Reflection::Type::Type<bool>(char const*,bool *)")]
pub fn stub_0x6fdbc8() -> ! {
    todo!("0x6fdbc8 RBX::Reflection::Type::Type<bool>(char const*,bool *)")
}

// 0x6fdc68 — __ZN3RBX10Reflection5TTypeIbED0Ev
#[doc(alias = "RBX::Reflection::TType<bool>::~TType()")]
pub fn stub_0x6fdc68() {
    // IDA 0x6fdc68: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x6fdd54 — __ZN3RBX10Reflection4TypeC2IlEEPKcPT_
#[doc(alias = "RBX::Reflection::Type::Type<long>(char const*,long *)")]
pub fn stub_0x6fdd54() -> ! {
    todo!("0x6fdd54 RBX::Reflection::Type::Type<long>(char const*,long *)")
}

// 0x6fddf4 — __ZN3RBX10Reflection5TTypeIlED0Ev
#[doc(alias = "RBX::Reflection::TType<long>::~TType()")]
pub fn stub_0x6fddf4() {
    // IDA 0x6fddf4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x6fddf8 — __ZN3RBX10Reflection4TypeC2IiEEPKcPT_
#[doc(alias = "RBX::Reflection::Type::Type<int>(char const*,int *)")]
pub fn stub_0x6fddf8() -> ! {
    todo!("0x6fddf8 RBX::Reflection::Type::Type<int>(char const*,int *)")
}

// 0x6fde98 — __ZN3RBX10Reflection5TTypeIiED0Ev
#[doc(alias = "RBX::Reflection::TType<int>::~TType()")]
pub fn stub_0x6fde98() {
    // IDA 0x6fde98: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6fdf48() {
    // IDA 0x6fdf48: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6fdff8() {
    // IDA 0x6fdff8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x6fdffc — __ZN3RBX10Reflection4TypeC2IN5boost10shared_ptrINS0_13DescribedBaseEEEEEPKcPT_
#[doc(alias = "RBX::Reflection::Type::Type<rbx_core::SharedPtr<RBX::Reflection::DescribedBase>>(char const*,rbx_core::SharedPtr<RBX::Reflection::DescribedBase> *)")]
pub fn stub_0x6fdffc() -> ! {
    todo!("0x6fdffc RBX::Reflection::Type::Type<rbx_core::SharedPtr<RBX::Reflection::DescribedBase>>(char const*,rbx_core::SharedPtr<RBX::Reflection::DescribedBase> *)")
}

// 0x6fe0a8 — __ZN3RBX10Reflection5TTypeIN5boost10shared_ptrINS0_13DescribedBaseEEEED0Ev
#[doc(alias = "RBX::Reflection::TType<rbx_core::SharedPtr<RBX::Reflection::DescribedBase>>::~TType()")]
pub fn stub_0x6fe0a8() {
    // IDA 0x6fe0a8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7030d0() {
    // IDA 0x7030d0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x7030f4 — __ZN3RBX10Reflection13DescribedBase3isAESs
#[doc(alias = "RBX::Reflection::DescribedBase::isA(std::string)")]
pub fn stub_0x7030f4() -> ! {
...
pub fn stub_0x703104() {
    // IDA 0x703104: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x703168 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EED1Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(std::string,bool),2>::~BoundFuncDesc()")]
pub fn stub_0x703168() {
    // IDA 0x703168: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x7031b0 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EED1Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x7031b0() {
    // IDA 0x7031b0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7031d4() {
    // IDA 0x7031d4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> ()(void),0>::~BoundFuncDesc()")]
pub fn stub_0x70320c() {
    // IDA 0x70320c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x70323c() {
    // IDA 0x70323c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x703274 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EED1Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(rbx_core::SharedPtr<RBX::Instance>),1>::~BoundFuncDesc()")]
pub fn stub_0x703274() {
    // IDA 0x703274: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7033a0() {
    // IDA 0x7033a0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7033fc() {
    // IDA 0x7033fc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x703420() {
    // IDA 0x703420: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x703444() {
    // IDA 0x703444: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x703498() {
    // IDA 0x703498: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7034d8() {
    // IDA 0x7034d8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x703520() {
    // IDA 0x703520: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x703544() {
    // IDA 0x703544: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x705340() {
    // IDA 0x705340: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x705354 — __ZN3RBX10Reflection13DescribedBaseD0Ev
#[doc(alias = "RBX::Reflection::DescribedBase::~DescribedBase()")]
pub fn stub_0x705354() {
    // IDA 0x705354: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7064c0() {
    // IDA 0x7064c0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x707500() -> ! {
    todo!("0x707500 rbx_core::SharedPtr<rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::slot>::operator=(rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::slot*)")
}
...
pub fn stub_0x707528() {
    // IDA 0x707528: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x707638 — __ZN3rbx7signals6signalIFvPKN3RBX10Reflection18PropertyDescriptorEEE13callable_slotIN5boost8functionIS7_EEED0Ev
#[doc(alias = "rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::callable_slot<boost::function<void ()(RBX::Reflection::PropertyDescriptor const*)>>::~callable_slot()")]
pub fn stub_0x707638() {
    // IDA 0x707638: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x707888() {
    // IDA 0x707888: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "rbx::callable<rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::slot,boost::function<void ()(RBX::Reflection::PropertyDescriptor const*)>,1,void ()(RBX::Reflection::PropertyDescriptor const*)>::~callable()")]
pub fn stub_0x707998() {
    // IDA 0x707998: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x707ac8() {
    // IDA 0x707ac8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x707d18() {
    // IDA 0x707d18: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x709ad4() {
    // IDA 0x709ad4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::RefPropDescriptor<RBX::Instance,RBX::Instance>::~RefPropDescriptor()")]
pub fn stub_0x70a410() {
    // IDA 0x70a410: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
// --- next 100 EA-sorted asc after 0x70a5a0 (RBX::Reflection, 7323 uncovered -> 7223) ---
...
pub fn stub_0x70ae4c() {
    // IDA 0x70ae4c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x70b07c() {
    // IDA 0x70b07c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x70bcb8() {
    // IDA 0x70bcb8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x70be80() {
    // IDA 0x70be80: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,int>::GetImpl<int (RBX::Instance::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8InstanceEiE7GetImplIMS2_KFivEE8getValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x70beb4() -> ! {
    todo!("0x70beb4 RBX::Reflection::PropDescriptor<RBX::Instance,int>::GetImpl<int (RBX::Instance::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x70bed4 — __ZNK3RBX10Reflection14PropDescriptorINS_8InstanceEiE7GetImplIMS2_KFivEE8setValueEPNS0_13DescribedBaseERKi
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,int>::GetImpl<int (RBX::Instance::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,int const&)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8InstanceEiE7GetImplIMS2_KFivEE8setValueEPNS0_13DescribedBaseERKi")]
pub fn stub_0x70bed4() -> ! {
    todo!("0x70bed4 RBX::Reflection::PropDescriptor<RBX::Instance,int>::GetImpl<int (RBX::Instance::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,int const&)const")
}

// 0x70bff4 — __ZN3RBX10Reflection14PropDescriptorINS_8InstanceESsEC2IMS2_KFSsvEiEEPKcS8_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE
// type: int __fastcall(int, int, int, int, int, void *, int, int, int, int)
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,std::string>::PropDescriptor<std::string (RBX::Instance::*)(void)const,int>(char const*,char const*,std::string (RBX::Instance::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_8InstanceESsEC2IMS2_KFSsvEiEEPKcS8_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")]
pub fn stub_0x70bff4() -> ! {
    todo!("0x70bff4 RBX::Reflection::PropDescriptor<RBX::Instance,std::string>::PropDescriptor<std::string (RBX::Instance::*)(void)const,int>(char const*,char const*,std::string (RBX::Instance::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,std::string>::GetImpl<std::string (RBX::Instance::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8InstanceESsE7GetImplIMS2_KFSsvEE8getValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x70c108() -> ! {
    todo!("0x70c108 RBX::Reflection::PropDescriptor<RBX::Instance,std::string>::GetImpl<std::string (RBX::Instance::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x70c130 — __ZNK3RBX10Reflection14PropDescriptorINS_8InstanceESsE7GetImplIMS2_KFSsvEE8setValueEPNS0_13DescribedBaseERKSs
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,std::string>::GetImpl<std::string (RBX::Instance::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8InstanceESsE7GetImplIMS2_KFSsvEE8setValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_0x70c130() -> ! {
    todo!("0x70c130 RBX::Reflection::PropDescriptor<RBX::Instance,std::string>::GetImpl<std::string (RBX::Instance::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}

// 0x70c250 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EEC2EMS2_FSsiEPKcS8_iNS_8Security11PermissionsENS0_10Descriptor10AttributesE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::BoundFuncDesc(std::string (RBX::Instance::*)(int),char const*,char const*,int,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EEC2EMS2_FSsiEPKcS8_iNS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70c250() -> ! {
    todo!("0x70c250 RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::BoundFuncDesc(std::string (RBX::Instance::*)(int),char const*,char const*,int,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70c3fc — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EE16declareSignatureEPKcNS0_7VariantE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::declareSignature(char const*,RBX::Reflection::Variant)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EE16declareSignatureEPKcNS0_7VariantE")]
pub fn stub_0x70c3fc() -> ! {
    todo!("0x70c3fc RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}

// 0x70c42c — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EED0Ev")]
pub fn stub_0x70c42c() {
    // IDA 0x70c42c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70c500 — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsiELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70c500() -> ! {
    todo!("0x70c500 RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(int),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70c540 — __ZN3RBX10Reflection11Call1HelperINS_8InstanceEMS2_FSsiEiSsE4callEPS2_S4_RNS0_7VariantERKi
#[doc(alias = "RBX::Reflection::Call1Helper<RBX::Instance,std::string (RBX::Instance::*)(int),int,std::string>::call(RBX::Instance*,std::string (RBX::Instance::*)(int),RBX::Reflection::Variant &,int const&)")]
#[doc(alias = "__ZN3RBX10Reflection11Call1HelperINS_8InstanceEMS2_FSsiEiSsE4callEPS2_S4_RNS0_7VariantERKi")]
pub fn stub_0x70c540() -> ! {
    todo!("0x70c540 RBX::Reflection::Call1Helper<RBX::Instance,std::string (RBX::Instance::*)(int),int,std::string>::call(RBX::Instance*,std::string (RBX::Instance::*)(int),RBX::Reflection::Variant &,int const&)")
}

// 0x70c680 — __ZN3RBX10Reflection9ArgHelper6getArgIiLi1EEET_RNS0_18FunctionDescriptor9ArgumentsERKN5boost10scoped_ptrIS3_EEPNS7_10disable_ifINS7_7is_sameIS3_NS7_10shared_ptrIKNS0_5TupleEEEEEvE4typeE
#[doc(alias = "int RBX::Reflection::ArgHelper::getArg<int,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<int> const&,boost::disable_if<boost::is_same<int,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")]
#[doc(alias = "__ZN3RBX10Reflection9ArgHelper6getArgIiLi1EEET_RNS0_18FunctionDescriptor9ArgumentsERKN5boost10scoped_ptrIS3_EEPNS7_10disable_ifINS7_7is_sameIS3_NS7_10shared_ptrIKNS0_5TupleEEEEEvE4typeE")]
pub fn stub_0x70c680() -> ! {
    todo!("0x70c680 int RBX::Reflection::ArgHelper::getArg<int,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<int> const&,boost::disable_if<boost::is_same<int,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")
}

// 0x70c814 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EEC2EMS2_FbS5_EPKcSB_NS_8Security11PermissionsENS0_10Descriptor10AttributesE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(rbx_core::SharedPtr<RBX::Instance>),1>::BoundFuncDesc(bool (RBX::Instance::*)(rbx_core::SharedPtr<RBX::Instance>),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EEC2EMS2_FbS5_EPKcSB_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70c814() -> ! {
    todo!("0x70c814 RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(boost::shared_ptr<RBX::Instance>),1>::BoundFuncDesc(bool (RBX::Instance::*)(boost::shared_ptr<RBX::Instance>),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70c9ac — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EE16declareSignatureEPKcNS0_7VariantE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(rbx_core::SharedPtr<RBX::Instance>),1>::declareSignature(char const*,RBX::Reflection::Variant)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EE16declareSignatureEPKcNS0_7VariantE")]
pub fn stub_0x70c9ac() -> ! {
    todo!("0x70c9ac RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(boost::shared_ptr<RBX::Instance>),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}

// 0x70c9dc — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(rbx_core::SharedPtr<RBX::Instance>),1>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EED0Ev")]
pub fn stub_0x70c9dc() {
    // IDA 0x70c9dc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70caf8 — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(rbx_core::SharedPtr<RBX::Instance>),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFbN5boost10shared_ptrIS2_EEELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70caf8() -> ! {
    todo!("0x70caf8 RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(boost::shared_ptr<RBX::Instance>),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70cbe0 — __ZN3RBX10Reflection11Call1HelperINS_8InstanceEMS2_FbN5boost10shared_ptrIS2_EEES5_bE4callEPS2_S7_RNS0_7VariantERKS5_
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "RBX::Reflection::Call1Helper<RBX::Instance,bool (RBX::Instance::*)(rbx_core::SharedPtr<RBX::Instance>),rbx_core::SharedPtr<RBX::Instance>,bool>::call(RBX::Instance*,bool (RBX::Instance::*)(rbx_core::SharedPtr<RBX::Instance>),RBX::Reflection::Variant &,rbx_core::SharedPtr<RBX::Instance> const&)")]
#[doc(alias = "__ZN3RBX10Reflection11Call1HelperINS_8InstanceEMS2_FbN5boost10shared_ptrIS2_EEES5_bE4callEPS2_S7_RNS0_7VariantERKS5_")]
pub fn stub_0x70cbe0() -> ! {
    todo!("0x70cbe0 RBX::Reflection::Call1Helper<RBX::Instance,bool (RBX::Instance::*)(boost::shared_ptr<RBX::Instance>),boost::shared_ptr<RBX::Instance>,bool>::call(RBX::Instance*,bool (RBX::Instance::*)(boost::shared_ptr<RBX::Instance>),RBX::Reflection::Variant &,boost::shared_ptr<RBX::Instance> const&)")
}

// 0x70ccf0 — __ZN3RBX10Reflection9ArgHelper10try_objectILi1ENS_8InstanceEEEbRNS0_18FunctionDescriptor9ArgumentsERN5boost10shared_ptrIT0_EEPNS7_9enable_ifINS7_10is_base_ofINS0_13DescribedBaseES9_EEvE4typeE
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "bool RBX::Reflection::ArgHelper::try_object<1,RBX::Instance>(RBX::Reflection::FunctionDescriptor::Arguments &,rbx_core::SharedPtr<RBX::Instance> &,boost::enable_if<boost::is_base_of<RBX::Reflection::DescribedBase,RBX::Instance>,void>::type *)")]
#[doc(alias = "__ZN3RBX10Reflection9ArgHelper10try_objectILi1ENS_8InstanceEEEbRNS0_18FunctionDescriptor9ArgumentsERN5boost10shared_ptrIT0_EEPNS7_9enable_ifINS7_10is_base_ofINS0_13DescribedBaseES9_EEvE4typeE")]
pub fn stub_0x70ccf0() -> ! {
    todo!("0x70ccf0 bool RBX::Reflection::ArgHelper::try_object<1,RBX::Instance>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::shared_ptr<RBX::Instance> &,boost::enable_if<boost::is_base_of<RBX::Reflection::DescribedBase,RBX::Instance>,void>::type *)")
}

// 0x70ce10 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsvELi0EEC2EMS2_FSsvEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int)
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(void),0>::BoundFuncDesc(std::string (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsvELi0EEC2EMS2_FSsvEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70ce10() -> ! {
    todo!("0x70ce10 RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(void),0>::BoundFuncDesc(std::string (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70cf14 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsvELi0EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(void),0>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsvELi0EED0Ev")]
pub fn stub_0x70cf14() {
    // IDA 0x70cf14: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70cfc8 — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFSsvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70cfc8() -> ! {
    todo!("0x70cfc8 RBX::Reflection::BoundFuncDesc<RBX::Instance,std::string ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70cfec — __ZN3RBX10Reflection11Call0HelperINS_8InstanceEMS2_FSsvESsE4callEPS2_S4_RNS0_7VariantE
#[doc(alias = "RBX::Reflection::Call0Helper<RBX::Instance,std::string (RBX::Instance::*)(void),std::string>::call(RBX::Instance*,std::string (RBX::Instance::*)(void),RBX::Reflection::Variant &)")]
#[doc(alias = "__ZN3RBX10Reflection11Call0HelperINS_8InstanceEMS2_FSsvESsE4callEPS2_S4_RNS0_7VariantE")]
pub fn stub_0x70cfec() -> ! {
    todo!("0x70cfec RBX::Reflection::Call0Helper<RBX::Instance,std::string (RBX::Instance::*)(void),std::string>::call(RBX::Instance*,std::string (RBX::Instance::*)(void),RBX::Reflection::Variant &)")
}

// 0x70d128 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvELi0EEC2EMS2_FSA_vEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int)
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> ()(void),0>::BoundFuncDesc(rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvELi0EEC2EMS2_FSA_vEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70d128() -> ! {
    todo!("0x70d128 RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> ()(void),0>::BoundFuncDesc(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70d22c — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvELi0EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> ()(void),0>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvELi0EED0Ev")]
pub fn stub_0x70d22c() {
    // IDA 0x70d22c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70d2e0 — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70d2e0() -> ! {
    todo!("0x70d2e0 RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70d304 — __ZN3RBX10Reflection11Call0HelperINS_8InstanceEMS2_FN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvESA_E4callEPS2_SC_RNS0_7VariantE
#[doc(alias = "RBX::Reflection::Call0Helper<RBX::Instance,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> (RBX::Instance::*)(void),rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const>>::call(RBX::Instance*,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> const> (RBX::Instance::*)(void),RBX::Reflection::Variant &)")]
#[doc(alias = "__ZN3RBX10Reflection11Call0HelperINS_8InstanceEMS2_FN5boost10shared_ptrIKSt6vectorINS4_IS2_EESaIS6_EEEEvESA_E4callEPS2_SC_RNS0_7VariantE")]
pub fn stub_0x70d304() -> ! {
    todo!("0x70d304 RBX::Reflection::Call0Helper<RBX::Instance,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> (RBX::Instance::*)(void),boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>>::call(RBX::Instance*,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> (RBX::Instance::*)(void),RBX::Reflection::Variant &)")
}

// 0x70d3ec — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFvvELi0EEC2EMS2_FvvEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int)
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,void ()(void),0>::BoundFuncDesc(void (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFvvELi0EEC2EMS2_FvvEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70d3ec() -> ! {
    todo!("0x70d3ec RBX::Reflection::BoundFuncDesc<RBX::Instance,void ()(void),0>::BoundFuncDesc(void (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70d4f0 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFvvELi0EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,void ()(void),0>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFvvELi0EED0Ev")]
pub fn stub_0x70d4f0() {
    // IDA 0x70d4f0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70d5a4 — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFvvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,void ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFvvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70d5a4() -> ! {
    todo!("0x70d5a4 RBX::Reflection::BoundFuncDesc<RBX::Instance,void ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70d5c4 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EEC2EMS2_FS5_vEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int)
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(void),0>::BoundFuncDesc(rbx_core::SharedPtr<RBX::Instance> (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EEC2EMS2_FS5_vEPKcNS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70d5c4() -> ! {
    todo!("0x70d5c4 RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<RBX::Instance> ()(void),0>::BoundFuncDesc(boost::shared_ptr<RBX::Instance> (RBX::Instance::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70d6c8 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(void),0>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EED0Ev")]
pub fn stub_0x70d6c8() {
    // IDA 0x70d6c8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70d77c — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EEvELi0EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70d77c() -> ! {
    todo!("0x70d77c RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<RBX::Instance> ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70d7a0 — __ZN3RBX10Reflection11Call0HelperINS_8InstanceEMS2_FN5boost10shared_ptrIS2_EEvES5_E4callEPS2_S7_RNS0_7VariantE
#[doc(alias = "RBX::Reflection::Call0Helper<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> (RBX::Instance::*)(void),rbx_core::SharedPtr<RBX::Instance>>::call(RBX::Instance*,rbx_core::SharedPtr<RBX::Instance> (RBX::Instance::*)(void),RBX::Reflection::Variant &)")]
#[doc(alias = "__ZN3RBX10Reflection11Call0HelperINS_8InstanceEMS2_FN5boost10shared_ptrIS2_EEvES5_E4callEPS2_S7_RNS0_7VariantE")]
pub fn stub_0x70d7a0() -> ! {
    todo!("0x70d7a0 RBX::Reflection::Call0Helper<RBX::Instance,boost::shared_ptr<RBX::Instance> (RBX::Instance::*)(void),boost::shared_ptr<RBX::Instance>>::call(RBX::Instance*,boost::shared_ptr<RBX::Instance> (RBX::Instance::*)(void),RBX::Reflection::Variant &)")
}

// 0x70d888 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EEC2EMS2_FS5_SsbEPKcSB_SB_bNS_8Security11PermissionsENS0_10Descriptor10AttributesE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(std::string,bool),2>::BoundFuncDesc(rbx_core::SharedPtr<RBX::Instance> (RBX::Instance::*)(std::string,bool),char const*,char const*,char const*,bool,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EEC2EMS2_FS5_SsbEPKcSB_SB_bNS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70d888() -> ! {
    todo!("0x70d888 RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<RBX::Instance> ()(std::string,bool),2>::BoundFuncDesc(boost::shared_ptr<RBX::Instance> (RBX::Instance::*)(std::string,bool),char const*,char const*,char const*,bool,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70da84 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EE16declareSignatureEPKcNS0_7VariantES9_SA_
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(std::string,bool),2>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EE16declareSignatureEPKcNS0_7VariantES9_SA_")]
pub fn stub_0x70da84() -> ! {
    todo!("0x70da84 RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<RBX::Instance> ()(std::string,bool),2>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")
}

// 0x70dad0 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(std::string,bool),2>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EED0Ev")]
pub fn stub_0x70dad0() {
    // IDA 0x70dad0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70dbac — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> ()(std::string,bool),2>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFN5boost10shared_ptrIS2_EESsbELi2EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70dbac() -> ! {
    todo!("0x70dbac RBX::Reflection::BoundFuncDesc<RBX::Instance,boost::shared_ptr<RBX::Instance> ()(std::string,bool),2>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70dd0c — __ZN3RBX10Reflection11Call2HelperINS_8InstanceEMS2_FN5boost10shared_ptrIS2_EESsbESsbS5_E4callEPS2_S7_RNS0_7VariantERKSsRKb
// type: int __fastcall(int, int, int, int, std::string *, int)
#[doc(alias = "RBX::Reflection::Call2Helper<RBX::Instance,rbx_core::SharedPtr<RBX::Instance> (RBX::Instance::*)(std::string,bool),std::string,bool,rbx_core::SharedPtr<RBX::Instance>>::call(RBX::Instance*,rbx_core::SharedPtr<RBX::Instance> (RBX::Instance::*)(std::string,bool),RBX::Reflection::Variant &,std::string const&,bool const&)")]
#[doc(alias = "__ZN3RBX10Reflection11Call2HelperINS_8InstanceEMS2_FN5boost10shared_ptrIS2_EESsbESsbS5_E4callEPS2_S7_RNS0_7VariantERKSsRKb")]
pub fn stub_0x70dd0c() -> ! {
    todo!("0x70dd0c RBX::Reflection::Call2Helper<RBX::Instance,boost::shared_ptr<RBX::Instance> (RBX::Instance::*)(std::string,bool),std::string,bool,boost::shared_ptr<RBX::Instance>>::call(RBX::Instance*,boost::shared_ptr<RBX::Instance> (RBX::Instance::*)(std::string,bool),RBX::Reflection::Variant &,std::string const&,bool const&)")
}

// 0x70de94 — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EEC2EMS2_FbSsEPKcS8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::BoundFuncDesc(bool (RBX::Instance::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EEC2EMS2_FbSsEPKcS8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x70de94() -> ! {
    todo!("0x70de94 RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::BoundFuncDesc(bool (RBX::Instance::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x70e00c — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EE16declareSignatureEPKcNS0_7VariantE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EE16declareSignatureEPKcNS0_7VariantE")]
pub fn stub_0x70e00c() -> ! {
    todo!("0x70e00c RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}

// 0x70e03c — __ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EED0Ev")]
pub fn stub_0x70e03c() {
    // IDA 0x70e03c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x70e108 — __ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_8InstanceEFbSsELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_0x70e108() -> ! {
    todo!("0x70e108 RBX::Reflection::BoundFuncDesc<RBX::Instance,bool ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x70e248 — __ZN3RBX10Reflection11Call1HelperINS_8InstanceEMS2_FbSsESsbE4callEPS2_S4_RNS0_7VariantERKSs
// type: int __fastcall(int, int, int, int, std::string *)
#[doc(alias = "RBX::Reflection::Call1Helper<RBX::Instance,bool (RBX::Instance::*)(std::string),std::string,bool>::call(RBX::Instance*,bool (RBX::Instance::*)(std::string),RBX::Reflection::Variant &,std::string const&)")]
#[doc(alias = "__ZN3RBX10Reflection11Call1HelperINS_8InstanceEMS2_FbSsESsbE4callEPS2_S4_RNS0_7VariantERKSs")]
pub fn stub_0x70e248() -> ! {
    todo!("0x70e248 RBX::Reflection::Call1Helper<RBX::Instance,bool (RBX::Instance::*)(std::string),std::string,bool>::call(RBX::Instance*,bool (RBX::Instance::*)(std::string),RBX::Reflection::Variant &,std::string const&)")
}

// 0x70e39c — __ZN3RBX10Reflection14PropDescriptorINS_8InstanceEbEC2IMS2_KFbvEMS2_FvbEEEPKcSA_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE
// type: int __fastcall(int, int, int, int, int, void *, int, int, int, int, int)
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,bool>::PropDescriptor<bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool)>(char const*,char const*,bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")]
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_8InstanceEbEC2IMS2_KFbvEMS2_FvbEEEPKcSA_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")]
pub fn stub_0x70e39c() -> ! {
    todo!("0x70e39c RBX::Reflection::PropDescriptor<RBX::Instance,bool>::PropDescriptor<bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool)>(char const*,char const*,bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x70e4b4 — __ZN3RBX10Reflection14PropDescriptorINS_8InstanceEbED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,bool>::~PropDescriptor()")]
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_8InstanceEbED0Ev")]
pub fn stub_0x70e4b4() {
    // IDA 0x70e4b4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,bool>::GetSetImpl<bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool)>::getValue(RBX::Reflection::DescribedBase const*)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8InstanceEbE10GetSetImplIMS2_KFbvEMS2_FvbEE8getValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x70e4ec() -> ! {
    todo!("0x70e4ec RBX::Reflection::PropDescriptor<RBX::Instance,bool>::GetSetImpl<bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool)>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x70e510 — __ZNK3RBX10Reflection14PropDescriptorINS_8InstanceEbE10GetSetImplIMS2_KFbvEMS2_FvbEE8setValueEPNS0_13DescribedBaseERKb
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Instance,bool>::GetSetImpl<bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool)>::setValue(RBX::Reflection::DescribedBase *,bool const&)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8InstanceEbE10GetSetImplIMS2_KFbvEMS2_FvbEE8setValueEPNS0_13DescribedBaseERKb")]
pub fn stub_0x70e510() -> ! {
    todo!("0x70e510 RBX::Reflection::PropDescriptor<RBX::Instance,bool>::GetSetImpl<bool (RBX::Instance::*)(void)const,void (RBX::Instance::*)(bool)>::setValue(RBX::Reflection::DescribedBase *,bool const&)const")
}

// 0x70fb7c — __ZSt8for_eachIN3RBX10Reflection25MemberDescriptorContainerINS1_18PropertyDescriptorEE13ConstIteratorEN5boost3_bi6bind_tIvNS6_4_mfi3mf3IvNS0_6ClonerERKNS1_13ConstPropertyEPKNS0_8InstanceEPSF_EENS7_5list4INS7_5valueIPSB_EENS6_3argILi1EEENSL_ISH_EENSL_ISI_EEEEEEET0_T_SV_SU_
// type: int __fastcall(int, RBX::Reflection::DescribedBase *, int, int, int, int, int, int, int, int)
#[doc(alias = "boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Cloner,RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*>,boost::_bi::list4<boost::_bi::value<RBX::Cloner*>,boost::arg<1>,boost::_bi::value<RBX::Instance const*>,boost::_bi::value<RBX::Instance*>>> std::for_each<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::ConstIterator,boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Cloner,RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*>,boost::_bi::list4<boost::_bi::value<RBX::Cloner*>,boost::arg<1>,boost::_bi::value<RBX::Instance const*>,boost::_bi::value<RBX::Instance*>>>>(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::ConstIterator,RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::ConstIterator,boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Cloner,RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*>,boost::_bi::list4<boost::_bi::value<RBX::Cloner*>,boost::arg<1>,boost::_bi::value<RBX::Instance const*>,boost::_bi::value<RBX::Instance*>>>)")]
#[doc(alias = "__ZSt8for_eachIN3RBX10Reflection25MemberDescriptorContainerINS1_18PropertyDescriptorEE13ConstIteratorEN5boost3_bi6bind_tIvNS6_4_mfi3mf3IvNS0_6ClonerERKNS1_13ConstPropertyEPKNS0_8InstanceEPSF_EENS7_5list4INS7_5valueIPSB_EENS6_3argILi1EEENSL_ISH_EENSL_ISI_EEEEEEET0_T_SV_SU_")]
pub fn stub_0x70fb7c() -> ! {
    todo!("0x70fb7c boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Cloner,RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*>,boost::_bi::list4<boost::_bi::value<RBX::Cloner*>,boost::arg<1>,boost::_bi::value<RBX::Instance const*>,boost::_bi::value<RBX::Instance*>>> std::for_each<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::ConstIterator,boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Cloner,RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*>,boost::_bi::list4<boost::_bi::value<RBX::Cloner*>,boost::arg<1>,boost::_bi::value<RBX::Instance const*>,boost::_bi::value<RBX::Instance*>>>>(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::ConstIterator,RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::ConstIterator,boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Cloner,RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*>,boost::_bi::list4<boost::_bi::value<RBX::Cloner*>,boost::arg<1>,boost::_bi::value<RBX::Instance const*>,boost::_bi::value<RBX::Instance*>>>)")
}

// 0x70fc4c — __ZN3RBX6Cloner12copyPropertyERKNS_10Reflection13ConstPropertyEPKNS_8InstanceEPS5_
#[doc(alias = "RBX::Cloner::copyProperty(RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*)")]
#[doc(alias = "__ZN3RBX6Cloner12copyPropertyERKNS_10Reflection13ConstPropertyEPKNS_8InstanceEPS5_")]
pub fn stub_0x70fc4c() -> ! {
    todo!("0x70fc4c RBX::Cloner::copyProperty(RBX::Reflection::ConstProperty const&,RBX::Instance const*,RBX::Instance*)")
}

// 0x70fe98 — __ZN3RBX10Reflection21RefPropertyDescriptor23isRefPropertyDescriptorERKNS0_18PropertyDescriptorE
// type: _DWORD __fastcall(RBX::Reflection::RefPropertyDescriptor *__hidden this, const RBX::Reflection::PropertyDescriptor *)
...
pub fn stub_0x714a64() {
    // IDA 0x714a64: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x714aa4() {
    // IDA 0x714aa4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x714ac8() {
    // IDA 0x714ac8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x714ee0() {
    // IDA 0x714ee0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// --- next 100 EA-sorted asc after 0x714ee0 (RBX::Reflection, 7223 uncovered -> 7123) ---
...
pub fn stub_0x71525c() {
    // IDA 0x71525c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x715744() {
    // IDA 0x715744: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7710b0() {
    // IDA 0x7710b0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7711a4() {
    // IDA 0x7711a4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7711d0() {
    // IDA 0x7711d0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7711f4() {
    // IDA 0x7711f4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771218() {
    // IDA 0x771218: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x77123c() {
    // IDA 0x77123c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x77127c() {
    // IDA 0x77127c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7712a0() {
    // IDA 0x7712a0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771394() {
    // IDA 0x771394: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771488() {
    // IDA 0x771488: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7714ac() {
    // IDA 0x7714ac: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7714d0() {
    // IDA 0x7714d0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771510() {
    // IDA 0x771510: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771534() {
    // IDA 0x771534: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771658() {
    // IDA 0x771658: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771778() {
    // IDA 0x771778: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7717a4() {
    // IDA 0x7717a4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7717e0() {
    // IDA 0x7717e0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771824() {
    // IDA 0x771824: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771848() {
    // IDA 0x771848: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x77186c() {
    // IDA 0x77186c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771890() {
    // IDA 0x771890: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7718b8() {
    // IDA 0x7718b8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7718e0() {
    // IDA 0x7718e0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x771908() {
    // IDA 0x771908: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7740e8() -> ! {
    todo!("0x7740e8 boost::shared_ptr<RBX::Instance> RBX::Reflection::Variant::get<boost::shared_ptr<RBX::Instance>>(void)const")
}
...
pub fn stub_0x774ebc() {
    // IDA 0x774ebc: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x775e84() -> ! {
    todo!("0x775e84 rbx::implementation::typed_holder<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>::singleton(void)")
}
...
pub fn stub_0x775ef0() -> ! {
    todo!("0x775ef0 rbx::implementation::typed_holder<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>::construct_func(char const*,char *)")
}
...
pub fn stub_0x776704() -> ! {
    todo!("0x776704 boost::_bi::list3<boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::arg<1>>::list3(boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::arg<1>)")
}
...
pub fn stub_0x776824() -> ! {
    todo!("0x776824 boost::_bi::storage3<boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::arg<1>>::storage3(boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::arg<1>)")
}
...
pub fn stub_0x776944() -> ! {
    todo!("0x776944 boost::_bi::storage2<boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>>::storage2(boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>)")
}
...
pub fn stub_0x778d94() -> ! {
    todo!("0x778d94 boost::_bi::list4<boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::_bi::value<int>,boost::arg<1>>::list4(boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::_bi::value<int>,boost::arg<1>)")
}
...
pub fn stub_0x778ebc() -> ! {
    todo!("0x778ebc boost::_bi::storage4<boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::_bi::value<int>,boost::arg<1>>::storage4(boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::_bi::value<int>,boost::arg<1>)")
}
...
pub fn stub_0x778fe4() -> ! {
    todo!("0x778fe4 boost::_bi::storage3<boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::_bi::value<int>>::storage3(boost::_bi::value<std::string>,boost::reference_wrapper<RBX::Reflection::Variant const>,boost::_bi::value<int>)")
}
...
pub fn stub_0x779360() -> ! {
    todo!("0x779360 boost::function2<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>,lua_State *,lua_Debug *>::operator()(lua_State *,lua_Debug *)const")
}
...
pub fn stub_0x779668() -> ! {
    todo!("0x779668 void RBX::Scripting::ScriptDebugger::withPausedThreadHook<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>(lua_State *,lua_Debug *,boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>,boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>&,boost::shared_ptr<std::string> &)")
}
...
pub fn stub_0x779a2c() -> ! {
    todo!("0x779a2c boost::_bi::list6<boost::_bi::value<RBX::Scripting::ScriptDebugger *>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>>,boost::reference_wrapper<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>,boost::reference_wrapper<boost::shared_ptr<std::string>>>::list6(boost::_bi::value<RBX::Scripting::ScriptDebugger *>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>>,boost::reference_wrapper<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>,boost::reference_wrapper<boost::shared_ptr<std::string>>)")
}
...
pub fn stub_0x779b00() -> ! {
    todo!("0x779b00 boost::_bi::storage6<boost::_bi::value<RBX::Scripting::ScriptDebugger *>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>>,boost::reference_wrapper<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>,boost::reference_wrapper<boost::shared_ptr<std::string>>>::storage6(boost::_bi::value<RBX::Scripting::ScriptDebugger *>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>>,boost::reference_wrapper<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>,boost::reference_wrapper<boost::shared_ptr<std::string>>)")
}
...
pub fn stub_0x77a0b8() -> ! {
    todo!("0x77a0b8 bool boost::detail::function::basic_vtable2<void,lua_State *,lua_Debug *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf5<void,RBX::Scripting::ScriptDebugger,lua_State *,lua_Debug *,boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>,boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>&,boost::shared_ptr<std::string> &>,boost::_bi::list6<boost::_bi::value<RBX::Scripting::ScriptDebugger*>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>>,boost::reference_wrapper<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>,boost::reference_wrapper<boost::shared_ptr<std::string>>>>>(boost::_bi::bind_t<void,boost::_mfi::mf5<void,RBX::Scripting::ScriptDebugger,lua_State *,lua_Debug *,boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>,boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>&,boost::shared_ptr<std::string> &>,boost::_bi::list6<boost::_bi::value<RBX::Scripting::ScriptDebugger*>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(lua_State *,lua_Debug *)>>,boost::reference_wrapper<boost::shared_ptr<std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>>,boost::reference_wrapper<boost::shared_ptr<std::string>>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")
}
