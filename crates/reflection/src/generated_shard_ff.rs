// Auto-generated shard FF — 150 RBX::Reflection stubs EA-sorted asc 0x782110..0x7be6b4 (demangled contains RBX::Reflection, 16171 total, 9148 covered -> 9298 after, 6873 remaining)
// Source: ida/export.json (85545 funcs) filtered demangled contains RBX::Reflection, EA asc not in crates/reflection/src/*.rs
...
pub fn stub_0x78291c() {
    // IDA 0x78291c: non-virtual thunk to `RBX::Reflection::RefPropDescriptor<RBX::Scripting::ScriptDebugger,RBX::Script>::assignIDREF( int a1, int a2, int a3, int a4,` — this/arg-adjust + tail-call (arg a1 -= 40) (decompiled). Rust uses static dispatch; no thunk needed. Target unmodeled: cutover no-op.
}
