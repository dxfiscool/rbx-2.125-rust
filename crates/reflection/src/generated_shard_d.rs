// Auto-generated shard D — next 100 RBX::Reflection stubs — EA-sorted after 0x6404ac
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 7300 stubbed -> 8871 remaining, showing next 100)
...
pub fn stub_0x6404b0() -> bool {
    // IDA 0x6404b0: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x6404b4() -> ! {
    todo!("0x6404b4 RBX::Reflection::PropDescriptor<RBX::SpawnLocation,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::SpawnLocation::*)(void)const,void (RBX::SpawnLocation::*)(RBX::BrickColor)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x6404dc() -> ! {
    todo!("0x6404dc RBX::Reflection::PropDescriptor<RBX::SpawnLocation,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::SpawnLocation::*)(void)const,void (RBX::SpawnLocation::*)(RBX::BrickColor)>::setValue(RBX::Reflection::DescribedBase *,RBX::BrickColor const&)const")
}
...
pub fn stub_0x640500() -> ! {
    todo!("0x640500 RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundProp<RBX::SpawnLocation>(char const*,char const*,bool RBX::SpawnLocation::*,void (RBX::SpawnLocation::*)(RBX::Reflection::PropertyDescriptor const&),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x640694() -> bool {
    // IDA 0x640694: BoundPropGetSet::isReadOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x640698() -> bool {
    // IDA 0x640698: BoundPropGetSet::isWriteOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x640a18() -> bool {
    // IDA 0x640a18: BoundPropGetSet::isReadOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x640a1c() -> bool {
    // IDA 0x640a1c: BoundPropGetSet::isWriteOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x642348() {
    // IDA 0x642348: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x642cdc() {
    // IDA 0x642cdc: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x6441a8() {
    // IDA 0x6441a8: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x6441b8() {
    // IDA 0x6441b8: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x644384() -> bool {
    // IDA 0x644384: EnumPropDescriptor::hasStringValue -- hardcoded `return 1` (decompiled 0x10244/0x10dc8/0x11650).
    true
}
...
pub fn stub_0x6447f4() -> bool {
    // IDA 0x6447f4: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x6447f8() -> bool {
    // IDA 0x6447f8: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x645080() -> ! {
    todo!("0x645080 RBX::Stats::StatsService::report(std::string,boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)")
}
...
pub fn stub_0x645d6c() -> ! {
    todo!("0x645d6c RBX::Stats::JsonWriter::writeTableEntries(boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const&)")
}
...
pub fn stub_0x645db0() -> ! {
    todo!("0x645db0 RBX::Stats::JsonWriter::writeTableEntry(std::pair<std::string,RBX::Reflection::Variant> const&)")
}
...
pub fn stub_0x645de8() -> ! {
    todo!("0x645de8 RBX::Stats::JsonWriter::writeArrayEntry(RBX::Reflection::Variant const&)")
}
...
pub fn stub_0x645e24() -> ! {
    todo!("0x645e24 RBX::Stats::JsonWriter::writeKeyValue(std::pair<std::string,RBX::Reflection::Variant> const&)")
}
...
pub fn stub_0x645fec() -> ! {
    todo!("0x645fec RBX::Stats::JsonWriter::writeValue(RBX::Reflection::Variant const&)")
}
...
pub fn stub_0x647730() -> ! {
    todo!("0x647730 RBX::Stats::StatsService::report(std::string,boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>,int)")
}
...
pub fn stub_0x6478e8() -> ! {
    todo!("0x6478e8 RBX::Stats::StatsService::report_BypassThrottlingAndCustomUrl(std::string,boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const&,char const*)")
}
...
pub fn stub_0x64a5c4() -> ! {
    todo!("0x64a5c4 boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::Stats::JsonWriter,std::pair const&<std::string,RBX::Reflection::Variant>>,boost::_bi::list2<boost::_bi::value<RBX::Stats::JsonWriter*>,boost::arg<1>>> std::for_each<boost::unordered::iterator_detail::c_iterator<boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>>,boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>> const*>,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::Stats::JsonWriter,std::pair const&<std::string,RBX::Reflection::Variant>>,boost::_bi::list2<boost::_bi::value<RBX::Stats::JsonWriter*>,boost::arg<1>>>>(boost::unordered::iterator_detail::c_iterator<boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>>,boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>> const*>,boost::unordered::iterator_detail::c_iterator<boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>>,boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Reflection::Variant>> const*>,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::Stats::JsonWriter,std::pair const&<std::string,RBX::Reflection::Variant>>,boost::_bi::list2<boost::_bi::value<RBX::Stats::JsonWriter*>,boost::arg<1>>>)")
}
...
pub fn stub_0x64a620() -> ! {
    todo!("0x64a620 boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::Stats::JsonWriter,RBX::Reflection::Variant const&>,boost::_bi::list2<boost::_bi::value<RBX::Stats::JsonWriter*>,boost::arg<1>>> std::for_each<__gnu_cxx::__normal_iterator<RBX::Reflection::Variant const*,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::Stats::JsonWriter,RBX::Reflection::Variant const&>,boost::_bi::list2<boost::_bi::value<RBX::Stats::JsonWriter*>,boost::arg<1>>>>(__gnu_cxx::__normal_iterator<RBX::Reflection::Variant const*,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>,__gnu_cxx::__normal_iterator<RBX::Reflection::Variant const*,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>>>,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::Stats::JsonWriter,RBX::Reflection::Variant const&>,boost::_bi::list2<boost::_bi::value<RBX::Stats::JsonWriter*>,boost::arg<1>>>)")
}

// 0x64a670 — __ZNK3RBX10Reflection4TypeeqERKS1_
#[doc(alias = "RBX::Reflection::Type::operator==(RBX::Reflection::Type const&)const")]
pub fn stub_0x64a670() -> ! {
    todo!("0x64a670 RBX::Reflection::Type::operator==(RBX::Reflection::Type const&)const")
}
...
pub fn stub_0x64a874() -> ! {
    todo!("0x64a874 boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> RBX::Reflection::Variant::get<boost::shared_ptr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const>>(void)const")
}
...
pub fn stub_0x64d120() {
    // IDA 0x64d120: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x64e580() {
    // IDA 0x64e580: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x64f240() {
    // IDA 0x64f240: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x64fe38() {
    // IDA 0x64fe38: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x650a30() {
    // IDA 0x650a30: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x65163c() {
    // IDA 0x65163c: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x651938() {
    // IDA 0x651938: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x651c74() -> ! {
    todo!("0x651c74 rbx::callable<rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::slot,boost::_bi::bind_t<bool,boost::_mfi::mf0<bool,RBX::Stats::StatsService>,boost::_bi::list1<boost::_bi::value<RBX::Stats::StatsService*>>>,1,void ()(RBX::Reflection::PropertyDescriptor const*)>::call(RBX::Reflection::PropertyDescriptor const*)")
}
...
pub fn stub_0x651c8c() {
    // IDA 0x651c8c: non-virtual thunk to `rbx::callable<rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::slot,boost::_bi::bind_t<bool,boost::_mfi::mf0<bool,RBX::Stats::StatsSer` — this/arg-adjust + tail-call (decompiled). Rust uses static dispatch; no thunk needed. Target unmodeled: cutover no-op.
}
...
pub fn stub_0x651ca8() -> ! {
    todo!("0x651ca8 rbx::signals::signal<void ()(RBX::Reflection::PropertyDescriptor const*)>::slot::safe_static_do_get_mutex(void)")
}
