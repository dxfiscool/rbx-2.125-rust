//! Auto-generated refl 24 — 100 stubs EA-sorted asc 0x230e78..0x2376a4 (global gap filler, RBX::Reflection exhausted 19829/19829, crate-local gaps 57763->57663 , rbx_core::SharedPtr not boost, // 0xADDR mangled + doc alias + todo)
...
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsSsESt10_Select1stIS2_ESt4lessISsESaIS2_EE4findERS1_")]
pub fn stub_0x232bf4() -> ! {
    todo!("0x232bf4 std::_Rb_tree<std::string,std::pair<std::string const,std::string>,std::_Select1st<std::pair<std::string const,std::string>>,std::less<std::string>,std::allocator<std::pair<std::string const,std::string>>>::find(std::string const&)")
}
...
#[doc(alias = "__ZN3OIS16iPhoneMultiTouch15_touchCancelledEP7UITouch")]
pub fn stub_0x232c6c() -> ! {
    todo!("0x232c6c OIS::iPhoneMultiTouch::_touchCancelled(UITouch *)")
}

// 0x232dbc — __ZN3OIS16iPhoneMultiTouch11_touchMovedEP7UITouch
// type: int __fastcall(OIS::iPhoneMultiTouch *this, UITouch *)
#[doc(alias = "OIS::iPhoneMultiTouch::_touchMoved(UITouch *)")]
#[doc(alias = "__ZN3OIS16iPhoneMultiTouch11_touchMovedEP7UITouch")]
pub fn stub_0x232dbc() -> ! {
    todo!("0x232dbc OIS::iPhoneMultiTouch::_touchMoved(UITouch *)")
}

// 0x232f58 — __ZN3OIS16iPhoneMultiTouch11_touchEndedEP7UITouch
// type: int __fastcall(OIS::iPhoneMultiTouch *this, UITouch *)
#[doc(alias = "OIS::iPhoneMultiTouch::_touchEnded(UITouch *)")]
#[doc(alias = "__ZN3OIS16iPhoneMultiTouch11_touchEndedEP7UITouch")]
pub fn stub_0x232f58() -> ! {
    todo!("0x232f58 OIS::iPhoneMultiTouch::_touchEnded(UITouch *)")
}

// 0x2330a8 — __ZN3OIS16iPhoneMultiTouch11_touchBeganEP7UITouch
// type: int __fastcall(OIS::iPhoneMultiTouch *this, UITouch *)
#[doc(alias = "OIS::iPhoneMultiTouch::_touchBegan(UITouch *)")]
#[doc(alias = "__ZN3OIS16iPhoneMultiTouch11_touchBeganEP7UITouch")]
pub fn stub_0x2330a8() -> ! {
    todo!("0x2330a8 OIS::iPhoneMultiTouch::_touchBegan(UITouch *)")
}
...
#[doc(alias = "__ZNKSt6vectorIN3OIS15MultiTouchStateESaIS1_EE4sizeEv")]
pub fn stub_0x2331f8() -> ! {
    todo!("0x2331f8 std::vector<OIS::MultiTouchState,std::allocator<OIS::MultiTouchState>>::size(void)const")
}
...
#[doc(alias = "__ZSt18uninitialized_copyIPN3OIS15MultiTouchStateES2_ET0_T_S4_S3_")]
pub fn stub_0x233214() -> ! {
    todo!("0x233214 OIS::MultiTouchState * std::uninitialized_copy<OIS::MultiTouchState *,OIS::MultiTouchState *>(OIS::MultiTouchState *,OIS::MultiTouchState *,OIS::MultiTouchState *)")
}
...
#[doc(alias = "__ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3OIS15MultiTouchStateES5_EET0_T_S7_S6_")]
pub fn stub_0x23344c() -> ! {
    todo!("0x23344c OIS::MultiTouchState * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<OIS::MultiTouchState *,OIS::MultiTouchState *>(OIS::MultiTouchState *,OIS::MultiTouchState *,OIS::MultiTouchState *)")
}
...
#[doc(alias = "__ZN9__gnu_cxx13new_allocatorIN3OIS15MultiTouchStateEE8allocateEmPKv")]
pub fn stub_0x2336a0() -> ! {
    todo!("0x2336a0 __gnu_cxx::new_allocator<OIS::MultiTouchState>::allocate(unsigned long,void const*)")
}

// 0x2336d0 — __ZN3OIS15MultiTouchStateC2Ev
// type: int __fastcall(int this)
#[doc(alias = "OIS::MultiTouchState::MultiTouchState(void)")]
#[doc(alias = "__ZN3OIS15MultiTouchStateC2Ev")]
pub fn stub_0x2336d0() -> ! {
    todo!("0x2336d0 OIS::MultiTouchState::MultiTouchState(void)")
}
...
#[doc(alias = "__ZNSt6vectorIN3OIS15MultiTouchStateESaIS1_EE13_M_insert_auxEN9__gnu_cxx17__normal_iteratorIPS1_S3_EERKS1_")]
pub fn stub_0x233714() -> ! {
    todo!("0x233714 std::vector<OIS::MultiTouchState,std::allocator<OIS::MultiTouchState>>::_M_insert_aux(__gnu_cxx::__normal_iterator<OIS::MultiTouchState*,std::vector<OIS::MultiTouchState,std::allocator<OIS::MultiTouchState>>>,OIS::MultiTouchState const&)")
}
...
#[doc(alias = "__ZNSt6vectorIN3OIS15MultiTouchStateESaIS1_EE9push_backERKS1_")]
pub fn stub_0x233920() -> ! {
    todo!("0x233920 std::vector<OIS::MultiTouchState,std::allocator<OIS::MultiTouchState>>::push_back(OIS::MultiTouchState const&)")
}
...
pub fn stub_0x235884() -> ! {
    todo!("0x235884 boost::detail::get_once_per_thread_epoch(void)")
}

// 0x2358d0 — _create_epoch_tss_key
#[doc(alias = "_create_epoch_tss_key")]
pub fn stub_0x2358d0() -> ! {
    todo!("0x2358d0 _create_epoch_tss_key")
}

// 0x2358f0 — _delete_epoch_tss_data
// type: void __fastcall(void *)
#[doc(alias = "_delete_epoch_tss_data")]
pub fn stub_0x2358f0() -> ! {
    todo!("0x2358f0 _delete_epoch_tss_data")
}
...
pub fn stub_0x235d7c() -> ! {
    todo!("0x235d7c boost::detail::get_current_thread_data(void)")
}
...
pub fn stub_0x235dc4() -> ! {
    todo!("0x235dc4 boost::thread::start_thread_noexcept(void)")
}
...
pub fn stub_0x235e8c() -> ! {
    todo!("0x235e8c _thread_proxy")
}
...
pub fn stub_0x2360c4() -> ! {
    todo!("0x2360c4 boost::thread::join_noexcept(void)")
}
...
pub fn stub_0x236318() -> ! {
    todo!("0x236318 boost::thread::do_try_join_until_noexcept(timespec const&,bool &)")
}
...
pub fn stub_0x236598() -> ! {
    todo!("0x236598 boost::thread::detach(void)")
}
...
pub fn stub_0x2366b0() -> ! {
    todo!("0x2366b0 boost::this_thread::hiden::sleep_until(timespec const&)")
}
...
pub fn stub_0x2368cc() -> ! {
    todo!("0x2368cc boost::thread::native_handle(void)")
}
...
pub fn stub_0x236a00() -> ! {
    todo!("0x236a00 boost::this_thread::interruption_point(void)")
}
...
pub fn stub_0x236b14() -> ! {
    todo!("0x236b14 boost::this_thread::disable_interruption::disable_interruption(void)")
}
...
pub fn stub_0x236f30() -> ! {
    todo!("0x236f30 boost::detail::add_new_tss_node(void const*,rbx_core::SharedPtr<boost::detail::tss_cleanup_function>,void *)")
}
...
pub fn stub_0x237130() -> ! {
    todo!("0x237130 boost::detail::set_tss_data(void const*,rbx_core::SharedPtr<boost::detail::tss_cleanup_function>,void *,bool)")
}
...
pub fn stub_0x2374bc() -> ! {
    todo!("0x2374bc rbx_core::SharedPtr<boost::detail::thread_data_base>::operator=(rbx_core::SharedPtr<boost::detail::thread_data_base> const&)")
}
...
pub fn stub_0x2375b0() -> ! {
    todo!("0x2375b0 rbx_core::SharedPtr<boost::detail::tss_cleanup_function>::operator=(rbx_core::SharedPtr<boost::detail::tss_cleanup_function> const&)")
}
