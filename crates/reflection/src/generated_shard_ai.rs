// Auto-generated shard AI — next 120 RBX::Reflection stubs — EA-sorted after 0x877748
// Source: ida/export.json filtered mangled contains RBX10Reflection|demangled RBX::Reflection (19290 total, 10557 prior -> 10677 total, EA-sorted after 0x877748, rbx_core::SharedPtr not boost)
...
pub fn stub_886cb8() {
    // IDA 0x886cb8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886cdc() {
    // IDA 0x886cdc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886d00() {
    // IDA 0x886d00: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886d40() {
    // IDA 0x886d40: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886d64() {
    // IDA 0x886d64: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886da4() {
    // IDA 0x886da4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886df4() {
    // IDA 0x886df4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_886e34() {
    // IDA 0x886e34: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88a8bc() {
    // IDA 0x88a8bc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88a8c0() {
    // IDA 0x88a8c0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88a960() {
    // IDA 0x88a960: __ZThn32 thunk (D1 base dtor): `this -= 32`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88a968() {
    // IDA 0x88a968: __ZThn32 thunk (D0 deleting dtor): `this -= 32`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88aa0c() {
    // IDA 0x88aa0c: __ZThn36 thunk (D1 base dtor): `this -= 36`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88aa14() {
    // IDA 0x88aa14: __ZThn36 thunk (D0 deleting dtor): `this -= 36`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88adb4() {
    // IDA 0x88adb4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88adb8() {
    // IDA 0x88adb8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88ae58() {
    // IDA 0x88ae58: __ZThn32 thunk (D1 base dtor): `this -= 32`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88ae60() {
    // IDA 0x88ae60: __ZThn32 thunk (D0 deleting dtor): `this -= 32`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88af04() {
    // IDA 0x88af04: __ZThn36 thunk (D1 base dtor): `this -= 36`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88af0c() {
    // IDA 0x88af0c: __ZThn36 thunk (D0 deleting dtor): `this -= 36`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b504() {
    // IDA 0x88b504: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88b508() {
    // IDA 0x88b508: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b5a8() {
    // IDA 0x88b5a8: __ZThn32 thunk (D1 base dtor): `this -= 32`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88b5b0() {
    // IDA 0x88b5b0: __ZThn32 thunk (D0 deleting dtor): `this -= 32`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b654() {
    // IDA 0x88b654: __ZThn36 thunk (D1 base dtor): `this -= 36`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88b65c() {
    // IDA 0x88b65c: __ZThn36 thunk (D0 deleting dtor): `this -= 36`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b700() {
    // IDA 0x88b700: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88b704() {
    // IDA 0x88b704: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b7a4() {
    // IDA 0x88b7a4: __ZThn32 thunk (D1 base dtor): `this -= 32`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88b7ac() {
    // IDA 0x88b7ac: __ZThn32 thunk (D0 deleting dtor): `this -= 32`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b850() {
    // IDA 0x88b850: __ZThn36 thunk (D1 base dtor): `this -= 36`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88b858() {
    // IDA 0x88b858: __ZThn36 thunk (D0 deleting dtor): `this -= 36`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88b8fc() {
    // IDA 0x88b8fc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
// was: RBX::Reflection::EventDescImpl<0,RBX::Button,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Button::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
...
pub fn stub_88b9b0() -> ! {
    todo!("0x88b9b0 RBX::Reflection::EventDescImpl<0,RBX::Button,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Button::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_88bbb4() -> ! {
    todo!("0x88bbb4 RBX::Reflection::EventDescImpl<0,RBX::Button,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Button::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}
...
pub fn stub_88bc28() -> ! {
    todo!("0x88bc28 RBX::Reflection::EventDescBase<RBX::Button,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Button::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}
...
pub fn stub_88bc3c() -> ! {
    todo!("0x88bc3c RBX::Reflection::BoundFuncDesc<RBX::Button,void ()(bool),1>::BoundFuncDesc(void (RBX::Button::*)(bool),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_88bdb4() -> ! {
    todo!("0x88bdb4 RBX::Reflection::BoundFuncDesc<RBX::Button,void ()(bool),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_88bde4() {
    // IDA 0x88bde4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88beb8() -> ! {
    todo!("0x88beb8 RBX::Reflection::BoundFuncDesc<RBX::Button,void ()(bool),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_88c16c() {
    // IDA 0x88c16c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88c8f0() {
    // IDA 0x88c8f0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88cc7c() {
    // IDA 0x88cc7c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
// was: RBX::Reflection::EventDescImpl<0,RBX::Plugin,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Plugin::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
...
pub fn stub_88cd30() -> ! {
    todo!("0x88cd30 RBX::Reflection::EventDescImpl<0,RBX::Plugin,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Plugin::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_88d164() {
    // IDA 0x88d164: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88d370() {
    // IDA 0x88d370: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88d634() {
    // IDA 0x88d634: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88f5f0() {
    // IDA 0x88f5f0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88f5f4() {
    // IDA 0x88f5f4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88f694() {
    // IDA 0x88f694: __ZThn32 thunk (D1 base dtor): `this -= 32`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_88f69c() {
    // IDA 0x88f69c: __ZThn32 thunk (D0 deleting dtor): `this -= 32`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_88f740() {
    // IDA 0x88f740: __ZThn36 thunk (D1 base dtor): `this -= 36`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_8927b0() -> ! {
    todo!("0x8927b0 __ZN3RBX10ReflectionL14resume_adapterISsEEvN5boost8functionIFvNS0_7VariantEEEET__1")
}
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EED1Ev")]
pub fn stub_892908() {
    // IDA 0x892908: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvN5boost10shared_ptrINS_8InstanceEEEELi1EED1Ev")]
pub fn stub_892948() {
    // IDA 0x892948: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection18BoundYieldFuncDescINS_21PersonalServerServiceEFSsiESsLi1EED1Ev")]
pub fn stub_892a54() {
    // IDA 0x892a54: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsED1Ev")]
pub fn stub_892aa8() {
    // IDA 0x892aa8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_89379c() {
    // IDA 0x89379c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_8937a0() {
    // IDA 0x8937a0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_893840() {
    // IDA 0x893840: __ZThn32 thunk (D1 base dtor): `this -= 32`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_893848() {
    // IDA 0x893848: __ZThn32 thunk (D0 deleting dtor): `this -= 32`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_8938ec() {
    // IDA 0x8938ec: __ZThn36 thunk (D1 base dtor): `this -= 36`, run base-object dtor in place (cf. decompiled 0x6d2e50). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_8938f4() {
    // IDA 0x8938f4: __ZThn36 thunk (D0 deleting dtor): `this -= 36`, run complete-object dtor, `operator delete` (cf. decompiled 0xfb5c). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsEC2IMS2_KFSsvEMS2_FvSsEEEPKcSA_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")]
pub fn stub_893e88() -> ! {
    todo!("0x893e88 RBX::Reflection::PropDescriptor<RBX::PersonalServerService,std::string>::PropDescriptor<std::string (RBX::PersonalServerService::*)(void)const,void (RBX::PersonalServerService::*)(std::string)>(char const*,char const*,std::string (RBX::PersonalServerService::*)(void)const,void (RBX::PersonalServerService::*)(std::string),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x893f9c — __ZN3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PersonalServerService,std::string>::~PropDescriptor()")]
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsED0Ev")]
pub fn stub_893f9c() {
    // IDA 0x893f9c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PersonalServerService,std::string>::GetSetImpl<std::string (RBX::PersonalServerService::*)(void)const,void (RBX::PersonalServerService::*)(std::string)>::getValue(RBX::Reflection::DescribedBase const*)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsE10GetSetImplIMS2_KFSsvEMS2_FvSsEE8getValueEPKNS0_13DescribedBaseE")]
pub fn stub_893fd0() -> ! {
    todo!("0x893fd0 RBX::Reflection::PropDescriptor<RBX::PersonalServerService,std::string>::GetSetImpl<std::string (RBX::PersonalServerService::*)(void)const,void (RBX::PersonalServerService::*)(std::string)>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x893ff8 — __ZNK3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsE10GetSetImplIMS2_KFSsvEMS2_FvSsEE8setValueEPNS0_13DescribedBaseERKSs
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::PersonalServerService,std::string>::GetSetImpl<std::string (RBX::PersonalServerService::*)(void)const,void (RBX::PersonalServerService::*)(std::string)>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")]
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_21PersonalServerServiceESsE10GetSetImplIMS2_KFSsvEMS2_FvSsEE8setValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_893ff8() -> ! {
    todo!("0x893ff8 RBX::Reflection::PropDescriptor<RBX::PersonalServerService,std::string>::GetSetImpl<std::string (RBX::PersonalServerService::*)(void)const,void (RBX::PersonalServerService::*)(std::string)>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
#[doc(alias = "__ZN3RBX10Reflection18BoundYieldFuncDescINS_21PersonalServerServiceEFSsiESsLi1EEC2EMS2_FviN5boost8functionIFvSsEEES8_EPKcSC_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_89413c() -> ! {
...
#[doc(alias = "__ZN3RBX10Reflection18BoundYieldFuncDescINS_21PersonalServerServiceEFSsiESsLi1EE16declareSignatureEPKcNS0_7VariantE")]
pub fn stub_8942b4() -> ! {
...
#[doc(alias = "RBX::Reflection::BoundYieldFuncDesc<RBX::PersonalServerService,std::string ()(int),std::string,1>::~BoundYieldFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection18BoundYieldFuncDescINS_21PersonalServerServiceEFSsiESsLi1EED0Ev")]
pub fn stub_8942e4() {
    // IDA 0x8942e4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZNK3RBX10Reflection18BoundYieldFuncDescINS_21PersonalServerServiceEFSsiESsLi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsEN5boost8functionIFvNS0_7VariantEEEENSB_IFvSsEEE")]
pub fn stub_8943b8() -> ! {
    todo!("0x8943b8 RBX::Reflection::BoundYieldFuncDesc<RBX::PersonalServerService,std::string ()(int),std::string,1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &,boost::function<void ()(RBX::Reflection::Variant)>,boost::function<void ()(std::string)>)const")
}
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvN5boost10shared_ptrINS_8InstanceEEEELi1EEC2EMS2_FvS6_EPKcSC_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_894558() -> ! {
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvN5boost10shared_ptrINS_8InstanceEEEELi1EE16declareSignatureEPKcNS0_7VariantE")]
pub fn stub_8946f0() -> ! {
...
// was: RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(boost::shared_ptr<RBX::Instance>),1>::~BoundFuncDesc()
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(rbx_core::SharedPtr<RBX::Instance>),1>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvN5boost10shared_ptrINS_8InstanceEEEELi1EED0Ev")]
pub fn stub_894720() {
    // IDA 0x894720: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvN5boost10shared_ptrINS_8InstanceEEEELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_89483c() -> ! {
...
#[doc(alias = "__ZN3RBX10Reflection11Call1HelperINS_21PersonalServerServiceEMS2_FvN5boost10shared_ptrINS_8InstanceEEEES6_vE4callEPS2_S8_RNS0_7VariantERKS6_")]
pub fn stub_894920() -> ! {
    todo!("0x894920 RBX::Reflection::Call1Helper<RBX::PersonalServerService,void (RBX::PersonalServerService::*)(rbx_core::SharedPtr<RBX::Instance>),rbx_core::SharedPtr<RBX::Instance>,void>::call(RBX::PersonalServerService*,void (RBX::PersonalServerService::*)(rbx_core::SharedPtr<RBX::Instance>),RBX::Reflection::Variant &,rbx_core::SharedPtr<RBX::Instance> const&)")
}

// 0x894a08 — __ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EEC2EMS2_FvSsEPKcS8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EEC2EMS2_FvSsEPKcS8_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_894a08() -> ! {
    todo!("0x894a08 RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(std::string),1>::BoundFuncDesc(void (RBX::PersonalServerService::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}

// 0x894b80 — __ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EE16declareSignatureEPKcNS0_7VariantE
...
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EE16declareSignatureEPKcNS0_7VariantE")]
pub fn stub_894b80() -> ! {
    todo!("0x894b80 RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}

// 0x894bb0 — __ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(std::string),1>::~BoundFuncDesc()")]
#[doc(alias = "__ZN3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EED0Ev")]
pub fn stub_894bb0() {
    // IDA 0x894bb0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")]
#[doc(alias = "__ZNK3RBX10Reflection13BoundFuncDescINS_21PersonalServerServiceEFvSsELi1EE7executeEPNS0_13DescribedBaseERNS0_18FunctionDescriptor9ArgumentsE")]
pub fn stub_894c7c() -> ! {
    todo!("0x894c7c RBX::Reflection::BoundFuncDesc<RBX::PersonalServerService,void ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}

// 0x894db8 — __ZN3RBX10Reflection11Call1HelperINS_21PersonalServerServiceEMS2_FvSsESsvE4callEPS2_S4_RNS0_7VariantERKSs
...
#[doc(alias = "__ZN3RBX10Reflection11Call1HelperINS_21PersonalServerServiceEMS2_FvSsESsvE4callEPS2_S4_RNS0_7VariantERKSs")]
pub fn stub_894db8() -> ! {
    todo!("0x894db8 RBX::Reflection::Call1Helper<RBX::PersonalServerService,void (RBX::PersonalServerService::*)(std::string),std::string,void>::call(RBX::PersonalServerService*,void (RBX::PersonalServerService::*)(std::string),RBX::Reflection::Variant &,std::string const&)")
}

// 0x897480 — __ZN3RBX10Reflection4Type12getSingletonINS_6CellIDEEERKS1_v
#[doc(alias = "RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::CellID>(void)")]
#[doc(alias = "__ZN3RBX10Reflection4Type12getSingletonINS_6CellIDEEERKS1_v")]
pub fn stub_897480() -> ! {
    todo!("0x897480 RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::CellID>(void)")
}

// 0x89768c — __ZN3RBX10Reflection5TTypeINS_6CellIDEED1Ev
#[doc(alias = "RBX::Reflection::TType<RBX::CellID>::~TType()")]
#[doc(alias = "__ZN3RBX10Reflection5TTypeINS_6CellIDEED1Ev")]
pub fn stub_89768c() {
    // IDA 0x89768c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection4TypeC2INS_6CellIDEEEPKcPT_")]
pub fn stub_897690() -> ! {
    todo!("0x897690 RBX::Reflection::Type::Type<RBX::CellID>(char const*,RBX::CellID *)")
}

// 0x89773c — __ZN3RBX10Reflection5TTypeINS_6CellIDEED0Ev
#[doc(alias = "RBX::Reflection::TType<RBX::CellID>::~TType()")]
#[doc(alias = "__ZN3RBX10Reflection5TTypeINS_6CellIDEED0Ev")]
pub fn stub_89773c() {
    // IDA 0x89773c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}

// 0x8978d8 — __ZN3RBX10Reflection4Type12getSingletonINS_12Region3int16EEERKS1_v
#[doc(alias = "RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Region3int16>(void)")]
#[doc(alias = "__ZN3RBX10Reflection4Type12getSingletonINS_12Region3int16EEERKS1_v")]
pub fn stub_8978d8() -> ! {
    todo!("0x8978d8 RBX::Reflection::Type const& RBX::Reflection::Type::getSingleton<RBX::Region3int16>(void)")
}

// 0x8979fc — __ZN3RBX10Reflection5TTypeINS_12Region3int16EED1Ev
#[doc(alias = "RBX::Reflection::TType<RBX::Region3int16>::~TType()")]
#[doc(alias = "__ZN3RBX10Reflection5TTypeINS_12Region3int16EED1Ev")]
pub fn stub_8979fc() {
    // IDA 0x8979fc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection4TypeC2INS_12Region3int16EEEPKcPT_")]
pub fn stub_897a00() -> ! {
    todo!("0x897a00 RBX::Reflection::Type::Type<RBX::Region3int16>(char const*,RBX::Region3int16 *)")
}
