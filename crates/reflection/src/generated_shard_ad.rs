// Auto-generated shard AD — next 100 RBX::Reflection stubs — EA-sorted after 0x845a1c
// Source: ida/export.json filtered mangled contains 10Reflection (19808 total, 10080 stubbed -> 10180 total, showing next 100)
...
pub fn stub_0x845bd4() -> ! {
    todo!("0x845bd4 void boost::_bi::list4<boost::_bi::value<rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>,boost::arg<3>>::operator()<boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,int const&,int const&,RBX::FriendService::FriendStatus const&>,boost::_bi::list3<int &,int &,RBX::FriendService::FriendStatus&>>(boost::_bi::type<void>,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,int const&,int const&,RBX::FriendService::FriendStatus const&> &,boost::_bi::list3<int &,int &,RBX::FriendService::FriendStatus&> &,int)")
}
...
pub fn stub_0x84672c() {
    // IDA 0x84672c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x846750() {
    // IDA 0x846750: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x846804() {
    // IDA 0x846804: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x847374() -> ! {
    todo!("0x847374 void boost::_bi::list4<boost::_bi::value<rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>,boost::arg<3>>::operator()<boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,int const&,int const&,RBX::FriendService::FriendEventType const&>,boost::_bi::list3<int &,int &,RBX::FriendService::FriendEventType&>>(boost::_bi::type<void>,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,int const&,int const&,RBX::FriendService::FriendEventType const&> &,boost::_bi::list3<int &,int &,RBX::FriendService::FriendEventType&> &,int)")
}
...
pub fn stub_0x847ecc() {
    // IDA 0x847ecc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x847ef0() {
    // IDA 0x847ef0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84814c() {
    // IDA 0x84814c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x8483fc() {
    // IDA 0x8483fc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x849f94() {
    // IDA 0x849f94: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x849fbc() {
    // IDA 0x849fbc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection18EnumPropDescriptorINS_17GameBasicSettingsENS2_20RenderQualitySettingEED1Ev")]
pub fn stub_0x849fe4() {
    // IDA 0x849fe4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84a008() {
    // IDA 0x84a008: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84a048() {
    // IDA 0x84a048: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84a090() {
    // IDA 0x84a090: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84a0bc() {
    // IDA 0x84a0bc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84a114() {
    // IDA 0x84a114: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84a140() {
    // IDA 0x84a140: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection8EnumDescINS_17GameBasicSettings11ControlModeEE7addPairES3_PKc")]
pub fn stub_0x84a164(desc: &mut crate::enum_desc::EnumDesc, value: i32, name: &str) {
    // IDA 0x84a164: EnumDesc<T>::addPair -- ReleaseAssert(value<=2304), push Item, grow tables (decompiled 0x9b48/0x64154c). Delegates to the shared model.
...
#[doc(alias = "__ZN3RBX10Reflection8EnumDescINS_17GameBasicSettings20RenderQualitySettingEE7addPairES3_PKc")]
pub fn stub_0x84a4c4(desc: &mut crate::enum_desc::EnumDesc, value: i32, name: &str) {
    // IDA 0x84a4c4: EnumDesc<T>::addPair -- ReleaseAssert(value<=2304), push Item, grow tables (decompiled 0x9b48/0x64154c). Delegates to the shared model.
    desc.add_pair(value, name)
}
...
pub fn stub_0x84b91c() {
    // IDA 0x84b91c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84b920() {
    // IDA 0x84b920: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection9EventDescINS_17GameBasicSettingsEFvbEN3rbx6signalIS3_EEMS2_S6_EC2ES7_PKcSA_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x84c4f8() -> ! {
    todo!("0x84c4f8 RBX::Reflection::EventDesc<RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::EventDesc(rbx::signal<void ()(bool)> RBX::GameBasicSettings::*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x84c67c() {
    // IDA 0x84c67c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")]
#[doc(alias = "__ZNK3RBX10Reflection13EventDescImplILi1ENS_17GameBasicSettingsEFvbEN3rbx6signalIS3_EEMS2_S6_E14connectGenericEPNS0_11EventSourceEN5boost10shared_ptrINS0_18GenericSlotWrapperEEE")]
pub fn stub_0x84c730() -> ! {
    todo!("0x84c730 RBX::Reflection::EventDescImpl<1,RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}

// 0x84c884 — __ZNK3RBX10Reflection13EventDescImplILi1ENS_17GameBasicSettingsEFvbEN3rbx6signalIS3_EEMS2_S6_E9fireEventEPNS0_11EventSourceERKSt6vectorINS0_7VariantESaISC_EE
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")]
#[doc(alias = "__ZNK3RBX10Reflection13EventDescImplILi1ENS_17GameBasicSettingsEFvbEN3rbx6signalIS3_EEMS2_S6_E9fireEventEPNS0_11EventSourceERKSt6vectorINS0_7VariantESaISC_EE")]
pub fn stub_0x84c884() -> ! {
    todo!("0x84c884 RBX::Reflection::EventDescImpl<1,RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}

// 0x84c910 — __ZNK3RBX10Reflection13EventDescBaseINS_17GameBasicSettingsEFvbEN3rbx6signalIS3_EEMS2_S6_E13disconnectAllEPNS0_11EventSourceE
#[doc(alias = "RBX::Reflection::EventDescBase<RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::disconnectAll(RBX::Reflection::EventSource *)const")]
#[doc(alias = "__ZNK3RBX10Reflection13EventDescBaseINS_17GameBasicSettingsEFvbEN3rbx6signalIS3_EEMS2_S6_E13disconnectAllEPNS0_11EventSourceE")]
pub fn stub_0x84c910() -> ! {
    todo!("0x84c910 RBX::Reflection::EventDescBase<RBX::GameBasicSettings,void ()(bool),rbx::signal<void ()(bool)>,rbx::signal<void ()(bool)> RBX::GameBasicSettings::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}
...
pub fn stub_0x84c924() -> ! {
    todo!("0x84c924 RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,bool ()(void),0>::BoundFuncDesc(bool (RBX::GameBasicSettings::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x84ca28() {
    // IDA 0x84ca28: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84cadc() -> ! {
    todo!("0x84cadc RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,bool ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x84cb00() -> ! {
    todo!("0x84cb00 RBX::Reflection::Call0Helper<RBX::GameBasicSettings,bool (RBX::GameBasicSettings::*)(void),bool>::call(RBX::GameBasicSettings*,bool (RBX::GameBasicSettings::*)(void),RBX::Reflection::Variant &)")
}
...
pub fn stub_0x84cc44() {
    // IDA 0x84cc44: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84cc78() -> ! {
    todo!("0x84cc78 RBX::Reflection::PropDescriptor<RBX::GameBasicSettings,bool>::GetSetImpl<bool (RBX::GameBasicSettings::*)(void)const,void (RBX::GameBasicSettings::*)(bool)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x84cc9c() -> ! {
    todo!("0x84cc9c RBX::Reflection::PropDescriptor<RBX::GameBasicSettings,bool>::GetSetImpl<bool (RBX::GameBasicSettings::*)(void)const,void (RBX::GameBasicSettings::*)(bool)>::setValue(RBX::Reflection::DescribedBase *,bool const&)const")
}
...
pub fn stub_0x84cdd4() {
    // IDA 0x84cdd4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84ce08() -> ! {
    todo!("0x84ce08 RBX::Reflection::PropDescriptor<RBX::GameBasicSettings,std::string>::GetSetImpl<std::string (RBX::GameBasicSettings::*)(void)const,void (RBX::GameBasicSettings::*)(std::string)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x84ce30() -> ! {
    todo!("0x84ce30 RBX::Reflection::PropDescriptor<RBX::GameBasicSettings,std::string>::GetSetImpl<std::string (RBX::GameBasicSettings::*)(void)const,void (RBX::GameBasicSettings::*)(std::string)>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x84cf74() -> ! {
    todo!("0x84cf74 RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,void ()(std::string,bool),2>::BoundFuncDesc(void (RBX::GameBasicSettings::*)(std::string,bool),char const*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x84d13c() -> ! {
    todo!("0x84d13c RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,void ()(std::string,bool),2>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x84d188() {
    // IDA 0x84d188: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84d264() -> ! {
    todo!("0x84d264 RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,void ()(std::string,bool),2>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x84d3bc() -> ! {
    todo!("0x84d3bc RBX::Reflection::Call2Helper<RBX::GameBasicSettings,void (RBX::GameBasicSettings::*)(std::string,bool),std::string,bool,void>::call(RBX::GameBasicSettings*,void (RBX::GameBasicSettings::*)(std::string,bool),RBX::Reflection::Variant &,std::string const&,bool const&)")
}
...
pub fn stub_0x84d4f4() -> ! {
    todo!("0x84d4f4 RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,bool ()(std::string),1>::BoundFuncDesc(bool (RBX::GameBasicSettings::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x84d66c() -> ! {
    todo!("0x84d66c RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,bool ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x84d69c() {
    // IDA 0x84d69c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84d768() -> ! {
    todo!("0x84d768 RBX::Reflection::BoundFuncDesc<RBX::GameBasicSettings,bool ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x84d8a8() -> ! {
    todo!("0x84d8a8 RBX::Reflection::Call1Helper<RBX::GameBasicSettings,bool (RBX::GameBasicSettings::*)(std::string),std::string,bool>::call(RBX::GameBasicSettings*,bool (RBX::GameBasicSettings::*)(std::string),RBX::Reflection::Variant &,std::string const&)")
}
...
pub fn stub_0x84dbb0() {
    // IDA 0x84dbb0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x84dbfc() -> ! {
    todo!("0x84dbfc RBX::Reflection::EnumPropDescriptor<RBX::GameBasicSettings,RBX::GameBasicSettings::RenderQualitySetting>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x84dc24() -> ! {
    todo!("0x84dc24 RBX::Reflection::EnumPropDescriptor<RBX::GameBasicSettings,RBX::GameBasicSettings::RenderQualitySetting>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x84dc48() -> ! {
    todo!("0x84dc48 RBX::Reflection::EnumPropDescriptor<RBX::GameBasicSettings,RBX::GameBasicSettings::RenderQualitySetting>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x84dd94() -> ! {
    todo!("0x84dd94 RBX::Reflection::EnumPropDescriptor<RBX::GameBasicSettings,RBX::GameBasicSettings::RenderQualitySetting>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x84ddbc() -> ! {
    todo!("0x84ddbc RBX::Reflection::EnumPropDescriptor<RBX::GameBasicSettings,RBX::GameBasicSettings::RenderQualitySetting>::getStringValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x84dde0() -> ! {
    todo!("0x84dde0 RBX::Reflection::EnumPropDescriptor<RBX::GameBasicSettings,RBX::GameBasicSettings::RenderQualitySetting>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
