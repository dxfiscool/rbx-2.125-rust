//! Auto-generated generated_refl_wd_10p — 100 stubs EA-sorted asc 0x2c8560..0x2ceaa8 (global gap filler, RBX::Reflection exhausted 19829/19829, rbx_core::SharedPtr not boost, // 0xADDR mangled + doc alias + todo)
//! Source: ida/export.json (85545 funcs) global EA asc not yet in crates/reflection/src — next 100 uncovered after 0x2c8488 (RBX::Reflection filter yielded 0 remaining, fallback to global gap)
...
pub fn stub_2ce130() -> ! {
    todo!("0x2ce130 RBX::Security::Context::isInRole(RBX::Security::Identities,RBX::Security::Permissions)")
}
...
pub fn stub_2ce8cc() {
    // IDA 0x2ce8cc: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner -- if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
