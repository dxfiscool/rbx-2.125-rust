//! reflection — generated_gap_4 — 120 stubs EA-sorted asc global gap filler 0x2b3f24..0x2e3234 not yet in crates/reflection/src
...
pub fn stub_0x2b54d8() -> ! {
    todo!("0x2b54d8 RBX::InvocationMeter<2>::updateBuckets(bool)")
}
...
pub fn stub_0x2b5590() -> ! {
    todo!("0x2b5590 rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<double>(double const&)")
}
...
pub fn stub_0x2b55e8() -> ! {
    todo!("0x2b55e8 rbx::implementation::typed_holder<double>::construct_func(char const*,char *)")
}
...
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsN3RBX13ScriptContext21ScriptStatInformationEESt10_Select1stIS5_ESt4lessISsESaIS5_EE4findERS1_")]
...
pub fn stub_0x2b5650() -> ! {
    todo!("0x2b5650 rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<std::string>(std::string const&)")
}
...
pub fn stub_0x2b56a8() -> ! {
    todo!("0x2b56a8 rbx::implementation::typed_holder<std::string>::construct_func(char const*,char *)")
}
...
pub fn stub_0x2b56b8() -> ! {
    todo!("0x2b56b8 rbx::implementation::typed_holder<std::string>::destruct_func(char *)")
}
...
pub fn stub_0x2b5d68() {
    // IDA 0x2b5d68: non-virtual thunk to `rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,boost::shared_ptr<RBX::Instance>)>::slot,boost::_bi::bind_t<void,boost::` — this/arg-adjust + tail-call (decompiled). Rust uses static dispatch; no thunk needed. Target unmodeled: cutover no-op.
}
...
pub fn stub_0x2b6fe4() {
    // IDA 0x2b6fe4: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x2b72c8() {
    // IDA 0x2b72c8: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX15ServiceProvider15doGetClassIndexINS_9WorkspaceEEEmv")]
...
#[doc(alias = "__ZN3RBX3Lua15SingletonBridgeIPKNS0_18AllEnumDescriptorsELb1EE4pushEP9lua_StateS4_")]
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIPKNS0_18AllEnumDescriptorsELb1EE13pushNewObjectIS4_EEPS4_P9lua_StateT_")]
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIPKNS0_18AllEnumDescriptorsELb1EE8on_indexEP9lua_State")]
...
#[doc(alias = "__ZN3RBX3Lua6BridgeIPKNS0_18AllEnumDescriptorsELb1EE11on_newindexEP9lua_State")]
