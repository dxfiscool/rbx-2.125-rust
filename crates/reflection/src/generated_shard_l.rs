// Auto-generated shard L — next 100 RBX::Reflection stubs — EA-sorted from earliest gap 0x67b46c
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 7513 stubbed -> 7613 total, showing next 100)
...
pub fn stub_0x67b46c() {
    // IDA 0x67b46c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x67b498() -> bool {
    // IDA 0x67b498: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x67b49c() -> bool {
    // IDA 0x67b49c: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x67b514() -> ! {
    todo!("0x67b514 RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::BrickColor>::PropDescriptor<RBX::BrickColor (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::BrickColor)>(char const*,char const*,RBX::BrickColor (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::BrickColor),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x67b628() {
    // IDA 0x67b628: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x67b654() -> bool {
    // IDA 0x67b654: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x67b658() -> bool {
    // IDA 0x67b658: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x67b65c() -> ! {
    todo!("0x67b65c RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::BrickColor)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67b694() -> ! {
    todo!("0x67b694 RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::BrickColor>::GetSetImpl<RBX::BrickColor (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::BrickColor)>::setValue(RBX::Reflection::DescribedBase *,RBX::BrickColor const&)const")
}
...
pub fn stub_0x67b6b8() -> ! {
    todo!("0x67b6b8 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::EnumPropDescriptor<RBX::TextService::Font (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::Font)>(char const*,char const*,RBX::TextService::Font (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::Font),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x67b86c() {
    // IDA 0x67b86c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x67b898() {
    // IDA 0x67b898: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x67b8a8() {
    // IDA 0x67b8a8: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x67b8b8() -> ! {
    todo!("0x67b8b8 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67b8e0() -> ! {
    todo!("0x67b8e0 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x67b904() -> ! {
    todo!("0x67b904 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x67ba50() -> ! {
    todo!("0x67ba50 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x67ba74() -> bool {
    // IDA 0x67ba74: EnumPropDescriptor::hasStringValue -- hardcoded `return 1` (decompiled 0x10244/0x10dc8/0x11650).
    true
}
...
pub fn stub_0x67ba78() -> ! {
    todo!("0x67ba78 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::getStringValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67ba9c() -> ! {
    todo!("0x67ba9c RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x67badc() -> ! {
    todo!("0x67badc RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}
...
pub fn stub_0x67bafc() -> ! {
    todo!("0x67bafc RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}
...
pub fn stub_0x67bd3c() -> ! {
    todo!("0x67bd3c RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::getIndexValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67bd58() -> ! {
    todo!("0x67bd58 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const")
}
...
pub fn stub_0x67bd8c() -> ! {
    todo!("0x67bd8c RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::getEnumValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67bd94() -> ! {
    todo!("0x67bd94 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::setEnumValue(RBX::Reflection::DescribedBase *,int)const")
}
...
pub fn stub_0x67bde0() -> ! {
    todo!("0x67bde0 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::getEnumItem(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67be00() -> ! {
    todo!("0x67be00 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const")
}
...
pub fn stub_0x67be34() -> ! {
    todo!("0x67be34 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::Font>::setIntValue(RBX::Reflection::DescribedBase *,int)const")
}
...
pub fn stub_0x67be74() -> bool {
    // IDA 0x67be74: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x67be78() -> bool {
    // IDA 0x67be78: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x67be7c() -> ! {
    todo!("0x67be7c RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::TextService::Font>::GetSetImpl<RBX::TextService::Font (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::Font)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67bea8() -> ! {
    todo!("0x67bea8 RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::TextService::Font>::GetSetImpl<RBX::TextService::Font (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::Font)>::setValue(RBX::Reflection::DescribedBase *,RBX::TextService::Font const&)const")
}
...
pub fn stub_0x67becc() -> ! {
    todo!("0x67becc RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::EnumPropDescriptor<RBX::TextService::FontSize (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::FontSize)>(char const*,char const*,RBX::TextService::FontSize (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::FontSize),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x67c080() {
    // IDA 0x67c080: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x67c0ac() {
    // IDA 0x67c0ac: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x67c0bc() {
    // IDA 0x67c0bc: EnumPropDescriptor::isReadOnly/isWriteOnly -- forwards through the bound member descriptor at +44 (`(**(this+44))(this+44)`, decompiled 0x10064/0x10074). Member descriptors unmodeled: cutover no-op.
}
...
pub fn stub_0x67c0cc() -> ! {
    todo!("0x67c0cc RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c0f4() -> ! {
    todo!("0x67c0f4 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x67c118() -> ! {
    todo!("0x67c118 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const")
}
...
pub fn stub_0x67c264() -> ! {
    todo!("0x67c264 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x67c288() -> bool {
    // IDA 0x67c288: EnumPropDescriptor::hasStringValue -- hardcoded `return 1` (decompiled 0x10244/0x10dc8/0x11650).
    true
}
...
pub fn stub_0x67c28c() -> ! {
    todo!("0x67c28c RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::getStringValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c2b0() -> ! {
    todo!("0x67c2b0 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x67c2f0() -> ! {
    todo!("0x67c2f0 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const")
}
...
pub fn stub_0x67c310() -> ! {
    todo!("0x67c310 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const")
}
...
pub fn stub_0x67c550() -> ! {
    todo!("0x67c550 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::getIndexValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c56c() -> ! {
    todo!("0x67c56c RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const")
}
...
pub fn stub_0x67c5a0() -> ! {
    todo!("0x67c5a0 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::getEnumValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c5a8() -> ! {
    todo!("0x67c5a8 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::setEnumValue(RBX::Reflection::DescribedBase *,int)const")
}
...
pub fn stub_0x67c5f4() -> ! {
    todo!("0x67c5f4 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::getEnumItem(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c614() -> ! {
    todo!("0x67c614 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const")
}
...
pub fn stub_0x67c648() -> ! {
    todo!("0x67c648 RBX::Reflection::EnumPropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::setIntValue(RBX::Reflection::DescribedBase *,int)const")
}
...
pub fn stub_0x67c688() -> bool {
    // IDA 0x67c688: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x67c68c() -> bool {
    // IDA 0x67c68c: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x67c690() -> ! {
    todo!("0x67c690 RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::GetSetImpl<RBX::TextService::FontSize (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::FontSize)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c6bc() -> ! {
    todo!("0x67c6bc RBX::Reflection::PropDescriptor<RBX::TextLabel,RBX::TextService::FontSize>::GetSetImpl<RBX::TextService::FontSize (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(RBX::TextService::FontSize)>::setValue(RBX::Reflection::DescribedBase *,RBX::TextService::FontSize const&)const")
}
...
pub fn stub_0x67c6e0() -> ! {
    todo!("0x67c6e0 RBX::Reflection::PropDescriptor<RBX::TextLabel,std::string>::PropDescriptor<std::string (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(std::string)>(char const*,char const*,std::string (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(std::string),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x67c7f4() {
    // IDA 0x67c7f4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x67c820() -> bool {
    // IDA 0x67c820: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x67c824() -> bool {
    // IDA 0x67c824: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
...
pub fn stub_0x67c828() -> ! {
    todo!("0x67c828 RBX::Reflection::PropDescriptor<RBX::TextLabel,std::string>::GetSetImpl<std::string (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(std::string)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x67c860() -> ! {
    todo!("0x67c860 RBX::Reflection::PropDescriptor<RBX::TextLabel,std::string>::GetSetImpl<std::string (RBX::GuiTextMixin::*)(void)const,void (RBX::TextLabel::*)(std::string)>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x68285c() {
    // IDA 0x68285c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x682880() {
    // IDA 0x682880: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6828b4() {
    // IDA 0x6828b4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6828e8() {
    // IDA 0x6828e8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
// was: RBX::Reflection::EventDesc<RBX::Tool,void ()(boost::shared_ptr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::~EventDesc()
...
pub fn stub_0x68290c() {
    // IDA 0x68290c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x682930() {
    // IDA 0x682930: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x682954() {
    // IDA 0x682954: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
// was: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Tool,RBX::Tool>(boost::shared_ptr<RBX::Tool> const*,RBX::Tool *)const
...
pub fn stub_0x683430() {
    // IDA 0x683430: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x683a04() -> ! {
    todo!("0x683a04 RBX::Reflection::RemoteEventDescImpl<0,RBX::Tool,void ()(void),rbx::remote_signal<void ()(void)>>::replicateEvent(RBX::Reflection::EventSource *)")
}
...
// was: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Mouse,RBX::Mouse>(boost::shared_ptr<RBX::Mouse> const*,RBX::Mouse *)const
...
pub fn stub_0x685a18() {
    // IDA 0x685a18: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}

// 0x686c0c — __ZN3RBX10Reflection15RemoteEventDescINS_4ToolEFvvEN3rbx13remote_signalIS3_EEED0Ev
#[doc(alias = "RBX::Reflection::RemoteEventDesc<RBX::Tool,void ()(void),rbx::remote_signal<void ()(void)>>::~RemoteEventDesc()")]
pub fn stub_0x686c0c() {
    // IDA 0x686c0c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
// was: RBX::Reflection::EventDescImpl<0,RBX::Tool,void ()(void),rbx::remote_signal<void ()(void)>,rbx::remote_signal<void ()(void)> RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
#[doc(alias = "RBX::Reflection::EventDescImpl<0,RBX::Tool,void ()(void),rbx::remote_signal<void ()(void)>,rbx::remote_signal<void ()(void)> RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")]
pub fn stub_0x686cc0() -> ! {
    todo!("0x686cc0 RBX::Reflection::EventDescImpl<0,RBX::Tool,void ()(void),rbx::remote_signal<void ()(void)>,rbx::remote_signal<void ()(void)> RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_0x686ed4() {
    // IDA 0x686ed4: RemoteEventDesc::isScriptable -- `return *(this+48) & 1` permission-flags read (decompiled 0x39f7ac/0x39fdf8). Flags word unmodeled: cutover no-op.
}
...
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Tool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Tool::*>::~EventDesc()")]
pub fn stub_0x686f7c() {
    // IDA 0x686f7c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
// was: RBX::Reflection::EventDescImpl<0,RBX::Tool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
#[doc(alias = "RBX::Reflection::EventDescImpl<0,RBX::Tool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")]
pub fn stub_0x687030() -> ! {
    todo!("0x687030 RBX::Reflection::EventDescImpl<0,RBX::Tool,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_0x6872bc() -> ! {
    todo!("0x6872bc RBX::Reflection::EventDesc<RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::EventDesc(RBX::Tool::special_equipped_signal RBX::Tool::*,char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
// was: RBX::Reflection::EventDesc<RBX::Tool,void ()(boost::shared_ptr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::~EventDesc()
#[doc(alias = "RBX::Reflection::EventDesc<RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::~EventDesc()")]
pub fn stub_0x687440() {
    // IDA 0x687440: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
// was: RBX::Reflection::EventDescImpl<1,RBX::Tool,void ()(boost::shared_ptr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")]
pub fn stub_0x6874f4() -> ! {
    todo!("0x6874f4 RBX::Reflection::EventDescImpl<1,RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
// was: RBX::Reflection::EventDescImpl<1,RBX::Tool,void ()(boost::shared_ptr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")]
pub fn stub_0x687648() -> ! {
    todo!("0x687648 RBX::Reflection::EventDescImpl<1,RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")
}
...
// was: RBX::Reflection::EventDescBase<RBX::Tool,void ()(boost::shared_ptr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::disconnectAll(RBX::Reflection::EventSource *)const
#[doc(alias = "RBX::Reflection::EventDescBase<RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::disconnectAll(RBX::Reflection::EventSource *)const")]
pub fn stub_0x687788() -> ! {
    todo!("0x687788 RBX::Reflection::EventDescBase<RBX::Tool,void ()(rbx_core::SharedPtr<RBX::Instance>),RBX::Tool::special_equipped_signal,RBX::Tool::special_equipped_signal RBX::Tool::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}
...
pub fn stub_0x687a1c() -> bool {
    // IDA 0x687a1c: BoundPropGetSet::isReadOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
pub fn stub_0x687a20() -> bool {
    // IDA 0x687a20: BoundPropGetSet::isWriteOnly -- hardcoded `return 0` (decompiled 0x659d38/0x659d3c SurfaceGetSet, 0x6ba528/0x6ba52c BoundPropGetSet).
    false
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Tool,bool>::~PropDescriptor()")]
pub fn stub_0x687b94() {
    // IDA 0x687b94: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x687bc0() -> bool {
    // IDA 0x687bc0: GetSetImpl::isReadOnly -- hardcoded `return 0` (decompiled 0xfcb4/0x106b4/0x1084c). Get/set-bound props are never read-only.
    false
}
...
pub fn stub_0x687bc4() -> bool {
    // IDA 0x687bc4: GetSetImpl::isWriteOnly -- hardcoded `return 0` (decompiled 0xfcb8/0x106b8/0x10850). Get/set-bound props are never write-only.
    false
}
