//! Auto-generated generated_refl_wd_10q — 120 stubs EA-sorted asc 0x2ceaac..0x2d8ce4 (global gap filler, RBX::Reflection exhausted 19829/19829, rbx_core::SharedPtr not boost, // 0xADDR mangled + doc alias + todo)
//! Source: ida/export.json (85545 funcs) global EA asc not yet in crates/reflection/src — next 120 uncovered after 0x2ceaa8 (RBX::Reflection filter yielded 0 remaining, fallback to global gap)
...
pub fn stub_2ceaac() {
    // IDA 0x2ceaac: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_2cef40() {
    // IDA 0x2cef40: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_2cefe0() {
    // IDA 0x2cefe0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2ceff4() {
    // IDA 0x2ceff4: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d072c() -> ! {
    todo!("0x2d072c std::auto_ptr<RBX::AdvRunDragger>::reset(RBX::AdvRunDragger*)")
}
...
pub fn stub_2d0804() {
    // IDA 0x2d0804: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d0808() {
    // IDA 0x2d0808: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d0dd8() {
    // IDA 0x2d0dd8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d0ddc() {
    // IDA 0x2d0ddc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_2d11b8() {
    // IDA 0x2d11b8: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d1a5c() {
    // IDA 0x2d1a5c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_2d1afc() {
    // IDA 0x2d1afc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d1b08() {
    // IDA 0x2d1b08: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_2d1c50() -> ! {
    todo!("0x2d1c50 RBX::AdvLuaDragTool::onMouseDown(RBX::UIEvent const&)")
}
...
pub fn stub_2d1e34() -> ! {
    todo!("0x2d1e34 RBX::AdvLuaDragTool::onMouseMove(RBX::UIEvent const&)")
}
...
pub fn stub_2d1edc() -> ! {
    todo!("0x2d1edc RBX::AdvLuaDragTool::onMouseIdle(RBX::UIEvent const&)")
}
...
pub fn stub_2d1f5c() -> ! {
    todo!("0x2d1f5c RBX::AdvLuaDragTool::onMouseUp(RBX::UIEvent const&)")
}
...
pub fn stub_2d21d8() -> ! {
    todo!("0x2d21d8 RBX::AdvLuaDragTool::onKeyDown(RBX::UIEvent const&)")
}
...
pub fn stub_2d2374() -> ! {
    todo!("0x2d2374 boost::shared_ptr<RBX::AdvLuaDragger>::operator=(boost::shared_ptr<RBX::AdvLuaDragger> const&)")
}
...
pub fn stub_2d23ac() -> ! {
    todo!("0x2d23ac boost::shared_ptr<RBX::AdvLuaDragTool> RBX::shared_from<RBX::AdvLuaDragTool>(RBX::AdvLuaDragTool*)")
}
...
pub fn stub_2d253c() -> ! {
    todo!("0x2d253c RBX::AdvLuaDragTool::getCursorName(void)const")
}
...
pub fn stub_2d2548() -> ! {
    todo!("0x2d2548 RBX::AdvLuaDragTool::setCursor(std::string)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBaseC2EPNS_9WorkspaceE")]
pub fn stub_2d28a4() -> ! {
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase12onMouseHoverERKNS_7UIEventE")]
pub fn stub_2d2a94() -> ! {
    todo!("0x2d2a94 RBX::AdvMoveToolBase::onMouseHover(RBX::UIEvent const&)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase11onMouseIdleERKNS_7UIEventE")]
pub fn stub_2d2ab0() -> ! {
    todo!("0x2d2ab0 RBX::AdvMoveToolBase::onMouseIdle(RBX::UIEvent const&)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase11onMouseDownERKNS_7UIEventE")]
pub fn stub_2d2c3c() -> ! {
    todo!("0x2d2c3c RBX::AdvMoveToolBase::onMouseDown(RBX::UIEvent const&)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase30saveAndModifyPartsTransparencyEv")]
pub fn stub_2d2f40() -> ! {
    todo!("0x2d2f40 RBX::AdvMoveToolBase::saveAndModifyPartsTransparency(void)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase11onMouseMoveERKNS_7UIEventE")]
pub fn stub_2d3174() -> ! {
    todo!("0x2d3174 RBX::AdvMoveToolBase::onMouseMove(RBX::UIEvent const&)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase9onMouseUpERKNS_7UIEventE")]
pub fn stub_2d421c() -> ! {
    todo!("0x2d421c RBX::AdvMoveToolBase::onMouseUp(RBX::UIEvent const&)")
}
...
#[doc(alias = "__ZN3RBX15AdvMoveToolBase29restoreSavedPartsTransparencyEv")]
pub fn stub_2d427c() -> ! {
    todo!("0x2d427c RBX::AdvMoveToolBase::restoreSavedPartsTransparency(void)")
}

// 0x2d43a4 — __ZN3RBX15AdvMoveToolBase9onKeyDownERKNS_7UIEventE
#[doc(alias = "RBX::AdvMoveToolBase::onKeyDown(RBX::UIEvent const&)")]
#[doc(alias = "__ZN3RBX15AdvMoveToolBase9onKeyDownERKNS_7UIEventE")]
pub fn stub_2d43a4() -> ! {
    todo!("0x2d43a4 RBX::AdvMoveToolBase::onKeyDown(RBX::UIEvent const&)")
}

// 0x2d448c — __ZN3RBX15AdvMoveToolBase8render2dEPNS_5AdornE
#[doc(alias = "RBX::AdvMoveToolBase::render2d(RBX::Adorn *)")]
#[doc(alias = "__ZN3RBX15AdvMoveToolBase8render2dEPNS_5AdornE")]
pub fn stub_2d448c() -> ! {
...
#[doc(alias = "__ZNK3RBX15AdvMoveToolBase10getExtentsERNS_7ExtentsE")]
pub fn stub_2d45b8() -> ! {
    todo!("0x2d45b8 RBX::AdvMoveToolBase::getExtents(RBX::Extents &)const")
}
...
#[doc(alias = "__ZN3RBX11AdvMoveTool11onMouseDownERKNS_7UIEventE")]
pub fn stub_2d496c() -> ! {
    todo!("0x2d496c RBX::AdvMoveTool::onMouseDown(RBX::UIEvent const&)")
}
...
#[doc(alias = "__ZN3RBX13AdvRotateToolD1Ev")]
pub fn stub_2d5fd0() {
    // IDA 0x2d5fd0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x2d5fd4 — __ZN3RBX13AdvRotateToolD0Ev
#[doc(alias = "RBX::AdvRotateTool::~AdvRotateTool()")]
#[doc(alias = "__ZN3RBX13AdvRotateToolD0Ev")]
pub fn stub_2d5fd4() {
    // IDA 0x2d5fd4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX13AdvRunDragger8SnapInfo20updateSurfaceFromHitEv")]
pub fn stub_2d6390() -> ! {
    todo!("0x2d6390 RBX::AdvRunDragger::SnapInfo::updateSurfaceFromHit(void)")
}
...
#[doc(alias = "__ZN3RBX13AdvRunDragger8SnapInfo20updateHitFromSurfaceERKNS_6RbxRayE")]
pub fn stub_2d64ac() -> ! {
    todo!("0x2d64ac RBX::AdvRunDragger::SnapInfo::updateHitFromSurface(RBX::RbxRay const&)")
}
...
#[doc(alias = "__ZN3RBX13AdvRunDragger8SnapInfo17hitOutsideExtentsEv")]
pub fn stub_2d6784() -> ! {
    todo!("0x2d6784 RBX::AdvRunDragger::SnapInfo::hitOutsideExtents(void)")
}

// 0x2d68d8 — __ZN3RBX13AdvRunDraggerC1Ev
#[doc(alias = "RBX::AdvRunDragger::AdvRunDragger(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDraggerC1Ev")]
pub fn stub_2d68d8() -> ! {
    todo!("0x2d68d8 RBX::AdvRunDragger::AdvRunDragger(void)")
}

// 0x2d68dc — __ZN3RBX13AdvRunDraggerC2Ev
#[doc(alias = "RBX::AdvRunDragger::AdvRunDragger(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDraggerC2Ev")]
pub fn stub_2d68dc() -> ! {
    todo!("0x2d68dc RBX::AdvRunDragger::AdvRunDragger(void)")
}

// 0x2d6ac8 — __ZN3RBX13AdvRunDraggerD1Ev
#[doc(alias = "RBX::AdvRunDragger::~AdvRunDragger()")]
#[doc(alias = "__ZN3RBX13AdvRunDraggerD1Ev")]
pub fn stub_2d6ac8() {
    // IDA 0x2d6ac8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}

// 0x2d6acc — __ZN3RBX13AdvRunDraggerD2Ev
#[doc(alias = "RBX::AdvRunDragger::~AdvRunDragger()")]
#[doc(alias = "__ZN3RBX13AdvRunDraggerD2Ev")]
pub fn stub_2d6acc() {
    // IDA 0x2d6acc: D2 base-object destructor: destroy members in place, no delete (decompiled 0x111270 PluginList map-node loop, 0x35bfec NameMap, 0xdc29cc Ogre::SceneNode; 0x4a15b0 EnumDesc). Rust: Drop glue covers it; no explicit body.
}

// 0x2d6c30 — __ZN3RBX13AdvRunDragger20snapInfoFromSnapPartEv
#[doc(alias = "RBX::AdvRunDragger::snapInfoFromSnapPart(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger20snapInfoFromSnapPartEv")]
pub fn stub_2d6c30() -> ! {
    todo!("0x2d6c30 RBX::AdvRunDragger::snapInfoFromSnapPart(void)")
}

// 0x2d6ed8 — __ZN3RBX13AdvRunDragger20snapPartFromSnapInfoEv
#[doc(alias = "RBX::AdvRunDragger::snapPartFromSnapInfo(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger20snapPartFromSnapInfoEv")]
pub fn stub_2d6ed8() -> ! {
    todo!("0x2d6ed8 RBX::AdvRunDragger::snapPartFromSnapInfo(void)")
}
...
#[doc(alias = "__ZN3RBX13AdvRunDragger12moveDragPartEv")]
pub fn stub_2d79c8() -> ! {
    todo!("0x2d79c8 RBX::AdvRunDragger::moveDragPart(void)")
}

// 0x2d83d0 — __ZN3RBX13AdvRunDragger19getSnapSurfaceCoordEv
#[doc(alias = "RBX::AdvRunDragger::getSnapSurfaceCoord(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger19getSnapSurfaceCoordEv")]
pub fn stub_2d83d0() -> ! {
    todo!("0x2d83d0 RBX::AdvRunDragger::getSnapSurfaceCoord(void)")
}

// 0x2d8564 — __ZN3RBX13AdvRunDragger12snapDragPartEv
#[doc(alias = "RBX::AdvRunDragger::snapDragPart(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger12snapDragPartEv")]
pub fn stub_2d8564() -> ! {
    todo!("0x2d8564 RBX::AdvRunDragger::snapDragPart(void)")
}
...
#[doc(alias = "__ZN3RBX13AdvRunDragger8adjacentEPNS_9PrimitiveES2_")]
pub fn stub_2d8a78() -> ! {
    todo!("0x2d8a78 RBX::AdvRunDragger::adjacent(RBX::Primitive *,RBX::Primitive *)")
}
