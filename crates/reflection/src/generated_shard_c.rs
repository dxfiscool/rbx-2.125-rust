// Auto-generated shard C — next 100 RBX::Reflection stubs — EA-sorted, offset after 0x6334a0
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 7201 stubbed -> 9658 remaining, showing next 100)
...
pub fn stub_0x633c3c() {
    // IDA 0x633c3c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x633dcc() {
    // IDA 0x633dcc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x63586c() {
    // IDA 0x63586c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x63621c() {
    // IDA 0x63621c: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Sky,int>::~PropDescriptor()")]
pub fn stub_0x636bd8() {
    // IDA 0x636bd8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x637870() {
    // IDA 0x637870: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x637898() {
    // IDA 0x637898: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x637d08() {
    // IDA 0x637d08: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x6386d0() -> ! {
    todo!("0x6386d0 RBX::Reflection::PropDescriptor<RBX::Smoke,float>::PropDescriptor<float (RBX::Smoke::*)(void)const,void (RBX::Smoke::*)(float)>(char const*,char const*,float (RBX::Smoke::*)(void)const,void (RBX::Smoke::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x6387e4 — __ZN3RBX10Reflection14PropDescriptorINS_5SmokeEfED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Smoke,float>::~PropDescriptor()")]
pub fn stub_0x6387e4() {
    // IDA 0x6387e4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x638818() -> ! {
    todo!("0x638818 RBX::Reflection::PropDescriptor<RBX::Smoke,float>::GetSetImpl<float (RBX::Smoke::*)(void)const,void (RBX::Smoke::*)(float)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x638838() -> ! {
    todo!("0x638838 RBX::Reflection::PropDescriptor<RBX::Smoke,float>::GetSetImpl<float (RBX::Smoke::*)(void)const,void (RBX::Smoke::*)(float)>::setValue(RBX::Reflection::DescribedBase *,float const&)const")
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Smoke,G3D::Color3>::~PropDescriptor()")]
pub fn stub_0x638970() {
    // IDA 0x638970: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x638a08() -> ! {
    todo!("0x638a08 RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundProp<RBX::Smoke>(char const*,char const*,bool RBX::Smoke::*,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x638ba0() -> ! {
    todo!("0x638ba0 RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::Smoke>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x638bac() -> ! {
    todo!("0x638bac RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::Smoke>::setValue(RBX::Reflection::DescribedBase *,bool const&)const")
}
...
pub fn stub_0x63a240() {
    // IDA 0x63a240: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x63b910() -> ! {
    todo!("0x63b910 RBX::Reflection::BoundFuncDesc<RBX::SocialService,void ()(std::string),1>::BoundFuncDesc(void (RBX::SocialService::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x63ba88() -> ! {
    todo!("0x63ba88 RBX::Reflection::BoundFuncDesc<RBX::SocialService,void ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}

// 0x63bab8 — __ZN3RBX10Reflection13BoundFuncDescINS_13SocialServiceEFvSsELi1EED0Ev
#[doc(alias = "RBX::Reflection::BoundFuncDesc<RBX::SocialService,void ()(std::string),1>::~BoundFuncDesc()")]
pub fn stub_0x63bab8() {
    // IDA 0x63bab8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x63bb84() -> ! {
    todo!("0x63bb84 RBX::Reflection::BoundFuncDesc<RBX::SocialService,void ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x63bcc0() -> ! {
    todo!("0x63bcc0 RBX::Reflection::Call1Helper<RBX::SocialService,void (RBX::SocialService::*)(std::string),std::string,void>::call(RBX::SocialService*,void (RBX::SocialService::*)(std::string),RBX::Reflection::Variant &,std::string const&)")
}
...
pub fn stub_0x63c460() {
    // IDA 0x63c460: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::Sparkles,G3D::Color3>::~PropDescriptor()")]
pub fn stub_0x63cbf4() {
    // IDA 0x63cbf4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x63cc8c() -> ! {
    todo!("0x63cc8c RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundProp<RBX::Sparkles>(char const*,char const*,bool RBX::Sparkles::*,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x63ce24() -> ! {
    todo!("0x63ce24 RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::Sparkles>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x63ce30() -> ! {
    todo!("0x63ce30 RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::Sparkles>::setValue(RBX::Reflection::DescribedBase *,bool const&)const")
}
...
pub fn stub_0x63e2a8() -> ! {
    todo!("0x63e2a8 RBX::SpawnLocation::onAllowTeamChangeOnTouchChanged(RBX::Reflection::PropertyDescriptor const&)")
}
...
pub fn stub_0x63e2ac() {
    // IDA 0x63e2ac: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x63ef38() {
    // IDA 0x63ef38: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x63fba4() {
    // IDA 0x63fba4: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x64036c() -> ! {
    todo!("0x64036c RBX::Reflection::PropDescriptor<RBX::SpawnLocation,RBX::BrickColor>::PropDescriptor<RBX::BrickColor (RBX::SpawnLocation::*)(void)const,void (RBX::SpawnLocation::*)(RBX::BrickColor)>(char const*,char const*,RBX::BrickColor (RBX::SpawnLocation::*)(void)const,void (RBX::SpawnLocation::*)(RBX::BrickColor),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}

// 0x640480 — __ZN3RBX10Reflection14PropDescriptorINS_13SpawnLocationENS_10BrickColorEED0Ev
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::SpawnLocation,RBX::BrickColor>::~PropDescriptor()")]
pub fn stub_0x640480() {
    // IDA 0x640480: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
