//! Auto-generated generated_refl_wd_10r — 120 stubs EA-sorted asc 0x2d8de4..0x2e1ed8 (global gap filler, RBX::Reflection exhausted 19829/19829, rbx_core::SharedPtr not boost, // 0xADDR mangled + doc alias + todo)
//! Source: ida/export.json (85545 funcs) global EA asc not yet in crates/reflection/src — next 120 uncovered after 0x2d8ce4 (RBX::Reflection filter yielded 0 remaining, fallback to global gap)
...
#[doc(alias = "__ZN3RBX13AdvRunDragger11fallOffEdgeEv")]
pub fn stub_2d8de4() -> ! {
    todo!("0x2d8de4 RBX::AdvRunDragger::fallOffEdge(void)")
}

// 0x2d8e1c — __ZN3RBX13AdvRunDragger11fallOffPartERb
#[doc(alias = "RBX::AdvRunDragger::fallOffPart(bool &)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger11fallOffPartERb")]
pub fn stub_2d8e1c() -> ! {
    todo!("0x2d8e1c RBX::AdvRunDragger::fallOffPart(bool &)")
}

// 0x2d8f8c — __ZN3RBX13AdvRunDragger17rayHitsCloserPartEv
#[doc(alias = "RBX::AdvRunDragger::rayHitsCloserPart(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger17rayHitsCloserPartEv")]
pub fn stub_2d8f8c() -> ! {
    todo!("0x2d8f8c RBX::AdvRunDragger::rayHitsCloserPart(void)")
}

// 0x2d90dc — __ZN3RBX13AdvRunDragger16tooCloseToCameraEv
#[doc(alias = "RBX::AdvRunDragger::tooCloseToCamera(void)")]
#[doc(alias = "__ZN3RBX13AdvRunDragger16tooCloseToCameraEv")]
pub fn stub_2d90dc() -> ! {
    todo!("0x2d90dc RBX::AdvRunDragger::tooCloseToCamera(void)")
}
...
#[doc(alias = "__ZN3RBX13AdvRunDragger9findSafeYEv")]
pub fn stub_2d9430() -> ! {
    todo!("0x2d9430 RBX::AdvRunDragger::findSafeY(void)")
}
...
pub fn stub_2d9ae0() -> ! {
    todo!("0x2d9ae0 RBX::AdvRunDragger::snap(RBX::RbxRay const&)")
}
...
pub fn stub_2da2d0() -> ! {
    todo!("0x2da2d0 RBX::AxisToolBase::onMouseHover(RBX::UIEvent const&)")
}
...
pub fn stub_2da2d8() -> ! {
    todo!("0x2da2d8 RBX::AxisToolBase::onMouseIdle(RBX::UIEvent const&)")
}
...
pub fn stub_2da450() -> ! {
    todo!("0x2da450 RBX::AxisToolBase::onMouseDown(RBX::UIEvent const&)")
}
...
pub fn stub_2da788() -> ! {
    todo!("0x2da788 RBX::AxisToolBase::onMouseMove(RBX::UIEvent const&)")
}
...
pub fn stub_2dac1c() -> ! {
    todo!("0x2dac1c RBX::AxisToolBase::onMouseUp(RBX::UIEvent const&)")
}
...
pub fn stub_2dad94() -> ! {
    todo!("0x2dad94 RBX::AxisToolBase::getExtents(RBX::Extents &)const")
}
...
pub fn stub_2db058() -> ! {
    todo!("0x2db058 boost::shared_ptr<RBX::AxisToolBase> RBX::shared_from<RBX::AxisToolBase>(RBX::AxisToolBase*)")
}
...
pub fn stub_2db1c0() -> ! {
    todo!("0x2db1c0 std::auto_ptr<RBX::MegaDragger>::reset(RBX::MegaDragger*)")
}
...
pub fn stub_2dba80() -> ! {
    todo!("0x2dba80 RBX::CloneTool::onMouseIdle(RBX::UIEvent const&)")
}
...
pub fn stub_2dbb58() -> ! {
    todo!("0x2dbb58 RBX::CloneTool::onMouseDown(RBX::UIEvent const&)")
}
...
pub fn stub_2dbda0() -> ! {
    todo!("0x2dbda0 RBX::CloneTool::getCursorName(void)const")
}
...
pub fn stub_2dbfb0() -> ! {
    todo!("0x2dbfb0 RBX::CloneTool::isSticky(void)const")
}
...
pub fn stub_2dc144() {
    // IDA 0x2dc144: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner -- if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_2dc604() -> ! {
    todo!("0x2dc604 RBX::Dragger::computeExtents(std::vector<RBX::Primitive *,std::allocator<RBX::Primitive *>> const&)")
}
...
pub fn stub_2e0ab4() {
    // IDA 0x2e0ab4: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner -- if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
