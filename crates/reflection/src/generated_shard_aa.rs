// Auto-generated shard AA — next 120 RBX::Reflection stubs — EA-sorted from 0x7cad88
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 9760->9880 total, showing next 120)
...
#[doc(alias = "__ZN3RBX10Reflection14PropDescriptorINS_8HumanoidEN3G3D7Vector3EEC2IMS2_KFRKS4_vEMS2_FvS8_EEEPKcSE_T_T0_NS0_18PropertyDescriptor10AttributesENS_8Security11PermissionsE")]
pub fn stub_0x7cadd0() -> ! {
    todo!("0x7cadd0 RBX::Reflection::PropDescriptor<RBX::Humanoid,G3D::Vector3>::PropDescriptor<G3D::Vector3 const& (RBX::Humanoid::*)(void)const,void (RBX::Humanoid::*)(G3D::Vector3 const&)>(char const*,char const*,G3D::Vector3 const& (RBX::Humanoid::*)(void)const,void (RBX::Humanoid::*)(G3D::Vector3 const&),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8HumanoidEN3G3D7Vector3EE10GetSetImplIMS2_KFRKS4_vEMS2_FvS8_EE8getValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x7caeec() -> ! {
    todo!("0x7caeec RBX::Reflection::PropDescriptor<RBX::Humanoid,G3D::Vector3>::GetSetImpl<G3D::Vector3 const& (RBX::Humanoid::*)(void)const,void (RBX::Humanoid::*)(G3D::Vector3 const&)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
#[doc(alias = "__ZNK3RBX10Reflection14PropDescriptorINS_8HumanoidEN3G3D7Vector3EE10GetSetImplIMS2_KFRKS4_vEMS2_FvS8_EE8setValueEPNS0_13DescribedBaseES8_")]
pub fn stub_0x7caf20() -> ! {
    todo!("0x7caf20 RBX::Reflection::PropDescriptor<RBX::Humanoid,G3D::Vector3>::GetSetImpl<G3D::Vector3 const& (RBX::Humanoid::*)(void)const,void (RBX::Humanoid::*)(G3D::Vector3 const&)>::setValue(RBX::Reflection::DescribedBase *,G3D::Vector3 const&)const")
}
...
pub fn stub_0x7cb148() {
    // IDA 0x7cb148: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "RBX::Reflection::CallbackDescriptor::setGenericCallbackHelper(RBX::Reflection::DescribedBase *,boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)> const&)const")]
...
pub fn stub_0x7d7b58() -> ! {
    todo!("0x7d7b58 RBX::Reflection::CallbackDescriptor::setGenericCallbackHelper(RBX::Reflection::DescribedBase *,boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)> const&)const")
}
...
pub fn stub_0x7d7c98() -> ! {
    todo!("0x7d7c98 rbx_core::SharedPtr<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::shared_ptr<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>(boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)> *)")
}
...
pub fn stub_0x7d7d70() -> ! {
    todo!("0x7d7d70 boost::detail::shared_count::shared_count<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>(boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)> *)")
}
...
pub fn stub_0x7d7e7c() -> ! {
    todo!("0x7d7e7c boost::function1<rbx_core::SharedPtr<RBX::Reflection::Tuple>,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>::clear(void)")
}
...
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::~sp_counted_impl_p()")]
...
pub fn stub_0x7d7ea8() {
    // IDA 0x7d7ea8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7d7eac() {
    // IDA 0x7d7eac: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::dispose(void)")]
...
pub fn stub_0x7d7eb0() -> ! {
    todo!("0x7d7eb0 boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::dispose(void)")
}
...
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::get_deleter(std::type_info const&)")]
...
pub fn stub_0x7d7f58() -> ! {
    todo!("0x7d7f58 boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::get_deleter(std::type_info const&)")
}
...
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::get_untyped_deleter(void)")]
...
pub fn stub_0x7d7f5c() -> ! {
    todo!("0x7d7f5c boost::detail::sp_counted_impl_p<boost::function<rbx_core::SharedPtr<RBX::Reflection::Tuple> ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>>::get_untyped_deleter(void)")
}
...
pub fn stub_0x7d7f60() -> ! {
    todo!("0x7d7f60 boost::function1<rbx_core::SharedPtr<RBX::Reflection::Tuple>,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>::assign_to_own(boost::function1<rbx_core::SharedPtr<RBX::Reflection::Tuple>,rbx_core::SharedPtr<RBX::Reflection::Tuple const>> const&)")
}
...
pub fn stub_0x7db7d0() -> ! {
    todo!("0x7db7d0 RBX::WebSerializer::writeTable(std::map<std::string,RBX::Reflection::Variant,std::less<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const&)")
}
...
pub fn stub_0x7f03d8() {
    // IDA 0x7f03d8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f0418() {
    // IDA 0x7f0418: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f043c() {
    // IDA 0x7f043c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f047c() {
    // IDA 0x7f047c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f04bc() {
    // IDA 0x7f04bc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f7344() {
    // IDA 0x7f7344: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f7438() {
    // IDA 0x7f7438: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f746c() -> ! {
    todo!("0x7f746c RBX::Reflection::PropDescriptor<RBX::ContentProvider,int>::GetImpl<int (RBX::ContentProvider::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x7f748c() -> ! {
    todo!("0x7f748c RBX::Reflection::PropDescriptor<RBX::ContentProvider,int>::GetImpl<int (RBX::ContentProvider::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,int const&)const")
}
...
pub fn stub_0x7f75ac() -> ! {
    todo!("0x7f75ac RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(RBX::ContentId),1>::BoundFuncDesc(void (RBX::ContentProvider::*)(RBX::ContentId),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x7f7724() -> ! {
    todo!("0x7f7724 RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(RBX::ContentId),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x7f7754() {
    // IDA 0x7f7754: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f7820() -> ! {
    todo!("0x7f7820 RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(RBX::ContentId),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x7f795c() -> ! {
    todo!("0x7f795c RBX::Reflection::Call1Helper<RBX::ContentProvider,void (RBX::ContentProvider::*)(RBX::ContentId),RBX::ContentId,void>::call(RBX::ContentProvider*,void (RBX::ContentProvider::*)(RBX::ContentId),RBX::Reflection::Variant &,RBX::ContentId const&)")
}
...
pub fn stub_0x7f7a98() -> ! {
    todo!("0x7f7a98 RBX::ContentId RBX::Reflection::ArgHelper::getArg<RBX::ContentId,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::ContentId> const&,boost::disable_if<boost::is_same<RBX::ContentId,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x7f7c74() -> ! {
    todo!("0x7f7c74 RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(int),1>::BoundFuncDesc(void (RBX::ContentProvider::*)(int),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x7f7dec() -> ! {
    todo!("0x7f7dec RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(int),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x7f7e1c() {
    // IDA 0x7f7e1c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f7ef0() -> ! {
    todo!("0x7f7ef0 RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(int),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x7f7f28() -> ! {
    todo!("0x7f7f28 RBX::Reflection::PropDescriptor<RBX::ContentProvider,std::string>::PropDescriptor<std::string const& (RBX::ContentProvider::*)(void)const,int>(char const*,char const*,std::string const& (RBX::ContentProvider::*)(void)const,int,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)")
}
...
pub fn stub_0x7f8038() {
    // IDA 0x7f8038: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f8068() -> ! {
    todo!("0x7f8068 RBX::Reflection::TypedPropertyDescriptor<std::string>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const")
}
...
pub fn stub_0x7f8198() -> ! {
    todo!("0x7f8198 RBX::Reflection::TypedPropertyDescriptor<std::string>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const")
}
...
pub fn stub_0x7f82c0() {
    // IDA 0x7f82c0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f82f4() -> ! {
    todo!("0x7f82f4 RBX::Reflection::PropDescriptor<RBX::ContentProvider,std::string>::GetImpl<std::string const& (RBX::ContentProvider::*)(void)const>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_0x7f8324() -> ! {
    todo!("0x7f8324 RBX::Reflection::PropDescriptor<RBX::ContentProvider,std::string>::GetImpl<std::string const& (RBX::ContentProvider::*)(void)const>::setValue(RBX::Reflection::DescribedBase *,std::string const&)const")
}
...
pub fn stub_0x7f8444() -> ! {
    todo!("0x7f8444 RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(std::string),1>::BoundFuncDesc(void (RBX::ContentProvider::*)(std::string),char const*,char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)")
}
...
pub fn stub_0x7f85bc() -> ! {
    todo!("0x7f85bc RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(std::string),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x7f85ec() {
    // IDA 0x7f85ec: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x7f86b8() -> ! {
    todo!("0x7f86b8 RBX::Reflection::BoundFuncDesc<RBX::ContentProvider,void ()(std::string),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x7f87f4() -> ! {
    todo!("0x7f87f4 RBX::Reflection::Call1Helper<RBX::ContentProvider,void (RBX::ContentProvider::*)(std::string),std::string,void>::call(RBX::ContentProvider*,void (RBX::ContentProvider::*)(std::string),RBX::Reflection::Variant &,std::string const&)")
}
...
pub fn stub_0x803614() {
    // IDA 0x803614: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x803708() {
    // IDA 0x803708: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x80372c() {
    // IDA 0x80372c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x803750() {
    // IDA 0x803750: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x803874() {
    // IDA 0x803874: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x803878() {
    // IDA 0x803878: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x80389c() {
    // IDA 0x80389c: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x8038c0() {
    // IDA 0x8038c0: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x8039b4() {
    // IDA 0x8039b4: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x803aa8() {
    // IDA 0x803aa8: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x803acc() {
    // IDA 0x803acc: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x805690() {
    // IDA 0x805690: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
