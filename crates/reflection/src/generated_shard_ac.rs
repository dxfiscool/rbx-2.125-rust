// Auto-generated shard AC - next 100 RBX::Reflection stubs - EA-sorted after 0x8113d0
// Source: ida/export.json filtered demangled contains RBX::Reflection or Reflection (19829 total, 9931 stubbed -> 10031 total, showing next 100)
...
// was: RBX::FriendService::processServiceResults(int,std::string *,std::exception const*,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>)
pub fn stub_0x839f90() -> ! {
...
// was: RBX::FriendService::getFriendsOnline(int,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>)
pub fn stub_0x83a374() -> ! {
...
pub fn stub_0x83d130() -> ! {
    todo!("0x83d130 RBX::Reflection::BoundFuncDesc<RBX::FriendService,void ()(std::string),1>::~BoundFuncDesc()")
}
...
pub fn stub_0x83d170() -> ! {
    todo!("0x83d170 RBX::Reflection::BoundFuncDesc<RBX::FriendService,void ()(bool),1>::~BoundFuncDesc()")
}
...
pub fn stub_0x83d1b0() -> ! {
    todo!("0x83d1b0 RBX::Reflection::RemoteEventDesc<RBX::FriendService,void ()(int,int,RBX::FriendService::FriendEventType),rbx::remote_signal<void ()(int,int,RBX::FriendService::FriendEventType)>>::~RemoteEventDesc()")
}
...
pub fn stub_0x83d1d4() -> ! {
    todo!("0x83d1d4 RBX::Reflection::RemoteEventDesc<RBX::FriendService,void ()(int,int,RBX::FriendService::FriendStatus),rbx::remote_signal<void ()(int,int,RBX::FriendService::FriendStatus)>>::~RemoteEventDesc()")
}
...
// 0x8439d8 - __ZN5boost8functionIFvPSsPSt9exceptionEEC2INS_3_bi6bind_tIvNS_4_mfi3mf5IvN3RBX13FriendServiceEiS1_PKS2_NS0_IFvNS_10shared_ptrIKNS_9unordered13unordered_mapISsNSB_10Reflection7VariantENS_4hashISsEESt8equal_toISsESaISt4pairIKSsSJ_EEEEEEEEENS0_IFvSsEEEEENS7_5list6INS7_5valueIPSC_EENS11_IiEENS_3argILi1EEENS15_ILi2EEENS11_ISW_EENS11_ISY_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralIS1C_EE5valueEEE5valueEiE4typeE
...
pub fn stub_0x8439d8() -> ! {
    todo!("0x8439d8 __ZN5boost8functionIFvPSsPSt9exceptionEEC2INS_3_bi6bind_tIvNS_4_mfi3mf5IvN3RBX13FriendServiceEiS1_PKS2_NS0_IFvNS_10shared_ptrIKNS_9unordered13unordered_mapISsNSB_10Reflection7VariantENS_4hashISsEESt8equal_toISsESaISt4pairIKSsSJ_EEEEEEEEENS0_IFvSsEEEEENS7_5list6INS7_5valueIPSC_EENS11_IiEENS_3argILi1EEENS15_ILi2EEENS11_ISW_EENS11_ISY_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralIS1C_EE5valueEEE5valueEiE4typeE")
}

// 0x843b38 - __ZN5boost9function2IvPSsPSt9exceptionEC2INS_3_bi6bind_tIvNS_4_mfi3mf5IvN3RBX13FriendServiceEiS1_PKS2_NS_8functionIFvNS_10shared_ptrIKNS_9unordered13unordered_mapISsNSA_10Reflection7VariantENS_4hashISsEESt8equal_toISsESaISt4pairIKSsSJ_EEEEEEEEENSE_IFvSsEEEEENS6_5list6INS6_5valueIPSB_EENS11_IiEENS_3argILi1EEENS15_ILi2EEENS11_ISW_EENS11_ISY_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralIS1C_EE5valueEEE5valueEiE4typeE
...
pub fn stub_0x843b38() -> ! {
    todo!("0x843b38 __ZN5boost9function2IvPSsPSt9exceptionEC2INS_3_bi6bind_tIvNS_4_mfi3mf5IvN3RBX13FriendServiceEiS1_PKS2_NS_8functionIFvNS_10shared_ptrIKNS_9unordered13unordered_mapISsNSA_10Reflection7VariantENS_4hashISsEESt8equal_toISsESaISt4pairIKSsSJ_EEEEEEEEENSE_IFvSsEEEEENS6_5list6INS6_5valueIPSB_EENS11_IiEENS_3argILi1EEENS15_ILi2EEENS11_ISW_EENS11_ISY_EEEEEEEET_NS_11enable_if_cIXsr5boost11type_traits7ice_notIXsr11is_integralIS1C_EE5valueEEE5valueEiE4typeE")
}
...
// was: boost::detail::function::void_function_obj_invoker2<boost::_bi::bind_t<void,boost::_mfi::mf5<void,RBX::FriendService,int,std::string *,std::exception const*,boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>,boost::function<void ()(std::string)>>,boost::_bi::list6<boost::_bi::value<RBX::FriendService*>,boost::_bi::value<int>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(boost::shared_ptr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>)>>,boost::_bi::value<boost::function<void ()(std::string)>>>>,void,std::string *,std::exception*>::invoke(boost::detail::function::function_buffer &,std::string *,std::exception*)
pub fn stub_0x843e28() -> ! {
...
// was: void boost::function3<void,int,int,RBX::FriendService::FriendStatus>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,int const&,int const&,RBX::FriendService::FriendStatus const&>,boost::_bi::list4<boost::_bi::value<boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>>(boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::Reflection::GenericSlotWrapper,int const&,int const&,RBX::FriendService::FriendStatus const&>,boost::_bi::list4<boost::_bi::value<boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>)
pub fn stub_0x8457f8() -> ! {
