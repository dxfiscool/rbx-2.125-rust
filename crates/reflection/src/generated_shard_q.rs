// Auto-generated shard Q — next 120 RBX::Reflection stubs — EA-sorted from 0x6d8394
// Source: ida/export.json filtered demangled contains RBX::Reflection (16171 total, 7913 stubbed -> 8033 total, showing next 120)
...
pub fn stub_0x6d83ec() {
    // IDA 0x6d83ec: D1 complete-object destructor: reset vtable, destroy owned member (decompiled 0xb3bc PropDescriptor, 0x4a7734 EnumPropDescriptor; trivial cases like 0x1c7724 FIRational compile to an empty body). Rust: Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6d849c() {
    // IDA 0x6d849c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6d85a8() {
    // IDA 0x6d85a8: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6d8824() {
    // IDA 0x6d8824: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6d89d4() {
    // IDA 0x6d89d4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6d9398() {
    // IDA 0x6d9398: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6d9770() -> ! {
    todo!("0x6d9770 RBX::RbxRay RBX::Reflection::ArgHelper::getArg<RBX::RbxRay,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::RbxRay> const&,boost::disable_if<boost::is_same<RBX::RbxRay,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x6d9b18() -> ! {
    todo!("0x6d9b18 bool RBX::Reflection::ArgHelper::getArg<bool,3>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<bool> const&,boost::disable_if<boost::is_same<bool,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x6d9ef8() -> ! {
    todo!("0x6d9ef8 RBX::Reflection::BoundFuncDesc<RBX::Workspace,bool ()(RBX::Region3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),2>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x6d9f44() {
    // IDA 0x6d9f44: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6da064() -> ! {
    todo!("0x6da064 RBX::Reflection::BoundFuncDesc<RBX::Workspace,bool ()(RBX::Region3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),2>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x6da2bc() -> ! {
    todo!("0x6da2bc RBX::Region3 RBX::Reflection::ArgHelper::getArg<RBX::Region3,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::Region3> const&,boost::disable_if<boost::is_same<RBX::Region3,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x6da7a4() {
    // IDA 0x6da7a4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6dae38() -> ! {
    todo!("0x6dae38 RBX::Reflection::BoundFuncDesc<RBX::Workspace,boost::shared_ptr<RBX::Reflection::Tuple const> ()(RBX::RbxRay,boost::shared_ptr<RBX::Instance>,bool),3>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x6daf4c() {
    // IDA 0x6daf4c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6db08c() -> ! {
    todo!("0x6db08c RBX::Reflection::BoundFuncDesc<RBX::Workspace,boost::shared_ptr<RBX::Reflection::Tuple const> ()(RBX::RbxRay,boost::shared_ptr<RBX::Instance>,bool),3>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x6db574() -> ! {
    todo!("0x6db574 RBX::Reflection::BoundFuncDesc<RBX::Workspace,bool ()(RBX::Region3,boost::shared_ptr<RBX::Instance>),2>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x6db5c0() {
    // IDA 0x6db5c0: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6db6e0() -> ! {
    todo!("0x6db6e0 RBX::Reflection::BoundFuncDesc<RBX::Workspace,bool ()(RBX::Region3,boost::shared_ptr<RBX::Instance>),2>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x6dbc70() {
    // IDA 0x6dbc70: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6dbd9c() -> ! {
    todo!("0x6dbd9c RBX::Reflection::BoundFuncDesc<RBX::Workspace,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> ()(RBX::Region3,boost::shared_ptr<RBX::Instance>,int),3>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x6dc1ac() -> ! {
    todo!("0x6dc1ac RBX::Reflection::BoundFuncDesc<RBX::Workspace,void ()(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x6dc1dc() {
    // IDA 0x6dc1dc: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6dc2e4() -> ! {
    todo!("0x6dc2e4 RBX::Reflection::BoundFuncDesc<RBX::Workspace,void ()(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x6dc4b0() -> ! {
    todo!("0x6dc4b0 boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> RBX::Reflection::ArgHelper::getArg<boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>> const&,boost::disable_if<boost::is_same<boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")
}
...
pub fn stub_0x6dc7e8() -> ! {
    todo!("0x6dc7e8 RBX::Reflection::BoundFuncDesc<RBX::Workspace,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> ()(RBX::ContentId),1>::declareSignature(char const*,RBX::Reflection::Variant)")
}
...
pub fn stub_0x6dc818() {
    // IDA 0x6dc818: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6dc8e4() -> ! {
    todo!("0x6dc8e4 RBX::Reflection::BoundFuncDesc<RBX::Workspace,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> ()(RBX::ContentId),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
...
pub fn stub_0x6dccc4() {
    // IDA 0x6dccc4: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6dce5c() {
    // IDA 0x6dce5c: D0 deleting destructor: reset vtables, destroy members, `operator delete` (decompiled 0x396f40 Animation, 0x6d2f2c Described<Workspace>, 0x602e98 BoundFuncDesc). Rust: `Arc` Drop glue covers it; no explicit body.
}
...
pub fn stub_0x6df430() {
    // IDA 0x6df430: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x6e04a0() {
    // IDA 0x6e04a0: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
pub fn stub_0x6e0c54() {
    // IDA 0x6e0c54: boost::enable_shared_from_this<DescribedBase>::_internal_accept_owner — if weak expired, store owner ptr + `weak_count::operator=` (decompiled 0x4a2ae8). Rust: `rbx_core::SharedPtr`/`Weak` covers it; no explicit body.
}
...
#[doc(alias = "__ZN3RBX10Reflection7Variant7convertINS_8NormalIdEEERT_v")]
pub fn stub_0x6f2b8c() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorISsE11getDataSizeEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2b90() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorISsE14getStringValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2bec() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorISsE14setStringValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_0x6f2bfc() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIbE11getDataSizeEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2c0c() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIbE14getStringValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2c14() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIbE14setStringValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_0x6f2c38() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIfE11getDataSizeEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2c64() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIfE14getStringValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2c6c() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIfE14setStringValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_0x6f2c8c() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIdE11getDataSizeEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2cb8() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIdE14getStringValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2cc0() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIdE14setStringValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_0x6f2cec() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIiE11getDataSizeEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2d24() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIiE14getStringValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2d2c() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorIiE14setStringValueEPNS0_13DescribedBaseERKSs")]
pub fn stub_0x6f2d4c() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorINS_12Region3int16EE11getDataSizeEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2d78() -> ! {
...
#[doc(alias = "__ZNK3RBX10Reflection23TypedPropertyDescriptorINS_12Region3int16EE14getStringValueEPKNS0_13DescribedBaseE")]
pub fn stub_0x6f2d80() -> ! {
