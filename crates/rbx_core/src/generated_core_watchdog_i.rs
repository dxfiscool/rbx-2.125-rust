//! core watchdog i — 120 core stubs EA-sorted, continuation after watchdog_h 0x739784.
//! Source: ida/export.json (85545 funcs) global EA asc not yet in rbx_core — next 120 uncovered after 0x739784 (watchdog_h max).
