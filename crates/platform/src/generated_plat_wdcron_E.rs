//! platform — generated_plat_wdcron_E — 100 stubs EA-sorted asc gap filler distinct NOT yet in rbx_platform
//! Source: ida/export.json (85545 funcs) global gap filler EA-sorted asc next 100 after generated_plat_wdcron_D 0x4c93e8 (platform strict gaps)
//! Range 0x4c9488..0x4fc0c8 | distinct gap filler | rbx_core::SharedPtr not boost
//! Batch: generated_plat_wdcron_E 100 stubs (global gap filler) EA-sorted asc distinct shard B continuation
...
// 0x4c9488 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE6lookupEPKc — RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::lookup(char const*)const — int __fastcall(int, const char *const *)
...
// 0x4c94b8 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE6lookupERKNS0_7VariantE — RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::lookup(RBX::Reflection::Variant const&)const — int __fastcall(int, int)
...
// 0x4c9534 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE15convertToStringEmRSs — RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToString(unsigned long,std::string &)const — int __fastcall(int, unsigned int, std::string *, int)
...
// 0x4c9678 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE15convertToStringERKS3_ — RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToString(RBX::BasicPartInstance::LegacyPartType const&)const — void __fastcall(std::string *, int, int *, int, struct _Unwind_Exception *lpuexcpt, int)
...
// 0x4c9818 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_17BasicPartInstance14LegacyPartTypeEEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::BasicPartInstance::LegacyPartType>(RBX::BasicPartInstance::LegacyPartType const&) — void (__fastcall ***__fastcall(void (__fastcall ***)(int), void (__fastcall ***)(int)))(int)
...
// 0x4c9868 — __ZN3rbx14implementation12typed_holderIN3RBX17BasicPartInstance14LegacyPartTypeEE9singletonEv — rbx::implementation::typed_holder<RBX::BasicPartInstance::LegacyPartType>::singleton(void) — _DWORD *()
...
// 0x4c98d4 — __ZN3rbx14implementation12typed_holderIN3RBX17BasicPartInstance14LegacyPartTypeEE14construct_funcEPKcPc — rbx::implementation::typed_holder<RBX::BasicPartInstance::LegacyPartType>::construct_func(char const*,char *) — _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// 0x4c98e0 — __ZN3rbx14implementation12typed_holderIN3RBX17BasicPartInstance14LegacyPartTypeEE13destruct_funcEPc — rbx::implementation::typed_holder<RBX::BasicPartInstance::LegacyPartType>::destruct_func(char *) — void()
...
// 0x4c98e4 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE13convertToItemERKS3_ — RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToItem(RBX::BasicPartInstance::LegacyPartType const&)const — int __fastcall(int, int *)
...
// 0x4c99b0 — __ZN3rbx8any_castIRKN3RBX17BasicPartInstance14LegacyPartTypeENS1_7Region3EEET_RNS_13placement_anyIT0_EE — RBX::BasicPartInstance::LegacyPartType const& rbx::any_cast<RBX::BasicPartInstance::LegacyPartType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &) — char ****__fastcall(char ****)
...
// 0x4c9aa0 — __ZNK3RBX10Reflection8EnumDescINS_17BasicPartInstance14LegacyPartTypeEE14convertToValueERKNS_4NameERS3_ — RBX::Reflection::EnumDesc<RBX::BasicPartInstance::LegacyPartType>::convertToValue(RBX::Name const&,RBX::BasicPartInstance::LegacyPartType&)const — int __fastcall(_DWORD *, unsigned int, _DWORD *)
...
// 0x4c9b1c — __ZNSt8_Rb_treeIPKN3RBX4NameESt4pairIKS3_NS0_17BasicPartInstance14LegacyPartTypeEESt10_Select1stIS8_ESt4lessIS3_ESaIS8_EE8_M_eraseEPSt13_Rb_tree_nodeIS8_E — std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::BasicPartInstance::LegacyPartType>> *) — void __fastcall(int, _DWORD *)
...
#[doc(alias = "__ZN3RBX10Reflection9EventDescINS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_EC2ESB_PKcSE_NS_8Security11PermissionsENS0_10Descriptor10AttributesE")]
pub fn stub_0x4f6f10() -> ! {
    todo!("0x4f6f10")
}

// 0x4f7094 — __ZN3RBX10Reflection9EventDescINS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_ED0Ev — RBX::Reflection::EventDesc<RBX::FlagStand,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::FlagStand::*>::~EventDesc()
...
#[doc(alias = "__ZN3RBX10Reflection9EventDescINS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_ED0Ev")]
...
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::FlagStand,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::FlagStand::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")]
#[doc(alias = "__ZNK3RBX10Reflection13EventDescImplILi1ENS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_E14connectGenericEPNS0_11EventSourceENS4_INS0_18GenericSlotWrapperEEE")]
pub fn stub_0x4f7148() -> ! {
    todo!("0x4f7148")
}
...
#[doc(alias = "RBX::Reflection::EventDescImpl<1,RBX::FlagStand,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::FlagStand::*>::fireEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const")]
#[doc(alias = "__ZNK3RBX10Reflection13EventDescImplILi1ENS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_E9fireEventEPNS0_11EventSourceERKSt6vectorINS0_7VariantESaISG_EE")]
pub fn stub_0x4f729c() -> ! {
    todo!("0x4f729c")
}

// 0x4f73fc — __ZNK3RBX10Reflection13EventDescBaseINS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_E13disconnectAllEPNS0_11EventSourceE — RBX::Reflection::EventDescBase<RBX::FlagStand,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::FlagStand::*>::disconnectAll(RBX::Reflection::EventSource *)const
...
#[doc(alias = "__ZNK3RBX10Reflection13EventDescBaseINS_9FlagStandEFvN5boost10shared_ptrINS_8InstanceEEEEN3rbx6signalIS7_EEMS2_SA_E13disconnectAllEPNS0_11EventSourceE")]
pub fn stub_0x4f73fc() -> ! {
    todo!("0x4f73fc")
}

// 0x4f75a4 — __ZN3RBX9FlagStandD2Ev — RBX::FlagStand::~FlagStand() — void __fastcall(RBX::FlagStand *__hidden this)
#[doc(alias = "RBX::FlagStand::~FlagStand()")]
#[doc(alias = "__ZN3RBX9FlagStandD2Ev")]
pub fn stub_0x4f75a4() -> ! {
    todo!("0x4f75a4")
}

// 0x4f7894 — __GLOBAL__I_a_197 — `global constructor keyed to'_a_197
#[doc(alias = "global constructor keyed to_a_197")]
#[doc(alias = "__GLOBAL__I_a_197")]
pub fn stub_0x4f7894() -> ! {
    todo!("0x4f7894")
}

// 0x4f7c58 — __ZN3RBX10ForceFieldC1Ev — RBX::ForceField::ForceField(void) — _DWORD __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "RBX::ForceField::ForceField(void)")]
#[doc(alias = "__ZN3RBX10ForceFieldC1Ev")]
pub fn stub_0x4f7c58() -> ! {
    todo!("0x4f7c58")
}

// 0x4f7c5c — __ZN3RBX10ForceFieldC2Ev — RBX::ForceField::ForceField(void) — _DWORD __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "RBX::ForceField::ForceField(void)")]
#[doc(alias = "__ZN3RBX10ForceFieldC2Ev")]
pub fn stub_0x4f7c5c() -> ! {
    todo!("0x4f7c5c")
}

// 0x4f7f40 — __ZNK3RBX10ForceField12askSetParentEPKNS_8InstanceE — RBX::ForceField::askSetParent(RBX::Instance const*)const — _DWORD __fastcall(RBX::ForceField *__hidden this, const RBX::Instance *)
#[doc(alias = "RBX::ForceField::askSetParent(RBX::Instance const*)const")]
#[doc(alias = "__ZNK3RBX10ForceField12askSetParentEPKNS_8InstanceE")]
pub fn stub_0x4f7f40() -> ! {
    todo!("0x4f7f40")
}

// 0x4f7f80 — __ZN3RBX18containsForceFieldEPNS_8InstanceE — RBX::containsForceField(RBX::Instance *) — _DWORD __fastcall(RBX *__hidden this, RBX::Instance *)
#[doc(alias = "RBX::containsForceField(RBX::Instance *)")]
#[doc(alias = "__ZN3RBX18containsForceFieldEPNS_8InstanceE")]
pub fn stub_0x4f7f80() -> ! {
    todo!("0x4f7f80")
}

// 0x4f7ff0 — __ZN3RBX26ancestorContainsForceFieldEPNS_8InstanceE — RBX::ancestorContainsForceField(RBX::Instance *) — _DWORD __fastcall(RBX *__hidden this, RBX::Instance *)
#[doc(alias = "RBX::ancestorContainsForceField(RBX::Instance *)")]
#[doc(alias = "__ZN3RBX26ancestorContainsForceFieldEPNS_8InstanceE")]
pub fn stub_0x4f7ff0() -> ! {
    todo!("0x4f7ff0")
}

// 0x4f8094 — __ZN3RBX10ForceField16partInForceFieldEPNS_12PartInstanceE — RBX::ForceField::partInForceField(RBX::PartInstance *) — _DWORD __fastcall(RBX::ForceField *__hidden this, RBX::PartInstance *)
#[doc(alias = "RBX::ForceField::partInForceField(RBX::PartInstance *)")]
#[doc(alias = "__ZN3RBX10ForceField16partInForceFieldEPNS_12PartInstanceE")]
pub fn stub_0x4f8094() -> ! {
    todo!("0x4f8094")
}

// 0x4f80a0 — __ZN3RBX16renderForceFieldEN5boost10shared_ptrINS_8InstanceEEEPNS_5AdornEii — RBX::renderForceField(rbx_core::SharedPtr<RBX::Instance>,RBX::Adorn *,int,int) — int __fastcall(int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, int)
...
#[doc(alias = "__ZN3RBX16renderForceFieldEN5boost10shared_ptrINS_8InstanceEEEPNS_5AdornEii")]
pub fn stub_0x4f80a0() -> ! {
    todo!("0x4f80a0")
}

// 0x4f842c — __ZN3RBX10ForceField13render3dAdornEPNS_5AdornE — RBX::ForceField::render3dAdorn(RBX::Adorn *) — _DWORD __fastcall(RBX::ForceField *__hidden this, RBX::Adorn *)
#[doc(alias = "RBX::ForceField::render3dAdorn(RBX::Adorn *)")]
#[doc(alias = "__ZN3RBX10ForceField13render3dAdornEPNS_5AdornE")]
pub fn stub_0x4f842c() -> ! {
    todo!("0x4f842c")
}

// 0x4f8778 — __ZThn92_N3RBX10ForceField13render3dAdornEPNS_5AdornE — `non-virtual thunk to'RBX::ForceField::render3dAdorn(RBX::Adorn *) — _DWORD __fastcall(RBX::ForceField *__hidden this, RBX::Adorn *)
...
// 0x4f8780 — __ZN3RBX10ForceFieldD1Ev — RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "RBX::ForceField::~ForceField()")]
#[doc(alias = "__ZN3RBX10ForceFieldD1Ev")]
pub fn stub_0x4f8780() -> ! {
    todo!("0x4f8780")
}

// 0x4f8784 — __ZN3RBX10ForceFieldD0Ev — RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "RBX::ForceField::~ForceField()")]
#[doc(alias = "__ZN3RBX10ForceFieldD0Ev")]
...
#[doc(alias = "__ZNK3RBX14FactoryProductINS_10ForceFieldENS_8InstanceELZNS_11sForceFieldEES2_E12getClassNameEv")]
pub fn stub_0x4f8824() -> ! {
    todo!("0x4f8824")
}

// 0x4f8834 — __ZNK3RBX10ForceField19shouldRender3dAdornEv — RBX::ForceField::shouldRender3dAdorn(void)const — _DWORD __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "RBX::ForceField::shouldRender3dAdorn(void)const")]
#[doc(alias = "__ZNK3RBX10ForceField19shouldRender3dAdornEv")]
pub fn stub_0x4f8834() -> ! {
    todo!("0x4f8834")
}

// 0x4f8838 — __ZThn32_N3RBX10ForceFieldD1Ev — `non-virtual thunk to'RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::ForceField::~ForceField()")]
#[doc(alias = "__ZThn32_N3RBX10ForceFieldD1Ev")]
pub fn stub_0x4f8838() -> ! {
    todo!("0x4f8838")
}

// 0x4f8840 — __ZThn32_N3RBX10ForceFieldD0Ev — `non-virtual thunk to'RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::ForceField::~ForceField()")]
#[doc(alias = "__ZThn32_N3RBX10ForceFieldD0Ev")]
...
#[doc(alias = "__ZThn32_NK3RBX14FactoryProductINS_10ForceFieldENS_8InstanceELZNS_11sForceFieldEES2_E12getClassNameEv")]
pub fn stub_0x4f8848() -> ! {
    todo!("0x4f8848")
}

// 0x4f8858 — __ZThn36_N3RBX10ForceFieldD1Ev — `non-virtual thunk to'RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::ForceField::~ForceField()")]
#[doc(alias = "__ZThn36_N3RBX10ForceFieldD1Ev")]
pub fn stub_0x4f8858() -> ! {
    todo!("0x4f8858")
}

// 0x4f8860 — __ZThn36_N3RBX10ForceFieldD0Ev — `non-virtual thunk to'RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::ForceField::~ForceField()")]
#[doc(alias = "__ZThn36_N3RBX10ForceFieldD0Ev")]
pub fn stub_0x4f8860() -> ! {
    todo!("0x4f8860")
}

// 0x4f8868 — __ZThn92_NK3RBX10ForceField19shouldRender3dAdornEv — `non-virtual thunk to'RBX::ForceField::shouldRender3dAdorn(void)const — _DWORD __fastcall(RBX::ForceField *__hidden this)
...
// 0x4f886c — __ZThn116_N3RBX10ForceFieldD1Ev — `non-virtual thunk to'RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::ForceField::~ForceField()")]
#[doc(alias = "__ZThn116_N3RBX10ForceFieldD1Ev")]
pub fn stub_0x4f886c() -> ! {
    todo!("0x4f886c")
}

// 0x4f8874 — __ZThn116_N3RBX10ForceFieldD0Ev — `non-virtual thunk to'RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::ForceField::~ForceField()")]
...
// 0x4f8a48 — __ZThn36_N3RBX18DescribedCreatableINS_10ForceFieldENS_8InstanceELZNS_11sForceFieldEELNS_10Reflection15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev — void __fastcall(int)
...
// 0x4f8ce8 — __ZN3RBX10ForceFieldD2Ev — RBX::ForceField::~ForceField() — void __fastcall(RBX::ForceField *__hidden this)
#[doc(alias = "RBX::ForceField::~ForceField()")]
...
// 0x4f8e28 — __GLOBAL__I_a_198 — `global constructor keyed to'_a_198
#[doc(alias = "global constructor keyed to_a_198")]
#[doc(alias = "__GLOBAL__I_a_198")]
pub fn stub_0x4f8e28() -> ! {
    todo!("0x4f8e28")
}

// 0x4f90d8 — __ZN3RBX5Frame8setStyleENS0_5StyleE — RBX::Frame::setStyle(RBX::Frame::Style) — _DWORD __fastcall(RBX::Frame *__hidden this, Style)
#[doc(alias = "RBX::Frame::setStyle(RBX::Frame::Style)")]
#[doc(alias = "__ZN3RBX5Frame8setStyleENS0_5StyleE")]
pub fn stub_0x4f90d8() -> ! {
    todo!("0x4f90d8")
}

// 0x4f932c — __ZN3RBX5FrameC1Ev — RBX::Frame::Frame(void) — _DWORD __fastcall(RBX::Frame *__hidden this)
#[doc(alias = "RBX::Frame::Frame(void)")]
#[doc(alias = "__ZN3RBX5FrameC1Ev")]
pub fn stub_0x4f932c() -> ! {
    todo!("0x4f932c")
}

// 0x4f9330 — __ZN3RBX5FrameC2Ev — RBX::Frame::Frame(void) — _DWORD __fastcall(RBX::Frame *__hidden this)
#[doc(alias = "RBX::Frame::Frame(void)")]
...
// 0x4f94b8 — __ZNK3RBX5Frame14getChildRect2DEv — RBX::Frame::getChildRect2D(void)const — _DWORD __fastcall(RBX::Frame *__hidden this)
#[doc(alias = "RBX::Frame::getChildRect2D(void)const")]
#[doc(alias = "__ZNK3RBX5Frame14getChildRect2DEv")]
pub fn stub_0x4f94b8() -> ! {
    todo!("0x4f94b8")
}

// 0x4f956c — __ZN3RBX5Frame8render2dEPNS_5AdornE — RBX::Frame::render2d(RBX::Adorn *) — void __fastcall(RBX::Frame *this, RBX::Adorn *)
#[doc(alias = "RBX::Frame::render2d(RBX::Adorn *)")]
#[doc(alias = "__ZN3RBX5Frame8render2dEPNS_5AdornE")]
pub fn stub_0x4f956c() -> ! {
    todo!("0x4f956c")
}

// 0x4f9978 — __ZThn96_N3RBX5Frame8render2dEPNS_5AdornE — `non-virtual thunk to'RBX::Frame::render2d(RBX::Adorn *) — _DWORD __fastcall(RBX::Frame *__hidden this, RBX::Adorn *)
...
// 0x4f9980 — __ZNK3RBX5Frame8getStyleEv — RBX::Frame::getStyle(void)const — _DWORD __fastcall(RBX::Frame *__hidden this)
#[doc(alias = "RBX::Frame::getStyle(void)const")]
#[doc(alias = "__ZNK3RBX5Frame8getStyleEv")]
pub fn stub_0x4f9980() -> ! {
    todo!("0x4f9980")
}
...
#[doc(alias = "__ZNSt12_Vector_baseIN3RBX5Frame5StyleESaIS2_EE11_M_allocateEm")]
pub fn stub_0x4fa214() -> ! {
    todo!("0x4fa214")
}
...
#[doc(alias = "__ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX5Frame5StyleES6_EET0_T_S8_S7_")]
pub fn stub_0x4fa22c() -> ! {
    todo!("0x4fa22c")
}
...
#[doc(alias = "__ZNSt6vectorIN3RBX5Frame5StyleESaIS2_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS2_S4_EEmRKS2_")]
pub fn stub_0x4fa268() -> ! {
    todo!("0x4fa268")
}

// 0x4fac70 — __GLOBAL__I_a_199 — `global constructor keyed to'_a_199
#[doc(alias = "global constructor keyed to_a_199")]
#[doc(alias = "__GLOBAL__I_a_199")]
pub fn stub_0x4fac70() -> ! {
    todo!("0x4fac70")
}

// 0x4faee8 — __ZN3RBX16SecurePlayerGameC1EPNS_4VerbEPKcb — RBX::SecurePlayerGame::SecurePlayerGame(RBX::Verb *,char const*,bool) — _DWORD __fastcall(RBX::SecurePlayerGame *__hidden this, RBX::Verb *, const char *, bool)
#[doc(alias = "RBX::SecurePlayerGame::SecurePlayerGame(RBX::Verb *,char const*,bool)")]
#[doc(alias = "__ZN3RBX16SecurePlayerGameC1EPNS_4VerbEPKcb")]
pub fn stub_0x4faee8() -> ! {
    todo!("0x4faee8")
}

// 0x4faeec — __ZN3RBX16SecurePlayerGameC2EPNS_4VerbEPKcb — RBX::SecurePlayerGame::SecurePlayerGame(RBX::Verb *,char const*,bool) — _DWORD __fastcall(RBX::SecurePlayerGame *__hidden this, RBX::Verb *, const char *, bool)
#[doc(alias = "RBX::SecurePlayerGame::SecurePlayerGame(RBX::Verb *,char const*,bool)")]
#[doc(alias = "__ZN3RBX16SecurePlayerGameC2EPNS_4VerbEPKcb")]
pub fn stub_0x4faeec() -> ! {
    todo!("0x4faeec")
}

// 0x4fafc4 — __ZN3RBX4GameC2EPNS_4VerbEPKcb — RBX::Game::Game(RBX::Verb *,char const*,bool) — _DWORD __fastcall(RBX::Game *__hidden this, RBX::Verb *, const char *, bool)
#[doc(alias = "RBX::Game::Game(RBX::Verb *,char const*,bool)")]
#[doc(alias = "__ZN3RBX4GameC2EPNS_4VerbEPKcb")]
pub fn stub_0x4fafc4() -> ! {
    todo!("0x4fafc4")
}

// 0x4fb85c — __ZN3RBX4GameD2Ev — RBX::Game::~Game() — void __fastcall(RBX::Game *__hidden this)
#[doc(alias = "RBX::Game::~Game()")]
#[doc(alias = "__ZN3RBX4GameD2Ev")]
pub fn stub_0x4fb85c() -> ! {
    todo!("0x4fb85c")
}

// 0x4fba28 — __ZN3RBX19UnsecuredStudioGameC1EPNS_4VerbEPKcb — RBX::UnsecuredStudioGame::UnsecuredStudioGame(RBX::Verb *,char const*,bool) — _DWORD __fastcall(RBX::UnsecuredStudioGame *__hidden this, RBX::Verb *, const char *, bool)
#[doc(alias = "RBX::UnsecuredStudioGame::UnsecuredStudioGame(RBX::Verb *,char const*,bool)")]
#[doc(alias = "__ZN3RBX19UnsecuredStudioGameC1EPNS_4VerbEPKcb")]
pub fn stub_0x4fba28() -> ! {
    todo!("0x4fba28")
}

// 0x4fba2c — __ZN3RBX19UnsecuredStudioGameC2EPNS_4VerbEPKcb — RBX::UnsecuredStudioGame::UnsecuredStudioGame(RBX::Verb *,char const*,bool) — _DWORD __fastcall(RBX::UnsecuredStudioGame *__hidden this, RBX::Verb *, const char *, bool)
#[doc(alias = "RBX::UnsecuredStudioGame::UnsecuredStudioGame(RBX::Verb *,char const*,bool)")]
#[doc(alias = "__ZN3RBX19UnsecuredStudioGameC2EPNS_4VerbEPKcb")]
pub fn stub_0x4fba2c() -> ! {
    todo!("0x4fba2c")
}

// 0x4fbb04 — __ZN3RBX4Game10globalInitEv — RBX::Game::globalInit(void) — _DWORD __fastcall(RBX::Game *__hidden this)
#[doc(alias = "RBX::Game::globalInit(void)")]
#[doc(alias = "__ZN3RBX4Game10globalInitEv")]
pub fn stub_0x4fbb04() -> ! {
    todo!("0x4fbb04")
}

// 0x4fbc68 — __ZN3RBX4Game14setupDataModelERKSs — RBX::Game::setupDataModel(std::string const&) — _DWORD __fastcall(RBX::Game *__hidden this, const std::string *)
...
// 0x4fc0c8 — __ZN3RBX4Game12setDataModelEN5boost10shared_ptrINS_9DataModelEEE — RBX::Game::setDataModel(rbx_core::SharedPtr<RBX::DataModel>) — int __fastcall(int, int)
// was: RBX::Game::setDataModel(boost::shared_ptr<RBX::DataModel>)
#[doc(alias = "RBX::Game::setDataModel(rbx_core::SharedPtr<RBX::DataModel>)")]
#[doc(alias = "__ZN3RBX4Game12setDataModelEN5boost10shared_ptrINS_9DataModelEEE")]
pub fn stub_0x4fc0c8() -> ! {
    todo!("0x4fc0c8")
}
