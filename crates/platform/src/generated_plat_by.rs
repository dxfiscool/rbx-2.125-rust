//! platform — generated_plat_by — 120 stubs EA-sorted asc gap filler not yet in rbx_platform after 0x3d60f4 | Source ida/export.json | range 0x3d63dc..0x3dad48 | rbx_core::SharedPtr not boost
//! Source: ida/export.json (85545 funcs) gap filler next 120 EA-sorted asc not yet stubbed in platform after 0x3d60f4 (global gap filler distinct not in crates/platform/src)
//! Distinct stub_ 38307/85545 -> 38427/85545 | platform | rbx_core::SharedPtr not boost
//! Batch: 120 stubs | range 0x3d63dc..0x3dad48 | rbx_core::SharedPtr not boost
...
// type: int __fastcall(int, int, int)
#[doc(alias = "`non-virtual thunk to'rbx::callable<rbx::signals::signal<void ()(RBX::RunTransition)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::ChangeHistoryService,RBX::RunTransition>,boost::_bi::list2<boost::_bi::value<RBX::ChangeHistoryService*>,boost::arg<1>>>,1,void ()(RBX::RunTransition)>::call(RBX::RunTransition)")]
