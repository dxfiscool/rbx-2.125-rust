//! platform — generated_platform_watchdog_t — 100 stubs EA-sorted asc fallback gap filler
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not yet stubbed in rbx_platform (fallback gap filler after watchdog_s 0x381424..0x387770, iOS/RobloxView/GameViewController/ObjC exhausted -> global gap filler, rbx_core::SharedPtr not boost)
//! Batch: 100 stubs | range 0x387874..0x38c368 | rbx_core::SharedPtr not boost
//! Distinct stub_ 36448/85545 -> 36548/85545 | platform 36448->36548 | uncovered 49098->48998
...
// 0x387a60 — __ZNSt6vectorIN3RBX18PriorityThreadPool12PriorityTaskESaIS2_EE9push_backERKS2_ — std::vector<RBX::PriorityThreadPool::PriorityTask,std::allocator<RBX::PriorityThreadPool::PriorityTask>>::push_back(RBX::PriorityThreadPool::PriorityTask const&)
...
// 0x387e64 — __ZNSt12_Vector_baseIN3RBX18PriorityThreadPool12PriorityTaskESaIS2_EE11_M_allocateEm — std::_Vector_base<RBX::PriorityThreadPool::PriorityTask,std::allocator<RBX::PriorityThreadPool::PriorityTask>>::_M_allocate(unsigned long)
...
// 0x387e88 — __ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN3RBX18PriorityThreadPool12PriorityTaskES6_EET0_T_S8_S7_ — RBX::PriorityThreadPool::PriorityTask * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::PriorityThreadPool::PriorityTask *,RBX::PriorityThreadPool::PriorityTask *>(RBX::PriorityThreadPool::PriorityTask *,RBX::PriorityThreadPool::PriorityTask *,RBX::PriorityThreadPool::PriorityTask *)
...
// 0x387ee8 — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE9push_backERKS7_ — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::push_back(boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)> const&)
// type: int __fastcall(int)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::push_back(boost::function<void ()(boost::shared_ptr<RBX::mutex>)> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_387ee8() -> ! {
    todo!("0x387ee8 __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE9push_backERKS7_")
}

// 0x387f18 — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE16_M_push_back_auxERKS7_ — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::_M_push_back_aux(boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)> const&)
// type: void __fastcall(_DWORD *, int, int, int, int, int, int, int, void *, int)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::_M_push_back_aux(boost::function<void ()(boost::shared_ptr<RBX::mutex>)> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_387f18() -> ! {
    todo!("0x387f18 __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE16_M_push_back_auxERKS7_")
}

// 0x388050 — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE22_M_reserve_map_at_backEm — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::_M_reserve_map_at_back(unsigned long)
// type: _DWORD *__fastcall(_DWORD *result, int)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::_M_reserve_map_at_back(unsigned long) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_388050() -> ! {
    todo!("0x388050 __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE22_M_reserve_map_at_backEm")
}

// 0x38806c — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE17_M_reallocate_mapEmb — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::_M_reallocate_map(unsigned long,bool)
// type: int __fastcall(int, unsigned int, int)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::_M_reallocate_map(unsigned long,bool) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38806c() -> ! {
    todo!("0x38806c __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE17_M_reallocate_mapEmb")
}

// 0x388144 — __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE15_M_allocate_mapEm — std::_Deque_base<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::_M_allocate_map(unsigned long)
// type: int __fastcall(int, unsigned int)
// was: std::_Deque_base<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::_M_allocate_map(unsigned long) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38815c() -> ! {
    todo!("0x38815c __ZN5boost3_bi5list2INS_3argILi1EEENS0_5valueINS_9date_time18subsecond_durationINS_10posix_time13time_durationELx1000EEEEEEclIPFvNS_10shared_ptrINS_6threadEEES9_ENS0_5list1IRSF_EEEEvNS0_4typeIvEERT_RT0_i")
}

// 0x388238 — __ZN5boost3_bi5list1INS_3argILi1EEEEclIPFvNS_10shared_ptrINS_6threadEEEENS1_IRS8_EEEEvNS0_4typeIvEERT_RT0_i — void boost::_bi::list1<boost::arg<1>>::operator()<void (*)(rbx_core::SharedPtr<boost::thread>),boost::_bi::list1<rbx_core::SharedPtr<boost::thread>&>>(boost::_bi::type<void>,void (*)(rbx_core::SharedPtr<boost::thread>) &,boost::_bi::list1<rbx_core::SharedPtr<boost::thread>&> &,int)
// type: void __fastcall(int, void (__fastcall **)(sp_counted_base **), const shared_count **)
// was: void boost::_bi::list1<boost::arg<1>>::operator()<void (*)(boost::shared_ptr<boost::thread>),boost::_bi::list1<boost::shared_ptr<boost::thread>&>>(boost::_bi::type<void>,void (*)(boost::shared_ptr<boost::thread>) &,boost::_bi::list1<boost::shared_ptr<boost::thread>&> &,int) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_388238() -> ! {
    todo!("0x388238 __ZN5boost3_bi5list1INS_3argILi1EEEEclIPFvNS_10shared_ptrINS_6threadEEEENS1_IRS8_EEEEvNS0_4typeIvEERT_RT0_i")
}

// 0x388304 — __ZN5boost9date_time16counted_time_repINS_10posix_time33millisec_posix_time_system_configEEC2ERKNS_9gregorian4dateERKNS2_13time_durationE — boost::date_time::counted_time_rep<boost::posix_time::millisec_posix_time_system_config>::counted_time_rep(boost::gregorian::date const&,boost::posix_time::time_duration const&)
...
pub fn stub_388304() -> ! {
    todo!("0x388304 __ZN5boost9date_time16counted_time_repINS_10posix_time33millisec_posix_time_system_configEEC2ERKNS_9gregorian4dateERKNS2_13time_durationE")
}

// 0x38845c — __ZN5boost9date_time22time_resolution_traitsINS0_37time_resolution_traits_adapted64_implELNS0_16time_resolutionsE5ELx1000000ELt6EiE13to_tick_countEiiix — boost::date_time::time_resolution_traits<boost::date_time::time_resolution_traits_adapted64_impl,(boost::date_time::time_resolutions)5,1000000ll,(unsigned short)6,int>::to_tick_count(int,int,int,long long)
...
pub fn stub_38845c() -> ! {
    todo!("0x38845c __ZN5boost9date_time22time_resolution_traitsINS0_37time_resolution_traits_adapted64_implELNS0_16time_resolutionsE5ELx1000000ELt6EiE13to_tick_countEiiix")
}

// 0x38850c — __ZN5boost10shared_ptrINS_6threadEEC2IS1_EEPT_ — rbx_core::SharedPtr<boost::thread>::shared_ptr<boost::thread>(boost::thread *)
// type: int *__fastcall(int *, int, int, int)
// was: boost::shared_ptr<boost::thread>::shared_ptr<boost::thread>(boost::thread *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38850c() -> ! {
    todo!("0x38850c __ZN5boost10shared_ptrINS_6threadEEC2IS1_EEPT_")
}

// 0x3885e0 — __ZN5boost6detail12shared_countC2INS_6threadEEEPT_ — boost::detail::shared_count::shared_count<boost::thread>(boost::thread *)
...
pub fn stub_3885e0() -> ! {
    todo!("0x3885e0 __ZN5boost6detail12shared_countC2INS_6threadEEEPT_")
}

// 0x3886ec — __ZN5boost6detail17sp_counted_impl_pINS_6threadEED1Ev — boost::detail::sp_counted_impl_p<boost::thread>::~sp_counted_impl_p()
// type: void()
...
pub fn stub_3886ec() -> ! {
    todo!("0x3886ec __ZN5boost6detail17sp_counted_impl_pINS_6threadEED1Ev")
}

// 0x3886f0 — __ZN5boost6detail17sp_counted_impl_pINS_6threadEED0Ev — boost::detail::sp_counted_impl_p<boost::thread>::~sp_counted_impl_p()
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::thread>::~sp_counted_impl_p()")]
#[doc(alias = "__ZN5boost6detail17sp_counted_impl_pINS_6threadEED0Ev")]
pub fn stub_3886f0() -> ! {
    todo!("0x3886f0 __ZN5boost6detail17sp_counted_impl_pINS_6threadEED0Ev")
}

// 0x3886f4 — __ZN5boost6detail17sp_counted_impl_pINS_6threadEE7disposeEv — boost::detail::sp_counted_impl_p<boost::thread>::dispose(void)
...
pub fn stub_3886f4() -> ! {
    todo!("0x3886f4 __ZN5boost6detail17sp_counted_impl_pINS_6threadEE7disposeEv")
}

// 0x388798 — __ZN5boost6detail17sp_counted_impl_pINS_6threadEE11get_deleterERKSt9type_info — boost::detail::sp_counted_impl_p<boost::thread>::get_deleter(std::type_info const&)
// type: int()
...
pub fn stub_388798() -> ! {
    todo!("0x388798 __ZN5boost6detail17sp_counted_impl_pINS_6threadEE11get_deleterERKSt9type_info")
}

// 0x38879c — __ZN5boost6detail17sp_counted_impl_pINS_6threadEE19get_untyped_deleterEv — boost::detail::sp_counted_impl_p<boost::thread>::get_untyped_deleter(void)
// type: int()
...
pub fn stub_38879c() -> ! {
    todo!("0x38879c __ZN5boost6detail17sp_counted_impl_pINS_6threadEE19get_untyped_deleterEv")
}
...
pub fn stub_388934() -> ! {
    todo!("0x388934 __ZN5boost6detail13heap_new_implINS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS5_INS6_5mutexEEEENS3_5list2INS3_5valueIS9_EENSF_ISB_EEEEEEEERSJ_EEPT_T0_")
}
...
pub fn stub_388ab8() -> ! {
    todo!("0x388ab8 __ZN5boost6detail11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS4_INS5_5mutexEEEENS2_5list2INS2_5valueIS8_EENSE_ISA_EEEEEEEC2ESI_")
}

// 0x388bec — __ZN5boost6detail11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS4_INS5_5mutexEEEENS2_5list2INS2_5valueIS8_EENSE_ISA_EEEEEEED1Ev — boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>,rbx_core::SharedPtr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>>>::~thread_data()
// type: int __fastcall(boost::detail::thread_data_base *)
// was: boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::BaseThreadPool::PoolData>,boost::shared_ptr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>>>::~thread_data() (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_388bec() -> ! {
    todo!("0x388bec __ZN5boost6detail11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS4_INS5_5mutexEEEENS2_5list2INS2_5valueIS8_EENSE_ISA_EEEEEEED1Ev")
}
...
pub fn stub_388cec() -> ! {
    todo!("0x388cec __ZN5boost6detail11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS4_INS5_5mutexEEEENS2_5list2INS2_5valueIS8_EENSE_ISA_EEEEEEED0Ev")
}

// 0x388dfc — __ZN5boost6detail11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS4_INS5_5mutexEEEENS2_5list2INS2_5valueIS8_EENSE_ISA_EEEEEEE3runEv — boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>,rbx_core::SharedPtr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>>>::run(void)
// was: boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::BaseThreadPool::PoolData>,boost::shared_ptr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>>>::run(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_388f28() -> ! {
    todo!("0x388f28 __ZN5boost10shared_ptrINS_6detail16thread_data_baseEEC2INS1_11thread_dataINS_3_bi6bind_tIvPFvNS0_IN3RBX14BaseThreadPool8PoolDataEEENS0_INS8_5mutexEEEENS6_5list2INS6_5valueISB_EENSH_ISD_EEEEEEEEEEPT_")
}
...
pub fn stub_389010() -> ! {
    todo!("0x389010 __ZNK5boost23enable_shared_from_thisINS_6detail16thread_data_baseEE22_internal_accept_ownerIS2_NS1_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS8_INS9_5mutexEEEENS6_5list2INS6_5valueISC_EENSI_ISE_EEEEEEEEEEvPKNS8_IT_EEPT0_")
}
...
pub fn stub_389134() -> ! {
    todo!("0x389134 __ZN5boost6detail12shared_countC2INS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS6_INS7_5mutexEEEENS4_5list2INS4_5valueISA_EENSG_ISC_EEEEEEEEEEPT_")
}
...
pub fn stub_38922c() -> ! {
    todo!("0x38922c __ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS5_INS6_5mutexEEEENS3_5list2INS3_5valueIS9_EENSF_ISB_EEEEEEEEED1Ev")
}
...
pub fn stub_389230() -> ! {
    todo!("0x389230 __ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS5_INS6_5mutexEEEENS3_5list2INS3_5valueIS9_EENSF_ISB_EEEEEEEEED0Ev")
}
...
// type: int __fastcall(int)
// was: boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::BaseThreadPool::PoolData>,boost::shared_ptr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>>>>::dispose(void) (boost::shared_ptr -> rbx_core::SharedPtr)
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>,rbx_core::SharedPtr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>>>>::dispose(void)")]
...
pub fn stub_389234() -> ! {
    todo!("0x389234 __ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS5_INS6_5mutexEEEENS3_5list2INS3_5valueIS9_EENSF_ISB_EEEEEEEEE7disposeEv")
}
...
// type: int()
// was: boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::BaseThreadPool::PoolData>,boost::shared_ptr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>>>>::get_deleter(std::type_info const&) (boost::shared_ptr -> rbx_core::SharedPtr)
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>,rbx_core::SharedPtr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>>>>::get_deleter(std::type_info const&)")]
...
pub fn stub_389244() -> ! {
    todo!("0x389244 __ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS5_INS6_5mutexEEEENS3_5list2INS3_5valueIS9_EENSF_ISB_EEEEEEEEE11get_deleterERKSt9type_info")
}
...
// type: int()
// was: boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(boost::shared_ptr<RBX::BaseThreadPool::PoolData>,boost::shared_ptr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>>>>::get_untyped_deleter(void) (boost::shared_ptr -> rbx_core::SharedPtr)
#[doc(alias = "boost::detail::sp_counted_impl_p<boost::detail::thread_data<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>,rbx_core::SharedPtr<RBX::mutex>),boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>>>>::get_untyped_deleter(void)")]
...
pub fn stub_389248() -> ! {
    todo!("0x389248 __ZN5boost6detail17sp_counted_impl_pINS0_11thread_dataINS_3_bi6bind_tIvPFvNS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEENS5_INS6_5mutexEEEENS3_5list2INS3_5valueIS9_EENSF_ISB_EEEEEEEEE19get_untyped_deleterEv")
}

// 0x38924c — __ZN5boost3_bi5list2INS0_5valueINS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEEEENS2_INS3_INS4_5mutexEEEEEEC2ES8_SB_ — boost::_bi::list2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>::list2(boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>)
// type: void __fastcall __spoils<R1,R2,R3,R12,LR>(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
// was: boost::_bi::list2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>::list2(boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38924c() -> ! {
    todo!("0x38924c __ZN5boost3_bi5list2INS0_5valueINS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEEEENS2_INS3_INS4_5mutexEEEEEEC2ES8_SB_")
}

// 0x389364 — __ZN5boost3_bi8storage2INS0_5valueINS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEEEENS2_INS3_INS4_5mutexEEEEEEC2ES8_SB_ — boost::_bi::storage2<boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>>::storage2(boost::_bi::value<rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<rbx_core::SharedPtr<RBX::mutex>>)
...
// was: boost::_bi::storage2<boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>>::storage2(boost::_bi::value<boost::shared_ptr<RBX::BaseThreadPool::PoolData>>,boost::_bi::value<boost::shared_ptr<RBX::mutex>>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389364() -> ! {
    todo!("0x389364 __ZN5boost3_bi8storage2INS0_5valueINS_10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEEEENS2_INS3_INS4_5mutexEEEEEEC2ES8_SB_")
}

// 0x389480 — __ZN5boost10shared_ptrIN3RBX5mutexEEC2IS2_EEPT_ — rbx_core::SharedPtr<RBX::mutex>::shared_ptr<RBX::mutex>(RBX::mutex *)
// type: int *__fastcall(int *, int, int, int)
// was: boost::shared_ptr<RBX::mutex>::shared_ptr<RBX::mutex>(RBX::mutex *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389480() -> ! {
    todo!("0x389480 __ZN5boost10shared_ptrIN3RBX5mutexEEC2IS2_EEPT_")
}

// 0x389554 — __ZN5boost6detail12shared_countC2IN3RBX5mutexEEEPT_ — boost::detail::shared_count::shared_count<RBX::mutex>(RBX::mutex *)
// type: _DWORD *__fastcall(_DWORD *, int, int, int, void *, int)
...
pub fn stub_389554() -> ! {
    todo!("0x389554 __ZN5boost6detail12shared_countC2IN3RBX5mutexEEEPT_")
}

// 0x389660 — __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEED1Ev — boost::detail::sp_counted_impl_p<RBX::mutex>::~sp_counted_impl_p()
// type: void()
...
pub fn stub_389660() -> ! {
    todo!("0x389660 __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEED1Ev")
}

// 0x389664 — __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEED0Ev — boost::detail::sp_counted_impl_p<RBX::mutex>::~sp_counted_impl_p()
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_p<RBX::mutex>::~sp_counted_impl_p()")]
#[doc(alias = "__ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEED0Ev")]
pub fn stub_389664() -> ! {
    todo!("0x389664 __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEED0Ev")
}

// 0x389668 — __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEE7disposeEv — boost::detail::sp_counted_impl_p<RBX::mutex>::dispose(void)
// type: void __fastcall(int)
...
pub fn stub_389668() -> ! {
    todo!("0x389668 __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEE7disposeEv")
}

// 0x38970c — __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEE11get_deleterERKSt9type_info — boost::detail::sp_counted_impl_p<RBX::mutex>::get_deleter(std::type_info const&)
// type: int()
...
pub fn stub_38970c() -> ! {
    todo!("0x38970c __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEE11get_deleterERKSt9type_info")
}

// 0x389710 — __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEE19get_untyped_deleterEv — boost::detail::sp_counted_impl_p<RBX::mutex>::get_untyped_deleter(void)
// type: int()
...
pub fn stub_389710() -> ! {
    todo!("0x389710 __ZN5boost6detail17sp_counted_impl_pIN3RBX5mutexEE19get_untyped_deleterEv")
}

// 0x389714 — __ZNSt6vectorIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EE15_M_erase_at_endEPS4_ — std::vector<rbx_core::SharedPtr<RBX::mutex>,std::allocator<rbx_core::SharedPtr<RBX::mutex>>>::_M_erase_at_end(rbx_core::SharedPtr<RBX::mutex>*)
// type: boost::detail::sp_counted_base *__fastcall(boost::detail::sp_counted_base *result, int)
// was: std::vector<boost::shared_ptr<RBX::mutex>,std::allocator<boost::shared_ptr<RBX::mutex>>>::_M_erase_at_end(boost::shared_ptr<RBX::mutex>*) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389714() -> ! {
    todo!("0x389714 __ZNSt6vectorIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EE15_M_erase_at_endEPS4_")
}

// 0x389744 — __ZNSt6vectorIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS4_S6_EEmRKS4_ — std::vector<rbx_core::SharedPtr<RBX::mutex>,std::allocator<rbx_core::SharedPtr<RBX::mutex>>>::_M_fill_insert(__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::mutex>*,std::vector<rbx_core::SharedPtr<RBX::mutex>,std::allocator<rbx_core::SharedPtr<RBX::mutex>>>>,unsigned long,rbx_core::SharedPtr<RBX::mutex> const&)
// type: void __fastcall(int *, struct _Unwind_Exception *, int, const shared_count *)
// was: std::vector<boost::shared_ptr<RBX::mutex>,std::allocator<boost::shared_ptr<RBX::mutex>>>::_M_fill_insert(__gnu_cxx::__normal_iterator<boost::shared_ptr<RBX::mutex>*,std::vector<boost::shared_ptr<RBX::mutex>,std::allocator<boost::shared_ptr<RBX::mutex>>>>,unsigned long,boost::shared_ptr<RBX::mutex> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389744() -> ! {
    todo!("0x389744 __ZNSt6vectorIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS4_S6_EEmRKS4_")
}

// 0x389d44 — __ZNSt12_Vector_baseIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EE11_M_allocateEm — std::_Vector_base<rbx_core::SharedPtr<RBX::mutex>,std::allocator<rbx_core::SharedPtr<RBX::mutex>>>::_M_allocate(unsigned long)
// type: int __fastcall(int, unsigned int)
// was: std::_Vector_base<boost::shared_ptr<RBX::mutex>,std::allocator<boost::shared_ptr<RBX::mutex>>>::_M_allocate(unsigned long) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389d44() -> ! {
    todo!("0x389d44 __ZNSt12_Vector_baseIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EE11_M_allocateEm")
}

// 0x389d5c — __ZSt26__uninitialized_fill_n_auxIPN5boost10shared_ptrIN3RBX5mutexEEEmS4_EvT_T0_RKT1_St12__false_type — void std::__uninitialized_fill_n_aux<rbx_core::SharedPtr<RBX::mutex> *,unsigned long,rbx_core::SharedPtr<RBX::mutex>>(rbx_core::SharedPtr<RBX::mutex> *,unsigned long,rbx_core::SharedPtr<RBX::mutex> const&,std::__false_type)
// type: void __fastcall(int, int, shared_count *, int, int, int, int, int, void *, int)
// was: void std::__uninitialized_fill_n_aux<boost::shared_ptr<RBX::mutex> *,unsigned long,boost::shared_ptr<RBX::mutex>>(boost::shared_ptr<RBX::mutex> *,unsigned long,boost::shared_ptr<RBX::mutex> const&,std::__false_type) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389d5c() -> ! {
    todo!("0x389d5c __ZSt26__uninitialized_fill_n_auxIPN5boost10shared_ptrIN3RBX5mutexEEEmS4_EvT_T0_RKT1_St12__false_type")
}

// 0x389e84 — __ZN5boost10shared_ptrIN3RBX5mutexEEaSERKS3_ — rbx_core::SharedPtr<RBX::mutex>::operator=(rbx_core::SharedPtr<RBX::mutex> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
// was: boost::shared_ptr<RBX::mutex>::operator=(boost::shared_ptr<RBX::mutex> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389e84() -> ! {
    todo!("0x389e84 __ZN5boost10shared_ptrIN3RBX5mutexEEaSERKS3_")
}

// 0x389ebc — __ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN5boost10shared_ptrIN3RBX5mutexEEES8_EET0_T_SA_S9_ — rbx_core::SharedPtr<RBX::mutex> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<rbx_core::SharedPtr<RBX::mutex> *,rbx_core::SharedPtr<RBX::mutex> *>(rbx_core::SharedPtr<RBX::mutex> *,rbx_core::SharedPtr<RBX::mutex> *,rbx_core::SharedPtr<RBX::mutex> *)
// type: int __fastcall(int, int, int)
// was: boost::shared_ptr<RBX::mutex> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<boost::shared_ptr<RBX::mutex> *,boost::shared_ptr<RBX::mutex> *>(boost::shared_ptr<RBX::mutex> *,boost::shared_ptr<RBX::mutex> *,boost::shared_ptr<RBX::mutex> *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389ebc() -> ! {
    todo!("0x389ebc __ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN5boost10shared_ptrIN3RBX5mutexEEES8_EET0_T_SA_S9_")
}

// 0x389f0c — __ZNSt6vectorIN5boost10shared_ptrINS0_6threadEEESaIS3_EE15_M_erase_at_endEPS3_ — std::vector<rbx_core::SharedPtr<boost::thread>,std::allocator<rbx_core::SharedPtr<boost::thread>>>::_M_erase_at_end(rbx_core::SharedPtr<boost::thread>*)
// type: boost::detail::sp_counted_base *__fastcall(boost::detail::sp_counted_base *result, int)
// was: std::vector<boost::shared_ptr<boost::thread>,std::allocator<boost::shared_ptr<boost::thread>>>::_M_erase_at_end(boost::shared_ptr<boost::thread>*) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_389f0c() -> ! {
    todo!("0x389f0c __ZNSt6vectorIN5boost10shared_ptrINS0_6threadEEESaIS3_EE15_M_erase_at_endEPS3_")
}
...
pub fn stub_389f3c() -> ! {
    todo!("0x389f3c __ZNSt6vectorIN5boost10shared_ptrINS0_6threadEEESaIS3_EE14_M_fill_insertEN9__gnu_cxx17__normal_iteratorIPS3_S5_EEmRKS3_")
}

// 0x38a53c — __ZNSt12_Vector_baseIN5boost10shared_ptrINS0_6threadEEESaIS3_EE11_M_allocateEm — std::_Vector_base<rbx_core::SharedPtr<boost::thread>,std::allocator<rbx_core::SharedPtr<boost::thread>>>::_M_allocate(unsigned long)
// type: int __fastcall(int, unsigned int)
// was: std::_Vector_base<boost::shared_ptr<boost::thread>,std::allocator<boost::shared_ptr<boost::thread>>>::_M_allocate(unsigned long) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a53c() -> ! {
    todo!("0x38a53c __ZNSt12_Vector_baseIN5boost10shared_ptrINS0_6threadEEESaIS3_EE11_M_allocateEm")
}
...
// type: void __fastcall(int, int, shared_count *, int, int, int, int, int, void *, int)
// was: void std::__uninitialized_fill_n_aux<boost::shared_ptr<boost::thread> *,unsigned long,boost::shared_ptr<boost::thread>>(boost::shared_ptr<boost::thread> *,unsigned long,boost::shared_ptr<boost::thread> const&,std::__false_type) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a554() -> ! {
    todo!("0x38a554 __ZSt26__uninitialized_fill_n_auxIPN5boost10shared_ptrINS0_6threadEEEmS3_EvT_T0_RKT1_St12__false_type")
}

// 0x38a67c — __ZN5boost10shared_ptrINS_6threadEEaSERKS2_ — rbx_core::SharedPtr<boost::thread>::operator=(rbx_core::SharedPtr<boost::thread> const&)
// type: sp_counted_base **__fastcall(sp_counted_base **, const shared_count *)
// was: boost::shared_ptr<boost::thread>::operator=(boost::shared_ptr<boost::thread> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a67c() -> ! {
    todo!("0x38a67c __ZN5boost10shared_ptrINS_6threadEEaSERKS2_")
}

// 0x38a6b4 — __ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN5boost10shared_ptrINS3_6threadEEES7_EET0_T_S9_S8_ — rbx_core::SharedPtr<boost::thread> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<rbx_core::SharedPtr<boost::thread> *,rbx_core::SharedPtr<boost::thread> *>(rbx_core::SharedPtr<boost::thread> *,rbx_core::SharedPtr<boost::thread> *,rbx_core::SharedPtr<boost::thread> *)
// type: int __fastcall(int, int, int)
// was: boost::shared_ptr<boost::thread> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<boost::shared_ptr<boost::thread> *,boost::shared_ptr<boost::thread> *>(boost::shared_ptr<boost::thread> *,boost::shared_ptr<boost::thread> *,boost::shared_ptr<boost::thread> *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a6b4() -> ! {
    todo!("0x38a6b4 __ZNSt15__copy_backwardILb0ESt26random_access_iterator_tagE8__copy_bIPN5boost10shared_ptrINS3_6threadEEES7_EET0_T_S9_S8_")
}

// 0x38a704 — __ZNSt6vectorIN5boost10shared_ptrINS0_6threadEEESaIS3_EED2Ev — std::vector<rbx_core::SharedPtr<boost::thread>,std::allocator<rbx_core::SharedPtr<boost::thread>>>::~vector()
// type: int __fastcall(int)
// was: std::vector<boost::shared_ptr<boost::thread>,std::allocator<boost::shared_ptr<boost::thread>>>::~vector() (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a704() -> ! {
    todo!("0x38a704 __ZNSt6vectorIN5boost10shared_ptrINS0_6threadEEESaIS3_EED2Ev")
}

// 0x38a7d0 — __ZNSt6vectorIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EED2Ev — std::vector<rbx_core::SharedPtr<RBX::mutex>,std::allocator<rbx_core::SharedPtr<RBX::mutex>>>::~vector()
// type: int __fastcall(int)
// was: std::vector<boost::shared_ptr<RBX::mutex>,std::allocator<boost::shared_ptr<RBX::mutex>>>::~vector() (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a7d0() -> ! {
    todo!("0x38a7d0 __ZNSt6vectorIN5boost10shared_ptrIN3RBX5mutexEEESaIS4_EED2Ev")
}

// 0x38a89c — __ZN5boost10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEC2IS3_EEPT_ — rbx_core::SharedPtr<RBX::BaseThreadPool::PoolData>::shared_ptr<RBX::BaseThreadPool::PoolData>(RBX::BaseThreadPool::PoolData *)
// type: int *__fastcall(int *, int, int, int)
// was: boost::shared_ptr<RBX::BaseThreadPool::PoolData>::shared_ptr<RBX::BaseThreadPool::PoolData>(RBX::BaseThreadPool::PoolData *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38a89c() -> ! {
    todo!("0x38a89c __ZN5boost10shared_ptrIN3RBX14BaseThreadPool8PoolDataEEC2IS3_EEPT_")
}

// 0x38a970 — __ZN5boost6detail12shared_countC2IN3RBX14BaseThreadPool8PoolDataEEEPT_ — boost::detail::shared_count::shared_count<RBX::BaseThreadPool::PoolData>(RBX::BaseThreadPool::PoolData *)
// type: _DWORD *__fastcall(_DWORD *, int, int, int, void *, int)
...
pub fn stub_38a970() -> ! {
    todo!("0x38a970 __ZN5boost6detail12shared_countC2IN3RBX14BaseThreadPool8PoolDataEEEPT_")
}

// 0x38aa68 — __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEED1Ev — boost::detail::sp_counted_impl_p<RBX::BaseThreadPool::PoolData>::~sp_counted_impl_p()
// type: void()
...
pub fn stub_38aa68() -> ! {
    todo!("0x38aa68 __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEED1Ev")
}

// 0x38aa6c — __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEED0Ev — boost::detail::sp_counted_impl_p<RBX::BaseThreadPool::PoolData>::~sp_counted_impl_p()
// type: int __fastcall(int)
#[doc(alias = "boost::detail::sp_counted_impl_p<RBX::BaseThreadPool::PoolData>::~sp_counted_impl_p()")]
#[doc(alias = "__ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEED0Ev")]
pub fn stub_38aa6c() -> ! {
    todo!("0x38aa6c __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEED0Ev")
}

// 0x38aa70 — __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEE7disposeEv — boost::detail::sp_counted_impl_p<RBX::BaseThreadPool::PoolData>::dispose(void)
// type: int __fastcall(int)
...
pub fn stub_38aa70() -> ! {
    todo!("0x38aa70 __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEE7disposeEv")
}

// 0x38aa80 — __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEE11get_deleterERKSt9type_info — boost::detail::sp_counted_impl_p<RBX::BaseThreadPool::PoolData>::get_deleter(std::type_info const&)
// type: int()
...
pub fn stub_38aa80() -> ! {
    todo!("0x38aa80 __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEE11get_deleterERKSt9type_info")
}

// 0x38aa84 — __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEE19get_untyped_deleterEv — boost::detail::sp_counted_impl_p<RBX::BaseThreadPool::PoolData>::get_untyped_deleter(void)
// type: int()
...
pub fn stub_38aa84() -> ! {
    todo!("0x38aa84 __ZN5boost6detail17sp_counted_impl_pIN3RBX14BaseThreadPool8PoolDataEE19get_untyped_deleterEv")
}

// 0x38aa88 — __ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEE13assign_to_ownERKS5_ — boost::function1<void,rbx_core::SharedPtr<RBX::mutex>>::assign_to_own(boost::function1<void,rbx_core::SharedPtr<RBX::mutex>> const&)
// type: int __fastcall(int result, int *)
// was: boost::function1<void,boost::shared_ptr<RBX::mutex>>::assign_to_own(boost::function1<void,boost::shared_ptr<RBX::mutex>> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38aa88() -> ! {
    todo!("0x38aa88 __ZN5boost9function1IvNS_10shared_ptrIN3RBX5mutexEEEE13assign_to_ownERKS5_")
}

// 0x38aab8 — __ZN3RBX14BaseThreadPool8PoolDataD2Ev — RBX::BaseThreadPool::PoolData::~PoolData()
...
// 0x38ab90 — __ZN3RBX14BaseThreadPool8PoolDataD1Ev — RBX::BaseThreadPool::PoolData::~PoolData()
// type: void __fastcall(RBX::BaseThreadPool::PoolData *__hidden this)
#[doc(alias = "RBX::BaseThreadPool::PoolData::~PoolData()")]
...
// 0x38ab94 — __ZN3RBX14BaseThreadPool8PoolDataD0Ev — RBX::BaseThreadPool::PoolData::~PoolData()
// type: void __fastcall(RBX::BaseThreadPool::PoolData *__hidden this)
#[doc(alias = "RBX::BaseThreadPool::PoolData::~PoolData()")]
...
// 0x38ac34 — __ZNSt6vectorIN3RBX18PriorityThreadPool12PriorityTaskESaIS2_EED2Ev — std::vector<RBX::PriorityThreadPool::PriorityTask,std::allocator<RBX::PriorityThreadPool::PriorityTask>>::~vector()
...
// 0x38ad00 — __ZN3RBX14BaseThreadPool8PoolDataC2Ev — RBX::BaseThreadPool::PoolData::PoolData(void)
...
// 0x38add0 — __ZN3RBX10ThreadPool14ThreadPoolDataD1Ev — RBX::ThreadPool::ThreadPoolData::~ThreadPoolData()
...
// 0x38aec4 — __ZN3RBX10ThreadPool14ThreadPoolDataD0Ev — RBX::ThreadPool::ThreadPoolData::~ThreadPoolData()
// type: void __fastcall(RBX::ThreadPool::ThreadPoolData *__hidden this)
#[doc(alias = "RBX::ThreadPool::ThreadPoolData::~ThreadPoolData()")]
...
// 0x38afc8 — __ZN3RBX10ThreadPool14ThreadPoolData11getNextTaskERN5boost8functionIFvNS2_10shared_ptrINS_5mutexEEEEEE — RBX::ThreadPool::ThreadPoolData::getNextTask(boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)> &)
// type: int __fastcall(int)
// was: RBX::ThreadPool::ThreadPoolData::getNextTask(boost::function<void ()(boost::shared_ptr<RBX::mutex>)> &) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38afc8() -> ! {
    todo!("0x38afc8 __ZN3RBX10ThreadPool14ThreadPoolData11getNextTaskERN5boost8functionIFvNS2_10shared_ptrINS_5mutexEEEEEE")
}

// 0x38afd4 — __ZN3rbx10safe_queueIN5boost8functionIFvNS1_10shared_ptrIN3RBX5mutexEEEEEEE14pop_if_presentERS8_ — rbx::safe_queue<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>::pop_if_present(boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>&)
// type: int __fastcall(int, int)
// was: rbx::safe_queue<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>::pop_if_present(boost::function<void ()(boost::shared_ptr<RBX::mutex>)>&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38afd4() -> ! {
    todo!("0x38afd4 __ZN3rbx10safe_queueIN5boost8functionIFvNS1_10shared_ptrIN3RBX5mutexEEEEEEE14pop_if_presentERS8_")
}

// 0x38b0b4 — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE9pop_frontEv — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::pop_front(void)
// type: int __fastcall(int)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::pop_front(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38b0b4() -> ! {
    todo!("0x38b0b4 __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE9pop_frontEv")
}

// 0x38b0ec — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EED2Ev — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::~deque()
// type: int __fastcall(_DWORD *, int, int, int)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::~deque() (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38b0ec() -> ! {
    todo!("0x38b0ec __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EED2Ev")
}

// 0x38b1d4 — __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EED2Ev — std::_Deque_base<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::~_Deque_base()
// type: int __fastcall(int)
// was: std::_Deque_base<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::~_Deque_base() (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38b1d4() -> ! {
    todo!("0x38b1d4 __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EED2Ev")
}
...
pub fn stub_38b200() -> ! {
    todo!("0x38b200 __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE19_M_destroy_data_auxESt15_Deque_iteratorIS7_RS7_PS7_ESD_")
}

// 0x38b338 — __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE17_M_initialize_mapEm — std::_Deque_base<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::_M_initialize_map(unsigned long)
// type: void __fastcall(int *, unsigned int, int, int, struct _Unwind_Exception *lpuexcpt, int, int, int, void *, int)
// was: std::_Deque_base<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::_M_initialize_map(unsigned long) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38b338() -> ! {
    todo!("0x38b338 __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE17_M_initialize_mapEm")
}

// 0x38b490 — __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE15_M_create_nodesEPPS7_SB_ — std::_Deque_base<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::_M_create_nodes(boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>**,boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>**)
// type: void __fastcall(int, _DWORD *, unsigned int, int, void *, int)
// was: std::_Deque_base<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::_M_create_nodes(boost::function<void ()(boost::shared_ptr<RBX::mutex>)>**,boost::function<void ()(boost::shared_ptr<RBX::mutex>)>**) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_38b490() -> ! {
    todo!("0x38b490 __ZNSt11_Deque_baseIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EE15_M_create_nodesEPPS7_SB_")
}

// 0x38b584 — __ZNSt5dequeIN5boost8functionIFvNS0_10shared_ptrIN3RBX5mutexEEEEEESaIS7_EEC2ERKS9_ — std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>>::deque(std::deque<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>,std::allocator<boost::function<void ()(rbx_core::SharedPtr<RBX::mutex>)>>> const&)
// type: int __fastcall(int, _DWORD *)
// was: std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>>::deque(std::deque<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,std::allocator<boost::function<void ()(boost::shared_ptr<RBX::mutex>)>>> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// 0x38b808 — __ZN3RBX15StringConverterINS_4UDimEE15convertToStringERKS1_ — RBX::StringConverter<RBX::UDim>::convertToString(RBX::UDim const&)
...
// 0x38b970 — __ZN3RBX15StringConverterINS_4UDimEE14convertToValueERKSsRS1_ — RBX::StringConverter<RBX::UDim>::convertToValue(std::string const&,RBX::UDim&)
...
// 0x38ba5c — __ZN3RBX15StringConverterINS_5UDim2EE15convertToStringERKS1_ — RBX::StringConverter<RBX::UDim2>::convertToString(RBX::UDim2 const&)
...
// 0x38be8c — __ZN3RBX15StringConverterINS_5UDim2EE14convertToValueERKSsRS1_ — RBX::StringConverter<RBX::UDim2>::convertToValue(std::string const&,RBX::UDim2&)
// type: int __fastcall(std::string *, int)
...
// 0x38c0e8 — __ZNK3RBX4UDimplERKS0_ — RBX::UDim::operator+(RBX::UDim const&)const
...
// 0x38c108 — __ZNK3RBX4UDimmiERKS0_ — RBX::UDim::operator-(RBX::UDim const&)const
// type: int __fastcall(int result, int, int)
#[doc(alias = "RBX::UDim::operator-(RBX::UDim const&)const")]
...
// 0x38c128 — __ZNK3RBX4UDimngEv — RBX::UDim::operator-(void)const
// type: int __fastcall(int result, int)
...
// 0x38c140 — __ZNK3RBX5UDim2mlEN3G3D7Vector2E — RBX::UDim2::operator*(G3D::Vector2)const
...
pub fn stub_38c140() -> ! {
    todo!("0x38c140 __ZNK3RBX5UDim2mlEN3G3D7Vector2E")
}

// 0x38c188 — __ZNK3RBX5UDim2mlEf — RBX::UDim2::operator*(float)const
// type: _DWORD *__fastcall(_DWORD *result, int, __int32)
...
// 0x38c1e4 — __ZNK3RBX5UDim2plERKS0_ — RBX::UDim2::operator+(RBX::UDim2 const&)const
...
// 0x38c224 — __ZNK3RBX5UDim2miERKS0_ — RBX::UDim2::operator-(RBX::UDim2 const&)const
// type: _DWORD *__fastcall(_DWORD *result, int, int)
#[doc(alias = "RBX::UDim2::operator-(RBX::UDim2 const&)const")]
...
// 0x38c264 — __ZNK3RBX5UDim2ngEv — RBX::UDim2::operator-(void)const
// type: _DWORD *__fastcall(_DWORD *result, int)
...
#[doc(alias = "`global constructor keyed to'_a_147")]
#[doc(alias = "__GLOBAL__I_a_147")]
pub fn stub_38c294() -> ! {
    todo!("0x38c294 __GLOBAL__I_a_147")
}

// 0x38c35c — __ZNK3RBX7UIEvent18isTextCharacterKeyEv — RBX::UIEvent::isTextCharacterKey(void)const
...
// 0x38c368 — __ZNK3RBX7UIEvent10isAltEventEv — RBX::UIEvent::isAltEvent(void)const
