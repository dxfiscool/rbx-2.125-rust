//! platform — generated_plat_bx — 100 stubs EA-sorted asc fallback gap filler | Source ida/export.json | range 0x3d0738..0x3d60f4 | rbx_core::SharedPtr not boost
//! Source: ida/export.json (85545 funcs) global gap filler next 100 EA-sorted asc not yet stubbed in platform after 0x3d0737 (fallback global gap filler distinct not in crates/platform/src)
//! Distinct 38208/85545 -> 38308/85545 | platform | rbx_core::SharedPtr not boost
//! Batch: 100 stubs | range 0x3d0738..0x3d60f4 | rbx_core::SharedPtr not boost
...
// was: RBX::ChangeHistoryService::reportMissedPhysicsChanges(boost::shared_ptr<RBX::Instance>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: RBX::ChangeHistoryService::onItemAdded(boost::shared_ptr<RBX::Instance>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: RBX::ChangeHistoryService::onItemRemoved(boost::shared_ptr<RBX::Instance>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: RBX::ChangeHistoryService::onItemChanged(boost::shared_ptr<RBX::Instance>,RBX::Reflection::PropertyDescriptor const*) (boost::shared_ptr -> rbx_core::SharedPtr)
