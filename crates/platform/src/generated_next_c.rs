//! platform — generated_next_c — 100 stubs EA-sorted asc global gap filler
//! Source: ida/export.json (85545 funcs) global gap filler next 100 after 0x416f78 not yet in crates/platform/src
//! Batch: 100 stubs | range 0x417060..0x41d210 | rbx_core::SharedPtr not boost
...
#[doc(alias = "rbx_core::SharedPtr::shared_count<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter)")]
pub fn stub_417060() -> ! {
    todo!("0x417060 rbx_core::SharedPtr::shared_count<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0x417168 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX13ConfigurationENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// type: void()
#[doc(alias = "rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_417168() -> ! {
    todo!("0x417168 rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
#[doc(alias = "rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_41716c() -> ! {
    todo!("0x41716c rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
#[doc(alias = "rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")]
pub fn stub_417170() -> ! {
    todo!("0x417170 rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
#[doc(alias = "rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")]
pub fn stub_417190() -> ! {
    todo!("0x417190 rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
// type: int __fastcall(int)
#[doc(alias = "rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")]
pub fn stub_4171a8() -> ! {
    todo!("0x4171a8 rbx_core::SharedPtr<RBX::Configuration *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
// type: _DWORD *__fastcall(_DWORD *, int, int, int, void *, int)
#[doc(alias = "rbx_core::SharedPtr::shared_count<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter)")]
pub fn stub_418778() -> ! {
    todo!("0x418778 rbx_core::SharedPtr::shared_count<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0x418880 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX19CornerWedgeInstanceENS2_9CreatableINS2_8InstanceEE7DeleterEED1Ev
// type: void()
#[doc(alias = "rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_418880() -> ! {
    todo!("0x418880 rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
#[doc(alias = "rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_418884() -> ! {
    todo!("0x418884 rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
// type: int __fastcall(int, RBX::Instance *)
#[doc(alias = "rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")]
pub fn stub_418888() -> ! {
    todo!("0x418888 rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
// type: int __fastcall(int, int)
#[doc(alias = "rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")]
pub fn stub_4188a8() -> ! {
    todo!("0x4188a8 rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
// type: int __fastcall(int)
#[doc(alias = "rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")]
pub fn stub_4188c0() -> ! {
    todo!("0x4188c0 rbx_core::SharedPtr<RBX::CornerWedgeInstance *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
