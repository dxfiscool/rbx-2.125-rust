//! platform — generated_next_f — 150 stubs EA-sorted asc global gap filler
//! Source: ida/export.json (85545 funcs) global gap filler next 150 after 0x311a4 not yet in crates/platform/src
//! Batch: 150 stubs | range 0x311a4..0x3cb38 | rbx_core::SharedPtr not boost
...
// type: int(void)
// was: int(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: void __fastcall(int, int, int, int, char, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int) (boost::shared_ptr -> rbx_core::SharedPtr)
#[doc(alias = "RBX::TaskScheduler::removeBlocking(rbx_core::SharedPtr<RBX::TaskScheduler::Job>,boost::function<void ()(void)>)")]
pub fn stub_39c6c() -> ! {
    todo!("0x39c6c RBX::TaskScheduler::removeBlocking(rbx_core::SharedPtr<RBX::TaskScheduler::Job>,boost::function<void ()(void)>)")
}
...
pub fn stub_3a1bc() -> ! {
    todo!("0x3a1bc rbx_core::SharedPtr<RBX::Game>::operator=(rbx_core::SharedPtr<RBX::Game> const&)")
}
...
pub fn stub_3a5bc() -> ! {
    todo!("0x3a5bc void rbx_core::SharedPtr<RBX::Tasks::Sequence>::reset<RBX::Tasks::Sequence>(RBX::Tasks::Sequence *)")
}
...
// type: int __fastcall(_DWORD, _DWORD)
// was: int __fastcall(_DWORD, _DWORD) (boost::shared_ptr -> rbx_core::SharedPtr)
