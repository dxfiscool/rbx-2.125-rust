//! platform — generated_plat_wd3_1788337463 — 100 stubs EA-sorted asc gap filler not yet in rbx_platform
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not in platform
//! Distinct platform 39026/85545 -> 39126/85545 | uncovered 46519 -> 46419 | rbx_core::SharedPtr not boost
//! Batch: 100 stubs | range 0x3ed9c8..0x3f2130 | rbx_core::SharedPtr not boost
...
// 0x3ed9c8 — rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::remote_signal(void)
...
// 0x3edb24 — rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::disconnectAll(void)
...
// 0x3ede98 — RBX::ChatService::ChatColor * rbx::any_cast<RBX::ChatService::ChatColor,RBX::Region3>(rbx::placement_any<RBX::Region3> *)
...
// 0x3edef0 — RBX::ChatService::ChatColor & rbx::any_cast<RBX::ChatService::ChatColor &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// 0x3edfe0 — std::vector<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>::resize(unsigned long,RBX::ChatService::ChatColor)
...
// 0x3ee014 — std::vector<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>::push_back(RBX::ChatService::ChatColor const&)
...
// 0x3ee03c — std::map<RBX::Name const*,RBX::ChatService::ChatColor,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ChatService::ChatColor>>>::operator[](RBX::Name const* const&)
...
// 0x3ee1a0 — std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::ChatService::ChatColor>,std::_Select1st<std::pair<RBX::Name const* const,RBX::ChatService::ChatColor>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ChatService::ChatColor>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::ChatService::ChatColor> const&)
...
// 0x3ee208 — std::vector<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::ChatService::ChatColor*,std::vector<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>>,RBX::ChatService::ChatColor const&)
...
// 0x3ee2ec — std::_Vector_base<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>::_M_allocate(unsigned long)
...
// 0x3ee304 — RBX::ChatService::ChatColor * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::ChatService::ChatColor *,RBX::ChatService::ChatColor *>(RBX::ChatService::ChatColor *,RBX::ChatService::ChatColor *,RBX::ChatService::ChatColor *)
// type: int __fastcall(int, int, int)
...
// 0x3ee340 — std::vector<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::ChatService::ChatColor*,std::vector<RBX::ChatService::ChatColor,std::allocator<RBX::ChatService::ChatColor>>>,unsigned long,RBX::ChatService::ChatColor const&)
...
// 0x3ee4d0 — RBX::Reflection::RemoteEventDesc<RBX::ChatService,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>>::~RemoteEventDesc()
...
// 0x3ee6e8 — RBX::Reflection::RemoteEventDesc<RBX::ChatService,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>>::isScriptable(void)const
...
// 0x3ee6f0 — RBX::Reflection::RemoteEventDesc<RBX::ChatService,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>>::isBroadcast(void)const
// type: int __fastcall(int)
...
// 0x3eea50 — void RBX::Reflection::GenericSlotWrapper::execute3<boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor>(boost::shared_ptr<RBX::Instance> const&,std::string const&,RBX::ChatService::ChatColor const&)
...
// 0x3eebdc — boost::function3<void,boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor>::clear(void)
// type: int __fastcall(int *)
...
// 0x3ef51c — rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::callable_slot<boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>>::~callable_slot()
...
// 0x3ef62c — rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::callable_slot<boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>>::~callable_slot()
// type: void __fastcall(_DWORD *)
#[doc(alias = "rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::callable_slot<boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>>::~callable_slot()")]
pub fn stub_3ef62c() -> ! {
...
// 0x3ef75c — rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::slot,boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>,3,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::call(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)
...
// 0x3efa78 — rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::slot,boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>,3,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::~callable()
// type: _DWORD *__fastcall(_DWORD *)
...
// 0x3efb88 — rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::slot,boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>,3,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::~callable()
// type: void __fastcall(_DWORD *)
#[doc(alias = "rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::slot,boost::function<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>,3,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::~callable()")]
pub fn stub_3efb88() -> ! {
...
// 0x3efcb8 — boost::function3<void,boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor>::assign_to_own(boost::function3<void,boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor> const&)
...
// 0x3f0290 — RBX::Reflection::BoundFuncDesc<RBX::ChatService,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor),3>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)
...
// 0x3f02f8 — RBX::Reflection::BoundFuncDesc<RBX::ChatService,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor),3>::~BoundFuncDesc()
// type: void __fastcall(_DWORD *)
...
// 0x3f042c — RBX::Reflection::BoundFuncDesc<RBX::ChatService,void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor),3>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// 0x3f0760 — RBX::ChatService::ChatColor RBX::Reflection::ArgHelper::getArg<RBX::ChatService::ChatColor,3>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::ChatService::ChatColor> const&,boost::disable_if<boost::is_same<RBX::ChatService::ChatColor,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)
...
// 0x3f08f4 — bool RBX::Reflection::ArgHelper::try_enum<3,RBX::ChatService::ChatColor>(RBX::Reflection::FunctionDescriptor::Arguments &,RBX::ChatService::ChatColor &,boost::enable_if<boost::is_enum<RBX::ChatService::ChatColor>,void>::type *)
...
// 0x3f0948 — rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::~remote_signal()
...
// 0x3f0a94 — global constructor keyed to_a_170
// type: 
...
// 0x3f0e10 — RBX::ClickDetector::ClickDetector(void)
...
// 0x3f110c — RBX::ClickDetector::render3dAdorn(RBX::Adorn *)
// type: void()
...
// 0x3f1234 — RBX::ClickDetector::isClickable(boost::shared_ptr<RBX::PartInstance>,float,bool,RBX::Network::Player *)
...
// 0x3f12e0 — RBX::ClickDetector::updateLastHoverPart(boost::shared_ptr<RBX::Instance>,RBX::Network::Player *)
...
// 0x3f130c — RBX::ClickDetector::fireMouseHover(RBX::Network::Player *)
...
// 0x3f1410 — RBX::ClickDetector::fireMouseHoverLeave(RBX::Network::Player *)
// type: void __fastcall(RBX::ClickDetector *this, RBX::Network::Player *)
...
// 0x3f154c — RBX::ClickDetector::stopHover(boost::shared_ptr<RBX::PartInstance>,RBX::Network::Player *)
...
// 0x3f15b8 — RBX::ClickDetector::isHovered(RBX::PartInstance *,float,bool,RBX::Network::Player *)
...
// 0x3f17f8 — RBX::Reflection::RemoteEventDesc<RBX::ClickDetector,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>>::~RemoteEventDesc()
// type: _DWORD *__fastcall(_DWORD *)
...
// 0x3f181c — boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::PartInstance>(boost::shared_ptr<RBX::PartInstance> const&)
...
// 0x3f1850 — RBX::Reflection::RemoteEventDescImpl<1,RBX::ClickDetector,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>>::fireAndReplicateEvent(RBX::ClickDetector*,boost::shared_ptr<RBX::Instance>)
...
// 0x3f1984 — boost::shared_ptr<RBX::ClickDetector> RBX::shared_from<RBX::ClickDetector>(RBX::ClickDetector*)
...
// 0x3f1af4 — RBX::ClickDetector::~ClickDetector()
...
// 0x3f1af8 — RBX::ClickDetector::~ClickDetector()
// type: void __fastcall(RBX::ClickDetector *__hidden this)
#[doc(alias = "RBX::ClickDetector::~ClickDetector()")]
pub fn stub_3f1af8() -> ! {
...
// 0x3f1b98 — RBX::ClickDetector::askAddChild(RBX::Instance const*)const
...
// 0x3f1b9c — RBX::ClickDetector::askSetParent(RBX::Instance const*)const
...
// 0x3f1c00 — RBX::ClickDetector::shouldRender3dAdorn(void)const
// type: int __fastcall(RBX::ClickDetector *this)
...
// 0x3f1cac — RBX::ClickDetector const* RBX::Instance::findConstFirstChildOfType<RBX::ClickDetector>(void)const
...
// 0x3f1d14 — RBX::Reflection::EventDescImpl<1,RBX::ClickDetector,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>,rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)> RBX::ClickDetector::*>::fireEvent(RBX::ClickDetector*,boost::shared_ptr<RBX::Instance>)const
...
// 0x3f1de8 — RBX::Reflection::RemoteEventDescImpl<1,RBX::ClickDetector,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>>::replicateEvent(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Instance>)
// type: int __fastcall(int, int, int)
...
// 0x3f2130 — RBX::Reflection::BoundProp<float,(RBX::Reflection::Mutability)1>::BoundProp<RBX::ClickDetector>(char const*,char const*,float RBX::ClickDetector::*,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
