//! platform generated — next 682 stubs sorted by EA, from ida/export.json
...
//! Batch: 682 stubs (582 prior + 100 this batch, 1168 filter Roblox iOS, 586 remaining) | SharedPtr = rbx_core::SharedPtr (Arc) not boost::shared_ptr
