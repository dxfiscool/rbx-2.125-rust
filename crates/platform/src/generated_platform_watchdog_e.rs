//! platform — generated_platform_watchdog_e — 100 stubs EA-sorted asc fallback gap filler
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 100 not yet stubbed in rbx_platform (fallback gap filler after watchdog_d 0x6f6bbc..0x70e9e8, gap 0x31dd9c..0x3244fc, rbx_core::SharedPtr not boost)
//! Batch: 100 stubs | range 0x31dd9c..0x3244fc | rbx_core::SharedPtr not boost
//! Distinct stub_ 85545/85545 -> 85545/85545 | platform 34847->34947 | uncovered 0->0 (global gap already covered, platform gap filler)
...
// 0x31dd9c — __ZN5boost9function2IvPSsPSt9exceptionE13assign_to_ownERKS4_ — boost::function2<void,std::string *,std::exception *>::assign_to_own(boost::function2<void,std::string *,std::exception *> const&)
...
// 0x31ddcc — __ZN5boost3_bi5list3INS0_5valueISsEENS2_IbEENS2_INS_8functionIFvPSsPSt9exceptionEEEEEEC2ES3_S4_SB_ — boost::_bi::list3<boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>>::list3(boost::_bi::value<std::string>,boost::_bi::value<bool>,boost::_bi::value<boost::function<void ()(std::string *,std::exception *)>>)
// type: int(void)
...
// 0x31e45c — __ZN3RBX4Http10MutexGuardD2Ev — RBX::Http::MutexGuard::~MutexGuard()
...
pub fn stub_31e45c() -> ! {
    todo!("0x31e45c __ZN3RBX4Http10MutexGuardD2Ev")
}

// 0x31e558 — __ZN3RBX4Http10MutexGuardC2Ev — RBX::Http::MutexGuard::MutexGuard(void)
...
// 0x31e8b0 — __ZNK3RBX7Extents13clampInsideOfERKS0_ — RBX::Extents::clampInsideOf(RBX::Extents const&)const
...
// 0x31e9f4 — __ZN3RBX7Extents11closestFaceERKN3G3D7Vector3E — RBX::Extents::closestFace(G3D::Vector3 const&)
...
// 0x31eae4 — __ZNK3RBX7Extents14getCornerIndexEi — RBX::Extents::getCornerIndex(int)const
...
// 0x31eba8 — __ZNK3RBX7Extents9getCornerEi — RBX::Extents::getCorner(int)const
// type: _DWORD __fastcall(RBX::Extents *__hidden this, int)
...
// 0x31ebfc — __ZNK3RBX7Extents14getFaceCornersENS_8NormalIdERN3G3D7Vector3ES4_S4_S4_ — RBX::Extents::getFaceCorners(RBX::NormalId,G3D::Vector3 &,G3D::Vector3 &,G3D::Vector3 &,G3D::Vector3 &)const
...
// 0x31ee8c — __ZNK3RBX7Extents7expressERKN3G3D15CoordinateFrameES4_ — RBX::Extents::express(G3D::CoordinateFrame const&,G3D::CoordinateFrame const&)const
...
// 0x31f1b4 — __ZN3RBX7Extents12toWorldSpaceERKN3G3D15CoordinateFrameE — RBX::Extents::toWorldSpace(G3D::CoordinateFrame const&)
...
// 0x31f464 — __ZNK3RBX7Extents10faceCenterENS_8NormalIdE — RBX::Extents::faceCenter(RBX::NormalId)const
// type: int __fastcall(_DWORD, _DWORD, _DWORD)
#[doc(alias = "__ZNK3RBX7Extents10faceCenterENS_8NormalIdE")]
#[doc(alias = "RBX::Extents::faceCenter(RBX::NormalId)const")]
pub fn stub_31f464() -> ! {
    todo!("0x31f464 __ZNK3RBX7Extents10faceCenterENS_8NormalIdE")
}

// 0x31f4d0 — __ZNK3RBX7Extents31computeClosestSqDistanceToPointERKN3G3D7Vector3E — RBX::Extents::computeClosestSqDistanceToPoint(G3D::Vector3 const&)const
// type: _DWORD __fastcall(RBX::Extents *__hidden this, const Vector3 *)
...
pub fn stub_31f4d0() -> ! {
    todo!("0x31f4d0 __ZNK3RBX7Extents31computeClosestSqDistanceToPointERKN3G3D7Vector3E")
}

// 0x31f5b4 — __ZNK3RBX7Extents19separatedByMoreThanERKS0_f — RBX::Extents::separatedByMoreThan(RBX::Extents const&,float)const
...
// 0x31f68c — __ZN3RBX7Extents2vvERKN3G3D7Vector3ES4_ — RBX::Extents::vv(G3D::Vector3 const&,G3D::Vector3 const&)
...
// 0x31f90c — __ZNK3RBX4FaceixEi — RBX::Face::operator[](int)const
#[doc(alias = "__ZNK3RBX4FaceixEi")]
#[doc(alias = "RBX::Face::operator[](int)const")]
pub fn stub_31f90c() -> ! {
    todo!("0x31f90c __ZNK3RBX4FaceixEi")
}

// 0x31f918 — __ZN3RBX4FaceixEi — RBX::Face::operator[](int)
#[doc(alias = "__ZN3RBX4FaceixEi")]
#[doc(alias = "RBX::Face::operator[](int)")]
pub fn stub_31f918() -> ! {
    todo!("0x31f918 __ZN3RBX4FaceixEi")
}

// 0x31f924 — __ZN3RBX4Face10snapToGridEf — RBX::Face::snapToGrid(float)
...
pub fn stub_31f924() -> ! {
    todo!("0x31f924 __ZN3RBX4Face10snapToGridEf")
}

// 0x31f964 — __ZN3RBX4Face19overlapWithinPlanesERKS0_S2_f — RBX::Face::overlapWithinPlanes(RBX::Face const&,RBX::Face const&,float)
...
pub fn stub_31f964() -> ! {
    todo!("0x31f964 __ZN3RBX4Face19overlapWithinPlanesERKS0_S2_f")
}

// 0x31fa44 — __ZNK3RBX4Face18projectOverlapOnMeERKS0_ — RBX::Face::projectOverlapOnMe(RBX::Face const&)const
...
pub fn stub_31fa44() -> ! {
    todo!("0x31fa44 __ZNK3RBX4Face18projectOverlapOnMeERKS0_")
}

// 0x31fcd4 — __ZNK3RBX4Face24fuzzyContainsInExtrusionERKN3G3D7Vector3Ef — RBX::Face::fuzzyContainsInExtrusion(G3D::Vector3 const&,float)const
...
pub fn stub_31fcd4() -> ! {
    todo!("0x31fcd4 __ZNK3RBX4Face24fuzzyContainsInExtrusionERKN3G3D7Vector3Ef")
}

// 0x31fdc4 — __ZNK3RBX4Face6minMaxERKN3G3D7Vector3ES4_RfS5_ — RBX::Face::minMax(G3D::Vector3 const&,G3D::Vector3 const&,float &,float &)const
...
pub fn stub_31fdc4() -> ! {
    todo!("0x31fdc4 __ZNK3RBX4Face6minMaxERKN3G3D7Vector3ES4_RfS5_")
}

// 0x31fe6c — __ZN3RBX4Face10hasOverlapERKS0_S2_f — RBX::Face::hasOverlap(RBX::Face const&,RBX::Face const&,float)
...
pub fn stub_31fe6c() -> ! {
    todo!("0x31fe6c __ZN3RBX4Face10hasOverlapERKS0_S2_f")
}

// 0x31fefc — __ZN3RBX4Face14cornersAlignedERKS0_S2_f — RBX::Face::cornersAligned(RBX::Face const&,RBX::Face const&,float)
// type: _DWORD __fastcall(RBX::Face *__hidden this, const RBX::Face *, const RBX::Face *, float)
#[doc(alias = "__ZN3RBX4Face14cornersAlignedERKS0_S2_f")]
#[doc(alias = "RBX::Face::cornersAligned(RBX::Face const&,RBX::Face const&,float)")]
pub fn stub_31fefc() -> ! {
    todo!("0x31fefc __ZN3RBX4Face14cornersAlignedERKS0_S2_f")
}

// 0x31ffe4 — __ZN3RBX4Face15fromExtentsSideERKNS_7ExtentsENS_8NormalIdE — RBX::Face::fromExtentsSide(RBX::Extents const&,RBX::NormalId)
...
pub fn stub_31ffe4() -> ! {
    todo!("0x31ffe4 __ZN3RBX4Face15fromExtentsSideERKNS_7ExtentsENS_8NormalIdE")
}

// 0x320024 — __ZNK3RBX4Face12toWorldSpaceERKN3G3D15CoordinateFrameE — RBX::Face::toWorldSpace(G3D::CoordinateFrame const&)const
// type: int __fastcall(_DWORD, _DWORD, _DWORD)
...
pub fn stub_320024() -> ! {
    todo!("0x320024 __ZNK3RBX4Face12toWorldSpaceERKN3G3D15CoordinateFrameE")
}

// 0x32010c — __ZNK3RBX4Face13toObjectSpaceERKN3G3D15CoordinateFrameE — RBX::Face::toObjectSpace(G3D::CoordinateFrame const&)const
...
pub fn stub_32010c() -> ! {
    todo!("0x32010c __ZNK3RBX4Face13toObjectSpaceERKN3G3D15CoordinateFrameE")
}

// 0x3201f4 — __ZNK3RBX4Face7getAxisEi — RBX::Face::getAxis(int)const
...
// 0x320314 — __ZN3RBX5FacesC1Ei — RBX::Faces::Faces(int)
// type: _DWORD __fastcall(RBX::Faces *__hidden this, int)
#[doc(alias = "__ZN3RBX5FacesC1Ei")]
#[doc(alias = "RBX::Faces::Faces(int)")]
pub fn stub_320314() -> ! {
    todo!("0x320314 __ZN3RBX5FacesC1Ei")
}

// 0x320318 — __ZN3RBX5Faces11setNormalIdENS_8NormalIdEb — RBX::Faces::setNormalId(RBX::NormalId,bool)
// type: int __fastcall(_DWORD, _DWORD, _DWORD)
#[doc(alias = "__ZN3RBX5Faces11setNormalIdENS_8NormalIdEb")]
#[doc(alias = "RBX::Faces::setNormalId(RBX::NormalId,bool)")]
pub fn stub_320318() -> ! {
    todo!("0x320318 __ZN3RBX5Faces11setNormalIdENS_8NormalIdEb")
}

// 0x320338 — __ZNK3RBX5Faces11getNormalIdENS_8NormalIdE — RBX::Faces::getNormalId(RBX::NormalId)const
// type: int __fastcall(_DWORD, _DWORD)
#[doc(alias = "__ZNK3RBX5Faces11getNormalIdENS_8NormalIdE")]
#[doc(alias = "RBX::Faces::getNormalId(RBX::NormalId)const")]
pub fn stub_320338() -> ! {
    todo!("0x320338 __ZNK3RBX5Faces11getNormalIdENS_8NormalIdE")
}

// 0x32034c — __ZN3RBX15StringConverterINS_5FacesEE15convertToStringERKS1_ — RBX::StringConverter<RBX::Faces>::convertToString(RBX::Faces const&)
...
pub fn stub_32034c() -> ! {
    todo!("0x32034c __ZN3RBX15StringConverterINS_5FacesEE15convertToStringERKS1_")
}

// 0x32059c — __ZN3RBX15StringConverterINS_5FacesEE14convertToValueERKSsRS1_ — RBX::StringConverter<RBX::Faces>::convertToValue(std::string const&,RBX::Faces&)
// type: int __fastcall(_DWORD, _DWORD)
...
// 0x3226f8 — __ZL14initLocalScopev — initLocalScope(void)
// type: _DWORD __fastcall()
#[doc(alias = "__ZL14initLocalScopev")]
#[doc(alias = "initLocalScope(void)")]
pub fn stub_3226f8() -> ! {
    todo!("0x3226f8 __ZL14initLocalScopev")
}

// 0x32281c — __ZN3RBX4GuidC1Ev — RBX::Guid::Guid(void)
// type: _DWORD __fastcall(RBX::Guid *__hidden this)
#[doc(alias = "__ZN3RBX4GuidC1Ev")]
#[doc(alias = "RBX::Guid::Guid(void)")]
pub fn stub_32281c() -> ! {
    todo!("0x32281c __ZN3RBX4GuidC1Ev")
}

// 0x322850 — __ZN3RBX4Guid20generateStandardGUIDERSs — RBX::Guid::generateStandardGUID(std::string &)
...
pub fn stub_322850() -> ! {
    todo!("0x322850 __ZN3RBX4Guid20generateStandardGUIDERSs")
}

// 0x32298c — __ZN3RBX4Guid15generateRBXGUIDERSs — RBX::Guid::generateRBXGUID(std::string &)
...
pub fn stub_32298c() -> ! {
    todo!("0x32298c __ZN3RBX4Guid15generateRBXGUIDERSs")
}

// 0x322b04 — __ZN3RBX4Guid6assignENS0_4DataE — RBX::Guid::assign(RBX::Guid::Data)
// type: Data *__fastcall(Data *this, Data)
#[doc(alias = "__ZN3RBX4Guid6assignENS0_4DataE")]
#[doc(alias = "RBX::Guid::assign(RBX::Guid::Data)")]
pub fn stub_322b04() -> ! {
    todo!("0x322b04 __ZN3RBX4Guid6assignENS0_4DataE")
}

// 0x322b10 — __ZNK3RBX4Guid4DataltERKS1_ — RBX::Guid::Data::operator<(RBX::Guid::Data const&)const
// type: int __fastcall(_DWORD, _DWORD)
#[doc(alias = "__ZNK3RBX4Guid4DataltERKS1_")]
#[doc(alias = "RBX::Guid::Data::operator<(RBX::Guid::Data const&)const")]
pub fn stub_322b10() -> ! {
    todo!("0x322b10 __ZNK3RBX4Guid4DataltERKS1_")
}

// 0x322b38 — __ZN3RBX4Guid7compareEPKS0_S2_ — RBX::Guid::compare(RBX::Guid const*,RBX::Guid const*)
...
pub fn stub_322b38() -> ! {
    todo!("0x322b38 __ZN3RBX4Guid7compareEPKS0_S2_")
}

// 0x322b78 — __ZN3RBX4Guid7compareEPKS0_S2_S2_S2_ — RBX::Guid::compare(RBX::Guid const*,RBX::Guid const*,RBX::Guid const*,RBX::Guid const*)
...
pub fn stub_322b78() -> ! {
    todo!("0x322b78 __ZN3RBX4Guid7compareEPKS0_S2_S2_S2_")
}

// 0x322bdc — __ZNK3RBX4Guid4Data14readableStringEi — RBX::Guid::Data::readableString(int)const
...
// 0x322ec8 — __ZN3RBX14InstanceHandleC1EPNS_10Reflection13DescribedBaseE — RBX::InstanceHandle::InstanceHandle(RBX::Reflection::DescribedBase *)
...
pub fn stub_322ec8() -> ! {
    todo!("0x322ec8 __ZN3RBX14InstanceHandleC1EPNS_10Reflection13DescribedBaseE")
}

// 0x322ed8 — __ZNK3RBX14InstanceHandle12operatorLessERKS0_ — RBX::InstanceHandle::operatorLess(RBX::InstanceHandle const&)const
// type: int __fastcall(_DWORD, _DWORD)
...
pub fn stub_322ed8() -> ! {
    todo!("0x322ed8 __ZNK3RBX14InstanceHandle12operatorLessERKS0_")
}

// 0x322ee8 — __ZNK3RBX14InstanceHandle5emptyEv — RBX::InstanceHandle::empty(void)const
...
pub fn stub_322ee8() -> ! {
    todo!("0x322ee8 __ZNK3RBX14InstanceHandle5emptyEv")
}

// 0x322ef4 — __ZN3RBX14InstanceHandle6linkToEN5boost10shared_ptrINS_10Reflection13DescribedBaseEEE — RBX::InstanceHandle::linkTo(boost::shared_ptr<RBX::Reflection::DescribedBase>)
// type: int __fastcall(_DWORD, _DWORD)
...
// 0x323028 — __ZN3RBX4Hash4hashERKSs — RBX::Hash::hash(std::string const&)
...
// 0x32305c — __ZN3RBX17HeartbeatInstance34onServiceProviderHeartbeatInstanceEPNS_15ServiceProviderES2_ — RBX::HeartbeatInstance::onServiceProviderHeartbeatInstance(RBX::ServiceProvider *,RBX::ServiceProvider *)
...
pub fn stub_32305c() -> ! {
    todo!("0x32305c __ZN3RBX17HeartbeatInstance34onServiceProviderHeartbeatInstanceEPNS_15ServiceProviderES2_")
}
...
pub fn stub_323238() -> ! {
    todo!("0x323238 __ZN3rbx7signals6signalIFvRKN3RBX9HeartbeatEEE7connectIN5boost3_bi6bind_tIvNS9_4_mfi3mf1IvNS2_17HeartbeatInstanceES5_EENSA_5list2INSA_5valueIPSE_EENS9_3argILi1EEEEEEEEENS0_10connectionERKT_")
}

// 0x3232ac — __ZN3rbx7signals6signalIFvRKN3RBX9HeartbeatEEE13callable_slotIN5boost3_bi6bind_tIvNS9_4_mfi3mf1IvNS2_17HeartbeatInstanceES5_EENSA_5list2INSA_5valueIPSE_EENS9_3argILi1EEEEEEEED1Ev — rbx::signals::signal<void ()(RBX::Heartbeat const&)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>>::~callable_slot()
...
pub fn stub_3232ac() -> ! {
    todo!("0x3232ac __ZN3rbx7signals6signalIFvRKN3RBX9HeartbeatEEE13callable_slotIN5boost3_bi6bind_tIvNS9_4_mfi3mf1IvNS2_17HeartbeatInstanceES5_EENSA_5list2INSA_5valueIPSE_EENS9_3argILi1EEEEEEEED1Ev")
}
...
#[doc(alias = "rbx::signals::signal<void ()(RBX::Heartbeat const&)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>>::~callable_slot()")]
pub fn stub_3232d8() -> ! {
    todo!("0x3232d8 __ZN3rbx7signals6signalIFvRKN3RBX9HeartbeatEEE13callable_slotIN5boost3_bi6bind_tIvNS9_4_mfi3mf1IvNS2_17HeartbeatInstanceES5_EENSA_5list2INSA_5valueIPSE_EENS9_3argILi1EEEEEEEED0Ev")
}

// 0x3233ac — __ZN3rbx8callableINS_7signals6signalIFvRKN3RBX9HeartbeatEEE4slotEN5boost3_bi6bind_tIvNSA_4_mfi3mf1IvNS3_17HeartbeatInstanceES6_EENSB_5list2INSB_5valueIPSF_EENSA_3argILi1EEEEEEELi1ES7_E4callES6_ — rbx::callable<rbx::signals::signal<void ()(RBX::Heartbeat const&)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>,1,void ()(RBX::Heartbeat const&)>::call(RBX::Heartbeat const&)
...
pub fn stub_3233ac() -> ! {
    todo!("0x3233ac __ZN3rbx8callableINS_7signals6signalIFvRKN3RBX9HeartbeatEEE4slotEN5boost3_bi6bind_tIvNSA_4_mfi3mf1IvNS3_17HeartbeatInstanceES6_EENSB_5list2INSB_5valueIPSF_EENSA_3argILi1EEEEEEELi1ES7_E4callES6_")
}

// 0x3233b4 — __ZThn4_N3rbx8callableINS_7signals6signalIFvRKN3RBX9HeartbeatEEE4slotEN5boost3_bi6bind_tIvNSA_4_mfi3mf1IvNS3_17HeartbeatInstanceES6_EENSB_5list2INSB_5valueIPSF_EENSA_3argILi1EEEEEEELi1ES7_E4callES6_ — `non-virtual thunk to'rbx::callable<rbx::signals::signal<void ()(RBX::Heartbeat const&)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>,1,void ()(RBX::Heartbeat const&)>::call(RBX::Heartbeat const&)
...
pub fn stub_3233bc() -> ! {
    todo!("0x3233bc __ZN5boost3_bi6bind_tIvNS_4_mfi3mf1IvN3RBX17HeartbeatInstanceERKNS4_9HeartbeatEEENS0_5list2INS0_5valueIPS5_EENS_3argILi1EEEEEEclIS6_EEvRKT_")
}

// 0x3233d4 — __ZN3rbx8callableINS_7signals6signalIFvRKN3RBX9HeartbeatEEE4slotEN5boost3_bi6bind_tIvNSA_4_mfi3mf1IvNS3_17HeartbeatInstanceES6_EENSB_5list2INSB_5valueIPSF_EENSA_3argILi1EEEEEEELi1ES7_ED1Ev — rbx::callable<rbx::signals::signal<void ()(RBX::Heartbeat const&)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>,1,void ()(RBX::Heartbeat const&)>::~callable()
...
pub fn stub_3233d4() -> ! {
    todo!("0x3233d4 __ZN3rbx8callableINS_7signals6signalIFvRKN3RBX9HeartbeatEEE4slotEN5boost3_bi6bind_tIvNSA_4_mfi3mf1IvNS3_17HeartbeatInstanceES6_EENSB_5list2INSB_5valueIPSF_EENSA_3argILi1EEEEEEELi1ES7_ED1Ev")
}

// 0x323400 — __ZN3rbx8callableINS_7signals6signalIFvRKN3RBX9HeartbeatEEE4slotEN5boost3_bi6bind_tIvNSA_4_mfi3mf1IvNS3_17HeartbeatInstanceES6_EENSB_5list2INSB_5valueIPSF_EENSA_3argILi1EEEEEEELi1ES7_ED0Ev — rbx::callable<rbx::signals::signal<void ()(RBX::Heartbeat const&)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>,1,void ()(RBX::Heartbeat const&)>::~callable()
...
// 0x32366c — __ZN3RBX13HandleHitTest18hitTestHandleWorldERKNS_7ExtentsENS_10HandleTypeERKNS_6RbxRayERN3G3D7Vector3ERNS_8NormalIdEi — RBX::HandleHitTest::hitTestHandleWorld(RBX::Extents const&,RBX::HandleType,RBX::RbxRay const&,G3D::Vector3 &,RBX::NormalId &,int)
...
pub fn stub_32366c() -> ! {
    todo!("0x32366c __ZN3RBX13HandleHitTest18hitTestHandleWorldERKNS_7ExtentsENS_10HandleTypeERKNS_6RbxRayERN3G3D7Vector3ERNS_8NormalIdEi")
}

// 0x323768 — __ZN3RBX13HandleHitTest18hitTestHandleLocalERKNS_7ExtentsERKN3G3D15CoordinateFrameENS_10HandleTypeERKNS_6RbxRayERNS4_7Vector3ERNS_8NormalIdEi — RBX::HandleHitTest::hitTestHandleLocal(RBX::Extents const&,G3D::CoordinateFrame const&,RBX::HandleType,RBX::RbxRay const&,G3D::Vector3 &,RBX::NormalId &,int)
...
pub fn stub_323768() -> ! {
    todo!("0x323768 __ZN3RBX13HandleHitTest18hitTestHandleLocalERKNS_7ExtentsERKN3G3D15CoordinateFrameENS_10HandleTypeERKNS_6RbxRayERNS4_7Vector3ERNS_8NormalIdEi")
}

// 0x3238e8 — __ZN3RBX13HandleHitTest22hitTestMoveHandleWorldERKNS_7ExtentsERKNS_6RbxRayERN3G3D7Vector3ERNS_8NormalIdEi — RBX::HandleHitTest::hitTestMoveHandleWorld(RBX::Extents const&,RBX::RbxRay const&,G3D::Vector3 &,RBX::NormalId &,int)
...
// 0x323de8 — __ZN3RBX8IndexBoxC1ERKN3G3D7Vector3ES4_ — RBX::IndexBox::IndexBox(G3D::Vector3 const&,G3D::Vector3 const&)
...
pub fn stub_323de8() -> ! {
    todo!("0x323de8 __ZN3RBX8IndexBoxC1ERKN3G3D7Vector3ES4_")
}

// 0x323dec — __ZN3RBX8IndexBoxC2ERKN3G3D7Vector3ES4_ — RBX::IndexBox::IndexBox(G3D::Vector3 const&,G3D::Vector3 const&)
...
// 0x323efc — __ZNK3RBX8IndexBox14getFaceCornersEiRN3G3D7Vector3ES3_S3_S3_ — RBX::IndexBox::getFaceCorners(int,G3D::Vector3 &,G3D::Vector3 &,G3D::Vector3 &,G3D::Vector3 &)const
...
pub fn stub_323efc() -> ! {
    todo!("0x323efc __ZNK3RBX8IndexBox14getFaceCornersEiRN3G3D7Vector3ES3_S3_S3_")
}

// 0x323fd8 — __ZN3RBX8IndexBoxD1Ev — RBX::IndexBox::~IndexBox()
// type: void __fastcall(RBX::IndexBox *__hidden this)
#[doc(alias = "__ZN3RBX8IndexBoxD1Ev")]
#[doc(alias = "RBX::IndexBox::~IndexBox()")]
pub fn stub_323fd8() -> ! {
    todo!("0x323fd8 __ZN3RBX8IndexBoxD1Ev")
}

// 0x323fdc — __ZN3RBX8IndexBoxD0Ev — RBX::IndexBox::~IndexBox()
// type: void __fastcall(RBX::IndexBox *__hidden this)
...
// 0x324018 — __ZN3RBX11IndexedMeshC2Ev — RBX::IndexedMesh::IndexedMesh(void)
...
pub fn stub_324018() -> ! {
    todo!("0x324018 __ZN3RBX11IndexedMeshC2Ev")
}

// 0x32403c — __ZN3RBX11IndexedMeshD0Ev — RBX::IndexedMesh::~IndexedMesh()
...
pub fn stub_32403c() -> ! {
    todo!("0x32403c __ZN3RBX11IndexedMeshD0Ev")
}

// 0x3240dc — __ZN3RBX11IndexedMeshD1Ev — RBX::IndexedMesh::~IndexedMesh()
// type: void __fastcall(RBX::IndexedMesh *__hidden this)
...
// 0x3240e0 — __ZN3RBX11IndexedMeshD2Ev — RBX::IndexedMesh::~IndexedMesh()
// type: void __fastcall(RBX::IndexedMesh *__hidden this)
...
// 0x324354 — __ZN3RBX11IndexedMesh16setComputedUpperEPS0_ — RBX::IndexedMesh::setComputedUpper(RBX::IndexedMesh*)
...
pub fn stub_324354() -> ! {
    todo!("0x324354 __ZN3RBX11IndexedMesh16setComputedUpperEPS0_")
}

// 0x32438c — __ZN3RBX11IndexedMesh8setUpperEPS0_ — RBX::IndexedMesh::setUpper(RBX::IndexedMesh*)
// type: _DWORD __fastcall(RBX::IndexedMesh *__hidden this, RBX::IndexedMesh *)
#[doc(alias = "__ZN3RBX11IndexedMesh8setUpperEPS0_")]
#[doc(alias = "RBX::IndexedMesh::setUpper(RBX::IndexedMesh*)")]
pub fn stub_32438c() -> ! {
    todo!("0x32438c __ZN3RBX11IndexedMesh8setUpperEPS0_")
}

// 0x3243d4 — __ZN3RBX11IndexedMesh8setLowerEPS0_ — RBX::IndexedMesh::setLower(RBX::IndexedMesh*)
// type: _DWORD __fastcall(RBX::IndexedMesh *__hidden this, RBX::IndexedMesh *)
#[doc(alias = "__ZN3RBX11IndexedMesh8setLowerEPS0_")]
#[doc(alias = "RBX::IndexedMesh::setLower(RBX::IndexedMesh*)")]
pub fn stub_3243d4() -> ! {
    todo!("0x3243d4 __ZN3RBX11IndexedMesh8setLowerEPS0_")
}

// 0x3244b8 — __ZN3RBX11IndexedMesh16getComputedUpperEv — RBX::IndexedMesh::getComputedUpper(void)
// type: _DWORD __fastcall(RBX::IndexedMesh *__hidden this)
#[doc(alias = "__ZN3RBX11IndexedMesh16getComputedUpperEv")]
#[doc(alias = "RBX::IndexedMesh::getComputedUpper(void)")]
pub fn stub_3244b8() -> ! {
    todo!("0x3244b8 __ZN3RBX11IndexedMesh16getComputedUpperEv")
}

// 0x3244bc — __ZN3RBX11IndexedMesh20getIndexedMeshParentEv — RBX::IndexedMesh::getIndexedMeshParent(void)
// type: _DWORD __fastcall(RBX::IndexedMesh *__hidden this)
#[doc(alias = "__ZN3RBX11IndexedMesh20getIndexedMeshParentEv")]
#[doc(alias = "RBX::IndexedMesh::getIndexedMeshParent(void)")]
pub fn stub_3244bc() -> ! {
    todo!("0x3244bc __ZN3RBX11IndexedMesh20getIndexedMeshParentEv")
}

// 0x3244c0 — __ZN3RBX11IndexedMesh14attachChildrenEPS0_ — RBX::IndexedMesh::attachChildren(RBX::IndexedMesh*)
// type: _DWORD __fastcall(RBX::IndexedMesh *__hidden this, RBX::IndexedMesh *)
#[doc(alias = "__ZN3RBX11IndexedMesh14attachChildrenEPS0_")]
#[doc(alias = "RBX::IndexedMesh::attachChildren(RBX::IndexedMesh*)")]
pub fn stub_3244c0() -> ! {
    todo!("0x3244c0 __ZN3RBX11IndexedMesh14attachChildrenEPS0_")
}

// 0x3244fc — __ZN3RBX11IndexedMesh15onParentChangedEPNS_11IndexedTreeE — RBX::IndexedMesh::onParentChanged(RBX::IndexedTree *)
...
pub fn stub_3244fc() -> ! {
    todo!("0x3244fc __ZN3RBX11IndexedMesh15onParentChangedEPNS_11IndexedTreeE")
}
