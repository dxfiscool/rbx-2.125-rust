//! platform — generated_plat_wd_watchdog12 — 100 stubs EA-sorted asc gap filler NOT yet in rbx_platform
//! Source: ida/export.json (85545 funcs) global gap filler EA-sorted asc next 100 after generated_plat_wd_watchdog11 0x46be00 (platform strict Platform/iOS 0 left, filler 100)
//! Range 0x46bee8..0x46fb68 | distinct 41468/85545 -> 41568/85545 | rbx_core::SharedPtr not boost
//! Batch: generated_plat_wd_watchdog12 100 stubs (filtered Platform/iOS 0 + filler 100) EA-sorted asc distinct
...
// was: RBX::Reflection::BoundFuncDesc<RBX::DataModel,void ()(void),0>::BoundFuncDesc(void (RBX::DataModel::*)(void),char const*,RBX::Security::Permissions,RBX::Reflection::Descriptor::Attributes)
...
// was: RBX::Reflection::BoundFuncDesc<RBX::DataModel,void ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
...
// was: void RBX::WindowAverage<double,double>::iter<RBX::WindowAverageDutyCycle<(RBX::Time::SampleMethod)1>::GTCounter>(RBX::WindowAverageDutyCycle<(RBX::Time::SampleMethod)1>::GTCounter &)const
...
// was: RBX::WindowAverageDutyCycle<(RBX::Time::SampleMethod)1>::getStats(unsigned long)const
...
// type: int(void)
// was: RBX::WindowAverageTimeInterval<(RBX::Time::SampleMethod)1>::getStats(unsigned long)const
...
// type: int(void)
// was: void RBX::WindowAverage<double,double>::iter<RBX::WindowAverageTimeInterval<(RBX::Time::SampleMethod)1>::FSum>(RBX::WindowAverageTimeInterval<(RBX::Time::SampleMethod)1>::FSum &)const
...
// was: RBX::DataModel::LegacyLock::Implementation::Events::Events(void)
...
// was: RBX::DataModel::LegacyLock::Implementation::safe_static_init_eventsPool(void)
...
// type: _DWORD __fastcall(RBX::DataModel::LegacyLock::Implementation *__hidden this)
// was: RBX::DataModel::LegacyLock::Implementation::safe_static_do_get_eventsPool(void)
...
// type: _DWORD __fastcall(RBX::DataModel::LegacyLock::Implementation *__hidden this)
// was: RBX::DataModel::LegacyLock::Implementation::safe_static_init_currentJob(void)
...
// type: _DWORD __fastcall(RBX::DataModel::LegacyLock::Implementation *__hidden this)
// was: RBX::DataModel::LegacyLock::Implementation::safe_static_do_get_currentJob(void)
...
// was: rbx::thread_specific_reference<RBX::DataModel::GenericJob>::~thread_specific_reference()
...
// was: rbx::signals::signal<void ()(std::string const&)>::disconnectAll(void)
...
// type: int __fastcall(int, int, int, int, char, int, int, int, int, int)
// was: rbx::signals::signal<void ()(RBX::UIEvent const&)>::disconnectAll(void)
...
// type: int __fastcall(_DWORD, _DWORD)
// was: std::_Rb_tree<std::string,std::pair<std::string const,int>,std::_Select1st<std::pair<std::string const,int>>,std::less<std::string>,std::allocator<std::pair<std::string const,int>>>::_M_erase(std::_Rb_tree_node<std::pair<std::string const,int>> *)
...
// was: RBX::GuiImageMixin::getImageRectOffset(void)const
...
// type: _DWORD __fastcall(RBX::GuiImageMixin *__hidden this)
// was: RBX::GuiImageMixin::getImageRectSize(void)const
