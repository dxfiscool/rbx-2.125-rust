//! platform generated_watchdog_plat_w1 — 40 stubs EA-sorted asc gap filler not yet in platform (fallback: global gaps exhausted, per-crate gap)
//! Source: ida/export.json (85545 funcs) EA-sorted asc next 40 not in platform | rbx_core::SharedPtr not boost
//! Range 0x26f1d4..0x270078 | per-crate distinct, cross-crate duplicates allowed
//! Batch: 40 stubs | // 0xADDR — mangled + #[doc(alias = "demangled")] + todo!("0xADDR mangled")
...
pub fn stub_26f1d4() -> ! {
    todo!("0x26f1d4 __ZN3RBX3Lua12LuaArguments9pushArrayIN9__gnu_cxx17__normal_iteratorIPKNS_10Reflection7VariantESt6vectorIS6_SaIS6_EEEEEEiT_SD_P9lua_State")
}

// 0x26f280 — __ZN3rbx8any_castIRKN3RBX3Lua15WeakFunctionRefENS1_7Region3EEET_RNS_13placement_anyIT0_EE — RBX::Lua::WeakFunctionRef const& rbx::any_cast<RBX::Lua::WeakFunctionRef const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &) — _DWORD **__fastcall(_DWORD **)
...
// 0x26f368 — __ZN3RBX10Reflection14EnumDescriptor16lookupDescriptorERKSt9type_info — RBX::Reflection::EnumDescriptor::lookupDescriptor(std::type_info const&) — int __fastcall(RBX::Reflection::EnumDescriptor *this, const std::type_info *)
...
pub fn stub_26f368() -> ! {
    todo!("0x26f368 __ZN3RBX10Reflection14EnumDescriptor16lookupDescriptorERKSt9type_info")
}

// 0x26f3a0 — __ZN3rbx8any_castIRKN3RBX15ProtectedStringENS1_7Region3EEET_RNS_13placement_anyIT0_EE — RBX::ProtectedString const& rbx::any_cast<RBX::ProtectedString const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &) — char ****__fastcall(char ****)
...
// 0x26f490 — __ZN3rbx8any_castIRKlN3RBX7Region3EEET_RNS_13placement_anyIT0_EE — long const& rbx::any_cast<long const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &) — _DWORD **__fastcall(_DWORD **)
...
// 0x26f578 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_11InputObjectEEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::InputObject>(RBX::InputObject const&) — int __fastcall(int, int)
...
// 0x26f5e0 — __ZN3rbx14implementation12typed_holderIN3RBX11InputObjectEE14construct_funcEPKcPc — rbx::implementation::typed_holder<RBX::InputObject>::construct_func(char const*,char *) — _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// 0x26f600 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_6CellIDEEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::CellID>(RBX::CellID const&) — int __fastcall(int, int)
...
// 0x26f680 — __ZN3rbx14implementation12typed_holderIN3RBX6CellIDEE9singletonEv — rbx::implementation::typed_holder<RBX::CellID>::singleton(void) — _DWORD *()
...
// 0x26f6ec — __ZN3rbx14implementation12typed_holderIN3RBX6CellIDEE14construct_funcEPKcPc — rbx::implementation::typed_holder<RBX::CellID>::construct_func(char const*,char *) — int __fastcall(int result, int)
...
// 0x26f718 — __ZN3rbx14implementation12typed_holderIN3RBX6CellIDEE13destruct_funcEPc — rbx::implementation::typed_holder<RBX::CellID>::destruct_func(char *) — void __fastcall(RBX::CellID *)
...
// 0x26f720 — __ZN3rbx14implementation12typed_holderIN3RBX4UDimEE14construct_funcEPKcPc — rbx::implementation::typed_holder<RBX::UDim>::construct_func(char const*,char *) — _DWORD *__fastcall(_DWORD *result, _DWORD *)
...
// 0x26f730 — __ZN3rbx14implementation12typed_holderIN3RBX4UDimEE13destruct_funcEPc — rbx::implementation::typed_holder<RBX::UDim>::destruct_func(char *) — void()
...
// 0x26f738 — __ZN3rbx14implementation12typed_holderIN3RBX6RbxRayEE9singletonEv — rbx::implementation::typed_holder<RBX::RbxRay>::singleton(void) — int *()
...
// 0x26f7a8 — __ZN3rbx14implementation12typed_holderIN3RBX6RbxRayEE13destruct_funcEPc — rbx::implementation::typed_holder<RBX::RbxRay>::destruct_func(char *) — int __fastcall(int (__fastcall ***)(_DWORD))
...
// 0x26f7b0 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSIN3G3D7Vector2EEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<G3D::Vector2>(G3D::Vector2 const&) — int **__fastcall(int **, int **)
...
// 0x26f808 — __ZN3rbx14implementation12typed_holderIN3G3D7Vector2EE9singletonEv — rbx::implementation::typed_holder<G3D::Vector2>::singleton(void) — int *()
...
// 0x26f878 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSIN3G3D7Vector3EEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<G3D::Vector3>(G3D::Vector3 const&) — _DWORD *__fastcall(_DWORD *, _DWORD *)
...
// 0x26f8d8 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSIN3G3D12Vector3int16EEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<G3D::Vector3int16>(G3D::Vector3int16 const&) — int __fastcall(int, int *)
...
// 0x26f930 — __ZN3rbx14implementation12typed_holderIN3G3D12Vector3int16EE9singletonEv — rbx::implementation::typed_holder<G3D::Vector3int16>::singleton(void) — int *()
...
// 0x26f9a0 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_12Region3int16EEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Region3int16>(RBX::Region3int16 const&) — int __fastcall(int, __int64 *)
...
// 0x26fa00 — __ZN3rbx14implementation12typed_holderIN3RBX12Region3int16EE9singletonEv — rbx::implementation::typed_holder<RBX::Region3int16>::singleton(void) — int *()
...
// 0x26fa70 — __ZN3rbx14implementation12typed_holderIN3RBX12Region3int16EE13destruct_funcEPc — rbx::implementation::typed_holder<RBX::Region3int16>::destruct_func(char *) — void()
...
// 0x26fa78 — __ZN3RBX3Lua6BridgeIN5boost10shared_ptrINS_8InstanceEEELb0EE8getValueINS_10Reflection7VariantEEEbP9lua_StatejRT_ — bool RBX::Lua::Bridge<boost::shared_ptr<RBX::Instance>,false>::getValue<RBX::Reflection::Variant>(lua_State *,unsigned int,RBX::Reflection::Variant &) — int __fastcall(int, int, _DWORD *)
...
// 0x26faf8 — __ZN3rbx13placement_anyIN3RBX7Region3EEaSINS1_3Lua15WeakFunctionRefEEERS3_RKT_ — rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::Lua::WeakFunctionRef>(RBX::Lua::WeakFunctionRef const&) — int **__fastcall(int **, const RBX::Lua::WeakFunctionRef *)
...
// 0x26fb50 — __ZN3rbx14implementation12typed_holderIN3RBX3Lua15WeakFunctionRefEE14construct_funcEPKcPc — rbx::implementation::typed_holder<RBX::Lua::WeakFunctionRef>::construct_func(char const*,char *) — const RBX::Lua::WeakFunctionRef *__fastcall(const RBX::Lua::WeakFunctionRef *result, RBX::Lua::WeakFunctionRef *)
...
// 0x26fb60 — __ZN3rbx14implementation12typed_holderIN3RBX3Lua15WeakFunctionRefEE13destruct_funcEPc — rbx::implementation::typed_holder<RBX::Lua::WeakFunctionRef>::destruct_func(char *) — int __fastcall(int)
...
// 0x26ff94 — __ZN3RBX3Lua6BridgeIN5boost10shared_ptrINS_8InstanceEEELb0EE8getValueINS3_INS_10Reflection13DescribedBaseEEEEEbP9lua_StatejRT_ — bool RBX::Lua::Bridge<boost::shared_ptr<RBX::Instance>,false>::getValue<boost::shared_ptr<RBX::Reflection::DescribedBase>>(lua_State *,unsigned int,boost::shared_ptr<RBX::Reflection::DescribedBase> &) — int __fastcall(int, int, int)
...
// 0x270008 — __ZN3RBX3Lua6BridgeIPKNS_10Reflection14EnumDescriptor4ItemELb1EE8getValueIS6_EEbP9lua_StatejRT_ — bool RBX::Lua::Bridge<RBX::Reflection::EnumDescriptor::Item const*,true>::getValue<RBX::Reflection::EnumDescriptor::Item const*>(lua_State *,unsigned int,RBX::Reflection::EnumDescriptor::Item const* &) — int __fastcall(int, int, _DWORD *)
...
// 0x270078 — __GLOBAL__I_a_63 — global constructor keyed to_a_63
#[doc(alias = "global constructor keyed to_a_63")]
#[doc(alias = "__GLOBAL__I_a_63")]
pub fn stub_270078() -> ! {
    todo!("0x270078 __GLOBAL__I_a_63")
}
