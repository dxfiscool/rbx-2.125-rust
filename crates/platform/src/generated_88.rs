//! platform generated_88 — next 100 stubs EA-sorted desc high-EA filler after 0xf46424
//! Filter: high-EA filler EA-sorted desc, rbx_core::SharedPtr not boost
//! Batch: 100 stubs EA-sorted desc | skeleton batch | range 0xf45de4..0xf46414 (rbx_core::SharedPtr not boost)
...
pub fn stub_f46414() -> ! {
    todo!("0xf46414 j___ZN3RBX4Name9doDeclareILZNS_12sPlayerMouseEEEERKS0_v")
}
...
pub fn stub_f46404() -> ! {
    todo!("0xf46404 j___ZN3RBX4Name9doDeclareILZNS_10sPlayerHUDEEEERKS0_v")
}
...
pub fn stub_f463f4() -> ! {
    todo!("0xf463f4 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType> const&)")
}
...
pub fn stub_f463e4() -> ! {
    todo!("0xf463e4 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>> *)")
}
...
pub fn stub_f463d4() -> ! {
    todo!("0xf463d4 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>,std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType> const&)")
}
...
pub fn stub_f463c4() -> ! {
    todo!("0xf463c4 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType> const&)")
}
...
pub fn stub_f463b4() -> ! {
    todo!("0xf463b4 std::vector<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>::push_back(RBX::StarterGuiService::CoreGuiType const&)")
}
...
pub fn stub_f463a4() -> ! {
    todo!("0xf463a4 std::vector<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>::resize(unsigned long,RBX::StarterGuiService::CoreGuiType)")
}
...
pub fn stub_f46394() -> ! {
    todo!("0xf46394 std::vector<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::StarterGuiService::CoreGuiType*,std::vector<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>>,unsigned long,RBX::StarterGuiService::CoreGuiType const&)")
}
...
pub fn stub_f46384() -> ! {
    todo!("0xf46384 std::vector<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::StarterGuiService::CoreGuiType*,std::vector<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>>,RBX::StarterGuiService::CoreGuiType const&)")
}
...
pub fn stub_f46374() -> ! {
    todo!("0xf46374 std::map<RBX::Name const*,RBX::StarterGuiService::CoreGuiType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::StarterGuiService::CoreGuiType>>>::operator[](RBX::Name const* const&)")
}
...
pub fn stub_f46364() -> ! {
    todo!("0xf46364 RBX::StarterGuiService::CoreGuiType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::StarterGuiService::CoreGuiType *,RBX::StarterGuiService::CoreGuiType *>(RBX::StarterGuiService::CoreGuiType *,RBX::StarterGuiService::CoreGuiType *,RBX::StarterGuiService::CoreGuiType *)")
}
...
pub fn stub_f46354() -> ! {
    todo!("0xf46354 std::_Vector_base<RBX::StarterGuiService::CoreGuiType,std::allocator<RBX::StarterGuiService::CoreGuiType>>::_M_allocate(unsigned long)")
}
...
pub fn stub_f46344() -> ! {
    todo!("0xf46344 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::min_buckets_for_size(unsigned long)const")
}
...
pub fn stub_f46334() -> ! {
    todo!("0xf46334 boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>> boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::find_node_impl<RBX::StarterGuiService::CoreGuiType,std::equal_to<RBX::StarterGuiService::CoreGuiType>>(unsigned long,RBX::StarterGuiService::CoreGuiType const&,std::equal_to<RBX::StarterGuiService::CoreGuiType> const&)const")
}
...
pub fn stub_f46324() -> ! {
    todo!("0xf46324 boost::function2<void,RBX::StarterGuiService::CoreGuiType,bool>::operator()(RBX::StarterGuiService::CoreGuiType,bool)const")
}
...
pub fn stub_f462e4() -> ! {
    todo!("0xf462e4 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::TextLabel,RBX::TextLabel>(boost::shared_ptr<RBX::TextLabel> const*,RBX::TextLabel *)const")
}
...
pub fn stub_f462d4() -> ! {
    todo!("0xf462d4 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::ScreenGui,RBX::ScreenGui>(boost::shared_ptr<RBX::ScreenGui> const*,RBX::ScreenGui *)const")
}
...
pub fn stub_f462c4() -> ! {
    todo!("0xf462c4 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::PlayerGui,RBX::PlayerGui>(boost::shared_ptr<RBX::PlayerGui> const*,RBX::PlayerGui *)const")
}
...
pub fn stub_f46284() -> ! {
    todo!("0xf46284 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::table(unsigned long,boost::hash<RBX::StarterGuiService::CoreGuiType> const&,std::equal_to<RBX::StarterGuiService::CoreGuiType> const&,std::allocator<boost::unordered::detail::ptr_node<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>> const&)")
}
...
pub fn stub_f46274() -> ! {
    todo!("0xf46274 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::reserve_for_insert(unsigned long)")
}
...
pub fn stub_f46264() -> ! {
    todo!("0xf46264 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::delete_buckets(void)")
}
...
pub fn stub_f46254() -> ! {
    todo!("0xf46254 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::create_buckets(unsigned long)")
}
...
pub fn stub_f46244() -> ! {
    todo!("0xf46244 boost::unordered::detail::node_constructor<std::allocator<boost::unordered::detail::ptr_node<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>>>::construct(void)")
}
...
pub fn stub_f46234() -> ! {
    todo!("0xf46234 boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::operator[](RBX::StarterGuiService::CoreGuiType const&)")
}
...
pub fn stub_f46224() -> ! {
    todo!("0xf46224 boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::place_in_bucket(boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>> &,boost::unordered::detail::ptr_bucket *)")
}
...
pub fn stub_f46214() -> ! {
    todo!("0xf46214 boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::StarterGuiService::CoreGuiType const,bool>>,RBX::StarterGuiService::CoreGuiType,bool,boost::hash<RBX::StarterGuiService::CoreGuiType>,std::equal_to<RBX::StarterGuiService::CoreGuiType>>>::rehash_impl(unsigned long)")
}
...
pub fn stub_f461e4() -> ! {
    todo!("0xf461e4 boost::function2<void,RBX::StarterGuiService::CoreGuiType,bool>::clear(void)")
}
...
pub fn stub_f461d4() -> ! {
    todo!("0xf461d4 boost::function2<void,RBX::StarterGuiService::CoreGuiType,bool>::assign_to_own(boost::function2<void,RBX::StarterGuiService::CoreGuiType,bool> const&)")
}
...
pub fn stub_f46124() -> ! {
    todo!("0xf46124 boost::multi_index::multi_index_container<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>,boost::flyweights::hashed_factory_class<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>,RBX::ProtectedString,mpl_::na,mpl_::na,mpl_::na>::index_list,std::allocator<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>>>::multi_index_container(boost::tuples::cons<boost::tuples::tuple<unsigned long,boost::multi_index::identity<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>>,boost::hash<RBX::ProtectedString>,std::equal_to<RBX::ProtectedString>,boost::tuples::null_type,boost::tuples::null_type,boost::tuples::null_type,boost::tuples::null_type,boost::tuples::null_type,boost::tuples::null_type>,boost::tuples::null_type> const&,std::allocator<boost::flyweights::detail::refcounted_value<boost::flyweights::detail::default_value_policy<RBX::ProtectedString>::rep_type,RBX::ProtectedString>> const&)")
}
...
pub fn stub_f46114() -> ! {
    todo!("0xf46114 boost::shared_ptr<RBX::TextLabel>::shared_ptr<RBX::TextLabel,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TextLabel *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f46104() -> ! {
    todo!("0xf46104 boost::shared_ptr<RBX::ScreenGui>::shared_ptr<RBX::ScreenGui,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ScreenGui *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f460f4() -> ! {
    todo!("0xf460f4 boost::shared_ptr<RBX::PlayerGui>::shared_ptr<RBX::PlayerGui,RBX::Creatable<RBX::Instance>::Deleter>(RBX::PlayerGui *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f460e4() -> ! {
    todo!("0xf460e4 boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::ScreenGui>(boost::shared_ptr<RBX::ScreenGui> const&)")
}

// 0xf460d4 — j___ZN5boost10flyweights6detail27recursive_lightweight_mutexC2Ev
// type: int __fastcall(boost::flyweights::detail::recursive_lightweight_mutex *this)
#[doc(alias = "boost::flyweights::detail::recursive_lightweight_mutex::recursive_lightweight_mutex(void)")]
pub fn stub_f460d4() -> ! {
    todo!("0xf460d4 boost::flyweights::detail::recursive_lightweight_mutex::recursive_lightweight_mutex(void)")
}
...
pub fn stub_f460c4() -> ! {
    todo!("0xf460c4 rbx::callable<rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::slot,boost::function<void ()(RBX::StarterGuiService::CoreGuiType,bool)>,2,void ()(RBX::StarterGuiService::CoreGuiType,bool)>::callable<rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>*>(boost::function<void ()(RBX::StarterGuiService::CoreGuiType,bool)> const&,rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>*)")
}
...
pub fn stub_f460b4() -> ! {
    todo!("0xf460b4 RBX::StarterGuiService::CoreGuiType & rbx::any_cast<RBX::StarterGuiService::CoreGuiType &,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")
}
...
pub fn stub_f460a4() -> ! {
    todo!("0xf460a4 RBX::StarterGuiService::CoreGuiType const& rbx::any_cast<RBX::StarterGuiService::CoreGuiType const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")
}
...
#[doc(alias = "RBX::StarterGuiService::CoreGuiType * rbx::any_cast<RBX::StarterGuiService::CoreGuiType,RBX::Region3>(rbx::placement_any<RBX::Region3> *)")]
pub fn stub_f46094() -> ! {
    todo!("0xf46094 RBX::StarterGuiService::CoreGuiType * rbx::any_cast<RBX::StarterGuiService::CoreGuiType,RBX::Region3>(rbx::placement_any<RBX::Region3> *)")
}
...
pub fn stub_f46084() -> ! {
    todo!("0xf46084 rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::on_error(std::exception &)")
}
...
pub fn stub_f46074() -> ! {
    todo!("0xf46074 rbx::signals::connection rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::connect<boost::function<void ()(RBX::StarterGuiService::CoreGuiType,bool)>>(boost::function<void ()(RBX::StarterGuiService::CoreGuiType,bool)> const&)")
}
...
pub fn stub_f46064() -> ! {
    todo!("0xf46064 rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::remove(rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::slot *)")
}
...
pub fn stub_f46054() -> ! {
    todo!("0xf46054 rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::insert(rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::slot *)")
}
...
pub fn stub_f46044() -> ! {
    todo!("0xf46044 rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::slot::safe_static_do_get_mutex(void)")
}
...
pub fn stub_f46024() -> ! {
    todo!("0xf46024 rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::safe_static_do_get_mutex(void)")
}
...
pub fn stub_f46014() -> ! {
    todo!("0xf46014 rbx::signals::signal<void ()(RBX::StarterGuiService::CoreGuiType,bool)>::disconnectAll(void)")
}
...
pub fn stub_f46004() -> ! {
    todo!("0xf46004 rbx::signals::signal_with_args<2,void ()(RBX::StarterGuiService::CoreGuiType,bool)>::operator()(RBX::StarterGuiService::CoreGuiType,bool)")
}
...
pub fn stub_f45ff4() -> ! {
    todo!("0xf45ff4 rbx::implementation::typed_holder<RBX::StarterGuiService::CoreGuiType>::singleton(void)")
}
...
pub fn stub_f45fe4() -> ! {
    todo!("0xf45fe4 rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::StarterGuiService::CoreGuiType>(RBX::StarterGuiService::CoreGuiType const&)")
}
...
pub fn stub_f45fd4() -> ! {
    todo!("0xf45fd4 boost::shared_ptr<RBX::TextLabel> RBX::Creatable<RBX::Instance>::create<RBX::TextLabel>(void)")
}
...
pub fn stub_f45fc4() -> ! {
    todo!("0xf45fc4 boost::shared_ptr<RBX::ScreenGui> RBX::Creatable<RBX::Instance>::create<RBX::ScreenGui>(void)")
}
...
pub fn stub_f45fb4() -> ! {
    todo!("0xf45fb4 boost::shared_ptr<RBX::PlayerGui> RBX::Creatable<RBX::Instance>::create<RBX::PlayerGui>(void)")
}
...
pub fn stub_f45fa4() -> ! {
    todo!("0xf45fa4 j___ZN3RBX4Name9doDeclareILZNS_14sBasePlayerGuiEEEERKS0_v")
}
...
pub fn stub_f45f94() -> ! {
    todo!("0xf45f94 j___ZN3RBX4Name9doDeclareILZNS_10sPlayerGuiEEEERKS0_v")
}
...
pub fn stub_f45de4() -> ! {
    todo!("0xf45de4 j___ZN3RBX26GlobalAdvancedSettingsItemINS_15PhysicsSettingsELZNS_16sPhysicsSettingsEEED0Ev")
}
