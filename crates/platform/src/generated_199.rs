//! platform — generated_199 — 150 stubs EA-sorted asc fallback gap filler | Source ida/export.json | range 0x2a5004..0x2abd38 | rbx_core::SharedPtr not boost
//! Source: ida/export.json (85545 funcs) global gap filler next 150 EA-sorted asc not yet stubbed in platform (fallback)
//! Distinct stub_ 32697/85545 -> 32847/85545 | uncovered 52848 -> 52698 (platform)
//! Batch: 150 stubs | range 0x2a5004..0x2abd38 | rbx_core::SharedPtr not boost
...
// was: boost::function1<void,boost::shared_ptr<RBX::Reflection::Tuple const>>::operator()(boost::shared_ptr<RBX::Reflection::Tuple const>)const (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a5550() -> ! {
    todo!("0x2a5550 boost::function1<void,boost::shared_ptr<RBX::Reflection::Tuple const>>::operator()(boost::shared_ptr<RBX::Reflection::Tuple const>)const")
}

// 0x2a5660 — __ZNK5boost9function4IvPKcS2_NS_10shared_ptrIN3RBX10BaseScriptEEEiEclES2_S2_S6_i
// was: boost::function4<void,char const*,char const*,boost::shared_ptr<RBX::BaseScript>,int>::operator()(char const*,char const*,boost::shared_ptr<RBX::BaseScript>,int)const (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: int __fastcall(int, int, std::string *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a5da0() -> ! {
    todo!("0x2a5da0 boost::function1<void,bool>::operator()(bool)const")
}

// 0x2a5e64 — __ZN3RBX11shared_fromINS_5Stats12StatsServiceEEEN5boost10shared_ptrIT_EEPS5_
// was: boost::shared_ptr<RBX::Stats::StatsService> RBX::shared_from<RBX::Stats::StatsService>(RBX::Stats::StatsService*) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a5e64() -> ! {
    todo!("0x2a5e64 boost::shared_ptr<RBX::Stats::StatsService> RBX::shared_from<RBX::Stats::StatsService>(RBX::Stats::StatsService*)")
}
...
pub fn stub_0x2a6058() -> ! {
    todo!("0x2a6058 RBX::RunningAverageTimeInterval<(RBX::Time::SampleMethod)1>::sample(void)")
}
...
pub fn stub_0x2a60b0() -> ! {
    todo!("0x2a60b0 RBX::RunningAverage<double,double>::sample(double)")
}
...
// was: void boost::shared_ptr<RBX::ScriptStats>::reset<RBX::ScriptStats>(RBX::ScriptStats *) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: _DWORD __fastcall(boost::thread *__hidden this) (boost::shared_ptr -> rbx_core::SharedPtr)
#[doc(alias = "boost::thread::join(void)")]
pub fn stub_0x2a6368() -> ! {
    todo!("0x2a6368 boost::thread::join(void)")
}

// 0x2a64a4 — __ZN5boost10shared_ptrIN3RBX12LuaStatsItemEEaSERKS3_
// was: boost::shared_ptr<RBX::LuaStatsItem>::operator=(boost::shared_ptr<RBX::LuaStatsItem> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::ScriptStats>::operator=(boost::shared_ptr<RBX::ScriptStats> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::RunService>::operator=(boost::shared_ptr<RBX::RunService> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
#[doc(alias = "rbx_core::SharedPtr<RBX::RunService>::operator=(rbx_core::SharedPtr<RBX::RunService> const&)")]
pub fn stub_0x2a65c8() -> ! {
    todo!("0x2a65c8 boost::shared_ptr<RBX::RunService>::operator=(boost::shared_ptr<RBX::RunService> const&)")
}
...
// was: boost::shared_ptr<RBX::StarterScript> RBX::Creatable<RBX::Instance>::create<RBX::StarterScript,RBX::ContentId>(RBX::ContentId) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::Instance>& boost::shared_ptr<RBX::Instance>::operator=<RBX::ScriptContext>(boost::shared_ptr<RBX::ScriptContext> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::CoreScript> RBX::Creatable<RBX::Instance>::create<RBX::CoreScript,RBX::ContentId>(RBX::ContentId) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::BaseScript> RBX::shared_from<RBX::BaseScript>(RBX::BaseScript*) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>::erase(__gnu_cxx::__normal_iterator<boost::shared_ptr<RBX::Instance>*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a6cc0() -> ! {
    todo!("0x2a6cc0 rbx::signals::signal_with_args<0,void ()(void)>::operator()(void)")
}
...
// was: boost::shared_ptr<RBX::BaseScript>::operator=(boost::shared_ptr<RBX::BaseScript> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: rbx::signals::signal_with_args<3,void ()(std::string,std::string,boost::shared_ptr<RBX::Instance>)>::operator()(std::string,std::string,boost::shared_ptr<RBX::Instance>) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a7120() -> ! {
    todo!("0x2a7120 RBX::Security::Impersonator::Impersonator(RBX::Security::Identities)")
}
...
// was: boost::intrusive_ptr<RBX::Lua::WeakThreadRef::Node>::operator=(RBX::Lua::WeakThreadRef::Node*) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a7348() -> ! {
    todo!("0x2a7348 std::basic_string<char,std::char_traits<char>,std::allocator<char>> std::operator+<char,std::char_traits<char>,std::allocator<char>>(std::basic_string<char,std::char_traits<char>,std::allocator<char>> const&,std::basic_string<char,std::char_traits<char>,std::allocator<char>> const&)")
}
...
pub fn stub_0x2a73ec() -> ! {
    todo!("0x2a73ec boost::function1<std::string,std::string const&>::operator()(std::string const&)const")
}
...
// was: int __fastcall(int, char, int, struct _Unwind_Exception *lpuexcpt, int, int, int, int, int, int, int, int, int, int, int, int, char, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::Scripting::DebuggerWatch> RBX::Creatable<RBX::Instance>::create<RBX::Scripting::DebuggerWatch>(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::Scripting::DebuggerWatch>::shared_ptr<RBX::Scripting::DebuggerWatch,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Scripting::DebuggerWatch *,RBX::Creatable<RBX::Instance>::Deleter) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Scripting::DebuggerWatch,RBX::Scripting::DebuggerWatch>(boost::shared_ptr<RBX::Scripting::DebuggerWatch> const*,RBX::Scripting::DebuggerWatch *)const (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: int __fastcall(int, int, int, int, void *, int) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::Scripting::ScriptDebugger> RBX::Creatable<RBX::Instance>::create<RBX::Scripting::ScriptDebugger>(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::intrusive_ptr<rbx::signals::signal<void ()(int)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(int)>::slot> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a947c() -> ! {
    todo!("0x2a947c boost::intrusive_ptr<rbx::signals::signal<void ()(int)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(int)>::slot> const&)")
}
...
pub fn stub_0x2a94a0() -> ! {
    todo!("0x2a94a0 rbx::signals::signal<void ()(int)>::safe_static_do_get_mutex(void)")
}
...
pub fn stub_0x2a9598() -> ! {
    todo!("0x2a9598 rbx::signals::signal<void ()(void)>::disconnectAll(void)")
}

// 0x2a9710 — __ZN5boost13intrusive_ptrIN3rbx7signals6signalIFvvEE4slotEEaSERKS7_
// was: boost::intrusive_ptr<rbx::signals::signal<void ()(void)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(void)>::slot> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
pub fn stub_0x2a9710() -> ! {
    todo!("0x2a9710 boost::intrusive_ptr<rbx::signals::signal<void ()(void)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(void)>::slot> const&)")
}
...
pub fn stub_0x2a9738() -> ! {
    todo!("0x2a9738 rbx::signals::signal<void ()(void)>::safe_static_do_get_mutex(void)")
}

// 0x2a9830 — __ZN3rbx7signals6signalIFvN5boost10shared_ptrIN3RBX8InstanceEEEEE13disconnectAllEv
// type: int __fastcall(int, int, int, int, char, int, int, int, int, int)
// was: rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>)>::disconnectAll(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::intrusive_ptr<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>)>::slot>::operator=(boost::intrusive_ptr<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>)>::slot> const&) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>)>::safe_static_do_get_mutex(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::Scripting::ScriptDebugger>::shared_ptr<RBX::Scripting::ScriptDebugger,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Scripting::ScriptDebugger *,RBX::Creatable<RBX::Instance>::Deleter) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Scripting::ScriptDebugger,RBX::Scripting::ScriptDebugger>(boost::shared_ptr<RBX::Scripting::ScriptDebugger> const*,RBX::Scripting::ScriptDebugger *)const (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::LocalScript> RBX::Creatable<RBX::Instance>::create<RBX::LocalScript>(void) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: boost::shared_ptr<RBX::LocalScript>::shared_ptr<RBX::LocalScript,RBX::Creatable<RBX::Instance>::Deleter>(RBX::LocalScript *,RBX::Creatable<RBX::Instance>::Deleter) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::LocalScript,RBX::LocalScript>(boost::shared_ptr<RBX::LocalScript> const*,RBX::LocalScript *)const (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>::_M_erase_at_end(boost::shared_ptr<RBX::Instance>*) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// type: int __fastcall(int, int, int, int, int, int, int, int, void *, int)
// was: void std::__uninitialized_fill_n_aux<boost::shared_ptr<RBX::Instance> *,unsigned long,boost::shared_ptr<RBX::Instance>>(boost::shared_ptr<RBX::Instance> *,unsigned long,boost::shared_ptr<RBX::Instance> const&,std::__false_type) (boost::shared_ptr -> rbx_core::SharedPtr)
...
// was: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, char, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int, int) (boost::shared_ptr -> rbx_core::SharedPtr)
