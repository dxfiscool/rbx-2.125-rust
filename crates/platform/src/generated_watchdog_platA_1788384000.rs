//! platform — generated_watchdog_platA_1788384000 — 100 stubs EA-sorted asc platform iOS/RobloxView/GameView/Touch/Watchdog/Platform/UIService/Adorn
//! Source: ida/export.json (85545 funcs) filter iOS|View|Gui|Input|RobloxView|GameView|Touch|Watchdog|Platform|UIService|Adorn skip /tmp/global_eas.txt EA-sorted asc
//! Batch: 100 stubs | range 0x7d6160..0x8bc8d0 | rbx_core::SharedPtr not boost
...
// type: _DWORD __fastcall(RBX::NotificationBox *__hidden this, RBX::Adorn *)
#[doc(alias = "`non-virtual thunk to'RBX::NotificationBox::render2d(RBX::Adorn *)")]
...
// type: _DWORD __fastcall(RBX::NotificationObject *__hidden this, RBX::Adorn *)
#[doc(alias = "`non-virtual thunk to'RBX::NotificationObject::render2d(RBX::Adorn *)")]
...
// type: _DWORD __fastcall(RBX::TextureTrail *__hidden this, RBX::Adorn *)
#[doc(alias = "`non-virtual thunk to'RBX::TextureTrail::render3dAdorn(RBX::Adorn *)")]
...
pub fn stub_867de4() -> ! {
    todo!("0x867de4 __ZN3RBX9FloorWire13render3dAdornEPNS_5AdornE")
}

// 0x8685d8 — __ZThn96_N3RBX9FloorWire13render3dAdornEPNS_5AdornE
// type: _DWORD __fastcall(RBX::FloorWire *__hidden this, RBX::Adorn *)
#[doc(alias = "`non-virtual thunk to'RBX::FloorWire::render3dAdorn(RBX::Adorn *)")]
...
pub fn stub_868ce0() -> ! {
    todo!("0x868ce0 __ZNK3RBX9GuiBase3d19shouldRender3dAdornEv")
}
...
// type: void __fastcall(RBX::UserInputService *__hidden this)
#[doc(alias = "`non-virtual thunk to'RBX::UserInputService::~UserInputService()")]
