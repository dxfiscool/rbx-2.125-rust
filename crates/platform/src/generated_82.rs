//! platform generated_82 — next 100 stubs EA-sorted desc high-EA filler after 0xf48a74
//! Filter: high-EA filler EA-sorted desc, rbx_core::SharedPtr not boost
//! Batch: 100 stubs EA-sorted desc | skeleton batch | range 0xf48434..0xf48a64 (rbx_core::SharedPtr not boost)
...
pub fn stub_f48a64() -> ! {
    todo!("0xf48a64 j___ZN3RBX4Name9doDeclareILZNS_10sGuiObjectEEEERKS0_v")
}
...
pub fn stub_f48a54() -> ! {
    todo!("0xf48a54 j___ZN3RBX4Name7declareILZNS_12sTextServiceEEEERKS0_v")
}
...
pub fn stub_f48a44() -> ! {
    todo!("0xf48a44 j___ZN3RBX4Name7declareILZNS_10sGuiObjectEEEERKS0_v")
}
...
pub fn stub_f489b4() -> ! {
    todo!("0xf489b4 boost::shared_ptr<RBX::TextBox> RBX::shared_from<RBX::TextBox>(RBX::TextBox*)")
}
...
pub fn stub_f489a4() -> ! {
    todo!("0xf489a4 RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::TextService::FontSize> const>::doGetSingleton(void)")
}
...
pub fn stub_f48994() -> ! {
    todo!("0xf48994 RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::TextService::Font> const>::doGetSingleton(void)")
}
...
pub fn stub_f48984() -> ! {
    todo!("0xf48984 RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::TextService::YAlignment> const>::doGetSingleton(void)")
}
...
pub fn stub_f48974() -> ! {
    todo!("0xf48974 RBX::Reflection::Singleton<RBX::Reflection::EnumDesc<RBX::TextService::XAlignment> const>::doGetSingleton(void)")
}
...
pub fn stub_f48824() -> ! {
    todo!("0xf48824 boost::shared_ptr<RBX::Team> RBX::shared_from<RBX::Team>(RBX::Team*)")
}
...
pub fn stub_f487d4() -> ! {
    todo!("0xf487d4 j___ZN3RBX4Name9doDeclareILZNS_5sTeamEEEERKS0_v")
}
...
pub fn stub_f48754() -> ! {
    todo!("0xf48754 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::SurfaceSelection,RBX::SurfaceSelection>(boost::shared_ptr<RBX::SurfaceSelection> const*,RBX::SurfaceSelection *)const")
}
...
pub fn stub_f48714() -> ! {
    todo!("0xf48714 boost::shared_ptr<RBX::SurfaceSelection>::shared_ptr<RBX::SurfaceSelection,RBX::Creatable<RBX::Instance>::Deleter>(RBX::SurfaceSelection *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f48704() -> ! {
    todo!("0xf48704 boost::shared_ptr<RBX::SurfaceSelection> RBX::Creatable<RBX::Instance>::create<RBX::SurfaceSelection>(void)")
}
...
pub fn stub_f486f4() -> ! {
    todo!("0xf486f4 j___ZN3RBX4Name9doDeclareILZNS_17sSurfaceSelectionEEEERKS0_v")
}
...
pub fn stub_f48654() -> ! {
    todo!("0xf48654 RBX::SurfaceType * rbx::any_cast<RBX::SurfaceType,RBX::Region3>(rbx::placement_any<RBX::Region3> *)")
}
...
pub fn stub_f48494() -> ! {
    todo!("0xf48494 std::map<std::string,std::string,std::less<std::string>,std::allocator<std::pair<std::string const,std::string>>>::operator[](std::string const&)")
}
...
pub fn stub_f48484() -> ! {
    todo!("0xf48484 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Time>>,std::string,RBX::Time,boost::hash<std::string>,std::equal_to<std::string>>>::find_node(std::string const&)const")
}
...
pub fn stub_f48474() -> ! {
    todo!("0xf48474 boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Time>>,std::string,RBX::Time,boost::hash<std::string>,std::equal_to<std::string>>>::min_buckets_for_size(unsigned long)const")
}
...
pub fn stub_f48464() -> ! {
    todo!("0xf48464 boost::unordered::iterator_detail::iterator<boost::unordered::detail::ptr_node<std::pair<std::string const,RBX::Time>>> boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<std::string const,RBX::Time>>,std::string,RBX::Time,boost::hash<std::string>,std::equal_to<std::string>>>::find_node_impl<std::string,std::equal_to<std::string>>(unsigned long,std::string const&,std::equal_to<std::string> const&)const")
}
...
pub fn stub_f48454() -> ! {
    todo!("0xf48454 boost::function0<unsigned long>::operator()(void)const")
}
...
pub fn stub_f48444() -> ! {
    todo!("0xf48444 boost::function0<float>::operator()(void)const")
}
