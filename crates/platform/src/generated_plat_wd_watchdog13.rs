//! platform — generated_plat_wd_watchdog13 — 100 stubs EA-sorted asc gap filler NOT yet in rbx_platform
//! Source: ida/export.json (85545 funcs) global gap filler EA-sorted asc next 100 after generated_plat_wd_watchdog12 0x46fb68 (platform strict Platform/iOS 0 left, filler 100)
//! Range 0x46fba0..0x4758a8 | distinct 41566/85545 -> 41666/85545 | rbx_core::SharedPtr not boost
//! Batch: generated_plat_wd_watchdog13 100 stubs (filtered Platform/iOS 0 + filler 100) EA-sorted asc distinct
...
// was: RBX::DataModel::MouseStats::MouseStats(void)
...
// was: RBX::DataModel::GenericJob::GenericJob(rbx_core::SharedPtr<RBX::DataModel>,char const*,RBX::DataModelJob::TaskType)
...
// was: RBX::DataModel::GenericJob::~GenericJob()
...
// was: RBX::DataModel::GenericJob::sleepTime(RBX::TaskScheduler::Job::Stats const&)
...
// was: RBX::DataModel::GenericJob::error(RBX::TaskScheduler::Job::Stats const&)
...
// type: _DWORD __fastcall(RBX::DataModel::GenericJob *__hidden this, const RBX::TaskScheduler::Job::Stats *)
// was: RBX::DataModel::GenericJob::stepDataModelJob(RBX::TaskScheduler::Job::Stats const&)
...
// was: RBX::DataModel::GenericJob::processTasks(void)
...
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::Instance::SaveFilter>,std::_Select1st<std::pair<RBX::Name const* const,RBX::Instance::SaveFilter>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::Instance::SaveFilter>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::Instance::SaveFilter>> *)
...
// type: int __fastcall(_DWORD, _DWORD)
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::DataModel::GearType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::DataModel::GearType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::DataModel::GearType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::DataModel::GearType>> *)
...
// type: int __fastcall(_DWORD, _DWORD)
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::DataModel::GearGenreSetting>,std::_Select1st<std::pair<RBX::Name const* const,RBX::DataModel::GearGenreSetting>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::DataModel::GearGenreSetting>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::DataModel::GearGenreSetting>> *)
...
// type: int __fastcall(_DWORD, _DWORD)
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::DataModel::Genre>,std::_Select1st<std::pair<RBX::Name const* const,RBX::DataModel::Genre>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::DataModel::Genre>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::DataModel::Genre>> *)
...
// type: int __fastcall(_DWORD, _DWORD)
// was: std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::DataModel::CreatorType>,std::_Select1st<std::pair<RBX::Name const* const,RBX::DataModel::CreatorType>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::DataModel::CreatorType>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::DataModel::CreatorType>> *)
...
// was: RBX::Reflection::EnumDesc<RBX::DataModelArbiter::ConcurrencyModel>::EnumDesc(void)
...
// was: RBX::DataModelJob::DataModelJob(char const*,RBX::DataModelJob::TaskType,bool,rbx_core::SharedPtr<RBX::DataModelArbiter>,RBX::Time::Interval)
...
// was: RBX::DataModelJob::step(RBX::TaskScheduler::Job::Stats const&)
...
// was: RBX::DataModelJob::getPriorityFactor(void)
...
// was: RBX::DataModelArbiter::areExclusive(RBX::TaskScheduler::Job *,RBX::TaskScheduler::Job *)
...
// was: RBX::DataModelArbiter::DataModelArbiter(void)
...
// was: RBX::DataModelArbiter::~DataModelArbiter()
...
// was: RBX::DataModelArbiter::preStep(RBX::TaskScheduler::Job *)
...
// type: _DWORD __fastcall(RBX::DataModelArbiter *__hidden this, RBX::TaskScheduler::Job *)
// was: RBX::DataModelArbiter::postStep(RBX::TaskScheduler::Job *)
...
// type: int(void)
// was: RBX::Reflection::EnumDesc<RBX::DataModelArbiter::ConcurrencyModel>::addPair(RBX::DataModelArbiter::ConcurrencyModel,char const*)
...
// was: RBX::DataModelJob::~DataModelJob()
...
// was: RBX::SimpleThrottlingArbiter::isThrottled(void)
...
// was: RBX::TaskScheduler::Arbiter::getSyncronizationArbiter(void)
...
// was: RBX::Reflection::EnumDesc<RBX::DataModelArbiter::ConcurrencyModel>::~EnumDesc()
...
// was: RBX::Reflection::EnumDesc<RBX::DataModelArbiter::ConcurrencyModel>::convertToString(unsigned long,std::string &)const
...
// was: rbx::implementation::typed_holder<RBX::DataModelArbiter::ConcurrencyModel>::construct_func(char const*,char *)
...
// type: int(void)
// was: RBX::Reflection::EnumDesc<RBX::DataModelArbiter::ConcurrencyModel>::convertToItem(RBX::DataModelArbiter::ConcurrencyModel const&)const
...
// type: int(void)
// was: RBX::DataModelArbiter::ConcurrencyModel const& rbx::any_cast<RBX::DataModelArbiter::ConcurrencyModel const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)
...
// was: rbx_core::SharedPtr<RBX::Limits::Counter>::shared_ptr<RBX::Limits::Counter>(RBX::Limits::Counter *)
...
// was: std::vector<RBX::Name const*,std::allocator<RBX::Name const*>>::resize(unsigned long,RBX::Name const*)
...
// type: int __fastcall(_DWORD, _DWORD, _DWORD)
// was: std::vector<RBX::Reflection::EnumDescriptor::Item const*,std::allocator<RBX::Reflection::EnumDescriptor::Item const*>>::resize(unsigned long,RBX::Reflection::EnumDescriptor::Item const*)
...
// type: int(void)
// was: std::_Vector_base<RBX::Reflection::EnumDescriptor::Item const*,std::allocator<RBX::Reflection::EnumDescriptor::Item const*>>::_M_allocate(unsigned long)
...
// was: std::vector<std::string,std::allocator<std::string>>::_M_fill_insert(__gnu_cxx::__normal_iterator<std::string *,std::vector<std::string,std::allocator<std::string>>>,unsigned long,std::string const&)
...
// type: int(void)
// was: std::_Vector_base<unsigned long,std::allocator<unsigned long>>::_M_allocate(unsigned long)
...
// type: int(void)
// was: RBX::ActivityMeter<2>::updateBuckets(void)
...
// was: RBX::OnScreenProfiler::GetInst(void)
...
// type: _DWORD __fastcall(RBX::OnScreenProfiler *__hidden this)
// was: RBX::OnScreenProfiler::Create(void)
