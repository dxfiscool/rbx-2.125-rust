//! platform — generated_plat_input_1788375157 — 100 stubs EA-sorted asc distinct not yet in platform | Source ida/export.json | range 0x52a9bc..0x52f128 | rbx_core::SharedPtr not boost
//! Filter: iOS|Controller|View|Gui|Input (6872 total, 2870 uncovered before batch, 100 in batch) EA-sorted asc distinct not yet in platform (platform gap, no global fallback needed)
//! Distinct stub_ 44443/85545 -> 44543/85545 | platform filtered remaining 2770
//! Batch: 100 stubs | range 0x52a9bc..0x52f128 | rbx_core::SharedPtr not boost
...
// 0x52a9bc — RBX::Reflection::EnumDesc<RBX::GuiButton::Style>::EnumDesc(void)
// type: 
#[doc(alias = "RBX::Reflection::EnumDesc<RBX::GuiButton::Style>::EnumDesc(void)")]
pub fn stub_0x52a9bc() -> ! {
    todo!("0x52a9bc RBX::Reflection::EnumDesc<RBX::GuiButton::Style>::EnumDesc(void)")
}

// 0x52ab98 — RBX::GuiButton::GuiButton(char const*)
...
pub fn stub_0x52ab98() -> ! {
    todo!("0x52ab98 RBX::GuiButton::GuiButton(char const*)")
}

// 0x52b088 — RBX::GuiButton::setServerGuiObject(void)
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
#[doc(alias = "RBX::GuiButton::setServerGuiObject(void)")]
pub fn stub_0x52b088() -> ! {
    todo!("0x52b088 RBX::GuiButton::setServerGuiObject(void)")
}

// 0x52b104 — RBX::GuiButton::onPropertyChanged(RBX::Reflection::PropertyDescriptor const&)
...
pub fn stub_0x52b104() -> ! {
    todo!("0x52b104 RBX::GuiButton::onPropertyChanged(RBX::Reflection::PropertyDescriptor const&)")
}

// 0x52b150 — RBX::GuiButton::getChildRect2D(void)const
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
#[doc(alias = "RBX::GuiButton::getChildRect2D(void)const")]
pub fn stub_0x52b150() -> ! {
    todo!("0x52b150 RBX::GuiButton::getChildRect2D(void)const")
}

// 0x52b1e0 — RBX::GuiButton::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)
...
pub fn stub_0x52b1e0() -> ! {
    todo!("0x52b1e0 RBX::GuiButton::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}

// 0x52b31c — RBX::GuiButton::render2dButtonImpl(RBX::Adorn *,G3D::Rect2D &)
...
// 0x52ba84 — RBX::GuiButton::processMouseEvent(RBX::GuiEvent const&)
// type: 
#[doc(alias = "RBX::GuiButton::processMouseEvent(RBX::GuiEvent const&)")]
pub fn stub_0x52ba84() -> ! {
    todo!("0x52ba84 RBX::GuiButton::processMouseEvent(RBX::GuiEvent const&)")
}

// 0x52bc78 — RBX::GuiLabel::GuiLabel(char const*)
...
pub fn stub_0x52bc78() -> ! {
    todo!("0x52bc78 RBX::GuiLabel::GuiLabel(char const*)")
}

// 0x52bdd0 — RBX::Reflection::BoundFuncDesc<RBX::GuiObject,bool ()(RBX::UDim2,RBX::UDim2,RBX::GuiObject::TweenEasingDirection,RBX::GuiObject::TweenEasingStyle,float,bool,RBX::Lua::WeakFunctionRef),7>::~BoundFuncDesc()
// type: 
...
// 0x52bdd8 — RBX::GuiObject::getSize(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getSize(void)const")]
pub fn stub_0x52bdd8() -> ! {
    todo!("0x52bdd8 RBX::GuiObject::getSize(void)const")
}

// 0x52bde8 — RBX::Reflection::PropDescriptor<RBX::GuiObject,RBX::UDim2>::~PropDescriptor()
// type: 
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::GuiObject,RBX::UDim2>::~PropDescriptor()")]
pub fn stub_0x52bde8() -> ! {
    todo!("0x52bde8 RBX::Reflection::PropDescriptor<RBX::GuiObject,RBX::UDim2>::~PropDescriptor()")
}

// 0x52be0c — RBX::GuiObject::getPosition(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getPosition(void)const")]
pub fn stub_0x52be0c() -> ! {
    todo!("0x52be0c RBX::GuiObject::getPosition(void)const")
}

// 0x52be1c — RBX::GuiObject::getBorderSizePixel(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getBorderSizePixel(void)const")]
pub fn stub_0x52be1c() -> ! {
    todo!("0x52be1c RBX::GuiObject::getBorderSizePixel(void)const")
}

// 0x52be24 — RBX::Reflection::PropDescriptor<RBX::GuiObject,int>::~PropDescriptor()
// type: 
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::GuiObject,int>::~PropDescriptor()")]
pub fn stub_0x52be24() -> ! {
    todo!("0x52be24 RBX::Reflection::PropDescriptor<RBX::GuiObject,int>::~PropDescriptor()")
}

// 0x52be48 — RBX::GuiObject::getSizeConstraint(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getSizeConstraint(void)const")]
pub fn stub_0x52be48() -> ! {
    todo!("0x52be48 RBX::GuiObject::getSizeConstraint(void)const")
}

// 0x52be50 — RBX::Reflection::EnumPropDescriptor<RBX::GuiObject,RBX::GuiObject::SizeConstraint>::~EnumPropDescriptor()
// type: 
...
pub fn stub_0x52be50() -> ! {
    todo!("0x52be50 RBX::Reflection::EnumPropDescriptor<RBX::GuiObject,RBX::GuiObject::SizeConstraint>::~EnumPropDescriptor()")
}

// 0x52be74 — RBX::GuiObject::getBorderColor(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getBorderColor(void)const")]
pub fn stub_0x52be74() -> ! {
    todo!("0x52be74 RBX::GuiObject::getBorderColor(void)const")
}

// 0x52be98 — RBX::Reflection::PropDescriptor<RBX::GuiObject,RBX::BrickColor>::~PropDescriptor()
// type: 
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::GuiObject,RBX::BrickColor>::~PropDescriptor()")]
pub fn stub_0x52be98() -> ! {
    todo!("0x52be98 RBX::Reflection::PropDescriptor<RBX::GuiObject,RBX::BrickColor>::~PropDescriptor()")
}

// 0x52bebc — RBX::GuiObject::getBorderColor3(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getBorderColor3(void)const")]
pub fn stub_0x52bebc() -> ! {
    todo!("0x52bebc RBX::GuiObject::getBorderColor3(void)const")
}

// 0x52bed0 — RBX::Reflection::PropDescriptor<RBX::GuiObject,G3D::Color3>::~PropDescriptor()
// type: 
...
// 0x52bef4 — RBX::GuiObject::getBackgroundColor(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getBackgroundColor(void)const")]
pub fn stub_0x52bef4() -> ! {
    todo!("0x52bef4 RBX::GuiObject::getBackgroundColor(void)const")
}

// 0x52bf18 — RBX::GuiObject::getBackgroundColor3(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getBackgroundColor3(void)const")]
pub fn stub_0x52bf18() -> ! {
    todo!("0x52bf18 RBX::GuiObject::getBackgroundColor3(void)const")
}

// 0x52bf2c — RBX::GuiObject::getBackgroundTransparency(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getBackgroundTransparency(void)const")]
pub fn stub_0x52bf2c() -> ! {
    todo!("0x52bf2c RBX::GuiObject::getBackgroundTransparency(void)const")
}

// 0x52bf34 — RBX::Reflection::PropDescriptor<RBX::GuiObject,float>::~PropDescriptor()
// type: 
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::GuiObject,float>::~PropDescriptor()")]
pub fn stub_0x52bf34() -> ! {
    todo!("0x52bf34 RBX::Reflection::PropDescriptor<RBX::GuiObject,float>::~PropDescriptor()")
}

// 0x52bf58 — RBX::GuiObject::getDraggable(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
#[doc(alias = "RBX::GuiObject::getDraggable(void)const")]
pub fn stub_0x52bf58() -> ! {
    todo!("0x52bf58 RBX::GuiObject::getDraggable(void)const")
}

// 0x52bf60 — RBX::Reflection::PropDescriptor<RBX::GuiObject,bool>::~PropDescriptor()
// type: 
#[doc(alias = "RBX::Reflection::PropDescriptor<RBX::GuiObject,bool>::~PropDescriptor()")]
pub fn stub_0x52bf60() -> ! {
    todo!("0x52bf60 RBX::Reflection::PropDescriptor<RBX::GuiObject,bool>::~PropDescriptor()")
}

// 0x52bf84 — RBX::GuiObject::getClipping(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
...
// 0x52bf8c — RBX::GuiObject::getVisible(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
...
// 0x52bf94 — RBX::GuiObject::getActive(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
...
// 0x52bf9c — RBX::GuiObject::getTransparencyLegacy(void)const
// type: _DWORD __fastcall(RBX::GuiObject *__hidden this)
...
// 0x52bfa4 — RBX::Reflection::RemoteEventDesc<RBX::GuiObject,void ()(int,int),rbx::remote_signal<void ()(int,int)>>::~RemoteEventDesc()
// type: 
...
// 0x52bfc8 — RBX::Reflection::RemoteEventDesc<RBX::GuiObject,void ()(RBX::UDim2),rbx::remote_signal<void ()(RBX::UDim2)>>::~RemoteEventDesc()
// type: 
...
// 0x52bfec — RBX::Reflection::EnumDesc<RBX::GuiObject::TweenEasingDirection>::addPair(RBX::GuiObject::TweenEasingDirection,char const*)
// type: 
...
// 0x52c34c — RBX::GuiObject::TweenEasingDirection & RBX::Reflection::Variant::genericConvert<RBX::GuiObject::TweenEasingDirection>(void)
// type: 
...
// 0x52c538 — RBX::Reflection::EnumDesc<RBX::GuiObject::TweenEasingStyle>::addPair(RBX::GuiObject::TweenEasingStyle,char const*)
// type: 
...
// 0x52c898 — RBX::GuiObject::TweenEasingStyle & RBX::Reflection::Variant::genericConvert<RBX::GuiObject::TweenEasingStyle>(void)
// type: 
...
// 0x52ca84 — RBX::Reflection::EnumDesc<RBX::GuiObject::TweenStatus>::addPair(RBX::GuiObject::TweenStatus,char const*)
// type: 
...
// 0x52cde4 — boost::function2<void,RBX::GuiObject *,RBX::UDim2>::operator()(RBX::GuiObject *,RBX::UDim2)const
// type: 
...
// 0x52ceb8 — boost::_bi::bind_t<void,void (*)(boost::function<void ()(RBX::GuiObject::TweenStatus)>,RBX::GuiObject::TweenStatus),boost::_bi::list_av_2<boost::function<void ()(RBX::GuiObject::TweenStatus)>,RBX::GuiObject::TweenStatus>::type> boost::bind<void,boost::function<void ()(RBX::GuiObject::TweenStatus)>,RBX::GuiObject::TweenStatus,boost::function<void ()(RBX::GuiObject::TweenStatus)>,RBX::GuiObject::TweenStatus>(void (*)(boost::function<void ()(RBX::GuiObject::TweenStatus)>,RBX::GuiObject::TweenStatus),boost::function<void ()(RBX::GuiObject::TweenStatus)>,RBX::GuiObject::TweenStatus)
...
// 0x52cfc0 — boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus),boost::_bi::list_av_3<boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>>::type> boost::bind<void,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>>(void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus),boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>)
...
// 0x52d230 — boost::_bi::bind_t<void,void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list_av_2<boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef>::type> boost::bind<void,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef>(void (*)(boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::weak_ptr<RBX::GuiObject>,RBX::Lua::WeakFunctionRef)
// type: int __fastcall(int, int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, char, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, int, int, int, int, int)
...
// 0x52d488 — boost::scoped_ptr<RBX::GuiObject::Tweens>::reset(RBX::GuiObject::Tweens*)
// type: 
...
// 0x52d55c — boost::function<void ()(RBX::GuiObject::TweenStatus)>::operator=(boost::function<void ()(RBX::GuiObject::TweenStatus)> const&)
// type: 
...
// 0x52d620 — RBX::EventReplicatorBase<RBX::GuiObject,void ()(int,int)>::setListenerMode(bool)
// type: 
...
// 0x52d780 — RBX::EventReplicatorBase<RBX::GuiObject,void ()(RBX::UDim2)>::setListenerMode(bool)
// type: 
...
// 0x52d9c4 — RBX::EventReplicatorBase<RBX::GuiObject,void ()(int,int)>::onPropertyChanged(RBX::Reflection::PropertyDescriptor const&)
// type: 
...
// 0x52da24 — RBX::EventReplicatorBase<RBX::GuiObject,void ()(RBX::UDim2)>::onPropertyChanged(RBX::Reflection::PropertyDescriptor const&)
// type: 
...
// 0x52dd4c — RBX::Reflection::BoundFuncDesc<RBX::GuiButton,void ()(std::string),1>::~BoundFuncDesc()
// type: 
...
// 0x52de40 — RBX::Reflection::RemoteEventDesc<RBX::GuiButton,void ()(void),rbx::remote_signal<void ()(void)>>::~RemoteEventDesc()
// type: 
...
// 0x52de64 — RBX::Reflection::RemoteEventDesc<RBX::GuiButton,void ()(int,int),rbx::remote_signal<void ()(int,int)>>::~RemoteEventDesc()
// type: 
...
// 0x52de88 — RBX::GuiButton::getAutoButtonColor(void)const
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
...
// 0x52de90 — RBX::Reflection::PropDescriptor<RBX::GuiButton,bool>::~PropDescriptor()
// type: 
...
// 0x52deb4 — RBX::GuiButton::getSelected(void)const
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
...
// 0x52debc — RBX::GuiButton::getModal(void)const
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
...
// 0x52dec4 — RBX::GuiButton::getStyle(void)const
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
...
// 0x52decc — RBX::Reflection::EnumPropDescriptor<RBX::GuiButton,RBX::GuiButton::Style>::~EnumPropDescriptor()
// type: 
...
// 0x52def0 — RBX::Reflection::EnumDesc<RBX::GuiButton::Style>::addPair(RBX::GuiButton::Style,char const*)
// type: 
...
// 0x52e250 — RBX::EventReplicatorBase<RBX::GuiButton,void ()(void)>::setListenerMode(bool)
// type: 
...
// 0x52e3b0 — RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>::setListenerMode(bool)
// type: 
...
// 0x52e510 — RBX::EventReplicatorBase<RBX::GuiButton,void ()(void)>::onPropertyChanged(RBX::Reflection::PropertyDescriptor const&)
// type: 
...
// 0x52e570 — RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>::onPropertyChanged(RBX::Reflection::PropertyDescriptor const&)
// type: 
...
// 0x52e5e0 — RBX::GuiButton::~GuiButton()
...
// 0x52e5e4 — RBX::GuiButton::~GuiButton()
// type: void __fastcall(RBX::GuiButton *__hidden this)
#[doc(alias = "RBX::GuiButton::~GuiButton()")]
...
// 0x52e6ac — RBX::GuiButton::isGuiLeaf(void)const
// type: _DWORD __fastcall(RBX::GuiButton *__hidden this)
...
// 0x52e6b0 — `non-virtual thunk toRBX::GuiButton::~GuiButton()
// type: void __fastcall(RBX::GuiButton *__hidden this)
...
// 0x52e784 — `non-virtual thunk toRBX::GuiButton::~GuiButton()
// type: void __fastcall(RBX::GuiButton *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::GuiButton::~GuiButton()")]
...
// 0x52e834 — RBX::GuiLabel::~GuiLabel()
// type: void __fastcall(RBX::GuiLabel *__hidden this)
#[doc(alias = "RBX::GuiLabel::~GuiLabel()")]
...
// 0x52e8fc — `non-virtual thunk toRBX::GuiLabel::~GuiLabel()
// type: void __fastcall(RBX::GuiLabel *__hidden this)
...
// 0x52e9d0 — `non-virtual thunk toRBX::GuiLabel::~GuiLabel()
// type: void __fastcall(RBX::GuiLabel *__hidden this)
#[doc(alias = "non-virtual thunk toRBX::GuiLabel::~GuiLabel()")]
...
// 0x52ee40 — rbx::signals::connection rbx::signals::signal<void ()(void)>::connect<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>>(boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>> const&)
// type: 
...
// 0x52eeb4 — RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>::listenerConnectionAdded(void)
// type: 
...
// 0x52ef00 — rbx::signals::signal<void ()(void)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>>::~callable_slot()
// type: 
...
// 0x52ef2c — rbx::signals::signal<void ()(void)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>>::~callable_slot()
// type: 
#[doc(alias = "rbx::signals::signal<void ()(void)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>>::~callable_slot()")]
...
// 0x52f000 — rbx::callable<rbx::signals::signal<void ()(void)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>,0,void ()(void)>::call(void)
// type: 
...
// 0x52f008 — `non-virtual thunk torbx::callable<rbx::signals::signal<void ()(void)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>,0,void ()(void)>::call(void)
// type: 
...
// 0x52f028 — rbx::callable<rbx::signals::signal<void ()(void)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>,0,void ()(void)>::~callable()
// type: 
...
// 0x52f054 — rbx::callable<rbx::signals::signal<void ()(void)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>,0,void ()(void)>::~callable()
// type: 
#[doc(alias = "rbx::callable<rbx::signals::signal<void ()(void)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(int,int)>*>>>,0,void ()(void)>::~callable()")]
...
// 0x52f128 — rbx::signals::connection rbx::signals::signal<void ()(void)>::connect<boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(void)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(void)>*>>>>(boost::_bi::bind_t<void,boost::_mfi::mf0<void,RBX::EventReplicatorBase<RBX::GuiButton,void ()(void)>>,boost::_bi::list1<boost::_bi::value<RBX::EventReplicatorBase<RBX::GuiButton,void ()(void)>*>>> const&)
// type: 
