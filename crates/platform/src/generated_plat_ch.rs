//! platform — generated_plat_ch — 100 stubs EA-sorted asc global gap filler | Source ida/export.json | Distinct 43646->43746 | range 0x5092dc..0x50ced8 | rbx_core::SharedPtr not boost | ObjC doc aliases
//! Source: ida/export.json (85545 funcs) global gap filler next 100 EA-sorted asc not yet stubbed in platform after 0x509208
//! Distinct stub_ 43646/85545 -> 43746/85545 | uncovered 41899 -> 41799 (platform)
//! Batch: 100 stubs | range 0x5092dc..0x50ced8 | rbx_core::SharedPtr not boost
...
pub fn stub_5095a4() -> ! {
    todo!("0x5095a4 RBX::GlobalBasicSettings::~GlobalBasicSettings()")
}
...
#[doc(alias = "RBX::GlobalBasicSettings::~GlobalBasicSettings()")]
pub fn stub_5096f0() -> ! {
    todo!("0x5096f0 RBX::GlobalBasicSettings::~GlobalBasicSettings()")
}
...
pub fn stub_50b228() -> ! {
    todo!("0x50b228 RBX::Selection * RBX::ServiceProvider::find<RBX::Selection>(void)const")
}
...
pub fn stub_50b5b0() -> ! {
    todo!("0x50b5b0 unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::Selection>(void)")
}
