//! platform — generated_plat_wd_watchdog5 — 100 stubs EA-sorted asc gap filler NOT yet in rbx_platform
//! Source: ida/export.json (85545 funcs) global gap filler EA-sorted asc next 100 after generated_plat_wd_watchdog3 0x45d500 (platform strict Platform/iOS 0 left, filler 100)
//! Range 0x45d710..0x460200 | distinct 41126/85545 -> 41226/85545 | rbx_core::SharedPtr not boost
//! Batch: generated_plat_wd_watchdog5 100 stubs (filtered Platform/iOS 0 + filler 100) EA-sorted asc distinct
...
// was: `non-virtual thunk to'rbx::callable<rbx::signals::signal<void ()(bool)>::slot,boost::function<void ()(bool)>,1,void ()(bool)>::call(bool)
...
#[doc(alias = "RBX::Reflection::EventDescImpl<0,RBX::DataModel,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::DataModel::*>::connectGeneric(RBX::Reflection::EventSource *,boost::shared_ptr<RBX::Reflection::GenericSlotWrapper>)const")]
pub fn stub_45dd2c() -> ! {
...
#[doc(alias = "RBX::DataModel::GearType RBX::Reflection::ArgHelper::getArg<RBX::DataModel::GearType,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<RBX::DataModel::GearType> const&,boost::disable_if<boost::is_same<RBX::DataModel::GearType,boost::shared_ptr<RBX::Reflection::Tuple const>>,void>::type *)")]
pub fn stub_45e4ec() -> ! {
