...
// Batch: 100 stubs | range 0x5c2c6c..0x5ea5b0 | total filtered 10215, remaining 996->896 after batch
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr;  stripped from alias
// Shard: 76 EA-sorted ascending next uncovered gap from 0x5c2c6c
...
pub fn stub_5ca1bc() -> ! {
    todo!("0x5ca1bc boost::detail::sp_counted_impl_pd<RBX::Hint *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x5ca1c0 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX4HintENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::Hint *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_5ca1c0() -> ! {
    todo!("0x5ca1c0 boost::detail::sp_counted_impl_pd<RBX::Hint *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_5ca1c4() -> ! {
    todo!("0x5ca1c4 boost::detail::sp_counted_impl_pd<RBX::Hint *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_5cc74c() -> ! {
    todo!("0x5cc74c RBX::Translate(rbx_core::SharedPtr<RBX::Instance>,G3D::Vector3 const*)")
}
...
pub fn stub_5cc7ec() -> ! {
    todo!("0x5cc7ec RBX::rotateModelPart(rbx_core::SharedPtr<RBX::Instance>,G3D::CoordinateFrame const*,G3D::Vector3 const*)")
}
...
// was: RBX::ModelInstance::onDescendantRemoving(boost::shared_ptr<RBX::Instance> const&)
pub fn stub_5ccac0() -> ! {
    todo!("0x5ccac0 RBX::ModelInstance::onDescendantRemoving(rbx_core::SharedPtr<RBX::Instance> const&)")
}
...
// was: RBX::VisitModelDescendants(boost::shared_ptr<RBX::Instance>,RBX::PartInstance **,float *)
pub fn stub_5cce3c() -> ! {
    todo!("0x5cce3c RBX::VisitModelDescendants(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *)")
}

// 0x5ccebc — __ZN3RBXL5makeJEN5boost10shared_ptrINS_8InstanceEEE
#[doc(alias = "RBX::makeJ(rbx_core::SharedPtr<RBX::Instance>)")]
// was: RBX::makeJ(boost::shared_ptr<RBX::Instance>)
pub fn stub_5ccebc() -> ! {
    todo!("0x5ccebc RBX::makeJ(rbx_core::SharedPtr<RBX::Instance>)")
}

// 0x5ccf3c — __ZN3RBXL6breakJEN5boost10shared_ptrINS_8InstanceEEE
#[doc(alias = "RBX::breakJ(rbx_core::SharedPtr<RBX::Instance>)")]
// was: RBX::breakJ(boost::shared_ptr<RBX::Instance>)
pub fn stub_5ccf3c() -> ! {
    todo!("0x5ccf3c RBX::breakJ(rbx_core::SharedPtr<RBX::Instance>)")
}
...
// was: RBX::unionPartExtentsWorld(boost::shared_ptr<RBX::Instance>,RBX::Extents &)
pub fn stub_5cd44c() -> ! {
    todo!("0x5cd44c RBX::unionPartExtentsWorld(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &)")
}
...
pub fn stub_5cd668() -> ! {
    todo!("0x5cd668 RBX::unionPartExtentsLocal(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &,G3D::CoordinateFrame const&)")
}
...
pub fn stub_5cde48() -> ! {
    todo!("0x5cde48 void RBX::Instance::visitDescendants<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *),boost::_bi::list3<boost::arg<1>,boost::_bi::value<RBX::PartInstance **>,boost::_bi::value<float *>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *),boost::_bi::list3<boost::arg<1>,boost::_bi::value<RBX::PartInstance **>,boost::_bi::value<float *>>> const&)const")
}
...
pub fn stub_5cdf50() -> ! {
    todo!("0x5cdf50 void RBX::Instance::visitDescendants<boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &),boost::_bi::list2<boost::arg<1>,boost::reference_wrapper<RBX::Extents>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents &),boost::_bi::list2<boost::arg<1>,boost::reference_wrapper<RBX::Extents>>> const&)const")
}
...
pub fn stub_5ce160() -> ! {
    todo!("0x5ce160 void boost::_bi::list3<boost::arg<1>,boost::reference_wrapper<RBX::Extents>,boost::reference_wrapper<G3D::CoordinateFrame const>>::operator()<void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents&,G3D::CoordinateFrame const&),boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents&,G3D::CoordinateFrame const&) &,boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&> &,int)")
}
...
pub fn stub_5ce23c() -> ! {
    todo!("0x5ce23c void boost::_bi::list2<boost::arg<1>,boost::reference_wrapper<RBX::Extents>>::operator()<void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents&),boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::Extents&) &,boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&> &,int)")
}
...
pub fn stub_5ce310() -> ! {
    todo!("0x5ce310 void boost::_bi::list3<boost::arg<1>,boost::_bi::value<RBX::PartInstance **>,boost::_bi::value<float *>>::operator()<void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *),boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(rbx_core::SharedPtr<RBX::Instance>,RBX::PartInstance **,float *) &,boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&> &,int)")
}
...
pub fn stub_5ce574() -> ! {
    todo!("0x5ce574 void boost::_bi::list3<boost::arg<1>,boost::_bi::value<G3D::CoordinateFrame *>,boost::_bi::value<G3D::Vector3 *>>::operator()<void (*)(rbx_core::SharedPtr<RBX::Instance>,G3D::CoordinateFrame const*,G3D::Vector3 const*),boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(rbx_core::SharedPtr<RBX::Instance>,G3D::CoordinateFrame const*,G3D::Vector3 const*) &,boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&> &,int)")
}
...
pub fn stub_5ce650() -> ! {
    todo!("0x5ce650 void boost::_bi::list2<boost::arg<1>,boost::_bi::value<G3D::Vector3 *>>::operator()<void (*)(rbx_core::SharedPtr<RBX::Instance>,G3D::Vector3 const*),boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&>>(boost::_bi::type<void>,void (*)(rbx_core::SharedPtr<RBX::Instance>,G3D::Vector3 const*) &,boost::_bi::list1<rbx_core::SharedPtr<RBX::Instance> const&> &,int)")
}
...
#[doc(alias = "RBX::PartInstance::findParts(RBX::Instance *,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>> &)")]
...
pub fn stub_5daf54() -> ! {
    todo!("0x5daf54 RBX::PartInstance::findParts(RBX::Instance *,std::vector<rbx_core::Weak<RBX::PartInstance>,std::allocator<rbx_core::Weak<RBX::PartInstance>>> &)")
}
...
// was: RBX::PartInstance::getConnectedPartsRecursiveImpl(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>> &,boost::unordered::unordered_set<RBX::PartInstance*,boost::hash<RBX::PartInstance*>,std::equal_to<RBX::PartInstance*>,std::allocator<RBX::PartInstance*>> &)const
pub fn stub_5de610() -> ! {
    todo!("0x5de610 RBX::PartInstance::getConnectedPartsRecursiveImpl(rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>> &,boost::unordered::unordered_set<RBX::PartInstance*,boost::hash<RBX::PartInstance*>,std::equal_to<RBX::PartInstance*>,std::allocator<RBX::PartInstance*>> &)const")
}
...
// was: RBX::getConnectedPartsVisitor(RBX::Primitive *,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>>> &)
pub fn stub_5de7fc() -> ! {
    todo!("0x5de7fc RBX::getConnectedPartsVisitor(RBX::Primitive *,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>> &)")
}
...
pub fn stub_5e1f50() -> ! {
    todo!("0x5e1f50 std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>::push_back(rbx_core::SharedPtr<RBX::Instance> const&)")
}
...
pub fn stub_5e1fa0() -> ! {
    todo!("0x5e1fa0 void RBX::Assembly::visitPrimitives<boost::_bi::bind_t<void,void (*)(RBX::Primitive *,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>> &),boost::_bi::list2<boost::arg<1>,boost::_bi::value<rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>>>>(boost::_bi::bind_t<void,void (*)(RBX::Primitive *,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>> &),boost::_bi::list2<boost::arg<1>,boost::_bi::value<rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>>>)")
}
...
pub fn stub_5e2888() -> ! {
    todo!("0x5e2888 RBX::PartInstance::TouchedSignal::operator()(rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_5e525c() -> ! {
    todo!("0x5e525c void RBX::Assembly::visitPrimitivesImpl<boost::_bi::bind_t<void,void (*)(RBX::Primitive *,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>> &),boost::_bi::list2<boost::arg<1>,boost::_bi::value<rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>>>>(boost::_bi::bind_t<void,void (*)(RBX::Primitive *,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>> &),boost::_bi::list2<boost::arg<1>,boost::_bi::value<rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>>>,RBX::Primitive *)")
}
...
pub fn stub_5e54e8() -> ! {
    todo!("0x5e54e8 boost::_bi::list2<boost::arg<1>,boost::_bi::value<rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>>::list2(boost::arg<1>,boost::_bi::value<rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>)")
}
...
pub fn stub_5e55c8() -> ! {
    todo!("0x5e55c8 rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>::shared_ptr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>(std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> *)")
}
...
pub fn stub_5e56a0() -> ! {
    todo!("0x5e56a0 std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>::~vector()")
}
...
pub fn stub_5e5770() -> ! {
    todo!("0x5e5770 boost::detail::sp_counted_impl_p<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>::~sp_counted_impl_p()")
}
...
pub fn stub_5e5778() -> ! {
    todo!("0x5e5778 boost::detail::sp_counted_impl_p<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>::get_deleter(std::type_info const&)")
}
...
pub fn stub_5e5c90() -> ! {
    todo!("0x5e5c90 std::_Vector_base<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>::_M_allocate(unsigned long)")
}
...
pub fn stub_5e5ca8() -> ! {
    todo!("0x5e5ca8 rbx_core::SharedPtr<RBX::Instance> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<rbx_core::SharedPtr<RBX::Instance> *,rbx_core::SharedPtr<RBX::Instance> *>(rbx_core::SharedPtr<RBX::Instance> *,rbx_core::SharedPtr<RBX::Instance> *,rbx_core::SharedPtr<RBX::Instance> *)")
}
