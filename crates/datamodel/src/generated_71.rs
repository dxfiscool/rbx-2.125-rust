...
// Batch: 100 stubs | range 0x5644b0..0x587804 | total filtered 10215, remaining 1397->1297 after batch
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr; `'` stripped from alias
// Shard: 71 EA-sorted ascending next uncovered gap from 0x5644b0
...
pub fn stub_5644b0() -> ! {
    todo!("0x5644b0 boost::detail::shared_count::shared_count<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_5645b8() -> ! {
    todo!("0x5645b8 boost::detail::sp_counted_impl_pd<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x5645bc — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX19BodyAngularVelocityENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_5645bc() -> ! {
    todo!("0x5645bc boost::detail::sp_counted_impl_pd<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_5645c0() -> ! {
    todo!("0x5645c0 boost::detail::sp_counted_impl_pd<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_5645e0() -> ! {
    todo!("0x5645e0 boost::detail::sp_counted_impl_pd<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_5645f8() -> ! {
    todo!("0x5645f8 boost::detail::sp_counted_impl_pd<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_564a20() -> ! {
    todo!("0x564a20 rbx_core::SharedPtr<RBX::BodyVelocity> RBX::Creatable<RBX::Instance>::create<RBX::BodyVelocity>(void)")
}
...
pub fn stub_564ad4() -> ! {
    todo!("0x564ad4 rbx_core::SharedPtr<RBX::BodyVelocity>::shared_ptr<RBX::BodyVelocity,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_564c84() -> ! {
    todo!("0x564c84 boost::detail::shared_count::shared_count<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_564d8c() -> ! {
    todo!("0x564d8c boost::detail::sp_counted_impl_pd<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x564d90 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX12BodyVelocityENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_564d90() -> ! {
    todo!("0x564d90 boost::detail::sp_counted_impl_pd<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_564d94() -> ! {
    todo!("0x564d94 boost::detail::sp_counted_impl_pd<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_564db4() -> ! {
    todo!("0x564db4 boost::detail::sp_counted_impl_pd<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_564dcc() -> ! {
    todo!("0x564dcc boost::detail::sp_counted_impl_pd<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_5651f4() -> ! {
    todo!("0x5651f4 rbx_core::SharedPtr<RBX::BodyPosition> RBX::Creatable<RBX::Instance>::create<RBX::BodyPosition>(void)")
}
...
pub fn stub_5652a8() -> ! {
    todo!("0x5652a8 rbx_core::SharedPtr<RBX::BodyPosition>::shared_ptr<RBX::BodyPosition,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_565458() -> ! {
    todo!("0x565458 boost::detail::shared_count::shared_count<RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_565560() -> ! {
    todo!("0x565560 boost::detail::sp_counted_impl_pd<RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x565564 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX12BodyPositionENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_565564() -> ! {
    todo!("0x565564 boost::detail::sp_counted_impl_pd<RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_565568() -> ! {
    todo!("0x565568 boost::detail::sp_counted_impl_pd<RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_5659c8() -> ! {
    todo!("0x5659c8 rbx_core::SharedPtr<RBX::BodyGyro> RBX::Creatable<RBX::Instance>::create<RBX::BodyGyro>(void)")
}
...
pub fn stub_565a7c() -> ! {
    todo!("0x565a7c rbx_core::SharedPtr<RBX::BodyGyro>::shared_ptr<RBX::BodyGyro,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyGyro *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_5681f4() -> ! {
    todo!("0x5681f4 rbx_core::SharedPtr<RBX::Handles> RBX::Creatable<RBX::Instance>::create<RBX::Handles>(void)")
}
...
pub fn stub_5682a8() -> ! {
    todo!("0x5682a8 rbx_core::SharedPtr<RBX::Handles>::shared_ptr<RBX::Handles,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Handles *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_5728a4() -> ! {
    todo!("0x5728a4 RBX::HopperBin::reverseSelectedConnectionShimFunction(rbx_core::SharedPtr<RBX::Instance> &)")
}
...
pub fn stub_5736b4() -> ! {
    todo!("0x5736b4 RBX::Reflection::EventDesc<RBX::HopperBin,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::HopperBin::*>::~EventDesc()")
}
...
pub fn stub_573890() -> ! {
    todo!("0x573890 rbx_core::SharedPtr<RBX::ScriptMouseCommand> RBX::Creatable<RBX::MouseCommand>::create<RBX::ScriptMouseCommand,RBX::Workspace *>(RBX::Workspace *)")
}
...
pub fn stub_574e08() -> ! {
    todo!("0x574e08 rbx_core::SharedPtr<RBX::StarterGear> RBX::Creatable<RBX::Instance>::create<RBX::StarterGear>(void)")
}
...
pub fn stub_574eb8() -> ! {
    todo!("0x574eb8 rbx_core::SharedPtr<RBX::StarterGear>::shared_ptr<RBX::StarterGear,RBX::Creatable<RBX::Instance>::Deleter>(RBX::StarterGear *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_574f80() -> ! {
    todo!("0x574f80 boost::detail::shared_count::shared_count<RBX::StarterGear *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::StarterGear *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_57568c() -> ! {
    todo!("0x57568c rbx_core::SharedPtr<RBX::HopperBin> RBX::Creatable<RBX::Instance>::create<RBX::HopperBin>(void)")
}
...
pub fn stub_575740() -> ! {
    todo!("0x575740 rbx_core::SharedPtr<RBX::HopperBin>::shared_ptr<RBX::HopperBin,RBX::Creatable<RBX::Instance>::Deleter>(RBX::HopperBin *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_5762b0() -> ! {
    todo!("0x5762b0 rbx::signals::connection rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::connect<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>>(boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>> const&)")
}
...
pub fn stub_576324() -> ! {
    todo!("0x576324 rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>>::~callable_slot()")
}
...
// was: rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,boost::shared_ptr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>>::~callable_slot()
pub fn stub_576350() -> ! {
    todo!("0x576350 rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>>::~callable_slot()")
}
...
pub fn stub_576424() -> ! {
    todo!("0x576424 rbx::callable<rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>,1,void ()(rbx_core::SharedPtr<RBX::Instance>)>::call(rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_576434() -> ! {
    todo!("0x576434 void boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance> &>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>::operator()<rbx_core::SharedPtr<RBX::Instance>>(rbx_core::SharedPtr<RBX::Instance> &)")
}
...
pub fn stub_57644c() -> ! {
    todo!("0x57644c rbx::callable<rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>,1,void ()(rbx_core::SharedPtr<RBX::Instance>)>::~callable()")
}
...
// was: rbx::callable<rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,boost::shared_ptr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>,1,void ()(boost::shared_ptr<RBX::Instance>)>::~callable()
pub fn stub_576478() -> ! {
    todo!("0x576478 rbx::callable<rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::slot,boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HopperBin,rbx_core::SharedPtr<RBX::Instance>&>,boost::_bi::list2<boost::_bi::value<RBX::HopperBin*>,boost::arg<1>>>,1,void ()(rbx_core::SharedPtr<RBX::Instance>)>::~callable()")
}
...
pub fn stub_5767e8() -> ! {
    todo!("0x5767e8 rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::remote_signal(void)")
}
...
// was: RBX::Reflection::EventDesc<RBX::HopperBin,void ()(boost::shared_ptr<RBX::Instance>),rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)>,rbx::remote_signal<void ()(boost::shared_ptr<RBX::Instance>)> RBX::HopperBin::*>::~EventDesc()
pub fn stub_57812c() -> ! {
    todo!("0x57812c RBX::Reflection::EventDesc<RBX::HopperBin,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::HopperBin::*>::~EventDesc()")
}
...
pub fn stub_5784a4() -> ! {
    todo!("0x5784a4 RBX::Reflection::EventDescBase<RBX::HopperBin,void ()(rbx_core::SharedPtr<RBX::Instance>),rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)> RBX::HopperBin::*>::disconnectAll(RBX::Reflection::EventSource *)const")
}
...
pub fn stub_579878() -> ! {
    todo!("0x579878 rbx::remote_signal<void ()(rbx_core::SharedPtr<RBX::Instance>)>::~remote_signal()")
}
...
pub fn stub_57d5f8() -> ! {
    todo!("0x57d5f8 rbx_core::SharedPtr<RBX::GuiImageButton> RBX::Creatable<RBX::Instance>::create<RBX::GuiImageButton>(void)")
}
...
pub fn stub_581250() -> ! {
    todo!("0x581250 RBX::InsertService::loadAsset(int,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,boost::function<void ()(std::string)>)")
}
...
pub fn stub_58134c() -> ! {
    todo!("0x58134c RBX::InsertService::loadAssetVersion(int,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,boost::function<void ()(std::string)>)")
}
...
pub fn stub_581448() -> ! {
    todo!("0x581448 RBX::InsertService::insert(rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_582ab8() -> ! {
    todo!("0x582ab8 RBX::InsertService::insertResultsReady(std::string,rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_582e5c() -> ! {
    todo!("0x582e5c RBX::InsertService::privateLoadAsset(int,bool,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,boost::function<void ()(std::string)>)")
}
...
pub fn stub_583644() -> ! {
    todo!("0x583644 RBX::InsertService::backendInsertReady(std::string,rbx_core::SharedPtr<RBX::Instance>)")
}

// 0x583850 — __ZN3RBX13InsertService24BackendInsertReadyHelperEN5boost8weak_ptrIS0_EESsNS1_10shared_ptrINS_8InstanceEEE
#[doc(alias = "RBX::InsertService::BackendInsertReadyHelper(rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>)")]
// was: RBX::InsertService::BackendInsertReadyHelper(boost::weak_ptr<RBX::InsertService>,std::string,boost::shared_ptr<RBX::Instance>)
pub fn stub_583850() -> ! {
    todo!("0x583850 RBX::InsertService::BackendInsertReadyHelper(rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_5839f0() -> ! {
    todo!("0x5839f0 RBX::InsertService::safeInsert(RBX::ContentId,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")
}
...
#[doc(alias = "RBX::InsertService::RemoteInsertItemsLoadedHelper(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")]
...
pub fn stub_583d54() -> ! {
    todo!("0x583d54 RBX::InsertService::RemoteInsertItemsLoadedHelper(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")
}
...
pub fn stub_583e90() -> ! {
    todo!("0x583e90 RBX::InsertService::remoteInsertItemsLoaded(RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")
}
...
pub fn stub_5841e8() -> ! {
    todo!("0x5841e8 RBX::UnsafeScriptStripperCollector(std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>> *,RBX::ScriptInformationProvider *,rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_584e40() -> ! {
    todo!("0x584e40 void RBX::Reflection::resume_adapter<rbx_core::SharedPtr<RBX::Instance>>(boost::function<void ()(RBX::Reflection::Variant)>,rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_585a10() -> ! {
    todo!("0x585a10 RBX::CallResultFunction(boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_585b24() -> ! {
    todo!("0x585b24 RBX::Reflection::RemoteEventDesc<RBX::InsertService,void ()(std::string,rbx_core::SharedPtr<RBX::Instance>),rbx::remote_signal<void ()(std::string,rbx_core::SharedPtr<RBX::Instance>)>>::~RemoteEventDesc()")
}
...
pub fn stub_585d20() -> ! {
    todo!("0x585d20 RBX::Reflection::BoundYieldFuncDesc<RBX::InsertService,rbx_core::SharedPtr<RBX::Instance> ()(int),rbx_core::SharedPtr<RBX::Instance>,1>::~BoundYieldFuncDesc()")
}
...
pub fn stub_585d60() -> ! {
    todo!("0x585d60 RBX::Reflection::BoundFuncDesc<RBX::InsertService,void ()(rbx_core::SharedPtr<RBX::Instance>),1>::~BoundFuncDesc()")
}
...
pub fn stub_585e6c() -> ! {
    todo!("0x585e6c boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>::operator=(boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)> const&)")
}
...
pub fn stub_5864b4() -> ! {
    todo!("0x5864b4 rbx_core::SharedPtr<RBX::Instance>& rbx_core::SharedPtr<RBX::Instance>::operator=<RBX::ModelInstance>(rbx_core::SharedPtr<RBX::ModelInstance> const&)")
}
...
pub fn stub_5864e8() -> ! {
    todo!("0x5864e8 RBX::Reflection::RemoteEventDescImpl<2,RBX::InsertService,void ()(std::string,rbx_core::SharedPtr<RBX::Instance>),rbx::remote_signal<void ()(std::string,rbx_core::SharedPtr<RBX::Instance>)>>::fireAndReplicateEvent(RBX::InsertService*,std::string,rbx_core::SharedPtr<RBX::Instance>)")
}
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list_av_3<rbx_core::Weak<RBX::InsertService>,std::string,boost::arg<1>>::type> boost::bind<void,rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>,rbx_core::Weak<RBX::InsertService>,std::string,boost::arg<1>>(void (*)(rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),rbx_core::Weak<RBX::InsertService>,std::string,boost::arg<1>)")]
...
pub fn stub_58673c() -> ! {
    todo!("0x58673c boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),boost::_bi::list_av_3<rbx_core::Weak<RBX::InsertService>,std::string,boost::arg<1>>::type> boost::bind<void,rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>,rbx_core::Weak<RBX::InsertService>,std::string,boost::arg<1>>(void (*)(rbx_core::Weak<RBX::InsertService>,std::string,rbx_core::SharedPtr<RBX::Instance>),rbx_core::Weak<RBX::InsertService>,std::string,boost::arg<1>)")
}
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list_av_4<rbx_core::Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>::type> boost::bind<void,rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx_core::Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>(void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),rbx_core::Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")]
...
pub fn stub_586fc8() -> ! {
    todo!("0x586fc8 boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list_av_4<rbx_core::Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>::type> boost::bind<void,rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>,rbx_core::Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>(void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),rbx_core::Weak<RBX::InsertService>,boost::arg<1>,boost::arg<2>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>)")
}
...
#[doc(alias = "void boost::function2<void,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>)")]
...
pub fn stub_587678() -> ! {
    todo!("0x587678 void boost::function2<void,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>)")
}
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
...
#[doc(alias = "boost::detail::function::void_function_obj_invoker2<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::InsertService>,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>),boost::_bi::list4<boost::_bi::value<rbx_core::Weak<RBX::InsertService>>,boost::arg<1>,boost::arg<2>,boost::_bi::value<boost::function<void ()(rbx_core::SharedPtr<RBX::Instance>)>>>>,void,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>::invoke(boost::detail::function::function_buffer &,RBX::AsyncHttpQueue::RequestResult,rbx_core::SharedPtr<std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)")]
