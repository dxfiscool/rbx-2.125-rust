...
// Batch: 100 stubs | range 0x496158..0x49a8c0 | gap filler EA-sorted ascending next 100 after 0x495c94 (shard wd_watchdog6)
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr;  and  stripped from alias
// Shard: wd_watchdog7 EA-sorted ascending continuation after wd_watchdog6 (gap filler local to datamodel)
...
pub fn stub_0x496bd8() -> ! {
    todo!("0x496bd8 rbx_core::SharedPtr<RBX::DialogRoot> RBX::shared_from<RBX::DialogRoot>(RBX::DialogRoot*)")
}
...
pub fn stub_0x497348() -> ! {
    todo!("0x497348 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::DialogRoot,RBX::DialogRoot>(rbx_core::SharedPtr<RBX::DialogRoot> const*,RBX::DialogRoot *)const")
}
