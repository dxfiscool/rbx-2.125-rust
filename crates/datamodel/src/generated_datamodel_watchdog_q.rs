// Auto-generated datamodel watchdog Q — 100 gap filler EA-sorted asc 0x2e899c..0x2f23f0 (RBX::Instance|DataModel|Workspace filter exhausted 10215/10215, gap filler next 100 not in datamodel)

// Source: ida/export.json (85545 funcs) filtered demangled contains RBX::Instance|RBX::DataModel|Workspace — fallback global gap filler (all 10215 datamodel EAs already stubbed, 85545 total, datamodel 33359->33459 distinct, gap 52987->52887 remaining not in datamodel)
...
pub fn stub_2e94dc() -> ! {
    todo!("0x2e94dc G3D::Vector3 RBX::Reflection::ArgHelper::getArg<G3D::Vector3,2>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<G3D::Vector3> const&,boost::disable_if<boost::is_same<G3D::Vector3,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")
}
