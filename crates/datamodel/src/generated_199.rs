...
// Filter: RBX::Instance (8021 filtered, 2459 remaining) — EA-sorted asc next 100 Instance gaps not yet in crates/datamodel/src
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: 100 stubs | range 0x786af8..0x810438 | dm distinct before 10321, after 10421, dm missing 75224->75124
// Shard: 199 EA-sorted asc next 100 Instance gaps after 197 (filtered RBX::Instance, 786af8..810438)
...
pub fn stub_0x787034() -> ! {
    todo!("0x787034 boost::shared_ptr<RBX::Scripting::DebuggerManager> RBX::Creatable<RBX::Instance>::create<RBX::Scripting::DebuggerManager>(void)")
}
...
pub fn stub_0x7870e4() -> ! {
    todo!("0x7870e4 boost::shared_ptr<RBX::Scripting::DebuggerManager>::shared_ptr<RBX::Scripting::DebuggerManager,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Scripting::DebuggerManager *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_0x7893c4() -> ! {
    todo!("0x7893c4 SerializerV2::loadInstancesFromText(XmlElement const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> &)")
}
...
pub fn stub_0x789594() -> ! {
    todo!("0x789594 SerializerV2::loadInstances(XmlElement const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> &,RBX::IReferenceBinder &,RBX::CreatorRole)")
}
...
pub fn stub_0x7897ac() -> ! {
    todo!("0x7897ac SerializerV2::loadInstancesFromMemory(XmlElement const*,std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> &,RBX::CreatorRole)")
}
...
pub fn stub_0x79d81c() -> ! {
    todo!("0x79d81c RBX::GameChatLine::GameChatLine(boost::shared_ptr<RBX::Instance>,std::string const&,float,bool,RBX::ChatLine::BubbleColor)")
}
...
pub fn stub_0x7a127c() -> ! {
    todo!("0x7a127c RBX::ChatOutput::onGameChatMessage(boost::shared_ptr<RBX::Instance>,std::string const&,RBX::ChatService::ChatColor)")
}
...
// type: void __fastcall(boost::detail::sp_counted_base *, int, int, int)
#[doc(alias = "RBX::ChatOutput::renderBubbleImposters(RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>)")]
// was: RBX::ChatOutput::renderBubbleImposters(RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>)
pub fn stub_0x7a2b0c() -> ! {
    todo!("0x7a2b0c RBX::ChatOutput::renderBubbleImposters(RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>)")
}
...
// type: int __fastcall(int, int, int, int, int, char, int, int, char)
#[doc(alias = "RBX::ChatOutput::renderBubbles(RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3)")]
...
pub fn stub_0x7a2db0() -> ! {
    todo!("0x7a2db0 RBX::ChatOutput::renderBubbles(RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3)")
}
...
#[doc(alias = "boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list_av_4<RBX::ChatOutput*,boost::arg<2>,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>::type> boost::bind<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,RBX::ChatOutput*,boost::arg<2>,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>(void (RBX::ChatOutput::*)(RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>),RBX::ChatOutput*,boost::arg<2>,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>)")]
...
pub fn stub_0x7a3fec() -> ! {
    todo!("0x7a3fec boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>>,boost::_bi::list_av_4<RBX::ChatOutput*,boost::arg<2>,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>>::type> boost::bind<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,RBX::ChatOutput*,boost::arg<2>,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>>(void (RBX::ChatOutput::*)(RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>),RBX::ChatOutput*,boost::arg<2>,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>)")
}

// 0x7a41e4 — __ZN3RBX9weak_fromIKNS_8InstanceEEEN5boost8weak_ptrIT_EEPS5_
#[doc(alias = "rbx_core::Weak<RBX::Instance const> RBX::weak_from<RBX::Instance const>(RBX::Instance const*)")]
// was: boost::weak_ptr<RBX::Instance const> RBX::weak_from<RBX::Instance const>(RBX::Instance const*)
pub fn stub_0x7a41e4() -> ! {
...
// type: int __fastcall(int, int, boost::detail::sp_counted_base *, boost::detail::sp_counted_base *, int, int, int, struct _Unwind_Exception *, struct _Unwind_Exception *lpuexcpt, boost::detail::sp_counted_base *, boost::detail::sp_counted_base *, struct _Unwind_Exception *, boost::detail::sp_counted_base *, int, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, int, int, int, int)
#[doc(alias = "boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list_av_7<RBX::ChatOutput*,boost::arg<2>,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>::type> boost::bind<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3,RBX::ChatOutput*,boost::arg<2>,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>(void (RBX::ChatOutput::*)(RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3),RBX::ChatOutput*,boost::arg<2>,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3)")]
...
pub fn stub_0x7a45f4() -> ! {
    todo!("0x7a45f4 boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list_av_7<RBX::ChatOutput*,boost::arg<2>,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>::type> boost::bind<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3,RBX::ChatOutput*,boost::arg<2>,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>(void (RBX::ChatOutput::*)(RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3),RBX::ChatOutput*,boost::arg<2>,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3)")
}
...
#[doc(alias = "void boost::function2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>(boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>)")]
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
...
// type: int __fastcall(int, int, int)
#[doc(alias = "boost::detail::function::void_function_obj_invoker2<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>,void,RBX::BillboardGui *,RBX::Adorn *>::invoke(boost::detail::function::function_buffer &,RBX::BillboardGui *,RBX::Adorn *)")]
...
// type: int __fastcall(int, int, boost::detail::sp_counted_base *, int, int, int, int, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, int, int, int)
#[doc(alias = "bool boost::detail::function::basic_vtable2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>(boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>,boost::detail::function::function_buffer &)const")]
...
// type: int __fastcall(int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, int, int, int)
#[doc(alias = "bool boost::detail::function::basic_vtable2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>(boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const")]
// was: bool boost::detail::function::basic_vtable2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>(boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>,boost::detail::function::function_buffer &,boost::detail::function::function_obj_tag)const
pub fn stub_0x7a50e8() -> ! {
...
#[doc(alias = "void boost::detail::function::basic_vtable2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_functor<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>(boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
// type: int __fastcall(int, int, int, int, int, int, int, int, int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "void boost::_bi::list7<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>::operator()<boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&>>(boost::_bi::type<void>,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3> &,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&> &,int)")]
...
pub fn stub_0x7a53b0() -> ! {
    todo!("0x7a53b0 void boost::_bi::list7<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>::operator()<boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&>>(boost::_bi::type<void>,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3> &,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&> &,int)")
}
...
// type: int __fastcall(int, int, int, int, int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>::operator()(RBX::ChatOutput*,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3)const")]
...
pub fn stub_0x7a54ec() -> ! {
    todo!("0x7a54ec boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>::operator()(RBX::ChatOutput*,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3)const")
}
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf6<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>,bool,G3D::Vector3,G3D::Vector3>,boost::_bi::list7<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>>>::manager(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type,mpl_::bool_<false>)")]
...
// type: int __fastcall(int, int, int, int, int, struct _Unwind_Exception *, int, boost::detail::sp_counted_base *, int, struct _Unwind_Exception *lpuexcpt, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_bi::list7<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>::list7(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>)")]
...
pub fn stub_0x7a582c() -> ! {
    todo!("0x7a582c boost::_bi::list7<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>::list7(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>)")
}
...
// type: int __fastcall(int, boost::detail::sp_counted_base *, int, int, int, struct _Unwind_Exception *lpuexcpt, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_bi::storage7<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>>::storage7(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>,boost::_bi::value<G3D::Vector3>)")]
...
#[doc(alias = "boost::_bi::storage6<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>>::storage6(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>)")]
...
pub fn stub_0x7a5ab8() -> ! {
    todo!("0x7a5ab8 boost::_bi::storage6<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>>::storage6(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>,boost::_bi::value<bool>,boost::_bi::value<G3D::Vector3>)")
}
...
#[doc(alias = "boost::_bi::storage5<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>>::storage5(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>,boost::_bi::value<bool>)")]
...
#[doc(alias = "boost::_bi::storage4<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>::storage4(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>)")]
...
#[doc(alias = "void boost::function2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>>(boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>)")]
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
...
#[doc(alias = "boost::detail::function::void_function_obj_invoker2<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>,void,RBX::BillboardGui *,RBX::Adorn *>::invoke(boost::detail::function::function_buffer &,RBX::BillboardGui *,RBX::Adorn *)")]
...
#[doc(alias = "bool boost::detail::function::basic_vtable2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_to<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>>(boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>,boost::detail::function::function_buffer &)const")]
...
// type: int __fastcall(int, int, int, int, void *, int, int, int, int, int)
#[doc(alias = "void boost::detail::function::basic_vtable2<void,RBX::BillboardGui *,RBX::Adorn *>::assign_functor<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>>(boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>,boost::detail::function::function_buffer &,mpl_::bool_<false>)const")]
...
// type: int __fastcall(int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "void boost::_bi::list4<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>::operator()<boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&>>(boost::_bi::type<void>,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>> &,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&> &,int)")]
...
pub fn stub_0x7a66d4() -> ! {
    todo!("0x7a66d4 void boost::_bi::list4<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<boost::weak_ptr<RBX::Instance const>>,boost::_bi::value<boost::weak_ptr<RBX::PartInstance>>>::operator()<boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>>,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&>>(boost::_bi::type<void>,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>> &,boost::_bi::list2<RBX::BillboardGui *&,RBX::Adorn *&> &,int)")
}
...
// type: int __fastcall(int, int, int, int, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>::operator()(RBX::ChatOutput*,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>)const")]
...
pub fn stub_0x7a67f8() -> ! {
    todo!("0x7a67f8 boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>>::operator()(RBX::ChatOutput*,RBX::Adorn *,boost::weak_ptr<RBX::Instance const>,boost::weak_ptr<RBX::PartInstance>)const")
}
...
// type: int __fastcall(int, int, int, int, int, void *, int, int, int, int)
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,RBX::Adorn *,rbx_core::Weak<RBX::Instance const>,rbx_core::Weak<RBX::PartInstance>>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>>>::manager(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type,mpl_::bool_<false>)")]
...
// type: int __fastcall(int, int, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, int, int, int)
#[doc(alias = "boost::_bi::list4<boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>>::list4(boost::_bi::value<RBX::ChatOutput *>,boost::arg<2>,boost::_bi::value<rbx_core::Weak<RBX::Instance const>>,boost::_bi::value<rbx_core::Weak<RBX::PartInstance>>)")]
...
#[doc(alias = "rbx_core::SharedPtr<RBX::Instance const>::shared_ptr<RBX::Instance const>(rbx_core::Weak<RBX::Instance const> const&,boost::detail::sp_nothrow_tag)")]
...
#[doc(alias = "rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::safe_static_init_mutex(void)")]
// was: rbx::signals::signal<void ()(boost::shared_ptr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::safe_static_init_mutex(void)
pub fn stub_0x7a821c() -> ! {
...
#[doc(alias = "rbx::signals::signal<void ()(rbx_core::SharedPtr<RBX::Instance>,std::string,RBX::ChatService::ChatColor)>::callable_slot<boost::_bi::bind_t<void,boost::_mfi::mf3<void,RBX::ChatOutput,rbx_core::SharedPtr<RBX::Instance>,std::string const&,RBX::ChatService::ChatColor>,boost::_bi::list4<boost::_bi::value<RBX::ChatOutput*>,boost::arg<1>,boost::arg<2>,boost::arg<3>>>>::~callable_slot()")]
...
pub fn stub_0x80fea8() -> ! {
    todo!("0x80fea8 bool RBX::Reflection::ArgHelper::try_object<3,RBX::Instance>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::shared_ptr<RBX::Instance> &,boost::enable_if<boost::is_base_of<RBX::Reflection::DescribedBase,RBX::Instance>,void>::type *)")
}
...
pub fn stub_0x81029c() -> ! {
    todo!("0x81029c RBX::Reflection::BoundFuncDesc<RBX::TestService,void ()(std::string,boost::shared_ptr<RBX::Instance>,int),3>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)")
}
...
// was: RBX::Reflection::BoundFuncDesc<RBX::TestService,void ()(std::string,boost::shared_ptr<RBX::Instance>,int),3>::~BoundFuncDesc()
pub fn stub_0x810304() -> ! {
    todo!("0x810304 RBX::Reflection::BoundFuncDesc<RBX::TestService,void ()(std::string,boost::shared_ptr<RBX::Instance>,int),3>::~BoundFuncDesc()")
}
...
// was: RBX::Reflection::BoundFuncDesc<RBX::TestService,void ()(std::string,boost::shared_ptr<RBX::Instance>,int),3>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
pub fn stub_0x810438() -> ! {
    todo!("0x810438 RBX::Reflection::BoundFuncDesc<RBX::TestService,void ()(std::string,boost::shared_ptr<RBX::Instance>,int),3>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const")
}
