...
// Filter: EA-sorted asc next 150 not yet stubbed in any crate (global gap filler fallback; 0 global gaps, using next 150 not yet in datamodel)
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: 150 stubs | range 0x25dff4..0x2635e4 | datamodel distinct 29914->30064 (global 85545 all covered, fallback to datamodel gap)
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::~EnumPropDescriptor()
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::isReadOnly(void)const
...
// type: int __fastcall(int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::isWriteOnly(void)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::equalValues(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getVariant(RBX::Reflection::DescribedBase const*,RBX::Reflection::Variant &)const
...
// type: int __fastcall(int, int, _DWORD *)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setVariant(RBX::Reflection::DescribedBase *,RBX::Reflection::Variant const&)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::copyValue(RBX::Reflection::DescribedBase const*,RBX::Reflection::DescribedBase*)const
...
// type: int()
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::hasStringValue(void)const
...
// type: int __fastcall(int, int, int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getStringValue(RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setStringValue(RBX::Reflection::DescribedBase *,std::string const&)const
...
// type: int __fastcall(int, int, _DWORD *)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::writeValue(RBX::Reflection::DescribedBase const*,XmlElement *)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::readValue(RBX::Reflection::DescribedBase *,XmlElement const*,RBX::IReferenceBinder &)const
...
// type: int __fastcall(int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getIndexValue(RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setIndexValue(RBX::Reflection::DescribedBase *,unsigned long)const
...
// type: int __fastcall(int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getEnumValue(RBX::Reflection::DescribedBase const*)const
...
// type: int __fastcall(int, int, int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setEnumValue(RBX::Reflection::DescribedBase *,int)const
...
// type: int __fastcall(int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::getEnumItem(RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setStringValue(RBX::Reflection::DescribedBase *,RBX::Name const&)const
...
// type: int __fastcall(int, int, int)
// was: RBX::Reflection::EnumDesc<RBX::NormalId>::convertToIndex(RBX::NormalId)const
...
// type: int __fastcall(int, int, int)
// was: RBX::Reflection::EnumPropDescriptor<RBX::SpotLight,RBX::NormalId>::setIntValue(RBX::Reflection::DescribedBase *,int)const
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::isReadOnly(void)const
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::isWriteOnly(void)const
...
// type: int __fastcall(int, int)
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::getValue(RBX::Reflection::DescribedBase const*)const
...
// type: int __fastcall(int, int, _DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,RBX::NormalId>::GetSetImpl<RBX::NormalId (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(RBX::NormalId)>::setValue(RBX::Reflection::DescribedBase *,RBX::NormalId const&)const
...
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::PropDescriptor<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>(char const*,char const*,float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
// type: int __fastcall(_DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::~PropDescriptor()
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::GetSetImpl<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>::isReadOnly(void)const
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::GetSetImpl<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>::isWriteOnly(void)const
...
// type: int __fastcall(int, int)
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::GetSetImpl<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>::getValue(RBX::Reflection::DescribedBase const*)const
...
// type: int __fastcall(int, int, _DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::SpotLight,float>::GetSetImpl<float (RBX::SpotLight::*)(void)const,void (RBX::SpotLight::*)(float)>::setValue(RBX::Reflection::DescribedBase *,float const&)const
...
// type: _DWORD *__fastcall(_DWORD *, int, int, int, int, void *, int, int, int, int, int)
// was: RBX::Reflection::PropDescriptor<RBX::PointLight,float>::PropDescriptor<float (RBX::PointLight::*)(void)const,void (RBX::PointLight::*)(float)>(char const*,char const*,float (RBX::PointLight::*)(void)const,void (RBX::PointLight::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
// type: int __fastcall(_DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::PointLight,float>::~PropDescriptor()
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::PointLight,float>::GetSetImpl<float (RBX::PointLight::*)(void)const,void (RBX::PointLight::*)(float)>::isReadOnly(void)const
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::PointLight,float>::GetSetImpl<float (RBX::PointLight::*)(void)const,void (RBX::PointLight::*)(float)>::isWriteOnly(void)const
...
// type: int __fastcall(int, int)
// was: RBX::Reflection::PropDescriptor<RBX::PointLight,float>::GetSetImpl<float (RBX::PointLight::*)(void)const,void (RBX::PointLight::*)(float)>::getValue(RBX::Reflection::DescribedBase const*)const
...
// type: int __fastcall(int, int, _DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::PointLight,float>::GetSetImpl<float (RBX::PointLight::*)(void)const,void (RBX::PointLight::*)(float)>::setValue(RBX::Reflection::DescribedBase *,float const&)const
...
// type: _DWORD *__fastcall(_DWORD *, int, int, int, int, void *, int, int, int, int, int)
// was: RBX::Reflection::PropDescriptor<RBX::Light,float>::PropDescriptor<float (RBX::Light::*)(void)const,void (RBX::Light::*)(float)>(char const*,char const*,float (RBX::Light::*)(void)const,void (RBX::Light::*)(float),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
// type: int __fastcall(_DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::Light,float>::~PropDescriptor()
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::Light,float>::GetSetImpl<float (RBX::Light::*)(void)const,void (RBX::Light::*)(float)>::isReadOnly(void)const
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::Light,float>::GetSetImpl<float (RBX::Light::*)(void)const,void (RBX::Light::*)(float)>::isWriteOnly(void)const
...
// type: int __fastcall(int, int)
// was: RBX::Reflection::PropDescriptor<RBX::Light,float>::GetSetImpl<float (RBX::Light::*)(void)const,void (RBX::Light::*)(float)>::getValue(RBX::Reflection::DescribedBase const*)const
...
// type: int __fastcall(int, int, _DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::Light,float>::GetSetImpl<float (RBX::Light::*)(void)const,void (RBX::Light::*)(float)>::setValue(RBX::Reflection::DescribedBase *,float const&)const
...
// type: _DWORD *__fastcall(_DWORD *, int, int, int, int, void *, int, int, int, int, int)
// was: RBX::Reflection::PropDescriptor<RBX::Light,bool>::PropDescriptor<bool (RBX::Light::*)(void)const,void (RBX::Light::*)(bool)>(char const*,char const*,bool (RBX::Light::*)(void)const,void (RBX::Light::*)(bool),RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
// type: int __fastcall(_DWORD *)
// was: RBX::Reflection::PropDescriptor<RBX::Light,bool>::~PropDescriptor()
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::Light,bool>::GetSetImpl<bool (RBX::Light::*)(void)const,void (RBX::Light::*)(bool)>::isReadOnly(void)const
...
// type: int()
// was: RBX::Reflection::PropDescriptor<RBX::Light,bool>::GetSetImpl<bool (RBX::Light::*)(void)const,void (RBX::Light::*)(bool)>::isWriteOnly(void)const
...
// type: int __fastcall(int, int)
// was: RBX::Reflection::PropDescriptor<RBX::Light,bool>::GetSetImpl<bool (RBX::Light::*)(void)const,void (RBX::Light::*)(bool)>::getValue(RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::PropDescriptor<RBX::Light,bool>::GetSetImpl<bool (RBX::Light::*)(void)const,void (RBX::Light::*)(bool)>::setValue(RBX::Reflection::DescribedBase *,bool const&)const
...
// type: 
// was: global constructor keyed to_a_56
...
// was: RBX::Reflection::RemoteEventCommon::Attributes::deprecated(RBX::Reflection::RemoteEventCommon::Functionality,RBX::Reflection::MemberDescriptor const*)
...
// type: int __fastcall(int, int)
// was: RBX::Reflection::EventSource::processRemoteEvent(RBX::Reflection::EventDescriptor const&,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&,RBX::SystemAddress const&)
...
// type: void()
// was: RBX::Reflection::EventSource::raiseEventInvocation(RBX::Reflection::EventDescriptor const&,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&,RBX::SystemAddress const*)
...
// type: int __fastcall(int **, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::EventDescriptor>::declare(RBX::Reflection::EventDescriptor*)
...
// was: RBX::Reflection::EventDescriptor::~EventDescriptor()
...
// was: RBX::Reflection::EventDescriptor::isScriptable(void)const
...
// type: int __fastcall(int, int, int)
// was: RBX::Reflection::EventDescriptor::sendEvent(RBX::Reflection::EventSource *,std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const&)const
...
// was: std::vector<RBX::Reflection::EventDescriptor *,std::allocator<RBX::Reflection::EventDescriptor *>>::insert(__gnu_cxx::__normal_iterator<RBX::Reflection::EventDescriptor **,std::vector<RBX::Reflection::EventDescriptor *,std::allocator<RBX::Reflection::EventDescriptor *>>>,RBX::Reflection::EventDescriptor * const&)
...
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::EventDescriptor>::declareSub(RBX::Reflection::EventDescriptor*,RBX::Reflection::EventDescriptor*)
...
// type: double *()
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::EventDescriptor>::staticData(void)
...
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::EventDescriptor>::Collection::~Collection()
...
pub fn stub_0x25fc58() -> ! {
    todo!("0x25fc58 void boost::throw_exception<boost::thread_resource_error>(boost::thread_resource_error const&)")
}
...
pub fn stub_0x25fdc0() -> ! {
    todo!("0x25fdc0 boost::exception_detail::error_info_injector<boost::thread_resource_error>::~error_info_injector()")
}
...
pub fn stub_0x25fdd0() -> ! {
    todo!("0x25fdd0 boost::exception_detail::copy_boost_exception(boost::exception *,boost::exception const*)")
}
...
pub fn stub_0x25ff10() -> ! {
    todo!("0x25ff10 boost::singleton_pool<XmlAttribute,20u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::get_pool(void)")
}

// 0x25ff60 — __ZN5boost16exception_detail10clone_implINS0_14bad_exception_EED1Ev
// type: boost::exception_detail::bad_exception_ *__fastcall(boost::exception_detail::bad_exception_ *)
...
pub fn stub_0x25ff60() -> ! {
    todo!("0x25ff60 boost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>::~clone_impl()")
}
...
pub fn stub_0x25ff88() -> ! {
    todo!("0x25ff88 boost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>::rethrow(void)const")
}

// 0x260098 — __ZThn20_N5boost16exception_detail10clone_implINS0_14bad_exception_EED0Ev
// type: int __fastcall(int)
// was: non-virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>::~clone_impl()
...
// type: int __fastcall(_DWORD *)
// was: virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>::clone(void)const
...
pub fn stub_0x2600b0() -> ! {
    todo!("0x2600b0 virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>::clone(void)const")
}

// 0x2600c0 — __ZN5boost6detail12shared_countC1ERKS1_
// type: shared_count *__fastcall(shared_count *this, const shared_count *)
...
pub fn stub_0x2600c0() -> ! {
    todo!("0x2600c0 boost::detail::shared_count::shared_count(boost::detail::shared_count const&)")
}

// 0x260110 — __ZNSt10_List_baseIN3RBX10Reflection19SignatureDescriptor4ItemESaIS3_EE8_M_clearEv
// type: void __fastcall(_DWORD **)
// was: std::_List_base<RBX::Reflection::SignatureDescriptor::Item,std::allocator<RBX::Reflection::SignatureDescriptor::Item>>::_M_clear(void)
...
// was: RBX::Reflection::MemberDescriptor::~MemberDescriptor()
...
// type: 
// was: global constructor keyed to_a_57
...
// type: int __fastcall(int **, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::FunctionDescriptor>::declare(RBX::Reflection::FunctionDescriptor*)
...
// type: int __fastcall(int **, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::declare(RBX::Reflection::YieldFunctionDescriptor*)
...
// was: RBX::Reflection::YieldFunctionDescriptor::~YieldFunctionDescriptor()
...
// type: int *__fastcall(int *, int, int, const void *)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::declareSub(RBX::Reflection::YieldFunctionDescriptor*,RBX::Reflection::YieldFunctionDescriptor*)
...
// type: double *()
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::staticData(void)
...
// type: void **__fastcall(void **)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::Collection::~Collection()
...
// type: int __fastcall(_DWORD *)
// was: virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_alloc_>::clone(void)const
...
pub fn stub_0x260e60() -> ! {
    todo!("0x260e60 virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_alloc_>::clone(void)const")
}
...
// type: 
// was: global constructor keyed to_a_58
...
// was: RBX::Reflection::MemberDescriptor::isMemberOf(RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::Descriptor::Descriptor(char const*,RBX::Reflection::Descriptor::Attributes)
...
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>::MemberDescriptorContainer(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::PropertyDescriptor>*)
...
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::EventDescriptor>::MemberDescriptorContainer(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::EventDescriptor>*)
...
// type: int __fastcall(_DWORD *, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::FunctionDescriptor>::MemberDescriptorContainer(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::FunctionDescriptor>*)
...
// type: int __fastcall(_DWORD *, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::MemberDescriptorContainer(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>*)
...
// type: _DWORD *__fastcall(_DWORD *, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::MemberDescriptorContainer(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>*)
...
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::mergeMembers(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor> const*)
...
// was: std::vector<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor> *,std::allocator<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor> *>>::push_back(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor> * const&)
...
// type: void **__fastcall(void **)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::Collection::~Collection()
...
// was: std::_Vector_base<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor> *,std::allocator<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor> *>>::_M_allocate(unsigned long)
...
// type: int __fastcall(int **, int)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::declare(RBX::Reflection::CallbackDescriptor*)
...
// type: int __fastcall(int *, _DWORD *, _DWORD *)
// was: std::vector<RBX::Reflection::CallbackDescriptor *,std::allocator<RBX::Reflection::CallbackDescriptor *>>::insert(__gnu_cxx::__normal_iterator<RBX::Reflection::CallbackDescriptor **,std::vector<RBX::Reflection::CallbackDescriptor *,std::allocator<RBX::Reflection::CallbackDescriptor *>>>,RBX::Reflection::CallbackDescriptor * const&)
...
// type: int *__fastcall(int *, int, int, const void *)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::declareSub(RBX::Reflection::CallbackDescriptor*,RBX::Reflection::CallbackDescriptor*)
...
// type: 
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::initStaticData(void)
...
// type: double *()
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::CallbackDescriptor>::staticData(void)
...
// was: RBX::Reflection::StringHashPredicate::operator()(char const*)const
...
// type: int __fastcall(int, unsigned int)
// was: std::_Vector_base<RBX::Reflection::CallbackDescriptor *,std::allocator<RBX::Reflection::CallbackDescriptor *>>::_M_allocate(unsigned long)
...
// type: int __fastcall(int result, int *)
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::mergeMembers(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor> const*)
...
// type: int __fastcall(int result, _DWORD *)
// was: std::vector<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor> *,std::allocator<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor> *>>::push_back(RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor> * const&)
...
// type: int __fastcall(int, unsigned int)
// was: std::_Vector_base<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor> *,std::allocator<RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor> *>>::_M_allocate(unsigned long)
...
// type: 
// was: RBX::Reflection::MemberDescriptorContainer<RBX::Reflection::YieldFunctionDescriptor>::initStaticData(void)
