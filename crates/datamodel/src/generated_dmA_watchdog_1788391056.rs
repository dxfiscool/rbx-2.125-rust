...
// Filter: RBX:: + Instance|DataModel|Workspace|Part (substring, 13473 total) | datamodelA watchdog
// Source: ida/export.json (85545 funcs, base 0x4000) | global dedup 70477 skipped
// Batch: 120 stubs | range 0xbc1d78..0xf3dcf4 | remaining 419 before batch
...
// 0xbc1d80 — __ZN3RBX18RbxParticleFactory17updateSmokeSystemEPN4Ogre14ParticleSystemEPNS_11SmokeParamsE
#[doc(alias = "RBX::RbxParticleFactory::updateSmokeSystem(Ogre::ParticleSystem *,RBX::SmokeParams *)")]
pub fn stub_bc1d80() -> ! {
    todo!("0xbc1d80 RBX::RbxParticleFactory::updateSmokeSystem(Ogre::ParticleSystem *,RBX::SmokeParams *)")
}

// 0xbc3114 — __ZN3RBX18RbxParticleFactory16updateFireSystemEPN4Ogre14ParticleSystemEPNS_10FireParamsE
#[doc(alias = "RBX::RbxParticleFactory::updateFireSystem(Ogre::ParticleSystem *,RBX::FireParams *)")]
pub fn stub_bc3114() -> ! {
    todo!("0xbc3114 RBX::RbxParticleFactory::updateFireSystem(Ogre::ParticleSystem *,RBX::FireParams *)")
}
...
pub fn stub_bc44a8() -> ! {
    todo!("0xbc44a8 RBX::RbxParticleManager::RbxParticleManager(Ogre::VisualEngine *)")
}
...
pub fn stub_bc45b0() -> ! {
    todo!("0xbc45b0 RBX::RbxParticleManager::FirstThrottleSystem(Ogre::ParticleSystem *)")
}
...
pub fn stub_c1c0dc() -> ! {
    todo!("0xc1c0dc RBX::LightGrid::setNonFixedPartsEnabled(bool)")
}

// 0xead9ac — __ZN3RBX16FrameRateManager19CountParticleQuotasEi
#[doc(alias = "RBX::FrameRateManager::CountParticleQuotas(int)")]
pub fn stub_ead9ac() -> ! {
    todo!("0xead9ac RBX::FrameRateManager::CountParticleQuotas(int)")
}
...
pub fn stub_eada68() -> ! {
    todo!("0xeada68 RBX::FrameRateManager::GetParticleThrottleFactor(void)")
}
...
pub fn stub_f27064() -> ! {
    todo!("0xf27064 boost::singleton_pool<RBX::OnDemandInstance,20u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::get_pool(void)")
}
...
pub fn stub_f2e6f4() -> ! {
    todo!("0xf2e6f4 rbx::signals::connection rbx::signals::signal<void ()(RBX::Heartbeat const&)>::connect<boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>>(boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>> const&)")
}
...
pub fn stub_f2e704() -> ! {
    todo!("0xf2e704 void boost::_bi::bind_t<void,boost::_mfi::mf1<void,RBX::HeartbeatInstance,RBX::Heartbeat const&>,boost::_bi::list2<boost::_bi::value<RBX::HeartbeatInstance*>,boost::arg<1>>>::operator()<RBX::Heartbeat>(RBX::Heartbeat const&)")
}

// 0xf2fde4 — j___ZN3RBX17HeartbeatInstanceD2Ev
#[doc(alias = "RBX::HeartbeatInstance::~HeartbeatInstance()")]
pub fn stub_f2fde4() -> ! {
    todo!("0xf2fde4 RBX::HeartbeatInstance::~HeartbeatInstance()")
}
...
pub fn stub_f312e4() -> ! {
    todo!("0xf312e4 boost::shared_ptr<RBX::PVInstance> RBX::shared_from<RBX::PVInstance>(RBX::PVInstance*)")
}
...
pub fn stub_f31304() -> ! {
    todo!("0xf31304 boost::shared_ptr<RBX::PVInstance>::shared_ptr<RBX::PVInstance>(boost::weak_ptr<RBX::PVInstance> const&,boost::detail::sp_nothrow_tag)")
}
...
pub fn stub_f33284() -> ! {
    todo!("0xf33284 boost::shared_ptr<RBX::MegaClusterInstance>::operator=(boost::shared_ptr<RBX::MegaClusterInstance> const&)")
}
...
pub fn stub_f33e04() -> ! {
    todo!("0xf33e04 std::_Vector_base<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>::_M_allocate(unsigned long)")
}
...
pub fn stub_f33e14() -> ! {
    todo!("0xf33e14 RBX::CharacterMesh::BodyPart * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::CharacterMesh::BodyPart *,RBX::CharacterMesh::BodyPart *>(RBX::CharacterMesh::BodyPart *,RBX::CharacterMesh::BodyPart *,RBX::CharacterMesh::BodyPart *)")
}
...
pub fn stub_f33e24() -> ! {
    todo!("0xf33e24 std::map<RBX::Name const*,RBX::CharacterMesh::BodyPart,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>>::operator[](RBX::Name const* const&)")
}
...
pub fn stub_f33e34() -> ! {
    todo!("0xf33e34 std::vector<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::CharacterMesh::BodyPart*,std::vector<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>>,RBX::CharacterMesh::BodyPart const&)")
}
...
pub fn stub_f33e44() -> ! {
    todo!("0xf33e44 std::vector<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::CharacterMesh::BodyPart*,std::vector<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>>,unsigned long,RBX::CharacterMesh::BodyPart const&)")
}
...
pub fn stub_f33e54() -> ! {
    todo!("0xf33e54 std::vector<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>::resize(unsigned long,RBX::CharacterMesh::BodyPart)")
}
...
pub fn stub_f33e64() -> ! {
    todo!("0xf33e64 std::vector<RBX::CharacterMesh::BodyPart,std::allocator<RBX::CharacterMesh::BodyPart>>::push_back(RBX::CharacterMesh::BodyPart const&)")
}
...
pub fn stub_f33e74() -> ! {
    todo!("0xf33e74 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>,std::_Select1st<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart> const&)")
}
...
pub fn stub_f33e84() -> ! {
    todo!("0xf33e84 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>,std::_Select1st<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>,std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart> const&)")
}
...
pub fn stub_f33e94() -> ! {
    todo!("0xf33e94 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>,std::_Select1st<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart> const&)")
}
...
pub fn stub_f34364() -> ! {
    todo!("0xf34364 boost::shared_ptr<RBX::FilteredSelection<RBX::PVInstance>> RBX::shared_from<RBX::FilteredSelection<RBX::PVInstance>>(RBX::FilteredSelection<RBX::PVInstance>*)")
}
...
pub fn stub_f345c4() -> ! {
    todo!("0xf345c4 boost::shared_ptr<RBX::FilteredSelection<RBX::PVInstance>>::operator=(boost::shared_ptr<RBX::FilteredSelection<RBX::PVInstance>> const&)")
}
...
pub fn stub_f3c4c4() -> ! {
    todo!("0xf3c4c4 rbx::placement_any<RBX::Region3>& rbx::placement_any<RBX::Region3>::operator=<RBX::CharacterMesh::BodyPart>(RBX::CharacterMesh::BodyPart const&)")
}
...
pub fn stub_f3c814() -> ! {
    todo!("0xf3c814 rbx::implementation::typed_holder<RBX::CharacterMesh::BodyPart>::singleton(void)")
}
...
pub fn stub_f3cbd4() -> ! {
    todo!("0xf3cbd4 RBX::CharacterMesh::BodyPart const& rbx::any_cast<RBX::CharacterMesh::BodyPart const&,RBX::Region3>(rbx::placement_any<RBX::Region3> &)")
}
...
pub fn stub_f3dad4() -> ! {
    todo!("0xf3dad4 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::BasicPartInstance,RBX::BasicPartInstance>(boost::shared_ptr<RBX::BasicPartInstance> const*,RBX::BasicPartInstance *)const")
}
...
pub fn stub_f3dc84() -> ! {
    todo!("0xf3dc84 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>,std::_Select1st<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::CharacterMesh::BodyPart>> *)")
}
