...
// Batch: 100 stubs | range 0x395464..0x3be8d8 | total filtered 13121, remaining 2415->2315 after batch
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr;  stripped from alias
// Shard: 93 EA-sorted ascending next uncovered gap from 0x395464
...
pub fn stub_3961b4() -> ! {
    todo!("0x3961b4 rbx_core::SharedPtr<RBX::PVInstance>::shared_ptr<RBX::PVInstance>(rbx_core::WeakPtr<RBX::PVInstance> const&,boost::detail::sp_nothrow_tag)")
}
