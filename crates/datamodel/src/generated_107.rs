...
// Batch: 100 stubs | range 0x65cab0..0x6d59b8 | total filtered 13121, remaining 1115->1015 after batch
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr; `'` stripped from alias
// Shard: 107 EA-sorted ascending next uncovered gap from 0x65cab0

#![allow(non_snake_case, dead_code, unused_variables, unused_imports, clippy::all)]

use rbx_core::SharedPtr;

// 0x65cab0 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE3EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE8setValueEPNS_10Reflection13DescribedBaseERKf
...
pub fn stub_65cab0() -> ! {
    todo!("0x65cab0 RBX::SurfaceGetSet<(RBX::NormalId)3,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::setValue(RBX::Reflection::DescribedBase *,float const&)const")
}
...
pub fn stub_65cad4() -> ! {
    todo!("0x65cad4 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)3,RBX::LegacyController::InputType>::SurfaceEnumPropDescriptor<RBX::LegacyController::InputType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::LegacyController::InputType)>(char const*,char const*,RBX::LegacyController::InputType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::LegacyController::InputType),RBX::Reflection::PropertyDescriptor::Functionality)")
}
...
pub fn stub_65d29c() -> ! {
    todo!("0x65d29c RBX::SurfaceGetSet<(RBX::NormalId)3,RBX::LegacyController::InputType,RBX::LegacyController::InputType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::LegacyController::InputType)>::getValue(RBX::Reflection::DescribedBase const*)const")
}
...
pub fn stub_65d2bc() -> ! {
    todo!("0x65d2bc RBX::SurfaceGetSet<(RBX::NormalId)3,RBX::LegacyController::InputType,RBX::LegacyController::InputType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::LegacyController::InputType)>::setValue(RBX::Reflection::DescribedBase *,RBX::LegacyController::InputType const&)const")
}

// 0x65d2e0 — __ZN3RBX25SurfaceEnumPropDescriptorILNS_8NormalIdE3ENS_11SurfaceTypeEEC2IMNS_12PartInstanceEKFS2_S1_EMS5_FvS1_S2_EEEPKcSB_T_T0_NS_10Reflection18PropertyDescriptor13FunctionalityE
...
pub fn stub_65d2e0() -> ! {
    todo!("0x65d2e0 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)3,RBX::SurfaceType>::SurfaceEnumPropDescriptor<RBX::SurfaceType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::SurfaceType)>(char const*,char const*,RBX::SurfaceType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::SurfaceType),RBX::Reflection::PropertyDescriptor::Functionality)")
}
...
// 0x65daa8 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE3ENS_11SurfaceTypeEMNS_12PartInstanceEKFS2_S1_EMS3_FvS1_S2_EE8getValueEPKNS_10Reflection13DescribedBaseE
...
pub fn stub_65daa8() -> ! {
    todo!("0x65daa8 RBX::SurfaceGetSet<(RBX::NormalId)3,RBX::SurfaceType,RBX::SurfaceType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::SurfaceType)>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x65dac8 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE3ENS_11SurfaceTypeEMNS_12PartInstanceEKFS2_S1_EMS3_FvS1_S2_EE8setValueEPNS_10Reflection13DescribedBaseERKS2_
...
pub fn stub_65dac8() -> ! {
    todo!("0x65dac8 RBX::SurfaceGetSet<(RBX::NormalId)3,RBX::SurfaceType,RBX::SurfaceType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::SurfaceType)>::setValue(RBX::Reflection::DescribedBase *,RBX::SurfaceType const&)const")
}

// 0x65daec — __ZN3RBX21SurfacePropDescriptorILNS_8NormalIdE4EfEC2IMNS_12PartInstanceEKFfS1_EMS4_FvS1_fEEEPKcSA_T_T0_NS_10Reflection18PropertyDescriptor13FunctionalityENS_8Security11PermissionsE
...
pub fn stub_65daec() -> ! {
    todo!("0x65daec RBX::SurfacePropDescriptor<(RBX::NormalId)4,float>::SurfacePropDescriptor<float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>(char const*,char const*,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float),RBX::Reflection::PropertyDescriptor::Functionality,RBX::Security::Permissions)")
}

// 0x65dc2c — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE4EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE10isReadOnlyEv
...
pub fn stub_65dc2c() -> ! {
    todo!("0x65dc2c RBX::SurfaceGetSet<(RBX::NormalId)4,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::isReadOnly(void)const")
}

// 0x65dc30 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE4EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE11isWriteOnlyEv
...
pub fn stub_65dc30() -> ! {
    todo!("0x65dc30 RBX::SurfaceGetSet<(RBX::NormalId)4,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::isWriteOnly(void)const")
}

// 0x65dc34 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE4EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE8getValueEPKNS_10Reflection13DescribedBaseE
...
pub fn stub_65dc34() -> ! {
    todo!("0x65dc34 RBX::SurfaceGetSet<(RBX::NormalId)4,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::getValue(RBX::Reflection::DescribedBase const*)const")
}

// 0x65dc54 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE4EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE8setValueEPNS_10Reflection13DescribedBaseERKf
...
pub fn stub_65dc54() -> ! {
    todo!("0x65dc54 RBX::SurfaceGetSet<(RBX::NormalId)4,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::setValue(RBX::Reflection::DescribedBase *,float const&)const")
}
...
pub fn stub_65dc78() -> ! {
    todo!("0x65dc78 RBX::SurfaceEnumPropDescriptor<(RBX::NormalId)4,RBX::LegacyController::InputType>::SurfaceEnumPropDescriptor<RBX::LegacyController::InputType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::LegacyController::InputType)>(char const*,char const*,RBX::LegacyController::InputType (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,RBX::LegacyController::InputType),RBX::Reflection::PropertyDescriptor::Functionality)")
}
...
// 0x65edd0 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE1EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE10isReadOnlyEv
...
pub fn stub_65edd0() -> ! {
    todo!("0x65edd0 RBX::SurfaceGetSet<(RBX::NormalId)1,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::isReadOnly(void)const")
}

// 0x65edd4 — __ZNK3RBX13SurfaceGetSetILNS_8NormalIdE1EfMNS_12PartInstanceEKFfS1_EMS2_FvS1_fEE11isWriteOnlyEv
...
pub fn stub_65edd4() -> ! {
    todo!("0x65edd4 RBX::SurfaceGetSet<(RBX::NormalId)1,float,float (RBX::PartInstance::*)(RBX::NormalId)const,void (RBX::PartInstance::*)(RBX::NormalId,float)>::isWriteOnly(void)const")
}
...
pub fn stub_680310() -> ! {
    todo!("0x680310 RBX::Tool::characterCanUnequipTool(RBX::ModelInstance *)")
}
...
#[doc(alias = "RBX::TouchTransmitter::checkTouch(boost::shared_ptr<RBX::PartInstance> const&)")]
pub fn stub_68e068() -> ! {
    todo!("0x68e068 RBX::TouchTransmitter::checkTouch(boost::shared_ptr<RBX::PartInstance> const&)")
}

// 0x68e078 — __ZN3RBX16TouchTransmitter12checkUntouchERKN5boost10shared_ptrINS_12PartInstanceEEE
#[doc(alias = "RBX::TouchTransmitter::checkUntouch(boost::shared_ptr<RBX::PartInstance> const&)")]
pub fn stub_68e078() -> ! {
    todo!("0x68e078 RBX::TouchTransmitter::checkUntouch(boost::shared_ptr<RBX::PartInstance> const&)")
}
...
pub fn stub_68e088() -> ! {
    todo!("0x68e088 RBX::TouchDebouncer::check(boost::shared_ptr<RBX::PartInstance> const&,RBX::TouchPair::Type)")
}
...
pub fn stub_6c0690() -> ! {
    todo!("0x6c0690 RBX::SeatImpl<RBX::PartInstance>::createSeatWeld(RBX::Humanoid *)")
}

// 0x6c14b0 — __ZN3RBX8SeatImplINS_12PartInstanceEED2Ev
#[doc(alias = "RBX::SeatImpl<RBX::PartInstance>::~SeatImpl()")]
pub fn stub_6c14b0() -> ! {
    todo!("0x6c14b0 RBX::SeatImpl<RBX::PartInstance>::~SeatImpl()")
}
...
pub fn stub_6c20e8() -> ! {
    todo!("0x6c20e8 RBX::ActionStation<RBX::PartInstance>::ActionStation(void)")
}
...
pub fn stub_6c3e14() -> ! {
    todo!("0x6c3e14 RBX::VirtualUser::getDataModel(void)")
}

// 0x6d1588 — __ZN3RBX10PVInstance15getLegacyOffsetEv
#[doc(alias = "RBX::PVInstance::getLegacyOffset(void)")]
pub fn stub_6d1588() -> ! {
    todo!("0x6d1588 RBX::PVInstance::getLegacyOffset(void)")
}
...
pub fn stub_6d2cfc() -> ! {
    todo!("0x6d2cfc RBX::ModelInstance::getRenderLocation(void)")
}

// 0x6d2d0c — __ZN3RBX13ModelInstance13getRenderSizeEv
#[doc(alias = "RBX::ModelInstance::getRenderSize(void)")]
pub fn stub_6d2d0c() -> ! {
    todo!("0x6d2d0c RBX::ModelInstance::getRenderSize(void)")
}
...
pub fn stub_6d59b8() -> ! {
    todo!("0x6d59b8 boost::shared_ptr<RBX::PartInstance> * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<boost::shared_ptr<RBX::PartInstance> *,boost::shared_ptr<RBX::PartInstance> *>(boost::shared_ptr<RBX::PartInstance> *,boost::shared_ptr<RBX::PartInstance> *,boost::shared_ptr<RBX::PartInstance> *)")
}
