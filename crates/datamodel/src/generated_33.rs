...
// Batch: 100 stubs | range 0xf3f174..0xf41b74 | total filtered 10215, remaining 1688 after batch
...
pub fn stub_f3f174() -> ! {
    todo!("0xf3f174 rbx_core::SharedPtr<RBX::GlobalAdvancedSettings> RBX::Creatable<RBX::Instance>::create<RBX::GlobalAdvancedSettings>(void)")
}
...
pub fn stub_f3f184() -> ! {
    todo!("0xf3f184 rbx_core::SharedPtr<RBX::Selection> RBX::Creatable<RBX::Instance>::create<RBX::Selection>(void)")
}
...
pub fn stub_f3f194() -> ! {
    todo!("0xf3f194 rbx_core::SharedPtr<RBX::GlobalBasicSettings>::shared_ptr<RBX::GlobalBasicSettings,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GlobalBasicSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f1a4() -> ! {
    todo!("0xf3f1a4 rbx_core::SharedPtr<RBX::GlobalAdvancedSettings>::shared_ptr<RBX::GlobalAdvancedSettings,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GlobalAdvancedSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f1b4() -> ! {
    todo!("0xf3f1b4 rbx_core::SharedPtr<RBX::Instance>& rbx_core::SharedPtr<RBX::Instance>::operator=<RBX::Selection>(rbx_core::SharedPtr<RBX::Selection> const&)")
}
...
pub fn stub_f3f1c4() -> ! {
    todo!("0xf3f1c4 rbx_core::SharedPtr<RBX::Selection>::shared_ptr<RBX::Selection,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Selection *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f1e4() -> ! {
    todo!("0xf3f1e4 boost::detail::shared_count::shared_count<RBX::GlobalBasicSettings *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GlobalBasicSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f1f4() -> ! {
    todo!("0xf3f1f4 boost::detail::shared_count::shared_count<RBX::GlobalAdvancedSettings *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GlobalAdvancedSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f204() -> ! {
    todo!("0xf3f204 boost::detail::shared_count::shared_count<RBX::Selection *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Selection *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f244() -> ! {
    todo!("0xf3f244 void RBX::Instance::visitChildren<void (*)(rbx_core::SharedPtr<RBX::Instance>)>(void (*)(rbx_core::SharedPtr<RBX::Instance>) const&)const")
}
...
pub fn stub_f3f484() -> ! {
    todo!("0xf3f484 rbx_core::SharedPtr<RBX::ChatButton> RBX::Creatable<RBX::Instance>::create<RBX::ChatButton,RBX::Adorn *,char const*,int>(RBX::Adorn *,char const*,int)")
}
...
pub fn stub_f3f494() -> ! {
    todo!("0xf3f494 rbx_core::SharedPtr<RBX::ChatOutput> RBX::Creatable<RBX::Instance>::create<RBX::ChatOutput>(void)")
}
...
pub fn stub_f3f4a4() -> ! {
    todo!("0xf3f4a4 rbx_core::SharedPtr<RBX::ChatWidget> RBX::Creatable<RBX::Instance>::create<RBX::ChatWidget,std::string,std::string>(std::string,std::string)")
}
...
pub fn stub_f3f4b4() -> ! {
    todo!("0xf3f4b4 rbx_core::SharedPtr<RBX::TextDisplay> RBX::Creatable<RBX::Instance>::create<RBX::TextDisplay,char const*,char const*>(char const*,char const*)")
}
...
pub fn stub_f3f4c4() -> ! {
    todo!("0xf3f4c4 rbx_core::SharedPtr<RBX::RelativePanel> RBX::Creatable<RBX::Instance>::create<RBX::RelativePanel,RBX::Layout>(RBX::Layout)")
}
...
pub fn stub_f3f4d4() -> ! {
    todo!("0xf3f4d4 rbx_core::SharedPtr<RBX::GuiImageButton> RBX::Creatable<RBX::Instance>::create<RBX::GuiImageButton,RBX::Verb *>(RBX::Verb *)")
}
...
pub fn stub_f3f4e4() -> ! {
    todo!("0xf3f4e4 rbx_core::SharedPtr<RBX::EquationDisplay> RBX::Creatable<RBX::Instance>::create<RBX::EquationDisplay,char const*,char const*>(char const*,char const*)")
}
...
pub fn stub_f3f4f4() -> ! {
    todo!("0xf3f4f4 rbx_core::SharedPtr<RBX::EquationDisplay> RBX::Creatable<RBX::Instance>::create<RBX::EquationDisplay,std::string,std::string>(std::string,std::string)")
}
...
pub fn stub_f3f504() -> ! {
    todo!("0xf3f504 rbx_core::SharedPtr<RBX::NotificationBox> RBX::Creatable<RBX::Instance>::create<RBX::NotificationBox>(void)")
}
...
pub fn stub_f3f514() -> ! {
    todo!("0xf3f514 rbx_core::SharedPtr<RBX::PhysicsSettings> RBX::Creatable<RBX::Instance>::create<RBX::PhysicsSettings>(void)")
}
...
pub fn stub_f3f524() -> ! {
    todo!("0xf3f524 rbx_core::SharedPtr<RBX::Frame> RBX::Creatable<RBX::Instance>::create<RBX::Frame>(void)")
}
...
pub fn stub_f3f534() -> ! {
    todo!("0xf3f534 rbx_core::SharedPtr<RBX::ChatButton>::shared_ptr<RBX::ChatButton,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ChatButton *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f544() -> ! {
    todo!("0xf3f544 rbx_core::SharedPtr<RBX::ChatOutput>::shared_ptr<RBX::ChatOutput,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ChatOutput *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f554() -> ! {
    todo!("0xf3f554 rbx_core::SharedPtr<RBX::ChatWidget>::shared_ptr<RBX::ChatWidget,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ChatWidget *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f574() -> ! {
    todo!("0xf3f574 rbx_core::SharedPtr<RBX::TextDisplay>::shared_ptr<RBX::TextDisplay,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TextDisplay *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f594() -> ! {
    todo!("0xf3f594 rbx_core::SharedPtr<RBX::RelativePanel>::shared_ptr<RBX::RelativePanel,RBX::Creatable<RBX::Instance>::Deleter>(RBX::RelativePanel *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f5a4() -> ! {
    todo!("0xf3f5a4 rbx_core::SharedPtr<RBX::GuiImageButton>::shared_ptr<RBX::GuiImageButton,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GuiImageButton *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f5b4() -> ! {
    todo!("0xf3f5b4 rbx_core::SharedPtr<RBX::EquationDisplay>::shared_ptr<RBX::EquationDisplay,RBX::Creatable<RBX::Instance>::Deleter>(RBX::EquationDisplay *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f5c4() -> ! {
    todo!("0xf3f5c4 rbx_core::SharedPtr<RBX::NotificationBox>::shared_ptr<RBX::NotificationBox,RBX::Creatable<RBX::Instance>::Deleter>(RBX::NotificationBox *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f5d4() -> ! {
    todo!("0xf3f5d4 rbx_core::SharedPtr<RBX::PhysicsSettings>::shared_ptr<RBX::PhysicsSettings,RBX::Creatable<RBX::Instance>::Deleter>(RBX::PhysicsSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f5e4() -> ! {
    todo!("0xf3f5e4 rbx_core::SharedPtr<RBX::Frame>::shared_ptr<RBX::Frame,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Frame *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f604() -> ! {
    todo!("0xf3f604 boost::detail::shared_count::shared_count<RBX::ChatButton *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ChatButton *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f614() -> ! {
    todo!("0xf3f614 boost::detail::shared_count::shared_count<RBX::ChatOutput *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ChatOutput *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f624() -> ! {
    todo!("0xf3f624 boost::detail::shared_count::shared_count<RBX::ChatWidget *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::ChatWidget *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f634() -> ! {
    todo!("0xf3f634 boost::detail::shared_count::shared_count<RBX::TextDisplay *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TextDisplay *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f644() -> ! {
    todo!("0xf3f644 boost::detail::shared_count::shared_count<RBX::RelativePanel *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::RelativePanel *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f654() -> ! {
    todo!("0xf3f654 boost::detail::shared_count::shared_count<RBX::GuiImageButton *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GuiImageButton *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f664() -> ! {
    todo!("0xf3f664 boost::detail::shared_count::shared_count<RBX::EquationDisplay *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::EquationDisplay *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f674() -> ! {
    todo!("0xf3f674 boost::detail::shared_count::shared_count<RBX::NotificationBox *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::NotificationBox *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f684() -> ! {
    todo!("0xf3f684 boost::detail::shared_count::shared_count<RBX::PhysicsSettings *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::PhysicsSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f694() -> ! {
    todo!("0xf3f694 boost::detail::shared_count::shared_count<RBX::GameBasicSettings *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::GameBasicSettings *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3f6a4() -> ! {
    todo!("0xf3f6a4 boost::detail::shared_count::shared_count<RBX::Frame *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Frame *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3fb64() -> ! {
    todo!("0xf3fb64 RBX::TweenService * RBX::ServiceProvider::create<RBX::TweenService>(RBX::Instance const*)")
}
...
pub fn stub_f3fca4() -> ! {
    todo!("0xf3fca4 rbx_core::SharedPtr<RBX::TweenService> RBX::Creatable<RBX::Instance>::create<RBX::TweenService>(void)")
}
...
pub fn stub_f3fee4() -> ! {
    todo!("0xf3fee4 rbx_core::SharedPtr<RBX::TweenService>::shared_ptr<RBX::TweenService,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TweenService *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f3fef4() -> ! {
    todo!("0xf3fef4 rbx_core::SharedPtr<RBX::Instance>& rbx_core::SharedPtr<RBX::Instance>::operator=<RBX::TweenService>(rbx_core::SharedPtr<RBX::TweenService> const&)")
}
...
pub fn stub_f40094() -> ! {
    todo!("0xf40094 boost::detail::shared_count::shared_count<RBX::TweenService *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::TweenService *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f40974() -> ! {
    todo!("0xf40974 RBX::ScriptContext * RBX::ServiceProvider::create<RBX::ScriptContext>(RBX::Instance const*)")
}
...
pub fn stub_f40984() -> ! {
    todo!("0xf40984 RBX::CoreGuiService * RBX::ServiceProvider::create<RBX::CoreGuiService>(RBX::Instance const*)")
}
...
pub fn stub_f409a4() -> ! {
    todo!("0xf409a4 rbx_core::SharedPtr<RBX::CoreGuiService> RBX::Creatable<RBX::Instance>::create<RBX::CoreGuiService>(void)")
}
...
pub fn stub_f409b4() -> ! {
    todo!("0xf409b4 rbx_core::SharedPtr<RBX::NotificationObject> RBX::Creatable<RBX::Instance>::create<RBX::NotificationObject>(void)")
}
...
pub fn stub_f40c14() -> ! {
    todo!("0xf40c14 rbx_core::SharedPtr<RBX::NotificationObject>::shared_ptr<RBX::NotificationObject,RBX::Creatable<RBX::Instance>::Deleter>(RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f40c24() -> ! {
    todo!("0xf40c24 rbx_core::SharedPtr<RBX::Instance>& rbx_core::SharedPtr<RBX::Instance>::operator=<RBX::CoreGuiService>(rbx_core::SharedPtr<RBX::CoreGuiService> const&)")
}
...
pub fn stub_f40d74() -> ! {
    todo!("0xf40d74 boost::detail::shared_count::shared_count<RBX::CoreGuiService *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::CoreGuiService *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f40d84() -> ! {
    todo!("0xf40d84 boost::detail::shared_count::shared_count<RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::NotificationObject *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f40fa4() -> ! {
    todo!("0xf40fa4 RBX::ScreenGui const* RBX::Instance::findConstFirstChildOfType<RBX::ScreenGui>(void)const")
}
...
pub fn stub_f417b4() -> ! {
    todo!("0xf417b4 rbx_core::SharedPtr<RBX::BodyThrust> RBX::Creatable<RBX::Instance>::create<RBX::BodyThrust>(void)")
}
...
pub fn stub_f417c4() -> ! {
    todo!("0xf417c4 rbx_core::SharedPtr<RBX::BodyPosition> RBX::Creatable<RBX::Instance>::create<RBX::BodyPosition>(void)")
}
...
pub fn stub_f417d4() -> ! {
    todo!("0xf417d4 rbx_core::SharedPtr<RBX::BodyVelocity> RBX::Creatable<RBX::Instance>::create<RBX::BodyVelocity>(void)")
}
...
pub fn stub_f417e4() -> ! {
    todo!("0xf417e4 rbx_core::SharedPtr<RBX::BodyAngularVelocity> RBX::Creatable<RBX::Instance>::create<RBX::BodyAngularVelocity>(void)")
}
...
pub fn stub_f417f4() -> ! {
    todo!("0xf417f4 rbx_core::SharedPtr<RBX::Rocket> RBX::Creatable<RBX::Instance>::create<RBX::Rocket>(void)")
}
...
pub fn stub_f41804() -> ! {
    todo!("0xf41804 rbx_core::SharedPtr<RBX::BodyGyro> RBX::Creatable<RBX::Instance>::create<RBX::BodyGyro>(void)")
}
...
pub fn stub_f41814() -> ! {
    todo!("0xf41814 rbx_core::SharedPtr<RBX::BodyForce> RBX::Creatable<RBX::Instance>::create<RBX::BodyForce>(void)")
}
...
pub fn stub_f41824() -> ! {
    todo!("0xf41824 rbx_core::SharedPtr<RBX::BodyThrust>::shared_ptr<RBX::BodyThrust,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyThrust *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41834() -> ! {
    todo!("0xf41834 rbx_core::SharedPtr<RBX::BodyPosition>::shared_ptr<RBX::BodyPosition,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41844() -> ! {
    todo!("0xf41844 rbx_core::SharedPtr<RBX::BodyVelocity>::shared_ptr<RBX::BodyVelocity,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41854() -> ! {
    todo!("0xf41854 rbx_core::SharedPtr<RBX::BodyAngularVelocity>::shared_ptr<RBX::BodyAngularVelocity,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41864() -> ! {
    todo!("0xf41864 rbx_core::SharedPtr<RBX::Rocket>::shared_ptr<RBX::Rocket,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Rocket *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41874() -> ! {
    todo!("0xf41874 rbx_core::SharedPtr<RBX::BodyGyro>::shared_ptr<RBX::BodyGyro,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyGyro *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41884() -> ! {
    todo!("0xf41884 rbx_core::SharedPtr<RBX::BodyForce>::shared_ptr<RBX::BodyForce,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyForce *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_f41894() -> ! {
    todo!("0xf41894 boost::detail::shared_count::shared_count<RBX::BodyThrust *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyThrust *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0xf418a4 — j___ZN5boost6detail12shared_countC2IPN3RBX12BodyPositionENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
...
pub fn stub_f418a4() -> ! {
    todo!("0xf418a4 boost::detail::shared_count::shared_count<RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyPosition *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0xf418b4 — j___ZN5boost6detail12shared_countC2IPN3RBX12BodyVelocityENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
...
pub fn stub_f418b4() -> ! {
    todo!("0xf418b4 boost::detail::shared_count::shared_count<RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0xf418c4 — j___ZN5boost6detail12shared_countC2IPN3RBX19BodyAngularVelocityENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
...
pub fn stub_f418c4() -> ! {
    todo!("0xf418c4 boost::detail::shared_count::shared_count<RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyAngularVelocity *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0xf418d4 — j___ZN5boost6detail12shared_countC2IPN3RBX6RocketENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
...
pub fn stub_f418d4() -> ! {
    todo!("0xf418d4 boost::detail::shared_count::shared_count<RBX::Rocket *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Rocket *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0xf418e4 — j___ZN5boost6detail12shared_countC2IPN3RBX8BodyGyroENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
...
pub fn stub_f418e4() -> ! {
    todo!("0xf418e4 boost::detail::shared_count::shared_count<RBX::BodyGyro *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyGyro *,RBX::Creatable<RBX::Instance>::Deleter)")
}

// 0xf418f4 — j___ZN5boost6detail12shared_countC2IPN3RBX9BodyForceENS3_9CreatableINS3_8InstanceEE7DeleterEEET_T0_
...
pub fn stub_f418f4() -> ! {
    todo!("0xf418f4 boost::detail::shared_count::shared_count<RBX::BodyForce *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::BodyForce *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
// 0xf41b74 — j___ZN3RBX9CreatableINS_8InstanceEE6createINS_7HandlesEEEN5boost10shared_ptrIT_EEv
...
pub fn stub_f41b74() -> ! {
    todo!("0xf41b74 rbx_core::SharedPtr<RBX::Handles> RBX::Creatable<RBX::Instance>::create<RBX::Handles>(void)")
}
