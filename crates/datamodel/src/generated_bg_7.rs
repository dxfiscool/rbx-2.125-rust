// Auto-generated skeletons for rbx-datamodel shard B — next 100 high-EA gap filler (opposite EA range)
// Filter: opposite EA range (high end) RBX:: — EA-sorted asc not yet in crates/datamodel/src
...
pub fn stub_f65e74() -> ! {
    todo!("0xf65e74 RBX::SolidTerrainRenderer<RBX::MegaClusterLegacy::VoxelGridOverlay>::apply(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&,RBX::Voxel::FaceDirection,RBX::RenderPredStatus)")
}
...
pub fn stub_f65e84() -> ! {
    todo!("0xf65e84 RBX::SolidTerrainRenderer<RBX::MegaClusterLegacy::VoxelGridOverlay>::wedgeFace(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&)")
}
...
pub fn stub_f65ef4() -> ! {
    todo!("0xf65ef4 RBX::SolidTerrainRenderer<RBX::Voxel::AreaCopy<36u,19u,34u>>::renderHelper(RBX::Voxel::Cell,RBX::Voxel::CellMaterial,G3D::Vector3int16 const&,bool,G3D::Vector3 const&,RBX::Voxel::FaceDirection,unsigned char)")
}
...
pub fn stub_f65f04() -> ! {
    todo!("0xf65f04 RBX::SolidTerrainRenderer<RBX::Voxel::AreaCopy<36u,19u,34u>>::wedgeUpEmpty(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&)")
}
...
pub fn stub_f65f14() -> ! {
    todo!("0xf65f14 RBX::SolidTerrainRenderer<RBX::Voxel::AreaCopy<36u,19u,34u>>::detectOutlines(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&,RBX::Voxel::FaceDirection,RBX::RenderPredStatus)")
}
...
pub fn stub_f65f24() -> ! {
    todo!("0xf65f24 RBX::SolidTerrainRenderer<RBX::Voxel::AreaCopy<36u,19u,34u>>::detectWedgeOutlines(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&)")
}
...
pub fn stub_f65f34() -> ! {
    todo!("0xf65f34 RBX::SolidTerrainRenderer<RBX::Voxel::AreaCopy<36u,19u,34u>>::apply(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&,RBX::Voxel::FaceDirection,RBX::RenderPredStatus)")
}
...
pub fn stub_f65f44() -> ! {
    todo!("0xf65f44 RBX::SolidTerrainRenderer<RBX::Voxel::AreaCopy<36u,19u,34u>>::wedgeFace(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&)")
}
...
pub fn stub_f65f54() -> ! {
    todo!("0xf65f54 RBX::MaterialTextureCoordinates::MaterialTextureCoordinates(G3D::Vector2int16 const&,G3D::Vector2int16 const&,G3D::Vector2int16 const&,float,bool)")
}
...
pub fn stub_f65f64() -> ! {
    todo!("0xf65f64 RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator::iterator(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk> const&)")
}
...
pub fn stub_f65f74() -> ! {
    todo!("0xf65f74 void RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk::fillFromRegion<RBX::Voxel::Region<RBX::Voxel::Grid::Chunk>>(RBX::Voxel::Region<RBX::Voxel::Grid::Chunk> const&)")
}
...
pub fn stub_f65f84() -> ! {
    todo!("0xf65f84 void RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk::loadData<RBX::Voxel::Grid>(RBX::Voxel::Grid const*,G3D::Vector3int16 const&)")
}
...
pub fn stub_f65f94() -> ! {
    todo!("0xf65f94 RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk::fillEmpty(G3D::Vector3int16 const&,G3D::Vector3int16 const&)")
}
...
pub fn stub_f65fa4() -> ! {
    todo!("0xf65fa4 RBX::WaterRenderPredicate<RBX::MegaClusterLegacy::VoxelGridOverlay>::internal(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&,RBX::Voxel::FaceDirection)const")
}
...
pub fn stub_f65fc4() -> ! {
    todo!("0xf65fc4 RBX::WaterRenderPredicate<RBX::Voxel::AreaCopy<36u,19u,34u>>::internal(RBX::Voxel::Region<RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk>::iterator const&,RBX::Voxel::FaceDirection)const")
}
...
pub fn stub_f65fd4() -> ! {
    todo!("0xf65fd4 RBX::Voxel::AreaCopy<36u,19u,34u>::Chunk::fillLocalAreaInfo(G3D::Vector3int16 const&,RBX::Voxel::Water::RelevantNeighbors const&,RBX::Voxel::Water::LocalAreaInfo *)const")
}
...
pub fn stub_f65fe4() -> ! {
    todo!("0xf65fe4 RBX::MegaCluster::ChunkData * std::__copy_backward_normal<false,false>::__copy_b_n<RBX::MegaCluster::ChunkData *,RBX::MegaCluster::ChunkData *>(RBX::MegaCluster::ChunkData *,RBX::MegaCluster::ChunkData *,RBX::MegaCluster::ChunkData *)")
}
...
pub fn stub_f65ff4() -> ! {
    todo!("0xf65ff4 std::vector<RBX::MegaCluster::ChunkData,std::allocator<RBX::MegaCluster::ChunkData>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::MegaCluster::ChunkData*,std::vector<RBX::MegaCluster::ChunkData,std::allocator<RBX::MegaCluster::ChunkData>>>,unsigned long,RBX::MegaCluster::ChunkData const&)")
}
...
pub fn stub_f66004() -> ! {
    todo!("0xf66004 std::vector<RBX::MegaClusterLegacy::ChunkData,std::allocator<RBX::MegaClusterLegacy::ChunkData>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::MegaClusterLegacy::ChunkData*,std::vector<RBX::MegaClusterLegacy::ChunkData,std::allocator<RBX::MegaClusterLegacy::ChunkData>>>,unsigned long,RBX::MegaClusterLegacy::ChunkData const&)")
}
...
pub fn stub_f66014() -> ! {
    todo!("0xf66014 void std::__uninitialized_fill_n_aux<RBX::MegaCluster::ChunkData *,unsigned long,RBX::MegaCluster::ChunkData>(RBX::MegaCluster::ChunkData *,unsigned long,RBX::MegaCluster::ChunkData const&,std::__false_type)")
}
...
pub fn stub_f66084() -> ! {
    todo!("0xf66084 void RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::getPrimitivesOverlapping<RBX::DenseHashSet<Ogre::RbxCullableSceneNode*,boost::hash<Ogre::RbxCullableSceneNode*>,std::allocator<Ogre::RbxCullableSceneNode*>>>(RBX::Extents const&,RBX::DenseHashSet<Ogre::RbxCullableSceneNode*,boost::hash<Ogre::RbxCullableSceneNode*>,std::allocator<Ogre::RbxCullableSceneNode*>> &)")
}
...
pub fn stub_f66094() -> ! {
    todo!("0xf66094 RBX::DenseHashSet<Ogre::RbxCullableSceneNode *,boost::hash<Ogre::RbxCullableSceneNode *>,std::allocator<Ogre::RbxCullableSceneNode *>>::insert(Ogre::RbxCullableSceneNode * const&)")
}
...
pub fn stub_f660a4() -> ! {
    todo!("0xf660a4 RBX::DenseHashSet<Ogre::RbxCullableSceneNode *,boost::hash<Ogre::RbxCullableSceneNode *>,std::allocator<Ogre::RbxCullableSceneNode *>>::rehash(void)")
}
...
pub fn stub_f660b4() -> ! {
    todo!("0xf660b4 RBX::DenseHashSet<Ogre::RbxCullableSceneNode *,boost::hash<Ogre::RbxCullableSceneNode *>,std::allocator<Ogre::RbxCullableSceneNode *>>::DenseHashSet(Ogre::RbxCullableSceneNode * const&,unsigned long,boost::hash<Ogre::RbxCullableSceneNode *> const&)")
}
...
pub fn stub_f66114() -> ! {
    todo!("0xf66114 RBX::Voxel::Region<RBX::Voxel::Grid::Chunk>::xline_iterator::xline_iterator(RBX::Voxel::Region<RBX::Voxel::Grid::Chunk> const&)")
}
...
pub fn stub_f66134() -> ! {
    todo!("0xf66134 void RBX::LightGrid::occupancyFillDF<RBX::TorsoDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::TorsoDistanceFunction &)")
}
...
pub fn stub_f66144() -> ! {
    todo!("0xf66144 void RBX::LightGrid::occupancyFillDF<RBX::WedgeDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::WedgeDistanceFunction &)")
}
...
pub fn stub_f66154() -> ! {
    todo!("0xf66154 void RBX::LightGrid::occupancyFillDF<RBX::SphereDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::SphereDistanceFunction &)")
}
...
pub fn stub_f66164() -> ! {
    todo!("0xf66164 void RBX::LightGrid::occupancyFillDF<RBX::CylinderXDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::CylinderXDistanceFunction &)")
}
...
pub fn stub_f66174() -> ! {
    todo!("0xf66174 void RBX::LightGrid::occupancyFillDF<RBX::CylinderYDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::CylinderYDistanceFunction &)")
}
...
pub fn stub_f66184() -> ! {
    todo!("0xf66184 void RBX::LightGrid::occupancyFillDF<RBX::EllipsoidDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::EllipsoidDistanceFunction &)")
}
...
pub fn stub_f66194() -> ! {
    todo!("0xf66194 void RBX::LightGrid::occupancyFillDF<RBX::CornerWedgeDistanceFunction>(RBX::LightGridChunk &,RBX::Extents const&,G3D::Vector3 const&,G3D::CoordinateFrame const&,float,RBX::CornerWedgeDistanceFunction &)")
}
...
pub fn stub_f661b4() -> ! {
    todo!("0xf661b4 void RBX::LightGrid::occupancyFillTerrain<RBX::Voxel::Grid>(RBX::LightGridChunk &,RBX::Voxel::Grid &,RBX::Vector3int32 const&,RBX::Extents const&)")
}
...
pub fn stub_f661d4() -> ! {
    todo!("0xf661d4 void RBX::LightGrid::occupancyFillTerrainSIMD<RBX::Voxel::Grid>(RBX::LightGridChunk &,RBX::Voxel::Grid &,RBX::Vector3int32 const&,RBX::Extents const&)")
}
...
pub fn stub_f661e4() -> ! {
    todo!("0xf661e4 void RBX::LightGrid::lightingBlurAxisYZScratch<false>(void)")
}
...
pub fn stub_f661f4() -> ! {
    todo!("0xf661f4 void RBX::LightGrid::lightingBlurAxisYZScratch<true>(void)")
}
...
pub fn stub_f66204() -> ! {
    todo!("0xf66204 void RBX::LightGrid::lightingComputeShadowMaskZ<false,false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66214() -> ! {
    todo!("0xf66214 void RBX::LightGrid::lightingComputeShadowMaskZ<false,true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66224() -> ! {
    todo!("0xf66224 void RBX::LightGrid::lightingComputeShadowMaskZ<true,false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66234() -> ! {
    todo!("0xf66234 void RBX::LightGrid::lightingComputeShadowMaskZ<true,true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66244() -> ! {
    todo!("0xf66244 void RBX::LightGrid::lightingComputeShadowMaskYZ<false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66254() -> ! {
    todo!("0xf66254 void RBX::LightGrid::lightingComputeShadowMaskYZ<true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66264() -> ! {
    todo!("0xf66264 void RBX::LightGrid::lightingUpdateDirectionalImpl<false,false>(RBX::LightGridChunk &,RBX::Vector3int32 const&)")
}
...
pub fn stub_f66274() -> ! {
    todo!("0xf66274 void RBX::LightGrid::lightingUpdateDirectionalImpl<false,true>(RBX::LightGridChunk &,RBX::Vector3int32 const&)")
}
...
pub fn stub_f66284() -> ! {
    todo!("0xf66284 void RBX::LightGrid::lightingUpdateDirectionalImpl<true,false>(RBX::LightGridChunk &,RBX::Vector3int32 const&)")
}
...
pub fn stub_f66294() -> ! {
    todo!("0xf66294 void RBX::LightGrid::lightingUpdateDirectionalImpl<true,true>(RBX::LightGridChunk &,RBX::Vector3int32 const&)")
}

// 0xf662a4 — j___ZN3RBX9LightGrid30lightingUpdateSpotLightScratchILb0EEEvRKNS_12Vector3int32ES4_RKN3G3D7Vector3EfS8_fRKNS5_11Color3uint8Ef
...
pub fn stub_f662a4() -> ! {
    todo!("0xf662a4 void RBX::LightGrid::lightingUpdateSpotLightScratch<false>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}

// 0xf662b4 — j___ZN3RBX9LightGrid30lightingUpdateSpotLightScratchILb1EEEvRKNS_12Vector3int32ES4_RKN3G3D7Vector3EfS8_fRKNS5_11Color3uint8Ef
// type: int __fastcall(int, int, int, int, float, int, float, int, float)
...
pub fn stub_f662b4() -> ! {
    todo!("0xf662b4 void RBX::LightGrid::lightingUpdateSpotLightScratch<true>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}

// 0xf662c4 — j___ZN3RBX9LightGrid31lightingUpdatePointLightScratchILb0EEEvRKNS_12Vector3int32ES4_RKN3G3D7Vector3EfRKNS5_11Color3uint8Ef
...
pub fn stub_f662c4() -> ! {
    todo!("0xf662c4 void RBX::LightGrid::lightingUpdatePointLightScratch<false>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}
...
pub fn stub_f662d4() -> ! {
    todo!("0xf662d4 void RBX::LightGrid::lightingUpdatePointLightScratch<true>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}
...
pub fn stub_f662e4() -> ! {
    todo!("0xf662e4 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<false,false,false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f662f4() -> ! {
    todo!("0xf662f4 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<false,false,true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66304() -> ! {
    todo!("0xf66304 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<false,true,false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66314() -> ! {
    todo!("0xf66314 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<false,true,true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66324() -> ! {
    todo!("0xf66324 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<true,false,false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66334() -> ! {
    todo!("0xf66334 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<true,false,true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66344() -> ! {
    todo!("0xf66344 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<true,true,false>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66354() -> ! {
    todo!("0xf66354 void RBX::LightGrid::lightingComputeShadowMaskImplLUT<true,true,true>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&)")
}
...
pub fn stub_f66364() -> ! {
    todo!("0xf66364 void RBX::LightGrid::lightingUpdateSpotLightScratchSIMD<false>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}
...
pub fn stub_f66374() -> ! {
    todo!("0xf66374 void RBX::LightGrid::lightingUpdateSpotLightScratchSIMD<true>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}
...
pub fn stub_f66384() -> ! {
    todo!("0xf66384 void RBX::LightGrid::lightingUpdatePointLightScratchSIMD<false>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}
...
pub fn stub_f66394() -> ! {
    todo!("0xf66394 void RBX::LightGrid::lightingUpdatePointLightScratchSIMD<true>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,G3D::Vector3 const&,float,G3D::Color3uint8 const&,float)")
}
...
pub fn stub_f663a4() -> ! {
    todo!("0xf663a4 void RBX::LightGrid::lightingTransferShadowMaskToShadowSlice<0>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,int,RBX::LightShadowSlice &,RBX::LightShadowSlice &)")
}
...
pub fn stub_f663b4() -> ! {
    todo!("0xf663b4 void RBX::LightGrid::lightingTransferShadowMaskToShadowSlice<1>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,int,RBX::LightShadowSlice &,RBX::LightShadowSlice &)")
}
...
pub fn stub_f663c4() -> ! {
    todo!("0xf663c4 void RBX::LightGrid::lightingTransferShadowMaskToShadowSlice<2>(RBX::LightGridChunk const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,int,RBX::LightShadowSlice &,RBX::LightShadowSlice &)")
}
...
pub fn stub_f663d4() -> ! {
    todo!("0xf663d4 void RBX::LightGrid::lightingTransferShadowSliceToShadowMask<0>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,int,RBX::LightShadowSlice const&,RBX::LightShadowSlice const&)")
}
...
pub fn stub_f663e4() -> ! {
    todo!("0xf663e4 void RBX::LightGrid::lightingTransferShadowSliceToShadowMask<1>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,int,RBX::LightShadowSlice const&,RBX::LightShadowSlice const&)")
}
...
pub fn stub_f663f4() -> ! {
    todo!("0xf663f4 void RBX::LightGrid::lightingTransferShadowSliceToShadowMask<2>(RBX::Vector3int32 const&,RBX::Vector3int32 const&,RBX::Vector3int32 const&,int,RBX::LightShadowSlice const&,RBX::LightShadowSlice const&)")
}
...
pub fn stub_f66484() -> ! {
    todo!("0xf66484 RBX::CornerWedgeDistanceFunction::operator()(G3D::Vector3 const&)const")
}
...
pub fn stub_f664d4() -> ! {
    todo!("0xf664d4 std::vector<RBX::LightObject *,std::allocator<RBX::LightObject *>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::LightObject **,std::vector<RBX::LightObject *,std::allocator<RBX::LightObject *>>>,RBX::LightObject * const&)")
}
...
pub fn stub_f664e4() -> ! {
    todo!("0xf664e4 std::vector<RBX::LightGridChunk *,std::allocator<RBX::LightGridChunk *>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::LightGridChunk **,std::vector<RBX::LightGridChunk *,std::allocator<RBX::LightGridChunk *>>>,RBX::LightGridChunk * const&)")
}
...
pub fn stub_f664f4() -> ! {
    todo!("0xf664f4 std::vector<RBX::LightGridChunk *,std::allocator<RBX::LightGridChunk *>>::_M_fill_insert(__gnu_cxx::__normal_iterator<RBX::LightGridChunk **,std::vector<RBX::LightGridChunk *,std::allocator<RBX::LightGridChunk *>>>,unsigned long,RBX::LightGridChunk * const&)")
}
...
pub fn stub_f66504() -> ! {
    todo!("0xf66504 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::ICreator const*>,std::_Select1st<std::pair<RBX::Name const* const,RBX::ICreator const*>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ICreator const*>>>::_M_insert_unique(std::pair<RBX::Name const* const,RBX::ICreator const*> const&)")
}
...
pub fn stub_f66514() -> ! {
    todo!("0xf66514 std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::ICreator const*>,std::_Select1st<std::pair<RBX::Name const* const,RBX::ICreator const*>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::ICreator const*>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::ICreator const*>> *)")
}
...
pub fn stub_f66524() -> ! {
    todo!("0xf66524 RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::changeMinMax(Ogre::RbxCullableSceneNode*,RBX::ExtentsInt32 const*,RBX::ExtentsInt32 const*,RBX::ExtentsInt32 const*,bool)")
}
...
pub fn stub_f66534() -> ! {
    todo!("0xf66534 RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::insertNodeToPrimitive(RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::SpatialNode *,Ogre::RbxCullableSceneNode*,RBX::Vector3int32 const&,int)")
}
...
pub fn stub_f66544() -> ! {
    todo!("0xf66544 RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::findOtherNodesInLevel0Cell(RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::SpatialNode *)")
}
...
pub fn stub_f66554() -> ! {
    todo!("0xf66554 RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::newNode(int,int,RBX::Vector3int32 const&)")
}
...
pub fn stub_f66564() -> ! {
    todo!("0xf66564 RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::findNode(Ogre::RbxCullableSceneNode*,RBX::Vector3int32 const&)")
}
...
pub fn stub_f66574() -> ! {
    todo!("0xf66574 RBX::Allocator<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::SpatialNode>::Allocator(void)")
}
...
pub fn stub_f66584() -> ! {
    todo!("0xf66584 RBX::Allocator<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::TreeNode>::Allocator(void)")
}

// 0xf66594 — j___ZN5boost10scoped_ptrIN3RBX14LightShadowMapEED2Ev
#[doc(alias = "boost::scoped_ptr<RBX::LightShadowMap>::~scoped_ptr()")]
pub fn stub_f66594() -> ! {
    todo!("0xf66594 boost::scoped_ptr<RBX::LightShadowMap>::~scoped_ptr()")
}
...
pub fn stub_f665a4() -> ! {
    todo!("0xf665a4 RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::SpatialNode* boost::object_pool<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::SpatialNode,RBX::roblox_allocator>::construct<int,int,RBX::Vector3int32>(int &,int &,RBX::Vector3int32 const&)")
}
...
pub fn stub_f665b4() -> ! {
    todo!("0xf665b4 boost::object_pool<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::TreeNode,RBX::roblox_allocator>::destroy(RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::TreeNode*)")
}
...
pub fn stub_f665c4() -> ! {
    todo!("0xf665c4 boost::object_pool<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::TreeNode,RBX::roblox_allocator>::construct(void)")
}
...
pub fn stub_f665d4() -> ! {
    todo!("0xf665d4 boost::singleton_pool<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::SpatialNode,32u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::malloc(void)")
}
...
pub fn stub_f665e4() -> ! {
    todo!("0xf665e4 boost::singleton_pool<RBX::SpatialHash<Ogre::RbxCullableSceneNode,RBX::Contact,RBX::ContactManager,4>::TreeNode,48u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::malloc(void)")
}
...
pub fn stub_f665f4() -> ! {
    todo!("0xf665f4 std::vector<RBX::RenderEntity *,std::allocator<RBX::RenderEntity *>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::RenderEntity **,std::vector<RBX::RenderEntity *,std::allocator<RBX::RenderEntity *>>>,RBX::RenderEntity * const&)")
}
...
pub fn stub_f66604() -> ! {
    todo!("0xf66604 RBX::WaterImpl::underwater(void)")
}
...
pub fn stub_f66614() -> ! {
    todo!("0xf66614 RBX::WaterImpl::load(void)")
}

// 0xf66624 — j___ZN3RBX9WaterImplC2EPN4Ogre12VisualEngineE
// type: _DWORD __fastcall(RBX::WaterImpl *__hidden this, Ogre::VisualEngine *)
#[doc(alias = "RBX::WaterImpl::WaterImpl(Ogre::VisualEngine *)")]
pub fn stub_f66624() -> ! {
    todo!("0xf66624 RBX::WaterImpl::WaterImpl(Ogre::VisualEngine *)")
}
...
pub fn stub_f66634() -> ! {
    todo!("0xf66634 RBX::WaterImpl::~WaterImpl()")
}
