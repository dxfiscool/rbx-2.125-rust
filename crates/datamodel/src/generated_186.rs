...
// Batch: 120 stubs | range 0xf6cc54..0xf6d3c4 | total filtered 10215, remaining 0 after batch; local 18015->18135 distinct, 67530->67410 not in datamodel (0 global missing)
// Shard: 186 EA-sorted asc next 120 high-EA global gap filler after 0xf6cc44 not yet in datamodel (filtered exhausted, 67530 missing before -> 67410 after)
...
pub fn stub_f6d044() -> ! {
    todo!("0xf6d044 _task_set_exception_ports")
}
...
pub fn stub_f6d054() -> ! {
    todo!("0xf6d054 _task_swap_exception_ports")
}
...
pub fn stub_f6d074() -> ! {
    todo!("0xf6d074 _thread_get_state")
}
...
pub fn stub_f6d094() -> ! {
    todo!("0xf6d094 _thread_set_exception_ports")
}
...
pub fn stub_f6d0b4() -> ! {
    todo!("0xf6d0b4 _thread_swap_exception_ports")
}
...
// 0xf6d144 — _vm_map
// type: kern_return_t __cdecl(vm_map_t target_task, vm_address_t *address, vm_size_t size, vm_address_t mask, int flags, mem_entry_name_port_t object, vm_offset_t offset, boolean_t copy, vm_prot_t cur_protection, vm_prot_t max_protection, vm_inherit_t inheritance)
#[doc(alias = "_vm_map")]
pub fn stub_f6d144() -> ! {
