...
// Filter: gap filler distinct not yet in crates/datamodel/src (global EA asc, distinct per crate)
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: 120 stubs | range 0x553cbc..0x55aa7c | remaining global for crate 44503 after batch
// Shard: wdog_dm_B2 EA-sorted asc gap filler 120 distinct (shard B distinct from A, rbx_core::SharedPtr not boost, 0xADDR mangled + doc alias + todo!)
...
pub fn stub_0x553cbc() -> ! {
    todo!("0x553cbc rbx::signals::signal<void ()(std::string,std::string)>::remove(rbx::signals::signal<void ()(std::string,std::string)>::slot *)")
}
...
pub fn stub_0x553dac() -> ! {
    todo!("0x553dac rbx::signals::signal<void ()(std::string,std::string)>::slot::safe_static_init_mutex(void)")
}
...
pub fn stub_0x553db0() -> ! {
    todo!("0x553db0 rbx::signals::signal<void ()(std::string,std::string)>::slot::safe_static_do_get_mutex(void)")
}
...
pub fn stub_0x5540e0() -> ! {
    todo!("0x5540e0 rbx::signals::signal<void ()(std::string,std::string)>::slot::~slot()")
}
...
pub fn stub_0x55410c() -> ! {
    todo!("0x55410c rbx::signals::signal<void ()(std::string,std::string)>::slot::~slot()")
}
...
pub fn stub_0x554a3c() -> ! {
    todo!("0x554a3c std::_Rb_tree<RBX::GuiService::CenterDialogType,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>,std::_Select1st<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>> *)")
}
...
pub fn stub_0x554a64() -> ! {
    todo!("0x554a64 std::_Rb_tree<RBX::GuiService::CenterDialogType,std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>,std::_Select1st<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>,std::less<RBX::GuiService::CenterDialogType>,std::allocator<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>>>::_M_destroy_node(std::_Rb_tree_node<std::pair<RBX::GuiService::CenterDialogType const,std::list<RBX::GuiService::DialogWrapper *,std::allocator<RBX::GuiService::DialogWrapper *>>>> *)")
}
...
pub fn stub_0x554a8c() -> ! {
    todo!("0x554a8c std::_Rb_tree<char,char,std::_Identity<char>,std::less<char>,std::allocator<char>>::_M_erase(std::_Rb_tree_node<char> *)")
}
...
pub fn stub_0x554adc() -> ! {
    todo!("0x554adc std::_Rb_tree<RBX::Name const*,std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>,std::_Select1st<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>>>::_M_erase(std::_Rb_tree_node<std::pair<RBX::Name const* const,RBX::GuiService::SpecialKey>> *)")
}
...
pub fn stub_0x555944() -> ! {
    todo!("0x555944 RBX::BodyMover::~BodyMover()")
}
...
pub fn stub_0x555b90() -> ! {
    todo!("0x555b90 RBX::BodyMover::computeForce(bool)")
}
...
pub fn stub_0x556284() -> ! {
    todo!("0x556284 RBX::BodyMover::getEngineBody(void)")
}
...
pub fn stub_0x556320() -> ! {
    todo!("0x556320 RBX::BodyMover::duplicateBodyMoverExists(RBX::Primitive *,RBX::Primitive *)")
}
...
pub fn stub_0x556c84() -> ! {
    todo!("0x556c84 RBX::Rocket::~Rocket()")
}
...
pub fn stub_0x556e4c() -> ! {
    todo!("0x556e4c RBX::Rocket::onStepped(RBX::Stepped const&)")
}
...
pub fn stub_0x5578a0() -> ! {
    todo!("0x5578a0 RBX::BodyGyro::BodyGyro(void)")
}
...
pub fn stub_0x557c50() -> ! {
    todo!("0x557c50 RBX::BodyGyro::computeBalanceTorque(RBX::Body *,RBX::Body *)")
}
...
pub fn stub_0x557ff8() -> ! {
    todo!("0x557ff8 RBX::BodyGyro::computeOrientationTorque(RBX::Body *,RBX::Body *)")
}

// 0x5582bc — __ZN3RBX12BodyPositionC2Ev
#[doc(alias = "RBX::BodyPosition::BodyPosition(void)")]
#[doc(alias = "__ZN3RBX12BodyPositionC2Ev")]
pub fn stub_0x5582bc() -> ! {
    todo!("0x5582bc RBX::BodyPosition::BodyPosition(void)")
}
...
pub fn stub_0x558780() -> ! {
    todo!("0x558780 RBX::BodyPosition::onStepped(RBX::Stepped const&)")
}
...
pub fn stub_0x5588f8() -> ! {
    todo!("0x5588f8 RBX::BodyVelocity::BodyVelocity(void)")
}
...
pub fn stub_0x558c34() -> ! {
    todo!("0x558c34 RBX::BodyAngularVelocity::BodyAngularVelocity(void)")
}
...
pub fn stub_0x558f70() -> ! {
    todo!("0x558f70 RBX::BodyForce::BodyForce(void)")
}
...
pub fn stub_0x559124() -> ! {
    todo!("0x559124 RBX::BodyThrust::BodyThrust(void)")
}
...
pub fn stub_0x559440() -> ! {
    todo!("0x559440 RBX::Rocket::getTargetDangerous(void)const")
}
...
pub fn stub_0x5594c4() -> ! {
    todo!("0x5594c4 RBX::Body::getBranchForce(void)const")
}
...
pub fn stub_0x559534() -> ! {
    todo!("0x559534 RBX::Body::getBranchTorque(void)const")
}
...
pub fn stub_0x5595ac() -> ! {
    todo!("0x5595ac RBX::BodyPosition::getLastForce(void)")
}
...
pub fn stub_0x559604() -> ! {
    todo!("0x559604 RBX::BodyVelocity::getLastForce(void)")
}
...
pub fn stub_0x559638() -> ! {
    todo!("0x559638 RBX::Body::getBranchVelocity(void)")
}

// 0x5596b0 — __ZN3RBX12BodyPositionD1Ev
#[doc(alias = "RBX::BodyPosition::~BodyPosition()")]
#[doc(alias = "__ZN3RBX12BodyPositionD1Ev")]
pub fn stub_0x5596b0() -> ! {
    todo!("0x5596b0 RBX::BodyPosition::~BodyPosition()")
}

// 0x5597e0 — __ZN3RBX12BodyPositionD0Ev
#[doc(alias = "RBX::BodyPosition::~BodyPosition()")]
#[doc(alias = "__ZN3RBX12BodyPositionD0Ev")]
pub fn stub_0x5597e0() -> ! {
    todo!("0x5597e0 RBX::BodyPosition::~BodyPosition()")
}
...
pub fn stub_0x55a860() -> ! {
    todo!("0x55a860 RBX::BodyGyro::~BodyGyro()")
}

// 0x55a864 — __ZN3RBX8BodyGyroD0Ev
#[doc(alias = "RBX::BodyGyro::~BodyGyro()")]
#[doc(alias = "__ZN3RBX8BodyGyroD0Ev")]
pub fn stub_0x55a864() -> ! {
    todo!("0x55a864 RBX::BodyGyro::~BodyGyro()")
}
