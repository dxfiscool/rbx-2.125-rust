// Auto-generated datamodel watchdog P — 100 gap filler EA-sorted asc 0x2decd4..0x2e880c (RBX::Instance|DataModel|Workspace filter exhausted 10215/10215, gap filler next 100 not in datamodel)

// Source: ida/export.json (85545 funcs) filtered demangled contains RBX::Instance|RBX::DataModel|RBX::Workspace — fallback global gap filler (all 10215 datamodel EAs already stubbed, 85545 total, datamodel 33258->33358 distinct, gap 53087->52987 remaining)
...
// was: boost::shared_ptr<RBX::LuaDragTool>::shared_ptr<RBX::LuaDragTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::LuaDragTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)
pub fn stub_2e09ec() -> ! {
    todo!("0x2e09ec rbx_core::SharedPtr<RBX::LuaDragTool>::shared_ptr<RBX::LuaDragTool,RBX::Creatable<RBX::MouseCommand>::Deleter>(RBX::LuaDragTool *,RBX::Creatable<RBX::MouseCommand>::Deleter)")
}
...
// was: void boost::enable_shared_from_this<RBX::MouseCommand>::_internal_accept_owner<RBX::LuaDragTool,RBX::LuaDragTool>(boost::shared_ptr<RBX::LuaDragTool> const*,RBX::LuaDragTool *)const
pub fn stub_2e0ab4() -> ! {
    todo!("0x2e0ab4 void boost::enable_shared_from_this<RBX::MouseCommand>::_internal_accept_owner<RBX::LuaDragTool,RBX::LuaDragTool>(rbx_core::SharedPtr<RBX::LuaDragTool> const*,RBX::LuaDragTool *)const")
}
...
pub fn stub_2e880c() -> ! {
    todo!("0x2e880c G3D::Vector3::Axis RBX::Reflection::ArgHelper::getArg<G3D::Vector3::Axis,1>(RBX::Reflection::FunctionDescriptor::Arguments &,boost::scoped_ptr<G3D::Vector3::Axis> const&,boost::disable_if<boost::is_same<G3D::Vector3::Axis,rbx_core::SharedPtr<RBX::Reflection::Tuple const>>,void>::type *)")
}
