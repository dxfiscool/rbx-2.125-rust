...
// Batch: 100 stubs | range 0x4047d4..0x41b498 | total filtered 10215, remaining 2780->2680 after batch
...
pub fn stub_411918() -> ! {
    todo!("0x411918 rbx_core::SharedPtr<RBX::AdvRotateTool> RBX::Creatable<RBX::MouseCommand>::create<RBX::AdvRotateTool,RBX::Workspace *>(RBX::Workspace *)")
}
...
pub fn stub_4125f4() -> ! {
    todo!("0x4125f4 rbx_core::SharedPtr<RBX::AdvMoveTool> RBX::Creatable<RBX::MouseCommand>::create<RBX::AdvMoveTool,RBX::Workspace *>(RBX::Workspace *)")
}
