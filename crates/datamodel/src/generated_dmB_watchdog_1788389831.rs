...
// Filter: DataModel|Part|Script demangled gap-fill EA-sorted asc, global-dedup attempted datamodel-dedup fallback
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: 120 stubs | range 0x8f2c7c..0xd4915c | remaining DataModel/Part/Script datamodel-remaining 1529 before batch, global-remaining 1529
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr; boost::shared_ptr stripped from alias
// Shard: dmB_watchdog_1788389831 EA-sorted ascending — second parallel datamodel worker, 120 unique stubs
...
// type: int __fastcall(int, double *, int, int, int, int, int, int, int (__fastcall *)(int, double *))
#[doc(alias = "__ZSt21__unguarded_partitionIPN3RBX24OSProfilerMarkerTempDataES1_PFbRKS1_S4_EET_S7_S7_T0_T1_")]
...
pub fn stub_8f2c7c() -> ! {
    todo!("0x8f2c7c RBX::OSProfilerMarkerTempData * std::__unguarded_partition<RBX::OSProfilerMarkerTempData *,RBX::OSProfilerMarkerTempData,bool (*)(RBX::OSProfilerMarkerTempData const&,RBX::OSProfilerMarkerTempData const&)>(RBX::OSProfilerMarkerTempData *,RBX::OSProfilerMarkerTempData *,RBX::OSProfilerMarkerTempData,bool (*)(RBX::OSProfilerMarkerTempData const&,RBX::OSProfilerMarkerTempData const&))")
}

// 0x8f3218 — __ZSt21__unguarded_partitionIPN3RBX27OSProfilerMarkerTempDataStrES1_PFbRKS1_S4_EET_S7_S7_T0_T1_
// type: _DWORD *__fastcall(_DWORD *, unsigned int, int, int, int, int (__fastcall *)(_DWORD *, _DWORD *))
#[doc(alias = "__ZSt21__unguarded_partitionIPN3RBX27OSProfilerMarkerTempDataStrES1_PFbRKS1_S4_EET_S7_S7_T0_T1_")]
...
pub fn stub_8f3218() -> ! {
    todo!("0x8f3218 RBX::OSProfilerMarkerTempDataStr * std::__unguarded_partition<RBX::OSProfilerMarkerTempDataStr *,RBX::OSProfilerMarkerTempDataStr,bool (*)(RBX::OSProfilerMarkerTempDataStr const&,RBX::OSProfilerMarkerTempDataStr const&)>(RBX::OSProfilerMarkerTempDataStr *,RBX::OSProfilerMarkerTempDataStr *,RBX::OSProfilerMarkerTempDataStr,bool (*)(RBX::OSProfilerMarkerTempDataStr const&,RBX::OSProfilerMarkerTempDataStr const&))")
}
...
#[doc(alias = "__ZSt21__unguarded_partitionIN9__gnu_cxx17__normal_iteratorIPN3RBX9ContentIdESt6vectorIS3_SaIS3_EEEES3_ET_S9_S9_T0_")]
...
pub fn stub_9460e0() -> ! {
    todo!("0x9460e0 __gnu_cxx::__normal_iterator<RBX::ContentId *,std::vector<RBX::ContentId,std::allocator<RBX::ContentId>>> std::__unguarded_partition<__gnu_cxx::__normal_iterator<RBX::ContentId *,std::vector<RBX::ContentId,std::allocator<RBX::ContentId>>>,RBX::ContentId>(__gnu_cxx::__normal_iterator<RBX::ContentId *,std::vector<RBX::ContentId,std::allocator<RBX::ContentId>>>,__gnu_cxx::__normal_iterator<RBX::ContentId *,std::vector<RBX::ContentId,std::allocator<RBX::ContentId>>>,RBX::ContentId)")
}
...
#[doc(alias = "__ZN6RakNet16SocketDescriptorC1EtPKc")]
...
// type: int __fastcall(int, Ogre::ParticleSystem *this)
#[doc(alias = "__ZN3RBX18RbxParticleFactory17updateSmokeSystemEPN4Ogre14ParticleSystemEPNS_11SmokeParamsE")]
...
// type: int __fastcall(int, Ogre::ParticleSystem *this)
#[doc(alias = "__ZN3RBX18RbxParticleFactory16updateFireSystemEPN4Ogre14ParticleSystemEPNS_10FireParamsE")]
...
#[doc(alias = "__ZN3RBX18RbxParticleManagerC1EPN4Ogre12VisualEngineE")]
...
#[doc(alias = "__ZN3RBX18RbxParticleManager19FirstThrottleSystemEPN4Ogre14ParticleSystemE")]
...
// 0xd45a34 — __ZN4Ogre25ParticleSystemUpdateValueD0Ev
// type: void __fastcall(Ogre::ParticleSystemUpdateValue *__hidden this)
#[doc(alias = "__ZN4Ogre25ParticleSystemUpdateValueD0Ev")]
#[doc(alias = "Ogre::ParticleSystemUpdateValue::~ParticleSystemUpdateValue()")]
pub fn stub_d45a34() -> ! {
    todo!("0xd45a34 Ogre::ParticleSystemUpdateValue::~ParticleSystemUpdateValue()")
}

// 0xd45ac0 — __ZNK4Ogre25ParticleSystemUpdateValue8getValueEv
// type: _DWORD __fastcall(Ogre::ParticleSystemUpdateValue *__hidden this)
#[doc(alias = "__ZNK4Ogre25ParticleSystemUpdateValue8getValueEv")]
#[doc(alias = "Ogre::ParticleSystemUpdateValue::getValue(void)const")]
pub fn stub_d45ac0() -> ! {
    todo!("0xd45ac0 Ogre::ParticleSystemUpdateValue::getValue(void)const")
}

// 0xd45ac4 — __ZN4Ogre25ParticleSystemUpdateValue8setValueEf
// type: _DWORD __fastcall(Ogre::ParticleSystemUpdateValue *__hidden this, float)
#[doc(alias = "__ZN4Ogre25ParticleSystemUpdateValue8setValueEf")]
#[doc(alias = "Ogre::ParticleSystemUpdateValue::setValue(float)")]
pub fn stub_d45ac4() -> ! {
    todo!("0xd45ac4 Ogre::ParticleSystemUpdateValue::setValue(float)")
}

// 0xd45cb0 — __ZN4Ogre21ParticleSystemManager12getSingletonEv
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager12getSingletonEv")]
#[doc(alias = "Ogre::ParticleSystemManager::getSingleton(void)")]
pub fn stub_d45cb0() -> ! {
    todo!("0xd45cb0 Ogre::ParticleSystemManager::getSingleton(void)")
}

// 0xd45cc0 — __ZN4Ogre21ParticleSystemManagerC1Ev
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManagerC1Ev")]
#[doc(alias = "Ogre::ParticleSystemManager::ParticleSystemManager(void)")]
pub fn stub_d45cc0() -> ! {
    todo!("0xd45cc0 Ogre::ParticleSystemManager::ParticleSystemManager(void)")
}

// 0xd45ccc — __ZN4Ogre21ParticleSystemManagerC2Ev
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManagerC2Ev")]
#[doc(alias = "Ogre::ParticleSystemManager::ParticleSystemManager(void)")]
pub fn stub_d45ccc() -> ! {
    todo!("0xd45ccc Ogre::ParticleSystemManager::ParticleSystemManager(void)")
}

// 0xd45f54 — __ZN4Ogre21ParticleSystemManagerD0Ev
// type: void __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManagerD0Ev")]
#[doc(alias = "Ogre::ParticleSystemManager::~ParticleSystemManager()")]
pub fn stub_d45f54() -> ! {
    todo!("0xd45f54 Ogre::ParticleSystemManager::~ParticleSystemManager()")
}

// 0xd45fe4 — __ZN4Ogre21ParticleSystemManagerD1Ev
// type: void __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManagerD1Ev")]
#[doc(alias = "Ogre::ParticleSystemManager::~ParticleSystemManager()")]
pub fn stub_d45fe4() -> ! {
    todo!("0xd45fe4 Ogre::ParticleSystemManager::~ParticleSystemManager()")
}

// 0xd45ff0 — __ZN4Ogre21ParticleSystemManagerD2Ev
// type: void __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManagerD2Ev")]
#[doc(alias = "Ogre::ParticleSystemManager::~ParticleSystemManager()")]
pub fn stub_d45ff0() -> ! {
    todo!("0xd45ff0 Ogre::ParticleSystemManager::~ParticleSystemManager()")
}

// 0xd462e8 — __ZNK4Ogre21ParticleSystemManager15getLoadingOrderEv
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZNK4Ogre21ParticleSystemManager15getLoadingOrderEv")]
#[doc(alias = "Ogre::ParticleSystemManager::getLoadingOrder(void)const")]
pub fn stub_d462e8() -> ! {
    todo!("0xd462e8 Ogre::ParticleSystemManager::getLoadingOrder(void)const")
}

// 0xd46308 — __ZN4Ogre21ParticleSystemManager17addEmitterFactoryEPNS_22ParticleEmitterFactoryE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, Ogre::ParticleEmitterFactory *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager17addEmitterFactoryEPNS_22ParticleEmitterFactoryE")]
#[doc(alias = "Ogre::ParticleSystemManager::addEmitterFactory(Ogre::ParticleEmitterFactory *)")]
pub fn stub_d46308() -> ! {
    todo!("0xd46308 Ogre::ParticleSystemManager::addEmitterFactory(Ogre::ParticleEmitterFactory *)")
}

// 0xd46618 — __ZN4Ogre21ParticleSystemManager18addAffectorFactoryEPNS_23ParticleAffectorFactoryE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, Ogre::ParticleAffectorFactory *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager18addAffectorFactoryEPNS_23ParticleAffectorFactoryE")]
#[doc(alias = "Ogre::ParticleSystemManager::addAffectorFactory(Ogre::ParticleAffectorFactory *)")]
pub fn stub_d46618() -> ! {
    todo!("0xd46618 Ogre::ParticleSystemManager::addAffectorFactory(Ogre::ParticleAffectorFactory *)")
}

// 0xd46928 — __ZN4Ogre21ParticleSystemManager18addRendererFactoryEPNS_29ParticleSystemRendererFactoryE
#[doc(alias = "__ZN4Ogre21ParticleSystemManager18addRendererFactoryEPNS_29ParticleSystemRendererFactoryE")]
#[doc(alias = "Ogre::ParticleSystemManager::addRendererFactory(Ogre::ParticleSystemRendererFactory *)")]
pub fn stub_d46928() -> ! {
    todo!("0xd46928 Ogre::ParticleSystemManager::addRendererFactory(Ogre::ParticleSystemRendererFactory *)")
}

// 0xd46c40 — __ZN4Ogre21ParticleSystemManager11addTemplateERKSsPNS_14ParticleSystemE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *, Ogre::ParticleSystem *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager11addTemplateERKSsPNS_14ParticleSystemE")]
#[doc(alias = "Ogre::ParticleSystemManager::addTemplate(std::string const&,Ogre::ParticleSystem *)")]
pub fn stub_d46c40() -> ! {
    todo!("0xd46c40 Ogre::ParticleSystemManager::addTemplate(std::string const&,Ogre::ParticleSystem *)")
}

// 0xd46f30 — __ZN4Ogre21ParticleSystemManager14createTemplateERKSsS2_
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *, const std::string *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager14createTemplateERKSsS2_")]
#[doc(alias = "Ogre::ParticleSystemManager::createTemplate(std::string const&,std::string const&)")]
pub fn stub_d46f30() -> ! {
    todo!("0xd46f30 Ogre::ParticleSystemManager::createTemplate(std::string const&,std::string const&)")
}

// 0xd47294 — __ZN4Ogre21ParticleSystemManager11getTemplateERKSs
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager11getTemplateERKSs")]
#[doc(alias = "Ogre::ParticleSystemManager::getTemplate(std::string const&)")]
pub fn stub_d47294() -> ! {
    todo!("0xd47294 Ogre::ParticleSystemManager::getTemplate(std::string const&)")
}

// 0xd472b0 — __ZN4Ogre21ParticleSystemManager16createSystemImplERKSsS2_
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *, const std::string *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager16createSystemImplERKSsS2_")]
#[doc(alias = "Ogre::ParticleSystemManager::createSystemImpl(std::string const&,std::string const&)")]
pub fn stub_d472b0() -> ! {
    todo!("0xd472b0 Ogre::ParticleSystemManager::createSystemImpl(std::string const&,std::string const&)")
}

// 0xd47648 — __ZN4Ogre21ParticleSystemManager14_createEmitterERKSsPNS_14ParticleSystemE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *, Ogre::ParticleSystem *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager14_createEmitterERKSsPNS_14ParticleSystemE")]
#[doc(alias = "Ogre::ParticleSystemManager::_createEmitter(std::string const&,Ogre::ParticleSystem *)")]
pub fn stub_d47648() -> ! {
    todo!("0xd47648 Ogre::ParticleSystemManager::_createEmitter(std::string const&,Ogre::ParticleSystem *)")
}

// 0xd4783c — __ZN4Ogre21ParticleSystemManager15_destroyEmitterEPNS_15ParticleEmitterE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, Ogre::ParticleEmitter *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager15_destroyEmitterEPNS_15ParticleEmitterE")]
#[doc(alias = "Ogre::ParticleSystemManager::_destroyEmitter(Ogre::ParticleEmitter *)")]
pub fn stub_d4783c() -> ! {
    todo!("0xd4783c Ogre::ParticleSystemManager::_destroyEmitter(Ogre::ParticleEmitter *)")
}

// 0xd47a30 — __ZN4Ogre21ParticleSystemManager15_createAffectorERKSsPNS_14ParticleSystemE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *, Ogre::ParticleSystem *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager15_createAffectorERKSsPNS_14ParticleSystemE")]
#[doc(alias = "Ogre::ParticleSystemManager::_createAffector(std::string const&,Ogre::ParticleSystem *)")]
pub fn stub_d47a30() -> ! {
    todo!("0xd47a30 Ogre::ParticleSystemManager::_createAffector(std::string const&,Ogre::ParticleSystem *)")
}

// 0xd47c24 — __ZN4Ogre21ParticleSystemManager16_destroyAffectorEPNS_16ParticleAffectorE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, Ogre::ParticleAffector *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager16_destroyAffectorEPNS_16ParticleAffectorE")]
#[doc(alias = "Ogre::ParticleSystemManager::_destroyAffector(Ogre::ParticleAffector *)")]
pub fn stub_d47c24() -> ! {
    todo!("0xd47c24 Ogre::ParticleSystemManager::_destroyAffector(Ogre::ParticleAffector *)")
}

// 0xd47e18 — __ZN4Ogre21ParticleSystemManager15_createRendererERKSs
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, const std::string *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager15_createRendererERKSs")]
#[doc(alias = "Ogre::ParticleSystemManager::_createRenderer(std::string const&)")]
pub fn stub_d47e18() -> ! {
    todo!("0xd47e18 Ogre::ParticleSystemManager::_createRenderer(std::string const&)")
}

// 0xd4800c — __ZN4Ogre21ParticleSystemManager16_destroyRendererEPNS_22ParticleSystemRendererE
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this, Ogre::ParticleSystemRenderer *)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager16_destroyRendererEPNS_22ParticleSystemRendererE")]
#[doc(alias = "Ogre::ParticleSystemManager::_destroyRenderer(Ogre::ParticleSystemRenderer *)")]
pub fn stub_d4800c() -> ! {
    todo!("0xd4800c Ogre::ParticleSystemManager::_destroyRenderer(Ogre::ParticleSystemRenderer *)")
}

// 0xd48208 — __ZN4Ogre21ParticleSystemManager11_initialiseEv
// type: _DWORD __fastcall(Ogre::ParticleSystemManager *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemManager11_initialiseEv")]
#[doc(alias = "Ogre::ParticleSystemManager::_initialise(void)")]
pub fn stub_d48208() -> ! {
    todo!("0xd48208 Ogre::ParticleSystemManager::_initialise(void)")
}

// 0xd485ec — __ZNK4Ogre21ParticleSystemFactory7getTypeEv
// type: _DWORD __fastcall(Ogre::ParticleSystemFactory *__hidden this)
#[doc(alias = "__ZNK4Ogre21ParticleSystemFactory7getTypeEv")]
#[doc(alias = "Ogre::ParticleSystemFactory::getType(void)const")]
pub fn stub_d485ec() -> ! {
    todo!("0xd485ec Ogre::ParticleSystemFactory::getType(void)const")
}

// 0xd48610 — __ZNSt3mapISsPN4Ogre22ParticleEmitterFactoryESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_
#[doc(alias = "__ZNSt3mapISsPN4Ogre22ParticleEmitterFactoryESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_")]
...
pub fn stub_d48610() -> ! {
    todo!("0xd48610 std::map<std::string,Ogre::ParticleEmitterFactory *,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleEmitterFactory *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::operator[](std::string const&)")
}

// 0xd487cc — __ZNSt3mapISsPN4Ogre23ParticleAffectorFactoryESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_
#[doc(alias = "__ZNSt3mapISsPN4Ogre23ParticleAffectorFactoryESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_")]
...
pub fn stub_d487cc() -> ! {
    todo!("0xd487cc std::map<std::string,Ogre::ParticleAffectorFactory *,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleAffectorFactory *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::operator[](std::string const&)")
}

// 0xd48988 — __ZNSt3mapISsPN4Ogre29ParticleSystemRendererFactoryESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_
// type: int __fastcall(int, const void **)
#[doc(alias = "__ZNSt3mapISsPN4Ogre29ParticleSystemRendererFactoryESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_")]
...
pub fn stub_d48988() -> ! {
    todo!("0xd48988 std::map<std::string,Ogre::ParticleSystemRendererFactory *,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleSystemRendererFactory *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::operator[](std::string const&)")
}

// 0xd48b44 — __ZNSt3mapISsPN4Ogre14ParticleSystemESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_
#[doc(alias = "__ZNSt3mapISsPN4Ogre14ParticleSystemESt4lessISsENS0_12STLAllocatorISt4pairIKSsS2_ENS0_22CategorisedAllocPolicyILNS0_14MemoryCategoryE0EEEEEEixERS7_")]
...
pub fn stub_d48b44() -> ! {
    todo!("0xd48b44 std::map<std::string,Ogre::ParticleSystem *,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleSystem *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::operator[](std::string const&)")
}

// 0xd48d00 — __ZN4Ogre21ParticleSystemFactoryD1Ev
// type: void __fastcall(Ogre::ParticleSystemFactory *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemFactoryD1Ev")]
#[doc(alias = "Ogre::ParticleSystemFactory::~ParticleSystemFactory()")]
pub fn stub_d48d00() -> ! {
    todo!("0xd48d00 Ogre::ParticleSystemFactory::~ParticleSystemFactory()")
}

// 0xd48d04 — __ZN4Ogre21ParticleSystemFactoryD0Ev
// type: void __fastcall(Ogre::ParticleSystemFactory *__hidden this)
#[doc(alias = "__ZN4Ogre21ParticleSystemFactoryD0Ev")]
#[doc(alias = "Ogre::ParticleSystemFactory::~ParticleSystemFactory()")]
pub fn stub_d48d04() -> ! {
    todo!("0xd48d04 Ogre::ParticleSystemFactory::~ParticleSystemFactory()")
}

// 0xd48d90 — __ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre29ParticleSystemRendererFactoryEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE4findERS1_
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre29ParticleSystemRendererFactoryEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE4findERS1_")]
...
pub fn stub_d48d90() -> ! {
    todo!("0xd48d90 std::_Rb_tree<std::string,std::pair<std::string const,Ogre::ParticleSystemRendererFactory *>,std::_Select1st<std::pair<std::string const,Ogre::ParticleSystemRendererFactory *>>,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleSystemRendererFactory *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::find(std::string const&)")
}

// 0xd48e34 — __ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre23ParticleAffectorFactoryEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE4findERS1_
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre23ParticleAffectorFactoryEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE4findERS1_")]
...
pub fn stub_d48e34() -> ! {
    todo!("0xd48e34 std::_Rb_tree<std::string,std::pair<std::string const,Ogre::ParticleAffectorFactory *>,std::_Select1st<std::pair<std::string const,Ogre::ParticleAffectorFactory *>>,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleAffectorFactory *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::find(std::string const&)")
}

// 0xd48ed8 — __ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre22ParticleEmitterFactoryEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE4findERS1_
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre22ParticleEmitterFactoryEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE4findERS1_")]
...
pub fn stub_d48ed8() -> ! {
    todo!("0xd48ed8 std::_Rb_tree<std::string,std::pair<std::string const,Ogre::ParticleEmitterFactory *>,std::_Select1st<std::pair<std::string const,Ogre::ParticleEmitterFactory *>>,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleEmitterFactory *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::find(std::string const&)")
}

// 0xd48f7c — __ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre14ParticleSystemEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE16_M_insert_uniqueESt17_Rb_tree_iteratorIS5_ERKS5_
// type: int __fastcall(int, int, struct _Unwind_Exception *lpuexcpt)
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre14ParticleSystemEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE16_M_insert_uniqueESt17_Rb_tree_iteratorIS5_ERKS5_")]
...
pub fn stub_d48f7c() -> ! {
    todo!("0xd48f7c std::_Rb_tree<std::string,std::pair<std::string const,Ogre::ParticleSystem *>,std::_Select1st<std::pair<std::string const,Ogre::ParticleSystem *>>,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleSystem *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<std::string const,Ogre::ParticleSystem *>>,std::pair<std::string const,Ogre::ParticleSystem *> const&)")
}

// 0xd4915c — __ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre14ParticleSystemEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE9_M_insertEPSt18_Rb_tree_node_baseSH_RKS5_
// type: int __fastcall(int, int, int, int, struct _Unwind_Exception *lpuexcpt, Ogre::NedPoolingImpl *, int, int, void *, int)
#[doc(alias = "__ZNSt8_Rb_treeISsSt4pairIKSsPN4Ogre14ParticleSystemEESt10_Select1stIS5_ESt4lessISsENS2_12STLAllocatorIS5_NS2_22CategorisedAllocPolicyILNS2_14MemoryCategoryE0EEEEEE9_M_insertEPSt18_Rb_tree_node_baseSH_RKS5_")]
...
pub fn stub_d4915c() -> ! {
    todo!("0xd4915c std::_Rb_tree<std::string,std::pair<std::string const,Ogre::ParticleSystem *>,std::_Select1st<std::pair<std::string const,Ogre::ParticleSystem *>>,std::less<std::string>,Ogre::STLAllocator<std::pair<std::string const,Ogre::ParticleSystem *>,Ogre::CategorisedAllocPolicy<(Ogre::MemoryCategory)0>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<std::string const,Ogre::ParticleSystem *> const&)")
}
