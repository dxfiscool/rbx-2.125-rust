...
// Filter: RBX::Instance|RBX::DataModel|RBX::Workspace|RBX::ServiceProvider EA-sorted asc next 100 not yet in datamodel
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: 100 stubs | range 0x457848..0x90746c | primary 10751 total, 277 remaining before batch, 177 after, datamodel distinct 27802->27902
...
pub fn stub_0x458b80() -> ! {
    todo!("0x458b80 RBX::ChangeHistoryService * RBX::ServiceProvider::find<RBX::ChangeHistoryService>(void)const")
}
...
pub fn stub_0x458d68() -> ! {
    todo!("0x458d68 void RBX::ServiceProvider::callDoGetClassIndex<RBX::ChangeHistoryService>(void)")
}
...
pub fn stub_0x458d6c() -> ! {
    todo!("0x458d6c unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::ChangeHistoryService>(void)")
}
...
pub fn stub_0x4594f8() -> ! {
    todo!("0x4594f8 RBX::Visit * RBX::ServiceProvider::find<RBX::Visit>(void)const")
}
...
pub fn stub_0x4598e0() -> ! {
    todo!("0x4598e0 void RBX::ServiceProvider::callDoGetClassIndex<RBX::Visit>(void)")
}
...
pub fn stub_0x4598e4() -> ! {
    todo!("0x4598e4 unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::Visit>(void)")
}
...
pub fn stub_0x559920() -> ! {
    todo!("0x559920 RBX::BodyPosition::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x55a7e8() -> ! {
    todo!("0x55a7e8 RBX::Rocket::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x581d68() -> ! {
    todo!("0x581d68 RBX::InsertService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x648bc0() -> ! {
    todo!("0x648bc0 RBX::Stats::StatsService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x680f9c() -> ! {
    todo!("0x680f9c RBX::Tool::setDesiredState(RBX::Tool::ToolState,RBX::ServiceProvider const*)")
}
...
pub fn stub_0x6bd78c() -> ! {
    todo!("0x6bd78c RBX::VehicleSeat::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x6c40e0() -> ! {
    todo!("0x6c40e0 RBX::VirtualUser::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x6d5f20() -> ! {
    todo!("0x6d5f20 void RBX::ServiceProvider::callDoGetClassIndex<RBX::StarterPackService>(void)")
}
...
pub fn stub_0x715310() -> ! {
    todo!("0x715310 RBX::Reflection::EventDescImpl<0,RBX::ServiceProvider,void ()(void),rbx::signal<void ()(void)>,rbx::signal<void ()(void)> RBX::ServiceProvider::*>::connectGeneric(RBX::Reflection::EventSource *,rbx_core::SharedPtr<RBX::Reflection::GenericSlotWrapper>)const")
}
...
pub fn stub_0x7a0bb8() -> ! {
    todo!("0x7a0bb8 RBX::ChatOutput::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}

// 0x7b9c50 — __ZN3RBX8Humanoid17onServiceProviderEPNS_15ServiceProviderES2_
...
// type: _DWORD __fastcall(RBX::FunctionalTest *__hidden this, RBX::ServiceProvider *, RBX::ServiceProvider *)
#[doc(alias = "RBX::FunctionalTest::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")]
pub fn stub_0x803140() -> ! {
...
pub fn stub_0x8340b8() -> ! {
    todo!("0x8340b8 RBX::TweenService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x8357dc() -> ! {
    todo!("0x8357dc RBX::NotificationBox::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}

// 0x83a7e8 — __ZN3RBX13FriendService17onServiceProviderEPNS_15ServiceProviderES2_
// type: _DWORD __fastcall(RBX::FriendService *__hidden this, RBX::ServiceProvider *, RBX::ServiceProvider *)
#[doc(alias = "RBX::FriendService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")]
pub fn stub_0x83a7e8() -> ! {
...
// type: void __fastcall(RBX::CacheableContentProvider *this, pthread_mutex_t *, struct _Unwind_Exception *)
#[doc(alias = "RBX::CacheableContentProvider::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")]
pub fn stub_0x89832c() -> ! {
...
// type: void __fastcall(RBX::UserInputService *this, struct _Unwind_Exception *, RBX::ServiceProvider *)
#[doc(alias = "RBX::UserInputService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")]
pub fn stub_0x8af9ac() -> ! {
    todo!("0x8af9ac RBX::UserInputService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x8c6288() -> ! {
    todo!("0x8c6288 RBX::UserInputService * RBX::ServiceProvider::create<RBX::UserInputService>(void)const")
}
...
pub fn stub_0x8c64a0() -> ! {
    todo!("0x8c64a0 unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::UserInputService>(void)")
}
...
// type: void __fastcall(int32_t **this, RBX::ServiceProvider *, RBX::ServiceProvider *, int)
#[doc(alias = "RBX::ContextActionService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")]
pub fn stub_0x8e6304() -> ! {
    todo!("0x8e6304 RBX::ContextActionService::onServiceProvider(RBX::ServiceProvider *,RBX::ServiceProvider *)")
}
...
pub fn stub_0x904ce0() -> ! {
    todo!("0x904ce0 RBX::ContentProvider * RBX::ServiceProvider::create<RBX::ContentProvider>(void)const")
}
...
pub fn stub_0x904ea8() -> ! {
    todo!("0x904ea8 RBX::ContentProvider * RBX::ServiceProvider::find<RBX::ContentProvider>(void)const")
}
...
pub fn stub_0x905068() -> ! {
    todo!("0x905068 unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::ContentProvider>(void)")
}
...
pub fn stub_0x907070() -> ! {
    todo!("0x907070 RBX::TimerService * RBX::ServiceProvider::create<RBX::TimerService>(void)const")
}
...
pub fn stub_0x90724c() -> ! {
    todo!("0x90724c RBX::TimerService * RBX::ServiceProvider::find<RBX::TimerService>(void)const")
}
...
pub fn stub_0x907468() -> ! {
    todo!("0x907468 void RBX::ServiceProvider::callDoGetClassIndex<RBX::TimerService>(void)")
}
...
pub fn stub_0x90746c() -> ! {
    todo!("0x90746c unsigned long RBX::ServiceProvider::doGetClassIndex<RBX::TimerService>(void)")
}
