...
pub fn stub_0x4b13b4() -> ! {
    todo!("0x4b13b4 rbx_core::SharedPtr<RBX::CustomEventReceiver>::shared_ptr<RBX::CustomEventReceiver>(rbx_core::WeakPtr<RBX::CustomEventReceiver> const&,boost::detail::sp_nothrow_tag)")
}
...
pub fn stub_0x4b1430() -> ! {
    todo!("0x4b1430 std::list<rbx_core::WeakPtr<RBX::CustomEventReceiver>,std::allocator<rbx_core::WeakPtr<RBX::CustomEventReceiver>>>::list(std::list<rbx_core::WeakPtr<RBX::CustomEventReceiver>,std::allocator<rbx_core::WeakPtr<RBX::CustomEventReceiver>>> const&)")
}
...
pub fn stub_0x4b14f8() -> ! {
    todo!("0x4b14f8 void std::list<rbx_core::WeakPtr<RBX::CustomEventReceiver>,std::allocator<rbx_core::WeakPtr<RBX::CustomEventReceiver>>>::_M_initialize_dispatch<std::_List_const_iterator<rbx_core::WeakPtr<RBX::CustomEventReceiver>>>(std::_List_const_iterator<rbx_core::WeakPtr<RBX::CustomEventReceiver>>,std::_List_const_iterator<rbx_core::WeakPtr<RBX::CustomEventReceiver>>,std::__false_type)")
}
...
pub fn stub_0x4b1a4c() -> ! {
    todo!("0x4b1a4c void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::CustomEvent,RBX::CustomEvent>(rbx_core::SharedPtr<RBX::CustomEvent> const*,RBX::CustomEvent *)const")
}
...
pub fn stub_0x4b3730() -> ! {
    todo!("0x4b3730 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::CustomEventReceiver,RBX::CustomEventReceiver>(rbx_core::SharedPtr<RBX::CustomEventReceiver> const*,RBX::CustomEventReceiver *)const")
}
