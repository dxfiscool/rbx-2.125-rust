...
// 0xb77db8 — __ZN3RBXL8getExtraEPNS_12PartInstanceERKNS_17GeometryGenerator7OptionsE
#[doc(alias = "RBX::getExtra(RBX::PartInstance *,RBX::GeometryGenerator::Options const&)")]
pub fn stub_b77db8() -> ! {
    todo!("0xb77db8 RBX::getExtra(RBX::PartInstance *,RBX::GeometryGenerator::Options const&)")
}
...
#[doc(alias = "RBX::GeometryGenerator::addPartImpl(RBX::PartInstance *,RBX::Decal *,RBX::GeometryGenerator::Options const&,rbx_core::SharedPtr<RBX::FileMeshData> const&)")]
pub fn stub_b7ba5c() -> ! {
    todo!("0xb7ba5c RBX::GeometryGenerator::addPartImpl(RBX::PartInstance *,RBX::Decal *,RBX::GeometryGenerator::Options const&,rbx_core::SharedPtr<RBX::FileMeshData> const&)")
}

// 0xb7c1c8 — __ZN3RBX17GeometryGenerator14fetchResourcesEPNS_12PartInstanceEPKNS_18HumanoidIdentifierEjPNS_11AsyncResultE
#[doc(alias = "RBX::GeometryGenerator::fetchResources(RBX::PartInstance *,RBX::HumanoidIdentifier const*,unsigned int,RBX::AsyncResult *)")]
pub fn stub_b7c1c8() -> ! {
    todo!("0xb7c1c8 RBX::GeometryGenerator::fetchResources(RBX::PartInstance *,RBX::HumanoidIdentifier const*,unsigned int,RBX::AsyncResult *)")
}
...
#[doc(alias = "RBX::GeometryGenerator::addInstance(RBX::PartInstance *,RBX::Decal *,RBX::GeometryGenerator::Options const&,rbx_core::SharedPtr<RBX::FileMeshData> const&)")]
pub fn stub_b7e74c() -> ! {
    todo!("0xb7e74c RBX::GeometryGenerator::addInstance(RBX::PartInstance *,RBX::Decal *,RBX::GeometryGenerator::Options const&,rbx_core::SharedPtr<RBX::FileMeshData> const&)")
}
...
pub fn stub_b8859c() -> ! {
    todo!("0xb8859c RBX::MaterialGenerator::createDefaultMaterial(RBX::PartInstance *,unsigned int,bool)")
}
...
pub fn stub_b890f0() -> ! {
    todo!("0xb890f0 RBX::MaterialGenerator::createMaterialForPart(RBX::PartInstance *,RBX::HumanoidIdentifier const*,unsigned int,RBX::AsyncResult *)")
}
...
pub fn stub_b8ab2c() -> ! {
    todo!("0xb8ab2c RBX::MaterialGenerator::createMaterial(RBX::PartInstance *,RBX::Decal *,RBX::HumanoidIdentifier const*,unsigned int,RBX::AsyncResult *)")
}
...
pub fn stub_bc63e4() -> ! {
    todo!("0xbc63e4 Ogre::RbxSceneManager::createRbxMegaCluster(rbx_core::SharedPtr<RBX::PartInstance> const&)")
}
...
// was: RBX::TextureCompositor::attachInstance(boost::shared_ptr<RBX::TextureCompositor::Job> const&,boost::shared_ptr<RBX::PartInstance> const&)
#[doc(alias = "RBX::TextureCompositor::attachInstance(rbx_core::SharedPtr<RBX::TextureCompositor::Job> const&,rbx_core::SharedPtr<RBX::PartInstance> const&)")]
pub fn stub_bdaf9c() -> ! {
    todo!("0xbdaf9c RBX::TextureCompositor::attachInstance(rbx_core::SharedPtr<RBX::TextureCompositor::Job> const&,rbx_core::SharedPtr<RBX::PartInstance> const&)")
}
...
pub fn stub_be9620() -> ! {
    todo!("0xbe9620 RBX::ViewRbxGfx::getWorkspace(void)")
}
...
// 0xc05ffc — __ZN3RBX17MegaClusterLegacy4bindERKN5boost10shared_ptrINS_12PartInstanceEEE
// was: RBX::MegaClusterLegacy::bind(boost::shared_ptr<RBX::PartInstance> const&)
#[doc(alias = "RBX::MegaClusterLegacy::bind(rbx_core::SharedPtr<RBX::PartInstance> const&)")]
pub fn stub_c05ffc() -> ! {
    todo!("0xc05ffc RBX::MegaClusterLegacy::bind(rbx_core::SharedPtr<RBX::PartInstance> const&)")
}
...
pub fn stub_c0727c() -> ! {
    todo!("0xc0727c RBX::MegaCluster::MegaCluster(Ogre::RbxSceneManager *,rbx_core::SharedPtr<RBX::PartInstance> const&)")
}
...
#[doc(alias = "RBX::MegaCluster::MegaCluster(Ogre::RbxSceneManager *,rbx_core::SharedPtr<RBX::PartInstance> const&)")]
pub fn stub_c07280() -> ! {
    todo!("0xc07280 RBX::MegaCluster::MegaCluster(Ogre::RbxSceneManager *,rbx_core::SharedPtr<RBX::PartInstance> const&)")
}

// 0xc09ab4 — __ZN3RBX17MegaClusterLegacy14bind_templatedINS0_16VoxelGridOverlayEEEvRKN5boost10shared_ptrINS_12PartInstanceEEE
...
pub fn stub_c09ab4() -> ! {
    todo!("0xc09ab4 void RBX::MegaClusterLegacy::bind_templated<RBX::MegaClusterLegacy::VoxelGridOverlay>(rbx_core::SharedPtr<RBX::PartInstance> const&)")
}

// 0xc09c4c — __ZN3RBX17MegaClusterLegacy14bind_templatedINS_19MegaClusterInstanceEEEvRKN5boost10shared_ptrINS_12PartInstanceEEE
...
pub fn stub_c09c4c() -> ! {
    todo!("0xc09c4c void RBX::MegaClusterLegacy::bind_templated<RBX::MegaClusterInstance>(rbx_core::SharedPtr<RBX::PartInstance> const&)")
}
...
// 0xc32a18 — __ZN3RBX11LightObject4bindERKN5boost10shared_ptrINS_12PartInstanceEEERKNS2_INS_5LightEEE
// was: RBX::LightObject::bind(boost::shared_ptr<RBX::PartInstance> const&,boost::shared_ptr<RBX::Light> const&)
#[doc(alias = "RBX::LightObject::bind(rbx_core::SharedPtr<RBX::PartInstance> const&,rbx_core::SharedPtr<RBX::Light> const&)")]
pub fn stub_c32a18() -> ! {
    todo!("0xc32a18 RBX::LightObject::bind(rbx_core::SharedPtr<RBX::PartInstance> const&,rbx_core::SharedPtr<RBX::Light> const&)")
}

// 0xeaf654 — __ZN3RBX9GfxCookie7computeEPNS_12PartInstanceE
#[doc(alias = "RBX::GfxCookie::compute(RBX::PartInstance *)")]
pub fn stub_eaf654() -> ! {
    todo!("0xeaf654 RBX::GfxCookie::compute(RBX::PartInstance *)")
}

// 0xeafb74 — __ZN3RBX10GfxBinding14bindPropertiesERKN5boost10shared_ptrINS_12PartInstanceEEE
// was: RBX::GfxBinding::bindProperties(boost::shared_ptr<RBX::PartInstance> const&)
#[doc(alias = "RBX::GfxBinding::bindProperties(rbx_core::SharedPtr<RBX::PartInstance> const&)")]
pub fn stub_eafb74() -> ! {
    todo!("0xeafb74 RBX::GfxBinding::bindProperties(rbx_core::SharedPtr<RBX::PartInstance> const&)")
}
...
pub fn stub_f2b1d4() -> ! {
    todo!("0xf2b1d4 RBX::Lua::ObjectBridge::registerInstanceClassLibrary(lua_State *)")
}

// 0xf2bb74 — j___ZN5boost14singleton_poolIN3RBX12PartInstance20OnDemandPartInstanceELj200ENS_34default_user_allocator_malloc_freeENS_5mutexELj32ELj0EE8get_poolEv
...
pub fn stub_f2bb74() -> ! {
    todo!("0xf2bb74 boost::singleton_pool<RBX::PartInstance::OnDemandPartInstance,200u,boost::default_user_allocator_malloc_free,boost::mutex,32u,0u>::get_pool(void)")
}
...
pub fn stub_f2d014() -> ! {
    todo!("0xf2d014 std::_Vector_base<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::_Vector_base(unsigned long,std::allocator<boost::weak_ptr<RBX::PartInstance>> const&)")
}
...
pub fn stub_f2d024() -> ! {
    todo!("0xf2d024 std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::vector(std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>> const&)")
}
...
pub fn stub_f2d134() -> ! {
    todo!("0xf2d134 std::map<boost::weak_ptr<RBX::PartInstance>,float,std::less<boost::weak_ptr<RBX::PartInstance>>,std::allocator<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>>::operator[](boost::weak_ptr<RBX::PartInstance> const&)")
}
...
pub fn stub_f2d144() -> ! {
    todo!("0xf2d144 std::_Rb_tree<boost::weak_ptr<RBX::PartInstance>,std::pair<boost::weak_ptr<RBX::PartInstance> const,float>,std::_Select1st<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>,std::less<boost::weak_ptr<RBX::PartInstance>>,std::allocator<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>>::_M_create_node(std::pair<boost::weak_ptr<RBX::PartInstance> const,float> const&)")
}
...
pub fn stub_f2d154() -> ! {
    todo!("0xf2d154 std::_Rb_tree<boost::weak_ptr<RBX::PartInstance>,std::pair<boost::weak_ptr<RBX::PartInstance> const,float>,std::_Select1st<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>,std::less<boost::weak_ptr<RBX::PartInstance>>,std::allocator<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>>::_M_insert_unique(std::pair<boost::weak_ptr<RBX::PartInstance> const,float> const&)")
}
...
pub fn stub_f2d164() -> ! {
    todo!("0xf2d164 std::_Rb_tree<boost::weak_ptr<RBX::PartInstance>,std::pair<boost::weak_ptr<RBX::PartInstance> const,float>,std::_Select1st<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>,std::less<boost::weak_ptr<RBX::PartInstance>>,std::allocator<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>>::_M_insert_unique(std::_Rb_tree_iterator<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>,std::pair<boost::weak_ptr<RBX::PartInstance> const,float> const&)")
}
...
pub fn stub_f2d174() -> ! {
    todo!("0xf2d174 std::_Rb_tree<boost::weak_ptr<RBX::PartInstance>,std::pair<boost::weak_ptr<RBX::PartInstance> const,float>,std::_Select1st<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>,std::less<boost::weak_ptr<RBX::PartInstance>>,std::allocator<std::pair<boost::weak_ptr<RBX::PartInstance> const,float>>>::_M_insert(std::_Rb_tree_node_base *,std::_Rb_tree_node_base *,std::pair<boost::weak_ptr<RBX::PartInstance> const,float> const&)")
}
...
pub fn stub_f2d494() -> ! {
    todo!("0xf2d494 boost::weak_ptr<RBX::PartInstance>* std::__copy<false,std::random_access_iterator_tag>::copy<boost::weak_ptr<RBX::PartInstance> const*,boost::weak_ptr<RBX::PartInstance>*>(boost::weak_ptr<RBX::PartInstance> const*,boost::weak_ptr<RBX::PartInstance> const*,boost::weak_ptr<RBX::PartInstance>*)")
}
...
pub fn stub_f2d4a4() -> ! {
    todo!("0xf2d4a4 boost::weak_ptr<RBX::PartInstance> * std::__copy<false,std::random_access_iterator_tag>::copy<boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *>(boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *,boost::weak_ptr<RBX::PartInstance> *)")
}
...
pub fn stub_f2d4c4() -> ! {
    todo!("0xf2d4c4 boost::weak_ptr<RBX::PartInstance>* std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::_M_allocate_and_copy<__gnu_cxx::__normal_iterator<boost::weak_ptr<RBX::PartInstance> const*,std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>>>(unsigned long,__gnu_cxx::__normal_iterator<boost::weak_ptr<RBX::PartInstance> const*,std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>>,__gnu_cxx::__normal_iterator<boost::weak_ptr<RBX::PartInstance> const*,std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>>)")
}
...
pub fn stub_f2d4d4() -> ! {
    todo!("0xf2d4d4 std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::operator=(std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>> const&)")
}
...
// 0xf31284 — j___ZNSt6vectorIN5boost8weak_ptrIN3RBX12PartInstanceEEESaIS4_EED2Ev
#[doc(alias = "std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::~vector()")]
pub fn stub_f31284() -> ! {
    todo!("0xf31284 std::vector<boost::weak_ptr<RBX::PartInstance>,std::allocator<boost::weak_ptr<RBX::PartInstance>>>::~vector()")
}
...
pub fn stub_f312b4() -> ! {
    todo!("0xf312b4 RBX::Reflection::Type::Type<RBX::PVInstance *>(char const*,char const*,RBX::PVInstance * *)")
}
...
pub fn stub_f312c4() -> ! {
    todo!("0xf312c4 RBX::Reflection::RefType<RBX::PVInstance *>::singleton(void)")
}
...
pub fn stub_f312e4() -> ! {
    todo!("0xf312e4 rbx_core::SharedPtr<RBX::PVInstance> RBX::shared_from<RBX::PVInstance>(RBX::PVInstance*)")
}
