...
// Batch: 120 stubs | range 0x30d740..0x316f2c | datamodel distinct 33699->33819 global uncovered 52647->52527, lowest gap EA-sorted asc next 120 after watchdog_r (0x2ff758..0x30d71c)
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr; ` and ' stripped from alias where needed
// Shard: watchdog_s EA-sorted ascending next uncovered gap after watchdog_r (distinct check via export.json sorted EA, no overlap)
...
// was: RBX::staticDoFilterRequest(boost::weak_ptr<RBX::ContentFilter>,std::string)
pub fn stub_0x30ef44() -> ! {
    todo!("0x30ef44 RBX::staticDoFilterRequest(Weak<RBX::ContentFilter>,std::string)")
}
...
// was: RBX::staticDoFilterResult(std::string *,std::exception *,boost::weak_ptr<RBX::ContentFilter>,std::string)
pub fn stub_0x30f598() -> ! {
    todo!("0x30f598 RBX::staticDoFilterResult(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string)")
}
...
// was: RBX::staticSaveFilterResult(boost::weak_ptr<RBX::ContentFilter>,std::string,bool)
pub fn stub_0x30f8e8() -> ! {
    todo!("0x30f8e8 RBX::staticSaveFilterResult(Weak<RBX::ContentFilter>,std::string,bool)")
}
...
pub fn stub_0x30faec() -> ! {
    todo!("0x30faec boost::_bi::bind_t<void,void (*)(Weak<RBX::ContentFilter>,std::string),boost::_bi::list_av_2<Weak<RBX::ContentFilter>,std::string>::type> boost::bind<void,Weak<RBX::ContentFilter>,std::string,Weak<RBX::ContentFilter>,std::string>(void (*)(Weak<RBX::ContentFilter>,std::string),Weak<RBX::ContentFilter>,std::string)")
}
...
pub fn stub_0x30fdbc() -> ! {
    todo!("0x30fdbc Weak<RBX::ContentFilter> RBX::weak_from<RBX::ContentFilter>(RBX::ContentFilter*)")
}
...
pub fn stub_0x30ffb4() -> ! {
    todo!("0x30ffb4 boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string),boost::_bi::list_av_4<boost::arg<1>,boost::arg<2>,Weak<RBX::ContentFilter>,std::string>::type> boost::bind<void,std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string,boost::arg<1>,boost::arg<2>,Weak<RBX::ContentFilter>,std::string>(void (*)(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string),boost::arg<1>,boost::arg<2>,Weak<RBX::ContentFilter>,std::string)")
}
...
pub fn stub_0x310b80() -> ! {
    todo!("0x310b80 void boost::function2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>>>(boost::_bi::bind_t<void,void (*)(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string),boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>>)")
}
...
pub fn stub_0x311258() -> ! {
    todo!("0x311258 void boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>::operator()<void (*)(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string),boost::_bi::list2<std::string *&,std::exception *&>>(boost::_bi::type<void>,void (*)(std::string *,std::exception *,Weak<RBX::ContentFilter>,std::string) &,boost::_bi::list2<std::string *&,std::exception *&> &,int)")
}
...
pub fn stub_0x3115e8() -> ! {
    todo!("0x3115e8 boost::_bi::list4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>::list4(boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>)")
}
...
pub fn stub_0x311794() -> ! {
    todo!("0x311794 boost::_bi::storage4<boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>::storage4(boost::arg<1>,boost::arg<2>,boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>)")
}
...
pub fn stub_0x3126e4() -> ! {
    todo!("0x3126e4 boost::_bi::list2<boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>::list2(boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>)")
}
...
pub fn stub_0x312890() -> ! {
    todo!("0x312890 boost::_bi::storage2<boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>>::storage2(boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>)")
}
...
pub fn stub_0x312a04() -> ! {
    todo!("0x312a04 Weak<RBX::ContentFilter>::weak_ptr<RBX::ContentFilter>(rbx_core::SharedPtr<RBX::ContentFilter> const&,boost::detail::sp_enable_if_convertible<RBX::ContentFilter,RBX::ContentFilter>::type)")
}
...
pub fn stub_0x313540() -> ! {
    todo!("0x313540 boost::_bi::bind_t<void,void (*)(Weak<RBX::ContentFilter>,std::string,bool),boost::_bi::list_av_3<Weak<RBX::ContentFilter>,std::string,bool>::type> boost::bind<void,Weak<RBX::ContentFilter>,std::string,bool,Weak<RBX::ContentFilter>,std::string,bool>(void (*)(Weak<RBX::ContentFilter>,std::string,bool),Weak<RBX::ContentFilter>,std::string,bool)")
}
...
pub fn stub_0x31381c() -> ! {
    todo!("0x31381c boost::_bi::list3<boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>::list3(boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>)")
}
...
pub fn stub_0x3139cc() -> ! {
    todo!("0x3139cc boost::_bi::storage3<boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>>::storage3(boost::_bi::value<Weak<RBX::ContentFilter>>,boost::_bi::value<std::string>,boost::_bi::value<bool>)")
}
...
pub fn stub_0x314994() -> ! {
    todo!("0x314994 rbx_core::SharedPtr<RBX::ContentFilter>::shared_ptr<RBX::ContentFilter>(Weak<RBX::ContentFilter> const&,boost::detail::sp_nothrow_tag)")
}
...
pub fn stub_0x316184() -> ! {
    todo!("0x316184 rbx_core::SharedPtr<boost::filesystem::detail::dir_itr_imp>::shared_ptr<boost::filesystem::detail::dir_itr_imp>(boost::filesystem::detail::dir_itr_imp *)")
}
