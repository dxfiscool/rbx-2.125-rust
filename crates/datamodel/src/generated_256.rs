...
pub fn stub_0x2379ec() -> ! {
    todo!("0x2379ec void boost::enable_shared_from_this<boost::detail::thread_data_base>::_internal_accept_owner<boost::detail::thread_data_base,boost::detail::thread_data_base>(rbx_core::SharedPtr<boost::detail::thread_data_base> const*,boost::detail::thread_data_base *)const")
}
...
pub fn stub_0x23a11c() -> ! {
    todo!("0x23a11c void boost::detail::sp_pointer_construct<boost::filesystem::filesystem_error::m_imp,boost::filesystem::filesystem_error::m_imp>(rbx_core::SharedPtr<boost::filesystem::filesystem_error::m_imp> *,boost::filesystem::filesystem_error::m_imp *,boost::detail::shared_count &)")
}
...
// was: RbxTotalUsableCoreCount(unsigned int)
...
// was: RBX::runtime_error(char const*,...)
...
// was: RBX::vformat(char const*,void *)
...
// was: ReleaseAssert(int,char const*)
...
// was: RBX::Debugable::doCrash(void)
