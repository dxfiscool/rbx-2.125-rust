...
// Batch: 120 stubs | range 0x47a508..0x47e8e8 | gap filler EA-sorted ascending next 120 after 0x47a504 (shard wd_watchdog)
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr; ` and ' stripped from alias
// Shard: wd_watchdog4 EA-sorted ascending continuation after wd_watchdog (global gap filler)
