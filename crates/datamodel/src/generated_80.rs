...
// Batch: 100 stubs | range 0x61c078..0x652504 | total filtered 10215, remaining 696->596 after batch
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr; ' stripped from alias
// Shard: 80 EA-sorted ascending next uncovered gap from 0x61c078
...
// was: RBX::Reflection::BoundFuncDesc<RBX::Selection,void ()(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>),1>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
pub fn stub_61c35c() -> ! {
...
// was: RBX::Reflection::BoundFuncDesc<RBX::Selection,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const> ()(void),0>::execute(RBX::Reflection::DescribedBase *,RBX::Reflection::FunctionDescriptor::Arguments &)const
pub fn stub_61c6e0() -> ! {
...
pub fn stub_61c7ec() -> ! {
    todo!("0x61c7ec RBX::SelectionChanged::SelectionChanged(rbx_core::SharedPtr<RBX::Instance>,rbx_core::SharedPtr<RBX::Instance>)")
}
...
pub fn stub_61ca44() -> ! {
    todo!("0x61ca44 void RBX::Selection::setSelection<__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Instance> const*,std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>>(__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Instance> const*,std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>,__gnu_cxx::__normal_iterator<rbx_core::SharedPtr<RBX::Instance> const*,std::vector<rbx_core::SharedPtr<RBX::Instance>,std::allocator<rbx_core::SharedPtr<RBX::Instance>>>>)")
}
...
pub fn stub_61d2a4() -> ! {
    todo!("0x61d2a4 RBX::SelectionBox::askSetParent(RBX::Instance const*)const")
}
...
pub fn stub_61da7c() -> ! {
    todo!("0x61da7c rbx_core::SharedPtr<RBX::SelectionBox> RBX::Creatable<RBX::Instance>::create<RBX::SelectionBox>(void)")
}
...
pub fn stub_61db2c() -> ! {
    todo!("0x61db2c rbx_core::SharedPtr<RBX::SelectionBox>::shared_ptr<RBX::SelectionBox,RBX::Creatable<RBX::Instance>::Deleter>(RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_61dcdc() -> ! {
    todo!("0x61dcdc boost::detail::shared_count::shared_count<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_61dde4() -> ! {
    todo!("0x61dde4 boost::detail::sp_counted_impl_pd<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x61dde8 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX12SelectionBoxENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_61dde8() -> ! {
    todo!("0x61dde8 boost::detail::sp_counted_impl_pd<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_61ddec() -> ! {
    todo!("0x61ddec boost::detail::sp_counted_impl_pd<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_61de0c() -> ! {
    todo!("0x61de0c boost::detail::sp_counted_impl_pd<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_61de24() -> ! {
    todo!("0x61de24 boost::detail::sp_counted_impl_pd<RBX::SelectionBox *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_621014() -> ! {
    todo!("0x621014 rbx_core::SharedPtr<RBX::SelectionPointLasso> RBX::Creatable<RBX::Instance>::create<RBX::SelectionPointLasso>(void)")
}
...
pub fn stub_6210c4() -> ! {
    todo!("0x6210c4 rbx_core::SharedPtr<RBX::SelectionPointLasso>::shared_ptr<RBX::SelectionPointLasso,RBX::Creatable<RBX::Instance>::Deleter>(RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_621274() -> ! {
    todo!("0x621274 boost::detail::shared_count::shared_count<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_62137c() -> ! {
    todo!("0x62137c boost::detail::sp_counted_impl_pd<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x621380 — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX19SelectionPointLassoENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_621380() -> ! {
    todo!("0x621380 boost::detail::sp_counted_impl_pd<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_621384() -> ! {
    todo!("0x621384 boost::detail::sp_counted_impl_pd<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_6213a4() -> ! {
    todo!("0x6213a4 boost::detail::sp_counted_impl_pd<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_6213bc() -> ! {
    todo!("0x6213bc boost::detail::sp_counted_impl_pd<RBX::SelectionPointLasso *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_62186c() -> ! {
    todo!("0x62186c rbx_core::SharedPtr<RBX::SelectionPartLasso> RBX::Creatable<RBX::Instance>::create<RBX::SelectionPartLasso>(void)")
}
...
pub fn stub_62191c() -> ! {
    todo!("0x62191c rbx_core::SharedPtr<RBX::SelectionPartLasso>::shared_ptr<RBX::SelectionPartLasso,RBX::Creatable<RBX::Instance>::Deleter>(RBX::SelectionPartLasso *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_62d050() -> ! {
    todo!("0x62d050 void boost::function1<void,RBX::DataModel *>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ModelInstance>,rbx_core::Weak<RBX::ModelInstance>),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::ModelInstance>>,boost::_bi::value<rbx_core::Weak<RBX::ModelInstance>>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::ModelInstance>,rbx_core::Weak<RBX::ModelInstance>),boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::ModelInstance>>,boost::_bi::value<rbx_core::Weak<RBX::ModelInstance>>>>)")
}
...
pub fn stub_62d7f4() -> ! {
    todo!("0x62d7f4 void boost::_bi::list2<boost::_bi::value<rbx_core::Weak<RBX::ModelInstance>>,boost::_bi::value<rbx_core::Weak<RBX::ModelInstance>>>::operator()<void (*)(rbx_core::Weak<RBX::ModelInstance>,rbx_core::Weak<RBX::ModelInstance>),boost::_bi::list1<RBX::DataModel *&>>(boost::_bi::type<void>,void (*)(rbx_core::Weak<RBX::ModelInstance>,rbx_core::Weak<RBX::ModelInstance>) &,boost::_bi::list1<RBX::DataModel *&> &,int)")
}
...
pub fn stub_63e090() -> ! {
    todo!("0x63e090 RBX::SpawnerService::SpawnPlayer(RBX::Workspace *,rbx_core::SharedPtr<RBX::ModelInstance>,G3D::Vector3,int)")
}

// 0x6482a0 — __ZN3RBX5StatsL14onGatherScriptEN5boost8weak_ptrINS_9DataModelEEEPSsPSt9exception
#[doc(alias = "RBX::Stats::onGatherScript(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *)")]
// was: RBX::Stats::onGatherScript(boost::weak_ptr<RBX::DataModel>,std::string *,std::exception *)
pub fn stub_6482a0() -> ! {
    todo!("0x6482a0 RBX::Stats::onGatherScript(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *)")
}
...
pub fn stub_649cf4() -> ! {
    todo!("0x649cf4 RBX::Stats::runScript(rbx_core::SharedPtr<RBX::DataModel>,std::string)")
}
...
pub fn stub_64af70() -> ! {
    todo!("0x64af70 boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),boost::_bi::list_av_3<rbx_core::Weak<RBX::DataModel>,boost::arg<1>,boost::arg<2>>::type> boost::bind<void,rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *,rbx_core::Weak<RBX::DataModel>,boost::arg<1>,boost::arg<2>>(void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),rbx_core::Weak<RBX::DataModel>,boost::arg<1>,boost::arg<2>)")
}
...
pub fn stub_64b558() -> ! {
    todo!("0x64b558 rbx_core::SharedPtr<RunningAverageItemDouble> RBX::Creatable<RBX::Instance>::create<RunningAverageItemDouble,RBX::RunningAverage<double,double> const*>(RBX::RunningAverage<double,double> const*)")
}
...
pub fn stub_64b6ec() -> ! {
    todo!("0x64b6ec rbx_core::SharedPtr<ProfilingItem> RBX::Creatable<RBX::Instance>::create<ProfilingItem,RBX::Profiling::Profiler const*>(RBX::Profiling::Profiler const*)")
}
...
pub fn stub_64b878() -> ! {
    todo!("0x64b878 rbx_core::SharedPtr<RBX::Stats::TypedMemItem> RBX::Creatable<RBX::Instance>::create<RBX::Stats::TypedMemItem,unsigned long const*>(unsigned long const*)")
}
...
pub fn stub_64b98c() -> ! {
    todo!("0x64b98c rbx_core::SharedPtr<RBX::Stats::TypedPercentItem> RBX::Creatable<RBX::Instance>::create<RBX::Stats::TypedPercentItem,float const*>(float const*)")
}
...
pub fn stub_64d058() -> ! {
    todo!("0x64d058 rbx_core::SharedPtr<RBX::Stats::TypedPercentItem>::shared_ptr<RBX::Stats::TypedPercentItem,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Stats::TypedPercentItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_64e4b8() -> ! {
    todo!("0x64e4b8 rbx_core::SharedPtr<RBX::Stats::TypedMemItem>::shared_ptr<RBX::Stats::TypedMemItem,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Stats::TypedMemItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_64e668() -> ! {
    todo!("0x64e668 boost::detail::shared_count::shared_count<RBX::Stats::TypedMemItem *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Stats::TypedMemItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_64e778() -> ! {
    todo!("0x64e778 boost::detail::sp_counted_impl_pd<RBX::Stats::TypedMemItem *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_64e798() -> ! {
    todo!("0x64e798 boost::detail::sp_counted_impl_pd<RBX::Stats::TypedMemItem *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_64e7b0() -> ! {
    todo!("0x64e7b0 boost::detail::sp_counted_impl_pd<RBX::Stats::TypedMemItem *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_64f178() -> ! {
    todo!("0x64f178 rbx_core::SharedPtr<ProfilingItem>::shared_ptr<ProfilingItem,RBX::Creatable<RBX::Instance>::Deleter>(ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_64f328() -> ! {
    todo!("0x64f328 boost::detail::shared_count::shared_count<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>(ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_64f430() -> ! {
    todo!("0x64f430 boost::detail::sp_counted_impl_pd<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x64f434 — __ZN5boost6detail18sp_counted_impl_pdIP13ProfilingItemN3RBX9CreatableINS4_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_64f434() -> ! {
    todo!("0x64f434 boost::detail::sp_counted_impl_pd<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_64f438() -> ! {
    todo!("0x64f438 boost::detail::sp_counted_impl_pd<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_64f458() -> ! {
    todo!("0x64f458 boost::detail::sp_counted_impl_pd<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_64f470() -> ! {
    todo!("0x64f470 boost::detail::sp_counted_impl_pd<ProfilingItem *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_64fd70() -> ! {
    todo!("0x64fd70 rbx_core::SharedPtr<RunningAverageItemDouble>::shared_ptr<RunningAverageItemDouble,RBX::Creatable<RBX::Instance>::Deleter>(RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_64ff20() -> ! {
    todo!("0x64ff20 boost::detail::shared_count::shared_count<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>(RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_650028() -> ! {
    todo!("0x650028 boost::detail::sp_counted_impl_pd<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x65002c — __ZN5boost6detail18sp_counted_impl_pdIP24RunningAverageItemDoubleN3RBX9CreatableINS4_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_65002c() -> ! {
    todo!("0x65002c boost::detail::sp_counted_impl_pd<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_650030() -> ! {
    todo!("0x650030 boost::detail::sp_counted_impl_pd<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_650050() -> ! {
    todo!("0x650050 boost::detail::sp_counted_impl_pd<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_650068() -> ! {
    todo!("0x650068 boost::detail::sp_counted_impl_pd<RunningAverageItemDouble *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_650968() -> ! {
    todo!("0x650968 rbx_core::SharedPtr<RunningAverageItemInt>::shared_ptr<RunningAverageItemInt,RBX::Creatable<RBX::Instance>::Deleter>(RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_650b18() -> ! {
    todo!("0x650b18 boost::detail::shared_count::shared_count<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>(RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_650c20() -> ! {
    todo!("0x650c20 boost::detail::sp_counted_impl_pd<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x650c24 — __ZN5boost6detail18sp_counted_impl_pdIP21RunningAverageItemIntN3RBX9CreatableINS4_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_650c24() -> ! {
    todo!("0x650c24 boost::detail::sp_counted_impl_pd<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_650c28() -> ! {
    todo!("0x650c28 boost::detail::sp_counted_impl_pd<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_650c48() -> ! {
    todo!("0x650c48 boost::detail::sp_counted_impl_pd<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_650c60() -> ! {
    todo!("0x650c60 boost::detail::sp_counted_impl_pd<RunningAverageItemInt *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_651574() -> ! {
    todo!("0x651574 rbx_core::SharedPtr<TotalCountTimeIntervalItem>::shared_ptr<TotalCountTimeIntervalItem,RBX::Creatable<RBX::Instance>::Deleter>(TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_651724() -> ! {
    todo!("0x651724 boost::detail::shared_count::shared_count<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>(TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_65182c() -> ! {
    todo!("0x65182c boost::detail::sp_counted_impl_pd<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
#[doc(alias = "boost::detail::sp_counted_impl_pd<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_651830() -> ! {
    todo!("0x651830 boost::detail::sp_counted_impl_pd<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_651834() -> ! {
    todo!("0x651834 boost::detail::sp_counted_impl_pd<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_651854() -> ! {
    todo!("0x651854 boost::detail::sp_counted_impl_pd<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_65186c() -> ! {
    todo!("0x65186c boost::detail::sp_counted_impl_pd<TotalCountTimeIntervalItem *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_651870() -> ! {
    todo!("0x651870 rbx_core::SharedPtr<RBX::Stats::Item>::shared_ptr<RBX::Stats::Item,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_651a20() -> ! {
    todo!("0x651a20 boost::detail::shared_count::shared_count<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>(RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter)")
}
...
pub fn stub_651b28() -> ! {
    todo!("0x651b28 boost::detail::sp_counted_impl_pd<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}

// 0x651b2c — __ZN5boost6detail18sp_counted_impl_pdIPN3RBX5Stats4ItemENS2_9CreatableINS2_8InstanceEE7DeleterEED0Ev
#[doc(alias = "boost::detail::sp_counted_impl_pd<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")]
pub fn stub_651b2c() -> ! {
    todo!("0x651b2c boost::detail::sp_counted_impl_pd<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>::~sp_counted_impl_pd()")
}
...
pub fn stub_651b30() -> ! {
    todo!("0x651b30 boost::detail::sp_counted_impl_pd<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>::dispose(void)")
}
...
pub fn stub_651b50() -> ! {
    todo!("0x651b50 boost::detail::sp_counted_impl_pd<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>::get_deleter(std::type_info const&)")
}
...
pub fn stub_651b68() -> ! {
    todo!("0x651b68 boost::detail::sp_counted_impl_pd<RBX::Stats::Item *,RBX::Creatable<RBX::Instance>::Deleter>::get_untyped_deleter(void)")
}
...
pub fn stub_6520f0() -> ! {
    todo!("0x6520f0 void boost::function2<void,std::string *,std::exception *>::assign_to<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),boost::_bi::list3<boost::_bi::value<rbx_core::Weak<RBX::DataModel>>,boost::arg<1>,boost::arg<2>>>>(boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),boost::_bi::list3<boost::_bi::value<rbx_core::Weak<RBX::DataModel>>,boost::arg<1>,boost::arg<2>>>)")
}
...
#[doc(alias = "boost::detail::function::functor_manager<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),boost::_bi::list3<boost::_bi::value<rbx_core::Weak<RBX::DataModel>>,boost::arg<1>,boost::arg<2>>>>::manage(boost::detail::function::function_buffer const&,boost::detail::function::function_buffer&,boost::detail::function::functor_manager_operation_type)")]
...
#[doc(alias = "boost::detail::function::void_function_obj_invoker2<boost::_bi::bind_t<void,void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),boost::_bi::list3<boost::_bi::value<rbx_core::Weak<RBX::DataModel>>,boost::arg<1>,boost::arg<2>>>,void,std::string *,std::exception *>::invoke(boost::detail::function::function_buffer &,std::string *,std::exception *)")]
...
pub fn stub_652504() -> ! {
    todo!("0x652504 void boost::_bi::list3<boost::_bi::value<rbx_core::Weak<RBX::DataModel>>,boost::arg<1>,boost::arg<2>>::operator()<void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *),boost::_bi::list2<std::string *&,std::exception *&>>(boost::_bi::type<void>,void (*)(rbx_core::Weak<RBX::DataModel>,std::string *,std::exception *) &,boost::_bi::list2<std::string *&,std::exception *&> &,int)")
}
