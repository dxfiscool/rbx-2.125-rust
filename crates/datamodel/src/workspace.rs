...
// 76 stubs in this file | batch range 0x380a4..0x6cc198 (1 existing + 75 new slice C)
...
#[doc(alias = "RBX::Workspace::makeJoints(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>)")]
...
#[doc(alias = "RBX::Workspace::breakJoints(boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>)")]
...
#[doc(alias = "RBX::Workspace::findPartsInRegion3(RBX::Region3,boost::shared_ptr<RBX::Instance>,int)")]
...
#[doc(alias = "RBX::Workspace::isRegion3Empty(RBX::Region3,boost::shared_ptr<RBX::Instance>)")]
...
#[doc(alias = "RBX::Workspace::findPartsInRegion3(RBX::Region3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>,int)")]
...
#[doc(alias = "RBX::Workspace::isRegion3Empty(RBX::Region3,boost::shared_ptr<std::vector<boost::shared_ptr<RBX::Instance>,std::allocator<boost::shared_ptr<RBX::Instance>>> const>)")]
