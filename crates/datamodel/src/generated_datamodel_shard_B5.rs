...
// Filter: RBX:: Instance subclasses (remaining not in shard A), EA-sorted asc next 100 uncovered not yet in crates/datamodel/src (distinct EA, gap filler)
...
#[doc(alias = "boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus),boost::_bi::list_av_3<Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>>::type> boost::bind<void,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>>(void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus),Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>)")]
...
pub fn stub_0x52cfc0() -> ! {
    todo!("0x52cfc0 boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus),boost::_bi::list_av_3<Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>>::type> boost::bind<void,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>>(void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,RBX::GuiObject::TweenStatus),Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,boost::arg<1>)")
}
...
// type: int __fastcall(int, int, int, int, int, int, int, int, int, int, boost::detail::sp_counted_base *, char, boost::detail::sp_counted_base *, int, int, int, int, int, int, int, int, int, int, int, int, int)
#[doc(alias = "boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list_av_2<Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef>::type> boost::bind<void,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef>(void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef)")]
...
pub fn stub_0x52d230() -> ! {
    todo!("0x52d230 boost::_bi::bind_t<void,void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),boost::_bi::list_av_2<Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef>::type> boost::bind<void,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef,Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef>(void (*)(Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef),Weak<RBX::GuiObject>,RBX::Lua::WeakFunctionRef)")
}
