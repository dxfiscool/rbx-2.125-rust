...
// Batch: 100 stubs | range 0x17f80..0x6e778 | total filtered 13497, workspace 80789->80889 covered (rbx_core::SharedPtr not boost)
// Shard: 154 EA-sorted asc global filler (next 100 uncovered)
...
// type: int __fastcall(int, int, int, int, int, int, struct _Unwind_Exception *lpuexcpt, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, int, boost::detail::sp_counted_base *, ch
