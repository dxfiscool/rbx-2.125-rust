//! datamodel -- generated_watchdog_datamodel_w15d3 -- 120 stubs (watchdog w15d3 Instance)
//! Source: ida/export.json (85545 funcs) global-dedup vs /tmp/global_eas.txt; EA-sorted asc first 120 uncovered
//! Filter: mangled contains Instance/DataModel/Workspace -> strict RBX::Instance 8021 total, 0 uncovered vs global (97448 EAs) and 0 vs datamodel (49585 EAs) -> fallback to next 120 not yet in datamodel asc
//! Range: 0x5a1bb8..0x5a7dac | total filtered strict 0, remaining 0 after batch; fallback 120
...
// 0x5a3220 -- __ZN3RBX10Reflection14PropDescriptorINS_4GlueEN3G3D7Vector3EED1Ev
 // RBX::Reflection::PropDescriptor<RBX::Glue,G3D::Vector3>::~PropDescriptor()
 // type: 
...
// 0x5a3c58 -- __ZThn92_NK3RBX10ManualWeld19shouldRender3dAdornEv
 // `non-virtual thunk to'RBX::ManualWeld::shouldRender3dAdorn(void)const
 // type: _DWORD __fastcall(RBX::ManualWeld *__hidden this)
...
// 0x5a3d10 -- __ZNK3RBX10ManualGlue19shouldRender3dAdornEv
 // RBX::ManualGlue::shouldRender3dAdorn(void)const
...
// 0x5a3d14 -- __ZThn32_N3RBX10ManualGlueD1Ev
 // `non-virtual thunk to'RBX::ManualGlue::~ManualGlue()
 // type: void __fastcall(RBX::ManualGlue *__hidden this)
...
// 0x5a3e7c -- __ZThn92_NK3RBX10ManualGlue19shouldRender3dAdornEv
 // `non-virtual thunk to'RBX::ManualGlue::shouldRender3dAdorn(void)const
 // type: _DWORD __fastcall(RBX::ManualGlue *__hidden this)
...
// 0x5a3f34 -- __ZThn32_N3RBX7Motor6DD1Ev
 // `non-virtual thunk to'RBX::Motor6D::~Motor6D()
 // type: void __fastcall(RBX::Motor6D *__hidden this)
...
// 0x5a4168 -- __ZThn32_N3RBX4SnapD1Ev
 // `non-virtual thunk to'RBX::Snap::~Snap()
 // type: void __fastcall(RBX::Snap *__hidden this)
...
pub fn stub_0x5a4224() -> ! {
    todo!("0x5a4224 `non-virtual thunk to'RBX::Snap::~Snap()")
}
...
pub fn stub_0x5a422c() -> ! {
    todo!("0x5a422c `non-virtual thunk to'RBX::Snap::~Snap()")
}
...
// 0x5a4384 -- __ZThn32_N3RBX4GlueD1Ev
 // `non-virtual thunk to'RBX::Glue::~Glue()
 // type: void __fastcall(RBX::Glue *__hidden this)
...
// 0x5a45a0 -- __ZThn32_N3RBX6RotateD1Ev
 // `non-virtual thunk to'RBX::Rotate::~Rotate()
 // type: void __fastcall(RBX::Rotate *__hidden this)
...
// 0x5a4708 -- __ZN3RBX13DynamicRotateD1Ev
 // RBX::DynamicRotate::~DynamicRotate()
...
// 0x5a47d4 -- __ZThn32_N3RBX13DynamicRotateD1Ev
 // `non-virtual thunk to'RBX::DynamicRotate::~DynamicRotate()
 // type: void __fastcall(RBX::DynamicRotate *__hidden this)
...
// 0x5a4a08 -- __ZThn32_N3RBX7RotatePD1Ev
 // `non-virtual thunk to'RBX::RotateP::~RotateP()
 // type: void __fastcall(RBX::RotateP *__hidden this)
...
// 0x5a4c24 -- __ZThn32_N3RBX7RotateVD1Ev
 // `non-virtual thunk to'RBX::RotateV::~RotateV()
 // type: void __fastcall(RBX::RotateV *__hidden this)
...
// 0x5a4e74 -- __ZN3RBX4Name13callDoDeclareILZNS_14sDynamicRotateEEEEvv
 // __ZN3RBX4Name13callDoDeclareILZNS_14sDynamicRotateEEEEvv
 // type: 
...
// 0x5a4e78 -- __ZN3RBX4Name9doDeclareILZNS_14sDynamicRotateEEEERKS0_v
 // __ZN3RBX4Name9doDeclareILZNS_14sDynamicRotateEEEERKS0_v
 // type: 
...
// 0x5a531c -- __ZN3RBX4Name13callDoDeclareILZNS_8sMotor6DEEEEvv
 // __ZN3RBX4Name13callDoDeclareILZNS_8sMotor6DEEEEvv
 // type: 
...
// 0x5a5320 -- __ZN3RBX4Name9doDeclareILZNS_8sMotor6DEEEERKS0_v
 // __ZN3RBX4Name9doDeclareILZNS_8sMotor6DEEEERKS0_v
 // type: 
...
// 0x5a5ccc -- __ZN3RBX4Name13callDoDeclareILZNS_11sManualGlueEEEEvv
 // __ZN3RBX4Name13callDoDeclareILZNS_11sManualGlueEEEEvv
 // type: 
...
// 0x5a5cd0 -- __ZN3RBX4Name9doDeclareILZNS_11sManualGlueEEEERKS0_v
 // __ZN3RBX4Name9doDeclareILZNS_11sManualGlueEEEERKS0_v
 // type: 
...
// 0x5a667c -- __ZN3RBX4Name13callDoDeclareILZNS_11sManualWeldEEEEvv
 // __ZN3RBX4Name13callDoDeclareILZNS_11sManualWeldEEEEvv
 // type: 
...
// 0x5a6680 -- __ZN3RBX4Name9doDeclareILZNS_11sManualWeldEEEERKS0_v
 // __ZN3RBX4Name9doDeclareILZNS_11sManualWeldEEEERKS0_v
 // type: 
...
// 0x5a7630 -- __ZN3RBX4Name13callDoDeclareILZNS_5sWeldEEEEvv
 // __ZN3RBX4Name13callDoDeclareILZNS_5sWeldEEEEvv
 // type: 
...
// 0x5a7634 -- __ZN3RBX4Name9doDeclareILZNS_5sWeldEEEERKS0_v
 // __ZN3RBX4Name9doDeclareILZNS_5sWeldEEEERKS0_v
 // type: 
...
// 0x5a7dac -- __ZNK5boost23enable_shared_from_thisIN3RBX10Reflection13DescribedBaseEE22_internal_accept_ownerINS1_5MotorES6_EEvPKNS_10shared_ptrIT_EEPT0_
 // void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::Motor,RBX::Motor>(rbx_core::SharedPtr<RBX::Motor> const*,RBX::Motor *)const
 // type: 
