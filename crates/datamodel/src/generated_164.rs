//! datamodel generated_164 — next 100 stubs EA-sorted asc RBX::Instance fallback filler shard 164
//! Filter: demangled contains RBX:: + Instance fallback filler EA-sorted asc next 100 uncovered after 0x3834bc (15897 covered, 69648 remaining)
//! Source: ida/export.json (85545 funcs, base 0x4000)
//! Batch: 100 stubs | range 0x383538..0x38c224 | fallback filler EA-sorted asc per-datamodel after 0x3834bc (rbx_core::SharedPtr not boost)
//! Shard: 164 EA-sorted asc fallback filler (next 100 >0x3834bc)
...
// was: global constructor keyed to'_a_144
pub fn stub_384c44() -> ! {
...
// was: global constructor keyed to'_a_145
pub fn stub_38587c() -> ! {
...
// was: RBX::BaseThreadPool::loop(boost::shared_ptr<RBX::BaseThreadPool::PoolData>,boost::shared_ptr<RBX::mutex>)
pub fn stub_385e28() -> ! {
...
// was: RBX::join(boost::shared_ptr<boost::thread>)
pub fn stub_386420() -> ! {
...
// was: RBX::timed_join(boost::shared_ptr<boost::thread>,boost::date_time::subsecond_duration<boost::posix_time::time_duration,1000ll>)
pub fn stub_386428() -> ! {
...
// was: RBX::ThreadPool::schedule(boost::function<void ()(boost::shared_ptr<RBX::mutex>)>)
pub fn stub_386774() -> ! {
...
// was: RBX::PriorityThreadPool::schedule(boost::function<void ()(boost::shared_ptr<RBX::mutex>)>,float)
pub fn stub_3868c8() -> ! {
...
// was: RBX::PriorityThreadPool::PriorityThreadPoolData::getNextTask(boost::function<void ()(boost::shared_ptr<RBX::mutex>)> &)
pub fn stub_3869e4() -> ! {
...
// was: global constructor keyed to'_a_146
pub fn stub_38b740() -> ! {
