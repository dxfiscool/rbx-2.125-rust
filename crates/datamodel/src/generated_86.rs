...
#[doc(alias = "boost::unordered::detail::table_impl<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>>::operator[](RBX::Instance * const&)")]
...
#[doc(alias = "boost::unordered::detail::node_holder<std::allocator<boost::unordered::detail::ptr_node<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>>>::~node_holder()")]
...
#[doc(alias = "boost::unordered::detail::node_constructor<std::allocator<boost::unordered::detail::ptr_node<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>>>::construct(void)")]
...
#[doc(alias = "boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>>::create_buckets(unsigned long)")]
...
#[doc(alias = "boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>>::reserve_for_insert(unsigned long)")]
...
#[doc(alias = "boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>>::init(boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>> const&)")]
...
#[doc(alias = "boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>>::assign(boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>> const&,boost::unordered::detail::integral_constant<bool,false>)")]
...
#[doc(alias = "boost::unordered::detail::table<boost::unordered::detail::map<std::allocator<std::pair<RBX::Instance * const,boost::weak_ptr<RBX::Instance>>>,RBX::Instance *,boost::weak_ptr<RBX::Instance>,boost::hash<RBX::Instance *>,std::equal_to<RBX::Instance *>>>::~table()")]
...
#[doc(alias = "boost::_bi::list1<boost::_bi::value<boost::weak_ptr<RBX::DataModel>>>::list1(boost::_bi::value<boost::weak_ptr<RBX::DataModel>>)")]
...
#[doc(alias = "void boost::_bi::list1<boost::_bi::value<boost::weak_ptr<RBX::DataModel>>>::operator()<void (*)(boost::weak_ptr<RBX::DataModel>),boost::_bi::list0>(boost::_bi::type<void>,void (*)(boost::weak_ptr<RBX::DataModel>) &,boost::_bi::list0 &,int)")]
