...
// Batch: 100 stubs | range 0x43bcf8..0x44c234 | total filtered 10215, remaining 6234 after batch (6334 before)
// Shard: 182 EA-sorted asc next 100 uncovered (RBX::Instance|DataModel|Workspace)
...
pub fn stub_4421cc() -> ! {
    todo!("0x4421cc rbx_core::SharedPtr<RBX::Instance>::shared_ptr<RBX::Instance>(rbx_core::WeakPtr<RBX::Instance> const&,boost::detail::sp_nothrow_tag)")
}
