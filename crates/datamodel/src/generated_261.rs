...
// Filter: EA-sorted asc next 100 not yet in datamodel (strict RBX::Instance|RBX::DataModel|Workspace 0 remaining, global 0 gaps, per-crate fallback)
// Source: ida/export.json (85545 funcs, base 0x4000)
// Batch: 100 stubs | range 0x2636c4..0x266500 | strict 10215 complete (0 remaining), datamodel distinct 30064->30164 (global 85545 all covered, fallback to per-crate gap)
...
// was: virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::error_info_injector<boost::thread_resource_error>>::rethrow(void)const
...
// was: virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_exception_>::~clone_impl()
...
// type: int __fastcall(int)
// was: non-virtual thunk toboost::exception_detail::clone_impl<boost::exception_detail::bad_alloc_>::~clone_impl()
