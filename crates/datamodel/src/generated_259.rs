...
// was: RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string,std::string,RBX::HttpService::HttpContentType),std::string,3>::~BoundYieldFuncDesc()
...
pub fn stub_0x257a10() -> ! {
    todo!("0x257a10 RBX::Reflection::BoundFuncDesc<RBX::HttpService,rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(std::string),1>::~BoundFuncDesc()")
}
...
pub fn stub_0x257a50() -> ! {
    todo!("0x257a50 RBX::Reflection::BoundFuncDesc<RBX::HttpService,std::string ()(rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>),1>::~BoundFuncDesc()")
}
...
// was: RBX::Reflection::EnumDesc<RBX::HttpService::HttpContentType>::addPair(RBX::HttpService::HttpContentType,char const*)
...
// was: RBX::HttpService::HttpContentType & RBX::Reflection::Variant::genericConvert<RBX::HttpService::HttpContentType>(void)
...
// was: RBX::HttpService::~HttpService()
...
// type: 
// was: __ZN3RBX4Name13callDoDeclareILZNS_12sHttpServiceEEEEvv
#[doc(alias = "__ZN3RBX4Name13callDoDeclareILZNS_12sHttpServiceEEEEvv")]
pub fn stub_0x2583c4() -> ! {
...
// type: int()
// was: __ZN3RBX4Name9doDeclareILZNS_12sHttpServiceEEEERKS0_v
#[doc(alias = "__ZN3RBX4Name9doDeclareILZNS_12sHttpServiceEEEERKS0_v")]
pub fn stub_0x2583c8() -> ! {
...
pub fn stub_0x258800() -> ! {
    todo!("0x258800 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::HttpService,RBX::HttpService>(rbx_core::SharedPtr<RBX::HttpService> const*,RBX::HttpService *)const")
}
...
// was: RBX::HttpService::HttpContentType * rbx::any_cast<RBX::HttpService::HttpContentType,RBX::Region3>(rbx::placement_any<RBX::Region3> *)
...
// was: std::vector<RBX::HttpService::HttpContentType,std::allocator<RBX::HttpService::HttpContentType>>::resize(unsigned long,RBX::HttpService::HttpContentType)
...
// was: std::vector<RBX::HttpService::HttpContentType,std::allocator<RBX::HttpService::HttpContentType>>::push_back(RBX::HttpService::HttpContentType const&)
...
// was: std::map<RBX::Name const*,RBX::HttpService::HttpContentType,std::less<RBX::Name const*>,std::allocator<std::pair<RBX::Name const* const,RBX::HttpService::HttpContentType>>>::operator[](RBX::Name const* const&)
...
// was: std::vector<RBX::HttpService::HttpContentType,std::allocator<RBX::HttpService::HttpContentType>>::_M_insert_aux(__gnu_cxx::__normal_iterator<RBX::HttpService::HttpContentType*,std::vector<RBX::HttpService::HttpContentType,std::allocator<RBX::HttpService::HttpContentType>>>,RBX::HttpService::HttpContentType const&)
...
// was: std::_Vector_base<RBX::HttpService::HttpContentType,std::allocator<RBX::HttpService::HttpContentType>>::_M_allocate(unsigned long)
...
// type: int __fastcall(int, int, int)
// was: RBX::HttpService::HttpContentType * std::__copy_backward<false,std::random_access_iterator_tag>::__copy_b<RBX::HttpService::HttpContentType *,RBX::HttpService::HttpContentType *>(RBX::HttpService::HttpContentType *,RBX::HttpService::HttpContentType *,RBX::HttpService::HttpContentType *)
...
// was: RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundProp<RBX::HttpService>(char const*,char const*,bool RBX::HttpService::*,RBX::Reflection::PropertyDescriptor::Attributes,RBX::Security::Permissions)
...
// type: int()
// was: RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::isReadOnly(void)const
...
// type: int()
// was: RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::isWriteOnly(void)const
...
// was: RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::getValue(RBX::Reflection::DescribedBase const*)const
...
// was: RBX::Reflection::BoundProp<bool,(RBX::Reflection::Mutability)1>::BoundPropGetSet<RBX::HttpService>::setValue(RBX::Reflection::DescribedBase *,bool const&)const
...
pub fn stub_0x259868() -> ! {
    todo!("0x259868 RBX::Reflection::BoundFuncDesc<RBX::HttpService,std::string ()(rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const>),1>::~BoundFuncDesc()")
}
...
pub fn stub_0x259f64() -> ! {
    todo!("0x259f64 RBX::Reflection::BoundFuncDesc<RBX::HttpService,rbx_core::SharedPtr<boost::unordered::unordered_map<std::string,RBX::Reflection::Variant,boost::hash<std::string>,std::equal_to<std::string>,std::allocator<std::pair<std::string const,RBX::Reflection::Variant>>> const> ()(std::string),1>::~BoundFuncDesc()")
}
...
// was: RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string,std::string,RBX::HttpService::HttpContentType),std::string,3>::declareSignature(char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant,char const*,RBX::Reflection::Variant)
...
// type: int __fastcall(int, int, int)
// was: RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string),std::string,1>::declareSignature(char const*,RBX::Reflection::Variant)
...
// type: void __fastcall(_DWORD *)
// was: RBX::Reflection::BoundYieldFuncDesc<RBX::HttpService,std::string ()(std::string),std::string,1>::~BoundYieldFuncDesc()
...
// was: RBX::Light::setEnabled(bool)
#[doc(alias = "RBX::Light::setEnabled(bool)")]
pub fn stub_0x25b4c0() -> ! {
    todo!("0x25b4c0 RBX::Light::setEnabled(bool)")
}
...
// was: RBX::Light::getEnabled(void)const
#[doc(alias = "RBX::Light::getEnabled(void)const")]
pub fn stub_0x25c0c4() -> ! {
    todo!("0x25c0c4 RBX::Light::getEnabled(void)const")
}
...
// was: RBX::Light::getColor(void)const
#[doc(alias = "RBX::Light::getColor(void)const")]
pub fn stub_0x25c0f0() -> ! {
    todo!("0x25c0f0 RBX::Light::getColor(void)const")
}
...
// type: int __fastcall(RBX::Light *this)
// was: RBX::Light::getBrightness(void)const
#[doc(alias = "RBX::Light::getBrightness(void)const")]
pub fn stub_0x25c124() -> ! {
    todo!("0x25c124 RBX::Light::getBrightness(void)const")
}
...
// was: RBX::PointLight::getRange(void)const
#[doc(alias = "RBX::PointLight::getRange(void)const")]
pub fn stub_0x25c14c() -> ! {
    todo!("0x25c14c RBX::PointLight::getRange(void)const")
}
...
// was: RBX::SpotLight::getRange(void)const
#[doc(alias = "RBX::SpotLight::getRange(void)const")]
pub fn stub_0x25c174() -> ! {
    todo!("0x25c174 RBX::SpotLight::getRange(void)const")
}
...
// type: 
// was: __ZNK3RBX17NonFactoryProductINS_8InstanceELZNS_6sLightEEE12getClassNameEv
...
// type: 
// was: __ZThn32_NK3RBX17NonFactoryProductINS_8InstanceELZNS_6sLightEEE12getClassNameEv
...
pub fn stub_0x25c648() -> ! {
    todo!("0x25c648 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::SpotLight,RBX::SpotLight>(rbx_core::SharedPtr<RBX::SpotLight> const*,RBX::SpotLight *)const")
}

// 0x25c87c — __ZN3RBX4Name13callDoDeclareILZNS_10sSpotLightEEEEvv
// type: 
// was: __ZN3RBX4Name13callDoDeclareILZNS_10sSpotLightEEEEvv
...
// type: int()
// was: __ZN3RBX4Name9doDeclareILZNS_10sSpotLightEEEERKS0_v
...
pub fn stub_0x25cff8() -> ! {
    todo!("0x25cff8 void boost::enable_shared_from_this<RBX::Reflection::DescribedBase>::_internal_accept_owner<RBX::PointLight,RBX::PointLight>(rbx_core::SharedPtr<RBX::PointLight> const*,RBX::PointLight *)const")
}

// 0x25d22c — __ZN3RBX4Name13callDoDeclareILZNS_11sPointLightEEEEvv
// type: 
// was: __ZN3RBX4Name13callDoDeclareILZNS_11sPointLightEEEEvv
...
// type: int()
// was: __ZN3RBX4Name9doDeclareILZNS_11sPointLightEEEERKS0_v
...
// type: 
// was: __ZN3RBX4Name13callDoDeclareILZNS_6sLightEEEEvv
...
// type: int()
// was: __ZN3RBX4Name9doDeclareILZNS_6sLightEEEERKS0_v
...
// was: __ZN3RBX10Reflection9DescribedINS_9SpotLightELZNS_10sSpotLightEENS_14FactoryProductIS2_NS_5LightELZNS_10sSpotLightEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev
...
// type: void __fastcall(RBX::Light *)
// was: __ZN3RBX10Reflection9DescribedINS_9SpotLightELZNS_10sSpotLightEENS_14FactoryProductIS2_NS_5LightELZNS_10sSpotLightEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev
...
// type: void __fastcall(int)
// was: __ZThn32_N3RBX10Reflection9DescribedINS_9SpotLightELZNS_10sSpotLightEENS_14FactoryProductIS2_NS_5LightELZNS_10sSpotLightEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev
...
// type: void __fastcall(int)
// was: __ZThn32_N3RBX10Reflection9DescribedINS_9SpotLightELZNS_10sSpotLightEENS_14FactoryProductIS2_NS_5LightELZNS_10sSpotLightEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev
...
// type: void __fastcall(int)
// was: __ZThn36_N3RBX10Reflection9DescribedINS_9SpotLightELZNS_10sSpotLightEENS_14FactoryProductIS2_NS_5LightELZNS_10sSpotLightEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED1Ev
...
// type: void __fastcall(int)
// was: __ZThn36_N3RBX10Reflection9DescribedINS_9SpotLightELZNS_10sSpotLightEENS_14FactoryProductIS2_NS_5LightELZNS_10sSpotLightEENS_8InstanceEEELNS0_15ClassDescriptor13FunctionalityE27ELNS_8Security11PermissionsE0EED0Ev
