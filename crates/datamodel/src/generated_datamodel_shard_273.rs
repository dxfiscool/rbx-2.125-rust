...
// Batch: 100 stubs | range 0x29a344..0x2a44a4 | datamodel distinct 31464->31564 global uncovered 54081->53981, lowest gap EA-sorted asc next 100 after shard 272 (0x28d6fc..0x29a240)
// SharedPtr = rbx_core::SharedPtr (Arc), not boost::shared_ptr;  and  stripped from alias where needed
// Shard: 273 EA-sorted ascending next uncovered gap after shard 272 (distinct check via export.json sorted EA, no overlap)
...
pub fn stub_0x29c588() -> ! {
    todo!("0x29c588 RBX::ScriptContext::setThreadIdentity(lua_State *,RBX::Security::Identities,rbx_core::SharedPtr<RBX::BaseScript>)")
}
...
pub fn stub_0x29df1c() -> ! {
    todo!("0x29df1c RBX::Lua::Continuations::onSuccessHandler(lua_State *,boost::function<void ()(rbx_core::SharedPtr<RBX::Reflection::Tuple const>)>)")
}
...
pub fn stub_0x29e080() -> ! {
    todo!("0x29e080 RBX::Lua::Continuations::onErrorHandler(lua_State *,boost::function<void ()(char const*,char const*,rbx_core::SharedPtr<RBX::BaseScript>,int)>)")
}
...
pub fn stub_0x29e2a8() -> ! {
    todo!("0x29e2a8 RBX::ScriptContext::extractCallStack(lua_State *,rbx_core::SharedPtr<RBX::BaseScript> &,int &)")
}
...
pub fn stub_0x29fcc0() -> ! {
    todo!("0x29fcc0 RBX::ScriptContext::resumeWithArgs(RBX::Lua::ThreadRef,rbx_core::SharedPtr<RBX::Reflection::Tuple const>)")
}
...
pub fn stub_0x2a279c() -> ! {
    todo!("0x2a279c RBX::ScriptContext::scheduleResume(RBX::Lua::ThreadRef,rbx_core::SharedPtr<RBX::Reflection::Tuple const>)")
}
...
pub fn stub_0x2a3b60() -> ! {
    todo!("0x2a3b60 RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,rbx_core::SharedPtr<RBX::Reflection::Tuple const> ()(bool),1>::~BoundFuncDesc()")
}
...
pub fn stub_0x2a3ba0() -> ! {
    todo!("0x2a3ba0 RBX::Reflection::BoundFuncDesc<RBX::ScriptContext,rbx_core::SharedPtr<std::vector<RBX::Reflection::Variant,std::allocator<RBX::Reflection::Variant>> const> ()(void),0>::~BoundFuncDesc()")
}
